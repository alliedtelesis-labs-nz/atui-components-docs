...
const AtuiRadioGroup = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '06a3e5c7a4752bfbd75ec171ada337e3f52c1b62', role: "radiogroup", onKeyDown: (event) => this.handleKeyDown(event), class: "block w-full" }, index.h("div", { key: '00ba4126c645e2f847a3e8767e61c24ce85e439e', class: "flex flex-col" }, index.h("slot", { key: '6b7e8453b98e1c54cf29176738213b0430347065', name: "label" }), (this.label || this.required || this.info_text) && (index.h("atui-form-label", { key: 'c030f3a733ff5d7a8e345495e15ed2ddc12bc2cd', label: this.label, required: this.required, info_text: this.info_text })), this.hint_text && (index.h("span", { key: 'bca4b1d729829e4ac20d45399554ceb1f6e0e8f0', class: "mb-8 inline-block text-xs leading-tight text-light", "data-name": "radio-group-hint" }, this.hint_text))), index.h("ul", { key: '7d3c4eea3f27e33f9efdd0972664dace3b5cf275', class: classname, "data-name": "radio-group-options" }, index.h("slot", { key: 'bba88ce2469b3292e50fbdd5c95b682a5aa5a493' }), this.getRadios &&
            this.getRadios.map((radio) => (index.h("li", { class: "flex" }, radio)))), this.error_text && this.invalid && (index.h("span", { key: '13dcc8f7ab3eb77256069e077e20a5924de7f1e4', class: "text-sm text-error", "data-name": "radio-group-error-text" }, this.error_text))));
    }
