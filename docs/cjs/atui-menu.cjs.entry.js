...
const AtuiMenu = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '6b700cacccff11270ce36922965c9e2b224ca8a1' }, index.h("div", { key: '35e5058f48e40cde69a51ada69083473a3197ef3', class: "relative", onBlur: () => this.trigger === 'click' && !this.disabled
                ? this.mouseLeaveHandler()
                : null }, index.h("div", { key: 'd69ff08c30efcdd93728fe849daf78fea6757e99', "aria-haspopup": "true", "data-name": "menu-trigger", ref: (el) => (this.triggerEl = el), "aria-expanded": `${this.isOpen ? 'true' : 'false'}`, onMouseEnter: () => this.trigger === 'hover' && !this.disabled
            ...
            }, onClick: () => this.autoclose && this.mouseLeaveHandler(), class: classname, "data-name": "menu-content-wrapper" }, index.h("slot", { key: 'cdbaa36397af9fd2a0a9660c8a1b438a899c77f6', name: "menu-content" })))));
    }
