...
const AtuiMenu = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '23b47de71ea9b397d257fac0597ad347c0937a6b' }, index.h("div", { key: '0c491d413415451f14d7e975e4b8c7b04b40f1db', class: "relative", onBlur: () => this.trigger === 'click' && !this.disabled
                ? this.mouseLeaveHandler()
                : null }, index.h("div", { key: '667edb9cd222600f2da52c91566a78f03879dbba', "aria-haspopup": "true", "data-name": "menu-trigger", ref: (el) => (this.triggerEl = el), "aria-expanded": `${this.isOpen ? 'true' : 'false'}`, onMouseEnter: () => this.trigger === 'hover' && !this.disabled
                ...
                ? this.toggleMenu()
                : null, class: this.disabled ? 'contents' : '' }, index.h("slot", { key: '401129981392a64300b9e4fdbfa4e0555c6d917c', name: "menu-trigger" })), index.h("div", { key: '3434330e723e9d26563527ae308a6edef948c129', role: this.role, style: this.positionStyle, "data-position": this.position, "data-align": this.align, ref: (el) => (this.menuEl = el), "aria-hidden": `${this.isOpen ? 'false' : 'true'}`, onMouseEnter: () => this.trigger === 'hover' &&
                !this.disabled &&
            ...
            }, onClick: () => this.autoclose && this.mouseLeaveHandler(), class: classname, "data-name": "menu-content-wrapper" }, index.h("slot", { key: 'a635182689f4d391af86c99f1754ab8389536ba1', name: "menu-content" })))));
    }
