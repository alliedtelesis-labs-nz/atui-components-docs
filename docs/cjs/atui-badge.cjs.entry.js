...
const AtuiBadgeComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: '576b1653a777091fd0eb93d73b738bb8ff927b50', class: `${this.baseClasses} ${this.variantClasses} ${this.sizeClasses}` }, this.icon && (index.h("i", { key: 'c3885da4672c2fd65cf3fb9e9e8093526334e9e8', class: "material-icons icon-sm relative my-2 h-[14px] w-[14px] text-sm", "data-name": "badge-icon" }, this.icon)), index.h("span", { key: '5451cd84fcbd4059d3b4fcf8c6f2edcf7864442f', "data-name": "badge-label" }, this.label), index.h("slot", { key: '22f9a3fbf478332fafdf2ff01068406e3e710fbe' })));
    }
};

exports.atui_badge = AtuiBadgeComponent;
//# sourceMappingURL=atui-badge.entry.cjs.js.map

//# sourceMappingURL=atui-badge.cjs.entry.js.map