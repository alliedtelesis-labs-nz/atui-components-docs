...
const AtuiSearchTable = class {
    ...
    render() {
        return (index.h(index.Host, { key: '0388d25406001d0472e9d5af634843dd3fee396f' }, index.h("atui-table-actions", { key: '0782344bb453410ede23a5c80d38a17a909dbf7d', ag_grid: this.agGrid }, index.h("div", { key: '6d4848f876e361b05805d783bbb4024dbc4fffce', class: "flex items-center gap-8", slot: "search" }, !this.hide_dropdown_filters && this.col_defs && (index.h("atui-table-filter-menu", { key: '153b3b6ba89e2f7fd919d2cdf0c5d492d5111e08', slot: "filter-menu", col_defs: this.col_defs, selected: this.menuSelectedIds, onAtuiChange: (event) => this.handleFilterChange(event) })), index.h("atui-search", { key: '6e38fddfe2d4580f216546672e15c9a9ac1b41d3', class: "w-input-md", label: this.search_label, hint_text: this.search_hint, info_text: this.search_info_tooltip, placeholder: this.translations.ATUI.TABLE.SEARCH_BY_KEYWORD, onAtuiChange: (event) => this.handleSearchChange(event) })), !this.hide_dropdown_filters && this.col_defs && (index.h("atui-table-filters", { key: '75e51fedb18c3986e861f09e11fb065c8f55154c', slot: "filters", col_defs: this.col_defs, selected: this.selectedFilters, onAtuiChange: (event) => this.handleFilterChange(event) })), !this.hide_export_menu && (index.h("atui-table-export-menu", { key: 'ae22e7c3c6c77aeed9f625e82e1dcca238b32c53', slot: "export-menu" })), !this.hide_column_manager && this.col_defs && (index.h("atui-column-manager", { key: '6be1e90adbe77823c9a2f94f2ae246a2b09f26d1', slot: "column-manager", col_defs: this.col_defs, onAtuiChange: (event) => this.handleColumnChange(event) })), index.h("div", { key: '2156b70fb445a89e20c9c2b6e05cf02b48b3b6bc', slot: "actions" }, index.h("slot", { key: 'adade4a626815d478f150bb3d72415ad06dea43b', name: "actions" }))), index.h("slot", { key: 'f689362be6df7c4c2f790d666f7948bc9172d69c', name: "multi-select-actions" }), index.h("atui-table", { key: '6e80157a24878d82b88249ce35515b50713d4310', ref: (el) => (this.tableEl = el), table_data: this.table_data, col_defs: this.col_defs, page_size: this.page_size, use_custom_pagination: this.use_custom_pagination, disable_auto_init: true })));
    }
