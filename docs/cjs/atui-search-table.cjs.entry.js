...
const AtuiSearchTable = class {
    ...
    render() {
        return (index.h(index.Host, { key: '4c2598c93c350489da9aabb14becb4ac3a7a1b17' }, index.h("atui-table-actions", { key: '69e425b83f8d1521344f1a3123b1b132c6aea8b3', ag_grid: this.agGrid }, index.h("div", { key: 'f617060bc1cf9f277d814dbb1bf0ab0c3380871e', class: "flex items-center gap-8", slot: "search" }, !this.hide_dropdown_filters && this.col_defs && (index.h("atui-table-filter-menu", { key: '65e694dbd10a1a1b4f58fca66d4fb741ca5e907c', slot: "filter-menu", col_defs: this.col_defs, selected: this.menuSelectedIds, onAtuiChange: (event) => this.handleFilterChange(event) })), index.h("atui-search", { key: '160ecc9b1828bb4cf6141ec8410f6c892259480e', class: "w-input-md", label: this.search_label, hint_text: this.search_hint, info_text: this.search_info_tooltip, placeholder: this.translations.ATUI.TABLE.SEARCH_BY_KEYWORD, onAtuiChange: (event) => this.handleSearchChange(event) })), !this.hide_dropdown_filters && this.col_defs && (index.h("atui-table-filters", { key: '6e590bdb124af1fb5cb4b1c6c673cbc2a5e92f9d', slot: "filters", col_defs: this.col_defs, selected: this.selectedFilters, onAtuiChange: (event) => this.handleFilterChange(event) })), !this.hide_export_menu && (index.h("atui-table-export-menu", { key: '8ca9b6f0c3fcea29a4f62fe4d4bbc1e14c1f4aaa', slot: "export-menu" })), !this.hide_column_manager && this.col_defs && (index.h("atui-column-manager", { key: '7e08182de30325b74d8fc82c7141b9509b38a78e', slot: "column-manager", col_defs: this.col_defs, onAtuiChange: (event) => this.handleColumnChange(event) })), index.h("div", { key: 'ddcd708522e3fff981b53cf77775a8173621d2ca', slot: "actions" }, index.h("slot", { key: '78182336857c86ef414ddb6b346fefc2e2c42d88', name: "actions" }))), index.h("slot", { key: '5b3501390290e7363bd29e6ae55eeaaa564e71d8', name: "multi-select-actions" }), index.h("atui-table", { key: 'a9e796054eb4e3462e842b46dfbc4d879f587dab', ref: (el) => (this.tableEl = el), table_data: this.table_data, col_defs: this.col_defs, page_size: this.page_size, use_custom_pagination: this.use_custom_pagination, disable_auto_init: true })));
    }
