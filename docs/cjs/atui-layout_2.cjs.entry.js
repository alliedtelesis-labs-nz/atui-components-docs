...
const AtuiLayout = class {
    ...
    render() {
        return index.h(index.Host, { key: 'eecc99407aa4e70807d7226bd23529f7e759d1f7' }, this.layoutElement);
    }
};
...
const AtuiTab = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '309422c8e1a593f40ea593f54f9f1e09583276cf', role: "tab", "aria-selected": this.is_active, "data-active": this.is_active ? 'true' : 'false', onKeyDown: (event) => this.handleKeyDown(event), "data-name": `tab-${this.tab_id}` }, index.h("a", { key: 'cc2e003b86c95e530d04c93cbae271c5845b4aab', id: `tab-${this.tab_id}`, tabindex: "0", class: classname, ref: (el) => (this.tabEl = el) }, this.tab_title, index.h("slot", { key: 'ac8690295c5b0c3aa49d76624af9224a388c5045' }))));
    }
};
