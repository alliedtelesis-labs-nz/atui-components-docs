...
const AtuiChartDonut = class {
    ...
    render() {
        return (index.h(index.Host, { key: '6004c4b8b496a154fca4e0e9e117dec0e0a5ab91', role: "region", class: `relative flex w-full flex-col items-center justify-center ${heightVariants[this.height]}` }, index.h("canvas", { key: '9048c17b9c636a7cdf55167f42f8d9bd0016a3ff', ref: (el) => (this.canvasEl = el), style: {
                position: 'absolute',
                top: '50%',
                left: '50%',
