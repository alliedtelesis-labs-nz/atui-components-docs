...
const AtuiTreeItemComponent = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'fa8192f387626220d7b89c29798ff68f1c9daf2d', class: classname, role: "button", tabIndex: 0, "aria-disabled": this.disabled, onKeyDown: (event) => this.handleKeyDown(event), onClick: (event) => this.handleClick(event) }, index.h("div", { key: 'cee059987f1cd587ae2aead161d2e64b352a1daf', class: "z-20 flex h-full w-full items-center justify-between gap-4", style: { paddingLeft: indent } }, index.h("div", { key: '1d25a32028084d6811677523d664fa3821f4b345', class: "flex gap-4" }, this.has_children && (index.h("span", { key: '9479a675fe453b069d1c3bbe8c6f597e9154b973', class: "material-icons h-16 w-16 text-[16px] leading-[16px]", "data-name": "tree-item-indicator" }, this.selected
            ? 'keyboard_arrow_down'
            : 'keyboard_arrow_right')), this.label && (index.h("span", { key: 'cac095dc00bdc819cae5b1c159ea0d0350e8010b', class: "leading-[16px]", "data-name": "tree-item-label" }, this.label))), index.h("slot", { key: '81e416dedeb861312cdca90a439642876c453c50' })), index.h("div", { key: 'c245c449ed9765343de2f4c3b466266c3162f832', "data-name": "focus-indicator", role: "presentation", class: "pointer-events-none absolute left-0 top-0 z-10 h-full w-full transition-colors duration-300 ease-in-out" })));
    }
