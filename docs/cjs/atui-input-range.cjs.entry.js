...
const AtuiInputRangeComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: '237950d70a3617cdcf602abbd79876f75a0863b7' }, index.h("div", { key: 'f8d2fec0d9511d8e59a84f1cdf984f5f9a2a52b2', class: "flex flex-col" }, index.h("slot", { key: '07c6e4eebe1fd4793084cc1f1b0bd1f0644c1234', name: "label" }), (this.label || this.required || this.info_text) && (index.h("atui-form-label", { key: '5666f5443354a461e9ea8a47c7494c7f6f2c6b86', label: this.label, for: this.sliderId, required: this.required && !this.readonly, info_text: this.info_text })), this.hint_text && (index.h("span", { key: 'b1cdbad1e3deff9c38e90034ca2ccc4f01670828', class: "inline-block text-xs leading-tight text-light", "data-name": "slider-hint" }, this.hint_text)), this.error_text && this.invalid && (index.h("span", { key: 'b68b73e27aceabbfbaf767ff9d39df9f1fac19b3', class: "text-xs font-normal text-error", "data-name": "slider-error" }, this.error_text)), this.warning_text && !this.invalid && (index.h("span", { key: 'e6896b6ce70e0ef950e95deaaf742a7a7d176e99', class: "text-xs font-normal text-warning-foreground", "data-name": "slider-warning" }, this.warning_text))), index.h("div", { key: 'cd021516ab83130a09fae8e0fec3b3c3de0cb0c7', class: `mt-4 flex items-start gap-8 ${this.label_position == 'before' ? 'flex-row-reverse' : 'flex-row'}` }, index.h("div", { key: 'ce816824f043a2e1b32e80077c4e8ef4921efecc', class: "flex flex-grow flex-col" }, index.h("div", { key: 'f20ee6dd8630dcd876310bd042c32c86df6b763b', class: "flex flex-grow" }, index.h("div", { key: '8a69f00978aad4eb2b1899085ca27d4b83833cfe', class: "range-slider", style: {
                '--min': `${this.min}`,
                '--max': `${this.max}`,
                '--step': `${this.step}`,
                '--value': `${this.value}`,
            ...
            }, ref: (el) => (this.sliderContainerRef = el) }, index.h("input", { key: '2051a425edb496e875c93f749aa3a5d3a0c860e8', list: "markers", type: "range", min: this.min, max: this.max, step: this.step, "aria-controls": this.sliderId, disabled: this.disabled || this.readonly
                ? true
            ...
            } }), this.show_value && (index.h("output", { key: '56831bc2cbc397605555cbeff2418a5802010645', class: "text-sm" }, this.value)), index.h("div", { key: '102260887a6d789ede76cf6871b6125dd76c032a', class: "range-slider__progress" })))), this.show_input && (index.h("div", { key: 'f7005ca72b9858d3a3585dcd2ae678fd449d9d81', class: "relative flex w-80 flex-row items-center gap-8" }, index.h("atui-input-numeric", { key: 'bde9dbfaeacfc95db62f9410519677b6cca58d93', readonly: this.readonly, disabled: this.disabled, min: this.min, max: this.max, step: this.step, value: this.value, show_buttons: false, "data-name": "slider-text-input", onAtuiChange: (event) => this.onChange(event.detail) }), this.suffix && (index.h("span", { key: '6bdfe91c8bb9dc4bad6ea4589872fe8616b5a0d3', "data-name": "slider-suffix", class: "absolute right-[36px] top-1/2 -translate-y-1/2 text-light" }, this.suffix)))))));
    }
