...
const AtuiInputRangeComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'e69278ad6aaabc3c5bb1b86fa03d32f80192ea62' }, index.h("div", { key: 'd6f18049362ed641601f420a2db8445724852077', class: "flex flex-col" }, index.h("slot", { key: '348859cca209357dd4517ea38937958e2960d668', name: "label" }), (this.label || this.required || this.info_text) && (index.h("atui-form-label", { key: '7f029d6622866fb260810430be8d0f7a597eb436', label: this.label, for: this.sliderId, required: this.required && !this.readonly, info_text: this.info_text })), this.hint_text && (index.h("span", { key: '52c07c5e8a8e87c8556a278ac9c88f9a7c097b0f', class: "inline-block text-xs leading-tight text-light", "data-name": "slider-hint" }, this.hint_text)), this.error_text && this.invalid && (index.h("span", { key: 'fd084549f23d78a4d1371ccd6ee34c1fc2880177', class: "text-xs font-normal text-error", "data-name": "slider-error" }, this.error_text)), this.warning_text && !this.invalid && (index.h("span", { key: 'd7faec2179685b80338748e31a048478f4815aac', class: "text-xs font-normal text-warning-foreground", "data-name": "slider-warning" }, this.warning_text))), index.h("div", { key: 'f5feef140a2792cba3f11c306da5f5c2b1230e4d', class: `mt-4 flex items-start gap-8 ${this.label_position == 'before' ? 'flex-row-reverse' : 'flex-row'}` }, index.h("div", { key: 'f02c0e9add138c56a6d2a521e458baab2f65196d', class: "flex flex-grow flex-col" }, index.h("div", { key: '40a7fde2765e5f2933ac9080eccc63ce96364c9e', class: "flex flex-grow" }, index.h("div", { key: 'a2f84ee95253e631cfb23f7ea231e743b95334f6', class: "range-slider", style: {
                '--min': `${this.min}`,
                '--max': `${this.max}`,
                '--step': `${this.step}`,
                '--value': `${this.value}`,
            ...
            }, ref: (el) => (this.sliderContainerRef = el) }, index.h("input", { key: '5836bc5127de72f8cc65f86d7fd48822edab00bd', list: "markers", type: "range", min: this.min, max: this.max, step: this.step, "aria-controls": this.sliderId, disabled: this.disabled || this.readonly
                ? true
            ...
            } }), this.show_value && (index.h("output", { key: '9a25c9638395a135000a15b1f9f0366979d86749', class: "text-sm" }, this.value)), index.h("div", { key: 'cf974384b357a0dafc9eaab960b26736bed185d9', class: "range-slider__progress" })))), this.show_input && (index.h("div", { key: '45199a5ea739ae7e7fb5e0bd2a30329bd4695f8f', class: "relative flex w-80 flex-row items-center gap-8" }, index.h("atui-input-numeric", { key: '17fc6ff1f2d69b6a7563f4165c02fc2e9edf0364', readonly: this.readonly, disabled: this.disabled, min: this.min, max: this.max, step: this.step, value: this.value, show_buttons: false, "data-name": "slider-text-input", onAtuiChange: (event) => this.onChange(event.detail) }), this.suffix && (index.h("span", { key: 'd05a89dd65d34811b9bdea3fc08f850fc1bb9cb9', "data-name": "slider-suffix", class: "absolute right-[36px] top-1/2 -translate-y-1/2 text-light" }, this.suffix)))))));
    }
