...
const AtuiInputRangeComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'b1a5b332ce016bef072e29e0ed6e20c029c99154' }, index.h("div", { key: '4cf67367291150d29a583b39a3f7a03f8e12e03c', class: "flex flex-col" }, index.h("slot", { key: '0a8c81d4ff1623235f60a480c3a6e5ed46647555', name: "label" }), (this.label || this.required || this.info_text) && (index.h("atui-form-label", { key: 'c4af67af5f888a1832490909211ff70d6845a6b3', label: this.label, for: this.sliderId, required: this.required && !this.readonly, info_text: this.info_text })), this.hint_text && (index.h("span", { key: '5bb244561844fa6f0318746b698604078d9ee575', class: "inline-block text-xs leading-tight text-light", "data-name": "slider-hint" }, this.hint_text)), this.error_text && this.invalid && (index.h("span", { key: '6a5659202dfde24c44bb3cb72412ece67da3c567', class: "text-xs font-normal text-error", "data-name": "slider-error" }, this.error_text)), this.warning_text && !this.invalid && (index.h("span", { key: '1ad0b55b29b5f01bf3d4ad7166dfab681324d362', class: "text-xs font-normal text-warning-foreground", "data-name": "slider-warning" }, this.warning_text))), index.h("div", { key: '941264a0bd7410d3dce5d53738d77161d3ae1be2', class: `mt-4 flex items-start gap-8 ${this.label_position == 'before' ? 'flex-row-reverse' : 'flex-row'}` }, index.h("div", { key: 'e87d898ba96b7b241b7647fd01d2f4211aed1eb5', class: "flex flex-grow flex-col" }, index.h("div", { key: 'adfadfbe1f7b7962971f81169c5849b05ee50f4c', class: "flex flex-grow" }, index.h("div", { key: '6fdfe86cb77846f734ed4efad4773816512845db', class: "range-slider", style: {
                '--min': `${this.min}`,
                '--max': `${this.max}`,
                '--step': `${this.step}`,
                '--value': `${this.value}`,
            ...
            }, ref: (el) => (this.sliderContainerRef = el) }, index.h("input", { key: 'ecb1d84a46c586e4f8a2bffc2e01d594d79c230f', list: "markers", type: "range", min: this.min, max: this.max, step: this.step, "aria-controls": this.sliderId, disabled: this.disabled || this.readonly
                ? true
            ...
            } }), this.show_value && (index.h("output", { key: '10bcec68155bbc60fd19e6fae99aecedf6e01262', class: "text-sm" }, this.value)), index.h("div", { key: 'ca264c60b80b9a78f4c219fe8141c8f43dd590f0', class: "range-slider__progress" })))), this.show_input && (index.h("div", { key: '193470aecbb6b1b59b9851e4123f81d3d5548b32', class: "relative flex w-80 flex-row items-center gap-8" }, index.h("atui-input-numeric", { key: '2d0502f7980ed52fbe90f660f309cd7a401f08f4', readonly: this.readonly, disabled: this.disabled, min: this.min, max: this.max, step: this.step, value: this.value, show_buttons: false, "data-name": "slider-text-input", onAtuiChange: (event) => this.onChange(event.detail) }), this.suffix && (index.h("span", { key: '90fe0f3d7d6260f2dfac3855b79cd79f8368c224', "data-name": "slider-suffix", class: "absolute right-[36px] top-1/2 -translate-y-1/2 text-light" }, this.suffix)))))));
    }
    get el() { return index.getElement(this); }
};
AtuiInputRangeComponent.style = atuiInputRangeCss;

exports.atui_input_range = AtuiInputRangeComponent;
//# sourceMappingURL=atui-input-range.entry.cjs.js.map

//# sourceMappingURL=atui-input-range.cjs.entry.js.map