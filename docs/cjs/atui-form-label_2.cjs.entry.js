...
const AtuiFormLabelComponent = class {
    ...
    render() {
        var _a;
        return (index.h("div", { key: 'bdf4ff18a98c5008722bfea3962cad3fd7eda26c', class: "flex items-center gap-8" }, [
            (this.label || this.required) && (index.h("label", { key: '9e41dfcb632810723ca9e9ec6bedf17ec2710d42', htmlFor: (_a = this.for) !== null && _a !== void 0 ? _a : undefined, class: "flex gap-4" }, this.label, this.required && index.h("span", { key: '9ec2daeb611fee10bd28f9c8cbff69adf63309de', class: "text-error" }, "*"))),
            this.info_text && (index.h("atui-tooltip", { key: 'd133a6a0ce90b18430c7dbe146de4260fe7a8b8d', position: "right" }, index.h("span", { key: '01cc5cb5d254444536b4663bedf07bac50ca970c', slot: "tooltip-trigger", class: "material-icons cursor-pointer !text-icon-sm text-light" }, "info_outline"), index.h("span", { key: '3109c5d73e5de37d8abc503d51bf4093576325e3', slot: "tooltip-content" }, this.info_text))),
        ]));
    }
};
...
const AtuiTooltipComponent = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'a598519e833f935d74894bfdd04d79d537d829c4', class: "relative inline-block" }, index.h("div", { key: '4c45eda8ea4f63c71b48da5314d92ee61e0c2f5b', class: "peer contents", ref: (el) => (this.triggerEl = el) }, index.h("slot", { key: '8ac880835bbb9cbb1c2bd4a2590003c534923715', name: "tooltip-trigger" })), index.h("div", { key: '2c2dabee0b7eb8e3ce5e03bd688a57fd2e96581b', ref: (el) => (this.tooltipEl = el), style: this.positionStyle, class: classname }, index.h("slot", { key: 'a821d59f054ebd52fecffbcb8405bcb96f7d9244', name: "tooltip-content" }))));
    }
