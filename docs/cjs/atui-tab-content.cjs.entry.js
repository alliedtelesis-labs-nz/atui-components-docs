...
const AtuiTabContent = class {
    ...
    render() {
        return (index.h("div", { key: 'fde188dc3d5f4e3dd870ba163575ad8bdb7a8b25', class: `${this.isActive ? 'flex flex-col' : 'hidden'}`, role: "tabpanel", id: `panel-${this.tab_id}`, "aria-labelledby": `tab-${this.tab_id}`, tabIndex: this.isActive ? 0 : -1, "aria-hidden": !this.isActive }, index.h("slot", { key: '4afbec4b9904d1199504187e7426ef3ff5d7d233' })));
    }
