...
const AtuiSelectComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: '3194d935aa118b1c4ac18aa2ff08c7302cfaa648', class: "group/select", onFocusout: async (event) => {
                if (!this.el.contains(event.relatedTarget)) {
                    await this.menuRef.closeMenu();
                }
            } }, this.renderlabel(), index.h("atui-menu", { key: 'c8c2f9eb6e863e2ddd80efe85ca2b99a81b23c6b', ref: (el) => (this.menuRef = el), trigger: "click", align: "start", width: this.parentWidth, role: "listbox", disabled: this.disabled || this.readonly, onAtuiMenuStateChange: (event) => this.updateIsOpenState(event) }, this.renderInput(), !this.disabled || !this.readonly
            ? this.renderOptions()
            : null), index.h("div", { key: 'f2ed16414d6c0fac7c34712ba6f11efd28045128' }, this.error_text && this.invalid && (index.h("span", { key: '4514da115460280d17e096bd6fed065ba82630df', class: "text-error", "data-name": "select-error" }, this.error_text)))));
    }
    renderlabel() {
