...
const AtuiButtonComponent = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'd4196b825ad2d2859be64dc7bdfd7796ee4423b4', class: classname, role: "button", tabIndex: 0, onKeyDown: (event) => this.handleKeyDown(event), onClick: (event) => this.handleClick(event) }, index.h("div", { key: '26f3be2175a8766f646c93461bc6d9c3a2e0fae3', class: "z-20 flex h-full w-full items-center justify-center gap-4" }, this.in_progress && (index.h("atui-loading", { key: '65248084418ed8292fe589062627bf148bf764ad', class: "absolute", size: "sm", type: this.spinnerColour })), this.icon && (index.h("span", { key: '9d641778263519d0f864f1e9a07081f68aabeaeb', class: `material-icons h-16 w-16 text-[16px] leading-[16px] ${this.in_progress ? 'invisible' : 'visible'}`, "data-name": "button-icon" }, this.icon)), this.label && (index.h("span", { key: 'f2e6d0979b214b5bf0ce9d14f0b04e212075ff4e', class: `leading-[16px] ${this.in_progress ? 'invisible' : 'visible'}`, "data-name": "button-label" }, this.label)), index.h("slot", { key: '54bcfbcaa311648c50a56b804ba25662174b4937' }), this.icon_right && (index.h("span", { key: '9a72417d46662209e32fa51455a0f70fc0f05fab', class: `material-icons h-16 w-16 text-[16px] leading-[16px] ${this.in_progress ? 'invisible w-0' : 'visible'}`, "data-name": "button-icon-right" }, this.icon_right))), index.h("div", { key: '2ae7de4b57f58a815ddb0e32e3181e1ea129a8e8', "data-name": "focus-indicator", role: "presentation", class: focusIndicatorClassname })));
    }
