...
const AtuiButtonComponent = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'af899a6b76c37a7d0a005c3881473c60ab3b76f7', class: classname, role: "button", tabIndex: 0, onKeyDown: (event) => this.handleKeyDown(event), onClick: (event) => this.handleClick(event) }, index.h("div", { key: '8536d8a42c8a608ba2c22e1d30ae6ca51fe86f47', class: "z-20 flex h-full w-full items-center justify-center gap-4" }, this.in_progress && (index.h("atui-loading", { key: '306a1491c4477ad5afda4ed7f1df4fa79689334e', class: "absolute", size: "sm", type: this.spinnerColour })), this.icon && (index.h("span", { key: 'be43bec2cf5fb6e2cd56a323d5c13820cd050103', class: `material-icons h-16 w-16 text-[16px] leading-[16px] ${this.in_progress ? 'invisible' : 'visible'}`, "data-name": "button-icon" }, this.icon)), this.label && (index.h("span", { key: 'c8126c8c59e5fe682a4494c6b0cd27292f57cda9', class: `leading-[16px] ${this.in_progress ? 'invisible' : 'visible'}`, "data-name": "button-label" }, this.label)), index.h("slot", { key: '9792446d993165a5cbbe4df006a27e3baeadb642' }), this.icon_right && (index.h("span", { key: 'ba8e9e319cc47aaf1ec636dcd5c5a9c55c4c6405', class: `material-icons h-16 w-16 text-[16px] leading-[16px] ${this.in_progress ? 'invisible w-0' : 'visible'}`, "data-name": "button-icon-right" }, this.icon_right))), index.h("div", { key: 'ddb0084d0f5d62c51215f6f562b66a28d52c9ca2', "data-name": "focus-indicator", role: "presentation", class: focusIndicatorClassname })));
    }
