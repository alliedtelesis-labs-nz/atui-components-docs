...
const AtuiButtonComponent = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '20143b0909d1f40a9d6be393765ee130241ed43b', class: classname, role: "button", tabIndex: 0, onKeyDown: (event) => this.handleKeyDown(event), onClick: (event) => this.handleClick(event) }, index.h("div", { key: 'd15cae52f69a29c3cca8997e7e2d39e0dea6d579', class: "z-20 flex h-full w-full items-center justify-center gap-4" }, this.in_progress && (index.h("atui-loading", { key: '4a13b448cf02a16330557dedeec2a3ad50089c59', class: "absolute", size: "sm", type: this.spinnerColour })), this.icon && (index.h("span", { key: '3f0dd31f7450565dca1487f57cc5da4f742078fe', class: `material-icons h-16 w-16 text-[16px] leading-[16px] ${this.in_progress ? 'invisible' : 'visible'}`, "data-name": "button-icon" }, this.icon)), this.label && (index.h("span", { key: 'fe7602d6b06ef3a3b2f9a0f680c5d7b2098edf6d', class: `leading-[16px] ${this.in_progress ? 'invisible' : 'visible'}`, "data-name": "button-label" }, this.label)), index.h("slot", { key: '1812617bca6bfdd78bf7c063372b30d68f0c6d94' }), this.icon_right && (index.h("span", { key: '8f05bf6da3fb53ec77240ef82fb6c80c3bf9c33b', class: `material-icons h-16 w-16 text-[16px] leading-[16px] ${this.in_progress ? 'invisible w-0' : 'visible'}`, "data-name": "button-icon-right" }, this.icon_right))), index.h("div", { key: '1d09be62bb51f2b899f3a728b7b27267c9e09518', "data-name": "focus-indicator", role: "presentation", class: focusIndicatorClassname })));
    }
