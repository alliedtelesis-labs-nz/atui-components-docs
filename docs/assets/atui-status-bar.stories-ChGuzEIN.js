...
/>
<script>
document.querySelector('atui-status-bar').status_bar = ${JSON.stringify(s.status_bar,null,4)}
<\/script>
...
/>
<script>
document.querySelector('atui-status-bar').status_bar = \${JSON.stringify(args.status_bar, null, 4)}
<\/script>
