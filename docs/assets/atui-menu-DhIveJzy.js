import{j as e,M as i}from"./index-lk0VIocu.js";import{useMDXComponents as s}from"./index-BZ-WbQW8.js";import{ar as u}from"./MermaidMarkdown-CscjgtQN.js";import"./iframe-BLGK-kH0.js";import"./index-CfOrKyLd.js";import"./index-DrFu-skq.js";const r=`# atui-auto-open-menu
...
| ----------------- | ---------------------------------------------- | ---------------------- |
| \`menuStateChange\` | Emits an event containing the open menu state. | \`CustomEvent<boolean>\` |
...
`,e.jsx(u,{md:r})]})}function g(n={}){const{wrapper:t}={...s(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(o,{...n})}):o()}export{g as default};
