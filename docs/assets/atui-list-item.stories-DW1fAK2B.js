...
<atui-list-item
    ...
    border=${!!e.border}
    size=${e.size??"sm"}
/>`,o={title:"Components/List Item",argTypes:{size:{options:["lg","md","sm","xs"],control:{type:"select"}}}},t=n.bind({});t.args={size:"sm",item_id:"id",item_title:"title",subtitle:"subtitle",item_prefix:"prefix",icon:"home",content:"content",border:!1};var i,s,r;t.parameters={...t.parameters,docs:{...(i=t.parameters)==null?void 0:i.docs,source:{originalSource:`args => \`
<atui-list-item
