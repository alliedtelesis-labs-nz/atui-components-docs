...
import { d as defineCustomElement$1 } from './p-B7VanSx_.js';
...
const AtuiCheckboxHeaderComponent = /*@__PURE__*/ proxyCustomElement(class AtuiCheckboxHeaderComponent extends H {
    ...
    render() {
        return (h("atui-checkbox", { key: 'cf67419314db05a2147818b874d19ed20b26d063', disabled: this.disabled, value: this.isChecked, onAtuiChange: (event) => this.setRowsValue(event.detail) }));
    }
    get el() { return this; }
...
//# sourceMappingURL=p-BHyFWj8f.js.map
