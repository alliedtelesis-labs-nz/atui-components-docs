...
import { d as defineCustomElement$1 } from './p-BwhlSt5K.js';
...
const AtuiCheckboxHeaderComponent = /*@__PURE__*/ proxyCustomElement(class AtuiCheckboxHeaderComponent extends H {
    ...
    render() {
        return (h("atui-checkbox", { key: '5376cf241159232371c09fcd562aa9a66604d3a5', disabled: this.disabled, value: this.isChecked, onAtuiChange: (event) => this.setRowsValue(event.detail) }));
    }
    get el() { return this; }
...
//# sourceMappingURL=p-lrgd7JEQ.js.map
