...
import { d as defineCustomElement$g } from './p-DRPzh5AP.js';
import { d as defineCustomElement$f } from './p-i_ooLqDN.js';
import { d as defineCustomElement$e } from './p-D6uAy_4U.js';
import { d as defineCustomElement$d } from './p-IW_3TsUX.js';
import { d as defineCustomElement$c } from './p-CoOWTCxi.js';
import { d as defineCustomElement$b } from './p-BSfjNoXC.js';
import { d as defineCustomElement$a } from './p-CHkT-iof.js';
import { d as defineCustomElement$9 } from './p-BAl9Vi-7.js';
import { d as defineCustomElement$8 } from './p-BWfeHCxZ.js';
import { d as defineCustomElement$7 } from './p-Dzk6JpCu.js';
import { d as defineCustomElement$6 } from './p-B4GQwf9G.js';
import { d as defineCustomElement$5 } from './p-P8hvtCEJ.js';
import { d as defineCustomElement$4 } from './p-Cs5eIb3v.js';
import { d as defineCustomElement$3 } from './p-BF9e-wi0.js';
...
const AtuiSearchTable$1 = /*@__PURE__*/ proxyCustomElement(class AtuiSearchTable extends H {
    ...
    render() {
        return (h(Host, { key: '3045ac09b42475f85f4a06d7d4e18d7dfd532a5a' }, h("atui-table-actions", { key: 'e5d733d57d9a2bf0b828ff0955f48c2800580825', ag_grid: this.agGrid }, h("div", { key: '6e089936a5cdff37dd324ddebd4d0b1e342089f3', class: "flex items-center gap-8", slot: "search" }, !this.hide_dropdown_filters && this.col_defs && (h("atui-table-filter-menu", { key: 'cc7bd0de32ff72ddb806f1d151a226c7525d8478', slot: "filter-menu", col_defs: this.col_defs, selected: this.menuSelectedIds, onAtuiChange: (event) => this.handleFilterChange(event) })), h("atui-search", { key: '3e1c13633a1edb86dcb572457a3f32bde504867b', class: "w-input-md", label: this.search_label, hint_text: this.search_hint, info_text: this.search_info_tooltip, placeholder: this.translations.ATUI.TABLE.SEARCH_BY_KEYWORD, onAtuiChange: (event) => this.handleSearchChange(event) })), !this.hide_dropdown_filters && this.col_defs && (h("atui-table-filters", { key: '480aac98405124e64ca72759f11db2e16184c7d4', slot: "filters", col_defs: this.col_defs, selected: this.selectedFilters, onAtuiChange: (event) => this.handleFilterChange(event) })), !this.hide_export_menu && (h("atui-table-export-menu", { key: 'b671cdbc77f9dcc78c459abe3e10aabe096e82de', slot: "export-menu" })), !this.hide_column_manager && this.col_defs && (h("atui-column-manager", { key: '690a511bc1bc5be8180a3dd57481d0aca23c2924', slot: "column-manager", col_defs: this.col_defs, onAtuiChange: (event) => this.handleColumnChange(event) })), h("div", { key: '3f22bdbae8a46adb1c4346177a981eb925353501', slot: "actions" }, h("slot", { key: '56c214619f50b29dfff083d95a99cdbbbee644e2', name: "actions" }))), h("slot", { key: 'adf290a7939087319e23e8fd8075ab9a864c0465', name: "multi-select-actions" }), h("atui-table", { key: 'd48b34e9af88625b5e781101a46927feab904482', ref: (el) => (this.tableEl = el), table_data: this.table_data, col_defs: this.col_defs, page_size: this.page_size, use_custom_pagination: this.use_custom_pagination, disable_auto_init: true, auto_size_columns: this.auto_size_columns })));
    }
    get el() { return this; }
