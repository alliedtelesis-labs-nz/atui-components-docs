...
import { d as defineCustomElement$d } from './p-CNIPth1r.js';
import { d as defineCustomElement$c } from './p-BOCO6_-f.js';
import { d as defineCustomElement$b } from './p-B8u3Es9V.js';
import { d as defineCustomElement$a } from './p-DsBr_t-L.js';
import { d as defineCustomElement$9 } from './p-CEO3zNbx.js';
import { d as defineCustomElement$8 } from './p-Dm8z4FlE.js';
import { d as defineCustomElement$7 } from './p-ByK4-pDJ.js';
import { d as defineCustomElement$6 } from './p-BlC_9xQ9.js';
import { d as defineCustomElement$5 } from './p-B-R-HO9p.js';
import { d as defineCustomElement$4 } from './p-B_URSIAY.js';
import { d as defineCustomElement$3 } from './p-C7zFI4_B.js';
...
const AtuiTimeRangeComponent = /*@__PURE__*/ proxyCustomElement(class AtuiTimeRangeComponent extends H {
    ...
    render() {
        var _a, _b, _c;
        return (h(Host, { key: '57dfb937dd2b9b98504063498f1fb2034de6b2c2', class: "relative flex justify-center gap-8" }, this.enable_relative_time && (h("atui-button-group", { key: '5def9a92508fb1843a7eb711fdc5af12ad963498', options: this.buttonGroupOptions, onAtuiIndexChange: (event) => (event.detail === 0 &&
                this.relativeTimeMenuEl.focus()) ||
                (event.detail === 1 &&
                    this.absoluteTimeMenuEl.focus()) })), !this.enable_relative_time && (h("atui-button-group", { key: '2592fcb942481ecc13c65172eccd30b808bb56a7', options: this.predefinedTimeRanges, onAtuiIndexChange: (event) => {
            ...
            } })), h("div", { key: '8d90557aa5b65b2119612a2ecc0f79258723c425', ref: (el) => (this.relativeTimeMenuEl = el), class: "absolute top-[42px] z-10 h-0 overflow-hidden bg-white focus-within:h-fit focus-within:overflow-visible focus:h-fit", tabindex: 0, onChange: (event) => event.stopPropagation() }, h("atui-time-with-unit", { key: '5d83502e524c6c6458c38d6fbe02fe0933d0c300', units: this.units, common_options: this.presets, min_date: this.lowerLimit, min_seconds: this.minSeconds, initial_selected_time: this.selected_time_range.selected ===
            ...
            } })), h("div", { key: 'bc26f2cd3106a5df7cd9873cebb41f68998096ac', ref: (el) => (this.absoluteTimeMenuEl = el), class: "absolute top-[42px] z-10 h-0 overflow-hidden bg-white focus-within:h-fit focus-within:overflow-visible focus:h-fit", tabindex: 0, onChange: (event) => event.stopPropagation() }, h("atui-custom-time-range", { key: '8cb1366e15a083283b87ff077dda0e9277f7b11a', min_date: this.lowerLimit, default_to_date: this.today, default_from_date: this.defaultFromDate, from_date_value: (_a = this.getCustomStartAndEndDate(this.selected_time_range)) === null || _a === void 0 ? void 0 : _a.fromDate, to_date_value: (_b = this.getCustomStartAndEndDate(this.selected_time_range)) === null || _b === void 0 ? void 0 : _b.toDate, lock_end_date_to_now: (_c = this.selected_time_range.custom) === null || _c === void 0 ? void 0 : _c.lockEndDateToNow, onAtuiSubmit: (event) => this.onChangeCustomTime(event.detail), onAtuiCancel: () => {
                this.absoluteTimeMenuEl.focus();
