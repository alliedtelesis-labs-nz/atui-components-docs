...
export default {
    ...
    parameters: {
        docs: {
            description: {
                component: 'Examples demonstrating manual table initialization using the disable_auto_init prop. This provides precise control over when and how the atui-table component is initialized, useful for complex scenarios requiring custom setup or external grid management.',
            },
        },
    },
};
...
//# sourceMappingURL=atui-table-manual-init.stories.js.map
