...
const AtuiToggleSwitchComponent = class {
    ...
    render() {
        ...
        return (h(Host, { key: '6db7379c6ca43e86d281bbe6efbf2216c402b489', id: `${this.toggleId}-host`, role: "switch", "aria-labelledby": `${this.toggleId}-label`, class: classname, tabIndex: 0, onClick: () => this.inputEl.click(), onKeyDown: (event) => {
                if (event.key === ' ' || event.key === 'Enter') {
                    event.preventDefault();
                    this.inputEl.click();
                }
            } }, h("div", { key: '4c1d973f1a24509b81d69e832fc4e8a00a12bf68', class: "flex flex-col" }, h("slot", { key: '91b19aaf4653d72d9909eb92dcfa58458eca914b', name: "label" }), !!this.label && this.show_label && (h("atui-form-label", { key: 'ec95f864a1eeb984e2816d00b3a22e368ec7b111', label: this.label, class: "pointer-events-none select-none", for: this.toggleId, id: `${this.toggleId}-label`, "data-name": "switch-label" })), this.hint_text && (h("span", { key: '4353ace32ae39bccd2cb411ddc8b343dca79a0f0', class: "inline-block text-xs leading-tight text-light", "data-name": "select-hint" }, this.hint_text))), h("div", { key: '19ee5c9e642be6e1d3cb2035e5b0472d7ff12fa8', class: "relative flex h-20 w-40" }, h("input", { key: '10be723c4af9c975eb84040c87cbf14e5a2ad4d7', id: this.toggleId, class: "h-0 w-0 opacity-0", disabled: this.disabled, type: "checkbox", checked: this.value, tabIndex: -1, onChange: (e) => this.onToggle(e.target.checked), ref: (el) => (this.inputEl = el), "data-name": "switch-input" }), h("span", { key: 'f768175f25bd097fb240aaed46bb15222085014d', class: trackClassname }, h("span", { key: 'a2ef9a6573f925ae36aee7327b781b19a2fbf4d9', class: thumbClassname }, this.value ? 'check' : 'remove')))));
    }
};
