...
/>
<script>
${args.data ? `document.querySelector('atui-chart-bar-line').data = ${JSON.stringify(args.data, null, 4)}` : ''}
${args.x_axis_format ? `document.querySelector('atui-chart-bar-line').x_axis_format = ${JSON.stringify(args.x_axis_format, null, 4)}` : ''}
${args.options ? `document.querySelector('atui-chart-bar-line').options = ${JSON.stringify(args.options, null, 4).replace(/"\(/g, '(').replace(/`"/g, '`')}` : ''}
${args.time_range ? `document.querySelector('atui-chart-bar-line').time_range = ${JSON.stringify(args.time_range, null, 4)}` : ''}
${args.thresholds ? `document.querySelector('atui-chart-bar-line').thresholds = ${JSON.stringify(args.thresholds, null, 4)}` : ''} 
${args.tooltip_options ? `document.querySelector('atui-chart-bar-line').tooltip_options = ${JSON.stringify(args.tooltip_options, null, 4).replace(/"\(/g, '(').replace(/`"/g, '`')}` : ''}
${args.point_styles ? `document.querySelector('atui-chart-bar-line').point_styles = ${JSON.stringify(args.point_styles, null, 4)}` : ''}
</script>
`;
export default {
...
//# sourceMappingURL=atui-chart-bar-line.stories.js.map
