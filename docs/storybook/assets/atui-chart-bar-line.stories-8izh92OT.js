...
/>
<script>
${a.data?`document.querySelector('atui-chart-bar-line').data = ${JSON.stringify(a.data,null,4)}`:""}
${a.x_axis_format?`document.querySelector('atui-chart-bar-line').x_axis_format = ${JSON.stringify(a.x_axis_format,null,4)}`:""}
${a.options?`document.querySelector('atui-chart-bar-line').options = ${JSON.stringify(a.options,null,4).replace(/"\(/g,"(").replace(/`"/g,"`")}`:""}
${a.time_range?`document.querySelector('atui-chart-bar-line').time_range = ${JSON.stringify(a.time_range,null,4)}`:""}
${a.thresholds?`document.querySelector('atui-chart-bar-line').thresholds = ${JSON.stringify(a.thresholds,null,4)}`:""} 
${a.tooltip_options?`document.querySelector('atui-chart-bar-line').tooltip_options = ${JSON.stringify(a.tooltip_options,null,4).replace(/"\(/g,"(").replace(/`"/g,"`")}`:""}
${a.point_styles?`document.querySelector('atui-chart-bar-line').point_styles = ${JSON.stringify(a.point_styles,null,4)}`:""}
<\/script>
