...
• **Game Playing**: AI systems that can play chess, Go, or video games`,name:"AI Assistant",timestamp:"2:31 PM"}],k={title:"Components/Prompt/Thread",component:"atui-prompt-thread",argTypes:{messages:{control:"object",description:"Array of messages to display"},loading:{control:"boolean",description:"Loading state"},empty_state_title:{control:"text",description:"Empty state title"},empty_state_description:{control:"text",description:"Empty state description"},auto_scroll:{control:"boolean",description:"Auto scroll to bottom on new messages"},max_height:{control:"text",description:"Maximum height of the thread container"}}},s={args:{messages:[],empty_state_title:"No messages yet",empty_state_description:"Start a conversation by sending a message"},render:e=>t`
        <div
  ...
  render: args => html\`
    ...
    \`
}`,...(h=(c=a.parameters)==null?void 0:c.docs)==null?void 0:h.source}}};var u,y,x;r.parameters={...r.parameters,docs:{...(u=r.parameters)==null?void 0:u.docs,source:{originalSource:`{
  args: {
    messages: sampleMessages,
    loading: true,
    auto_scroll: true,
  ...
  render: args => html\`
    ...
    \`
}`,...(x=(y=r.parameters)==null?void 0:y.docs)==null?void 0:x.source}}};var $,b,v;o.parameters={...o.parameters,docs:{...($=o.parameters)==null?void 0:$.docs,source:{originalSource:`{
  args: {
    messages: [...sampleMessages, {
      id: '5',
