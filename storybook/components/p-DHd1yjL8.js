...
const AtMenu = /*@__PURE__*/ proxyCustomElement(class AtMenu extends H {
    ...
    render() {
        return (h(Host, { key: '035a6c36eb09d23abc240efa4b5480489b244a62', class: "relative", onBlur: () => this.trigger === 'click' && !this.disabled
                ? this.mouseLeaveHandler()
                : null }, !this.trigger_id && (h("div", { key: '292086d7f40aa03142fd7afb99f9c5c1fc095495', "aria-haspopup": "true", "data-name": "menu-trigger", ref: (el) => (this.triggerEl = el), "aria-expanded": `${this.isOpen ? 'true' : 'false'}`, onMouseEnter: () => this.trigger === 'hover' && !this.disabled
                ? this.mouseEnterHandler()
            ...
            }, class: this.disabled ? 'contents' : '' }, h("slot", { key: 'ed799cc7f950b0f544affb15d790d3291cc6b310', name: "menu-trigger" }))), h("div", { key: 'e6b8224bcaaf65707592e2b0553e9666bb6022db', role: this.role, "data-position": this.position, "data-align": this.align, ref: (el) => (this.menuEl = el), "aria-hidden": `${this.isOpen ? 'false' : 'true'}`, popover: "auto", id: this.popoverId, onMouseEnter: () => this.trigger === 'hover' &&
                !this.disabled &&
            ...
            }, onClick: () => this.autoclose && this.mouseLeaveHandler(), class: `w-fit rounded-md bg-white p-4 shadow-md transition-opacity duration-150 ${this.isOpen ? 'opacity-100' : 'opacity-0'}`, "data-name": "menu-content-wrapper" }, h("slot", { key: '8a7772f04a3b45c6555a07b29021bc7654f7fdee' }))));
    }
...
//# sourceMappingURL=p-DHd1yjL8.js.map
