...
import { d as defineCustomElement$g } from './p-BkB7yMfB.js';
import { d as defineCustomElement$f } from './p-BjeWQPdc.js';
import { d as defineCustomElement$e } from './p-ByKYx6Hh.js';
import { d as defineCustomElement$d } from './p-CJjhP-rH.js';
import { d as defineCustomElement$c } from './p-cJhPHVMD.js';
import { d as defineCustomElement$b } from './p-BgNpHlsG.js';
import { d as defineCustomElement$a } from './p-BmgpvZ_L.js';
import { d as defineCustomElement$9 } from './p-C6qlH9rK.js';
import { d as defineCustomElement$8 } from './p-BYjeqBRs.js';
import { d as defineCustomElement$7 } from './p-ChXDDdsB.js';
import { d as defineCustomElement$6 } from './p-B63odi3N.js';
import { d as defineCustomElement$5 } from './p-D9z8ryz6.js';
import { d as defineCustomElement$4 } from './p-D7K5Evug.js';
import { d as defineCustomElement$3 } from './p-DUUoj1Sv.js';
...
const AtuiSearchTable$1 = /*@__PURE__*/ proxyCustomElement(class AtuiSearchTable extends H {
    ...
    render() {
        return (h(Host, { key: 'd8c0a333b89a631b16a5559fd6562f0e7103c4f3' }, h("atui-table-actions", { key: 'c49a5f4aac8a1a3a9cec8c5ba337cc1e9a54b445', ag_grid: this.agGrid }, h("div", { key: '6a4d8f88d5edcfaf2fdf9d1dd9300d112fc95ab8', class: "flex items-center gap-8", slot: "search" }, !this.hide_dropdown_filters && this.col_defs && (h("atui-table-filter-menu", { key: '3a850d86d22ef5415c2ba12fc04a979890d92d9e', slot: "filter-menu", col_defs: this.col_defs, selected: this.menuSelectedIds, onAtuiChange: (event) => this.handleFilterChange(event) })), h("atui-search", { key: '7e9f9d615cae5a4567cd2c2a468fa55725c47057', class: "w-input-md", label: this.search_label, hint_text: this.search_hint, info_text: this.search_info_tooltip, placeholder: this.translations.ATUI.TABLE.SEARCH_BY_KEYWORD, onAtuiChange: (event) => this.handleSearchChange(event) })), !this.hide_dropdown_filters && this.col_defs && (h("atui-table-filters", { key: '28694b00adfc1ab7106f02f6e881482f94463c99', slot: "filters", col_defs: this.col_defs, selected: this.selectedFilters, onAtuiChange: (event) => this.handleFilterChange(event) })), !this.hide_export_menu && (h("atui-table-export-menu", { key: '915d61ef599425ce457a7751af20b3f8028a7f99', slot: "export-menu" })), !this.hide_column_manager && this.col_defs && (h("atui-column-manager", { key: '6ea922430862c5ed7f88149d153e03631714cb73', slot: "column-manager", col_defs: this.col_defs, onAtuiChange: (event) => this.handleColumnChange(event) })), h("div", { key: 'a49b646e2ddbe6d5235f8905a25aebbed2a5e79d', slot: "actions" }, h("slot", { key: '457c73a8cdf9173df82921160cdd918c29f89c76', name: "actions" }))), h("slot", { key: 'b48445382a05be1f598f412cf60d27f1bb31c0d0', name: "multi-select-actions" }), h("atui-table", { key: '74e7b3d2b6fa2ac01d140494044856b5cac34e0b', ref: (el) => (this.tableEl = el), table_data: this.table_data, col_defs: this.col_defs, page_size: this.page_size, use_custom_pagination: this.use_custom_pagination, disable_auto_init: true, auto_size_columns: this.auto_size_columns })));
    }
    get el() { return this; }
