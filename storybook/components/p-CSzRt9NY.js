...
import { d as defineCustomElement$1 } from './p-DBWEgk0R.js';
...
const AtuiButtonComponent = /*@__PURE__*/ proxyCustomElement(class AtuiButtonComponent extends H {
    ...
    render() {
        ...
        return (h(Host, { key: 'a5100444d13dc88c9bcc53bce6e743bb5a376c99', class: classname, role: "button", tabIndex: 0, onKeyDown: (event) => this.handleKeyDown(event), onClick: (event) => this.handleClick(event) }, h("div", { key: '97e65f4f95253bdddcf766ebac051775ff1855eb', class: "z-20 flex h-full w-full items-center justify-center gap-4" }, this.in_progress && (h("atui-loading", { key: '89da814d2c61965fddfaa9a1fd74499962c1a7c6', class: "absolute", size: "sm", type: this.spinnerColour })), h("slot", { key: '3cdb643ecc2afcb573dd0c504234955fd35bcf2c', name: "icon" }), this.icon && (h("span", { key: '83dab241840b3544b1cabac522e87d075e0a5bf3', class: `material-icons h-16 w-16 text-[16px] leading-[16px] ${this.in_progress ? 'invisible' : 'visible'}`, "data-name": "button-icon" }, this.icon)), this.label && (h("span", { key: '07c2815b2eca41ea25581298ec513f7588c18b41', class: `leading-[16px] ${this.in_progress ? 'invisible' : 'visible'}`, "data-name": "button-label" }, this.label)), h("slot", { key: '26e0e468e6ab33d38f22d6b5a8daf1a973b83366' }), h("slot", { key: '8f0880a72d87dcfad1778ae92f73cccd98d01e3d', name: "icon_after" }), this.icon_after && (h("span", { key: 'd5598c7d142b14549b3b4affb287e4d29b74e13c', class: `material-icons h-16 w-16 text-[16px] leading-[16px] ${this.in_progress ? 'invisible w-0' : 'visible'}`, "data-name": "button-icon-right" }, this.icon_after))), h("div", { key: '2453a4e58b4cc787928781e7946a258eb900a85f', "data-name": "focus-indicator", role: "presentation", class: focusIndicatorClassname })));
    }
    get el() { return this; }
}, [260, "atui-button", {
        "submit": [4],
...
//# sourceMappingURL=p-CSzRt9NY.js.map
