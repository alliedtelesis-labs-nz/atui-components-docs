...
import { d as defineCustomElement$1 } from './p-i_ooLqDN.js';
...
const AtuiCheckboxHeaderComponent = /*@__PURE__*/ proxyCustomElement(class AtuiCheckboxHeaderComponent extends H {
    ...
    render() {
        return (h("atui-checkbox", { key: '1479ab1035f5e9dc972ab28fae8a45b581423b31', disabled: this.disabled, value: this.isChecked, onAtuiChange: (event) => this.setRowsValue(event.detail) }));
    }
    get el() { return this; }
...
//# sourceMappingURL=p-DW-ja-4E.js.map
