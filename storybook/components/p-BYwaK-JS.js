...
const AtTreeItemComponent = /*@__PURE__*/ proxyCustomElement(class AtTreeItemComponent extends H {
    ...
    render() {
        ...
        return (h(Host, { key: 'b1265bc42b67c43d7b81aeb828b9b13de201951a', class: classname, role: "button", tabIndex: 0, "aria-disabled": this.disabled, onKeyDown: (event) => this.handleKeyDown(event), onClick: (event) => this.handleClick(event) }, h("div", { key: '4305bb55fef3aae95f4ed09027de395a4d5c9ad6', class: "z-20 flex h-full w-full items-center justify-between gap-4", style: { paddingLeft: indent } }, h("div", { key: 'd251eb6c284cd87b4ec5222fd482268abc9a017e', class: "flex gap-4" }, this.has_children && (h("span", { key: '8710860e5c710c2ebee9c9e7907cd0818c0969a2', class: "material-icons h-16 w-16 text-[16px] leading-[16px]", "data-name": "tree-item-indicator" }, this.selected
            ? 'keyboard_arrow_down'
            : 'keyboard_arrow_right')), this.label && (h("span", { key: 'a90f274ff2858f551455972cafff0e57675318c1', class: "leading-[16px]", "data-name": "tree-item-label" }, this.label)), h("slot", { key: 'd72d0107c1c3fe2ce95c69808b01b22346db4965', name: "label" })), h("slot", { key: '33003fa4862bbb776424282b4da431ad89c40c11' })), h("div", { key: '3d1fe43b2fa1fffeab58c0591ef2a8e374f00748', "data-name": "focus-indicator", role: "presentation", class: "pointer-events-none absolute top-0 left-0 z-10 h-full w-full transition-colors duration-300 ease-in-out" })));
    }
}, [260, "at-tree-item", {
        "size": [1],
        "label": [1],
...
//# sourceMappingURL=p-BYwaK-JS.js.map
