...
const AtTreeItemComponent = /*@__PURE__*/ proxyCustomElement(class AtTreeItemComponent extends H {
    ...
    render() {
        ...
        return (h(Host, { key: 'a86c273578d90b331cc2d09a7cf147f5fe0c0c28', class: classname, role: "button", tabIndex: 0, "aria-disabled": this.disabled, onKeyDown: (event) => this.handleKeyDown(event), onClick: (event) => this.handleClick(event) }, h("div", { key: 'f9c455683c07beb541b629d39c82d8369f984b63', class: "z-20 flex h-full w-full items-center justify-between gap-4", style: { paddingLeft: indent } }, h("div", { key: 'f079e092dd53d69a222acd8e251a6a92f274dcc3', class: "flex gap-4" }, this.has_children && (h("span", { key: 'a941820278ec0bb5d98365a0bc1fd9f2563d7b81', class: "material-icons h-16 w-16 text-[16px] leading-[16px]", "data-name": "tree-item-indicator" }, this.selected
            ? 'keyboard_arrow_down'
            : 'keyboard_arrow_right')), this.label && (h("span", { key: '0ac9f25d2c7205ed948bbaf1bd83fc04bd6ac003', class: "leading-[16px]", "data-name": "tree-item-label" }, this.label)), h("slot", { key: 'aee7f15703fa28a236b1abe05d3384689d2dcef3', name: "label" })), h("slot", { key: 'b93678c5d1b16f1130891ed90818e41dd58fd6e8' })), h("div", { key: '1ec6b79fa26c64e8f58a494442fdcdfdd8ed3281', "data-name": "focus-indicator", role: "presentation", class: "pointer-events-none absolute top-0 left-0 z-10 h-full w-full transition-colors duration-300 ease-in-out" })));
    }
    get el() { return this; }
}, [260, "at-tree-item", {
        "size": [1],
...
//# sourceMappingURL=p-f0TjuR1R.js.map
