...
import { d as defineCustomElement$8 } from './p-BzsPb4KK.js';
import { d as defineCustomElement$7 } from './p-DdgKKrXv.js';
import { d as defineCustomElement$6 } from './p-C7_PGbxB.js';
import { d as defineCustomElement$5 } from './p-Cie1yJIR.js';
import { d as defineCustomElement$4 } from './p-Dq-NrSDT.js';
...
const AtMultiSelectComponent = /*@__PURE__*/ proxyCustomElement(class AtMultiSelectComponent extends H {
    ...
    render() {
        return (h(Host, { key: '0d41147cf4dd4185fff7b716b529e0056cb172fa', class: "group/select", onFocusout: async (event) => {
            ...
            ? this.renderOptions()
            : null), h("div", { key: 'd23de602596a37021f0b5a2b3015e2acb6f299e8' }, this.error_text && this.invalid && (h("span", { key: 'df9326c91bf483c0ce74e3b9c22a7fd30e382be6', "data-name": "multi-select-error", class: "text-error" }, this.error_text)))));
    }
    renderLabel() {
