...
const AtBadgeComponent = /*@__PURE__*/ proxyCustomElement(class AtBadgeComponent extends H {
...
function defineCustomElement() {
    ...
    const components = ["at-badge"];
    components.forEach(tagName => { switch (tagName) {
        case "at-badge":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, AtBadgeComponent);
            }
            break;
    } });
}

export { AtBadgeComponent as A, defineCustomElement as d };
//# sourceMappingURL=p-C1ISvew5.js.map
