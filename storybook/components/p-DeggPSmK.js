...
const AtTreeItemComponent = /*@__PURE__*/ proxyCustomElement(class AtTreeItemComponent extends H {
    ...
    render() {
        ...
        return (h(Host, { key: 'ff32c03d241e1853152347bf4f47ce42ebef65fd', class: classname, role: "button", tabIndex: 0, "aria-disabled": this.disabled, onKeyDown: (event) => this.handleKeyDown(event), onClick: (event) => this.handleClick(event) }, h("div", { key: '7ba7bcddd7170621df3b66165348b7e74c2d819e', class: "z-20 flex h-full w-full items-center justify-between gap-4", style: { paddingLeft: indent } }, h("div", { key: 'ea0a3c8c04e73b893fb18ac968c4f17cf04873f3', class: "flex gap-4" }, this.has_children && (h("span", { key: '584dbe8605dd99b1518adc732b11288878933010', class: "material-icons h-16 w-16 text-[16px] leading-[16px]", "data-name": "tree-item-indicator" }, this.selected
            ? 'keyboard_arrow_down'
            : 'keyboard_arrow_right')), this.label && (h("span", { key: 'd71b186baadceb96c70e6feac3a18113d8e097d0', class: "leading-[16px]", "data-name": "tree-item-label" }, this.label)), h("slot", { key: 'fc9f10b033f90205cbbdddc00f73b8dafdfa1147', name: "label" })), h("slot", { key: '4e935d94f64f11e893cebf9fb4793c8f52f9b06c' })), h("div", { key: '94ef361368ab0409d8b7d8b2c9adc8dd3ca1fd92', "data-name": "focus-indicator", role: "presentation", class: "pointer-events-none absolute top-0 left-0 z-10 h-full w-full transition-colors duration-300 ease-in-out" })));
    }
}, [260, "at-tree-item", {
        "size": [1],
        "label": [1],
...
//# sourceMappingURL=p-DeggPSmK.js.map
