...
import { d as defineCustomElement$4 } from './p-mCEpxKzE.js';
...
const AtInputNumericComponent = /*@__PURE__*/ proxyCustomElement(class AtInputNumericComponent extends H {
    ...
    render() {
        ...
        return (h(Host, { key: '45f9dc1e684a2b5cf65e53cb6d32395f103b69c8', class: "w-full" }, h("div", { key: '5e4d9a52bb0cc3907a9c1709dacba04047b9f08a', class: "flex flex-col" }, h("slot", { key: 'affe274b25c328431895b4afe2c0a4ccbd9ed9d2', name: "label" }), (this.label || this.required || this.info_text) && (h("at-form-label", { key: 'c90aa916e2c13c4018b7b2bb18786f032c843cf2', label: this.label, for: this.inputId, required: this.required && !this.readonly, info_text: this.info_text })), this.hint_text && (h("span", { key: '8ad71c3aeae60c6d2422900675fa5db31c3f1191', class: "text-light mb-8 inline-block text-xs leading-tight", "data-name": "input-hint" }, this.hint_text))), h("div", { key: 'eebdd261830ed1ae697fe347708fb6b514766beb', class: containerClassname }, this.show_buttons && !this.disabled && !this.readonly && (h("at-button", { key: '0e74753c353758fb85f506d04986e20191cd366b', class: "border-med rounded-l-md rounded-r-none border-r border-solid", type: "secondaryText", icon: "remove", onClick: this.handleDecrease, disabled: this.value <= this.min, "aria-label": "Subtract", "data-name": "input-subtract" })), h("input", { key: '58b15a19a52c79a6e97c273c3367733979ac7719', id: this.inputId, readonly: this.readonly ? true : undefined, disabled: this.disabled ? true : undefined, required: this.required, type: "number", placeholder: `${this.placeholder}`, onInput: (event) => (this.value = Number(event.target.value)), onChange: (event) => this.handleChange(event), value: this.value, ref: (el) => (this.inputEl = el), class: classname, "data-name": "input" }), this.show_buttons && !this.disabled && !this.readonly && (h("at-button", { key: '1928a74461afa1b0bfba11e3066d506c44baef3b', class: "border-med rounded-l-none rounded-r-md border-l border-solid", type: "secondaryText", icon: "add", onClick: this.handleIncrease, disabled: this.value >= this.max, "aria-label": "Add", "data-name": "input-add" }))), this.error_text && this.invalid && (h("span", { key: 'cc9784decf3ca3bd7656a7ffb678987121080639', class: "text-error text-sm", "data-name": "input-error" }, this.error_text))));
    }
...
//# sourceMappingURL=p-BqTMFh9g.js.map
