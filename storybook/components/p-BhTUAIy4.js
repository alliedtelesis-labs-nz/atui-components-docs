...
const AtMessage = /*@__PURE__*/ proxyCustomElement(class AtMessage extends H {
    ...
    static get style() { return atMessageCss; }
}, [260, "at-message", {
        "type": [1],
        "impact": [1],
        "message_title": [1],
    ...
    components.forEach(tagName => { switch (tagName) {
        case "at-message":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, AtMessage);
            }
            break;
    } });
}

export { AtMessage as A, defineCustomElement as d };
//# sourceMappingURL=p-BhTUAIy4.js.map
