...
function defineCustomElement$1() {
    ...
    const components = ["at-dashboard", "at-button", "at-loading", "at-menu"];
    components.forEach(tagName => { switch (tagName) {
        case "at-dashboard":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, AtDashboard$1);
            }
            break;
        case "at-button":
            if (!customElements.get(tagName)) {
...
const AtDashboard = AtDashboard$1;
const defineCustomElement = defineCustomElement$1;

export { AtDashboard, defineCustomElement };
