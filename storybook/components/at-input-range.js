...
import { d as defineCustomElement$6 } from './p-BT8_JQR7.js';
import { d as defineCustomElement$5 } from './p-CIL9MUFC.js';
import { d as defineCustomElement$4 } from './p-BitdoZgV.js';
...
const AtInputRangeComponent = /*@__PURE__*/ proxyCustomElement(class AtInputRangeComponent extends H {
    ...
    render() {
        return (h(Host, { key: '90824bca77ee421252f2cf0da5c6831bb21cb2e5' }, h("div", { key: 'a7db2d659d024c67063d30a4af8b77c2c528d1be', class: "flex flex-col" }, h("slot", { key: '193bac1dad2d8d5197be6b07ead80cbc319160b3', name: "label" }), (this.label || this.required || this.info_text) && (h("at-form-label", { key: '13c08deef9d9bb304382f8229648d18c704d6c4b', label: this.label, for: this.sliderId, required: this.required && !this.readonly, info_text: this.info_text })), this.hint_text && (h("span", { key: '5b986bd050f12ff1c1a4e7e4bb171da77af05c51', class: "text-light inline-block text-xs leading-tight", "data-name": "slider-hint" }, this.hint_text)), this.error_text && this.invalid && (h("span", { key: '197a95b30c08c8bf64632cc8861223dbba29aa6a', class: "text-error text-xs font-normal", "data-name": "slider-error" }, this.error_text)), this.warning_text && !this.invalid && (h("span", { key: '5e2115fec16359286d1336e8e67bec5e2660c844', class: "text-warning-foreground text-xs font-normal", "data-name": "slider-warning" }, this.warning_text))), h("div", { key: '5b8e55b828da273d3501342d9aa347881ed28bea', class: `mt-4 flex items-start gap-8 ${this.label_position == 'before' ? 'flex-row-reverse' : 'flex-row'}` }, h("div", { key: 'c8eec51408b18e13a030312d744ba5f935e7e20c', class: "flex flex-grow flex-col" }, h("div", { key: 'a603d639c8073ff91203979a33686e24617b8cc6', class: "flex flex-grow" }, h("div", { key: '0877102411f59a3bd59ffdcae86b2c28a318820f', class: "range-slider", style: {
                '--min': `${this.min}`,
                '--max': `${this.max}`,
                '--step': `${this.step}`,
                '--value': `${this.value}`,
            ...
            }, ref: (el) => (this.sliderContainerRef = el) }, h("input", { key: 'd05eceefe5cfc376ad09aa71c54edfb33494d155', list: "markers", type: "range", min: this.min, max: this.max, step: this.step, "aria-controls": this.sliderId, disabled: this.disabled || this.readonly
                ? true
            ...
            } }), this.show_value && (h("output", { key: '82788d52263837420f0fa75b5c25ad90e92e1931', class: "text-sm" }, this.value)), h("div", { key: '818cd00796d8319d11628b334402933e47a52306', class: "range-slider__progress" })))), this.show_input && (h("div", { key: '1e903a5ee8e3b466bec6467cff15fcf9cdbab321', class: "relative flex w-80 flex-row items-center gap-8" }, h("at-input-numeric", { key: 'c8fcb13d41b5d7331afc7777b3d7d0b32c53132c', readonly: this.readonly, disabled: this.disabled, min: this.min, max: this.max, step: this.step, value: this.value, show_buttons: false, "data-name": "slider-text-input", onAtuiChange: (event) => this.onChange(event.detail) }), this.suffix && (h("span", { key: 'f25da73606d9ccb9f15299f998f96c22ee6d2a93', "data-name": "slider-suffix", class: "text-light absolute top-1/2 right-[36px] -translate-y-1/2" }, this.suffix)))))));
    }
