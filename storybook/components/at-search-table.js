...
import { d as defineCustomElement$g } from './p-anL6prWM.js';
import { d as defineCustomElement$f } from './p-Df2_temq.js';
import { d as defineCustomElement$e } from './p-DpIDrqJD.js';
import { d as defineCustomElement$d } from './p-lQnrcPro.js';
import { d as defineCustomElement$c } from './p-CdWdq1MG.js';
import { d as defineCustomElement$b } from './p-TpI9gSdV.js';
import { d as defineCustomElement$a } from './p-pDYyfeah.js';
import { d as defineCustomElement$9 } from './p-BvmILoSj.js';
import { d as defineCustomElement$8 } from './p-HUz6dofu.js';
import { d as defineCustomElement$7 } from './p-KAzlYmFu.js';
import { d as defineCustomElement$6 } from './p-ZmctHVye.js';
import { d as defineCustomElement$5 } from './p-9kDQ_DVx.js';
import { d as defineCustomElement$4 } from './p-CEpHnzv6.js';
import { d as defineCustomElement$3 } from './p-Ba0BZ-cX.js';
...
const AtSearchTable$1 = /*@__PURE__*/ proxyCustomElement(class AtSearchTable extends H {
    ...
    render() {
        return (h(Host, { key: '488add810f84e0e169b5bd13708e2a4c6f31a272' }, h("at-table-actions", { key: 'b916e35f9d32cb45fb911be628fa5255ddf47878', ag_grid: this.agGrid }, h("div", { key: 'a0d6e13cada464261701fdead7b16f357f6b1677', class: "flex items-center gap-8", slot: "search" }, this.shouldShowDropdownFilters && (h("at-table-filter-menu", { key: '5a596a1761a8b892a5351a2bf49fe97bc16dac30', slot: "filter-menu", col_defs: this.col_defs, selected: this.menuSelectedIds, onAtChange: (event) => this.handleFilterChange(event) })), h("at-search", { key: 'e0cb0e2cd5c1ecd3c7484bac87083f5903fef16f', class: "w-input-md", label: this.search_label, hint_text: this.search_hint, info_text: this.search_info_tooltip, placeholder: this.translations.ATUI.TABLE.SEARCH_BY_KEYWORD, onAtChange: (event) => this.handleSearchChange(event) })), this.shouldShowDropdownFilters && (h("at-table-filters", { key: '4be83e7444d6e117fc93331d6b60ba653616ceb9', slot: "filters", col_defs: this.col_defs, selected: this.selectedFilters, onAtChange: (event) => this.handleFilterChange(event) })), !this.hide_export_menu && (h("at-table-export-menu", { key: '2f2e038ce32826a9ab222bb51a4f59c493bd8825', slot: "export-menu" })), this.shouldShowColumnManager && (h("at-column-manager", { key: '9b70da6564340102b3d5acbdbc71db553a72cfd2', slot: "column-manager", col_defs: this.col_defs, onAtChange: (event) => this.handleColumnChange(event) })), h("div", { key: '84f6f3049c053eb020b371edce5bbe503444ecd3', slot: "actions" }, h("slot", { key: '1696a21623d47d809392e1d7cf1707f83b109aeb', name: "actions" }))), h("slot", { key: 'bfbd53cad949977cbe86cbb9037025449eee5840', name: "multi-select-actions" }), h("at-table", { key: 'd0fde061696926578f4d91273fe16df97fa24534', ref: (el) => (this.tableEl = el), table_data: this.table_data, col_defs: this.col_defs, page_size: this.page_size, use_custom_pagination: this.use_custom_pagination, disable_auto_init: true, auto_size_columns: this.auto_size_columns })));
    }
    get el() { return this; }
