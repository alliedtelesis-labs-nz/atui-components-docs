...
import { d as defineCustomElement$f } from './p-D7s1p1gh.js';
import { d as defineCustomElement$e } from './p-CmoMXXJR.js';
import { d as defineCustomElement$d } from './p-C267TtKm.js';
import { d as defineCustomElement$c } from './p-DsrYZctu.js';
import { d as defineCustomElement$b } from './p-bn76tgB4.js';
import { d as defineCustomElement$a } from './p-DHT6iuTT.js';
import { d as defineCustomElement$9 } from './p-Bze1hNPA.js';
import { d as defineCustomElement$8 } from './p-Do3rqfsy.js';
import { d as defineCustomElement$7 } from './p-7E3v3HtE.js';
import { d as defineCustomElement$6 } from './p-BEJag_Jh.js';
import { d as defineCustomElement$5 } from './p-ClXhKI0W.js';
import { d as defineCustomElement$4 } from './p-B-4P7C4s.js';
import { d as defineCustomElement$3 } from './p-DmWzl3dA.js';
...
const AtSearchTable$1 = /*@__PURE__*/ proxyCustomElement(class AtSearchTable extends H {
    ...
    render() {
        return (h(Host, { key: 'f737bcd96c0c29e07379dd091615c5bad2720d4d' }, h("at-table-actions", { key: '3341246e73f158602248ac43a9392235ec35f98f', ag_grid: this.agGrid }, h("div", { key: '433e6dfda6134a86a4b2ed3880c153cc5bd579cb', class: "flex items-center gap-8", slot: "search" }, this.shouldShowDropdownFilters && (h("at-table-filter-menu", { key: '5cf32cf27b106d815fe1c448d9534f72de970862', slot: "filter-menu", col_defs: this.col_defs, selected: this.menuSelectedIds, onAtChange: (event) => this.handleFilterChange(event) })), h("at-search", { key: 'd168dda4dd58e04e2bd4699f3be2982ac792ec92', class: "w-input-md", label: this.search_label, hint_text: this.search_hint, info_text: this.search_info_tooltip, placeholder: this.translations.ATUI.TABLE.SEARCH_BY_KEYWORD, onAtChange: (event) => this.handleSearchChange(event) })), this.shouldShowDropdownFilters && (h("at-table-filters", { key: '0606897b0a540361f72840e97abe05678ca42563', slot: "filters", col_defs: this.col_defs, selected: this.selectedFilters, onAtChange: (event) => this.handleFilterChange(event) })), !this.hide_export_menu && (h("at-table-export-menu", { key: 'e28cbe39bb50464b39dcb149909a2cccc1e50cbc', slot: "export-menu" })), this.shouldShowColumnManager && (h("at-column-manager", { key: '5cbff32d9caea5ac6f1a921e40821f8c0c8a060d', slot: "column-manager", col_defs: this.col_defs, onAtChange: (event) => this.handleColumnChange(event) })), h("div", { key: 'e1f5c003d4b812e28850516cb71201bb7f9e3f07', slot: "actions" }, h("slot", { key: 'd3389697bb3396f7264f06a42a2ca5de679ba8de', name: "actions" }))), h("slot", { key: '7bc1a0a4a0900bbae6c86c60bc74837843e48171', name: "multi-select-actions" }), h("at-table", { key: 'e06745149b2e9790db085d0e0f3f5f0a23b6a41e', ref: (el) => (this.tableEl = el), table_data: this.table_data, col_defs: this.col_defs, page_size: this.page_size, use_custom_pagination: this.use_custom_pagination, disable_auto_init: true, auto_size_columns: this.auto_size_columns })));
    }
