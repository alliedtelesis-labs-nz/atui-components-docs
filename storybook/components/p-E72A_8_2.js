...
import { d as defineCustomElement$1 } from './p-VhBaVrJ8.js';
...
const AtCheckboxHeaderComponent = /*@__PURE__*/ proxyCustomElement(class AtCheckboxHeaderComponent extends H {
    ...
    render() {
        return (h("at-checkbox", { key: '6732211f2a6a1cbfebf8fbbab7a5c249e43e2a48', disabled: this.disabled, value: this.isChecked, onAtuiChange: (event) => this.setRowsValue(event.detail) }));
    }
...
//# sourceMappingURL=p-E72A_8_2.js.map
