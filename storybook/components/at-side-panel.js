...
const AtSidePanelComponent = /*@__PURE__*/ proxyCustomElement(class AtSidePanelComponent extends H {
    ...
    render() {
        return (h(Host, { key: 'bef4c52400cde533e581baca57dd46b489c150e6', "data-open": this.isOpen }, h("dialog", { key: 'ff8bc19a28533382f4f040a94dd65ba6414c66c2', ref: (el) => (this.panelDialog = el), class: `${this.backdrop ? 'backdrop' : ''}`, onClose: this.handleDialogClose, onKeyDown: this.handleKeyDown }, h("div", { key: 'c2fc68acb5f8c5f570e6e454ea54f54b58d09411', "data-scrollable": this.has_scrollbar, "data-open": this.isOpen, class: `container origin-${this.origin} size-${this.size} size-${this.size} position-${this.position}`, ref: (el) => (this.sidePanelWrapper = el), "data-name": "container" }, h("header", { key: 'ea248aa507584eba410476a6b463bc3d51d7f5d6', class: "header", "data-name": "header" }, h("div", { key: '614c315d1c6c832b4d56c63f248c63bc1e690639' }, this.panel_title && (h("h3", { key: 'd6651aa875eb61e353901452583878b415304633', class: "title" }, this.panel_title)), this.panel_subtitle && (h("p", { key: '8baeaa88f3df2b99350ed14cfa83522d92e4c965', class: "subtitle" }, this.panel_subtitle))), this.has_close_button && (h("at-button", { key: '23ff26e5fc0abe446158d9e29012ea2cbdb7bfd2', size: "md", icon: "close", type: "secondaryText", "data-name": "panel-close", onClick: this.handleClose }))), h("div", { key: '37a3a694e91ae6a486ad0b53d774054e137d5322', "data-name": "content", class: "content" }, h("slot", { key: 'bc70fb716fcae73c8a7577250e6b8d30017ded51' }))))));
    }
