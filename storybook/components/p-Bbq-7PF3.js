...
import { d as defineCustomElement$2, P as PromptResponseScore } from './p-aZTupYly.js';
...
const AtPromptThread = /*@__PURE__*/ proxyCustomElement(class AtPromptThread extends H {
    ...
    render() {
        ...
        return (h(Host, { key: 'bb48376a909ae4c3521ce254ed14a563e801d6e1', class: "block h-full", "data-name": "thread-container" }, h("div", { key: '96f259a2b2fef15b56efd748023a6c9bc6424e57', class: "flex h-full flex-col gap-16 overflow-y-auto scroll-smooth", ref: (el) => (this.scrollContainer = el), "data-name": "scroll-container" }, !hasMessages ? (h("slot", { name: "thread-empty-state" })) : (h("div", { "data-name": "thread-messages-container", class: "flex flex-col gap-16" }, this.renderMessages(), this.renderLoadingIndicator())), h("slot", { key: 'f4558c66990b21d64f518ca8595c9a8d25833fde', name: "thread-messages" }))));
    }
...
//# sourceMappingURL=p-Bbq-7PF3.js.map
