...
const AtSidebarComponent = /*@__PURE__*/ proxyCustomElement(class AtSidebarComponent extends H {
    ...
    render() {
        ...
        return (h(Host, { key: 'f52dce86dc6463e0fcd25ba0d87016d19be06ab7', "data-state": this.isOpen ? 'expanded' : 'collapsed', class: `mode-${this.mode} side-${this.side} collapse-${this.collapsible}` }, isModalOverlay && (h("div", { key: 'be559123446b6d5af8a2e338f07eec6ed2373750', class: "at-sidebar__backdrop", onClick: this.handleBackdropClick, "aria-hidden": "true" })), h("nav", { key: 'd743330e816eae1b5d219f8426216d06b5cb225d', "data-name": "sidebar-nav", "aria-expanded": this.isOpen ? 'true' : 'false', "aria-hidden": !this.isOpen && this.collapsible === 'offcanvas'
                ? 'true'
                : 'false', part: "nav", class: `at-sidebar__nav collapse-${this.collapsible}` }, h("slot", { key: 'd61353a4a1292fd2e3660d22bdf673dd5f1ee71c', name: "at-sidebar__header" }), h("div", { key: '2c0d4f36bdeeabdecf8d00f5ca7ebd89ffcd8d92', class: "at-sidebar__nav-content" }, h("slot", { key: '0971a19b02d42ebb079a5c3ebb7a8fc8de4375b6', name: "sidebar-content" })), h("div", { key: 'ca0850a81e7208e977aa3dc70d4a9ae7f48ef4b9', class: `${this.isOpen ? '' : 'hidden'}` }, h("slot", { key: '4045243fed0ead7e7fe7ce3bf9eae5029951d0e6', name: "sidebar-footer" }))), h("div", { key: '87bb83b3f444f866f3fed8c6c2d74fdb5ce7a183', class: "at-sidebar__content", "aria-hidden": isModalOverlay ? 'true' : 'false', inert: isModalOverlay }, h("slot", { key: 'fdae6e420f953a01e9b83ec1993d0f120942e639', name: "page-content" }))));
    }
