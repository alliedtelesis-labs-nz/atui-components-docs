...
const AtTab = /*@__PURE__*/ proxyCustomElement(class AtTab extends H {
    ...
    render() {
        ...
        return (h(Host, { key: 'e760375555e9b1489a09add49358652cef412e53', role: "tab", "aria-selected": this.is_active, "data-active": this.is_active ? 'true' : 'false', onKeyDown: (event) => this.handleKeyDown(event), "data-name": `tab-${this.tab_id}` }, h("a", { key: '9c7474608a04a163a27c9f65158bffe61097d938', id: `tab-${this.tab_id}`, tabindex: "0", class: classname, ref: (el) => (this.tabEl = el) }, this.tab_title, h("slot", { key: 'daf8134c57550ae6f8d0d69b284de937d657c4cf' }))));
    }
}, [260, "at-tab", {
        "tab_id": [1],
        "tab_title": [1],
...
//# sourceMappingURL=p-EGDFAKk8.js.map
