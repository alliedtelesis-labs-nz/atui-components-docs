...
`,h={title:"Components/Dialog"},a=m.bind({});a.args={dialog_id:"dialog"};const d=u.bind({});d.args={dialog_id:"external-dialog",trigger_id:"external-trigger",trigger_label:"Open Dialog"};const t=b.bind({});t.storyName="Table Row Example";t.parameters={docs:{description:{story:"Example showing how to use external triggers in table rows with unique IDs to avoid collisions."}}};var i,o,l;a.parameters={...a.parameters,docs:{...(i=a.parameters)==null?void 0:i.docs,source:{originalSource:`args => \`
...
\``,...(l=(o=a.parameters)==null?void 0:o.docs)==null?void 0:l.source}}};var r,n,s;d.parameters={...d.parameters,docs:{...(r=d.parameters)==null?void 0:r.docs,source:{originalSource:`args => \`
...
\``,...(s=(n=d.parameters)==null?void 0:n.docs)==null?void 0:s.source}}};var g,p,c;t.parameters={...t.parameters,docs:{...(g=t.parameters)==null?void 0:g.docs,source:{originalSource:`() => \`
<table style="width: 100%; border-collapse: collapse;">
    <thead>
        <tr>
            <th style="border: 1px solid #ddd; padding: 8px;">User</th>
...
\``,...(c=(p=t.parameters)==null?void 0:p.docs)==null?void 0:c.source}}};const x=["Default","ExternalTrigger","TableRowExample"];export{a as Default,d as ExternalTrigger,t as TableRowExample,x as __namedExportsOrder,h as default};
