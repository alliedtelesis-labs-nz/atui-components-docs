import{j as e,M as a}from"./index-Ewr_tigM.js";import{useMDXComponents as s}from"./index-B5yGpw6w.js";import{ar as o}from"./MermaidMarkdown-Be18Zlzl.js";import"./iframe-CX7qtR2j.js";import"./index-DGnb9v-d.js";import"./index-DrFu-skq.js";const r=`# atui-side-panel
...
| \`icon\`      | \`icon\`      | Icon or svg to be displayed with the label                | \`string\`  | \`undefined\` |
...
| Slot                                                                            | Description |
| ------------------------------------------------------------------------------- | ----------- |
| \`"icon: svg image displayed as the icon at the left of the menu item."\`         |             |
...
`,e.jsx(o,{md:r})]})}function c(n={}){const{wrapper:t}={...s(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(i,{...n})}):i()}export{c as default};
