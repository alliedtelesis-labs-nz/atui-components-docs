...
<\/script>
`,r={title:"Components/Table Components/Cell Components/Menu Cell"},e=n.bind({});e.args={col_defs:[{flex:1,field:"col_one",colId:"col_one",sortable:!1,headerName:"Menu Cell",cellRenderer:"***AtMenuCell***",cellRendererParams:{actions:[{title:"Action one",onTrigger:"***(params) => alert('action one clicked')***"},{title:"Action two",onTrigger:"***(params) => alert('Action two clicked')***"},{title:"Action three",getDisabled:"***(data) => true***",disabledTooltip:"disabled tooltip"}]}},{flex:1,field:"col_two",colId:"col_two",sortable:!1,headerName:"Popover Scroll Cell",cellRenderer:"***AtMenuCell***",cellRendererParams:{icon:"keyboard_arrow_down",actions:["Action one","Action two","Action three","Action four","Action five","Action six"]}}],table_data:{items:[{_id:"1",col_one:"",col_two:"Label"}],total:1},page_size:10};var l,o,a;e.parameters={...e.parameters,docs:{...(l=e.parameters)==null?void 0:l.docs,source:{originalSource:`args => \`
...
document.querySelector('at-table').createGrid()
<\/script>
\``,...(a=(o=e.parameters)==null?void 0:o.docs)==null?void 0:a.source}}};const c=["Default"];export{e as Default,c as __namedExportsOrder,r as default};
