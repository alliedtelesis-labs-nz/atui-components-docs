...
<at-prompt-input
    ...
    max_rows="${e.max_rows??4}"
    max_length="${e.max_length??2e3}"
    ${e.disabled?"disabled":""}
    ${e.readonly?"readonly":""}
    ${e.required?"required":""}
    ${e.invalid?"invalid":""}
...
></at-prompt-input>
\``,...(p=(g=a.parameters)==null?void 0:g.docs)==null?void 0:p.source}}};var m,_,c;t.parameters={...t.parameters,docs:{...(m=t.parameters)==null?void 0:m.docs,source:{originalSource:`args => \`
<at-prompt-input
    label="\${args.label ?? ''}"
    placeholder="\${args.placeholder ?? ''}"
    value="\${args.value ?? ''}"
    ...
    \${args.in_progress ? 'in_progress' : ''}
></at-prompt-input>
\``,...(c=(_=t.parameters)==null?void 0:_.docs)==null?void 0:c.source}}};var x,$,u;s.parameters={...s.parameters,docs:{...(x=s.parameters)==null?void 0:x.docs,source:{originalSource:`args => \`
<at-prompt-input
    label="\${args.label ?? ''}"
    placeholder="\${args.placeholder ?? ''}"
    value="\${args.value ?? ''}"
    ...
    \${args.in_progress ? 'in_progress' : ''}
></at-prompt-input>
\``,...(u=($=s.parameters)==null?void 0:$.docs)==null?void 0:u.source}}};var h,b,v;o.parameters={...o.parameters,docs:{...(h=o.parameters)==null?void 0:h.docs,source:{originalSource:`args => \`
<at-prompt-input
    label="\${args.label ?? ''}"
    placeholder="\${args.placeholder ?? ''}"
    value="\${args.value ?? ''}"
    ...
    \${args.in_progress ? 'in_progress' : ''}
></at-prompt-input>
\``,...(v=(b=o.parameters)==null?void 0:b.docs)==null?void 0:v.source}}};var w,y,f;i.parameters={...i.parameters,docs:{...(w=i.parameters)==null?void 0:w.docs,source:{originalSource:`args => \`
<at-prompt-input
    label="\${args.label ?? ''}"
    placeholder="\${args.placeholder ?? ''}"
    value="\${args.value ?? ''}"
    ...
    \${args.in_progress ? 'in_progress' : ''}
></at-prompt-input>
\``,...(f=(y=i.parameters)==null?void 0:y.docs)==null?void 0:f.source}}};var q,E,M;l.parameters={...l.parameters,docs:{...(q=l.parameters)==null?void 0:q.docs,source:{originalSource:`args => \`
<at-prompt-input
    label="\${args.label ?? ''}"
    placeholder="\${args.placeholder ?? ''}"
    value="\${args.value ?? ''}"
