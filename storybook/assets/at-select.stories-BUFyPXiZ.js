...
<\/script>
    \``,...(o=(l=r.parameters)==null?void 0:l.docs)==null?void 0:o.source}}};var n,s,d;t.parameters={...t.parameters,docs:{...(n=t.parameters)==null?void 0:n.docs,source:{originalSource:`args => \`
<at-select
    label="\${args.label ?? ''}"
    hint_text="\${args.hint_text ?? ''}"
    info_text="\${args.info_text ?? ''}"
...
document.querySelector('at-select').options = \${JSON.stringify(args.options, null, 4)};
<\/script>
    \``,...(d=(s=t.parameters)==null?void 0:s.docs)==null?void 0:d.source}}};const p=["Primary","Grouped"];export{t as Grouped,r as Primary,p as __namedExportsOrder,u as default};
