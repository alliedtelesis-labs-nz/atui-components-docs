import{j as t,M as i}from"./index-DfdVn7m7.js";import{useMDXComponents as o}from"./index-JBqQvZux.js";import{ar as r}from"./MermaidMarkdown-81CQ_Jqz.js";import"./iframe-Cc5cuJde.js";import"./index-DGnb9v-d.js";import"./index-DrFu-skq.js";const m=`# atui-time-range
...
| \`selected_time_range\`  | --                     | Selected time range.                                                                                                              | \`AtISelectedTimeRange \\| { selected: TimeRangeDisplay.ALL; custom?: undefined; }\` | \`{         selected: {             unit: TimeUnit.HOURS,             value: 1,         },     }\` |
...
| ------------ | ----------------------------------------------------------------- | ---------------------------------------------------------------------------------------------- |
| \`atuiChange\` | Emits an event containing the selected time range when it changes | \`CustomEvent<AtISelectedTimeRange \\| { selected: TimeRangeDisplay.ALL; custom?: undefined; }>\` |
