import{j as t,M as o}from"./index-CKkCopoY.js";import{useMDXComponents as l}from"./index-CCSEzhPK.js";import{at as i}from"./MermaidMarkdown-BpPevDjf.js";import"./iframe-K9Wp_FDQ.js";import"./index-DGnb9v-d.js";import"./index-DrFu-skq.js";const r=`# at-button
...
| Slot           | Description                                                                                                                                                                              |
| -------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
|                | Placed after the label, but before the icon_after. Can be used as a replacement for the label prop. Raw text should be wrapped in a \`<span>\` so CSS icon-only detection works correctly. |
| \`"icon"\`       | Carbon icon placed before the label                                                                                                                                                      |
| \`"icon_after"\` | Carbon icon placed after the label                                                                                                                                                       |
...
graph TD;
  ...
  at-search --> at-button
  at-search-table --> at-button
  at-select --> at-button
  at-side-panel --> at-button
  at-stepper --> at-button
...
`;function a(n){return t.jsxs(t.Fragment,{children:[t.jsx(o,{title:"Components/Button"}),`
`,t.jsx(i,{md:r})]})}function d(n={}){const{wrapper:e}={...l(),...n.components};return e?t.jsx(e,{...n,children:t.jsx(a,{...n})}):a()}export{d as default};
