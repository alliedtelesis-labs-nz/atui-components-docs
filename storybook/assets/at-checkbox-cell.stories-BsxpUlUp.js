...
<\/script>
`,c={title:"Components/Table Components/Cell Components/Checkbox Cell"},e=n.bind({});e.args={col_defs:[{flex:1,colId:"col_one",field:"col_one",sortable:!1,headerName:"Checkbox Cell",cellRenderer:"AtCheckboxCell",headerComponent:"checkboxHeader",cellRendererParams:{checked:"***(data) => data.col_one***"}}],table_data:{items:[{_id:"1",col_one:!1},{_id:"2",col_one:!0}],total:1},page_size:10};var a,o,l;e.parameters={...e.parameters,docs:{...(a=e.parameters)==null?void 0:a.docs,source:{originalSource:`args => \`
...
document.querySelector('at-table').createGrid()
<\/script>
\``,...(l=(o=e.parameters)==null?void 0:o.docs)==null?void 0:l.source}}};const r=["Default"];export{e as Default,r as __namedExportsOrder,c as default};
