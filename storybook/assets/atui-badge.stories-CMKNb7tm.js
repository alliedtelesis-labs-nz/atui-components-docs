...
/>\``,...(l=(u=r.parameters)==null?void 0:u.docs)==null?void 0:l.source}}};var i,g,p;o.parameters={...o.parameters,docs:{...(i=o.parameters)==null?void 0:i.docs,source:{originalSource:`args => \`
<atui-badge 
    \${args.count ? \`count="\${args.count}"\` : ''}
    icon="\${args.icon ?? ''}"
    label="\${args.label ?? ''}"
    ...
    impact="\${args.impact ?? 'low'}"
    type="\${args.type ?? 'default'}"
/>\``,...(p=(g=o.parameters)==null?void 0:g.docs)==null?void 0:p.source}}};var m,$,b;n.parameters={...n.parameters,docs:{...(m=n.parameters)==null?void 0:m.docs,source:{originalSource:`args => \`
<atui-badge 
    \${args.count ? \`count="\${args.count}"\` : ''}
    icon="\${args.icon ?? ''}"
    label="\${args.label ?? ''}"
