import{j as e,M as a}from"./index-nfsT75sJ.js";import{useMDXComponents as o}from"./index-CzD549k1.js";import{at as r}from"./MermaidMarkdown-p_ZvjsOn.js";import"./iframe-DlA6nhXN.js";import"./index-DGnb9v-d.js";import"./index-DrFu-skq.js";const s=`# at-sidebar-submenu
...
| Slot                      | Description                                                                                         |
| ------------------------- | --------------------------------------------------------------------------------------------------- |
| \`"icon"\`                  | Icon content to be shown in both expanded and collapsed menu items. Usually an \`<at-icon>\` element. |
...
`,e.jsx(r,{md:s})]})}function p(n={}){const{wrapper:t}={...o(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(i,{...n})}):i()}export{p as default};
