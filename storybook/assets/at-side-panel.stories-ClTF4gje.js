...
`,m={title:"Components/Side Panel",argTypes:{size:{options:["xs","sm","md","lg","xl"],control:{type:"radio"}},origin:{options:["left","right"],control:{type:"radio"}}}},i=b.bind({});i.args={panel_id:"panel",panel_title:"Panel title",panel_subtitle:"Panel subtitle",origin:"right",size:"xs",hide_scrollbar:!1,click_out_to_close:!1,show_close_button:!0};const n=_.bind({});n.args={panel_id:"external-panel",trigger_id:"external-panel-trigger",trigger_label:"Open Side Panel",panel_title:"External Trigger Panel",panel_subtitle:"Opened via external trigger",origin:"right",size:"md"};const t=u.bind({});t.storyName="Table Row Example";t.parameters={docs:{description:{story:"Example showing how to use external triggers in table rows with unique IDs to avoid collisions."}}};var a,d,l;i.parameters={...i.parameters,docs:{...(a=i.parameters)==null?void 0:a.docs,source:{originalSource:`args => \`
<at-side-panel 
