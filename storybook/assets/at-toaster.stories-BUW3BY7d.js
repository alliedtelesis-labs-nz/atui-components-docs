var d=Object.defineProperty;var b=(t,o,e)=>o in t?d(t,o,{enumerable:!0,configurable:!0,writable:!0,value:e}):t[o]=e;var n=(t,o,e)=>b(t,typeof o!="symbol"?o+"":o,e);const g={position:"bottom-right",timeout:5e3,dismissible:!0,closeButton:!1};class a{static async show(o,e,i={}){const p=this.id++,r={...g,...i},m={id:p,type:o,message:e,...r};this.getToaster(r.position).addToast(m)}static getToaster(o){if(this.containers.has(o))return this.containers.get(o);const e=document.createElement("at-toaster");e.setAttribute("position",o),document.body.appendChild(e);const i=e;return this.containers.set(o,i),i}}n(a,"id",0),n(a,"containers",new Map);typeof window<"u"&&(window.ToasterService=a);const $={title:"Components/Toaster",argTypes:{position:{options:["top-left","top-center","top-right","bottom-left","bottom-center","bottom-right"],control:{type:"select"}},type:{options:["success","error","info","warning","default"],control:{type:"select"}},message:{control:"text"},title:{control:"text"},timeout:{control:"number"},dismissible:{control:"boolean"},closeButton:{control:"boolean"}}},y=t=>`
  ...
  <script>
    document.querySelector("at-button").onclick = () => {
      ToasterUtil.show("${t.type}", "${t.message}", {
        title: "${t.title}",
        position: "${t.position}",
        timeout: ${t.timeout},
