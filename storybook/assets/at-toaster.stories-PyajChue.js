var P=Object.defineProperty;var F=(t,e,o)=>e in t?P(t,e,{enumerable:!0,configurable:!0,writable:!0,value:o}):t[e]=o;var m=(t,e,o)=>F(t,typeof e!="symbol"?e+"":e,o);const I={position:"bottom-right",timeout:5e3,dismissible:!0,closeButton:!1};class u{static async show(e,o,l={}){const a=this.id++,s={...I,...l},_={id:a,type:e,message:o,...s},p=await this.getToaster(s.position);return await p.addToast(_),{id:a,dismiss:()=>p.removeToast(a)}}static async getToaster(e){if(this.containers.has(e)){const s=this.containers.get(e);if(s&&document.body.contains(s))return s;this.containers.delete(e)}const o=document.createElement("at-toaster");o.setAttribute("position",e),document.body.appendChild(o),await customElements.whenDefined("at-toaster");const l=o;typeof l.componentOnReady=="function"&&await l.componentOnReady();const a=o;return this.containers.set(e,a),a}}m(u,"id",0),m(u,"containers",new Map);typeof window<"u"&&(window.ToasterService=u);const N={title:"Components/Toaster",argTypes:{position:{options:["top-left","top-center","top-right","bottom-left","bottom-center","bottom-right"],control:{type:"select"}},type:{options:["success","error","info","warning","default"],control:{type:"select"}},message:{control:"text"},title:{control:"text"},timeout:{control:"number"},dismissible:{control:"boolean"},closeButton:{control:"boolean"}}},L=t=>`
  ...
  <\/script>
`,d=L.bind({});d.args={position:"bottom-right",type:"success",title:"Success!",message:"Operation completed successfully",timeout:5e3,dismissible:!0,closeButton:!1};const n=()=>`
...
`,c=()=>`
  ...
  <\/script>
`;var h,y,b;d.parameters={...d.parameters,docs:{...(h=d.parameters)==null?void 0:h.docs,source:{originalSource:`args => \`
  ...
  <\/script>
\``,...(b=(y=d.parameters)==null?void 0:y.docs)==null?void 0:b.source}}};var w,g,f,v,S;n.parameters={...n.parameters,docs:{...(w=n.parameters)==null?void 0:w.docs,source:{originalSource:`() => \`
  <at-button data-name="remove" label="Remove Widget" type="destructive"></at-button>
  <p data-name="state">Widget is on the dashboard</p>
  <script>
    const state = document.querySelector('[data-name="state"]');
...
\``,...($=(k=r.parameters)==null?void 0:k.docs)==null?void 0:$.source},description:{story:"A toast for a condition rather than an event: `timeout: 0` so it never\nexpires on its own, and the handle `show` returns is what takes it down when\nthe condition clears. Dismissing twice, or after the toast has been tapped\naway, does nothing.",...(O=(q=r.parameters)==null?void 0:q.docs)==null?void 0:O.description}}};var W,B,x,C,A;i.parameters={...i.parameters,docs:{...(W=i.parameters)==null?void 0:W.docs,source:{originalSource:`() => \`
  ...
  <\/script>
\``,...(x=(B=i.parameters)==null?void 0:B.docs)==null?void 0:x.source},description:{story:`Every dismissible toast with a timeout carries a countdown bar. Hover it, or
...
so the pause is easy to see by hand.`,...(A=(C=i.parameters)==null?void 0:C.docs)==null?void 0:A.description}}};var E,R,U,D,H;c.parameters={...c.parameters,docs:{...(E=c.parameters)==null?void 0:E.docs,source:{originalSource:`() => \`
  <at-button data-name="show" label="Show every type" type="primary"></at-button>
  <script>
    document.querySelector('[data-name="show"]').onclick = () => {
      ["default", "info", "success", "warning", "error"].forEach((type) =>
...
chrome bolted underneath it. Raises all five at once to compare.`,...(H=(D=c.parameters)==null?void 0:D.docs)==null?void 0:H.description}}};const j=["Default","WithUndoAction","DismissedByHandle","PausesOnHover","CountdownByType"];export{c as CountdownByType,d as Default,r as DismissedByHandle,i as PausesOnHover,n as WithUndoAction,j as __namedExportsOrder,N as default};
