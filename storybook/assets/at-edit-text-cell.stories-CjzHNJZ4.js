...
<\/script>
`,r={title:"Components/Table Components/Cell Components/Edit Text Cell"},e=n.bind({});e.args={col_defs:[{flex:1,field:"col_one",colId:"col_one",sortable:!1,headerName:"Edit Text Cell",valueGetter:"***(params) => params.data['col_one']***",cellRenderer:"***AtEditTextCell***",cellRendererParams:{onValueChange:"***(params) => console.log(params.value)***",writePermission:!0}}],table_data:{items:[{_id:"1",col_one:"You can change this!"}],total:1},page_size:10};var a,l,o;e.parameters={...e.parameters,docs:{...(a=e.parameters)==null?void 0:a.docs,source:{originalSource:`args => \`
