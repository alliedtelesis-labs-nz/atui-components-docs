...
<at-input-range
    ...
    ${e.disabled?"disabled":""}
/>
`,r={title:"Components/Input Range"},a=i.bind({});a.args={label:"Label",info_text:"Info text",error_text:"Error text",hint_text:"Hint text",warning_text:"Warning text",suffix:"%",value:50,max_display_value:100,max_selectable_value:100,min_selectable_value:0,tick_interval:0,required:!0,readonly:!1,disabled:!1,invalid:!1};var t,l,n;a.parameters={...a.parameters,docs:{...(t=a.parameters)==null?void 0:t.docs,source:{originalSource:`args => \`
<at-input-range
    label="\${args.label ?? ''}"
