const c=a=>`
<at-search-table page_size=${a.page_size??10} />
<script>
document.querySelector('at-search-table').table_data = ${JSON.stringify(a.table_data,null,4)}
document.querySelector('at-search-table').col_defs = ${JSON.stringify(a.col_defs,null,4)}
<\/script>
