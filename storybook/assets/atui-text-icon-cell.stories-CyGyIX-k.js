...
document.querySelector('atui-table')
    .createGrid()
<\/script>
`,i={title:"Components/Table Components/Cell Components/Text Icon Cell"},e=n.bind({});e.args={col_defs:[{flex:1,field:"col_two",colId:"col_two",sortable:!1,cellRenderer:"***AtuiTextIconCell***",headerName:"Text with Icon Cell",valueGetter:"***(params) => { return { text: { textValue: params.data['col_one'] }, icons: [{ iconName: 'search', iconClass: 'text-success-foreground' }, { iconName: 'warning', iconClass: 'text-destructive-foreground' }]}}***",cellRendererParams:{generateTooltip:'***(params) => "text with icon tooltip" ***'}}],table_data:{items:[{_id:"1",col_one:"Text"}],total:1},page_size:10};var a,l,o;e.parameters={...e.parameters,docs:{...(a=e.parameters)==null?void 0:a.docs,source:{originalSource:`args => \`
