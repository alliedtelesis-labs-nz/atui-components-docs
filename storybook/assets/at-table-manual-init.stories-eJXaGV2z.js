...
<\/script>
`,I={title:"Components/Table Components/Table/Manual Initialization",parameters:{docs:{description:{component:"Examples demonstrating manual table initialization using the can_auto_init prop. This provides precise control over when and how the at-table component is initialized, useful for complex scenarios requiring custom setup or external grid management."}}}},o={col_defs:[{flex:1,field:"product_name",colId:"product_name",headerName:"Product Name",sortable:!0},{flex:1,field:"category",colId:"category",headerName:"Category",sortable:!0},{flex:1,field:"price",colId:"price",headerName:"Price",sortable:!0},{flex:1,field:"stock",colId:"stock",headerName:"Stock",sortable:!0}],table_data:{items:[{_id:"1",product_name:"Wireless Headphones",category:"Electronics",price:"$99.99",stock:"25"},{_id:"2",product_name:"Running Shoes",category:"Sports",price:"$129.99",stock:"15"},{_id:"3",product_name:"Coffee Mug",category:"Kitchen",price:"$12.99",stock:"100"},{_id:"4",product_name:"Notebook",category:"Office",price:"$8.99",stock:"50"},{_id:"5",product_name:"Smartphone Case",category:"Electronics",price:"$24.99",stock:"30"},{_id:"6",product_name:"Desk Lamp",category:"Office",price:"$45.99",stock:"12"},{_id:"7",product_name:"Water Bottle",category:"Sports",price:"$19.99",stock:"75"},{_id:"8",product_name:"Kitchen Scale",category:"Kitchen",price:"$35.99",stock:"8"}],total:8}},t={args:{...o,page_size:5},render:y,parameters:{docs:{description:{story:"Demonstrates manual table initialization where the user must click a button to initialize the table. This pattern is useful when you need to perform setup operations or wait for external dependencies before the table is created."}}}},a={args:{...o,page_size:5},render:x,parameters:{docs:{description:{story:"Shows a delayed initialization pattern where the table is automatically initialized after a countdown. This simulates scenarios where you might need to wait for external dependencies, API calls, or other asynchronous operations before initializing the table."}}}},n={args:{...o,page_size:5},render:_,parameters:{docs:{description:{story:"Demonstrates conditional initialization where table features are configured based on user preferences before initialization. This pattern is useful for customizable table implementations where different features like pagination and sorting can be enabled/disabled dynamically."}}}},i={args:{...o,page_size:5},render:z,parameters:{docs:{description:{story:"Shows how to use external grid API management where a grid is created independently and then attached to the table component. This pattern is useful for scenarios where multiple components need to share a grid instance or when the grid lifecycle is managed by a parent component."}}}};var r,s,l;t.parameters={...t.parameters,docs:{...(r=t.parameters)==null?void 0:r.docs,source:{originalSource:`{
  args: {
    ...sampleData,
    page_size: 5
  },
...
}`,...(l=(s=t.parameters)==null?void 0:s.docs)==null?void 0:l.source}}};var c,d,p;a.parameters={...a.parameters,docs:{...(c=a.parameters)==null?void 0:c.docs,source:{originalSource:`{
  args: {
    ...sampleData,
    page_size: 5
  },
...
}`,...(p=(d=a.parameters)==null?void 0:d.docs)==null?void 0:p.source}}};var u,m,g;n.parameters={...n.parameters,docs:{...(u=n.parameters)==null?void 0:u.docs,source:{originalSource:`{
  args: {
    ...sampleData,
    page_size: 5
  },
...
}`,...(g=(m=n.parameters)==null?void 0:m.docs)==null?void 0:g.source}}};var b,h,f;i.parameters={...i.parameters,docs:{...(b=i.parameters)==null?void 0:b.docs,source:{originalSource:`{
  args: {
    ...sampleData,
    page_size: 5
  },
...
}`,...(f=(h=i.parameters)==null?void 0:h.docs)==null?void 0:f.source}}};const w=["ManualInitialization","DelayedInitialization","ConditionalInitialization","ExternalGridApiManagement"];export{n as ConditionalInitialization,a as DelayedInitialization,i as ExternalGridApiManagement,t as ManualInitialization,w as __namedExportsOrder,I as default};
