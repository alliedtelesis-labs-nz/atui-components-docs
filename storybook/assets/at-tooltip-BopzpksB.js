import{j as t,M as l}from"./index-B1Q0xbv8.js";import{useMDXComponents as a}from"./index-BWiFu3Dh.js";import{at as i}from"./MermaidMarkdown-lqRWEInJ.js";import"./iframe-CBiHAvtU.js";import"./index-DGnb9v-d.js";import"./index-DrFu-skq.js";const r=`# at-tooltip
...
| \`delay\`      | \`delay\`      | Delay before showing and hiding the tooltip when interacting with the trigger element.                                                                        | \`number\`                                 | \`0\`         |
...
| \`trigger_id\` | \`trigger_id\` | Target an external element to use as the trigger. When provided, clicking an element with a matching data-tooltip attribute value will toggle the side panel. | \`string\`                                 | \`undefined\` |
...
### Used by
 ...
 - [at-relative-time](../at-relative-time)
...
graph TD;
  ...
  at-progress-bar-cell --> at-tooltip
  at-prompt-message --> at-tooltip
  at-relative-time --> at-tooltip
...
`,t.jsx(i,{md:r})]})}function u(e={}){const{wrapper:n}={...a(),...e.components};return n?t.jsx(n,{...e,children:t.jsx(o,{...e})}):o()}export{u as default};
