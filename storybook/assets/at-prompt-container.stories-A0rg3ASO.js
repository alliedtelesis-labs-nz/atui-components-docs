import{x as t}from"./lit-element-CzV6k0XT.js";const Y={title:"Components/Prompt/Container",component:"at-prompt-container",argTypes:{header_title:{control:"text",description:"Container title"},subtitle:{control:"text",description:"Container subtitle"},placeholder:{control:"text",description:"Input placeholder text"},loading:{control:"boolean",description:"Loading state"},disabled:{control:"boolean",description:"Disabled state"},max_height:{control:"text",description:"Maximum container height"},show_header:{control:"boolean",description:"Show header section"},show_clear_button:{control:"boolean",description:"Show clear messages button"},empty_state_title:{control:"text",description:"Empty state title"},empty_state_description:{control:"text",description:"Empty state description"},max_message_length:{control:"number",description:"Maximum message length"}}},n={args:{title:"AI Assistant",placeholder:"Type your message here...",show_header:!0,show_clear_button:!0,max_height:"600px"},render:e=>t`
    ...
    `},r={args:{placeholder:"Type your message here...",show_header:!1,show_clear_button:!0,max_height:"500px"},render:e=>t`
        <div style="width: 100%; max-width: 800px; margin: 0 auto;">
            <at-prompt-container
                .header_title=${e.header_title}
                .subtitle=${e.subtitle}
    ...
    `},i={args:{title:"Quick Chat",placeholder:"Ask a quick question...",show_header:!0,show_clear_button:!1,max_height:"400px",empty_state_title:"Quick Chat",empty_state_description:"Get fast answers to your questions"},render:e=>t`
  ...
  render: args => html\`
    ...
    \`
}`,...(x=(b=s.parameters)==null?void 0:b.docs)==null?void 0:x.source}}};var w,y,v;r.parameters={...r.parameters,docs:{...(w=r.parameters)==null?void 0:w.docs,source:{originalSource:`{
  args: {
    placeholder: 'Type your message here...',
    show_header: false,
    show_clear_button: true,
  ...
  render: args => html\`
    ...
    \`
}`,...(v=(y=r.parameters)==null?void 0:y.docs)==null?void 0:v.source}}};var A,S,f;i.parameters={...i.parameters,docs:{...(A=i.parameters)==null?void 0:A.docs,source:{originalSource:`{
  args: {
    title: 'Quick Chat',
  ...
  render: args => html\`
    ...
    \`
}`,...(f=(S=i.parameters)==null?void 0:S.docs)==null?void 0:f.source}}};var T,C,I;o.parameters={...o.parameters,docs:{...(T=o.parameters)==null?void 0:T.docs,source:{originalSource:`{
  args: {
    title: 'AI Assistant',
    placeholder: 'Type your message here...',
    loading: true,
