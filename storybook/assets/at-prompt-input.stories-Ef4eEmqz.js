import{x as r}from"./lit-element-CzV6k0XT.js";const C={title:"Components/Prompt/Input",component:"at-prompt-input",argTypes:{label:{control:"text",description:"Input label text"},placeholder:{control:"text",description:"Placeholder text"},value:{control:"text",description:"Input value"},min_rows:{control:"number",description:"Minimum number of rows to display"},max_rows:{control:"number",description:"Maximum number of rows to expand to"},disabled:{control:"boolean",description:"Disabled state"},readonly:{control:"boolean",description:"Read-only state"},required:{control:"boolean",description:"Required field"},invalid:{control:"boolean",description:"Invalid state"},hint_text:{control:"text",description:"Hint text below label"},error_text:{control:"text",description:"Error message text"},info_text:{control:"text",description:"Info tooltip text"},max_length:{control:"number",description:"Maximum character length"},in_progress:{control:"boolean",description:"Controls whether the component is in progress (shows stop button) or ready to send (shows send button)"}}},n={args:{placeholder:"Enter your message..."},render:e=>r`
    ...
    `},o={args:{label:"Message",placeholder:"Enter your message...",max_length:500,hint_text:"Maximum 500 characters"},render:e=>r`
        <at-prompt-input
            ...
            .in_progress=${e.in_progress}
        ></at-prompt-input>
    `},l={args:{label:"Message",placeholder:"Enter your message...",error_text:"This field is required",invalid:!0,required:!0},render:e=>r`
        <at-prompt-input
            .placeholder=${e.placeholder}
            .value=${e.value}
            .label=${e.label}
            ...
            .in_progress=${e.in_progress}
        ></at-prompt-input>
    `},i={args:{label:"Message",placeholder:"Enter your message...",disabled:!0,value:"This input is disabled"},render:e=>r`
        <at-prompt-input
            .placeholder=${e.placeholder}
            .value=${e.value}
            .label=${e.label}
  ...
  render: args => html\`
        ...
        ></at-prompt-input>
    \`
}`,...(_=(p=n.parameters)==null?void 0:p.docs)==null?void 0:_.source}}};var $,m,x;t.parameters={...t.parameters,docs:{...($=t.parameters)==null?void 0:$.docs,source:{originalSource:`{
  args: {
    label: 'Your Message',
  ...
  render: args => html\`
        ...
        ></at-prompt-input>
    \`
}`,...(x=(m=t.parameters)==null?void 0:m.docs)==null?void 0:x.source}}};var u,h,c;a.parameters={...a.parameters,docs:{...(u=a.parameters)==null?void 0:u.docs,source:{originalSource:`{
  args: {
  ...
  render: args => html\`
        ...
        ></at-prompt-input>
    \`
}`,...(v=(b=o.parameters)==null?void 0:b.docs)==null?void 0:v.source}}};var w,y,f;l.parameters={...l.parameters,docs:{...(w=l.parameters)==null?void 0:w.docs,source:{originalSource:`{
  args: {
    label: 'Message',
    placeholder: 'Enter your message...',
  ...
  render: args => html\`
        ...
        ></at-prompt-input>
    \`
}`,...(f=(y=l.parameters)==null?void 0:y.docs)==null?void 0:f.source}}};var q,M,E;i.parameters={...i.parameters,docs:{...(q=i.parameters)==null?void 0:q.docs,source:{originalSource:`{
  args: {
    label: 'Message',
    placeholder: 'Enter your message...',
    disabled: true,
  ...
  render: args => html\`
        ...
        ></at-prompt-input>
    \`
}`,...(E=(M=i.parameters)==null?void 0:M.docs)==null?void 0:E.source}}};var T,I,D;s.parameters={...s.parameters,docs:{...(T=s.parameters)==null?void 0:T.docs,source:{originalSource:`{
  args: {
    label: 'Message',
  ...
  render: args => html\`
        ...
        ></at-prompt-input>
    \`
}`,...(D=(I=s.parameters)==null?void 0:I.docs)==null?void 0:D.source}}};const L=["Default","WithLabel","LargeTextarea","WithCharacterLimit","WithError","Disabled","InProgress"];export{n as Default,i as Disabled,s as InProgress,a as LargeTextarea,o as WithCharacterLimit,l as WithError,t as WithLabel,L as __namedExportsOrder,C as default};
