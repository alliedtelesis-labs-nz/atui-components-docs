...
`,c={title:"Components/Chart Breakdown"},t={args:{canvas_id:"1",height:"md",data:{labels:["One","Two","Three"],datasets:[{label:"My First Dataset",data:[300,50,100],hoverOffset:4,backgroundColor:["#7E57C2","#26A69A","#42A5F5"],hoverBackgroundColor:["#7E57C2","#26A69A","#42A5F5"],hoverBorderColor:["#7E57C2","#26A69A","#42A5F5"]}]},options:{responsive:!0,maintainAspectRatio:!1},plugins:[]},render:l},n={args:{canvas_id:"1",height:"md",data:{labels:["One","Two","Three"],datasets:[{label:"My First Dataset",data:[300,50,100],hoverOffset:4,backgroundColor:["#7E57C2","#26A69A","#42A5F5"],hoverBackgroundColor:["#7E57C2","#26A69A","#42A5F5"],hoverBorderColor:["#7E57C2","#26A69A","#42A5F5"]}]},center_value:"450",center_text:"Devices",options:{responsive:!0,maintainAspectRatio:!1},plugins:[]},render:l};var o,a,r;t.parameters={...t.parameters,docs:{...(o=t.parameters)==null?void 0:o.docs,source:{originalSource:`{
  ...
  render: Template
}`,...(r=(a=t.parameters)==null?void 0:a.docs)==null?void 0:r.source}}};var s,i,d;n.parameters={...n.parameters,docs:{...(s=n.parameters)==null?void 0:s.docs,source:{originalSource:`{
  args: {
    canvas_id: '1',
    height: 'md',
    data: {
  ...
  render: Template
}`,...(d=(i=n.parameters)==null?void 0:i.docs)==null?void 0:d.source}}};const p=["Breakdown","CenterText"];export{t as Breakdown,n as CenterText,p as __namedExportsOrder,c as default};
