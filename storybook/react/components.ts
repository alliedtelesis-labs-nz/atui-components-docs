...
type AtTableFiltersEvents = {
    onAtChange: EventName<AtTableFiltersCustomEvent<AtIFilterGroup>>,
    onAtFilterClick: EventName<AtTableFiltersCustomEvent<AtIFilter>>
};
...
export const AtTableFilters: StencilReactComponent<AtTableFiltersElement, AtTableFiltersEvents> = /*@__PURE__*/ createComponent<AtTableFiltersElement, AtTableFiltersEvents>({
    ...
    events: {
        onAtChange: 'atChange',
        onAtFilterClick: 'atFilterClick'
    } as AtTableFiltersEvents,
