import { r as registerInstance, h, a as getElement, H as Host } from './index-vSlhROK9.js';
...
const AtTooltip = class {
    ...
    render() {
        return (h(Host, { key: 'bf73b4e3cb339c13c94f2486152c17ae0bc16f82', class: "relative" }, !this.trigger_id && (h("div", { key: '516be5c200af3ddfbed0df9c8f5a087fd7092ef9', "aria-haspopup": "true", "data-name": "tooltip-trigger", ref: (el) => (this.triggerEl = el), "aria-expanded": `${this.isOpen ? 'true' : 'false'}`, "aria-describedby": this.popoverId, class: this.disabled ? 'contents' : '', onMouseEnter: () => !this.disabled ? this.showHandler() : null, onMouseLeave: () => !this.disabled ? this.hideHandler() : null, onFocusin: () => !this.disabled ? this.showHandler() : null, onFocusout: () => !this.disabled ? this.hideHandler() : null }, h("slot", { key: '3b1951f398c0805b17980b6a678123fb2e5bff01', name: "tooltip-trigger" }))), h("div", { key: '7da536bbe58cf9407d526e6f868db0c8e3e09256', ref: (el) => (this.tooltipEl = el), "data-position": this.position, "data-align": this.align, popover: "auto", id: this.popoverId, class: "bg-surface-overlay/90 text-foreground-inv pointer-events-none w-fit rounded-md px-[6px] py-[2px] text-sm leading-tight break-words whitespace-normal opacity-0 shadow-md transition-opacity duration-200 ease-out", "data-name": "tooltip-content-wrapper" }, h("slot", { key: '3b640e80c01d3c3ee541720332f372307f5b72df' }))));
    }
