import { r as registerInstance, h, a as getElement, H as Host } from './index-_QbJz5mf.js';
...
const AtTooltip = class {
    ...
    render() {
        return (h(Host, { key: '73cd85c6627fe1a468b7585924b1c4c82cdc40e4', class: "relative" }, !this.trigger_id && (h("div", { key: '431c34a016599282afe46656067d090b851bc2e6', "aria-haspopup": "true", "data-name": "tooltip-trigger", ref: (el) => (this.triggerEl = el), "aria-expanded": `${this.isOpen ? 'true' : 'false'}`, "aria-describedby": this.popoverId, class: this.disabled ? 'contents' : '', onMouseEnter: () => !this.disabled ? this.showHandler() : null, onMouseLeave: () => !this.disabled ? this.hideHandler() : null, onFocusin: () => !this.disabled ? this.showHandler() : null, onFocusout: () => !this.disabled ? this.hideHandler() : null }, h("slot", { key: '7b8a1d51b3f7a731a8875f8e15d506c7e3d6c22a', name: "tooltip-trigger" }))), h("div", { key: 'ffd3657ba37c127bab49a74447adbbba315806e2', ref: (el) => (this.tooltipEl = el), "data-position": this.position, "data-align": this.align, popover: "auto", id: this.popoverId, class: "bg-surface-overlay/90 text-foreground-inv pointer-events-none w-fit rounded-md px-[6px] py-[2px] text-sm leading-tight break-words whitespace-normal opacity-0 shadow-md transition-opacity duration-200 ease-out", "data-name": "tooltip-content-wrapper" }, h("slot", { key: '4fc48aaf2c4127d3745748ff91efd19f2bb032e3' }))));
    }
