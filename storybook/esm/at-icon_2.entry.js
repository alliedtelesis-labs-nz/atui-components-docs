import { r as registerInstance, h, a as getElement, H as Host } from './index-lWb16Ay7.js';
...
const AtTooltip = class {
    ...
    render() {
        return (h(Host, { key: '1a42cfb205665f0380980db387e38d7b6a0ed500', class: "relative" }, !this.trigger_id && (h("div", { key: 'be41104ce445c97b184b7ce9f8cb1f3b429c959b', "aria-haspopup": "true", "data-name": "tooltip-trigger", ref: (el) => (this.triggerEl = el), "aria-expanded": `${this.isOpen ? 'true' : 'false'}`, "aria-describedby": this.popoverId, class: this.disabled ? 'contents' : '', onMouseEnter: () => !this.disabled ? this.showHandler() : null, onMouseLeave: () => !this.disabled ? this.hideHandler() : null, onFocusin: () => !this.disabled ? this.showHandler() : null, onFocusout: () => !this.disabled ? this.hideHandler() : null }, h("slot", { key: 'c3cb0c37aac784ffee043fa199d7fe7aed41944c', name: "tooltip-trigger" }))), h("div", { key: '12bbf9ed87adb1d15f2e2ab2248e6c1f70ca35d8', ref: (el) => (this.tooltipEl = el), "data-position": this.position, "data-align": this.align, popover: "auto", id: this.popoverId, class: "bg-surface-overlay/90 text-foreground-inv pointer-events-none w-fit rounded-md px-[6px] py-[2px] text-sm leading-tight break-words whitespace-normal opacity-0 shadow-md transition-opacity duration-200 ease-out", "data-name": "tooltip-content-wrapper" }, h("slot", { key: '6ed8aa85f0d5f4862a8b16e07c484e0041743bc4' }))));
    }
