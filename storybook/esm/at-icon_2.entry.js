import { r as registerInstance, h, a as getElement, H as Host } from './index-CGGSFxDu.js';
...
const AtTooltip = class {
    ...
    render() {
        return (h(Host, { key: 'dca4727523b10ddeeffd98394bbfba964a1e7478', class: "relative" }, !this.trigger_id && (h("div", { key: '062dbbd2400e3c9702b55341ef9d18558fb18c7e', "aria-haspopup": "true", "data-name": "tooltip-trigger", ref: (el) => (this.triggerEl = el), "aria-expanded": `${this.isOpen ? 'true' : 'false'}`, "aria-describedby": this.popoverId, class: this.disabled ? 'contents' : '', onMouseEnter: () => !this.disabled ? this.showHandler() : null, onMouseLeave: () => !this.disabled ? this.hideHandler() : null, onFocusin: () => !this.disabled ? this.showHandler() : null, onFocusout: () => !this.disabled ? this.hideHandler() : null }, h("slot", { key: 'b911927d882e233815ac5c6f93237fa04ee0ce9c', name: "tooltip-trigger" }))), h("div", { key: '4f25ff242dee29abe0ee1bfbf7371433c5c97366', ref: (el) => (this.tooltipEl = el), "data-position": this.position, "data-align": this.align, popover: "auto", id: this.popoverId, class: "bg-surface-overlay/90 text-foreground-inv pointer-events-none w-fit rounded-md px-[6px] py-[2px] text-sm leading-tight break-words whitespace-normal opacity-0 shadow-md transition-opacity duration-200 ease-out", "data-name": "tooltip-content-wrapper" }, h("slot", { key: 'd8e8db3a0add73cb96f6cd6513a75488bf1154b4' }))));
    }
