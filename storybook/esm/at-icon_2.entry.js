import { r as registerInstance, h, a as getElement, H as Host } from './index-m_dTEvgo.js';
...
const AtTooltip = class {
    ...
    render() {
        return (h(Host, { key: 'f4322853ee8012915d0d238f9523e9ba8e2ae3d6', class: "relative" }, !this.trigger_id && (h("div", { key: 'f50630664a10c61575d6db432b67d167ca04ff5e', "aria-haspopup": "true", "data-name": "tooltip-trigger", ref: (el) => (this.triggerEl = el), "aria-expanded": `${this.isOpen ? 'true' : 'false'}`, "aria-describedby": this.popoverId, class: this.disabled ? 'contents' : '', onMouseEnter: () => !this.disabled ? this.showHandler() : null, onMouseLeave: () => !this.disabled ? this.hideHandler() : null, onFocusin: () => !this.disabled ? this.showHandler() : null, onFocusout: () => !this.disabled ? this.hideHandler() : null }, h("slot", { key: '8f235e089d7b7272fc745c3030059037c7b0259d', name: "tooltip-trigger" }))), h("div", { key: 'e330d2ecadd8fed78185c057949f8475af50626d', ref: (el) => (this.tooltipEl = el), "data-position": this.position, "data-align": this.align, popover: "auto", id: this.popoverId, class: "bg-surface-overlay/90 text-foreground-inv pointer-events-none w-fit rounded-md px-[6px] py-[2px] text-sm leading-tight break-words whitespace-normal opacity-0 shadow-md transition-opacity duration-200 ease-out", "data-name": "tooltip-content-wrapper" }, h("slot", { key: '18f45d7e7746fe7550e50a9c467fc174614c7d9e' }))));
    }
