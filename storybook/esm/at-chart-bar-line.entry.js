...
const AtChartBarLine = class {
    ...
    render() {
        return (h(Host, { key: '3271f4ad3d93aaf75671f5e4eb482a62af80dcd7', style: { height: '100%', width: '100%' } }, h("canvas", { key: '7b191ec84f27b736c1be63526af9db5bdfe13120', ref: (el) => (this.canvasEl = el), class: `min-w-100 ${heightVariants[this.height]}` })));
    }
};
