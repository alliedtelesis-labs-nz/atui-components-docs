import { r as registerInstance, h, H as Host } from './index-Dnh7MvHP.js';
...
import { e as ensureLegendTooltipEl, s as setLegendTooltip, g as generateLegendLabels } from './chart-legend-DUoKUddP.js';
...
function requireSetter () {
	...
	Setter.ValueSetter =
	  Setter.Setter =
	  Setter.DateToSystemTimezoneSetter =
	    void 0;
...
adapters._date.override({
  ...
  parse: function(value, fmt) {
    ...
    if (type === 'number' || value instanceof Date) {
      value = dateFnsExports.toDate(value);
    } else if (type === 'string') {
      if (typeof fmt === 'string') {
        value = dateFnsExports.parse(value, fmt, new Date(), this.options);
      } else {
        value = dateFnsExports.parseISO(value, this.options);
      }
    }
    return dateFnsExports.isValid(value) ? value.getTime() : null;
  },

  format: function(time, fmt) {
    return dateFnsExports.format(time, fmt, this.options);
  },

  add: function(time, amount, unit) {
    switch (unit) {
    case 'millisecond': return dateFnsExports.addMilliseconds(time, amount);
    case 'second': return dateFnsExports.addSeconds(time, amount);
    case 'minute': return dateFnsExports.addMinutes(time, amount);
    case 'hour': return dateFnsExports.addHours(time, amount);
    case 'day': return dateFnsExports.addDays(time, amount);
    case 'week': return dateFnsExports.addWeeks(time, amount);
    case 'month': return dateFnsExports.addMonths(time, amount);
    case 'quarter': return dateFnsExports.addQuarters(time, amount);
    case 'year': return dateFnsExports.addYears(time, amount);
    default: return time;
    }
  },
  ...
  diff: function(max, min, unit) {
    switch (unit) {
    case 'millisecond': return dateFnsExports.differenceInMilliseconds(max, min);
    case 'second': return dateFnsExports.differenceInSeconds(max, min);
    case 'minute': return dateFnsExports.differenceInMinutes(max, min);
    case 'hour': return dateFnsExports.differenceInHours(max, min);
    case 'day': return dateFnsExports.differenceInDays(max, min);
    case 'week': return dateFnsExports.differenceInWeeks(max, min);
    case 'month': return dateFnsExports.differenceInMonths(max, min);
    case 'quarter': return dateFnsExports.differenceInQuarters(max, min);
    case 'year': return dateFnsExports.differenceInYears(max, min);
    default: return 0;
    }
  },
  ...
  startOf: function(time, unit, weekday) {
    switch (unit) {
    case 'second': return dateFnsExports.startOfSecond(time);
    case 'minute': return dateFnsExports.startOfMinute(time);
    case 'hour': return dateFnsExports.startOfHour(time);
    case 'day': return dateFnsExports.startOfDay(time);
    case 'week': return dateFnsExports.startOfWeek(time);
    case 'isoWeek': return dateFnsExports.startOfWeek(time, {weekStartsOn: +weekday});
    case 'month': return dateFnsExports.startOfMonth(time);
    case 'quarter': return dateFnsExports.startOfQuarter(time);
    case 'year': return dateFnsExports.startOfYear(time);
    default: return time;
    }
  },
  ...
  endOf: function(time, unit) {
    switch (unit) {
    case 'second': return dateFnsExports.endOfSecond(time);
    case 'minute': return dateFnsExports.endOfMinute(time);
    case 'hour': return dateFnsExports.endOfHour(time);
    case 'day': return dateFnsExports.endOfDay(time);
    case 'week': return dateFnsExports.endOfWeek(time);
    case 'month': return dateFnsExports.endOfMonth(time);
    case 'quarter': return dateFnsExports.endOfQuarter(time);
    case 'year': return dateFnsExports.endOfYear(time);
    default: return time;
    }
  }
});
...
const AtChartBarLine = class {
    ...
    render() {
        return (h(Host, { key: '2ce66d1c975c8675c80a16e487811eebff27e21d', style: { height: '100%', width: '100%' } }, h("canvas", { key: '992b658e672e5a716501a31dbca3aaec08841f06', ref: (el) => (this.canvasEl = el), class: `min-w-100 ${heightVariants[this.height]}` })));
    }
};
