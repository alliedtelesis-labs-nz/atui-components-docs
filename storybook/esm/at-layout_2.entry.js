...
const AtLayout = class {
    ...
    render() {
        return h(Host, { key: 'cbc2a4e4fee6aa45894dc5d0aac4b04b987b39d1' }, this.layoutElement);
    }
};
...
const AtTabTrigger = class {
    ...
    render() {
        ...
        return (h(Host, { key: '88d5d51817283b2d307ff02c9d0a5ccf3613329d', role: "tab", tabfocs: 0, "aria-selected": this.is_active, "data-active": this.is_active ? 'true' : 'false', onKeyDown: (event) => this.handleKeyDown(event), "data-name": `tab-${this.tab_id}`, class: this.fill ? 'flex-1' : undefined }, h("a", { key: '63384cdcce4317dfeea5fed5a0ab321367bf5c52', id: `tab-${this.tab_id}`, tabindex: "0", class: classname, ref: (el) => (this.tabEl = el) }, this.tab_title, h("slot", { key: '48dfe7a8f336813eee0bfc27bed14c2f0e44b9b9' }))));
    }
};
