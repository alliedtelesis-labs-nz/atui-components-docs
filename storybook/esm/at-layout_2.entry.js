...
const AtLayout = class {
    ...
    render() {
        return h(Host, { key: 'c42a16a7392c136bd0261f92ecdc93ca49a26c7c' }, this.layoutElement);
    }
};
...
const AtTabTrigger = class {
    ...
    render() {
        ...
        return (h(Host, { key: '2a3dc3d6697bf4d79b44d3fbeaa2595896680fad', role: "tab", tabfocs: 0, "aria-selected": this.is_active, "data-active": this.is_active ? 'true' : 'false', onKeyDown: (event) => this.handleKeyDown(event), "data-name": `tab-${this.tab_id}`, class: this.fill ? 'flex-1' : undefined }, h("a", { key: '1116272339d2b2f2d92e49ce935b186175dee162', id: `tab-${this.tab_id}`, tabindex: "0", class: classname, ref: (el) => (this.tabEl = el) }, this.tab_title, h("slot", { key: '7e12c1fa4ec63cd305d2f10598b4905b9d2162d3' }))));
    }
};
