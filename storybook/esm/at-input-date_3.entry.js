...
const AtInputDate = class {
    ...
    render() {
        ...
        return (h(Host, { key: '94d31205ea4b31f38640fad36a4a6461bc9c903b' }, h("style", { key: '2a047c5eef820e5c344a99fd065aad869c8c11a1' }, `
                ...
                `), h("div", { key: '8450940c896608cc6bafea97bce0582a71ca1ce8', class: "flex w-full flex-col" }, h("div", { key: 'e628fe4de21ec9b83af31c34f4f57243e7e00791', class: "flex flex-col" }, (this.label || this.required || this.info_text) && (h("at-form-label", { key: '07fd24216d639e0f0dfd962e8ce87496c47fd54d', label: this.label, for: this.inputId, required: this.required && !this.readonly, info_text: this.info_text })), this.hint_text && (h("span", { key: 'dcd6f9767a9fb60825add17d57bf482c251ba788', class: "text-light mb-8 inline-block text-xs leading-tight", "data-name": "datepicker-hint" }, this.hint_text)), h("div", { key: 'e9dfb1b105dc02261e252e4504e2b569c2d0d8ae', class: classname }, h("input", { key: '15ae3530e5c9bc45c030c73c4ef99243f0b6fb46', type: "date", id: this.inputId, name: "datePicker", class: "flex w-full cursor-pointer px-8 py-8 outline-0", readonly: this.readonly ? true : undefined, disabled: this.disabled ? true : undefined, required: this.required, value: this.selectedDate, min: TimeDatePresentationUtil.getFormattedDate(this.min_date, 'YYYY-MM-DD'), max: TimeDatePresentationUtil.getFormattedDate(this.max_date, 'YYYY-MM-DD'), "data-name": "datepicker", onChange: (event) => {
            ...
            } }))), this.error_text && this.invalid && (h("span", { key: '16f722068792915a353c5a78e3d7f2c357725165', class: "text-error text-sm", "data-name": "datepicker-error" }, this.error_text)))));
    }
...
const AtInputTime = class {
    ...
    render() {
        ...
        return (h(Host, { key: '0619ab8861039d8e1310b9ce66e8aa519e37bb07' }, h("style", { key: 'd9cb0a653272795509a7a5b3583c2ba460dc9971' }, `
                ...
                `), h("div", { key: '175de77cc3364db0e91517a48d800a2a0a612ef2', class: "flex flex-row" }, h("div", { key: 'aea0741d363a35b7b429566c3bd4ced5089e7031', class: "flex-fill flex flex-col" }, h("div", { key: 'd7472550e1f3135b359f48e657d546a9aa60f2ae', class: "flex flex-col" }, (this.label ||
            this.required ||
            this.info_text) && (h("at-form-label", { key: '353ec6e9da87c262fdf624513d8d9134c972b0fa', label: this.label, for: this.inputId, required: !!this.required && !this.readonly, info_text: this.info_text })), this.hint_text && (h("span", { key: '3b796b92d52fd93b15a3c9117f3dcbd500dfcfd3', class: "text-light mb-8 inline-block text-xs leading-tight", "data-name": "timepicker-hint" }, this.hint_text)), h("div", { key: 'df5539512ad07bf6e5059766dbad1fa9e79e58f8', class: classname }, h("input", { key: '6930c6c7d30626af988562ce1131d6cbd8866968', type: "time", id: this.inputId, name: "timePicker", class: "flex w-full cursor-pointer px-8 py-8 outline-0", readOnly: this.readonly ? true : undefined, disabled: this.disabled ? true : undefined, required: this.required, value: this.value ?? '', min: this.min, max: this.max, step: this.step, "data-name": "timepicker", onInput: this.onInput }))), this.error_text && this.invalid && (h("span", { key: '42f66d552f0ce336e2a2c79bb80bd8232ae4f841', class: "text-error text-sm", "data-name": "timepicker-error" }, this.error_text))))));
    }
};
