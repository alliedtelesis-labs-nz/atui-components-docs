import { r as registerInstance, h, a as getElement, H as Host } from './index-ChWFprTL.js';
...
const AtTooltip = class {
    ...
    render() {
        return (h(Host, { key: '6240fb46acec752996185c678491a063243d0bb3', class: "relative" }, !this.trigger_id && (h("div", { key: '0db80b2ef91e38df4520a293fb09cb296dc6ad32', "aria-haspopup": "true", "data-name": "tooltip-trigger", ref: (el) => (this.triggerEl = el), "aria-expanded": `${this.isOpen ? 'true' : 'false'}`, class: this.disabled ? 'contents' : '', onMouseEnter: () => !this.disabled ? this.mouseEnterHandler() : null, onMouseLeave: () => !this.disabled ? this.mouseLeaveHandler() : null }, h("slot", { key: 'e516037cf3a37b82eaf882ff15e26931e067a761', name: "tooltip-trigger" }))), h("div", { key: 'aa7cd0da5029779b257c753b159bb9b9ccaa152f', ref: (el) => (this.tooltipEl = el), "data-position": this.position, "data-align": this.align, popover: "auto", id: this.popoverId, class: "bg-surface-overlay/90 text-foreground-inv pointer-events-none w-fit rounded-md px-[6px] py-[2px] text-sm leading-tight break-words whitespace-normal opacity-0 shadow-md transition-opacity duration-200 ease-out", "data-name": "tooltip-content-wrapper" }, h("slot", { key: '488dd197cc0ccafd94eb66d49064b539fd8d17b9' }))));
    }
