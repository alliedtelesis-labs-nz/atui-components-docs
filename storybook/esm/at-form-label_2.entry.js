...
const AtTooltip = class {
    ...
    render() {
        return (h(Host, { key: '44317587852dbe2fc2df4ced438573d1c843abd2', class: "relative" }, !this.trigger_id && (h("div", { key: 'bb49785ce0a60bb69673b823ea0ae307ab083fa4', "aria-haspopup": "true", "data-name": "tooltip-trigger", ref: (el) => (this.triggerEl = el), "aria-expanded": `${this.isOpen ? 'true' : 'false'}`, class: this.disabled ? 'contents' : '', onMouseEnter: () => !this.disabled ? this.mouseEnterHandler() : null, onMouseLeave: () => !this.disabled ? this.mouseLeaveHandler() : null }, h("slot", { key: '6910f68297a2bea93dce585b2f965c40fa7f71fa', name: "tooltip-trigger" }))), h("div", { key: 'b2d3927084a8a14165df522236aa62bc0979eff6', ref: (el) => (this.tooltipEl = el), "data-position": this.position, "data-align": this.align, popover: "auto", id: this.popoverId, class: "bg-surface-overlay/90 text-foreground-inv pointer-events-none w-fit rounded-md px-[6px] py-[2px] text-sm leading-tight break-words whitespace-normal opacity-0 shadow-md transition-opacity duration-200 ease-out", "data-name": "tooltip-content-wrapper" }, h("slot", { key: '57aacb0231379bd9602a6fc01ee90867f283d607' }))));
    }
