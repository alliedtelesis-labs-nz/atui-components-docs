import { r as registerInstance, h, a as getElement, H as Host } from './index-HD-uhvb8.js';
...
const AtTooltip = class {
    ...
    render() {
        return (h(Host, { key: 'd2d106cfa9f36939a6ff52a6b666e391536c586c', class: "relative" }, !this.trigger_id && (h("div", { key: '787b7795cbe36cc4677e656e7851eb589f96c88c', "aria-haspopup": "true", "data-name": "tooltip-trigger", ref: (el) => (this.triggerEl = el), "aria-expanded": `${this.isOpen ? 'true' : 'false'}`, class: this.disabled ? 'contents' : '', onMouseEnter: () => !this.disabled ? this.mouseEnterHandler() : null, onMouseLeave: () => !this.disabled ? this.mouseLeaveHandler() : null }, h("slot", { key: 'beefcf93ce7db26c83827cca4696ffd14a53f576', name: "tooltip-trigger" }))), h("div", { key: '708bfe5899a43b57ed90f2e3500eb32333e8fa64', ref: (el) => (this.tooltipEl = el), "data-position": this.position, "data-align": this.align, popover: "auto", id: this.popoverId, class: "bg-surface-overlay/90 text-foreground-inv pointer-events-none w-fit rounded-md px-[6px] py-[2px] text-sm leading-tight break-words whitespace-normal opacity-0 shadow-md transition-opacity duration-200 ease-out", "data-name": "tooltip-content-wrapper" }, h("slot", { key: '72fe989d7f65c28e7d36f6cc2ef31a082bf535d5' }))));
    }
