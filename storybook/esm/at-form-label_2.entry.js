...
const AtTooltip = class {
    ...
    render() {
        return (h(Host, { key: 'dda55a567ae1cfeabb808e77cfa3a0279c207cc8', class: "relative" }, !this.trigger_id && (h("div", { key: 'd871ed7c3fb3a4a7c67fb406872537476f021bd7', "aria-haspopup": "true", "data-name": "tooltip-trigger", ref: (el) => (this.triggerEl = el), "aria-expanded": `${this.isOpen ? 'true' : 'false'}`, class: this.disabled ? 'contents' : '', onMouseEnter: () => !this.disabled ? this.mouseEnterHandler() : null, onMouseLeave: () => !this.disabled ? this.mouseLeaveHandler() : null }, h("slot", { key: '69942bc98ca007775ad8bf61ee3de00a0c3a4487', name: "tooltip-trigger" }))), h("div", { key: 'd27f833b34ca8ecca5711cf412d365872917c01a', ref: (el) => (this.tooltipEl = el), "data-position": this.position, "data-align": this.align, popover: "auto", id: this.popoverId, class: "bg-surface-overlay/90 text-foreground-inv pointer-events-none w-fit rounded-md px-[6px] py-[2px] text-sm leading-tight break-words whitespace-normal opacity-0 shadow-md transition-opacity duration-200 ease-out", "data-name": "tooltip-content-wrapper" }, h("slot", { key: '980e6c7c3d9aa16efda6a82377ce0399eb6dbc41' }))));
    }
