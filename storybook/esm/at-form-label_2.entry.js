...
const AtTooltip = class {
    ...
    render() {
        return (h(Host, { key: 'a9c0d3293ef3e6270f33cf548ab8b4b431e476fa', class: "relative" }, !this.trigger_id && (h("div", { key: '8e6051b634d4655bdba4af78f954e278e78efc92', "aria-haspopup": "true", "data-name": "tooltip-trigger", ref: (el) => (this.triggerEl = el), "aria-expanded": `${this.isOpen ? 'true' : 'false'}`, class: this.disabled ? 'contents' : '', onMouseEnter: () => !this.disabled ? this.mouseEnterHandler() : null, onMouseLeave: () => !this.disabled ? this.mouseLeaveHandler() : null }, h("slot", { key: '52ee24b298e17ca8dbf16ac4d3f6de90f50b72d4', name: "tooltip-trigger" }))), h("div", { key: 'd624be6b7baf82875729c2bdad727c4bfb1d7d5e', ref: (el) => (this.tooltipEl = el), "data-position": this.position, "data-align": this.align, popover: "auto", id: this.popoverId, class: "bg-surface-overlay/90 text-foreground-inv pointer-events-none w-fit rounded-md px-[6px] py-2 text-sm opacity-0 shadow-md transition-opacity duration-200 ease-out", "data-name": "tooltip-content-wrapper" }, h("slot", { key: '0409b8f42378b5f4afbcf8c7d2803840f714c188' }))));
    }
