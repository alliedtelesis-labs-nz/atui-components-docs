...
const AtPlaceholderComponent = class {
    ...
    render() {
        return (h("div", { key: '1814e838258f57fc93742db77cb59737961cdf03', class: `${this.placeholderSizeClass} bg-surface-0 text-med flex w-full items-center gap-16 rounded-sm text-center`, "data-name": "placeholder-container" }, this.icon && this.icon !== 'none' && (h("span", { key: '18f2c1fc3b8057120fde6c2b6adff4cf508255a3', class: `material-icons text-slate-300 ${this.iconSizeClass}`, "data-name": "placeholder-icon" }, this.icon)), h("div", { key: 'a4f096839c19b36eb416316e6073650846e05314', class: `border-radius-sm flex flex-col justify-center ${this.size === 'xs' ? 'items-start text-left' : 'items-center text-center'}` }, h("div", { key: 'a7fe8277a37426d3183c6a44c6a790ffb11954aa', class: "flex items-center" }, this.show_loading_spinner && (h("at-loading", { key: '3ae51b11b5d34ed75ed148fba538ae6539b497b9', class: "relative mr-8", size: "sm", type: "secondary", "data-name": "placeholder-spinner" })), this.placeholder_title && (h("h5", { key: '7df9692242180164cb7a608faa35117c7128852c', class: "text-med text-sm font-medium", "data-name": "placeholder-title" }, this.placeholder_title))), h("p", { key: 'de0a4533e7755c4dfee61c8ba2ba41c531d71cb7', class: "text-med text-sm", "data-name": "placeholder-content" }, this.content), h("slot", { key: '78684e4cc2f82f8369fedb3aa0459fd3f1c867cc' }))));
    }
};
