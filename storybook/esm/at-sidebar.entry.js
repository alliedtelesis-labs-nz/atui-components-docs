...
const AtSidebarComponent = class {
    ...
    render() {
        ...
        return (h(Host, { key: '2363f4295f26ed68a08874c64d810967932db568', "data-state": this.isOpen ? 'expanded' : 'collapsed', class: `mode-${this.mode} side-${this.side} collapse-${this.collapsible}` }, isModalOverlay && (h("div", { key: '44f982997bd84813c3c1ab5e554c28291c4285af', class: "backdrop", "data-name": "backdrop", onClick: this.handleBackdropClick, "aria-hidden": "true" })), h("nav", { key: 'f965a8b15d758c665a6353a4499856d8409ab57c', "data-name": "sidebar", "data-open": this.isOpen, class: `sidebar collapse-${this.collapsible}`, "aria-hidden": !this.isOpen && this.collapsible === 'offcanvas'
                ? 'true'
                : 'false', role: "navigation", "aria-label": "Sidebar navigation" }, h("div", { key: '2e0fb9af7da4a86f13243f05fc8926e404600ecc', class: "sidebar-header", "data-name": "sidebar-header" }, h("slot", { key: 'f58105d597146bb0df17d2f156541122e503bc0d', name: "sidebar-header" })), h("div", { key: 'd948de108c922e8880ca15a7b9571acec86a9b0c', class: "sidebar-content", "data-name": "sidebar-content" }, h("slot", { key: 'b9f76ae1c25b1103155a1d0b1dd3cb777006a9c3', name: "sidebar-content" })), h("div", { key: '3c50c9fc64fa518d66581ca02efa5de0927276d5', class: `sidebar-footer`, "data-name": "sidebar-footer" }, h("slot", { key: '057d4f9033cae23619e95ac2dbbee378ec229026', name: "sidebar-footer" }))), h("div", { key: 'b08e17ed36c10b6b4d6edecacf57d3c04a20ee38', class: "page-content", "data-name": "page-content", "aria-hidden": isModalOverlay ? 'true' : 'false', inert: isModalOverlay }, h("slot", { key: '23ac137431226d4830f7a34273a999680950cb20', name: "page-content" }))));
    }
};
