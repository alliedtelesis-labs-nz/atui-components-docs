...
const AtSidebarComponent = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'ea1ff09e1a10a47e1cb4ddd293e90883bdb86a7e', "data-state": this.isOpen ? 'expanded' : 'collapsed', class: `mode-${this.mode} side-${this.side} collapse-${this.collapsible}` }, isModalOverlay && (h("div", { key: '8eebade9eef85416a30695f2e48828205529d4d1', class: "backdrop", "data-name": "backdrop", onClick: this.handleBackdropClick, "aria-hidden": "true" })), h("nav", { key: '9cd0fd8e4b0e8a5b3f32e55b79cb0f3a5f43f15c', "data-name": "sidebar", "data-open": this.isOpen, class: `sidebar collapse-${this.collapsible}`, "aria-expanded": this.isOpen ? 'true' : 'false', "aria-hidden": !this.isOpen && this.collapsible === 'offcanvas'
                ? 'true'
                : 'false' }, h("div", { key: '194f7b314fa68ace9877ace7ccaaf33998e98886', class: "sidebar-header", "data-name": "sidebar-header" }, h("slot", { key: '2817756b9895c70a5cb7d805de14a9ea5e6ac86d', name: "sidebar-header" })), h("div", { key: '7c3c2068f957323b8b0a76bd89e58776a9e2450d', class: "sidebar-content", "data-name": "sidebar-content" }, h("slot", { key: 'ab465f1c612fda948331f70909c4704d24cb3086', name: "sidebar-content" })), h("div", { key: 'e33384df0b10d299c0e2a3e7f2a0f5e22ca0ca8a', class: `sidebar-footer`, "data-name": "sidebar-footer" }, h("slot", { key: 'a54f1227eae70a2cf568e3df70f009b26541edf2', name: "sidebar-footer" }))), h("div", { key: '114a354738a2af1b925aa3962d05028738226ab6', class: "page-content", "data-name": "page-content", "aria-hidden": isModalOverlay ? 'true' : 'false', inert: isModalOverlay }, h("slot", { key: '555d4d107ae37ec128e1718483af1ee554241772', name: "page-content" }))));
    }
};
