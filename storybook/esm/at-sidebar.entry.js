...
const AtSidebarComponent = class {
    ...
    render() {
        ...
        return (h(Host, { key: '0ddf6f22d40be753d4515ed934819df16c1a5173', "data-state": this.isOpen ? 'expanded' : 'collapsed', class: `mode-${this.mode} side-${this.side} collapse-${this.collapsible}` }, isModalOverlay && (h("div", { key: 'b4cde59b0ab580cf85480fb7dea62a300575cd47', class: "backdrop", "data-name": "backdrop", onClick: this.handleBackdropClick, "aria-hidden": "true" })), h("nav", { key: 'b989469f1825ca90b24a64f27dcbbea7984fa440', "data-name": "sidebar", "data-open": this.isOpen, class: `sidebar collapse-${this.collapsible}`, "aria-expanded": this.isOpen ? 'true' : 'false', "aria-hidden": !this.isOpen && this.collapsible === 'offcanvas'
                ? 'true'
                : 'false' }, h("div", { key: '9ab45cc7fd48b46dfce92f40e4e9d178003ebdad', class: "sidebar-header", "data-name": "sidebar-header" }, h("slot", { key: 'ea8f0ee23fb2713e5482d94578dbeaacad0e2563', name: "sidebar-header" })), h("div", { key: 'caa9f4169d7d06acd3f5d93b71714869d619f692', class: "sidebar-content", "data-name": "sidebar-content" }, h("slot", { key: 'bddd4ca38ed8a39ff6e37c20c915eec614fabd3b', name: "sidebar-content" })), h("div", { key: 'c183422dcab9843fc1dedd288e22d7571593c805', class: `sidebar-footer`, "data-name": "sidebar-footer" }, h("slot", { key: '63c8512c721a9f20f948ce52f59d3f3fc97de71e', name: "sidebar-footer" }))), h("div", { key: '80a19a125abe3220367392d6e06a3931604dc119', class: "page-content", "data-name": "page-content", "aria-hidden": isModalOverlay ? 'true' : 'false', inert: isModalOverlay }, h("slot", { key: '51188d07c94d12cf037d8b353c904b9b9e41e2bb', name: "page-content" }))));
    }
};
