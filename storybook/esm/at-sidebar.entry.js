...
const AtSidebarComponent = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'b20bfaa30f9a8db50551a1d3dbe1b96e265aaa52', "data-state": this.isOpen ? 'expanded' : 'collapsed', class: `mode-${this.mode} side-${this.side} collapse-${this.collapsible}` }, isModalOverlay && (h("div", { key: 'bf4554cc65ebc398cabc4ecc785e64489e34e763', class: "at-sidebar__backdrop", onClick: this.handleBackdropClick, "aria-hidden": "true" })), h("nav", { key: '63601549626358d723aef6c6fb4b9ec082e51dbe', "data-name": "sidebar-nav", "aria-expanded": this.isOpen ? 'true' : 'false', "aria-hidden": !this.isOpen && this.collapsible === 'offcanvas'
                ? 'true'
                : 'false', part: "nav", class: `at-sidebar__nav collapse-${this.collapsible}` }, h("slot", { key: '995ecf8ffc3f38dbe89e4e440731cfc69d96e6fe', name: "at-sidebar__header" }), h("div", { key: 'caa3dd7d9aabf8d50eb308c5f895706bc70de1e0', class: "at-sidebar__nav-content" }, h("slot", { key: 'bf9c8064647873b99cbc2e04f2f8e3ba5722c9c7', name: "sidebar-content" })), h("div", { key: 'a378130e2d0da5dede91b7f237d85900f58018a6', class: `${this.isOpen ? '' : 'hidden'}` }, h("slot", { key: 'a8fdcb142c5f2253b4793ffebac8461925d54c20', name: "sidebar-footer" }))), h("div", { key: '5b5f8635e55404637a51c21bbbd7c5c3d4534e8e', class: "at-sidebar__content", "aria-hidden": isModalOverlay ? 'true' : 'false', inert: isModalOverlay }, h("slot", { key: 'a1e16f54d23e90505bad7ecbd7e40beef9b20a51', name: "page-content" }))));
    }
};
