...
const atSidebarCss = "at-sidebar nav[data-name=sidebar-nav] at-sidebar-trigger{display:flex;width:100%}at-sidebar nav[data-name=sidebar-nav][data-state=expanded] at-sidebar-trigger{display:flex;justify-content:flex-end}at-sidebar i[slot=menu-item-actions],at-sidebar [data-name=sidebar-menu-item-label]{transition:opacity 150ms ease;transition-delay:150ms}at-sidebar[data-state=collapsed] at-sidebar-trigger at-button{width:100%}at-sidebar[data-state=collapsed] i[slot=menu-item-actions],at-sidebar[data-state=collapsed] [data-name=sidebar-menu-item-label]{opacity:0}at-sidebar[data-state=collapsed] at-menu i[slot=menu-item-actions],at-sidebar[data-state=collapsed] at-menu [data-name=sidebar-menu-item-label]{opacity:1}at-sidebar[data-state=expanded] at-sidebar-trigger{display:flex;justify-content:flex-end}at-sidebar[data-state=expanded] :not(at-menu) i[slot=menu-item-actions],at-sidebar[data-state=expanded] :not(at-menu) [data-name=sidebar-menu-item-label]{opacity:1}at-sidebar at-sidebar-menu at-sidebar-submenu [slot=submenu-content] at-sidebar-menuitem{padding-left:36px}at-sidebar at-sidebar-menu at-sidebar-submenu [slot=submenu-content] at-sidebar-submenu [slot=submenu-content] at-sidebar-menuitem{padding-left:50px}at-sidebar at-sidebar-menu at-sidebar-submenu [slot=submenu-content] at-sidebar-submenu [slot=submenu-content] at-sidebar-submenu [slot=submenu-content] at-sidebar-menuitem{padding-left:64px}at-sidebar at-sidebar-submenu at-menu [data-name=menu-content-wrapper]{background-color:var(--token-sidebar-background)}";
