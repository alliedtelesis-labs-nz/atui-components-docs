...
const AtSidebarComponent = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'f962f87fd45c0596f63d2c3faf6f220160e8dd38', "data-state": this.isOpen ? 'expanded' : 'collapsed', class: `mode-${this.mode} side-${this.side} collapse-${this.collapsible}` }, isModalOverlay && (h("div", { key: '00f5867926be50dce7b6a1feea96d39ae4565ef2', class: "backdrop", "data-name": "backdrop", onClick: this.handleBackdropClick, "aria-hidden": "true" })), h("nav", { key: 'ce89aac584f4eb5625d08f9f5a675e123c0da36f', "data-name": "sidebar", "data-open": this.isOpen, class: `sidebar collapse-${this.collapsible}`, "aria-hidden": !this.isOpen && this.collapsible === 'offcanvas'
                ? 'true'
                : 'false', role: "navigation", "aria-label": "Sidebar navigation" }, h("div", { key: '59a751b236b80fdf46030fc1aa0492b399477f0c', class: "sidebar-header", "data-name": "sidebar-header" }, h("slot", { key: '2dca5e441e62b4b9ad751d31d5afc31d7bb5073e', name: "sidebar-header" })), h("div", { key: 'e67ba56c90427515ca03861377d245196de08ff8', class: "sidebar-content", "data-name": "sidebar-content" }, h("slot", { key: '38a2fcea514ceb45a96e0590aacfcae57414adc6', name: "sidebar-content" })), h("div", { key: 'c9595a3ed28a7ddc157a419f965946f18b473c87', class: `sidebar-footer`, "data-name": "sidebar-footer" }, h("slot", { key: '372a83ee40802e777c41dbfb7e1bf00ac20747f4', name: "sidebar-footer" }))), h("div", { key: 'ebbdfe061341a7b1d6089564be7b89abda8637f4', class: "page-content", "data-name": "page-content", "aria-hidden": isModalOverlay ? 'true' : 'false', inert: isModalOverlay }, h("slot", { key: '194a36965c6c4b527285a14622dc4e8ff5bab1db', name: "page-content" }))));
    }
};
