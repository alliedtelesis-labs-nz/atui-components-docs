const ATUI$1 = {
	...
	USE: "Use",
	MORE_MATCHES_REFINE_SEARCH: "more matches. Refine your search.",
	...
	TABLE: {
		...
		RELOAD: "Reload",
		RELOAD_UPDATES_AVAILABLE: "Reload (updates available)",
		...
		SELECTION: {
			PAGE_SELECTED: "{count} {noun} selected.",
			SELECTED: "{count} {noun} selected.",
			SELECTED_ACROSS_PAGES: "{count} {noun} selected across all pages.",
			SELECT_ALL_MATCHING: "Select all {total} that match this filter",
			SELECT_PAGE_ONLY: "Select all in the current page",
			ALL_MATCHING_SELECTED: "All {total} {noun} matching your filter are selected.",
			ALL_MATCHING_SELECTED_EXCLUDED: "All {count} of {total} {noun} matching your filter are selected.",
			SELECT_ROW: "Select row",
			SELECT_ALL_ON_PAGE: "Select all rows on this page",
			ROW: "row",
			ROWS: "rows"
		}
	},
	TIME: {
		...
		RANGE_LABEL: {
			SECONDS_ONE: "Last second",
			SECONDS_OTHER: "Last {value} seconds",
			MINUTES_ONE: "Last minute",
			MINUTES_OTHER: "Last {value} minutes",
			HOURS_ONE: "Last hour",
			HOURS_OTHER: "Last {value} hours",
			DAYS_ONE: "Last day",
			DAYS_OTHER: "Last {value} days",
			WEEKS_ONE: "Last week",
			WEEKS_OTHER: "Last {value} weeks",
			MONTHS_ONE: "Last month",
			MONTHS_OTHER: "Last {value} months",
			YEARS_ONE: "Last year",
			YEARS_OTHER: "Last {value} years"
		},
		TO_SEPARATOR: "to",
		ALL_TIME_SINCE: "All Time (since {date})"
	},
	PROMPT: {
...
const ATUI = {
	...
	USE: "使用",
	MORE_MATCHES_REFINE_SEARCH: "件以上の候補があります。検索条件を絞り込んでください。",
	NO_OPTIONS_AVAILABLE: "選択可能なオプションがありません。",
	...
	TABLE: {
		...
		RELOAD: "再読み込み",
		RELOAD_UPDATES_AVAILABLE: "再読み込み（更新あり）",
		...
		SELECTION: {
			PAGE_SELECTED: "{count}件の{noun}を選択しました。",
			SELECTED: "{count}件の{noun}を選択しました。",
			SELECTED_ACROSS_PAGES: "全ページで{count}件の{noun}を選択しました。",
			SELECT_ALL_MATCHING: "このフィルターに一致する{total}件をすべて選択",
			SELECT_PAGE_ONLY: "現在のページをすべて選択",
			ALL_MATCHING_SELECTED: "フィルターに一致する{total}件の{noun}をすべて選択しました。",
			ALL_MATCHING_SELECTED_EXCLUDED: "フィルターに一致する{total}件のうち{count}件の{noun}を選択しました。",
			SELECT_ROW: "行を選択",
			SELECT_ALL_ON_PAGE: "このページのすべての行を選択",
			ROW: "行",
			ROWS: "行"
		}
	},
	TIME: {
		...
		RANGE_LABEL: {
			SECONDS_ONE: "直近1秒",
			SECONDS_OTHER: "直近{value}秒",
			MINUTES_ONE: "直近1分",
			MINUTES_OTHER: "直近{value}分",
			HOURS_ONE: "直近1時間",
			HOURS_OTHER: "直近{value}時間",
			DAYS_ONE: "直近1日",
			DAYS_OTHER: "直近{value}日",
			WEEKS_ONE: "直近1週間",
			WEEKS_OTHER: "直近{value}週間",
			MONTHS_ONE: "直近1か月",
			MONTHS_OTHER: "直近{value}か月",
			YEARS_ONE: "直近1年",
			YEARS_OTHER: "直近{value}年"
		},
		TO_SEPARATOR: "から",
		ALL_TIME_SINCE: "全期間（{date}以降）"
	},
	PROMPT: {
...
export { fetchTranslations as f, interpolate as i };
