import { r as registerInstance, c as createEvent, h, H as Host } from './index-BEGRcYEc.js';
...
const AtMenuitemComponent = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'cad01cfade2ad2d210dd6ef1b407af4787aaa4a8', role: "menuitem", tabindex: "0", class: classname, onClick: (e) => {
            ...
            } }, h("div", { key: '6f369479da46e4d2f24428100212691efdaa57cd', class: "flex min-w-0 flex-1" }, h("slot", { key: '7ce1146247c2656189ffb67ea3ca331a44d14140', name: "icon", "data-name": "menu-item-icon" }), this.label && (h("span", { key: '055911ab87ba9be158428962df3722bc1709f6b2', "data-name": "menu-item-label", class: "text-body min-w-0 flex-1 truncate leading-normal font-normal whitespace-nowrap group-data-[state=collapsed]/sidebar-wrapper:hidden" }, this.label)), h("slot", { key: 'becf402c9882720c93f43ee03dd5f9cccc624277' })), h("slot", { key: 'ee214116ea360ac99347a8db4ef8a07c7c117979', name: 'icon-after', "data-name": "menu-item-icon-after" })));
    }
};
