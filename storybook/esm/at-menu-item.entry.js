...
const AtMenuitemComponent = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'b6c4c26f24fd0158962571deb85ace1a1dbcb3ba', role: "menuitem", tabindex: "0", class: classname, onClick: (e) => {
                if (this.disabled) {
                    e.preventDefault();
                    e.stopPropagation();
                }
            ...
            } }, h("slot", { key: '3ba40b1c58eccbed81ffbfe08308ddef0fcb4767', name: "icon", "data-name": "menu-item-icon" }), this.label && (h("span", { key: 'a7ea3fde250328ce2e6b8079263d56eff80293e2', "data-name": "menu-item-label", class: "truncate whitespace-nowrap group-data-[state=collapsed]/sidebar-wrapper:hidden" }, this.label)), h("slot", { key: '53f65e74a5657725b267f61a4ef45551b3a53413' })));
    }
};
