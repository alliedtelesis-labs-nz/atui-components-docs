...
const AtSearchTable = class {
    ...
    render() {
        return (h(Host, { key: '4099a40d0f697b5305047f92aca9e6727957f763', class: this.server_side_mode ? 'is-loading' : '' }, h("at-table-actions", { key: '1d62c2ddc599c5d0417f579686e79d04438a4487', ag_grid: this.agGrid }, h("at-control-group", { key: '19dc569c70e534863d7de37eae7b1bbd2512b4d8', slot: "search" }, this.shouldShowDropdownFilters && (h("at-table-filter-menu", { key: '6da476eb314c058899830ad70c53dde59b6e7510', col_defs: this.col_defs, selected: this.menuSelectedIds, onAtChange: (event) => this.handleFilterChange(event) })), h("at-search", { key: '8868a3b2225eaaa3f04d79b95fd33e656e3257a3', class: "w-input-md", label: this.search_label, hint_text: this.search_hint, info_text: this.search_info_tooltip, placeholder: this.translations.ATUI.TABLE.SEARCH_BY_KEYWORD, onAtChange: (event) => this.handleSearchChange(event) })), this.shouldShowDropdownFilters && (h("at-table-filters", { key: '798e882be92f120596df81af2174acacd293ae73', slot: "filters", col_defs: this.col_defs, selected: this.selectedFilters, onAtChange: (event) => this.handleFilterChange(event) })), !this.hide_export_menu && (h("at-table-export-menu", { key: 'b483f71c7d2d360f8c69a0d6d961de0351530380', slot: "export-menu", hide_csv: this.hide_csv_export, hide_pdf: this.hide_pdf_export, onAtChange: (event) => this.handleExport(event) })), this.shouldShowColumnManager && (h("at-column-manager", { key: '6ba365aa005becd09263d1901a38bd8e0f275e52', slot: "column-manager", col_defs: this.col_defs, onAtChange: (event) => this.handleColumnChange(event) })), h("div", { key: 'd49bb365891b39113788a8b353d3c95306bc20db', slot: "actions" }, h("slot", { key: '0e769e4c9f45b48bd4e6c28c4dc776af9044f8ab', name: "actions" }))), h("slot", { key: 'ec466868a2b1612e5ca0f71e29174d9ca3ea07f2', name: "multi-select-actions" }), h("div", { key: '97afd91ff6ce3199bc7710be8ecbaa155fd713ed', class: "relative" }, h("at-table", { key: 'f1b2b38a13b50a7a449bdbec80e836e67f4b577a', ref: (el) => (this.tableEl = el), table_data: this.table_data, col_defs: this.col_defs, page_size: this.server_side_mode
                ? this.pageSize
                : this.page_size, use_custom_pagination: this.server_side_mode, use_custom_sorting: this.server_side_mode, auto_size_columns: this.auto_size_columns, disable_auto_init: !this.server_side_mode }), this.server_side_mode && (h("div", { key: '1b848cad03166c44845d9e722c5f501231047642', class: `loading-overlay bg-surface-foreground/80 absolute inset-0 z-10 items-center justify-center py-120 ${this.showLoadingOverlay ? 'is-visible' : ''}` }, h("div", { key: 'e41ae8e39cf954cff4977a6b0c064f3f06518466', class: "flex items-center" }, h("at-loading", { key: '838da369e4229e9599f83e61e89b5b5e74c5aa40', class: "relative mr-8", size: "sm", "data-name": "placeholder-spinner" }), h("span", { key: '7063be931b26d843631ec606ee56484eecdab874', class: "text-secondary text-sm font-medium", "data-name": "placeholder-title" }, this.translations?.ATUI?.TABLE
            ?.LOADING_DATA)))), this.server_side_mode && (h("div", { key: '27968ae4a2cab155a242f642a71a8a1d8db6f5f3', class: `no-data-overlay absolute inset-0 z-10 flex-col items-center justify-center gap-8 py-120 ${!this.loading && this.hasNoData ? 'is-visible' : ''}` }, h("at-icon", { key: '0c53234aa9f5eddb5da0cd7ab8cd3366c99c30f4', class: "fill-slate-300", name: this.hasActiveSearch
                ? 'search'
                : 'data_table', size: "sm", "data-name": "no-data-icon" }), h("span", { key: 'd5a2e887c5cfac4e999525d1bae042f27bcbb821', class: "text-secondary text-sm font-medium", "data-name": "no-data-title" }, this.hasActiveSearch
            ? this.translations?.ATUI?.NO_RESULTS_FOUND
            : (this.no_data_message ??
                this.translations?.ATUI?.TABLE?.NO_DATA))))), this.server_side_mode && (h("at-table-pagination", { key: 'a64bcd33a3f8184e48a794c72eeb4ed31891831b', current_page: this.currentPage, num_pages: this.totalPages, onAtChange: (event) => this.handlePageChange(event), onAtPageSizeChange: (event) => this.handlePageSizeChange(event) }))));
    }
