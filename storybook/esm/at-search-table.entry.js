...
const AtSearchTable = class {
    ...
    render() {
        return (h(Host, { key: '521dd14008db9a90ffc347290e90f1e07e13fba8', class: this.server_side_mode ? 'is-loading' : '' }, h("at-table-actions", { key: 'e3a1f35c7164c9f553e1d249953018896a1499b7', ag_grid: this.agGrid }, h("at-control-group", { key: '90feb70babc3306935f453d04c0a78f3eba85c88', slot: "search" }, this.shouldShowTableFilters &&
            !this.search_filters && (h("at-table-filter-menu", { key: 'c0cbfce89f5d2e54d6396a67bc773c535d479099', ref: (el) => (this.filterMenuEl =
                el), col_defs: this.col_defs, filters: this.selectedFilters, onAtChange: (event) => this.handleFilterChange(event) })), h("at-search", { key: '8f03b1da800846aabfcb2b554c137d0f9b0f40b5', class: "w-input-md", info_text: this.searchInfoTooltip, placeholder: this.translations.ATUI.TABLE.SEARCH_BY_KEYWORD, onAtChange: (event) => this.handleSearchChange(event) })), this.shouldShowTableFilters && (h("at-table-filters", { key: '43aa733b813ac9f32f94b786157b9da3156164af', slot: "filters", filters: this.selectedFilters, onAtChange: (event) => this.handleFilterChange(event), onAtFilterClick: () => this.filterMenuEl?.openMenu() })), this.show_reload_button && (h("at-reload-button", { key: 'd5638aeebeeacfa4a9bc32bcea8ea7acefefcbe4', slot: "reload-button", has_updates: this.has_updates, onAtuiReload: (event) => {
            ...
            } })), this.show_export_menu && (h("at-table-export-menu", { key: 'f622b79878df789c96756996053a955cdc65c6c0', slot: "export-menu", show_csv: this.show_csv_export, show_pdf: this.show_pdf_export, onAtChange: (event) => this.handleExport(event) })), this.shouldShowColumnManager && (h("at-column-manager", { key: 'da5d0e46a3d881009fe037552c35e54a26bd648f', slot: "column-manager", col_defs: this.col_defs, onAtChange: (event) => this.handleColumnChange(event) })), h("div", { key: 'be1ef6b1a27bc9fc3af2d97c7441a254d840d712', slot: "leading-actions" }, h("slot", { key: '95c7375f317a93e6ccdfa799abdbff5b835bda56', name: "leading-actions" })), h("div", { key: '2acec49ab289ad81cfb1bdac49ac1fc78d061dee', slot: "actions" }, h("slot", { key: '8551dfce947d13c0996421c3abdf9d63f36bbde7', name: "actions" }))), h("slot", { key: '0413f685eb0f76f6e5986dac65a341db88aac749', name: "multi-select-actions" }), h("div", { key: '9b0bde747d85aede4dad86bf498996a18eb7ce5a', class: "relative" }, h("at-table", { key: '4fc7b7459acf8d3ab93ed80f30c436bd420999bf', ref: (el) => (this.tableEl = el), table_data: this.table_data, col_defs: this.col_defs, page_size: this.server_side_mode
                ? this.pageSize
                : this.page_size, use_custom_pagination: this.server_side_mode || this.use_custom_pagination, use_custom_sorting: this.server_side_mode, auto_size_columns: this.auto_size_columns, can_auto_init: this.server_side_mode, onAtColumnVisibilityChange: (event) => this.syncColumnVisibility(event) }), this.server_side_mode && (h("div", { key: 'cc48f454f895b89ed976e2e0f434a989f243be20', class: `loading-overlay bg-surface-foreground/80 absolute inset-0 z-10 items-center justify-center py-120 ${this.showLoadingOverlay ? 'is-visible' : ''}` }, h("div", { key: 'ac3f62b96402eabbe66e20280b17a67c5cb6ec40', class: "flex items-center" }, h("at-loading", { key: '2c45f54835a996b326b4b71c5ca5cac227ec2aae', class: "relative mr-8", size: "sm", "data-name": "placeholder-spinner" }), h("span", { key: '01ddd4071c2a6b9b966830f3fc5d1816ee113d7f', class: "text-secondary text-sm font-medium", "data-name": "placeholder-title" }, this.translations?.ATUI?.TABLE
            ?.LOADING_DATA)))), this.server_side_mode && (h("div", { key: '9369031b89f671f802a4dceda18e0a44e5b6f4ef', class: `no-data-overlay absolute inset-0 z-10 flex-col items-center justify-center gap-8 py-120 ${!this.is_loading && this.hasNoData ? 'is-visible' : ''}` }, h("at-icon", { key: '244fd5a75e45365a88852ab15d872ab09b59476e', class: "fill-slate-300", name: this.hasActiveSearch
                ? 'search'
                : 'data_table', size: "sm", "data-name": "no-data-icon" }), h("span", { key: 'b335cec793f7d0b50af45ad4f213d33e7a19cbed', class: "text-secondary text-sm font-medium", "data-name": "no-data-title" }, this.hasActiveSearch
            ? this.translations?.ATUI?.NO_RESULTS_FOUND
            : (this.no_data_message ??
                this.translations?.ATUI?.TABLE?.NO_DATA))))), this.server_side_mode && (h("at-table-pagination", { key: '8b627ae34694b1a0920dd6fc6e51c75bf179e014', current_page: this.currentPage, num_pages: this.totalPages, page_size: this.pageSize, page_size_options: this.page_size_options, onAtChange: (event) => this.handlePageChange(event), onAtPageSizeChange: (event) => this.handlePageSizeChange(event) }))));
    }
