...
const AtSearchTable = class {
    ...
    render() {
        return (h(Host, { key: '5f1666215d4acecacfbe427bf632d97abb2f8f65' }, h("at-table-actions", { key: '3095738d2c5cf53e464a6e0272c11c2e7539dd3c', ag_grid: this.agGrid }, h("div", { key: '31223277414508fd014aa1f2be3703ffa9187d25', class: "flex items-center gap-8 px-8", slot: "search" }, this.shouldShowDropdownFilters && (h("at-table-filter-menu", { key: '4ce8df666a81a9d863334b6feb536c83a6240e38', slot: "filter-menu", col_defs: this.col_defs, selected: this.menuSelectedIds, onAtChange: (event) => this.handleFilterChange(event) })), h("at-search", { key: 'e5aa6d92265f0b37c34d39f16fe1ef8889476a97', class: "w-input-md", label: this.search_label, hint_text: this.search_hint, info_text: this.search_info_tooltip, placeholder: this.translations.ATUI.TABLE.SEARCH_BY_KEYWORD, onAtChange: (event) => this.handleSearchChange(event) })), this.shouldShowDropdownFilters && (h("at-table-filters", { key: '3a555cdd5f11e87ffd8a1d472121501d0b68c016', slot: "filters", col_defs: this.col_defs, selected: this.selectedFilters, onAtChange: (event) => this.handleFilterChange(event) })), !this.hide_export_menu && (h("at-table-export-menu", { key: '426338e9059c2bdaa0ae1f96e0368b580eeb08a7', slot: "export-menu", hide_csv: this.hide_csv_export, hide_pdf: this.hide_pdf_export, onAtChange: (event) => this.handleExport(event) })), this.shouldShowColumnManager && (h("at-column-manager", { key: 'd92959c71fe7a73f73aafbee239b2a826a0a43ca', slot: "column-manager", col_defs: this.col_defs, onAtChange: (event) => this.handleColumnChange(event) })), h("div", { key: 'a25a480e08ca3c344b02bce7b11ccea1eff7c0d1', slot: "actions" }, h("slot", { key: '6af26428037f4806318f76a4b4223b2cbddacd04', name: "actions" }))), h("slot", { key: 'e76a2d3fac8c3d20382f504c16f77d5795331e64', name: "multi-select-actions" }), this.loading && this.server_side_mode ? (h("at-placeholder", { size: "lg", placeholder_title: this.translations?.ATUI?.TABLE?.LOADING_DATA, show_loading_spinner: true })) : (h("at-table", { ref: (el) => (this.tableEl = el), table_data: this.table_data, col_defs: this.col_defs, page_size: this.server_side_mode
                ? this.pageSize
                : this.page_size, use_custom_pagination: this.server_side_mode, auto_size_columns: this.auto_size_columns, disable_auto_init: !this.server_side_mode })), this.server_side_mode && (h("at-table-pagination", { key: 'a74299413b5a42ff88f0f9f85aa3e6651f221b6a', current_page: this.currentPage, num_pages: this.totalPages, onAtChange: (event) => this.handlePageChange(event), onAtPageSizeChange: (event) => this.handlePageSizeChange(event) }))));
    }
