...
const AtSearchTable = class {
    ...
    render() {
        return (h(Host, { key: '8b458b45eb5c48f46b754f53bcd4ffd16828dfc3' }, h("at-table-actions", { key: 'ce6c886f7927a95438d4130ab09a01737df45a2b', ag_grid: this.agGrid }, h("div", { key: 'd0e8461d13de2c24b1983ed39f1536fcd0657a37', class: "flex items-center gap-8", slot: "search" }, this.shouldShowDropdownFilters && (h("at-table-filter-menu", { key: '528283b039c72827f633bfca5006df2214eaa38b', slot: "filter-menu", col_defs: this.col_defs, selected: this.menuSelectedIds, onAtChange: (event) => this.handleFilterChange(event) })), h("at-search", { key: 'c60a4528f4e78689e2899ae0cfbfc4e57438cad4', class: "w-input-md", label: this.search_label, hint_text: this.search_hint, info_text: this.search_info_tooltip, placeholder: this.translations.ATUI.TABLE.SEARCH_BY_KEYWORD, onAtChange: (event) => this.handleSearchChange(event) })), this.shouldShowDropdownFilters && (h("at-table-filters", { key: 'd716dea12f048dd593d6c49b880e43b6d45327c3', slot: "filters", col_defs: this.col_defs, selected: this.selectedFilters, onAtChange: (event) => this.handleFilterChange(event) })), !this.hide_export_menu && (h("at-table-export-menu", { key: '619edbf88351eca1219d02a8c5422e9d903cc3eb', slot: "export-menu", hide_csv: this.hide_csv_export, hide_pdf: this.hide_pdf_export, onAtChange: (event) => this.handleExport(event) })), this.shouldShowColumnManager && (h("at-column-manager", { key: '053ad77e5a4a1c561e93a4b4759b5846db65a82c', slot: "column-manager", col_defs: this.col_defs, onAtChange: (event) => this.handleColumnChange(event) })), h("div", { key: 'f89c9422ec874c6ad21fd9141fe9c4afc03f3aed', slot: "actions" }, h("slot", { key: '55284c872318e71f86eb706821b2a08f8fa908a8', name: "actions" }))), h("slot", { key: 'aaae7adb2241ac818a1ce6ede6dd5b81ad4b5808', name: "multi-select-actions" }), this.loading && this.server_side_mode ? (h("at-placeholder", { size: "lg", placeholder_title: this.translations?.ATUI?.TABLE?.LOADING_DATA, show_loading_spinner: true })) : (h("at-table", { ref: (el) => (this.tableEl = el), table_data: this.table_data, col_defs: this.col_defs, page_size: this.server_side_mode
                ? this.pageSize
                : this.page_size, use_custom_pagination: this.server_side_mode, auto_size_columns: this.auto_size_columns, disable_auto_init: !this.server_side_mode })), this.server_side_mode && (h("at-table-pagination", { key: '84dac2ad4041ca2b9c748acc8241c43d52e1784e', current_page: this.currentPage, num_pages: this.totalPages, onAtChange: (event) => this.handlePageChange(event), onAtPageSizeChange: (event) => this.handlePageSizeChange(event) }))));
    }
