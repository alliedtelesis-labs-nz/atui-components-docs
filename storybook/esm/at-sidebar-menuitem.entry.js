...
const AtSidebarMenuitemComponent = class {
    ...
    render() {
        return (h(Host, { key: 'afa8d4c9fad6a3789efe681e7fb899267888b34d', role: this.is_trigger ? 'presentation' : 'menuitem', "data-state": this.is_active ? 'active' : 'inactive', tabIndex: this.is_trigger ? undefined : 0, onKeyDown: this.is_trigger
                ? undefined
                : (event) => this.handleKeyDown(event), onClick: (event) => this.handleClick(event), "aria-current": this.is_active ? 'page' : undefined }, h("div", { key: '3d85e39a8176bd19500fbda8e0a89cd018c7b640', class: "content", "data-name": "content" }, h("slot", { key: '2ffe961d65e8644b0b42ccbdeff795d0fc4e430c', name: "icon", "data-name": "icon" }), this.icon && this.renderIcon(), h("slot", { key: '1ce76b901800dd6a19c92813b16ab427d35cb6b9', name: "label", "data-name": "label" }), this.label && (h("span", { key: 'e67f2386104671f148f3e634b91a7a82712bd008', "data-name": "sidebar-menu-item-label", class: "label" }, this.label)), this.badge && (h("at-badge", { key: 'f4e5fdce400ae5cfd768c0c2da67c7879af9418d', class: "badge", "data-name": "sidebar-menu-item-badge", role: "presentation", type: "error", impact: "high", rounded: false, label: this.badge }))), h("slot", { key: '89ec2d53f23f746cc929ea5dfe55d49bf285be1b', name: "sidebar-menu-item-actions" })));
    }
};
