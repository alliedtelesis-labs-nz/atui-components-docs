...
const AtSidebarMenuitemComponent = class {
    ...
    render() {
        return (h(Host, { key: '929f9222cfad1983c6b2503579e227b23a243808', role: this.is_trigger ? 'presentation' : 'menuitem', "data-state": this.is_active ? 'active' : 'inactive', tabIndex: this.is_trigger ? undefined : 0, onKeyDown: this.is_trigger
                ? undefined
                : (event) => this.handleKeyDown(event), onClick: (event) => this.handleClick(event), "aria-current": this.is_active ? 'page' : undefined }, h("div", { key: 'fffec24416fcdf372505dcfb38a64a81fe681d53', class: "content", "data-name": "content" }, h("slot", { key: 'ccb5add33948aaf2bfc49230f609fafbf94e8867', name: "icon", "data-name": "icon" }), this.icon && this.renderIcon(), h("slot", { key: '74d833d2b3e4ccc67a108f037561adc1fa5d531f', name: "label", "data-name": "label" }), this.label && (h("span", { key: '90f7b9c5fc83c93f2102590e56e5e59dfeae8f23', "data-name": "sidebar-menu-item-label", class: "label" }, this.label)), this.badge && (h("at-badge", { key: '8274a33687ed314643ef9343c3e69ef6516d8a02', class: "badge", "data-name": "sidebar-menu-item-badge", role: "presentation", type: "error", impact: "high", rounded: false, label: this.badge }))), h("slot", { key: '0ca72fdcb19e156d261f9f028e72ea9fc7eae4e6', name: "sidebar-menu-item-actions" })));
    }
};
