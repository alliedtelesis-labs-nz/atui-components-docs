...
const AtSidebarMenuitemComponent = class {
    ...
    render() {
        return (h(Host, { key: 'fd841fb869a8c813e39c9958ac513e83676762b4', role: "menuitem", "data-state": this.is_active ? 'active' : 'inactive', tabIndex: 0, onKeyDown: (event) => this.handleKeyDown(event), onClick: (event) => this.handleClick(event) }, h("div", { key: 'f39cc4aab4a1fc79ad9870934b1a5e6d72494b98', class: "content", "data-name": "content" }, h("slot", { key: '7e6c945851cc18bc006ddf908587941f8a494a63', name: "icon", "data-name": "icon" }), h("slot", { key: '63f14d698da0766a3c1086d96175c1251ad8c8a0', name: "label", "data-name": "label" }), this.badge && (h("at-badge", { key: '8c219f78b47182db4ddab9925b444918eb057769', class: "badge", "data-name": "sidebar-menu-item-badge", role: "presentation", type: "error", impact: "high", rounded: false, label: this.badge })), this.icon && this.renderIcon(), this.label && (h("span", { key: '42a1c3428bb6dbb2820c69b9c8922dcd6967c31b', "data-name": "sidebar-menu-item-label", class: "label" }, this.label))), h("slot", { key: '53726d76298055f229bb6633d85ac7199dedf9a6', name: "sidebar-menu-item-actions" }), h("div", { key: '93a000347c94c2f07353af5e811d2ac696d1fec0', class: "focus-indicator", "data-name": "focus-indicator", role: "presentation" })));
    }
};
