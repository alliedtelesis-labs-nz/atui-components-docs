...
const AtSidebarMenuitemComponent = class {
    ...
    render() {
        return (h(Host, { key: '41afc631ab0f94f562ff76fb3fc7d4253b371a46', role: this.is_trigger ? 'presentation' : 'menuitem', "data-state": this.is_active ? 'active' : 'inactive', tabIndex: this.is_trigger ? undefined : 0, onKeyDown: this.is_trigger
                ? undefined
                : (event) => this.handleKeyDown(event), onClick: (event) => this.handleClick(event), "aria-current": this.is_active ? 'page' : undefined }, h("div", { key: 'bfbd9d3c0bb25d709ba99973cc676206ee1215d3', class: "content", "data-name": "content" }, h("slot", { key: '464bddfad4223c04160273c6f3d29df3b8480d91', name: "icon", "data-name": "icon" }), this.icon && this.renderIcon(), h("slot", { key: 'bfdc65f14b07cd91cd2b4cede125964716e95a9c', name: "label", "data-name": "label" }), this.label && (h("span", { key: 'b244b5d5c333dca66ff1773ee6a0df37f360815d', "data-name": "sidebar-menu-item-label", class: "label" }, this.label)), this.badge && (h("at-badge", { key: 'bd0cf0c60acebeeb33b7de7d13990e132a4cc581', class: "badge", "data-name": "sidebar-menu-item-badge", role: "presentation", type: "error", impact: "high", rounded: false, label: this.badge }))), h("slot", { key: '56b85b4ce1dee6e4020afc24b25d3a125c914b17', name: "sidebar-menu-item-actions" })));
    }
};
