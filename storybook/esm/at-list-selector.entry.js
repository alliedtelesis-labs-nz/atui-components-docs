...
const AtListSelector = class {
    ...
    render() {
        return (h(Host, { key: 'ffcc8668e4caec45173161237412fa537cd64800', onKeyDown: (event) => this.handleKeyDown(event) }, h("slot", { key: '44b943aae8b832eaf93c9a8c31f43e082ebaccb5', name: "header" }), !!this.options.length && (h("nav", { key: '6bf12a2973a8b0d544f2da29b83c919e6c59b828', class: "flex-fill overflow-visible pb-16" }, h("div", { key: '626fcf0322fc98a1affdf636f61a1552debec8f0', class: "flex flex-col", role: "menu" }, this.getListItems))), h("slot", { key: 'cad95df873240f279ba02c1a39d155cf5ef51bcf' })));
    }
};
