...
const AtListSelector = class {
    ...
    render() {
        return (h(Host, { key: '6d50a54f015e5b2996202b282413f443e3cafe8f', onKeyDown: (event) => this.handleKeyDown(event) }, h("slot", { key: '6b620a1b0211bf815c2f9be14977fdb4e2e6e440', name: "header" }), !!this.options.length && (h("nav", { key: '18efd4dd6143da54f7774c62f0e10716c8b5f87a', class: "flex-fill overflow-visible pb-16" }, h("div", { key: '6ff6838dbefc3603378c453ffcd2246e316acf24', class: "flex flex-col", role: "menu" }, this.getListItems))), h("slot", { key: 'ec7027a93e3d61ee51a4aaeda0acca4e90ee8287' })));
    }
};
