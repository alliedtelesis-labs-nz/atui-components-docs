...
const AtListSelector = class {
    ...
    render() {
        return (h(Host, { key: '879b999e4ea0fa0792579b7233b1e4326833f4d1', onKeyDown: (event) => this.handleKeyDown(event) }, h("slot", { key: '47b520cba372ee98edd0dfdc1c035281ffdb9874', name: "header" }), !!this.options.length && (h("nav", { key: 'f1ecf26fb27ff10fb2f8912b7be563eb0c6d83ea', class: "flex-fill overflow-visible pb-16" }, h("div", { key: 'c7530e2b7eda34a32fe3e10c06f49f5deff4eb5f', class: "flex flex-col", role: "menu" }, this.getListItems))), h("slot", { key: '4e8fc923ceb3ec495819dfd0c1cd4a91f7d645c2' })));
    }
};
