...
const AtListSelector = class {
    ...
    render() {
        return (h(Host, { key: 'd3e3acdf1448a01096f38f3c7c6cc547355507a0', onKeyDown: (event) => this.handleKeyDown(event) }, h("slot", { key: 'a507babe1c283d8ae489169ddcce7eeccf4ffc8d', name: "header" }), !!this.options.length && (h("nav", { key: 'e6b891171727bdb949904198d23a7b1b80f602a3', class: "flex-fill overflow-visible pb-16" }, h("div", { key: '4a87081ee81f552a44514c3f97b244caea38f9a8', class: "flex flex-col", role: "menu" }, this.getListItems))), h("slot", { key: 'fc20560fcd4722a8bdca9220eea15b56bce90b4d' })));
    }
};
