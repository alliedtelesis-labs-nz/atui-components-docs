...
const AtSidebarProviderComponent = class {
    constructor(hostRef) {
        ...
        this.atuiSidebarProviderChange = createEvent(this, "atuiSidebarProviderChange", 7);
        this.atuiSidebarBackdropChange = createEvent(this, "atuiSidebarBackdropChange", 7);
    }
...
export { AtSidebarProviderComponent as at_sidebar_provider };
