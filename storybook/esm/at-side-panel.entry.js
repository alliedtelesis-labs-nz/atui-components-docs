...
const AtSidePanelComponent = class {
    ...
    render() {
        return (h(Host, { key: 'b6e8dba8161c3895176599eec004218504e45c0a', "data-open": this.isOpen }, h("dialog", { key: '88924e069415260f26e73346375c6f8fd54a2f5b', ref: (el) => (this.panelDialog = el), class: `${this.backdrop ? 'backdrop' : ''}`, onClose: this.handleDialogClose, onKeyDown: this.handleKeyDown }, h("div", { key: '35398bd4e38c93e19f617e1a374d0fd4405af7c7', "data-scrollable": this.has_scrollbar, "data-open": this.isOpen, class: `container origin-${this.origin} width-${this.size} size-${this.size} position-${this.position}`, ref: (el) => (this.sidePanelWrapper = el), "data-name": "container" }, h("header", { key: 'd0ec1b85b76b994ae951892653667d9cf99289f2', class: "header", "data-name": "header" }, h("div", { key: '7108299327c69d477916ada90136a6757244d4d9' }, h("slot", { key: '550721853524477cbec6ee7bb6b3f2a0b19367ce', name: "title" }), this.panel_title && (h("h3", { key: 'bf48578eefa3d337a82e941467af310b27e0ed95', class: "title" }, this.panel_title)), this.panel_subtitle && (h("p", { key: '06adcf766b0dceed010a1c23e19f35abeea5500b', class: "subtitle" }, this.panel_subtitle))), h("div", { key: '879f8c2630a5896656f2a217e1a5b90fa1b3bfb5' }, h("slot", { key: 'd67e877e638812d80b5819e5a72820eb1a5c78ac', name: "actions" }), this.has_close_button && (h("at-button", { key: 'e656f84b6804097da1dfcfdbe4995165b7429add', size: "md", type: "secondaryText", "data-name": "panel-close", onClick: this.handleClose }, h("at-icon", { key: '4329f6e8a922ed0ef4b202517490e1309b75bef0', slot: "icon", name: "close" }))))), h("div", { key: 'bedb2d0ccb4c19f15b16b638925d6043a18e6341', "data-name": "content", class: "content" }, h("slot", { key: '4d776dd1ed9d7f74e03834777f341834673392ed' }))))));
    }
};
