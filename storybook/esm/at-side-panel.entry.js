...
const AtSidePanelComponent = class {
    ...
    render() {
        return (h(Host, { key: '378901b129aca12c8dde8faed3f76dfd0d3160f7', "data-open": this.isOpen }, h("dialog", { key: '5669a9abc2e9491c97d9212bdffe599ccb101c0b', ref: (el) => (this.panelDialog = el), class: `${this.backdrop ? 'backdrop' : ''}`, onClose: this.handleDialogClose, onKeyDown: this.handleKeyDown }, h("div", { key: '5f9dd9ac052612d63628af29a8657839ca466360', "data-scrollable": this.has_scrollbar, "data-open": this.isOpen, class: `container origin-${this.origin} width-${this.size} size-${this.size} position-${this.position}`, ref: (el) => (this.sidePanelWrapper = el), "data-name": "container" }, h("header", { key: 'fd831afc5545661ad85c5eac5ea1630b3aa5d3ca', class: "header", "data-name": "header" }, h("div", { key: 'f540da2f1540af9784fb57e5e2c81572dcce649f' }, this.panel_title && (h("h3", { key: '1c317876caa139fdd357822303f6c5802dcc73d8', class: "title" }, this.panel_title)), this.panel_subtitle && (h("p", { key: 'b103d7ac4030201fae12bae3b1124f0884311bb1', class: "subtitle" }, this.panel_subtitle))), this.has_close_button && (h("at-button", { key: 'f8543389a615c20f99c7c3cd31191cf55b063bf6', size: "md", type: "secondaryText", "data-name": "panel-close", onClick: this.handleClose }, h("at-icon", { key: 'f865c21cd2b0e04297ce65f7f8d5f23846e7a5a6', slot: "icon", name: "close" })))), h("div", { key: 'd17068b7a8c478e0f513a6ea5f5cd741c536bc52', "data-name": "content", class: "content" }, h("slot", { key: '9c5d339f72f0a813d63fcee614e2fab1219eaa90' }))))));
    }
};
