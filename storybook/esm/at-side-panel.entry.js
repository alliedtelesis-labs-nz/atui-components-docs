...
const AtSidePanelComponent = class {
    ...
    render() {
        return (h(Host, { key: 'fb7beda54b0b42ae9b3db3bc8d008b24f11c0f22', "data-open": this.isOpen }, h("dialog", { key: '93eb0e4c0c634cf349b34f4e438182349f5235a8', ref: (el) => (this.panelDialog = el), class: `${this.backdrop ? 'backdrop' : ''}`, onClose: this.handleDialogClose, onKeyDown: this.handleKeyDown }, h("div", { key: 'df1daf4af3fe49c863bc869bba53ffb1c4caa8b0', "data-scrollable": this.has_scrollbar, "data-open": this.isOpen, class: `container origin-${this.origin} width-${this.size} size-${this.size} position-${this.position}`, ref: (el) => (this.sidePanelWrapper = el), "data-name": "container" }, h("header", { key: 'd1514ca63b50d48335f783c5ff7f19f7143e242d', class: "header", "data-name": "header" }, h("div", { key: '009e5d037e52d256d9dae869d2b391ec350c5ff5' }, h("slot", { key: 'ffc0170a27dfd24d919d922a3b7882f283143e46', name: "title" }), this.panel_title && (h("h3", { key: '0915def11ac5abbf5c33a94593765b1949b7586f', class: "title" }, this.panel_title)), this.panel_subtitle && (h("p", { key: '2609fc188cbf46d9f7b3b8ad5abd49b7077e205e', class: "subtitle" }, this.panel_subtitle))), h("div", { key: '0c835ddf644be26b096b0f5c42c4f71f9b341c7e' }, h("slot", { key: '078e1b42d7ad5140669d5861f39e6238e8e88680', name: "actions" }), this.has_close_button && (h("at-button", { key: '38e8b7c550a60807887cb116282e0b3955d6759a', size: "md", type: "secondaryText", "data-name": "panel-close", onClick: this.handleClose }, h("at-icon", { key: '0019eb0357874c29e33f549994af27699b40454d', slot: "icon", name: "close" }))))), h("div", { key: 'c557c0ae32ee769e88dd831c67b338956299a9ac', "data-name": "content", class: "content" }, h("slot", { key: '246a8ebf8c067b45a0fe6b5f05d51a7b6a232ec0' }))))));
    }
};
