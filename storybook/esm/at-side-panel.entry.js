...
const AtSidePanelComponent = class {
    ...
    render() {
        return (h(Host, { key: '45c0e54bcee87eb829c24e231e8555417e7b8fb6', "data-open": this.isOpen }, h("dialog", { key: 'e7036917954c7da54ff532c406c1e414bdfc3d43', ref: (el) => (this.panelDialog = el), class: `${this.backdrop ? 'backdrop' : ''}`, onClose: this.handleDialogClose, onKeyDown: this.handleKeyDown }, h("div", { key: '39790b1520675e650364c271bf5f6553f2fe6908', "data-scrollable": this.has_scrollbar, "data-open": this.isOpen, class: `container origin-${this.origin} width-${this.size} size-${this.size} position-${this.position}`, ref: (el) => (this.sidePanelWrapper = el), "data-name": "container" }, h("header", { key: 'cafa3318cacec3607d287c6a0f50cedcc975ae4e', class: "header", "data-name": "header" }, h("div", { key: 'c9a70da236f268084c6548541a365f42be1f1552' }, h("slot", { key: '63949000e83d752216b77abba3ffecbe89c00c2c', name: "title" }), this.panel_title && (h("h3", { key: 'cf38e0512df0b3822c7d396fbe29efd3af4a774d', class: "title" }, this.panel_title)), this.panel_subtitle && (h("p", { key: 'a32a477bad341b5e27fe8f39afdf84b7ce641b85', class: "subtitle" }, this.panel_subtitle))), h("div", { key: 'cdbd52465e5a6414f7b3e0598d406025428c94ff' }, h("slot", { key: '79fd48f8e37987d6a14b30b430104bfe02f9a25a', name: "actions" }), this.has_close_button && (h("at-button", { key: '06a44e51292212023f3e479dd2dae66f280f1ce7', size: "md", type: "secondaryText", "data-name": "panel-close", onClick: this.handleClose }, h("at-icon", { key: '38b8083df6afbdc8ad6b5ec528308cb661af01c6', slot: "icon", name: "close" }))))), h("div", { key: '4b16842f711a200a7c5b5f86c9fbc98158665e18', "data-name": "content", class: "content" }, h("slot", { key: '414dfbf6eee4bbf633908a630062ee44948e5d5e' }))))));
    }
};
