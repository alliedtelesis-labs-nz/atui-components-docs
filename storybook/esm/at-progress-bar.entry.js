...
const AtProgressBar = class {
    ...
    renderDeterminate() {
        ...
        return (h(Host, { role: "progressbar", "aria-valuemin": "0", "aria-valuemax": "100", "aria-valuenow": this.clamped, class: this.statusBarClass }, h("slot", { name: "label-before" }), h("div", { class: "flex w-full flex-1 items-stretch justify-start overflow-hidden rounded-full" }, h("div", { class: `${this.segments} ${fillClass(this.type)}`, style: {
