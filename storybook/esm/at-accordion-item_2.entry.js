...
const AtAccordionItemComponent = class {
    ...
    render() {
        return (h(Host, { key: '5727b763ace551d58b4171a35e5328d9638e1667', "data-name": this.item_id, "data-state": this.open ? 'expanded' : 'collapsed' }, h("details", { key: 'dc016406de8ee5f209e5b670efc7a9b3f6dbd035', class: `group/accordion-item'}`, ref: (el) => (this.accordionElement = el), role: "group", open: this.open }, h("summary", { key: '526727699a2d86e638bbda6fec1839e6aeb7ebaf', id: `trigger-${this.item_id}`, role: "button", "aria-expanded": this.open, "data-state": this.open ? 'expanded' : 'collapsed', class: "group/accordion-item focus-within:ring-active-glow flex rounded-sm outline-0 focus-within:ring", onClick: (event) => this.handleSummaryInteraction(event), onTouchEnd: (event) => this.handleSummaryInteraction(event), "aria-controls": `content-${this.item_id}` }, this.label && (h("at-accordion-trigger", { key: '06a1d41ccc0416fef546a172e860f2e4d0b97119', label: this.label })), h("slot", { key: 'c6daf83eeb8962e51c6a7e1fcb6650a0386e281c', name: "accordion-trigger" })), h("div", { key: '591636f99b1967742dd41c84663e862704bcd696', id: `content-${this.item_id}`, "aria-labelledby": `trigger-${this.item_id}`, class: "accordion-item-content", "data-name": "accordion-item-content" }, this.content && (h("div", { key: '4805fed545394bb51dbf416853bba212f7113833', class: "flex flex-col p-16 leading-normal" }, this.content)), h("slot", { key: 'cbcc8bbf24611a2fde725bac8d038c131c377953' })))));
    }
};
