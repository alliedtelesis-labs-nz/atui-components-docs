...
const AtAccordionItemComponent = class {
    ...
    render() {
        ...
        return (h(Host, { key: '6172f3bf1793e58d0f25e5bc868c2bd76bce3782', "data-name": this.item_id, "data-state": this.open ? 'expanded' : 'collapsed' }, h("details", { key: 'd87dceb9acfc6f5c857a73b6e6e9852885efa4e1', class: "group/accordion-item", role: "group", open: this.detailsOpen, ref: (el) => (this.detailsEl = el) }, h("summary", { key: '14c2c864df539bd7cc419206d1ec39d53a6a9923', id: `trigger-${this.item_id}`, role: "button", "aria-expanded": this.open, "aria-disabled": this.disabled ? 'true' : undefined, "data-state": this.open ? 'expanded' : 'collapsed', class: classname, onClick: (event) => this.handleSummaryInteraction(event), onTouchEnd: (event) => this.handleSummaryInteraction(event), onKeyDown: (event) => {
                if (event.key === 'Enter' || event.key === ' ') {
                    this.handleSummaryInteraction(event);
                }
            }, "aria-controls": `content-${this.item_id}` }, this.label && (h("at-accordion-trigger", { key: '15114b095ccf8eafdac775d6584b18f89e7a1de5', label: this.label })), h("slot", { key: '7017199aa18c004242f7742c3a3561fdd0ee51fa', name: "accordion-trigger" })), h("div", { key: '4eff90889db66b0667040bccac439da76d671fd9', id: `content-${this.item_id}`, "aria-labelledby": `trigger-${this.item_id}`, "data-state": this.open ? 'expanded' : 'collapsed', "data-name": "accordion-item-content" }, this.content && (h("div", { key: '3a66d2f0ed774bf080909b928e843a96f8d421fd', class: "flex flex-col p-16 leading-normal" }, this.content)), h("slot", { key: 'f754ddd8864a3eff1c6624c133030f80518d3332' })))));
    }
