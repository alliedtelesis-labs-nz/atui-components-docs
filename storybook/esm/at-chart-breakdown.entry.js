...
import { C as Chart, D as DoughnutController, A as ArcElement, p as plugin_legend, a as plugin_tooltip, i as index, g as getChartColors } from './chart-color-BSsHS4sa.js';
import { A as AtChartColorPalette, r as readChartTextColors, a as readChartTypography } from './chart-color-BeJCqIOU.js';
...
const AtChartBreakdown = class {
    ...
    render() {
        ...
        const typography = showSideText
            ...
            : undefined;
        return (h(Host, { key: 'a033e056c59441a279b97049b1e87519dfa2f620', style: {
                height: '100%',
                width: '100%',
                minHeight: '65px',
                position: 'relative',
            ...
            } }, h("canvas", { key: '45c42ce813cf7cca47bd216f5bc6746353273ce3', class: heightVariants[this.height], style: {
                aspectRatio: '1 / 1',
                flexShrink: '0',
            }, ref: (el) => {
                if (el) {
            ...
            } }), showSideText && (h("div", { key: '7bc63b04613672425a5221355593e74d7e12232f', class: "flex flex-col justify-center ps-8", style: {
                position: 'absolute',
                left: `${this.compactOffset}px`,
            }, ref: (el) => {
                this.sideTextEl = el ?? undefined;
            } }, this.center_value && (h("span", { key: 'e89faf9f63832dfdaff2db870ad0ee899ce01116', style: {
                fontSize: `${typography.valueRem}rem`,
                fontWeight: String(typography.weightBold),
                lineHeight: '1.1',
                color: 'var(--chart-title)',
            } }, this.center_value)), this.center_text && (h("span", { key: '0efaec6d5b4ebea8c4b91ac57221fcdd49dbe86a', style: {
