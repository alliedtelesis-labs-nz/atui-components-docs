...
const AtToggleCell = class {
    ...
    render() {
        return (h(Host, { key: '19372fdb92f5b37d3c16bcbc7609f2844f9f8015', class: "flex h-full items-center leading-[100%]" }, h("at-toggle-switch", { key: '1dfa32848ddaee1b7bbe6b413f9199142dc86bb5', label: this.label, onChange: () => this.params.onTrigger?.(this.params), label_position: this.labelPosition, show_label: !!this.label, value: this.value, disabled: this.disabled })));
    }
};
