...
const AtToggleCell = class {
    ...
    render() {
        return (h(Host, { key: 'e4afa1137cc636e439122d6adfeb164b2c40fe9f', class: "flex h-full items-center leading-[100%]" }, h("at-toggle-switch", { key: 'b475d6f65b6785fb10e73708ade5ee7d21a70d26', label: this.label, onChange: () => this.params.onTrigger?.(this.params), label_position: this.labelPosition, show_label: !!this.label, value: this.value, disabled: this.disabled })));
    }
};
