...
const AtButtonComponent = class {
    ...
    render() {
        ...
        return (h(Host, { key: '9936b2699c71dfc5dbfb836d270d6adf24155d97', class: classname, role: "button", tabIndex: 0, onKeyDown: (event) => this.handleKeyDown(event), onClick: (event) => this.handleClick(event) }, h("div", { key: '532d6eb09cd7ddb663b7f4e1f36edeb2fc9c7eff', class: "z-20 flex h-full w-full items-center justify-center gap-4" }, this.in_progress && (h("at-loading", { key: '0413f6b7ee1efbe9a7988e91a9bda59cdb19d3b5', class: "absolute", size: "sm", type: this.spinnerColour })), h("slot", { key: '2265ac4d49b46bc2fcefeb4c149490b6e0b854f4', name: "icon" }), this.icon && (h("span", { key: '6a8f6f902d386bb501fc468523212176389686d2', class: `material-icons !text-icon-md h-16 w-16 leading-[16px] ${this.in_progress ? 'invisible' : 'visible'}`, "data-name": "button-icon" }, this.icon)), this.label && (h("span", { key: 'bb39b1dab2320cf8395198b02c4ad5e2ad0c0f2c', class: `leading-[16px] ${this.in_progress ? 'invisible' : 'visible'}`, "data-name": "button-label" }, this.label)), h("slot", { key: '3ebb4a7548e06d9fd4f0896bd5e39c76e16afda1' }), h("slot", { key: '0420e7b1940f292c5ea58cf9899d9d0134110c9d', name: "icon_after" }), this.icon_after && (h("span", { key: '05bafd426f25d107d805e9f3332d9ec9ef90523a', class: `material-icons !text-icon-md h-16 w-16 leading-[16px] ${this.in_progress ? 'invisible w-0' : 'visible'}`, "data-name": "button-icon-right" }, this.icon_after))), h("div", { key: '0312cbeb2142bfd4cc48ee425e29b19634cfd995', "data-name": "focus-indicator", role: "presentation", class: focusIndicatorClassname })));
    }
};
