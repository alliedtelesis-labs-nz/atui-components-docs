...
const AtCheckbox = class {
    ...
    render() {
        ...
        return (h(Host, { key: '65468c8a130a46cf6fa0ae47c8b336a0a682b2dc', role: "checkbox", "aria-checked": this.checked, "aria-labelledby": `${this.value}-label`, tabindex: 0, class: classname, "data-name": "checkbox-container", onKeyDown: (event) => (event.key === 'Enter' || event.key === ' ') &&
                this.checkboxEl.click(), onClick: () => this.checkboxEl.click() }, h("input", { key: '35d01b596e917d154192990351c50f46dc3c5dfe', type: "checkbox", class: checkboxClassname, "data-name": "checkbox-input", checked: this.checked, onChange: (event) => this.handleChange(event), id: this.value, tabindex: -1, ref: (el) => (this.checkboxEl = el), disabled: this.disabled }), (this.label || this.hint_text) && (h("div", { key: 'af8c77cdbfa1dab37c737fc68be6ba8303d29d4f', class: "pointer-events-none flex flex-col" }, h("slot", { key: '79442c64809800b367fc38db5e78080646e1063e', name: "label" }), this.label && (h("label", { key: 'e36e92c590073bc051cc1765b25238bc2874e767', class: "mt-0 pl-4 text-xs font-medium", id: `${this.value}-label`, "data-name": "checkbox-label" }, this.label)), this.hint_text && (h("span", { key: '5604de428f90d10f1081d72957895c7a0b64d48a', class: "text-muted mt-0 pl-4 text-xs", "data-name": "checkbox-hint" }, this.hint_text)))), h("slot", { key: 'd1f2de5a302726919b2dc47edf2f2aa6d8c068e9' })));
    }
};
