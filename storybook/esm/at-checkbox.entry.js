...
const AtCheckbox = class {
    ...
    render() {
        ...
        return (h(Host, { key: '8dd85f286b59af5ec043f47884925eea1d55d1cb', role: "checkbox", "aria-checked": this.checked, "aria-labelledby": `${this.value}-label`, tabindex: 0, class: classname, "data-name": "checkbox-container", onKeyDown: (event) => (event.key === 'Enter' || event.key === ' ') &&
                this.checkboxEl.click(), onClick: () => this.checkboxEl.click() }, h("input", { key: '78e593e26e6b18903bd682e6d592bcc00c13e5f1', type: "checkbox", class: checkboxClassname, "data-name": "checkbox-input", checked: this.checked, onChange: (event) => this.handleChange(event), id: this.value, tabindex: -1, ref: (el) => (this.checkboxEl = el), disabled: this.disabled }), (this.label || this.hint_text) && (h("div", { key: '00fb381cba0bdfa1e01fd8d99a99c73d73a7faa1', class: "pointer-events-none flex flex-col" }, h("slot", { key: 'e53ed15227ae6b29aae906f23242e4f4c6f28159', name: "label" }), this.label && (h("label", { key: 'd8fa9950552df60919eb6c3bf02f37a2d2a07520', class: "mt-0 pl-4 text-xs font-medium", id: `${this.value}-label`, "data-name": "checkbox-label" }, this.label)), this.hint_text && (h("span", { key: 'cabdc65139efb8042fb97f33a9d5cc675c6b119b', class: "text-muted mt-0 pl-4 text-xs", "data-name": "checkbox-hint" }, this.hint_text)))), h("slot", { key: 'a4c34c1385e1df1b895f2bbb8b1d89912c17fbe0' })));
    }
};
