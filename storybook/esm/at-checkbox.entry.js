...
const AtCheckbox = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'c1c322d059fc5a60c90e2b0cdc28017c94128ce0', role: "checkbox", "aria-checked": this.checked, "aria-labelledby": `${this.value}-label`, tabindex: 0, class: classname, "data-name": "checkbox-container", onKeyDown: (event) => (event.key === 'Enter' || event.key === ' ') &&
                this.checkboxEl.click(), onClick: () => this.checkboxEl.click() }, h("input", { key: '00918287d30e410f7749a094b44847ce01b54f68', type: "checkbox", class: checkboxClassname, "data-name": "checkbox-input", checked: this.checked, onChange: (event) => this.handleChange(event), id: this.value, tabindex: -1, ref: (el) => (this.checkboxEl = el), disabled: this.disabled }), (this.label || this.hint_text) && (h("div", { key: '9d4e02c810373ddcdfc5fbba0abc28f613c35eea', class: "pointer-events-none flex flex-col" }, h("slot", { key: '1e24dbba1b53bbbfd4bc7c7e475856ba20faaafc', name: "label" }), this.label && (h("label", { key: '96c079ed895bdf55be2ea3aa1fcf05633f030b7d', class: "mt-0 pl-4 text-xs font-medium", id: `${this.value}-label`, "data-name": "checkbox-label" }, this.label)), this.hint_text && (h("span", { key: 'e0261777a5fd8523adc5682bee1f1f6a960d522b', class: "text-light mt-0 pl-4 text-xs", "data-name": "checkbox-hint" }, this.hint_text)))), h("slot", { key: '43b19862a39555a0a63d3c609562a42da20e0d73' })));
    }
};
