...
const AtCheckbox = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'cd810c319a5b811ca0f3a1774304af67d3683d50', role: "checkbox", "aria-checked": this.checked, "aria-labelledby": this.label ? this.labelId : undefined, tabindex: 0, class: classname, "data-name": "checkbox-container", onKeyDown: (event) => (event.key === 'Enter' || event.key === ' ') &&
                this.checkboxEl.click(), onClick: () => this.checkboxEl.click() }, h("input", { key: 'f377244ef3ad8233c2d01627efe0413b28a8e73b', type: "checkbox", class: checkboxClassname, "data-name": "checkbox-input", checked: this.checked, onChange: (event) => this.handleChange(event), id: this.inputId, tabindex: -1, ref: (el) => (this.checkboxEl = el), disabled: this.disabled }), (this.label || this.hint_text) && (h("div", { key: '0e43f3fff8dea2c39169e5e9a0925fadb4be7a6a', class: "pointer-events-none flex flex-col" }, h("slot", { key: '7da9dac2f2a94f5be427d0e6ded3f6ffed8ef6ce', name: "label" }), this.label && (h("label", { key: '0e32c20b8935296c2471fd63072f6f7cfcbe4481', class: "mt-0 pl-4 text-xs font-medium", id: this.labelId, "data-name": "checkbox-label" }, this.label)), this.hint_text && (h("span", { key: '88884a5e02d3425e593eec7c9c9c55a9a594deae', class: "text-muted mt-0 pl-4 text-xs", "data-name": "checkbox-hint" }, this.hint_text)))), h("slot", { key: 'e00c215c9c50bbc1bd661a3f052a28488895cd20' })));
    }
};
