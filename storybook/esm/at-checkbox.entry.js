...
const AtCheckbox = class {
    ...
    render() {
        ...
        return (h(Host, { key: '536548f623dfbf07938904da0ea28e754b30d96d', role: "checkbox", "aria-checked": this.checked, "aria-labelledby": `${this.value}-label`, tabindex: 0, class: classname, "data-name": "checkbox-container", onKeyDown: (event) => (event.key === 'Enter' || event.key === ' ') &&
                this.checkboxEl.click(), onClick: () => this.checkboxEl.click() }, h("input", { key: 'f00917d4fd2ed5efec0c76c855de36f8001a7e48', type: "checkbox", class: checkboxClassname, "data-name": "checkbox-input", checked: this.checked, onChange: (event) => this.handleChange(event), id: this.value, tabindex: -1, ref: (el) => (this.checkboxEl = el), disabled: this.disabled }), (this.label || this.hint_text) && (h("div", { key: 'bbc40f71240aa2eec837ebf965c541da1e9c06fe', class: "pointer-events-none flex flex-col" }, h("slot", { key: '710c502a2c2266880bda399c8fcbeb7ad37ec5fe', name: "label" }), this.label && (h("label", { key: 'eb679c54f876cce29cf0c065fe3697b2ab6f1509', class: "mt-0 pl-4 text-xs font-medium", id: `${this.value}-label`, "data-name": "checkbox-label" }, this.label)), this.hint_text && (h("span", { key: '338ab6cde801d16aec78eca4e327644ee48139c3', class: "text-muted mt-0 pl-4 text-xs", "data-name": "checkbox-hint" }, this.hint_text)))), h("slot", { key: '9a01216b058b379aff6832a38bfe7a8e002beb12' })));
    }
};
