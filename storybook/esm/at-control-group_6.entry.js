import { r as registerInstance, h, H as Host, c as createEvent, a as getElement } from './index-8e2OpwTu.js';
...
const AtControlGroup = class {
    ...
    render() {
        return (h(Host, { key: '4256ad0fb80f22452f09cecc669214b5e9f3ed38', class: `at-control-group at-control-group--${this.direction}` }, h("slot", { key: '063d03dee0172c98fc5ff29708e83a87a27e21c6' })));
    }
};
...
const AtTablePagination = class {
    ...
    atPageSizeChange;
    render() {
        return (h(Host, { key: 'dc62c3700bcce8d932d316f12177ce3845afda1d', class: "mt-8 flex items-center justify-end gap-8" }, h("span", { key: 'e30538e97819a8ac8501c2e2cdae1ff929f5c27d' }, "Page Size: "), h("at-select", { key: 'cf6d9856b56aae5f3d12779b778e715e5fbcd072', options: this.page_size_options, value: String(this.page_size), clearable: false, onAtuiChange: (event) => this.atPageSizeChange.emit(parseInt(event.detail)) }), h("at-button", { key: 'a98ce6b80b5b53d78ab2ba304f2e6e2384ae1840', disabled: this.current_page === 1, type: "secondaryText", onAtuiClick: () => this.atChange.emit(1) }, h("at-icon", { key: '2a5840774ae192dfc83ffbd6edd236dfb37fa0c9', slot: "icon", name: "first_page" })), h("at-button", { key: '275ea264a97a904b851f6ba79ab0f4fb5bf81f83', disabled: this.current_page === 1, type: "secondaryText", onAtuiClick: () => this.atChange.emit(this.current_page - 1) }, h("at-icon", { key: '160be5a6c83b34c7e4eb7022cfcb121ee9c99f36', slot: "icon", name: "chevron_left" })), h("span", { key: '886fa1d5c52e1b4b090784304df1904ba3f0eb90' }, "Page ", this.current_page, " of ", this.num_pages), h("at-button", { key: '11f30cda6f1a2c34a4606b6dfc7b73d25ab8d64c', disabled: this.current_page === this.num_pages, type: "secondaryText", onAtuiClick: () => this.atChange.emit(this.current_page + 1) }, h("at-icon", { key: 'b14331332e0d45277f0c61b30832d808859dea45', slot: "icon", name: "chevron_right" })), h("at-button", { key: '3135ad4cf9707e0beed83ac483c8c2c4a4765f3a', disabled: this.current_page === this.num_pages, type: "secondaryText", onAtuiClick: () => this.atChange.emit(this.num_pages) }, h("at-icon", { key: '53b36bafc0262d61ba5bc905c386131160084299', slot: "icon", name: "last_page" }))));
    }
};
