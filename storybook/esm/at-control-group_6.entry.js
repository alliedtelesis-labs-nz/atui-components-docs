import { r as registerInstance, h, H as Host, c as createEvent, a as getElement } from './index-HD-uhvb8.js';
...
const AtSearch = class {
    ...
    render() {
        return (h(Host, { key: 'decf5793090031833adb05d8e5eb7a46579cc846' }, this.label && (h("at-form-label", { key: '1911f2d518c8856d858a0bb14eb225e98d79dcbf', label: this.label, for: `search-input-${this.label.replace(/\s+/g, '-').toLowerCase()}` })), h("div", { key: 'ca6d0d7bb55a515fdb3121af93570f03738f19a1', class: "transition[background-color,color,box-shadow] border-input bg-input-background focus-within:border-active-accent focus-within:ring-active-glow rounded-input h-input min-h-input relative flex flex-row items-center justify-center border duration-300 ease-in-out focus-within:z-10 focus-within:ring" }, h("at-icon", { key: 'd6f6008dcedc6b906d0772897f5f70602ab5f294', class: "fill-foreground px-8", name: "search" }), h("input", { key: 'dfa4addf3f3c0ab7a790f836b158780665c1e194', id: this.label
                ? `search-input-${this.label.replace(/\s+/g, '-').toLowerCase()}`
                : undefined, role: "searchbox", tabindex: "0", class: "mr-24 h-full w-full bg-transparent p-0 leading-[30px] focus:border-none focus:outline-none", placeholder: this.placeholder, value: this.model, autocomplete: "off", name: "search", onInput: () => this.onChangeFn(), ref: (el) => (this.searchEl = el) }), h("div", { key: '8680c2f0a4789ef5970ebf9011faa4673fea6e8f', class: `transition-all duration-300 ease-in-out ${this.model !== '' && this.model !== undefined
                ? 'pr-4 opacity-100'
                : 'pointer-events-none pr-0 opacity-0'}` }, h("at-button", { key: 'e32a8b1ba1909a1e55eb4e27db8156953d318e00', size: "sm", type: "secondaryText", onClick: () => this.clearFn(), "data-name": "search-clear", tabindex: this.model !== '' && this.model !== undefined
                ? '0'
                : '-1' }, h("at-icon", { key: 'aae16e3160d2fc99605e1b9ba7a242e79c8836b6', slot: "icon", name: "backspace" }))), this.info_text && (h("div", { key: '10f14bb31ac218c6ce50ac31419eb2384ff11bc1', class: "flex items-center pr-8", "data-name": "search-info" }, h("at-tooltip", { key: '3c7a499c0cade58896aa3fd700db359016737cd8', position: "top" }, h("at-icon", { key: 'e09415f0815a93cb33b392cf86cbd9992f48c4c7', slot: "tooltip-trigger", class: "fill-muted cursor-pointer", name: "info", size: "1rem" }), h("span", { key: 'ac0ab50052a6fc8ac0bbf84b8ac70a9f8ef48533' }, this.info_text))))), this.hint_text && (h("span", { key: '8a84116fb09f06050f1f16120f7dd3b3b9804096', class: "text-secondary mt-4 truncate text-xs !leading-normal font-normal empty:hidden", "data-name": "search-hint" }, this.hint_text))));
    }
};
...
const AtTableFilterMenu = class {
    ...
    render() {
        return (h(Host, { key: '4ad296edfb5bd73e3c964c14bbda73b3e778ae20' }, h("at-menu", { key: '9e7200090d4def994af275b5c327b3f6480b9a17', ref: (el) => (this.menuEl = el), autoclose: false, width: "fit-content", class: "self-start", align: "start" }, h("div", { key: '9670e959d173a4f90f8a4bca41358ccc7567be60', class: "relative", slot: "menu-trigger", "data-tooltip": "table-filter-menu" }, this.filters &&
            countFilterConditions(this.filters) > 0 && (h("at-badge", { key: '9e95b6412756d564bbe00fc6c0e9e47482f1f242', class: "absolute top-[-8px] left-[-6px] z-10", type: "info", size: "sm", label: countFilterConditions(this.filters).toString() })), h("at-button", { key: '5ddcd791e0aae069206fba663047075ab0759c51', slot: "tooltip-trigger", type: "secondaryOutline", class: "h-input", "data-name": "filter-menu-trigger" }, h("at-icon", { key: '706f9b74e5131d7eb7bc4f4c73c750f545242ae6', slot: "icon", name: "edit_filters" }))), h("at-tooltip", { key: 'cf2de7fead41b9dd62a1794a16d225e484b30f0e', "trigger-id": "table-filter-menu", position: "top" }, this.translations.ATUI.TABLE.FILTER_DATA), h("at-filter-form", { key: 'b5645f60169854b0fcaf192be52fe335caf0b608', filter_config: this.filterConfig, active_filters: this.filters, onAtSearch: this.handleSearch, onAtCancel: this.handleCancel }))));
    }
};
