import { r as registerInstance, h, H as Host, c as createEvent, a as getElement } from './index-IMi8cNQw.js';
...
const AtTablePagination = class {
    ...
    atPageSizeChange;
    render() {
        return (h(Host, { key: 'cf8244cb851663f5c5c3180be3b92690e8ef8545', class: "mt-8 flex items-center justify-end gap-8" }, h("span", { key: 'd2cc1c3561a430649e9b23b9068bf1074b919164' }, "Page Size: "), h("at-select", { key: 'b91579fdb1564b475486e5381efbac7f65e79518', options: this.resolvedPageSizeOptions, value: String(this.page_size), clearable: false, onAtuiChange: (event) => this.atPageSizeChange.emit(parseInt(event.detail)) }), h("at-button", { key: 'b332ce3c5acad2d2ff2e090b3664133d1cdff00d', disabled: this.current_page === 1, type: "secondaryText", onAtuiClick: () => this.atChange.emit(1) }, h("at-icon", { key: 'd6e949a4d82ea2a7509e63180b5571c5d72c90ee', slot: "icon", name: "first_page" })), h("at-button", { key: 'c28c33d1cbf9f2907785a82d9b6578db1da5e8a5', disabled: this.current_page === 1, type: "secondaryText", onAtuiClick: () => this.atChange.emit(this.current_page - 1) }, h("at-icon", { key: '13c73be0c406e006df00ba9d9c72f28bbbac24c6', slot: "icon", name: "chevron_left" })), h("span", { key: '068aeb9adb03f83798d0b6e8233227e9285a93df' }, "Page ", this.current_page, " of ", this.num_pages), h("at-button", { key: '12b7ce269ceedcf2bf096618d9c3b1250a6e04ef', disabled: this.current_page === this.num_pages, type: "secondaryText", onAtuiClick: () => this.atChange.emit(this.current_page + 1) }, h("at-icon", { key: '351889c200c2483a35950ff11e2567c852c6e204', slot: "icon", name: "chevron_right" })), h("at-button", { key: '8b99b664d8f1734d0eb64c54d5d6b7280f9a8f48', disabled: this.current_page === this.num_pages, type: "secondaryText", onAtuiClick: () => this.atChange.emit(this.num_pages) }, h("at-icon", { key: '8042d59815eb58deedd31f4dbc23c72d42d0c81d', slot: "icon", name: "last_page" }))));
    }
};
