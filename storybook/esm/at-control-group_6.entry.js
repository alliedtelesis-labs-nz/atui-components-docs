...
const AtSearch = class {
    ...
    render() {
        return (h(Host, { key: '2647c3569294ecf81fc984afe7ec2cbef29e981e' }, (this.label || this.info_text) && (h("at-form-label", { key: 'bd39dcdba0ecc1c280877edb6d348396571ac7c8', label: this.label, for: this.label
                ? `search-input-${this.label.replace(/\s+/g, '-').toLowerCase()}`
                : undefined, info_text: this.info_text })), h("div", { key: '9e49d3cbee7d507e80f0bb53791021dbba063321', class: "transition[background-color,color,box-shadow] border-input bg-input-background focus-within:border-active-accent focus-within:ring-active-glow rounded-input h-input min-h-input relative flex flex-row items-center justify-center border duration-300 ease-in-out focus-within:z-10 focus-within:ring" }, h("at-icon", { key: 'ed16d1fb4ebb3de489209d6a0491ade2c169e538', class: "fill-foreground px-8", name: "search" }), h("input", { key: '36e1ddd0bb944b6a2a7c74f737c1264728307a13', id: this.label
                ? `search-input-${this.label.replace(/\s+/g, '-').toLowerCase()}`
                : undefined, role: "searchbox", tabindex: "0", class: "mr-24 h-full w-full bg-transparent p-0 leading-[30px] focus:border-none focus:outline-none", placeholder: this.placeholder, value: this.model, autocomplete: "off", name: "search", onInput: () => this.onChangeFn(), ref: (el) => (this.searchEl = el) }), h("div", { key: 'c417ed61a6727a180d968acd386956e8c893b6f9', class: `transition-all duration-300 ease-in-out ${this.model !== '' && this.model !== undefined
                ? 'pr-4 opacity-100'
                : 'pointer-events-none pr-0 opacity-0'}` }, h("at-button", { key: 'aa2197f19c1a925390f6ebbd0764f5573320efca', size: "sm", type: "secondaryText", onClick: () => this.clearFn(), "data-name": "search-clear", tabindex: this.model !== '' && this.model !== undefined
                ? '0'
                : '-1' }, h("at-icon", { key: '692a537e4e596bd668b0e30d475d4bfcee314762', slot: "icon", name: "backspace" })))), this.hint_text && (h("span", { key: '25f052c204eaa575fa7fd92b8f443e87af4e3185', class: "text-secondary mt-4 truncate text-xs !leading-normal font-normal empty:hidden", "data-name": "search-hint" }, this.hint_text))));
    }
};
...
const AtTableFilters = class {
    ...
    render() {
        return (this.col_defs && (h(Host, { key: '9293dd227559daa878fab2a62ba68affb0f8ebde', class: "flex items-start gap-8" }, this.selected.length > 0 && (h("div", { key: '62a2eacfd4c269a51aae2a490da587f9d9e9363d', class: "bg-surface-foreground rounded-input flex min-h-[36px] flex-wrap items-end gap-8 p-8" }, this.selected.map((column) => (h("div", { class: "flex items-center gap-2" }, h("at-input", { class: "w-input-sm", label: this.getHeaderName(column.id), prefix: this.getHeaderName(column.id) + ': ', value: column.value, onAtuiChange: (event) => this.filterChangeHandler(event, column.id) }, h("div", { slot: "input-actions" }, h("at-button", { type: "secondaryText", size: "sm", onClick: () => this.clearSingleFilter(column.id), "data-name": `filter-clear-${column.id}` }, h("at-icon", { slot: "icon", name: "cancel" }))))))), h("at-button", { key: 'fcd0a12986ceb67ac4ced9e0e421bff866e6b72c', type: "secondaryText", label: "Clear All", onClick: this.clearFilters, "data-name": "filter-clear-all" }))))));
    }
};
...
const AtTablePagination = class {
    ...
    atPageSizeChange;
    render() {
        return (h(Host, { key: 'c3bcab54296313cf9dbc28ecec5848339fbfd679', class: "mt-8 flex items-center justify-end gap-8" }, h("span", { key: '8ff856039354dd43d33c019d0441f501c89ce137' }, "Page Size: "), h("at-select", { key: 'dbcc3ccc76aeceffdc17354090ba92cc382273dd', options: this.page_size_options, value: String(this.page_size), clearable: false, onAtuiChange: (event) => this.atPageSizeChange.emit(parseInt(event.detail)) }), h("at-button", { key: '911517e0cb0f6da67de9f3654b0219db688c0253', disabled: this.current_page === 1, type: "secondaryText", onAtuiClick: () => this.atChange.emit(1) }, h("at-icon", { key: 'ec0c9ef20eca2e5c89550b8b7bbb5e8e20a9f89f', slot: "icon", name: "first_page" })), h("at-button", { key: '6a6ac4d333607f18dd19d5cc5d7b2370e7464b8f', disabled: this.current_page === 1, type: "secondaryText", onAtuiClick: () => this.atChange.emit(this.current_page - 1) }, h("at-icon", { key: 'fc885c4c69a5e5fff5511797971f76f02d34250f', slot: "icon", name: "chevron_left" })), h("span", { key: '48111c6cd8328b600b89329c178118bdee18a587' }, "Page ", this.current_page, " of ", this.num_pages), h("at-button", { key: '2dc4ff5b722a924b7adeea74b73f26f50fe7e8d9', disabled: this.current_page === this.num_pages, type: "secondaryText", onAtuiClick: () => this.atChange.emit(this.current_page + 1) }, h("at-icon", { key: 'b65ee1f7565b5cecf4828e1a82922983d046f3b7', slot: "icon", name: "chevron_right" })), h("at-button", { key: 'fbf5bbc95ce52406f5d5a9e7b9b7be1200659808', disabled: this.current_page === this.num_pages, type: "secondaryText", onAtuiClick: () => this.atChange.emit(this.num_pages) }, h("at-icon", { key: 'd12d27ecfc19703bc8ad1abfd66c3f42471f6c05', slot: "icon", name: "last_page" }))));
    }
};
