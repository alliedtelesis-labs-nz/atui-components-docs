...
const AtTableFilterMenu = class {
    ...
    render() {
        return (h(Host, { key: '7dd19557143045a3ab6952c3b9850e5eb569763f' }, h("at-menu", { key: '41283390e5fe7dab4c87c2a5511d71224fa39c20', autoclose: false, width: "fit-content", class: "self-start", align: "start" }, h("at-tooltip", { key: '81cb92071a64e2526742bb8dad1bdcaeb2a69416', slot: "menu-trigger", position: "top" }, h("at-button", { key: '91dec291612d297403e174591540105654a2f075', slot: "tooltip-trigger", type: "secondaryOutline" }, h("at-icon", { key: '2819620f1596efad6b2f546b1de5ff6ad7e606c3', slot: "icon", name: "edit_filters" })), h("span", { key: 'a2833f2a46bb5be09b88d82ecfa68f42ed5d31be' }, this.translations.ATUI.TABLE.FILTER_DATA)), h("div", { key: '7e2f2a0185c96a1ec66fd2d505f5dab2e35d60c2', class: "flex flex-col" }, h("at-checkbox-group", { key: '65c6937d2065f07220f22b5c24d0012109664214', class: "w-fit", options: this.filteredColumns, value: this.selected, onAtuiChange: (event) => this.handleColumnSelect(event) })))));
    }
