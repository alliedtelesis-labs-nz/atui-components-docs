import { r as registerInstance, h, H as Host, c as createEvent, a as getElement } from './index-H8lgnoYZ.js';
...
const AtSearch = class {
    ...
    render() {
        return (h(Host, { key: 'e417a4fa3f9db8d4582bd9f9d1ed81134d4ec5d5' }, (this.label || this.info_text) && (h("at-form-label", { key: 'eab3ca55715a680a3f54c59c8ddf96f93dd05b44', label: this.label, for: this.label
                ? `search-input-${this.label.replace(/\s+/g, '-').toLowerCase()}`
                : undefined, info_text: this.info_text })), h("div", { key: '329988f615ea2bee3350ff68adcd47046af2de3b', class: "transition[background-color,color,box-shadow] border-input bg-input-background focus-within:border-active-accent focus-within:ring-active-glow rounded-input h-input min-h-input relative flex flex-row items-center justify-center border duration-300 ease-in-out focus-within:z-10 focus-within:ring" }, h("at-icon", { key: '620b33412af5bc08e97815ab3df52f170967dcec', class: "fill-foreground px-8", name: "search" }), h("input", { key: '93905ec080c304d47b217ba4bc3717d1d2d7a11a', id: this.label
                ? `search-input-${this.label.replace(/\s+/g, '-').toLowerCase()}`
                : undefined, role: "searchbox", tabindex: "0", class: "mr-24 h-full w-full bg-transparent p-0 leading-[30px] focus:border-none focus:outline-none", placeholder: this.placeholder, value: this.model, autocomplete: "off", name: "search", onInput: () => this.onChangeFn(), ref: (el) => (this.searchEl = el) }), h("div", { key: '34e15e76c1639e18a700fa0b0763031117955cbe', class: `transition-all duration-300 ease-in-out ${this.model !== '' && this.model !== undefined
                ? 'pr-4 opacity-100'
                : 'pointer-events-none pr-0 opacity-0'}` }, h("at-button", { key: 'f3c9cebad1fd67192de8cb73f0293ec6b649cdd9', size: "sm", type: "secondaryText", onClick: () => this.clearFn(), "data-name": "search-clear", tabindex: this.model !== '' && this.model !== undefined
                ? '0'
                : '-1' }, h("at-icon", { key: '25f9f3bab8e76d04a1a7c5565950ec879ee13339', slot: "icon", name: "backspace" })))), this.hint_text && (h("span", { key: 'da1a3abee9ae400aa08225613883b879f8b50fc7', class: "text-secondary mt-4 truncate text-xs !leading-normal font-normal empty:hidden", "data-name": "search-hint" }, this.hint_text))));
    }
};
...
const AtTableFilterMenu = class {
    ...
    render() {
        return (h(Host, { key: '5bc53757292caaea0c036095c4c6d99d0c317259' }, h("at-menu", { key: '8580e0d26aeaf51125b55ecd9541f60d9493c735', autoclose: false, width: "fit-content", class: "self-start", align: "start" }, h("at-tooltip", { key: 'e9cc2619e2d5eb435e055da2203a1b09635be1b3', slot: "menu-trigger", position: "top" }, h("at-button", { key: '010e519dd347a5021f93853fb630cd9d49ecb397', slot: "tooltip-trigger", type: "secondaryOutline" }, h("at-icon", { key: 'fa1705d38291489e8ac1014d7c4895cacee62186', slot: "icon", name: "edit_filters" })), h("span", { key: '07db43137df77c7415fc436d19f96052986d9ca0' }, this.translations.ATUI.TABLE.FILTER_DATA)), h("div", { key: '3a4022836b1378e87f4a79e1b6ef246a895fe1dd', class: "flex flex-col" }, h("at-checkbox-group", { key: 'c0aacc8f542b0e9fc0f68eaf30ba5893bb79c88a', class: "w-fit", options: this.filteredColumns, value: this.selected, onAtuiChange: (event) => this.handleColumnSelect(event) })))));
    }
...
const AtTableFilters = class {
    ...
    render() {
        return (this.col_defs && (h(Host, { key: '41d329fcf1765c60ad2917d2e74703c5f5e72591', class: "flex items-start gap-8" }, this.selected.length > 0 && (h("div", { key: '7478f57cc058284c2ac95ac05d40d6758c0499ba', class: "bg-surface-foreground rounded-input flex min-h-[36px] flex-wrap items-end gap-8 p-8" }, this.selected.map((column) => (h("div", { class: "flex items-center gap-2" }, h("at-input", { class: "w-input-sm", label: this.getHeaderName(column.id), prefix: this.getHeaderName(column.id) + ': ', value: column.value, onAtuiChange: (event) => this.filterChangeHandler(event, column.id) }, h("div", { slot: "input-actions" }, h("at-button", { type: "secondaryText", size: "sm", onClick: () => this.clearSingleFilter(column.id), "data-name": `filter-clear-${column.id}` }, h("at-icon", { slot: "icon", name: "cancel" }))))))), h("at-button", { key: '3349c608bbef57767719d2adf9842fe46f2ce2a1', type: "secondaryText", label: "Clear All", onClick: this.clearFilters, "data-name": "filter-clear-all" }))))));
    }
};
...
const AtTablePagination = class {
    ...
    atPageSizeChange;
    render() {
        return (h(Host, { key: '701ae28cabcef5b2afbddbaf652dcc15bd903509', class: "mt-8 flex items-center justify-end gap-8" }, h("span", { key: '314c7ec7963cf012237922f6fad0dcd789849108' }, "Page Size: "), h("at-select", { key: '807d03033980a7ac788c5a1fb4932b23cb6fc78a', options: this.page_size_options, value: String(this.page_size), clearable: false, onAtuiChange: (event) => this.atPageSizeChange.emit(parseInt(event.detail)) }), h("at-button", { key: '68bb5a13a396ab1453fc8ff2b42c0fe9f0cfd688', disabled: this.current_page === 1, type: "secondaryText", onAtuiClick: () => this.atChange.emit(1) }, h("at-icon", { key: '82722dbba8701f7e805d54c0db35654be08600e1', slot: "icon", name: "first_page" })), h("at-button", { key: '21dd4d1375950d73cb74529c340e4593dc59ec0b', disabled: this.current_page === 1, type: "secondaryText", onAtuiClick: () => this.atChange.emit(this.current_page - 1) }, h("at-icon", { key: 'bfb306580179a3067256624a75c1907dc2ea0db9', slot: "icon", name: "chevron_left" })), h("span", { key: '8674bd6eb2118f77bee07fe48bca0e32b34e5246' }, "Page ", this.current_page, " of ", this.num_pages), h("at-button", { key: 'da88bab22a4c9a0e2a9df95589ff9b9f18c06da5', disabled: this.current_page === this.num_pages, type: "secondaryText", onAtuiClick: () => this.atChange.emit(this.current_page + 1) }, h("at-icon", { key: 'e83ea1e6712b5afdd2265c04d9e7763bedfede84', slot: "icon", name: "chevron_right" })), h("at-button", { key: '4a696650ec9115ce14a9af11b4ff55fea7eb02b2', disabled: this.current_page === this.num_pages, type: "secondaryText", onAtuiClick: () => this.atChange.emit(this.num_pages) }, h("at-icon", { key: 'bfc5efe4af2d4f7a5d12bddb121433da6e452cea', slot: "icon", name: "last_page" }))));
    }
};
