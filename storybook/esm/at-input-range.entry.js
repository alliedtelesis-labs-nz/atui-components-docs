...
const AtInputRangeComponent = class {
    ...
    render() {
        return (h(Host, { key: '89a89de7ad05eb7303185c4fbbfeed0bf4fa9634' }, h("div", { key: 'ce6ab2feae4d33ff20fd505cb3825499bf07c842', class: "mb-4 flex flex-col empty:hidden" }, h("slot", { key: '47d0d90293199e8b483b5b67c445c7510d4aeeba', name: "label" }), (this.label || this.required || this.info_text) && (h("at-form-label", { key: '679f7a4c0969b72ecee9a6927cf2e9a36effcf3d', label: this.label, for: this.sliderId, required: this.required && !this.readonly, info_text: this.info_text })), this.hint_text && (h("span", { key: 'd7420b539dde204e5d4456d5c3a7306a8a413b0d', class: "text-muted inline-block text-xs leading-tight", "data-name": "slider-hint" }, this.hint_text)), this.error_text && this.invalid && (h("span", { key: 'c93e6dbe6456b90637e003c601b0e04b0babbf1b', class: "text-error text-xs font-normal", "data-name": "slider-error" }, this.error_text)), this.warning_text && !this.invalid && (h("span", { key: '54f544f44ce2f96f2a8d58ece40cc4ada141e6ae', class: "text-warning-foreground text-xs font-normal", "data-name": "slider-warning" }, this.warning_text))), h("div", { key: 'baee9b485c0a8bcbd937f9b132f128eac5f8684d', class: `mt-4 flex items-start gap-8 ${this.label_position == 'before' ? 'flex-row-reverse' : 'flex-row'}` }, h("div", { key: '2b823f0ef5054cc65c63e66dd89ac443e1d4d70a', class: "flex flex-grow flex-col" }, h("div", { key: '98945a7befc665747eaecaecfc5b63f16ca69a5f', class: "flex flex-grow" }, h("div", { key: '6ac6bd69fd784984e455ac17af7c72d0830331c9', class: "range-slider", style: {
                '--min': `${this.min}`,
                '--max': `${this.max}`,
                '--step': `${this.step}`,
                '--value': `${this.value}`,
            ...
            }, ref: (el) => (this.sliderContainerRef = el) }, h("input", { key: 'd126decbd7e8c27db1857ad1ee1b5d6fe46a35da', list: "markers", type: "range", min: this.min, max: this.max, step: this.step, "aria-controls": this.sliderId, disabled: this.disabled || this.readonly
                ? true
            ...
            } }), this.show_value && (h("output", { key: 'bea1013b9a5f3086557ff801888ae1c67b9d8124', class: "text-sm" }, this.value)), h("div", { key: 'b221f6458ddf295a41b1e8c18d354c8efb15c857', class: "range-slider__progress" })))), this.show_input && (h("div", { key: 'eca661c6b2ce1e77f355b5ba8128c0765d8c183b', class: "relative flex w-80 flex-row items-center gap-8" }, h("at-input-numeric", { key: 'fa6721ba8fd12c02d706d9d870ebd18507bae8ce', readonly: this.readonly, disabled: this.disabled, min: this.min, max: this.max, step: this.step, value: this.value, show_buttons: false, "data-name": "slider-text-input", onAtuiChange: (event) => this.onChange(event.detail) }), this.suffix && (h("span", { key: '56e5506bb12f7125131b0abf619653f420f51c58', "data-name": "slider-suffix", class: "text-muted absolute top-1/2 right-[36px] -translate-y-1/2" }, this.suffix)))))));
    }
};
