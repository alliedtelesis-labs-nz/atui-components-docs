...
const AtBreadcrumbItem = class {
    ...
    render() {
        return (h(Host, { key: '0ec99a8a12f02c7fe7e66974d69d5b7395bfec40', class: "flex w-fit items-center" }, this.is_active ? (h("span", { "aria-current": "page", class: "text-active-accent cursor-default rounded-lg px-8 py-2" }, this.label)) : (h("a", { role: "link", tabIndex: 0, onKeyDown: (event) => {
                if (event.key === 'Enter') {
