...
const AtPlaceholderComponent = class {
    ...
    render() {
        return (h("div", { key: '1c68b47d2863fe516524e8599402e5623c881e7a', class: `${this.placeholderSizeClass} bg-surface-foreground text-subtle rounded-placeholder flex w-full items-center gap-16 text-center`, "data-name": "placeholder-container" }, this.icon && this.icon !== 'none' && (h("span", { key: 'd82c3e6fcc4f77aa864ef9ed92c91fc5fb6bb8fc', class: `material-icons text-subtle ${this.iconSizeClass}`, "data-name": "placeholder-icon" }, this.icon)), h("div", { key: '4446a8c2fe27ec4a250df3bdff0f6ee9476b61cb', class: `border-radius-sm flex flex-col justify-center ${this.size === 'xs' ? 'items-start text-left' : 'items-center text-center'}` }, h("div", { key: '98fe7c8c1f3cd363be0f551b85a45e558d2ce95d', class: "flex items-center" }, this.show_loading_spinner && (h("at-loading", { key: '28d2d7e92f2fd3acfaa3ad0e6534c4055ef35732', class: "relative mr-8", size: "sm", type: "secondary", "data-name": "placeholder-spinner" })), this.placeholder_title && (h("h5", { key: '779e53692b3c7bd58628975cb33c5e8e3565c352', class: "text-secondary text-sm font-medium", "data-name": "placeholder-title" }, this.placeholder_title))), h("p", { key: '8b42d1da7ee0e3bfb555db5deef24b5ad43a37f7', class: "text-secondary text-sm", "data-name": "placeholder-content" }, this.content), h("slot", { key: 'd5c012d9d14c1014e321b48f6bf6b722be822e88' }))));
    }
};
...
const AtSearch = class {
    ...
    render() {
        return (h("div", { key: 'c07be93db801a2b885ab90b3e5675b26ac58e0ca' }, (this.label || this.info_text) && (h("at-form-label", { key: '7d1541e5f5144dd85fb97dae7e064b80a397a305', label: this.label, for: this.label
                ...
                : undefined, info_text: this.info_text })), h("div", { key: '622ab0abce9987c7e81592020c1e23b3f2ff01a3', class: "transition[background-color,color,box-shadow] border-input bg-surface-0 focus-within:border-active-accent focus-within:ring-active-glow rounded-input relative flex h-[36px] flex-row items-center justify-center border duration-300 ease-in-out focus-within:ring" }, h("span", { key: '4ea98c7d66422261364fce2f1221b85de6999111', class: "px-8" }, h("at-icon", { key: '85bf52868b183574dbb66bb5ad76398f03cdff3b', class: "fill-light", name: "search" })), h("input", { key: '909dbb7397048660f4c5473fb6cb2dfc23ae1c89', id: this.label
                ? `search-input-${this.label.replace(/\s+/g, '-').toLowerCase()}`
                : undefined, role: "searchbox", tabindex: "0", class: "mr-24 h-30 w-full bg-transparent p-0 leading-[30px] focus:border-none focus:outline-none", placeholder: this.placeholder, value: this.model, autocomplete: "off", name: "search", onInput: () => this.onChangeFn(), ref: (el) => (this.searchEl = el) }), h("div", { key: 'd4c6f65efbbe5983fe3e930b6ff1a800c86f714f', class: `transition-all duration-300 ease-in-out ${this.model !== '' && this.model !== undefined
                ? 'pr-4 opacity-100'
                : 'pointer-events-none pr-0 opacity-0'}` }, h("at-button", { key: '4d185670edb8f972324e63013dd87433b3f5d8d9', size: "sm", type: "secondaryText", onClick: () => this.clearFn(), "data-name": "search-clear", tabindex: this.model !== '' && this.model !== undefined
                ? '0'
                : '-1' }, h("at-icon", { key: '35697a517300cc85d0d5082edd9c17474e20bc23', slot: "icon", name: "backspace" })))), h("span", { key: '8b2560817367995af01019d4f2b0a893be635cd8', class: "text-secondary mt-4 truncate text-xs !leading-normal font-normal", "data-name": "search-hint" }, this.hint_text)));
    }
};
