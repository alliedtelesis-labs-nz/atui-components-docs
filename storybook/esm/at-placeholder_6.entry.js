...
const AtPlaceholderComponent = class {
    ...
    render() {
        return (h("div", { key: '8ee87ca3d703e695fcc3ad56cd2e4e77c5b4b265', class: `${this.placeholderSizeClass} bg-surface-0 text-med flex w-full items-center gap-16 rounded-sm text-center`, "data-name": "placeholder-container" }, this.icon && this.icon !== 'none' && (h("span", { key: '3d245e54cfbfc8b374124e23f543d575b2c90154', class: `material-icons text-slate-300 ${this.iconSizeClass}`, "data-name": "placeholder-icon" }, this.icon)), h("div", { key: '5dd20ef6225ae7c41fbf748574e10be2c74f7549', class: `border-radius-sm flex flex-col justify-center ${this.size === 'xs' ? 'items-start text-left' : 'items-center text-center'}` }, h("div", { key: 'ce7b9cd0349769c2ae2ebac1eb5ae36c1754a03b', class: "flex items-center" }, this.show_loading_spinner && (h("at-loading", { key: '9022b1fb908bd97106076ea2bbb895ff6cab6cb7', class: "relative mr-8", size: "sm", type: "secondary", "data-name": "placeholder-spinner" })), this.placeholder_title && (h("h5", { key: '999393b99bbe2f78473dc7c013fe94b0acbaf114', class: "text-med text-sm font-medium", "data-name": "placeholder-title" }, this.placeholder_title))), h("p", { key: '689ce2680901bb700b8d0db2c6a62d296fe58052', class: "text-med text-sm", "data-name": "placeholder-content" }, this.content), h("slot", { key: '9589a6decdc9900bd295955ee456b74ed7802ea9' }))));
    }
};
...
const AtTableFilters = class {
    ...
    render() {
        return (this.col_defs && (h(Host, { key: 'c346db680f385b8c2a99d1c32b722b318de8d4e7', class: "flex items-start gap-8" }, this.selected.length > 0 && (h("div", { key: 'e48209e7f0fbdaafb6d0b8c47af15e606f1c4f6c', class: "bg-surface-0 flex min-h-[36px] flex-wrap items-end gap-8 rounded-md p-8" }, this.selected.map((column) => (h("div", { class: "flex items-center gap-2" }, h("at-input", { class: "w-input-sm", label: column.id, prefix: column.id + ': ', value: column.value, onAtuiChange: (event) => this.filterChangeHandler(event, column.id) }, h("div", { slot: "input-actions" }, h("at-button", { type: "secondaryText", size: "sm", onClick: () => this.clearSingleFilter(column.id), "data-name": `filter-clear-${column.id}` }, h("at-icon", { slot: "icon", name: "cancel" }))))))), h("at-button", { key: '9f63ed6f45ef1c4981d7256cde44f2f5e7ec2aee', type: "secondaryText", label: "Clear All", onClick: this.clearFilters, "data-name": "filter-clear-all" }))))));
    }
};
