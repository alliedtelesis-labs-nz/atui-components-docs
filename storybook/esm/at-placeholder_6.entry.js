...
const AtSearch = class {
    ...
    render() {
        return (h("div", { key: '367247873f13cf7257e53cc6f9708ae910404830' }, (this.label || this.info_text) && (h("at-form-label", { key: 'f2e80fd9f766c614b29efef518522d3f048819e4', label: this.label, for: this.label
                ? `search-input-${this.label.replace(/\s+/g, '-').toLowerCase()}`
                : undefined, info_text: this.info_text })), h("div", { key: '1197ac8f8c35bc017a55f86ac3a44413a924fdad', class: "transition[background-color,color,box-shadow] border-input bg-input-background focus-within:border-active-accent focus-within:ring-active-glow rounded-input relative flex h-[36px] flex-row items-center justify-center border duration-300 ease-in-out focus-within:ring" }, h("span", { key: '96611dcf1daba74ee1273d994a27b78584ddd3cb', class: "px-8" }, h("at-icon", { key: 'c4a1e3d22e112aa61488d7e6177a33ba02e7e63b', class: "fill-foreground", name: "search" })), h("input", { key: '3255809b76be65ea2653191be9b1ea37d6d164b1', id: this.label
                ? `search-input-${this.label.replace(/\s+/g, '-').toLowerCase()}`
                : undefined, role: "searchbox", tabindex: "0", class: "mr-24 h-30 w-full bg-transparent p-0 leading-[30px] focus:border-none focus:outline-none", placeholder: this.placeholder, value: this.model, autocomplete: "off", name: "search", onInput: () => this.onChangeFn(), ref: (el) => (this.searchEl = el) }), h("div", { key: '355e8c7f7a73051787cdb0a5d9efeca6fe0e36bf', class: `transition-all duration-300 ease-in-out ${this.model !== '' && this.model !== undefined
                ? 'pr-4 opacity-100'
                : 'pointer-events-none pr-0 opacity-0'}` }, h("at-button", { key: 'fec89b6a5c67cb254c372ea4ca9da06bce39f0c2', size: "sm", type: "secondaryText", onClick: () => this.clearFn(), "data-name": "search-clear", tabindex: this.model !== '' && this.model !== undefined
                ? '0'
                : '-1' }, h("at-icon", { key: '849604a729749d784ac654c5b04d7334acb09cbd', slot: "icon", name: "backspace" })))), h("span", { key: '4986716bf39d5bdbfd579110c67e66c599f08e31', class: "text-secondary mt-4 truncate text-xs !leading-normal font-normal", "data-name": "search-hint" }, this.hint_text)));
    }
};
...
const AtTableFilters = class {
    ...
    render() {
        return (this.col_defs && (h(Host, { key: 'bc9e0c266ddbc1926d2416930d91c923903db613', class: "flex items-start gap-8" }, this.selected.length > 0 && (h("div", { key: '52edab56e770da6ae8a697ad542f677b9a829b14', class: "bg-surface-foreground rounded-input flex min-h-[36px] flex-wrap items-end gap-8 p-8" }, this.selected.map((column) => (h("div", { class: "flex items-center gap-2" }, h("at-input", { class: "w-input-sm", label: this.getHeaderName(column.id), prefix: this.getHeaderName(column.id) + ': ', value: column.value, onAtuiChange: (event) => this.filterChangeHandler(event, column.id) }, h("div", { slot: "input-actions" }, h("at-button", { type: "secondaryText", size: "sm", onClick: () => this.clearSingleFilter(column.id), "data-name": `filter-clear-${column.id}` }, h("at-icon", { slot: "icon", name: "cancel" }))))))), h("at-button", { key: '7935e583d2d7b5f238a240f1eb83758ab3efd421', type: "secondaryText", label: "Clear All", onClick: this.clearFilters, "data-name": "filter-clear-all" }))))));
    }
};
...
const AtTablePagination = class {
    ...
    atPageSizeChange;
    render() {
        return (h(Host, { key: 'e871f1942f0d65f9562c38c85c58ec20b0d82fc7', class: "mt-8 flex items-center justify-end gap-8" }, h("span", { key: 'd67efcd9b710b6ade7ce7d4d414a6a204f0f6bf8' }, "Page Size: "), h("at-select", { key: '18893a54edb274b6ecb394285fc68ecde816e166', options: this.page_size_options, value: String(this.page_size), clearable: false, onAtuiChange: (event) => this.atPageSizeChange.emit(parseInt(event.detail)) }), h("at-button", { key: '6427625f869c38164b24075eefff5e98a37d6143', disabled: this.current_page === 1, type: "secondaryText", onAtuiClick: () => this.atChange.emit(1) }, h("at-icon", { key: '2b5f56f7cac699301135d3aebb2b8adacc50644e', slot: "icon", name: "first_page" })), h("at-button", { key: '70751fb46b97925c45c6af9ef86abd914624786f', disabled: this.current_page === 1, type: "secondaryText", onAtuiClick: () => this.atChange.emit(this.current_page - 1) }, h("at-icon", { key: 'a35cce49f8626b473bf16d11f1318e0742adafbe', slot: "icon", name: "chevron_left" })), h("span", { key: 'd13fbdda699e14626466323a74bbc7a1416e41ea' }, "Page ", this.current_page, " of ", this.num_pages), h("at-button", { key: '6e36b786b3915e94f368a4a4da5cb9c7777d1bba', disabled: this.current_page === this.num_pages, type: "secondaryText", onAtuiClick: () => this.atChange.emit(this.current_page + 1) }, h("at-icon", { key: '5790afaa0b3e1297cb1a4eee275f4a036026db7d', slot: "icon", name: "chevron_right" })), h("at-button", { key: 'b9a2400b86d11996dc565a81890807d289336b75', disabled: this.current_page === this.num_pages, type: "secondaryText", onAtuiClick: () => this.atChange.emit(this.num_pages) }, h("at-icon", { key: '3648975400c11fea29055044f481841d84013ae7', slot: "icon", name: "last_page" }))));
    }
};
