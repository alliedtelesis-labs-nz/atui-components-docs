...
const AtButtonComponent = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'aa497e6425d8532b38764b8deab810aa2fc6b527', class: classname, role: "button", tabIndex: 0, onKeyDown: (event) => this.handleKeyDown(event), onClick: (event) => this.handleClick(event) }, h("div", { key: '80a4254c2c5e2a702832dab44e75e79c6498616f', class: "z-20 flex h-full w-full items-center justify-center gap-4" }, this.in_progress && (h("at-loading", { key: '13f9e1de25238068886eec65074cc74db0e0efe7', class: "absolute", size: "sm", type: this.spinnerColour })), h("slot", { key: '6a48ce727e4bc91f787a53e231c8152440c668d7', name: "icon" }), this.icon && (h("span", { key: 'b2da969df7b166168139fb3d26286ab3967e30a1', class: `material-icons !text-icon-md h-16 w-16 leading-[16px] ${this.in_progress ? 'invisible' : 'visible'}`, "data-name": "button-icon" }, this.icon)), this.label && (h("span", { key: 'd31102012718adbaf68f6f22e02d5bafc16ce099', class: `leading-[16px] ${this.in_progress ? 'invisible' : 'visible'}`, "data-name": "button-label" }, this.label)), h("slot", { key: '9bfe50c2f689932f4e79e844ee1e839ac8fbcd55' }), h("slot", { key: 'fbbd0dacfe7975c59ecdd2304de3f910a6573a7c', name: "icon_after" }), this.icon_after && (h("span", { key: '89889351942244894802c8fd9c83de9fa67eada1', class: `material-icons !text-icon-md h-16 w-16 leading-[16px] ${this.in_progress ? 'invisible w-0' : 'visible'}`, "data-name": "button-icon-right" }, this.icon_after))), h("div", { key: '4fdd24812c255325f7d6c3d94b065fbea439876d', "data-name": "focus-indicator", role: "presentation", class: focusIndicatorClassname })));
    }
};
