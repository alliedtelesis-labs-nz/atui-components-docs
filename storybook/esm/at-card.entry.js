...
const AtCardComponent = class {
    ...
    render() {
        ...
        return (h(Host, { key: '2aad49b9c47c5ca0e202d23795164230fcd323b8', class: containerClassname }, h("div", { key: '0141c10a1c5a8b2cfb5846c0f6cf83f63ae80590', class: `${headerClassname}` }, h("slot", { key: 'ceb88b8af1eb03b2910dfdc27863d65cae4fd139', name: "card-header" }), (this.card_title || this.subtitle) && (h("div", { key: 'fa90846a2b97dc690d2172396f4170adb86eb068', class: "flex flex-col" }, this.card_title && (h("h4", { key: 'd36ab0452fce24e0ec858f1f57f1303390cb7c37', "data-name": "card-title", class: "text-h4 font-medium" }, this.card_title)), this.subtitle && (h("h5", { key: '7aefcd0bb8e19c3bbba0bbdf203f0bf171d3a3d8', class: "text-light text-sm font-normal", "data-name": "card-subtitle" }, this.subtitle)))), h("slot", { key: '9e2770353ecf26def1deee4ffbefce99714783f2', name: "card-header-actions" })), h("div", { key: 'd40b24e7ec90d81ed3d803ce461184acd3fdd5bd', class: contentClassname, "data-name": "card-content" }, this.content, h("slot", { key: '8006d297ab50c5c3bc71cddf2bb3beded5be2ca2' })), h("div", { key: 'c78e5dd0187195df54808262d243f0c579789616', class: footerClassname }, h("slot", { key: 'f1e59e02c1931f87525ebf603ae94cd626763a56', name: "card-footer" }))));
    }
};
