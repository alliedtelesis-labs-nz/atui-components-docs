...
const AtButtonSwitchComponent = class {
    ...
    render() {
        ...
        return (h(Host, { key: '4f9bfb6f8af8607ddba517b7f97b86e307d292e0', id: `${this.toggleId}-host`, role: "radiogroup", "aria-labelledby": `${this.toggleId}-label` }, h("div", { key: '33516caba4023f026e33855ebf97a267b02a42a6', class: "flex flex-col" }, h("slot", { key: '862c21cf9cddce76654f20faa20f1ed3f498c414', name: "label" }), (this.label || this.info_text) && (h("at-form-label", { key: '9d9a30a1f1e7f77b4be03f45b7ddd611ce343269', id: this.toggleId, label: this.label, info_text: this.info_text })), this.hint_text && (h("span", { key: 'b96d91f445b767e6d5c057d06bddb49c2d211ea0', class: "text-muted mb-8 inline-block text-xs leading-tight", "data-name": "button-switch-hint" }, this.hint_text))), h("div", { key: 'c2ce3c1189c3b64cfb26c46257c9a3ecd8fd2505', class: "border-input bg-input-background relative w-fit rounded-lg border inset-shadow-xs" }, h("div", { key: '53d208df0656740375b667410caa6d89b49ae3e2', class: "relative z-20 m-[2px] flex flex-row", "data-name": "switch-options" }, h("button", { key: 'fbddce63489d64b59f051e0c4cd13484a972a6fe', class: offButtonClasses, role: "radio", tabindex: 0, "aria-checked": this.value === false, disabled: this.disabled, onClick: () => this.onToggle(false), "data-name": "switch-off-button", "data-value": "false", type: "button" }, this.translations?.ATUI?.OFF || 'Off'), h("button", { key: '954cfdcc8ac40dc8641ed030595e4bb5e6747083', class: onButtonClasses, role: "radio", tabindex: 0, "aria-checked": this.value === true, disabled: this.disabled, onClick: () => this.onToggle(true), "data-name": "switch-on-button", "data-value": "true", type: "button" }, this.translations?.ATUI?.ON || 'On')))));
    }
};
