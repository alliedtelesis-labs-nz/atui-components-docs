...
const AtChartDonut = class {
    ...
    render() {
        return (h(Host, { key: '859c4c8b0ad7dfc6a68c59e32e09980c8494a216', style: { height: '100%', width: '100%' } }, h("canvas", { key: '98130e41fe371caae9dc585b6e5c5c82790c1788', class: `w-full ${heightVariants[this.height]}`, ref: (el) => (this.canvasEl = el) })));
    }
};
