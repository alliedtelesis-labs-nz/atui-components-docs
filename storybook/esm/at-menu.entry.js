...
const AtMenu = class {
    ...
    render() {
        return (h(Host, { key: '14c2a9407ddf2ff716638ae0ec244cc767663424', class: "relative", onBlur: (e) => {
            ...
            } }, !this.trigger_id && (h("div", { key: '4a9e61d4d5bfcec07d340dea0cdf53a618d6d785', "aria-haspopup": "true", "data-name": "menu-trigger", ref: (el) => (this.triggerEl = el), "aria-expanded": `${this.isOpen ? 'true' : 'false'}`, onMouseEnter: () => this.trigger === 'hover' && !this.disabled
                ? this.mouseEnterHandler()
            ...
            }, onClick: () => this.autoclose && this.mouseLeaveHandler(), class: `bg-menu border-muted rounded-menu w-max min-w-0 flex-none border p-4 shadow-lg transition-opacity duration-150 ${this.isOpen ? 'opacity-100' : 'opacity-0'}`, "data-name": "menu-content-wrapper" }, h("slot", { key: 'd38c5e30faba3f328a481a03ba67f8c9ef210446' }))));
    }
