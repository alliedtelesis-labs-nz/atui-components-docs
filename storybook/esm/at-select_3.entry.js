...
const AtSelectComponent = class {
    ...
    render() {
        return (h(Host, { key: '0624bcca7600bbd968a6d5aa40e887853bce1609', class: "group/select", onFocusout: async (event) => {
            ...
            } }, this.renderLabel(), h("at-menu", { key: '77a247d1f5de1b04b901a009f3fd3a9414848ed2', ref: (el) => (this.menuRef = el), trigger: "click", align: "start", width: this.parentWidth, max_height: this.menu_max_height, role: "presentation", disabled: this.disabled || this.readonly, onAtuiMenuStateChange: (event) => this.updateIsOpenState(event) }, this.renderInput(), !this.disabled && !this.readonly
            ? this.renderOptions()
            : null), h("div", { key: 'bb154cb0be3f46c654b41ec45e72475f0a0be56e' }, this.error_text && this.invalid && (h("span", { key: '6a0236c947f1c84a0b0c5be8ccfccaf97dddaf0f', class: "text-error", "data-name": "select-error" }, this.error_text)))));
    }
    renderLabel() {
...
const AtSelectOptionComponent = class {
    ...
    render() {
        ...
        return (h("li", { key: '3b0793053626d9e658f9225f3e2457c7bcba7e21', role: "option", value: this.value, "data-name": "select-option", "aria-selected": this.is_active ? 'true' : 'false', "aria-disabled": this.disabled ? 'true' : 'false', tabIndex: this.disabled ? -1 : 0, class: classname, onClick: this.disabled ? undefined : () => this.handleClick() }, h("slot", { key: 'ef68cab01cd9629f37d5e2b0471a70dea57d3ce5' }), h("span", { key: '63825cd8adaa9b6a322b4a52dce1b03099b3f265', class: "min-w-0 flex-1 truncate", "data-name": "select-option-label" }, this.label || this.value), h("slot", { key: '9ce04c8e860fc49e4ff695f12a4a05754ff9843c', name: "after" })));
    }
};
