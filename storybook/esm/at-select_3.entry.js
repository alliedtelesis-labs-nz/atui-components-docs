...
const AtSelectComponent = class {
    ...
    render() {
        return (h(Host, { key: '86385586aaf1a144ffeba64a73c7b38d4d25aff7', class: "group/select", onFocusout: async (event) => {
            ...
            } }, this.renderLabel(), h("at-menu", { key: 'fd02aa292362ac278a1122267bb6de72ed9fdb1b', ref: (el) => (this.menuRef = el), trigger: "click", align: "start", width: this.parentWidth, max_height: this.menu_max_height, role: "listbox", disabled: this.disabled || this.readonly, onAtuiMenuStateChange: (event) => this.updateIsOpenState(event) }, this.renderInput(), !this.disabled && !this.readonly
            ? this.renderOptions()
            : null), h("div", { key: 'a827d5359b732e6d42801bf76e9b1230fafa6552' }, this.error_text && this.invalid && (h("span", { key: '96729b9cba29bf57a715417099e69c6adadeffde', class: "text-error", "data-name": "select-error" }, this.error_text)))));
    }
    renderLabel() {
...
const AtSelectGroupComponent = class {
    ...
    label;
    render() {
        return (h(Host, { key: '5944cf15bd28ca65cf62354e2bfefd28fd664933', role: "group", "aria-labelledby": this.label, "data-name": "select-option-group" }, h("div", { key: '0372119149725d866967259de8f915b9578f0d2c', role: "group", "aria-labelledby": this.label }, h("li", { key: '760a6bdb759fea550afab84ebad1eeb1354c56e6', id: this.label, class: "text-muted border-muted border-b px-0 pt-8 pb-4 text-sm", "data-name": "select-option-group-title" }, this.label), h("slot", { key: 'd8ef76adf36517bd91b97b65504aff7af9ccae22' }))));
    }
};
...
const AtSelectOptionComponent = class {
    ...
    render() {
        ...
        return (h("li", { key: 'fe239ec5f630cd78a26e6d8ea35a1942addcdd68', role: "option", value: this.value, "data-name": "select-option", "aria-selected": this.is_active ? 'true' : 'false', "aria-disabled": this.disabled ? 'true' : 'false', tabIndex: this.disabled ? -1 : 0, class: classname, onClick: this.disabled ? undefined : () => this.handleClick() }, h("slot", { key: '31eec7be73ef3d1838979988120fb4492d9d5782' }), this.label || this.value, h("slot", { key: '9dcece7df5d8731a37f9289eecc63af418108763', name: "after" })));
    }
};
