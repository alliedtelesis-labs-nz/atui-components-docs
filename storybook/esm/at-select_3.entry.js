...
const AtSelectComponent = class {
    ...
    render() {
        return (h(Host, { key: '27cf1ca5c355ab1f07b38201ab85d648d52cc179', class: "group/select", onFocusout: async (event) => {
            ...
            } }, this.renderLabel(), h("at-menu", { key: '5896f9017afc77b7b95a77b8ca8a0ee21ab382bb', ref: (el) => (this.menuRef = el), trigger: "click", align: "start", width: this.parentWidth, max_height: this.menu_max_height, role: "presentation", disabled: this.disabled || this.readonly, onAtuiMenuStateChange: (event) => this.updateIsOpenState(event) }, this.renderInput(), !this.disabled && !this.readonly
            ? this.renderOptions()
            : null), h("div", { key: '2134ca7b171264b028b29dd5109e6de166d558f9' }, this.error_text && this.invalid && (h("span", { key: 'bfc1f76b9d35283874ab6f52b3f7dd87b0a2cfab', class: "text-error", "data-name": "select-error" }, this.error_text)))));
    }
    renderLabel() {
...
const AtSelectOptionComponent = class {
    ...
    render() {
        ...
        return (h("li", { key: '993deea16edd048e1d3b5933d04df362d90a4bab', role: "option", value: this.value, "data-name": "select-option", "aria-selected": this.is_active ? 'true' : 'false', "aria-disabled": this.disabled ? 'true' : 'false', tabIndex: this.disabled ? -1 : 0, class: classname, onClick: this.disabled ? undefined : () => this.handleClick() }, h("slot", { key: 'b3ddc58ba3d2dbfb502a38ba435fb82f8a803be9' }), h("span", { key: '844865d5129cbb6bd0a16255aa844eed78ba0428', class: "min-w-0 flex-1 truncate", "data-name": "select-option-label" }, this.label || this.value), h("slot", { key: '6c00e7226e677937234f88a2d122ffdd926d83ec', name: "after" })));
    }
};
