...
const AtMultiSelectComponent = class {
    ...
    render() {
        return (h(Host, { key: 'ae9e05f361b89778363c3e01d15a08a0bc3840ee', class: "group/select", onFocusout: async (event) => {
