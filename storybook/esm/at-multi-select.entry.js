...
const AtMultiSelectComponent = class {
    ...
    render() {
        return (h(Host, { key: '8e35eb8578dd8da41ec0f89d0652fac3c551bffe', class: "group/select", onFocusout: async (event) => {
