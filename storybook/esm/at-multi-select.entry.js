...
const AtMultiSelectComponent = class {
    ...
    render() {
        return (h(Host, { key: 'db434942fe1af29aeb98049ce29e077b2e67ee56', class: "group/select", onFocusout: async (event) => {
