...
const AtMultiSelectComponent = class {
    ...
    render() {
        return (h(Host, { key: '3bbbba2f5812026f1ffb6662a117908073ff3574', class: "group/select", onFocusout: async (event) => {
