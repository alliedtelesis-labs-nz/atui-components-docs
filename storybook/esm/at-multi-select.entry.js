...
const AtMultiSelectComponent = class {
    ...
    render() {
        return (h(Host, { key: 'd713466b7908a3b2711c8efdadc92918f74459f6', class: "group/select", onFocusout: async (event) => {
