...
const ATUI_ICONS = [
    { name: 'add', icon: _16$B },
    { name: 'arrow_left', icon: _16$A },
    { name: 'arrow_right', icon: _16$z },
    { name: 'arrow_up', icon: _16$y },
    { name: 'backspace', icon: _16$x },
    { name: 'cancel', icon: _16$w },
    { name: 'caret_down', icon: _16$v },
    { name: 'caret_up', icon: _16$u },
    { name: 'check', icon: _16$t },
    { name: 'chevron_down', icon: _16$s },
    { name: 'chevron_left', icon: _16$r },
    { name: 'chevron_right', icon: _16$q },
    { name: 'close', icon: _16$p },
    { name: 'column', icon: _16$o },
    { name: 'copy', icon: _16$n },
    { name: 'download', icon: _16$m },
    { name: 'edit', icon: _16$l },
    { name: 'error', icon: _16$k },
    { name: 'filter_list', icon: _16$j },
    { name: 'first_page', icon: _16$i },
    { name: 'help', icon: _16$h },
    { name: 'info', icon: _16$g },
    { name: 'info_filled', icon: _16$f },
    { name: 'last_page', icon: _16$e },
    { name: 'menu', icon: _16$d },
    { name: 'menu_close', icon: _16$c },
    { name: 'overflow_menu', icon: _16$b },
    { name: 'retry', icon: _16$a },
    { name: 'schedule', icon: _16$9 },
    { name: 'search', icon: _16$8 },
    { name: 'stop', icon: _16$7 },
    { name: 'subtract', icon: _16$6 },
    { name: 'success', icon: _16$5 },
    { name: 'thumbs_down', icon: _16$4 },
    { name: 'thumbs_down_filled', icon: _16$3 },
    { name: 'thumbs_up', icon: _16$2 },
    { name: 'thumbs_up_filled', icon: _16$1 },
    { name: 'warning', icon: _16 },
];
