...
const AtChartSparkline = class {
    ...
    render() {
        return (h(Host, { key: 'fb2c50b9a3429dbfaeb8e883e679b62138460c46', style: { height: '100%', width: '100%' } }, h("canvas", { key: 'c0fbaab7343d023b0b22c26863da1cd5993030fe', ref: (el) => (this.canvasEl = el), class: `w-full ${heightVariants[this.height]}`, "data-name": "sparkline-canvas" })));
    }
};
