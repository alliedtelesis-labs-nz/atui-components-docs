...
const AtPromptInputComponent = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'e2f60bc00f30ff0bd9f295b963a00488761d0c7b', id: this.inputId + '-container', class: "w-full px-16" }, h("div", { key: '79d7778a3101e874374e7fa01d6e069af85bdff3', class: "flex flex-col" }, h("slot", { key: 'bfac766410aca84fd203d41198b4cd12cb025b95', name: "label" }), (this.label || this.info_text) && (h("at-form-label", { key: '22a3e0c44132cbf16201f9f4ae854cf98c19af63', label: this.label, for: this.inputId, info_text: this.info_text, "data-name": "prompt-input-label" })), this.hint_text && (h("span", { key: '5f5323fd45fe0d650843bc6dfdd1311f914364f3', class: "text-muted mb-8 inline-block text-xs leading-tight", "data-name": "prompt-input-hint" }, this.hint_text))), h("div", { key: 'b3d95dbf968c90dc88dca46049accdcf5989ed24', class: containerClass }, h("textarea", { key: '6a86eaff551b3b25995aee4a9c45ef101ca9c382', class: inputClass, disabled: this.disabled, id: this.inputId, placeholder: this.placeholder, onInput: (event) => this.handleInput(event), onKeyDown: (event) => this.handleKeyDown(event), value: this.value, ref: (el) => (this.textareaEl = el), style: {
                minHeight: '44px',
                maxHeight: this.max_height + 'px',
                overflow: 'auto',
            }, "data-name": "prompt-input" }), h("div", { key: '14408095708c7ecd92358f2ce830352c2d678c17', class: "flex w-full items-center justify-between gap-1" }, h("div", { key: '8368c6acbd426b951650c49c7529b36201e08270', class: "flex items-center gap-4" }, h("slot", { key: '49b83ab0f8ababe9e78a4c332ad49afa2b8f3839', name: "actions-left" })), h("div", { key: 'cc6f8100b9c43d9f4d651e5151a23c11e0d35207', class: "flex items-center gap-4 self-end" }, h("slot", { key: '4bf3cbc42e78571f7ce49002a07038c02c410cb9', name: "actions-right" }), h("at-button", { key: '26ee55b84d02bcace3e4f13f06f25d91fe10c696', class: "rounded-lg", size: "sm", type: "secondary", disabled: !canSend, onClick: () => this.sendMessage(), onKeyDown: (event) => {
                if (event.key === 'Enter' ||
                    event.key === ' ') {
                    this.sendMessage();
                }
            }, "data-name": "prompt-send-button" }, h("at-icon", { key: '035d20ad95e0a11c1c86c45a03f5f8d9d47bf43d', slot: "icon", name: this.in_progress ? 'stop' : 'allowUp' }))))), h("slot", { key: 'b2f9bfc3bebfc5bcbabe9550d40f5ea7809bb405', name: "footer" }), this.invalid && (h("span", { key: '28bfe0844516b86145982ac1f1ddc6841ade370a', class: "text-error-foreground text-xs", "data-name": "error-text" }, this.error_text
            ? this.error_text
...
const AtPromptThread = class {
    ...
    render() {
        ...
        return (h(Host, { key: '0943e1dc54a2dd54c43a91fcc107be9c85aa7e91', class: "block h-full", "data-name": "thread-container" }, h("div", { key: '3e1cbe6335ba36bc9138b8f71f87a17e8514321b', class: "flex h-full flex-col gap-16 overflow-y-auto scroll-smooth", ref: (el) => (this.scrollContainer = el), "data-name": "scroll-container" }, !hasMessages ? (h("slot", { name: "thread-empty-state" })) : (h("div", { "data-name": "thread-messages-container", class: "flex flex-col gap-16" }, this.renderMessages(), this.renderLoadingIndicator())), h("slot", { key: 'e0b7596f8c9994067775f04ecf4718d2caa3ddbe', name: "thread-messages" }))));
    }
};
