import { r as registerInstance, c as createEvent, a as getElement, h, H as Host } from './index-9VFkhV2N.js';
...
const AtPromptInputComponent = class {
    ...
    render() {
        ...
        return (h(Host, { key: '976755bd74254ac3df04262f5310cfc97753e7c4', id: this.inputId + '-container', class: "w-full px-16" }, h("div", { key: 'ab1047ed9977045990766fd0ab861685c4621e47', class: "flex flex-col empty:hidden" }, h("slot", { key: '741fa18073ff423cd4a92ee8bc2bc019440f65d0', name: "label" }), (this.label || this.info_text) && (h("at-form-label", { key: '4de698e153421ac2ab3bc500a3cbd5a2c4140d9e', label: this.label, for: this.inputId, info_text: this.info_text, "data-name": "prompt-input-label" })), this.hint_text && (h("span", { key: '18019c0f434ce5ab31b40b5de58567fc0a19716f', class: "text-muted mb-8 inline-block text-xs leading-tight", "data-name": "prompt-input-hint" }, this.hint_text))), h("div", { key: '2cc787daf01f1dbfaf9dba9f2c595a12d46493f9', class: containerClass }, h("textarea", { key: 'd90a972ca301eb8341afce7cd2b37c5b54064884', class: inputClass, disabled: this.disabled, id: this.inputId, placeholder: this.placeholder, onInput: (event) => this.handleInput(event), onKeyDown: (event) => this.handleKeyDown(event), value: this.value, ref: (el) => (this.textareaEl = el), style: {
                minHeight: '44px',
                maxHeight: this.max_height + 'px',
                overflow: 'auto',
            }, "data-name": "prompt-input" }), h("div", { key: '3fc9748a271c551fbf76acf15652ddb9687f5046', class: "flex w-full items-center justify-between gap-1" }, h("div", { key: '23e692772d5ee56324edd3c883c3707d1163514e', class: "flex items-center gap-4" }, h("slot", { key: '4e3e4ea13bedb8f6faf1c4388c086eef45809c1b', name: "actions-left" })), h("div", { key: 'a04a74516f3ef07cf13793ede4615453bc574f22', class: "flex items-center gap-4 self-end" }, h("slot", { key: 'b0049bc09579d226f6e5085b7b7da43d33a697fa', name: "actions-right" }), h("at-button", { key: '43f7e171b57450cda43a604a0fc21c65ebe5ae29', class: "rounded-lg", size: "sm", type: "primary", disabled: !canSend, onClick: () => this.sendMessage(), onKeyDown: (event) => {
                if (event.key === 'Enter' ||
                    event.key === ' ') {
                    this.sendMessage();
                }
            }, "data-name": "prompt-send-button" }, h("at-icon", { key: 'd82db227a9440d3f12dc776ac96ca3e7e50eaca4', slot: "icon", name: this.in_progress ? 'stop' : 'send' }))))), h("slot", { key: 'f3ed7656adbf99faee818d5b308a833f006e7080', name: "footer" }), this.invalid && (h("span", { key: '0f637c7de968cf6188e5362122375a2592541b07', class: "text-error-foreground text-xs", "data-name": "error-text" }, this.error_text
            ? this.error_text
...
const AtPromptThread = class {
    ...
    render() {
        ...
        return (h(Host, { key: '2daa77c641f655fc6e713a78b73154c7b867b68b', class: "block h-full", "data-name": "thread-container" }, h("div", { key: 'c9c1fc2fb7f9b139a7be8435cb79b4d465606550', class: "flex h-full flex-col gap-16 overflow-y-auto scroll-smooth", ref: (el) => (this.scrollContainer = el), "data-name": "scroll-container" }, !hasMessages ? (h("slot", { name: "thread-empty-state" })) : (h("div", { "data-name": "thread-messages-container", class: "flex flex-col gap-16" }, this.renderMessages(), this.renderLoadingIndicator())), h("slot", { key: '59eab9e05cd645a5683bca56e0480e3fa7895c68', name: "thread-messages" }))));
    }
