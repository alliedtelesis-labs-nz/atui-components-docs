...
const promptInputContainerVariants = classlist('relative flex flex-col items-end gap-2 rounded-lg border border-solid p-8 transition-[color,background-color,border-color,box-shadow,fill] duration-150 ease-in-out', {
    variants: {
        invalid: {
...
const AtPromptInputComponent = class {
    ...
    render() {
        ...
        return (h(Host, { key: '065fd28a9ee3412de51d003dd628d8a348058bb5', id: this.inputId + '-container', class: "w-full px-16" }, h("div", { key: '582a80f81c67ed7a19a0cdb20328be2346f30ba1', class: "flex flex-col empty:hidden" }, h("slot", { key: '47ff0c259478909885ac1b72903fdcc20aed3b14', name: "label" }), (this.label || this.info_text) && (h("at-form-label", { key: '71d107a11ac49c1172fbb01a3d4cb66d44047d79', label: this.label, for: this.inputId, info_text: this.info_text, "data-name": "prompt-input-label" })), this.hint_text && (h("span", { key: '0729764c336f68191cf3e6bd149988e174f94f1e', class: "text-muted mb-8 inline-block text-xs leading-tight", "data-name": "prompt-input-hint" }, this.hint_text))), h("div", { key: 'a5b15ec1202dc6f646e60fd11f2d05a7df86b90e', class: containerClass }, h("textarea", { key: '5728643ae90af3e6c11d440e8f4a1b871ced60d9', class: inputClass, disabled: this.disabled, id: this.inputId, placeholder: this.placeholder, onInput: (event) => this.handleInput(event), onKeyDown: (event) => this.handleKeyDown(event), value: this.value, ref: (el) => (this.textareaEl = el), style: {
                minHeight: '44px',
                maxHeight: this.max_height + 'px',
                overflow: 'auto',
            }, "data-name": "prompt-input" }), h("div", { key: '7dbb5bf93b8fd65e1b54c539fb246cb635c18d4a', class: "flex w-full items-center justify-between gap-1" }, h("div", { key: '399a4f46bff8ecdd9edff00170d4a54cda6bff03', class: "flex items-center gap-4" }, h("slot", { key: 'd1d98d15e968946b078e00ff1c429feb8047584b', name: "actions-left" })), h("div", { key: '9df82c38f5d414389bbbf3a87993853b6861d675', class: "flex items-center gap-4 self-end" }, h("slot", { key: '99cd56d97d390a8f1ce5e588b2328d248fffed8d', name: "actions-right" }), h("at-button", { key: '996ef7f6307eb36c0a13499139ef545bb85d8365', class: "rounded-lg", size: "sm", type: "primary", disabled: !canSend, onClick: () => this.sendMessage(), onKeyDown: (event) => {
                if (event.key === 'Enter' ||
                    event.key === ' ') {
                    this.sendMessage();
                }
            }, "data-name": "prompt-send-button" }, h("at-icon", { key: 'c1eecd9a4349dbb1c9f96397a6766559a087bed7', slot: "icon", name: this.in_progress ? 'stop' : 'send' }))))), h("slot", { key: 'c60ecf06d9a043479921bbf256367df64967fbe5', name: "footer" }), this.invalid && (h("span", { key: 'f641c42ef83bbd5e3fe0dc1ea8917000c7edc8b4', class: "text-error-foreground text-xs", "data-name": "error-text" }, this.error_text
            ? this.error_text
