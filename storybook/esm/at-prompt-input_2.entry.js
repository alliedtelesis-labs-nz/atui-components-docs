...
const AtPromptInputComponent = class {
    ...
    render() {
        ...
        return (h(Host, { key: '92e5d4aa482fde04b25cc0da4f79e9189354be32', id: this.inputId + '-container', class: "w-full px-16" }, h("div", { key: 'f122e4127914c69865ed6f8fc4b0a3ecebcef633', class: "flex flex-col" }, h("slot", { key: 'aca983807ef1cf545e4b923999818932c49a62b7', name: "label" }), (this.label || this.info_text) && (h("at-form-label", { key: '5514b43a9510b4155153a8d3029c0aeb4d787258', label: this.label, for: this.inputId, info_text: this.info_text, "data-name": "prompt-input-label" })), this.hint_text && (h("span", { key: '467415efd9a4712911beaba4077e7387962748a1', class: "text-muted mb-8 inline-block text-xs leading-tight", "data-name": "prompt-input-hint" }, this.hint_text))), h("div", { key: '612a8f53789aa37bf421549b75e6fb49b11eca32', class: containerClass }, h("textarea", { key: '2fefb3120c2ccd599539fb0e0f757440a0d39c1a', class: inputClass, disabled: this.disabled, id: this.inputId, placeholder: this.placeholder, onInput: (event) => this.handleInput(event), onKeyDown: (event) => this.handleKeyDown(event), value: this.value, ref: (el) => (this.textareaEl = el), style: {
                minHeight: '44px',
                maxHeight: this.max_height + 'px',
                overflow: 'auto',
            }, "data-name": "prompt-input" }), h("div", { key: 'a9c668f44d9b5d155c0eb0e01173e4a5b4225bb5', class: "flex w-full items-center justify-between gap-1" }, h("div", { key: '99d07d00c63917b32f2600ceb3a0bd001a7946f2', class: "flex items-center gap-4" }, h("slot", { key: '3c41a5d170ab9858e4611afcf6362896d98eded3', name: "actions-left" })), h("div", { key: 'bb5efa91096ec140f89620a32cca3f6a0b9187c5', class: "flex items-center gap-4 self-end" }, h("slot", { key: '05731ea80f3fb4ef4f3d970f0613d81d1466fb22', name: "actions-right" }), h("at-button", { key: '535713995c4f08b6545dce5e3505c707657ab547', class: "rounded-lg", size: "sm", type: "secondary", disabled: !canSend, onClick: () => this.sendMessage(), onKeyDown: (event) => {
                if (event.key === 'Enter' ||
                    event.key === ' ') {
                    this.sendMessage();
                }
            }, "data-name": "prompt-send-button" }, h("at-icon", { key: '02dbce7bd56c726885bd63420b5c0f6d25672c2a', slot: "icon", name: this.in_progress ? 'stop' : 'allowUp' }))))), h("slot", { key: '39469f2ed730bb5d8c1005bf8513bcd3b11d7aa0', name: "footer" }), this.invalid && (h("span", { key: '50ee15254db201aca96dfaf3b35bc3037e34793f', class: "text-error-foreground text-xs", "data-name": "error-text" }, this.error_text
            ? this.error_text
