...
const AtPromptInputComponent = class {
    ...
    render() {
        ...
        return (h(Host, { key: '4dc8b89cb13373fb5bfbb521cdca48c88f39f11d', id: this.inputId + '-container', class: "w-full px-16" }, h("div", { key: '1d7e325004f67d356031b47d07a0086883700142', class: "flex flex-col empty:hidden" }, h("slot", { key: 'a8cbca5c2096a96a5a6cacdb8760681f34866e89', name: "label" }), (this.label || this.info_text) && (h("at-form-label", { key: '3b90fd2665ba71b9e1c010cb8e22fbeb5e9531c8', label: this.label, for: this.inputId, info_text: this.info_text, "data-name": "prompt-input-label" })), this.hint_text && (h("span", { key: '58cb73d9d61f93aa27b682fafc46fdbe21a1d0be', class: "text-muted mb-8 inline-block text-xs leading-tight", "data-name": "prompt-input-hint" }, this.hint_text))), h("div", { key: 'e6dca6346d45dd51c780b5d60e907a3fdadee13a', class: containerClass }, h("textarea", { key: '86dadb93ae70837edad2ba2fa2bcfe6e93fd50ec', class: inputClass, disabled: this.disabled, id: this.inputId, placeholder: this.placeholder, onInput: (event) => this.handleInput(event), onKeyDown: (event) => this.handleKeyDown(event), value: this.value, ref: (el) => (this.textareaEl = el), style: {
                minHeight: '44px',
                maxHeight: this.max_height + 'px',
                overflow: 'auto',
            }, "data-name": "prompt-input" }), h("div", { key: 'cf0d085b6916d8f96e32e1b68bf352f16827daca', class: "flex w-full items-center justify-between gap-1" }, h("div", { key: 'be1e4c5bc4bc2bd222b4f8d3f641b85e6fae7b2a', class: "flex items-center gap-4" }, h("slot", { key: 'c193f6895908b53597572f3359b338f946231344', name: "actions-left" })), h("div", { key: 'fdd69ce17ddb83290a1efb3e256b2b1346f58fbf', class: "flex items-center gap-4 self-end" }, h("slot", { key: 'af849114d9de57359d8a1bb5a3eb51c215d38c19', name: "actions-right" }), h("at-button", { key: 'cd739d0a81267c4d57304b36aad28113414a383b', class: "rounded-lg", size: "sm", type: "primary", disabled: !canSend, onClick: () => this.sendMessage(), onKeyDown: (event) => {
                if (event.key === 'Enter' ||
                    event.key === ' ') {
                    this.sendMessage();
                }
            }, "data-name": "prompt-send-button" }, h("at-icon", { key: '3e56ed575602034c306062b71731adc82528132e', slot: "icon", name: this.in_progress ? 'stop' : 'send' }))))), h("slot", { key: '2158314b7d09f45131a11c7c38ba090cc3d4c597', name: "footer" }), this.invalid && (h("span", { key: '3836213bc8a033a688652038abdbb81055c0b5c2', class: "text-error-foreground text-xs", "data-name": "error-text" }, this.error_text
            ? this.error_text
...
const AtPromptThread = class {
    ...
    render() {
        ...
        return (h(Host, { key: '1f0b6f1e42606e152755b1fe4cb3877e5ff9d256', class: "block h-full", "data-name": "thread-container" }, h("div", { key: '410f15903bc7ef040980ca43f5f5124c98ee8772', class: "flex h-full flex-col gap-16 overflow-y-auto scroll-smooth", ref: (el) => (this.scrollContainer = el), "data-name": "scroll-container" }, !hasMessages ? (h("slot", { name: "thread-empty-state" })) : (h("div", { "data-name": "thread-messages-container", class: "flex flex-col gap-16" }, this.renderMessages(), this.renderLoadingIndicator())), h("slot", { key: '9dd82d20b210ab82352464d40cc791b3cc8767a5', name: "thread-messages" }))));
    }
