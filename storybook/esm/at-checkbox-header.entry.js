...
const AtCheckboxHeaderComponent = class {
    ...
    render() {
        return (h("at-checkbox", { key: 'b7a9a98514f56cc4a5db93480451c59a486593fe', disabled: this.disabled, checked: this.isChecked, onAtuiChange: (event) => this.setRowsValue(event.detail) }));
    }
};
