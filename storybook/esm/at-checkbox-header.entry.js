...
const AtCheckboxHeaderComponent = class {
    ...
    render() {
        return (h("at-checkbox", { key: '77ed66b18b0403427ed5561e70d0c7c94746165a', disabled: this.disabled, checked: this.isChecked, onAtuiChange: (event) => this.setRowsValue(event.detail) }));
    }
};
