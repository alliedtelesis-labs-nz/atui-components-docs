import { r as registerInstance, h, H as Host, c as createEvent, a as getElement } from './index-lWb16Ay7.js';
...
const AtControlGroup = class {
    ...
    render() {
        return (h(Host, { key: '89091780de572e5d7c2aa3053dc0965caa5575b8', class: `at-control-group at-control-group--${this.direction}` }, h("slot", { key: '67554b8da7a537c381b40101e62c7a778771e1e3' })));
    }
};
...
const AtTableFilterMenu = class {
    ...
    render() {
        return (h(Host, { key: '20b352ed5671960089b5ae76b1ff2f8324cc7b01' }, h("at-menu", { key: '51dd260c20fd7c8fef0f4dbfb6c429a7b04c04e6', ref: (el) => (this.menuEl = el), autoclose: false, width: "fit-content", class: "self-start", align: "start" }, h("div", { key: '3c8c0f78ee64e42c885ba0982a1229654ee8d2b2', class: "relative", slot: "menu-trigger", "data-tooltip": "table-filter-menu" }, this.filters &&
            countFilterConditions(this.filters) > 0 && (h("at-badge", { key: 'ad201c9126797d23e16ad613852c7c5a383af238', class: "absolute top-[-8px] left-[-6px] z-10", type: "info", size: "sm", label: countFilterConditions(this.filters).toString() })), h("at-button", { key: 'b8eca58a4b9ba873149d6c0381aa6c9630b5aa5f', slot: "tooltip-trigger", type: "secondaryOutline", class: "h-input", "data-name": "filter-menu-trigger" }, h("at-icon", { key: '3e67ded5e02f1ba5ffa78d0f5a38e8d29bd12933', slot: "icon", name: "edit_filters" }))), h("at-tooltip", { key: '0c8b8db018de9d0f874fabb48664d7bfb672c61c', "trigger-id": "table-filter-menu", position: "top" }, this.translations.ATUI.TABLE.FILTER_DATA), h("at-filter-form", { key: '5e52108fd39d0d55d2ab873c695862a66893ef23', filter_config: this.filterConfig, active_filters: this.filters, onAtSearch: this.handleSearch, onAtCancel: this.handleCancel }))));
    }
};
