import { r as registerInstance, h, H as Host, c as createEvent, a as getElement } from './index-46ti_ijN.js';
...
const AtControlGroup = class {
    ...
    render() {
        return (h(Host, { key: 'a529e34be10d97a7944b5e587d9d17fd1a71674d', class: `at-control-group at-control-group--${this.direction}` }, h("slot", { key: '547214b162578b95b51ac3a41c1aebf37004a971' })));
    }
};
...
const AtTableFilterMenu = class {
    ...
    render() {
        return (h(Host, { key: '022bbd04268c7989d95cbb8fbae23c6fbfbe5623' }, h("at-menu", { key: '9e234bf71a92c0be28654513b69e08b9969ea697', ref: (el) => (this.menuEl = el), autoclose: false, width: "fit-content", class: "self-start", align: "start" }, h("div", { key: 'e05b308373e06edb7331c72bbdb1c3e5ec56833c', class: "relative", slot: "menu-trigger", "data-tooltip": "table-filter-menu" }, this.filters &&
            countFilterConditions(this.filters) > 0 && (h("at-badge", { key: '5ebde514fd78f4caf41ed161abba63474d765e88', class: "absolute top-[-8px] left-[-6px] z-50", type: "info", size: "sm", label: countFilterConditions(this.filters).toString() })), h("at-button", { key: '3237e08cda1bf4d704b85c8240507c61e15d2039', slot: "tooltip-trigger", type: "secondaryOutline", class: "h-input", "data-name": "filter-menu-trigger" }, h("at-icon", { key: 'a782a1a9b554900e8b21f68fc5037cd9d426fb24', slot: "icon", name: "edit_filters" }))), h("at-tooltip", { key: '8e582e0d378911da7776c70051089b6cb6a86935', "trigger-id": "table-filter-menu", position: "top" }, this.translations.ATUI.TABLE.FILTER_DATA), h("at-filter-form", { key: '5c5008217ddb864946e6bd9675b412a5837db727', filter_config: this.filterConfig, active_filters: this.filters, onAtSearch: this.handleSearch, onAtCancel: this.handleCancel }))));
    }
};
...
const AtTablePagination = class {
    ...
    atPageSizeChange;
    render() {
        return (h(Host, { key: '4361d18122825313841e0e6585979bad7b7c0727', class: "mt-8 flex items-center justify-end gap-8" }, h("span", { key: 'c4791af06b9181ffb6eacd8d4beefc5310755401' }, "Page Size: "), h("at-select", { key: '23c23575b6810de62584d2f3730e3c7011d6b519', options: this.resolvedPageSizeOptions, value: String(this.page_size), clearable: false, onAtuiChange: (event) => this.atPageSizeChange.emit(parseInt(event.detail)) }), h("at-button", { key: 'ff0b2b7b3d1269aecb884715eb5e234e5b3e5acf', "data-name": "pagination-first", "aria-label": "First page", disabled: this.current_page === 1, type: "secondaryText", onAtuiClick: () => this.atChange.emit(1) }, h("at-icon", { key: 'd73c948e3cea5a877961f5af07224a47b89ed943', slot: "icon", name: "first_page" })), h("at-button", { key: '24f33abe768a97f7e81d928056c91b6abd4bcdfc', "data-name": "pagination-previous", "aria-label": "Previous page", disabled: this.current_page === 1, type: "secondaryText", onAtuiClick: () => this.atChange.emit(this.current_page - 1) }, h("at-icon", { key: '09839b8183a8045cfa99c548b689634b561351a6', slot: "icon", name: "chevron_left" })), h("span", { key: 'a9ca68745fbfdd60f8b11595e93ce47bf8369bdd' }, "Page ", this.current_page, " of ", this.num_pages), h("at-button", { key: 'b65ced065077cf636756053e87f39c3303458e37', "data-name": "pagination-next", "aria-label": "Next page", disabled: this.current_page === this.num_pages, type: "secondaryText", onAtuiClick: () => this.atChange.emit(this.current_page + 1) }, h("at-icon", { key: 'ad211b816f06187b755572747bfce55a3593dc3e', slot: "icon", name: "chevron_right" })), h("at-button", { key: '51f2f13f82f3ab9500a5c43a4e724a8a1ab9bfd6', "data-name": "pagination-last", "aria-label": "Last page", disabled: this.current_page === this.num_pages, type: "secondaryText", onAtuiClick: () => this.atChange.emit(this.num_pages) }, h("at-icon", { key: 'e98fc3008b8bfb5639f535558af9c699aa6d79fa', slot: "icon", name: "last_page" }))));
    }
};
