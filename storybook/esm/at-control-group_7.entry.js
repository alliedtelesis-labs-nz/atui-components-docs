import { r as registerInstance, h, H as Host, c as createEvent, a as getElement } from './index-CT99rxub.js';
...
const AtSearch = class {
    ...
    render() {
        return (h(Host, { key: '55b21e8d00779f9ce38ee8590d2f5b4f2df23a1f' }, this.label && (h("at-form-label", { key: 'e01a9282a646a456fc2706a4fb74027f2f2f2187', label: this.label, for: this.inputId })), h("div", { key: 'f251c6280f0f23c089eb73b257942c551ec3b6cb', class: "transition[background-color,color,box-shadow] border-input bg-input-background focus-within:border-active-accent focus-within:ring-active-glow rounded-input h-input min-h-input relative flex flex-row items-center justify-center border duration-300 ease-in-out focus-within:z-10 focus-within:ring" }, h("at-icon", { key: 'af6a418d8ed70891138f4063644a83d2396d45aa', class: "fill-foreground px-8", name: "search" }), h("input", { key: 'a5c4b3d5d2203997a5a0e5249198c640d48b1c91', id: this.inputId, role: "searchbox", "aria-label": this.label
                ? undefined
                : this.placeholder || 'Search', tabindex: "0", class: "mr-4 h-full w-full min-w-0 bg-transparent p-0 leading-[30px] text-ellipsis focus:border-none focus:outline-none", placeholder: this.placeholder, value: this.model, autocomplete: "off", name: "search", onInput: () => this.onChangeFn(), ref: (el) => (this.searchEl = el) }), h("div", { key: '470c79ef805bf671c287597d42ecb5a09067da65', class: `mt-2 transition-all duration-300 ease-in-out ${this.model !== '' && this.model !== undefined
                ? 'pr-4 opacity-100'
                : 'pointer-events-none pr-0 opacity-0'}` }, h("at-button", { key: '531a82d5450cabb4eece788a644274e7b73bfeac', size: "sm", type: "secondaryText", "aria-label": "Clear search", onClick: () => this.clearFn(), "data-name": "search-clear", tabindex: this.model !== '' && this.model !== undefined
                ? '0'
                : '-1' }, h("at-icon", { key: '1f6ea1aa36b147b100ec916c3435038d8fe0b6bc', slot: "icon", name: "cancel" }))), this.info_text && (h("div", { key: 'bb9f69ff7b6097c87da0be90aeaeaa939b646586', class: "flex items-center pr-8", "data-name": "search-info" }, h("at-tooltip", { key: '9578572684f009a6e479efb7372bc5c25d57efba', position: "top" }, h("at-icon", { key: 'e4452aed7cb543b9e916ab11506c1d614543aab0', slot: "tooltip-trigger", class: "fill-muted cursor-pointer", name: "info", size: "1rem" }), h("span", { key: 'e6a30665121d8823967278d08a9d687bf751765c' }, this.info_text))))), this.hint_text && (h("span", { key: 'f1c10da761e8182851ad57270f55a127809431bd', class: "text-secondary mt-4 truncate text-xs !leading-normal font-normal empty:hidden", "data-name": "search-hint" }, this.hint_text))));
    }
};
