...
const AtSearch = class {
    ...
    render() {
        return (h(Host, { key: '9742d30524c92ab20f4f467853d0e93f1fe17edb' }, this.label && (h("at-form-label", { key: '582255b52ed5ddab58274ebaba5b008d7dfc921a', label: this.label, for: this.inputId })), h("div", { key: '5830946a4c83c7bccd31a24347566c9a688a989e', class: "border-input bg-input-background focus-within:border-active-accent focus-within:ring-active-glow rounded-input h-input min-h-input relative flex flex-row items-center justify-center border transition-[color,background-color,border-color,box-shadow,fill] duration-150 ease-in-out focus-within:z-10 focus-within:ring" }, h("at-icon", { key: '983497f37c0b0aa30073d149f09b235a08098360', class: "fill-foreground px-8", name: "search" }), h("input", { key: '44f971d9e83d351da02fa6b66c9b83470d1d2ccf', id: this.inputId, role: "searchbox", "aria-label": this.label
                ? undefined
                : this.placeholder || 'Search', tabindex: "0", class: "mr-4 h-full w-full min-w-0 bg-transparent p-0 leading-[30px] text-ellipsis focus:border-none focus:outline-none", placeholder: this.placeholder, value: this.model, autocomplete: "off", name: "search", onInput: () => this.onChangeFn(), ref: (el) => (this.searchEl = el) }), h("div", { key: '50bd557b945f5c154bcb42286c6fcd0dd328d4d3', class: `mt-2 transition-[opacity] duration-150 ease-in-out ${this.model !== '' && this.model !== undefined
                ? 'pr-4 opacity-100'
                : 'pointer-events-none pr-0 opacity-0'}` }, h("at-button", { key: '302b5dba762d4514f77e63f3cbb24232adee34eb', size: "sm", type: "secondaryText", "aria-label": "Clear search", onClick: () => this.clearFn(), "data-name": "search-clear", tabindex: this.model !== '' && this.model !== undefined
                ? '0'
                : '-1' }, h("at-icon", { key: 'c9b105d1b750ab305c1ee3fa8a50254be3d2feb8', slot: "icon", name: "cancel" }))), this.info_text && (h("div", { key: '437519b1d4efb8df4007b4ce3d44cdf0e20d9aaa', class: "flex items-center pr-8", "data-name": "search-info" }, h("at-tooltip", { key: '40e616417e6c4aa199234e6704ebb4e56ee61fb7', position: "top" }, h("at-icon", { key: '2c831daae2d171c3985e3bf5806fc81c5740469b', slot: "tooltip-trigger", class: "fill-muted cursor-pointer", name: "info", size: "1rem" }), h("span", { key: '13509cb7a0d4b2ad0871052e5ebc1a9013b96828' }, this.info_text))))), this.hint_text && (h("span", { key: 'ea4500765e5fb5d2560c52c34c1a5a433b78cbe9', class: "text-secondary mt-4 truncate text-xs !leading-normal font-normal empty:hidden", "data-name": "search-hint" }, this.hint_text))));
    }
};
...
const AtTablePagination = class {
    ...
    atPageSizeChange;
    render() {
        return (h(Host, { key: 'bd20c40b0e6058117f9709c6e3d8e422b387390e', class: "mt-8 flex items-center justify-end gap-8" }, h("span", { key: 'e1de6a1c6f7ae3e562282adcd81bba87519749fd' }, "Page Size: "), h("at-select", { key: '84f449ff2e96dbf516825fd16cfdc1ae25332b41', options: this.resolvedPageSizeOptions, value: String(this.page_size), clearable: false, onAtuiChange: (event) => this.atPageSizeChange.emit(parseInt(event.detail)) }), h("at-button", { key: '895fdd920f289a8821924f3e500e9570d24768bf', "data-name": "pagination-first", "aria-label": "First page", disabled: this.current_page === 1, type: "secondaryText", onAtuiClick: () => this.atChange.emit(1) }, h("at-icon", { key: '3aaec4bd8be996ba06ac8ca5f160ce23ba087bc8', slot: "icon", name: "first_page" })), h("at-button", { key: '635b77c312800684433c8257d8cf053d13b8987d', "data-name": "pagination-previous", "aria-label": "Previous page", disabled: this.current_page === 1, type: "secondaryText", onAtuiClick: () => this.atChange.emit(this.current_page - 1) }, h("at-icon", { key: 'cca41b0ee8a0aad53f200c45750f2e82de1e0864', slot: "icon", name: "chevron_left" })), h("span", { key: '5fb2f34f84cd228e27502cdd74cdba1c7be0e1b4' }, "Page ", this.current_page, " of ", this.num_pages), h("at-button", { key: '512a569e73140bc153a610ba60e1e5386c9b29de', "data-name": "pagination-next", "aria-label": "Next page", disabled: this.current_page === this.num_pages, type: "secondaryText", onAtuiClick: () => this.atChange.emit(this.current_page + 1) }, h("at-icon", { key: '4590d1d304bd85367918e7ecf9a4ce75d63ecbf9', slot: "icon", name: "chevron_right" })), h("at-button", { key: 'd49fa12f66fc45d9fb9edc434c79f13700df442a', "data-name": "pagination-last", "aria-label": "Last page", disabled: this.current_page === this.num_pages, type: "secondaryText", onAtuiClick: () => this.atChange.emit(this.num_pages) }, h("at-icon", { key: 'fc7f8b2c1d86bc1d4aa56aa1ee69c7824b5020c6', slot: "icon", name: "last_page" }))));
    }
};
