import { r as registerInstance, h, H as Host, c as createEvent, a as getElement } from './index-BQ4XN8sR.js';
...
const AtReloadButton = class {
    ...
    atuiReload;
    render() {
        return (h("at-tooltip", { key: '0c69fa9e7fa90ee576b62d5bfef5d58d6aa19547', position: "top" }, h("div", { key: '1957b4e0b6b9203a2cd5cff540c5e386e733b110', slot: "tooltip-trigger", class: "relative" }, this.has_updates && (h("span", { key: 'a831d91ff1df1468a064b6939853a243ccc2561f', class: "!bg-active-foreground pointer-events-none absolute top-[2px] right-[2px] z-10 h-[8px] w-[8px] rounded-full", "data-name": "reload-updates-indicator" })), h("at-button", { key: 'd9c7c8455f4bd8ab5e7ed63fae2624fd01bcd8cf', type: "secondaryText", onAtuiClick: () => this.atuiReload.emit() }, h("at-icon", { key: '4a78af95cced83eca4a8a5dc0bf1d62f9ea22ac4', slot: "icon", name: "retry" }))), h("span", { key: '5cbda68b572d805e101b340ff8e1c59bdc5cde5c' }, this.has_updates
...
const AtSearch = class {
    ...
    render() {
        return (h(Host, { key: '90f38625b6270728e28643900051afa3afe0c47b' }, this.label && (h("at-form-label", { key: '5a7bf8bd3feb87ebe8299d7ad8307e462c11219d', label: this.label, for: this.inputId })), h("div", { key: '4cb2117323623d7c4d3155f24e8a2dda808a80ef', class: "transition[background-color,color,box-shadow] border-input bg-input-background focus-within:border-active-accent focus-within:ring-active-glow rounded-input h-input min-h-input relative flex flex-row items-center justify-center border duration-300 ease-in-out focus-within:z-10 focus-within:ring" }, h("at-icon", { key: 'dd34db1c47ad90cdf621d1d4edc4e38702700f65', class: "fill-foreground px-8", name: "search" }), h("input", { key: '9c956bbe1f30d9b5af91dc9e2c0326950ae3ee0a', id: this.inputId, role: "searchbox", "aria-label": this.label
                ? undefined
                : this.placeholder || 'Search', tabindex: "0", class: "mr-4 h-full w-full min-w-0 bg-transparent p-0 leading-[30px] text-ellipsis focus:border-none focus:outline-none", placeholder: this.placeholder, value: this.model, autocomplete: "off", name: "search", onInput: () => this.onChangeFn(), ref: (el) => (this.searchEl = el) }), h("div", { key: '13a7d5507770688d359f09cc67f570089af17bb2', class: `mt-2 transition-all duration-300 ease-in-out ${this.model !== '' && this.model !== undefined
                ? 'pr-4 opacity-100'
                : 'pointer-events-none pr-0 opacity-0'}` }, h("at-button", { key: '5cc89930b86856a61be7c43759799659b212cbbc', size: "sm", type: "secondaryText", "aria-label": "Clear search", onClick: () => this.clearFn(), "data-name": "search-clear", tabindex: this.model !== '' && this.model !== undefined
                ? '0'
                : '-1' }, h("at-icon", { key: '4cb827d0a1833107830a4e491ea3d71c06dc8f34', slot: "icon", name: "cancel" }))), this.info_text && (h("div", { key: '9a2c5955f903ca2bf5cb658974a0537b1614af03', class: "flex items-center pr-8", "data-name": "search-info" }, h("at-tooltip", { key: '9ae767fb14be628c3c2cea8d7ebf8210304a8826', position: "top" }, h("at-icon", { key: '3ba4f7072a1585c8d848f547b4339c1dae58dc71', slot: "tooltip-trigger", class: "fill-muted cursor-pointer", name: "info", size: "1rem" }), h("span", { key: '6a29730e9e37e8f7ae592942f9ad1fcb53095458' }, this.info_text))))), this.hint_text && (h("span", { key: '19610b51c41a07898cf6ac39d1a3b566a0bee88c', class: "text-secondary mt-4 truncate text-xs !leading-normal font-normal empty:hidden", "data-name": "search-hint" }, this.hint_text))));
    }
};
