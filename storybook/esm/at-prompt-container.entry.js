...
const AtPromptContainer = class {
    ...
    render() {
        return (h(Host, { key: 'dde4e3916344bbeb728f5eb6498a191f4320fbea', class: "flex h-full w-full flex-col overflow-hidden", "data-name": "prompt-container" }, this.renderHeader(), h("slot", { key: 'e5e32f2db12be44dc0b0acfea4daaa0efc262190', name: "prompt-container-header" }), h("div", { key: 'ce855d31cd19deb587ed154ade34a06b7fee6f9b', class: "min-h-0 flex-1", "data-name": "thread-wrapper" }, h("at-prompt-thread", { key: 'ab2e5df15ad5c5e4190b6dd36eb92e1a414d3380', messages: this.messages, loading: this.loading, auto_scroll: true, enable_vote: this.enable_vote, enable_copy: this.enable_copy, enable_edit: this.enable_edit, response_animation: this.response_animation, "data-name": "container-thread" })), h("div", { key: '9353911559d8c4f1df4f9f8dd708b1cd6d5b4efb', class: "flex flex-col gap-4" }, this.renderFooter(), h("slot", { key: '69ad1ce4e5d04f064b4ce036ec85953a15ddd368', name: "prompt-container-footer" }))));
    }
};
