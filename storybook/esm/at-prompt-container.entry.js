...
const AtPromptContainer = class {
    ...
    render() {
        return (h(Host, { key: '9ab4fa33968cd7d8acb2f24ee64f3b71ee952685', class: "flex h-full w-full flex-col overflow-hidden", "data-name": "prompt-container" }, this.renderHeader(), h("slot", { key: '0dc3dd193a56aae9e7b89c7531a8e4342a0bd15e', name: "prompt-container-header" }), h("div", { key: '60aa4d5e181ab0919ea8f4eb9a34b775fb10276c', class: "min-h-0 flex-1", "data-name": "thread-wrapper" }, h("at-prompt-thread", { key: '51fcfb256ce4127231ff043ed1c62b78a203dd1b', chatbot_title: this.chatbot_title, messages: this.messages, loading: this.loading, auto_scroll: true, enable_vote: this.enable_vote, enable_copy: this.enable_copy, enable_edit: this.enable_edit, response_animation: this.response_animation, "data-name": "container-thread" })), h("div", { key: '64f7f04bfd6673efcd81defc7402bfddf09e762c', class: "flex flex-col gap-4" }, this.renderFooter(), h("slot", { key: '349dc71cdd86212d6ff79e4033c6d9a06bc83864', name: "prompt-container-footer" }))));
    }
};
