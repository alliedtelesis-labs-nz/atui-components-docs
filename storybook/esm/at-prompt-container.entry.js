...
const AtPromptContainer = class {
    ...
    render() {
        return (h(Host, { key: 'adf608f19c15c6f7e43c203761e8e593c073c101', class: "flex h-full w-full flex-col overflow-hidden", "data-name": "prompt-container" }, this.renderHeader(), h("slot", { key: '22bd259fb8e52d4e052e116dcc62ab22d44fcae2', name: "prompt-container-header" }), h("div", { key: 'caacd409e5125ead8f4dcd3f0bbcd2f24442dffe', class: "min-h-0 flex-1", "data-name": "thread-wrapper" }, h("at-prompt-thread", { key: 'a5d752081cf5e48fe2e3658122847e724df224a3', chatbot_title: this.chatbot_title, messages: this.messages, loading: this.loading, auto_scroll: true, enable_vote: this.enable_vote, enable_copy: this.enable_copy, enable_edit: this.enable_edit, response_animation: this.response_animation, "data-name": "container-thread" })), h("div", { key: '31dbf6a9cb2cc3e187ceee8c46d132a5f493f26e', class: "flex flex-col gap-4" }, this.renderFooter(), h("slot", { key: '1a81416d88e59120346c62eccb9447d75ae5747c', name: "prompt-container-footer" }))));
    }
};
