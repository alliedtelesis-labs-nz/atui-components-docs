...
const AtPromptContainer = class {
    ...
    render() {
        return (h(Host, { key: '8e4655f80c49456eb1aad426e4953c207f6b2b21', class: "flex h-full w-full flex-col overflow-hidden", "data-name": "prompt-container" }, this.renderHeader(), h("slot", { key: '7782bf607cb52a2a41c8cdd5eb18dcf8e02abecc', name: "prompt-container-header" }), h("div", { key: '5cef41ad12bb4e31a885f198c7cab39d2cc07ac2', class: "min-h-0 flex-1", "data-name": "thread-wrapper" }, h("at-prompt-thread", { key: '2ba0af3e946691911a29cf4b8ffdfbbcdb0370ec', messages: this.messages, loading: this.loading, auto_scroll: true, enable_vote: this.enable_vote, enable_copy: this.enable_copy, enable_edit: this.enable_edit, response_animation: this.response_animation, "data-name": "container-thread" })), h("div", { key: 'bce0ab52db8181e3f6dfb256bc204c0b0f437027', class: "flex flex-col gap-4" }, this.renderFooter(), h("slot", { key: 'b53cefa668f3f5ea8135b9e7c4137a444a782699', name: "prompt-container-footer" }))));
    }
};
