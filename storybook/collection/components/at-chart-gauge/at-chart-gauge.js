...
export class AtChartGauge {
    ...
    render() {
        return (h(Host, { key: '9bb93b4c7b9a9ce1a76743c327ba703bbf7f6121', style: { height: '100%', width: '100%' } }, h("canvas", { key: 'c07a526ef3c81260bf81c1f1365d1fd5d56a8eef', ref: (el) => (this.canvasEl = el), class: `w-full ${heightVariants[this.height]}`, "data-name": "gauge-canvas" })));
    }
    ...
    static get properties() {
        return {
            ...
            "unit": {
                ...
                "docs": {
                    "tags": [],
                    "text": "Unit appended to `center_value`, rendered at a smaller size (e.g.\n`%`). Not appended to `center_value` directly \u2014 include it via this\nprop to get the smaller styling; otherwise bake it into `center_value`\nfor equal-size rendering."
                },
                "getter": false,
                "setter": false,
                "reflect": false,
