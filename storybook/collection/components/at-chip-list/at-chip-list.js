...
export class AtChipList {
    ...
    render() {
        return (h("div", { key: 'ccf3f636e256968cfc2f3c349dfb67b3620b2ffb', class: "flex h-full flex-wrap items-center gap-4" }, this.chips && this.getChips, !this.disabled &&
            this.chips &&
            this.chips.length > 1 &&
            this.show_clear_all && (h("at-button", { key: '65a7ec14f0b34c2663f4eb8d7795a5ff3a288ec3', size: "sm", type: "secondaryText", icon: "backspace", "data-name": "clear-all", "aria-label": "Clear all chips", onAtuiClick: () => {
                this.removeChipHandler(this.chips);
            } })), h("slot", { key: '8d5b803dd6e18d5f69d17028c1554407aae14bd5' })));
    }
