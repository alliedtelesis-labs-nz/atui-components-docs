...
export class AtStepperItem {
    ...
    render() {
        ...
        return (h(Host, { key: '64facba0e049b381706b044cfc621af03c853126', role: "listitem", "aria-current": this.state === 'current' ? 'step' : undefined, "data-state": this.state, "data-name": "stepper-item", class: `flex min-w-0 ${isVertical
                ...
                : ''}`, tabindex: this.navigable ? 0 : undefined }, h("span", { key: '1bee52871e783a645577193f124f66c48d076065', class: `flex shrink-0 ${isVertical
                ? 'w-24 flex-col items-center'
                : 'items-center'}`, "data-name": "stepper-rail" }, this.renderMarker(), this.renderConnector()), h("span", { key: 'f820058609da62073dc19896b773bdb268456c8f', class: `flex min-w-0 flex-col gap-2 ${isVertical ? (this.is_last ? '' : 'pb-16') : 'pr-16'}` }, h("span", { key: '6c605d5fed18698bb6d626a0cc9247628203b71b', class: `truncate text-sm font-medium ${labelVariants[this.state]}`, "data-name": "stepper-label" }, this.label, this.optional && (h("span", { key: 'e9f3fc5e125ce93e2bdc89d31089abb33d72b3b1', class: "text-secondary ml-4 text-xs font-normal", "data-name": "stepper-optional" }, "Optional")), this.state === 'skipped' && (h("at-badge", { key: 'e24e3d06dbdf0659e65b6553b22e459b9e7c9421', class: "ml-4", label: "Skipped", size: "sm", "data-name": "stepper-skipped" }))), this.description && (h("span", { key: 'de5a70867bed31bfdf360c91087eed673a836c8b', class: "text-secondary truncate text-xs", "data-name": "stepper-description" }, this.description)), h("slot", { key: 'fbc6d9c5250e3a350588b6e4b6837048886bbc67' }))));
    }
