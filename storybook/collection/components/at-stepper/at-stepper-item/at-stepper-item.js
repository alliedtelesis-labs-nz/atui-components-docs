...
export class AtStepperItem {
    ...
    render() {
        ...
        return (h(Host, { key: 'a243360eeed9e22ced1363b838dbbfc8f1460cc4', role: "listitem", "aria-current": this.state === 'current' ? 'step' : undefined, "data-state": this.state, "data-name": "stepper-item", class: `flex min-w-0 ${isVertical
                ...
                : ''}`, tabindex: this.navigable ? 0 : undefined }, h("span", { key: 'f12889f94c448f2514918f5d9656000a6ba8575c', class: `flex shrink-0 ${isVertical
                ? 'w-24 flex-col items-center'
                : 'items-center'}`, "data-name": "stepper-rail" }, this.renderMarker(), this.renderConnector()), h("span", { key: 'b4578a434b5ed071f4f6710854338f55a10db72e', class: `flex min-w-0 flex-col gap-2 ${isVertical ? (this.is_last ? '' : 'pb-16') : 'pr-16'}` }, h("span", { key: 'ae50c8ca72794a6d2ab5f80f827094a92327c039', class: `truncate text-sm font-medium ${labelVariants[this.state]}`, "data-name": "stepper-label" }, this.label, this.optional && (h("span", { key: '6f291aaedba58b8706e15a4af7fffb949a694af6', class: "text-secondary ml-4 text-xs font-normal", "data-name": "stepper-optional" }, "Optional")), this.state === 'skipped' && (h("at-badge", { key: '2c85f5cbc71bb771a9f175c494347f4854c8d3f5', class: "ml-4", label: "Skipped", size: "sm", "data-name": "stepper-skipped" }))), this.description && (h("span", { key: 'e7135a368479d4288c1affbf92b4b09d28cef41f', class: "text-secondary truncate text-xs", "data-name": "stepper-description" }, this.description)), h("slot", { key: '75252486396c8490f38025f05ff69bf0115d8667' }))));
    }
