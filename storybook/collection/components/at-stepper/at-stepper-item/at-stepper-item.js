...
export class AtStepperItem {
    ...
    render() {
        ...
        return (h(Host, { key: 'a626ce7ed8d8bba4e26b60bbd2992479b5cf8d43', role: "listitem", "aria-current": this.state === 'current' ? 'step' : undefined, "data-state": this.state, "data-name": "stepper-item", class: `flex min-w-0 ${isVertical
                ...
                : ''}`, tabindex: this.navigable ? 0 : undefined }, h("span", { key: '042dc4915047de2ddb86a0734f0a3709603aead2', class: `flex shrink-0 ${isVertical
                ? 'w-24 flex-col items-center'
                : 'items-center'}`, "data-name": "stepper-rail" }, this.renderMarker(), this.renderConnector()), h("span", { key: 'c8d9a570cf4c04c6477a62a6baa0ddf0f77b1e25', class: `flex min-w-0 flex-col gap-2 ${isVertical ? (this.is_last ? '' : 'pb-16') : 'pr-16'}` }, h("span", { key: 'c1b067c78d9b51717082e2aaf396bdca0417dbf8', class: `truncate text-sm font-medium ${labelVariants[this.state]}`, "data-name": "stepper-label" }, this.label, this.optional && (h("span", { key: '7171598d5e7185d5040476475832437f21a2c14e', class: "text-secondary ml-4 text-xs font-normal", "data-name": "stepper-optional" }, "Optional")), this.state === 'skipped' && (h("at-badge", { key: '8418edee84d0431337be1d85958f432bd694ba42', class: "ml-4", label: "Skipped", size: "sm", "data-name": "stepper-skipped" }))), this.description && (h("span", { key: 'e18b525d906e759d6a10f9f091e4bd47f624f500', class: "text-secondary truncate text-xs", "data-name": "stepper-description" }, this.description)), h("slot", { key: '7aa2ce5e8838289a8c3e2a439ee3244ec765e440' }))));
    }
    static get is() { return "at-stepper-item"; }
    static get properties() {
        return {
            ...
            "description": {
                ...
                "docs": {
                    "tags": [],
                    "text": "Supporting line beneath the label."
                },
                "getter": false,
                "setter": false,
                "reflect": false,
            ...
            "state": {
                ...
                "mutable": true,
                "complexType": {
                    "original": "AtStepperItemState",
                    "resolved": "\"completed\" | \"current\" | \"error\" | \"pending\" | \"skipped\" | \"success\"",
                    "references": {
                        "AtStepperItemState": {
                            "location": "local",
                            "path": "/home/runner/work/atui-components/atui-components/atui-components-stencil/src/components/at-stepper/at-stepper-item/at-stepper-item.tsx",
                            "id": "src/components/at-stepper/at-stepper-item/at-stepper-item.tsx::AtStepperItemState"
                        }
                    }
                },
                "required": false,
                ...
                "docs": {
                    "tags": [],
                    "text": "State of the step. Assigned by the parent `at-stepper` from its `current`\nindex unless set explicitly \u2014 an explicit value always wins, which is how a\nstep reports `error` or `skipped`."
                },
                "getter": false,
                "setter": false,
                "reflect": true,
            ...
            "index": {
                ...
                "docs": {
                    "tags": [],
                    "text": "Zero-based position of the step, assigned by the parent."
                },
                "getter": false,
                "setter": false,
                "reflect": false,
            ...
            "is_last": {
                ...
                "docs": {
                    "tags": [],
                    "text": "Whether this is the final step, assigned by the parent. The last step draws\nno connector, since there is nothing after it to connect to."
                },
                "getter": false,
                "setter": false,
                "reflect": false,
            ...
            "optional": {
                ...
                "docs": {
                    "tags": [],
                    "text": "Marks the step as optional, which allows it to be skipped in linear mode."
                },
                "getter": false,
                "setter": false,
                "reflect": false,
            ...
            "orientation": {
                ...
                "docs": {
                    "tags": [],
                    "text": "Layout of the parent stepper, assigned by it."
                },
                "getter": false,
                "setter": false,
                "reflect": false,
            ...
            "navigable": {
                ...
                "docs": {
                    "tags": [],
                    "text": "Whether the step can be navigated to directly. Assigned by the parent from\nits linear/non-linear mode."
                },
                "getter": false,
                "setter": false,
                "reflect": false,
