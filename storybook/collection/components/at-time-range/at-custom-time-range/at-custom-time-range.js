...
export class AtCustomTimeRangeComponent {
    ...
    render() {
        return (h("div", { key: 'f20861689336fb8971b4c3a6279c2324821854bf', class: "flex w-fit flex-col gap-8" }, h("h5", { key: '2adf1c1aea13f85b3e2991fdc65c6134efc92c52', class: "text-h5 text-foreground p-12 font-medium" }, this.translations.ATUI.TIME.SELECT_ABSOLUTE_TIME), h("div", { key: 'bbca86cdc6379ca01287c9970af06268a8b20259', class: "grid grid-cols-2 gap-16 px-12" }, h("div", { key: '230dd3bc159bbc3765ce75ed965a6a51cec8f8f7', class: "flex-fill flex flex-col gap-8" }, h("at-input-date", { key: '504d44d5154e5c2ac38a75671f84ce70149e1147', class: "w-full", label: this.translations.ATUI.TIME.FROM_DATE, value: this.from_date_value, min_date: this.min_date, max_date: this.max_date, invalid: this.isFromDateAfterToDate, onAtuiChange: (event) => {
                this.from_date_value = event.detail;
            } }), this.can_set_time && (h("at-input-time", { key: '5084856167860567df828a0f0b9e49c86182e093', class: "w-full", label: this.translations.ATUI.TIME.FROM_TIME, value: this.fromTime, min: this.fromTimeMin, max: this.fromTimeMax, onAtuiChange: (event) => {
                if (event.detail) {
                    this.from_date_value = dayjs(`${this.fromDate} ${event.detail}`, 'YYYY-MM-DD HH:mm').toDate();
                }
            } }))), h("div", { key: '364d3951b88288e76c0085ade924e051a5a0ef70', class: "flex-fill flex flex-col gap-8" }, h("at-input-date", { key: '3826e80754966dda83eefffe046bf07bec4fdc3d', class: "w-full", label: this.translations.ATUI.TIME.TO_DATE, value: this.to_date_value, min_date: this.min_date, max_date: this.max_date, invalid: this.isFromDateAfterToDate, disabled: this.lock_end_date_to_now, onAtuiChange: (event) => {
                this.to_date_value = event.detail;
            } }), this.can_set_time && (h("at-input-time", { key: '6c0bbc6d728152e61ee47b5a18fd20569e254225', class: "w-full", label: this.translations.ATUI.TIME.TO_TIME, value: this.toTime, min: this.toTimeMin, max: this.toTimeMax, disabled: this.lock_end_date_to_now, onAtuiChange: (event) => {
                if (event.detail) {
                    this.to_date_value = dayjs(`${this.toDate} ${event.detail}`, 'YYYY-MM-DD HH:mm').toDate();
                }
            } })))), h("div", { key: '0bb8b5880a17964f3008dd62d23a525c795142e9', class: "align-center rounded-input my-8 flex flex-row justify-between gap-8 px-12" }, h("div", { key: '07ee1fa97835c2bccd160a71b0c534c1c8db76c5', class: "flex flex-col" }, h("label", { key: 'b0c52942ebb1b8201113df24a3732beb10dae943', class: "c-form__label" }, this.translations.ATUI.TIME
            .SET_END_DATE_AND_TIME_TO_NOW), h("span", { key: '110fb320098ff23e640ce21035be5170d2b91eec', class: "text-secondary text-xs" }, this.translations.ATUI.TIME
            .SET_END_DATE_AND_TIME_TO_NOW_DESCRIPTION)), h("at-toggle-switch", { key: '5579f326517f5402b222423b86757c990f80f969', value: this.lock_end_date_to_now, onChange: () => this.setDateNow(), ref: (el) => (this.setDateNowSwitch = el) })), this.isFromDateAfterToDate && (h("div", { key: 'b012eb10d78b578c4dcb3d181d40b6a51df2bf86', class: "flex flex-col gap-4 px-12" }, h("span", { key: 'c5ae254250e2693f84da05a1d798114a5ba2e44c', class: "text-error text-sm", "data-name": "custom-time-range-error-from" }, this.translations.ATUI.TIME.VALIDATION
            .FROM_MUST_BE_BEFORE_TO))), h("div", { key: '2eeac1c26351e4ad58a3fffbd0d803e10092c7c2', class: "flex flex-row justify-between p-8" }, h("at-button", { key: '205fb2489d0f2418d5c0b0ff3c322de9f3463de4', type: "secondaryOutline", "data-name": "custom-time-range-clear", label: this.translations.ATUI.CLEAR_SELECTION, onAtuiClick: () => this.clearSelection() }), h("div", { key: 'd6269b36c5eb0ffbeee644e98455bebe1bbeeb2e', class: "flex flex-row gap-8" }, h("at-button", { key: 'a3fd7ee65bd8727e09f6abf554fc69cf2f2d04ae', type: "secondaryOutline", "data-name": "custom-time-range-cancel", label: this.translations.ATUI.CANCEL, onAtuiClick: () => this.handleCancel() }), h("at-button", { key: '38472ae0f6a15d7ef1c5fc87b83897b8bf7330f8', "data-name": "custom-time-range-apply", label: this.translations.ATUI.APPLY, disabled: this.isRangeInvalid, onAtuiClick: () => this.handleSubmit() })))));
    }
