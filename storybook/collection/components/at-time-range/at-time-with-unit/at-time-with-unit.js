...
export class AtTimeWithUnitComponent {
    ...
    render() {
        return (h("div", { key: 'bd493aa1379b5bbe2219425db30920a9ed4f9138', class: "w-panel-sm flex flex-col gap-16 border border-gray-300", onKeyUp: (event) => (event.key === 'Enter' || event.key === ' ') &&
                this.handleSubmit(), tabindex: 0 }, h("div", { key: 'fb60e3af79d4980ebbdf3ca4cb82aec3f7c57f55', class: "flex flex-col gap-8 p-12" }, h("h5", { key: 'e57516089ef720d62f90e2ab6ed2978e38750990', class: "text-h5 text-dark font-medium" }, this.translations.ATUI.TIME.SELECT_RELATIVE_TIME), h("div", { key: '91f517be1c38cb6ee4236d7fb09fb3822b465541', class: "flex flex-col gap-8" }, h("at-input-numeric", { key: 'bc9ce31af42205a9ab0264da079cc8885ad41e06', value: this.timeValue, onAtuiChange: (event) => (this.timeValue = event.detail) }), h("at-select", { key: '9ae04827d9d8ee1d6088b26f79d5e5f271799dd9', class: "flex-fill", value: this.translations.ATUI.TIME[this.timeUnit], options: this.dropdownOptions
            ...
            this.selectedTime?.unit && (h("span", { class: "text-med text-sm font-normal" }, this.startDate.toLocaleString(), " \u2060\u2014 NOW"))) : (this.selectedTime === TimeRangeDisplay.ALL && (h("span", { class: "text-med text-sm font-normal" }, this.translations.ATUI.TIME.ALL_TIME_LABEL)))), this.common_options && (h("div", { key: 'c4d9cf642f3ebce3fa44f58f241a28dd346ada3f', class: "flex flex-col gap-8 px-12" }, h("h5", { key: 'b3e4fa3a25593c3f1fcf047e6b5309de6d7e32e3', class: "text-h5 text-dark font-medium" }, this.translations.ATUI.TIME.COMMONLY_USED), h("div", { key: '420358179532e10085d9bf1bae5a63ce993c21c3', class: "columns-2", "data-name": "time-with-unit-common-options" }, this.common_options &&
            this.common_options.map((timerange) => (h("div", { onClick: () => this.updateSelectedRange(timerange), onKeyDown: (event) => {
                    event.stopPropagation();
                    if (event.key === 'Enter' ||
                        event.key === ' ')
                        this.updateSelectedRange(timerange);
                }, tabindex: 0, class: `${this.selectedTime !== TimeRangeDisplay.ALL && this.selectedTime?.value === timerange.value && this.selectedTime?.unit === timerange.unit ? 'bg-active-light px-4' : ''} cursor-pointer` }, h("small", null, this.translations.ATUI.TIME.LAST, ' ', timerange.value, ' ', this.translations.ATUI.TIME[timerange.unit]))))))), h("footer", { key: 'c895e2e8a7e5ecc5ecceb410a3127ad256984584', class: "flex justify-between p-8" }, h("at-button", { key: 'd3c4e710021c99d49ac586bcf103a2014ff7ebe7', type: "secondaryOutline", "data-name": "clear", label: this.translations.ATUI.RESET, onAtuiClick: () => this.clearSelection() }), h("div", { key: '231ae6ed9afb8ea480057dc42790f4444f995053', class: "flex gap-8" }, h("at-button", { key: 'a90a1c2856768b0d677e9877fc0adf4ab9d59037', type: "secondaryOutline", "data-name": "cancel", label: this.translations.ATUI.CANCEL, onAtuiClick: () => this.handleCancel() }), h("at-button", { key: 'f1734e7c3d2cfcdb734f0655a4409b6e4cefd540', "data-name": "apply", label: this.translations.ATUI.APPLY, onAtuiClick: () => this.handleSubmit() })))));
    }
