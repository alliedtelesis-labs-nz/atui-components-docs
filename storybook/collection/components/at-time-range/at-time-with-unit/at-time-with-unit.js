...
export class AtTimeWithUnitComponent {
    ...
    render() {
        ...
        return (h("div", { key: 'efa90b228c8d1e2a133cc8e1a23f71ed9dcc9d59', class: "w-panel-sm flex flex-col gap-16" }, h("div", { key: '3479235ac2a6bb1ce7d2de06d7d17f47f6eb65dc', class: "flex flex-col gap-8 p-12" }, h("h5", { key: 'dd6de646f15186167cce8a0f2c6cdcffb3fb9abb', class: "text-h5 text-foreground font-medium" }, this.translations.ATUI.TIME.SELECT_RELATIVE_TIME), h("div", { key: '4c38ed8cddf4791e91ae4fef0598e195d49a1596', class: "grid grid-cols-2 gap-8" }, h("at-input-numeric", { key: 'df4ac9e7541f17c50d3a9d955f099721ca977458', value: this.timeValue, min: 1, disabled: this.disabledTimeValue, onAtuiChange: (event) => {
                this.timeValue = event.detail;
            } }), h("at-select", { key: '3882ac94099b51ddf231726f1325bb6bd7059d64', class: "flex-fill", value: this.timeUnit, options: this.dropdownOptions
            ...
            this.selectedTime?.unit && (h("span", { class: "text-secondary text-sm font-normal" }, this.startDate.toLocaleString(), " \u2014", ' ', this.translations?.ATUI?.TIME?.NOW || 'Now'))) : (this.selectedTime === TimeRangeDisplay.ALL && (h("span", { class: "text-secondary text-sm font-normal" }, this.translations.ATUI.TIME.ALL_TIME_LABEL)))), visibleCommonOptions.length > 0 && (h("div", { key: '2bdf7cc9b0b4138aabd6e43486211dd8368e8b8d', class: "flex flex-col gap-8 px-12" }, h("h5", { key: '5d94687664d3eb37e23e1f0cae88443fb0f30edb', class: "text-h5 text-foreground font-medium" }, this.translations.ATUI.TIME.COMMONLY_USED), h("div", { key: '2f735f6f474e042d1b90f65469cd4c204520cb28', class: "grid grid-cols-2 content-stretch", "data-name": "time-with-unit-common-options" }, visibleCommonOptions.map((timerange) => (h("button", { onClick: () => this.updateSelectedRange(timerange), onKeyDown: (event) => {
                event.stopPropagation();
                if (event.key === 'Enter' ||
                    event.key === ' ')
                    this.updateSelectedRange(timerange);
            }, tabindex: 0, class: `focus-visible:ring-active-glow cursor-pointer rounded-sm px-[6px] py-2 text-left focus-visible:ring ${this.isSelectedOption(timerange) ? 'bg-active-background' : 'hover:bg-surface-2'}` }, h("small", null, this.translations.ATUI.TIME.LAST, ' ', timerange.value, ' ', this.translations.ATUI.TIME[timerange.unit]))))))), h("footer", { key: '9013054174e7bcb3cc5e10963e984803d997d15f', class: "flex justify-between p-8" }, h("at-button", { key: '141080aea2b04c9000b356934b56bf4454675197', type: "secondaryOutline", "data-name": "clear", label: this.translations.ATUI.RESET, onAtuiClick: () => this.clearSelection() }), h("div", { key: 'bebc9a323a75bf726d1e81a74022ae6671fbfb12', class: "flex gap-8" }, h("at-button", { key: 'c2f54303e7fcb95fa6d92715e773022ac4ddcfac', type: "secondaryOutline", "data-name": "cancel", label: this.translations.ATUI.CANCEL, onAtuiClick: () => this.handleCancel() }), h("at-button", { key: 'eda83292d48fd8feeeaf51824730675872ab9f01', "data-name": "apply", label: this.translations.ATUI.APPLY, disabled: !!this.errorText, onAtuiClick: () => this.handleSubmit() })))));
    }
