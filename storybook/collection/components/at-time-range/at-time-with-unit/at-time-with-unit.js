...
export class AtTimeWithUnitComponent {
    ...
    render() {
        return (h("div", { key: '5207770216265c837a6d253adcc921e2e49a679b', class: "w-panel-sm flex flex-col gap-16", onKeyUp: (event) => (event.key === 'Enter' || event.key === ' ') &&
                this.handleSubmit(), tabindex: 0 }, h("div", { key: '69bb786e368e13e04b0e141a73b0edf1be0ae146', class: "flex flex-col gap-8 p-12" }, h("h5", { key: '9de0737d9cbd3b2bbf91097e0d65b16ba06c2fc7', class: "text-h5 text-dark font-medium" }, this.translations.ATUI.TIME.SELECT_RELATIVE_TIME), h("div", { key: '32b7d4bb9826a03830a4e192ae3d659f08c0f217', class: "flex flex-col gap-8" }, h("at-input-numeric", { key: '0611500b1f11036708935945de94294c538bb572', value: this.timeValue, disabled: this.disabledTimeValue, onAtuiChange: (event) => {
                this.timeValue = event.detail;
            } }), h("at-select", { key: 'a97048eb9817e360dfc5591421e1122720cfe085', class: "flex-fill", value: this.timeUnit, options: this.dropdownOptions
            ...
            this.selectedTime?.unit && (h("span", { class: "text-med text-sm font-normal" }, this.startDate.toLocaleString(), " \u2060\u2014 NOW"))) : (this.selectedTime === TimeRangeDisplay.ALL && (h("span", { class: "text-med text-sm font-normal" }, this.translations.ATUI.TIME.ALL_TIME_LABEL)))), this.common_options && (h("div", { key: '63145b83980704f29d6312d8d8e2c2d7905e6945', class: "flex flex-col gap-8 px-12" }, h("h5", { key: 'd02232ff909f5d55211b76af910a224c2fcc5ede', class: "text-h5 text-dark font-medium" }, this.translations.ATUI.TIME.COMMONLY_USED), h("div", { key: 'daa8951e9d41cea86b2850fc234b1810542a45a2', class: "grid grid-cols-2 content-stretch", "data-name": "time-with-unit-common-options" }, this.common_options &&
            this.common_options.map((timerange) => (h("button", { onClick: () => this.updateSelectedRange(timerange), onKeyDown: (event) => {
                    event.stopPropagation();
                    if (event.key === 'Enter' ||
                        event.key === ' ')
                        this.updateSelectedRange(timerange);
                }, tabindex: 0, class: `hover:bg-surface-1 rounded-sm px-[6px] py-2 text-left ${this.selectedTime !== TimeRangeDisplay.ALL && this.selectedTime?.value === timerange.value && this.selectedTime?.unit === timerange.unit ? 'bg-active-light hover:bg-active-light' : ''} cursor-pointer` }, h("small", null, this.translations.ATUI.TIME.LAST, ' ', timerange.value, ' ', this.translations.ATUI.TIME[timerange.unit]))))))), h("footer", { key: 'afb1f4a92ed6eda23837c3f12071e6f9b20c53a4', class: "flex justify-between p-8" }, h("at-button", { key: '89f6179b9bdf3493656b8dc4dfc3b8ee8a311692', type: "secondaryOutline", "data-name": "clear", label: this.translations.ATUI.RESET, onAtuiClick: () => this.clearSelection() }), h("div", { key: '89c74d7154033194f8f601dcc67c05549a6fa664', class: "flex gap-8" }, h("at-button", { key: '731eb5541e6b61ed540e91b729be617166d76b77', type: "secondaryOutline", "data-name": "cancel", label: this.translations.ATUI.CANCEL, onAtuiClick: () => this.handleCancel() }), h("at-button", { key: 'ef46508f9579b5c79e7c67b61f4348cdc65a9b05', "data-name": "apply", label: this.translations.ATUI.APPLY, onAtuiClick: () => this.handleSubmit() })))));
    }
