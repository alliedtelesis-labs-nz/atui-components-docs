...
export class AtTimeWithUnitComponent {
    ...
    render() {
        ...
        return (h("div", { key: 'd133f135e72eaea6593a62dccbed2f2c44107631', class: "w-panel-sm flex flex-col gap-16" }, h("div", { key: '33df3c8de4302ca8e2a872441f355fe2811c0c75', class: "flex flex-col gap-8 p-12" }, h("h5", { key: 'c7e3d8bc537f0532ae061ee962a357df5a35efa9', class: "text-h5 text-foreground font-medium" }, this.translations.ATUI.TIME.SELECT_RELATIVE_TIME), h("div", { key: '4bdd41a7034e663a1b29490eb8064379befec5fd', class: "grid grid-cols-2 gap-8" }, h("at-input-numeric", { key: '9975ec3f2e5be4e9a56fc6205a81bf9f7f8fbcf9', value: this.timeValue, min: 1, disabled: this.disabledTimeValue, onAtuiChange: (event) => {
                this.timeValue = event.detail;
            } }), h("at-select", { key: '9de46e79125016d59204c345b9a21cd1fd819996', class: "flex-fill", value: this.timeUnit, options: this.dropdownOptions
            ...
            this.selectedTime?.unit && (h("span", { class: "text-secondary text-sm font-normal" }, this.startDate.toLocaleString(), " \u2014", ' ', this.translations?.ATUI?.TIME?.NOW || 'Now'))) : (this.selectedTime === TimeRangeDisplay.ALL && (h("span", { class: "text-secondary text-sm font-normal" }, this.translations.ATUI.TIME.ALL_TIME_LABEL)))), visibleCommonOptions.length > 0 && (h("div", { key: '8df593730a1c86ea8d710b47371e24aa280a255e', class: "flex flex-col gap-8 px-12" }, h("h5", { key: '6ecdb6c7f4c13c02ed4b4632882dcc5b852c1c3d', class: "text-h5 text-foreground font-medium" }, this.translations.ATUI.TIME.COMMONLY_USED), h("div", { key: '7c71528d57ba610fa302f933ec899d005a08c60c', class: "grid grid-cols-2 content-stretch", "data-name": "time-with-unit-common-options" }, visibleCommonOptions.map((timerange) => (h("button", { onClick: () => this.updateSelectedRange(timerange), onKeyDown: (event) => {
                event.stopPropagation();
                if (event.key === 'Enter' ||
                    event.key === ' ')
                    this.updateSelectedRange(timerange);
            }, tabindex: 0, class: `focus-visible:ring-active-glow cursor-pointer rounded-sm px-[6px] py-2 text-left focus-visible:ring ${this.isSelectedOption(timerange) ? 'bg-active-background' : 'hover:bg-surface-2'}` }, h("small", null, this.translations.ATUI.TIME.LAST, ' ', timerange.value, ' ', this.translations.ATUI.TIME[timerange.unit]))))))), h("footer", { key: '3fc1537d9856ac46e659c2877c1f85b867080426', class: "flex justify-between p-8" }, h("at-button", { key: 'b5edf326841defe1e93e251b74d81e94279331df', type: "secondaryOutline", "data-name": "clear", label: this.translations.ATUI.RESET, onAtuiClick: () => this.clearSelection() }), h("div", { key: '78296ea3960ec85027bf83b50a3afea76073db58', class: "flex gap-8" }, h("at-button", { key: 'b8fc91fc6f0d05e463abc29ab827b588ed3399f4', type: "secondaryOutline", "data-name": "cancel", label: this.translations.ATUI.CANCEL, onAtuiClick: () => this.handleCancel() }), h("at-button", { key: '1c1ca3aef96b5e725b70d74e965de43d9cbf0458', "data-name": "apply", label: this.translations.ATUI.APPLY, disabled: !!this.errorText, onAtuiClick: () => this.handleSubmit() })))));
    }
