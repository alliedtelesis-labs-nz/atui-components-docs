...
export class AtPromptContainer {
    ...
    render() {
        return (h(Host, { key: '0cba399b54b6dee836fef04045e4e16c7fef8aac', class: "flex h-full w-full flex-col overflow-hidden", "data-name": "prompt-container" }, this.renderHeader(), h("slot", { key: '7042af640c410501677fd4e9ac7f254be4d4852f', name: "prompt-container-header" }), h("div", { key: 'c544857c9baaf25cd0c13cee60c2a71b1af074ed', class: "min-h-0 flex-1", "data-name": "thread-wrapper" }, h("at-prompt-thread", { key: 'f852c4256a24343d89ffaf72df209ea801cace88', messages: this.messages, loading: this.loading, auto_scroll: true, enable_vote: this.enable_vote, enable_copy: this.enable_copy, enable_edit: this.enable_edit, response_animation: this.response_animation, "data-name": "container-thread" })), h("div", { key: '9a523b11fd14481587e7eb9e493a0caea4bd0054', class: "flex flex-col gap-4" }, this.renderFooter(), h("slot", { key: '534e1e0d5eb0eb4d32ab0a22d4778136d0b63d69', name: "prompt-container-footer" }))));
    }
