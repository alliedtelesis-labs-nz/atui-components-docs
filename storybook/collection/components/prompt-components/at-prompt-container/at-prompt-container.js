...
export class AtPromptContainer {
    ...
    render() {
        return (h(Host, { key: 'e147281abf4d7427d00536f9ab1c35e8725a9d6e', class: "flex h-full w-full flex-col overflow-hidden", "data-name": "prompt-container" }, this.renderHeader(), h("slot", { key: '1f14d6f7b9ee1c2904b23f21afba40df1aed8077', name: "prompt-container-header" }), h("div", { key: '6dd24107af2e2003e55611bf7c5355e77af05e43', class: "min-h-0 flex-1", "data-name": "thread-wrapper" }, h("at-prompt-thread", { key: 'd12c5b9f7c4d06546a2318993514b050abf54492', messages: this.messages, loading: this.loading, auto_scroll: true, enable_vote: this.enable_vote, enable_copy: this.enable_copy, enable_edit: this.enable_edit, response_animation: this.response_animation, "data-name": "container-thread" })), h("div", { key: 'd281880c82b3cab06d707aa7c925a30174eab88d', class: "flex flex-col gap-4" }, this.renderFooter(), h("slot", { key: 'f6fdf54ef531eb768289995fabedeb00e392a8e6', name: "prompt-container-footer" }))));
    }
