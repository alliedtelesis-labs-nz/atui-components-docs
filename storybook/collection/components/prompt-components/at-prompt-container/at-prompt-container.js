...
export class AtPromptContainer {
    ...
    render() {
        return (h(Host, { key: '4c925883d68b5c70e9eae7407c0cf94e554c095f', class: "flex h-full w-full flex-col overflow-hidden", "data-name": "prompt-container" }, this.renderHeader(), h("slot", { key: 'efedc39821ad3b38d845656e38ea2828a3b9d3fc', name: "prompt-container-header" }), h("div", { key: 'c17e468f73dab6740679ed6207dca92590f81bbf', class: "min-h-0 flex-1", "data-name": "thread-wrapper" }, h("at-prompt-thread", { key: '4c5bb501dd086fabb950ad5fb550be6eebd46ccf', messages: this.messages, loading: this.loading, auto_scroll: true, enable_vote: this.enable_vote, enable_copy: this.enable_copy, enable_edit: this.enable_edit, response_animation: this.response_animation, "data-name": "container-thread" })), h("div", { key: '8817b8154a6260c8057d42b79cec21f4fea91cfd', class: "flex flex-col gap-4" }, this.renderFooter(), h("slot", { key: '606eb248626e0fdca9ca65fe596ee1b73b5c7466', name: "prompt-container-footer" }))));
    }
