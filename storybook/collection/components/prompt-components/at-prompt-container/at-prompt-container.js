...
export class AtPromptContainer {
    ...
    render() {
        return (h(Host, { key: '75bf4e1868017628fc9a6e581f68ac43c69a94ba', class: "flex h-full w-full flex-col overflow-hidden", "data-name": "prompt-container" }, this.renderHeader(), h("slot", { key: 'adb9395dc3d252fab9af3d1108a197c166c7d4be', name: "prompt-container-header" }), h("div", { key: 'd1d58221bc99da21884387cb1ee35f30be2d239f', class: "min-h-0 flex-1", "data-name": "thread-wrapper" }, h("at-prompt-thread", { key: 'c3276f5d2ca7bd1ab73855b58b17af010575153d', messages: this.messages, loading: this.loading, auto_scroll: true, enable_vote: this.enable_vote, enable_copy: this.enable_copy, enable_edit: this.enable_edit, response_animation: this.response_animation, "data-name": "container-thread" })), h("div", { key: 'bdbdd585ddd0f41ef07e13614ff1693faac58f4a', class: "flex flex-col gap-4" }, this.renderFooter(), h("slot", { key: '1074e57cf400cb5455c8982bc499daac12e9c4c6', name: "prompt-container-footer" }))));
    }
