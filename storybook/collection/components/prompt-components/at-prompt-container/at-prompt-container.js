...
export class AtPromptContainer {
    ...
    render() {
        return (h(Host, { key: 'd805fdce9d4b06556bf92cd37e1e960c668e4e51', class: "flex h-full w-full flex-col overflow-hidden", "data-name": "prompt-container" }, this.renderHeader(), h("slot", { key: '0e287071bfdf7980ad5f0038776b138509fb484d', name: "prompt-container-header" }), h("div", { key: '49cc5b6231bc66a6b9d0df620c1f5c2bf05247b7', class: "min-h-0 flex-1", "data-name": "thread-wrapper" }, h("at-prompt-thread", { key: '0ac39ad770fa52050987a952049fc95f4575926e', chatbot_title: this.chatbot_title, messages: this.messages, loading: this.loading, auto_scroll: true, enable_vote: this.enable_vote, enable_copy: this.enable_copy, enable_edit: this.enable_edit, response_animation: this.response_animation, "data-name": "container-thread" })), h("div", { key: 'dc7bc02831f4b72cb83ef54978d3cceee0fac198', class: "flex flex-col gap-4" }, this.renderFooter(), h("slot", { key: 'cd0c54a37987e077d980d3b84b2387c7ca9cff40', name: "prompt-container-footer" }))));
    }
