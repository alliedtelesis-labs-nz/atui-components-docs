...
export class AtPromptContainer {
    ...
    render() {
        return (h(Host, { key: '91b5a6d494258dcd2b4bb184f0e4c88c5bca6a36', class: "flex h-full w-full flex-col overflow-hidden", "data-name": "prompt-container" }, this.renderHeader(), h("slot", { key: '041901b19ecc60834310fdc1713e1d11cda0ffa9', name: "prompt-container-header" }), h("div", { key: '6a8b02769f9b761e31c6aff92dc22410193a179f', class: "min-h-0 flex-1", "data-name": "thread-wrapper" }, h("at-prompt-thread", { key: '47f9c0dd7b6213a6cb7e42186817635bc93cee75', chatbot_title: this.chatbot_title, messages: this.messages, loading: this.loading, auto_scroll: true, enable_vote: this.enable_vote, enable_copy: this.enable_copy, enable_edit: this.enable_edit, response_animation: this.response_animation, "data-name": "container-thread" })), h("div", { key: 'bda31e331e9ad56ead0350f12ba3738e661305a5', class: "flex flex-col gap-4" }, this.renderFooter(), h("slot", { key: '991dcc13d5e2795749df5f8b912f988b50995ab9', name: "prompt-container-footer" }))));
    }
