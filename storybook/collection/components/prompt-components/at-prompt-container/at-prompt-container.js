...
export class AtPromptContainer {
    ...
    render() {
        return (h(Host, { key: '57c78dc3263095ab6deaa176dfc50806fb9265b3', class: "flex h-full w-full flex-col overflow-hidden", "data-name": "prompt-container" }, this.renderHeader(), h("slot", { key: 'f8b32a973c8f912db221334f630aaefa92ed9ee5', name: "prompt-container-header" }), h("div", { key: 'b7eab6e6f3911dd970d326e3c7d09cf1755eac25', class: "min-h-0 flex-1", "data-name": "thread-wrapper" }, h("at-prompt-thread", { key: '8860d47c202b060365ec39a1952482694fd9f672', chatbot_title: this.chatbot_title, messages: this.messages, loading: this.loading, auto_scroll: true, enable_vote: this.enable_vote, enable_copy: this.enable_copy, enable_edit: this.enable_edit, response_animation: this.response_animation, "data-name": "container-thread" })), h("div", { key: 'e7e3c9d2532a769d50660e692cd576150ecce27a', class: "flex flex-col gap-4" }, this.renderFooter(), h("slot", { key: 'c83a155495a367284ed8136b1777263bc57b3af8', name: "prompt-container-footer" }))));
    }
