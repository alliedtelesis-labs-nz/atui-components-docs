...
export class AtPromptInputComponent {
    ...
    render() {
        ...
        return (h(Host, { key: '848d1bd2757d67fd580fc8a206b98ab9fa006db5', id: this.inputId + '-container', class: "w-full px-16" }, h("div", { key: '151a89e04c76b9eef039355a8a0ee647806586de', class: "flex flex-col" }, h("slot", { key: '17998e19238badfd3605581b13306b2d2fa7d825', name: "label" }), (this.label || this.info_text) && (h("at-form-label", { key: '2d4e95b0093e53c56b9b4859e749496aa9cacd74', label: this.label, for: this.inputId, info_text: this.info_text, "data-name": "prompt-input-label" })), this.hint_text && (h("span", { key: 'd9df4341d86b039a1c072a47fda206d77212d59c', class: "text-light mb-8 inline-block text-xs leading-tight", "data-name": "prompt-input-hint" }, this.hint_text))), h("div", { key: '00f93cbcf36190ddbf745178de3e88b6cf4fbd12', class: containerClass }, h("textarea", { key: '2a8ef9072ee3192d7c3e8f60db04a439d33a2377', class: inputClass, disabled: this.disabled, id: this.inputId, placeholder: this.placeholder, onInput: (event) => this.handleInput(event), onKeyDown: (event) => this.handleKeyDown(event), value: this.value, ref: (el) => (this.textareaEl = el), style: {
                minHeight: '44px',
                maxHeight: this.max_height + 'px',
                overflow: 'auto',
            }, "data-name": "prompt-input" }), h("div", { key: 'a4ca856b7c1f89138f603d610afab453d85e48bf', class: "flex w-full items-center justify-between gap-1" }, h("div", { key: '544091336e44740aa6a657daadf40c53be8cfa6a', class: "flex items-center gap-4" }, h("slot", { key: '62b37c3d74007176ff5e92c670bce68abe505cad', name: "actions-left" })), h("div", { key: 'd55f1f714b33a2e0a7a0ca89df74a2b874245cf8', class: "flex items-center gap-4 self-end" }, h("slot", { key: '64acfccdbdaed1ca05b4db2dce3460167ea891d2', name: "actions-right" }), h("at-button", { key: '90bf22522f16ba6be9da1f174d1c02c360307221', class: "rounded-lg", size: "sm", type: "secondary", icon: this.in_progress ? 'stop' : 'arrow_upward', disabled: !canSend, onClick: () => this.sendMessage(), onKeyDown: (event) => {
                if (event.key === 'Enter' ||
                    event.key === ' ') {
                    this.sendMessage();
                }
            }, "data-name": "prompt-send-button" })))), h("slot", { key: 'ffdc63f989c359fcb418c4c0410b7761cef2990b', name: "footer" }), this.invalid && (h("span", { key: 'c00825cf72593f16e3bb9a07baf3a0b0d08ef252', class: "text-error-dark text-xs", "data-name": "error-text" }, this.error_text
            ? this.error_text
