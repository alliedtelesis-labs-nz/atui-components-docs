...
export class AtPromptInputComponent {
    ...
    render() {
        ...
        return (h(Host, { key: '45278da97b93912cbfd6390fcb92aebc8b9c3928', id: this.inputId + '-container', class: "w-full px-16" }, h("div", { key: '558316238988a83cf09b570dba83bf4b44364741', class: "flex flex-col" }, h("slot", { key: '29b7a778302cc7fbb559608f37a8fdf66a63dd7f', name: "label" }), (this.label || this.info_text) && (h("at-form-label", { key: '1c08ab49a1cf65be225e4b6b39ea089089d2923b', label: this.label, for: this.inputId, info_text: this.info_text, "data-name": "prompt-input-label" })), this.hint_text && (h("span", { key: '382e0beb8a9e93c041e03931841bd3dfe97446bf', class: "text-muted mb-8 inline-block text-xs leading-tight", "data-name": "prompt-input-hint" }, this.hint_text))), h("div", { key: '9c84b2ce193d9d1b706a1549cee252d8c12761c2', class: containerClass }, h("textarea", { key: '065cf0acae603ffc4140c564474266887861d6f4', class: inputClass, disabled: this.disabled, id: this.inputId, placeholder: this.placeholder, onInput: (event) => this.handleInput(event), onKeyDown: (event) => this.handleKeyDown(event), value: this.value, ref: (el) => (this.textareaEl = el), style: {
                minHeight: '44px',
                maxHeight: this.max_height + 'px',
                overflow: 'auto',
            }, "data-name": "prompt-input" }), h("div", { key: '8adab2ef6d4e12d1d59abee7baf043f8791df54b', class: "flex w-full items-center justify-between gap-1" }, h("div", { key: '773cb20f623f6992e2dcfd693cf8690e1a7f7996', class: "flex items-center gap-4" }, h("slot", { key: 'a6f1e0a1aa94cf0c86ff5037165788d8a989ac93', name: "actions-left" })), h("div", { key: '477f90c786f4f3492e794cf3397afd0faf3814e7', class: "flex items-center gap-4 self-end" }, h("slot", { key: '2ae56b8d2d8276fbfa69ceadbb90d81b6c91c27e', name: "actions-right" }), h("at-button", { key: 'f7a6540e64a7132ac9d2b7719558d6e01666aa37', class: "rounded-lg", size: "sm", type: "primary", disabled: !canSend, onClick: () => this.sendMessage(), onKeyDown: (event) => {
                if (event.key === 'Enter' ||
                    event.key === ' ') {
                    this.sendMessage();
                }
            }, "data-name": "prompt-send-button" }, h("at-icon", { key: '7ada3a7f2991ff77e7e154d09015efddbf7acc0c', slot: "icon", name: this.in_progress ? 'stop' : 'send' }))))), h("slot", { key: 'bf9382234cf24806dedf142a7e694a2325413bb7', name: "footer" }), this.invalid && (h("span", { key: 'b6159090318777b9acfb977d1b23154033d0361f', class: "text-error-foreground text-xs", "data-name": "error-text" }, this.error_text
            ? this.error_text
