...
export class AtMenu {
    ...
    render() {
        return (h(Host, { key: '8ec775a40891e2b2e9fbeffffa1b85f936c06743', class: "relative", onBlur: (e) => {
            ...
            } }, !this.trigger_id && (h("div", { key: '584b21f80f97e880ab4fe722d01855c16d0a9ede', "aria-haspopup": "true", "data-name": "menu-trigger", ref: (el) => (this.triggerEl = el), "aria-expanded": `${this.isOpen ? 'true' : 'false'}`, onMouseEnter: () => this.trigger === 'hover' && !this.disabled
                ? this.mouseEnterHandler()
            ...
            }, class: this.disabled ? 'contents' : '' }, h("slot", { key: 'b3e9ddc8f1bb9402cd421db42689e59a67beb100', name: "menu-trigger" }))), h("div", { key: '8217427106f4d7a7b302afcf697a2636e550aa19', role: this.role, "data-position": this.position, "data-align": this.align, ref: (el) => (this.menuEl = el), "aria-hidden": `${this.isOpen ? 'false' : 'true'}`, popover: "manual", id: this.popoverId, onMouseEnter: () => this.trigger === 'hover' &&
                !this.disabled &&
            ...
            }, onClick: () => this.autoclose && this.mouseLeaveHandler(), class: `bg-menu border-muted rounded-menu w-max min-w-0 flex-none border p-4 shadow-lg transition-opacity duration-150 ${this.isOpen ? 'opacity-100' : 'opacity-0'}`, "data-name": "menu-content-wrapper" }, h("slot", { key: '4acc6b55b055eb5bcd2fef5ab885139f746dc861' }))));
    }
