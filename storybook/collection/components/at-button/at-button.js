...
export class AtButtonComponent {
    ...
    render() {
        ...
        return (h(Host, { key: '02ad697d570521130b2fb88a7a97db11ba37bffa', class: classname, role: "button", tabIndex: this.disabled ? -1 : 0, "aria-disabled": this.disabled ? 'true' : undefined, onKeyDown: (event) => this.handleKeyDown(event), onClick: (event) => this.handleClick(event) }, h("div", { key: 'cfa42d24e5b1cb462559b5b896a9c30bad978dee', class: "z-20 flex h-full w-full items-center justify-center gap-4" }, this.in_progress && (h("at-loading", { key: 'b83c34375ae7ac57e6963d408d0e9bab9ad6a95e', class: "absolute", size: "sm", type: this.spinnerColour })), !this.in_progress && (h("slot", { key: 'c8d838424619fbc7ced06425dc4ad14627afd115', name: "icon", "data-name": "button-icon" })), this.label && (h("span", { key: 'c007175a85b8d37f939a4c14aa80479dc70e47cf', class: `leading-[16px] ${this.in_progress ? 'invisible' : 'visible'}`, "data-name": "button-label" }, this.label)), h("slot", { key: '9cbce84b52bbc18770da570669932f0aaa740c9a' }), !this.in_progress && (h("slot", { key: 'dd468d8f9870e91a3c071b8bb6d1b01e48caf7f0', name: "icon_after", "data-name": "button-icon-right" }))), h("div", { key: '5b83b80a49fcb17fecc9a5c58f2260afd4bc1cb7', "data-name": "focus-indicator", role: "presentation", class: focusIndicatorClassname })));
    }
