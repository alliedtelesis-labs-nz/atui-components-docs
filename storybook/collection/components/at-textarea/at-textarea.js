...
export class AtTextareaComponent {
    ...
    render() {
        ...
        return (h(Host, { key: '68701173b5aa113a98d4c6cb2ff49c06a5a5729a' }, h("div", { key: '5178fe11adbb2fbc75f19a840eda9ba9ac2cad3d', class: "mb-4 flex flex-col empty:hidden" }, h("slot", { key: '881fc9915bc9f20033c20b45c083e8e349052fac', name: "label" }), (this.label || this.required || this.info_text) && (h("at-form-label", { key: '5591f64aa375394a5bd942c57c53ab7b7f73084a', label: this.label, for: this.textareaId, required: this.required && !this.readonly, info_text: this.info_text })), this.hint_text && (h("span", { key: 'c4bc2231e188bdf5a58a9d0278382723a2cb4106', class: "text-muted mb-8 inline-block text-xs leading-tight", "data-name": "textarea-hint" }, this.hint_text))), h("div", { key: '0eda626456eef98a11282b51f3da9bcc7f90b037', class: "grid" }, h("textarea", { key: '1488ebc4328acea0399d488e77439818d9f9ac83', id: this.textareaId, readonly: this.readonly ? true : undefined, disabled: this.disabled ? true : undefined, required: this.required, placeholder: this.placeholder, autocomplete: this.autocomplete, autocapitalize: "none", onInput: (event) => this.handleChange(event), onChange: (event) => this.handleChange(event), value: this.value, ref: (el) => (this.textareaEl = el), style: { gridArea: '1 / 1 / 2 / 2' }, class: classname, "data-name": "textarea-input" }), h("div", { key: 'dceae2ecab05b9aba883cef20de4a6ce3dd86bd5', "data-name": "textarea-resize-container", style: {
                gridArea: '1 / 1 / 2 / 2',
                minHeight: `${this.min_rows * 1.5 + 1}rem`,
                maxHeight: `${this.max_rows * 1.5 + 1}rem`,
            }, class: "text-body invisible rounded-sm border px-8 py-[6px] break-all whitespace-pre-wrap" }, this.value)), this.error_text && this.invalid && (h("span", { key: 'd9bb0ad8b830865f5ae03dc1d3b28b230a8b14e9', class: "text-error text-sm", "data-name": "textarea-error" }, this.error_text))));
    }
