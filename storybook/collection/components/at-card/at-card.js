...
export class AtCardComponent {
    ...
    render() {
        ...
        return (h(Host, { key: '6ab4f2d29ef090b08eee4a289858ee855dc30c35', class: containerClassname }, h("div", { key: '453dd458444b49f3f3f21c2067f3424d7d8f3abe', class: `${headerClassname}` }, h("slot", { key: '8892034539f51aa72c78c2cc9cae5ad20b898cd9', name: "card-header" }), (this.card_title || this.subtitle) && (h("div", { key: 'b1c821b723ab04b463f210ee912f3baaccf643b7', class: "flex min-w-0 flex-1 flex-col break-words" }, this.card_title && (h("h4", { key: '894cac6b6049888c0f694f8e99e4df10aae9ecf4', "data-name": "card-title", class: "text-h4 font-medium" }, this.card_title)), this.subtitle && (h("h5", { key: 'f26ce740ef2b73da92e2cc545c25636e3a5e073f', class: "text-muted text-sm font-normal", "data-name": "card-subtitle" }, this.subtitle)))), h("slot", { key: '5f6bd39a4a954b23c188c353f982848c189e04f9', name: "card-header-actions" })), h("div", { key: 'd50a153dcad2f0afe1ef4b58c7b20906bb5672c3', class: contentClassname, "data-name": "card-content" }, this.content, h("slot", { key: 'f01784d0399ca1caa2f05a170e0109d33de11d10' })), h("div", { key: '0498096922535550efcc0e49a9f364c5da296f3a', class: footerClassname }, h("slot", { key: 'fda53cc0524ffa0afb542c0bfa00731578b8b60d', name: "card-footer" }))));
    }
