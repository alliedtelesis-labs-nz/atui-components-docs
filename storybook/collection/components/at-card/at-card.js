...
export class AtCardComponent {
    ...
    render() {
        ...
        return (h(Host, { key: '90901a6ea32c96c7ca3bfb25ee7af8ce07159d0b', class: containerClassname }, h("div", { key: '3bfb47da76a5d43c74fe6fdbf15cf9468611b5e3', class: `${headerClassname}` }, h("slot", { key: '90cbc757bc3ddd42dbbc52a6f9f97ff4e36ece99', name: "card-header" }), (this.card_title || this.subtitle) && (h("div", { key: '9fbf5f1c665fd810ad30284e0b5caf41c0ad8c57', class: "flex flex-col" }, this.card_title && (h("h4", { key: 'aaa4d1f7c899869c47fd07a1abf2621ab56d2aff', "data-name": "card-title", class: "text-h4 font-medium" }, this.card_title)), this.subtitle && (h("h5", { key: '2e998675ec95e3fe8ee0564cd2c48ba2c6ba35c1', class: "text-muted text-sm font-normal", "data-name": "card-subtitle" }, this.subtitle)))), h("slot", { key: 'be5a1746e5de687a253fe1e78a78d26472ca64e0', name: "card-header-actions" })), h("div", { key: '8fba1addc0a18eac1b782af0c06e60dfe1482298', class: contentClassname, "data-name": "card-content" }, this.content, h("slot", { key: 'e0d946f2f2de24f665c0e9eb7c5b09f4629f858a' })), h("div", { key: '306a1949930209420ecd1fb7996db3d59c81c4b9', class: footerClassname }, h("slot", { key: '6a955c5de9d8d8812c65c847e0c3a02d00ca3b1d', name: "card-footer" }))));
    }
