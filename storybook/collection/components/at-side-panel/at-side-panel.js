...
export class AtSidePanelComponent {
    ...
    render() {
        return (h(Host, { key: 'b97de40f337ccd4705e88842431be360cf91fae6', "data-open": this.isOpen }, h("dialog", { key: '5072b9a36022b0bfe2378c44a33f9bc19371f0ee', ref: (el) => (this.panelDialog = el), class: `${this.backdrop ? 'backdrop' : ''}`, onClose: this.handleDialogClose, onKeyDown: this.handleKeyDown }, h("div", { key: '9968d2238c6a6f934d3867708d2981ba4ff82846', "data-scrollable": this.has_scrollbar, "data-open": this.isOpen, class: `container origin-${this.origin} width-${this.size} size-${this.size} position-${this.position}`, ref: (el) => (this.sidePanelWrapper = el), "data-name": "container" }, h("header", { key: '22a9d4e48868981ac6659d6632278fad7a15f863', class: "header", "data-name": "header" }, h("div", { key: '91356ba37045aa9bd8e29298f54b250332c139c3' }, this.panel_title && (h("h3", { key: 'bf2f081b554cf0ecfdb6de76c717263e3a9224f0', class: "title" }, this.panel_title)), this.panel_subtitle && (h("p", { key: 'd8c544c140da88732d5519103aa300a0f7a600c1', class: "subtitle" }, this.panel_subtitle))), this.has_close_button && (h("at-button", { key: 'f97ad30cb4d590af46cd078d37e85cee9c4a607a', size: "md", type: "secondaryText", "data-name": "panel-close", onClick: this.handleClose }, h("at-icon", { key: '7a786815c5e7bf112d3771b66d4014b80dcc080f', slot: "icon", name: "close" })))), h("div", { key: '53ceeb24da73c2dc516a53d897c3fb1e4e230f7d', "data-name": "content", class: "content" }, h("slot", { key: '83db7e80aef8a23d766b16fd11f4ac01395decb8' }))))));
    }
