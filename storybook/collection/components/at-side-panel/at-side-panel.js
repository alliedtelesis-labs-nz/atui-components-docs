...
export class AtSidePanelComponent {
    ...
    render() {
        return (h(Host, { key: '8a680e2a603dd7816632024aac323281ae5164ef', "data-open": this.isOpen }, h("dialog", { key: '0a8c4c843506c86d0442bc5564f6a1bf70557cd1', ref: (el) => (this.panelDialog = el), class: `${this.backdrop ? 'backdrop' : ''}`, onClose: this.handleDialogClose, onKeyDown: this.handleKeyDown }, h("div", { key: '48539711e5dcf91837851be0b0d94d0108b82cce', "data-scrollable": this.has_scrollbar, "data-open": this.isOpen, class: `container origin-${this.origin} size-${this.size} size-${this.size} position-${this.position}`, ref: (el) => (this.sidePanelWrapper = el), "data-name": "container" }, h("header", { key: 'e9ee440018f177d3ebbf381c19a3200151b26345', class: "header", "data-name": "header" }, h("div", { key: 'a3362f10f306b2b429d9b1e542c072c3ddd28276' }, this.panel_title && (h("h3", { key: '9177448fb76c0a82f5f0d1bc1eb7901db4703fef', class: "title" }, this.panel_title)), this.panel_subtitle && (h("p", { key: '7bdd9bd5a50fa600cd93fe92524a79c741348b7e', class: "subtitle" }, this.panel_subtitle))), this.has_close_button && (h("at-button", { key: 'a0a4910442a9602d7b2052a2e02d34324a80fac6', size: "md", icon: "close", type: "secondaryText", "data-name": "panel-close", onClick: this.handleClose }))), h("div", { key: '4fd4b7282194f3476d448f03a24b86e383c7c786', "data-name": "content", class: "content" }, h("slot", { key: '1c92e2a1a4f91dc4d3e61aec0360391988ac06ed' }))))));
    }
