...
export class AtSidePanelComponent {
    ...
    render() {
        return (h(Host, { key: '0b6f73f6f8c46576f67d22788df95087d05b23f7', "data-open": this.isOpen }, h("dialog", { key: '28c6a9dbb0f119ea958da914bee57bc38e2e89ae', ref: (el) => (this.panelDialog = el), class: `${this.backdrop ? 'backdrop' : ''}`, onClose: this.handleDialogClose, onKeyDown: this.handleKeyDown }, h("div", { key: 'd93bfb238711ffee5fa90a66eab2b6ba633040ea', "data-scrollable": this.has_scrollbar, "data-open": this.isOpen, class: `container origin-${this.origin} size-${this.size} size-${this.size} position-${this.position}`, ref: (el) => (this.sidePanelWrapper = el), "data-name": "container" }, h("header", { key: '3818adba4cbdb548576cdd9d313fb6146f2c5484', class: "header", "data-name": "header" }, h("div", { key: 'd7f55fc7deb9640f34eaf2aa5b9dfaf961b53a14' }, this.panel_title && (h("h3", { key: 'af91a1e28c472d5f974b63eed38567a369568ab4', class: "title" }, this.panel_title)), this.panel_subtitle && (h("p", { key: 'b8f3650084b1f3978c5170c9aae695357d009cee', class: "subtitle" }, this.panel_subtitle))), this.has_close_button && (h("at-button", { key: '4ae794f23c8ca1269edd6646891400e30666ac85', size: "md", type: "secondaryText", "data-name": "panel-close", onClick: this.handleClose }, h("at-icon", { key: 'b2c2da46e8d7fd78b9f8d6e71650d555dec46662', slot: "icon", name: "close" })))), h("div", { key: 'aead32f9b3954e94a94de4acab584679b2eda1c9', "data-name": "content", class: "content" }, h("slot", { key: '1b8359ee7968241c0376ca335325beb0267821df' }))))));
    }
