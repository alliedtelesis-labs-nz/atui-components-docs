...
export class AtSidePanelComponent {
    ...
    render() {
        return (h(Host, { key: '5b31a221790c52fd819f01d4072bf7c21c36450e', "data-open": this.isOpen }, h("dialog", { key: 'ffac55ca447d7f8c5c0a31111d2f98ded00fa43e', ref: (el) => (this.panelDialog = el), class: `${this.backdrop ? 'backdrop' : ''}`, onClose: this.handleDialogClose, onKeyDown: this.handleKeyDown }, h("div", { key: 'eee3185ddaf3354e11602df98a9640d025975a84', "data-scrollable": this.has_scrollbar, "data-open": this.isOpen, class: `container origin-${this.origin} width-${this.size} size-${this.size} position-${this.position}`, ref: (el) => (this.sidePanelWrapper = el), "data-name": "container" }, h("header", { key: '9e20f08eb3ea5ca6c0ea38e823a790d3fd75e959', class: "header", "data-name": "header" }, h("div", { key: '5d20e26c84c5143b86c536fa2e2bfe14ba40111a' }, h("slot", { key: '1b1add6d421c3df09d4048821ff0d1ee1d6f5284', name: "title" }), this.panel_title && (h("h3", { key: 'fed7ab97de11d59b4aba58e50e10ce183f1a8049', class: "title" }, this.panel_title)), this.panel_subtitle && (h("p", { key: '87e3263715295ec72ce8218145c2236e0e0d702f', class: "subtitle" }, this.panel_subtitle))), h("div", { key: '5b405a3209170b86efded4de6ab82db54ed74954' }, h("slot", { key: '6e939459229c77c3e49bfe120ee1729270dd403d', name: "actions" }), this.has_close_button && (h("at-button", { key: '8d9388ede8c40e9489a20eb2f4d6baa09f5c793b', size: "md", type: "secondaryText", "data-name": "panel-close", onClick: this.handleClose }, h("at-icon", { key: '5d5c7fba6c87365d3065bd082228ec3201b9c88e', slot: "icon", name: "close" }))))), h("div", { key: 'bff19f862443f9dba4f196e56dc656c65cb93b52', "data-name": "content", class: "content" }, h("slot", { key: '2d9f99cfc88317dc67a73a0d273569f4d96dcc9c' }))))));
    }
