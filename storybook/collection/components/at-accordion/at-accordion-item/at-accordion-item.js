...
export class AtAccordionItemComponent {
    ...
    render() {
        ...
        return (h(Host, { key: '4433e9ed600607eafb49fdd2800c5fefdc995b76', "data-name": this.item_id, "data-state": this.open ? 'expanded' : 'collapsed' }, h("details", { key: 'bcdeb28b16d75947f3e982f6d219e80350bd6423', class: "group/accordion-item", role: "group", ref: (el) => (this.detailsEl = el) }, h("summary", { key: 'dfdd4a5368f969a23aeaa65c35e942922faadb37', id: `trigger-${this.item_id}`, role: "button", "aria-expanded": this.open, "data-state": this.open ? 'expanded' : 'collapsed', class: classname, onClick: (event) => this.handleSummaryInteraction(event), onTouchEnd: (event) => this.handleSummaryInteraction(event), "aria-controls": `content-${this.item_id}` }, this.label && (h("at-accordion-trigger", { key: '343e4b546691db65fed832e3340601b5edbeb9de', label: this.label })), h("slot", { key: '1ab02c917b6e65c702a85a73139af8bc291b3143', name: "accordion-trigger" })), h("div", { key: '66ccf0b15e67a0b3b72cba1a026c4616f18ff21b', id: `content-${this.item_id}`, "aria-labelledby": `trigger-${this.item_id}`, "data-state": this.open ? 'expanded' : 'collapsed', "data-name": "accordion-item-content" }, this.content && (h("div", { key: 'd6e3d2283108dbeda06a405d477ce94b7ff17dca', class: "flex flex-col p-16 leading-normal" }, this.content)), h("slot", { key: 'c707d097b283898636a9b4fe7e4c43a1e30ba4c3' })))));
    }
