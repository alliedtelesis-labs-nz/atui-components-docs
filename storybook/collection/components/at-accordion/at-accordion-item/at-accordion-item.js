...
export class AtAccordionItemComponent {
    ...
    render() {
        ...
        return (h(Host, { key: 'ff5d09caba29fb53a4cc83cd8a7fca7030c757f3', "data-name": this.item_id, "data-state": this.open ? 'expanded' : 'collapsed' }, h("details", { key: '5ba79967ed7fd72db86d37ad2c303f82f321ab5c', class: "group/accordion-item", role: "group", ref: (el) => (this.detailsEl = el) }, h("summary", { key: '16d2d2123491bc92354d375d5ecb19b61cf231dd', id: `trigger-${this.item_id}`, role: "button", "aria-expanded": this.open, "data-state": this.open ? 'expanded' : 'collapsed', class: classname, onClick: (event) => this.handleSummaryInteraction(event), onTouchEnd: (event) => this.handleSummaryInteraction(event), "aria-controls": `content-${this.item_id}` }, this.label && (h("at-accordion-trigger", { key: '5800cc6ea8c115699e9895f79084d1139eb531c7', label: this.label })), h("slot", { key: '6958858066e04bc5aa8fad6c20f6b968b4166df3', name: "accordion-trigger" })), h("div", { key: '2389ec9c61e37a9d78e5969deb16168f912c5013', id: `content-${this.item_id}`, "aria-labelledby": `trigger-${this.item_id}`, "data-state": this.open ? 'expanded' : 'collapsed', "data-name": "accordion-item-content" }, this.content && (h("div", { key: 'd1b7976996d2bcab4405d6fc9a80eeb783a9f3a0', class: "flex flex-col p-16 leading-normal" }, this.content)), h("slot", { key: '6c1434d9e4e4bf0206f392e1919295facd931e09' })))));
    }
