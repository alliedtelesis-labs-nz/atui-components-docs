...
export class AtToggleSwitchComponent {
    ...
    render() {
        ...
        return (h(Host, { key: '9d69805370b5fb42b9f84187d2a01ba4be2a3e16', id: `${this.toggleId}-host`, role: "switch", "aria-checked": this.value ? 'true' : 'false', "aria-disabled": this.disabled ? 'true' : undefined, "aria-labelledby": this.label && this.show_label
                ? `${this.toggleId}-label`
            ...
            } }, h("div", { key: 'ba70d88c5b324e6c71174b0cfe643a252ef9d91d', class: "flex flex-col empty:hidden" }, h("slot", { key: '11e37fad726a699bc2535aa39e6e5c6bbf5fbab7', name: "label" }), !!this.label && this.show_label && (h("at-form-label", { key: '47699361e547b14f732643770023d1eac00961dd', label: this.label, class: "pointer-events-none select-none", for: this.toggleId, id: `${this.toggleId}-label`, "data-name": "switch-label" })), this.hint_text && (h("span", { key: '440320d8e6c0b0dbc8ac9e1712bbbd2925970c0d', class: "text-muted inline-block text-xs leading-tight", "data-name": "select-hint" }, this.hint_text))), h("div", { key: 'f213cd1757c67e5390b02abfc83af10da23511e2', class: "relative flex h-20 w-40" }, h("input", { key: '53b869dee898a59c7a4216c4543c89b268c0225e', id: this.toggleId, class: "h-0 w-0 opacity-0", disabled: this.disabled, type: "checkbox", checked: this.value, tabIndex: -1, onChange: (e) => this.onToggle(e.target.checked), ref: (el) => (this.inputEl = el), "data-name": "switch-input" }), h("span", { key: '90e341d95f4bab152619953a2854a0ac0495ef17', class: trackClassname }, h("at-icon", { key: 'dfab19fe3d37a51735c50e8744172c5991d84ce2', name: this.value ? 'checkmark' : 'subtract', class: thumbClassname, style: {
