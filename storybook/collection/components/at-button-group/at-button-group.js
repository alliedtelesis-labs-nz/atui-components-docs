...
export class AtButtonGroup {
    ...
    render() {
        return (h(Host, { key: '3a23f89b077e1c6ede8d5aeed0af9cc5d931c3d1', role: "radiogroup", "aria-labelledby": this.buttonGroupId }, h("div", { key: '8be59c99906993f5da5bc64e8adb1983a7bbe239', class: "mb-4 flex flex-col empty:hidden" }, h("slot", { key: 'ed79ab0ad21f3ccde8942262fae4add41750bb80', name: "label" }), (this.label || this.info_text) && (h("at-form-label", { key: '2f460abe88b4aa4cee0d61ff82fcb113afcc04ca', label: this.label, for: this.buttonGroupId, info_text: this.info_text })), this.hint_text && (h("span", { key: '20c838ea82a0ffa95634db2f7dc6d088045750e5', class: "text-muted inline-block text-xs leading-tight", "data-name": "button-group-hint" }, this.hint_text))), h("div", { key: '42d6ca0c281abe4fc6b6982072783e0308f44e25', class: "border-input bg-surface-background relative w-fit rounded-lg border inset-shadow-xs" }, h("ul", { key: 'ceec51cd873861f118d32e18d4cb62de074e069a', class: "relative z-20 m-[2px] flex flex-row", "data-name": "button-group-options" }, h("slot", { key: 'f04d77dd589a661c2df9f8a79a8d4734228909a8' }), this.getButtonGroupOptions &&
            this.getButtonGroupOptions.map((button) => (h("li", { class: "relative z-10 mr-[-1px]" }, button))))), this.error_text && (h("span", { key: 'b27413228111030bcbd833ea047e0ac5697eab18', class: "text-error text-xs font-medium", "data-name": "button-group-error-text" }, this.error_text))));
    }
