...
export class AtButtonGroup {
    ...
    render() {
        return (h(Host, { key: 'ae159169efe6f70587c54f99b508288a5cd04439', role: "radiogroup", "aria-labelledby": this.buttonGroupId, class: 'flex flex-col items-start' }, h("div", { key: '4b3ef5b36010ca6e617e0f6415705f2ec014ec49', class: "mb-4 flex flex-col" }, h("slot", { key: 'edc8c3ced3e5416f654f3737ef35d7c77c581e8c', name: "label" }), (this.label || this.info_text) && (h("at-form-label", { key: 'fdc9aae0cfd710d18c5fa556a6a16fced349c350', id: this.buttonGroupId, label: this.label, info_text: this.info_text })), this.hint_text && (h("span", { key: '15b9bb0ae947b555251a82ec4cb2eeab59cdd48d', class: "text-light inline-block text-xs leading-tight", "data-name": "button-group-hint" }, this.hint_text))), h("div", { key: 'd93b651a59dea9e654ca3fa12533952770deae7c', class: "border-med relative rounded-lg border bg-white inset-shadow-xs" }, h("ul", { key: 'b0e9117d3c622e044efe8f8a4a9407ecb438573f', class: "relative z-20 m-[2px] flex flex-row", "data-name": "button-group-options" }, h("slot", { key: '2ded56804c92c7c8baf3e632322f3fbbbc573708' }), this.getButtonGroupOptions &&
            this.getButtonGroupOptions.map((button) => (h("li", { class: "relative z-10 mr-[-1px]" }, button))))), this.error_text && (h("span", { key: '0e43faf09aa4e02e17d1850f857ba15ee7ae94ec', class: "text-error text-xs font-medium", "data-name": "button-group-error-text" }, this.error_text))));
    }
