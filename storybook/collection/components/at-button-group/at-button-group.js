...
export class AtButtonGroup {
    ...
    render() {
        return (h(Host, { key: '44e1973357a355adc050185f49449a4a9a9962ab', role: "radiogroup", "aria-labelledby": this.buttonGroupId }, h("div", { key: '5ddc4438f13f386f1d84d95b320a4d68c6cdc484', class: "mb-4 flex flex-col empty:hidden" }, h("slot", { key: '3cd5014a9f51ff225e08ffac01b89c7339675e34', name: "label" }), (this.label || this.info_text) && (h("at-form-label", { key: 'ad5bd187de51c33edd6c6f13b12cb0f5ca804d5d', label: this.label, for: this.buttonGroupId, info_text: this.info_text })), this.hint_text && (h("span", { key: 'c64073eba25063b7dbcdaab8b5c81da391f1eb50', class: "text-muted inline-block text-xs leading-tight", "data-name": "button-group-hint" }, this.hint_text))), h("div", { key: 'f75b6a3b254254d123a6af2dda85623e8ab38662', class: "border-input bg-surface-background relative w-fit rounded-lg border inset-shadow-xs" }, h("ul", { key: 'c8e1b730390b74019a41d431e41c67bea4cafd19', class: "relative z-20 m-[2px] flex flex-row", "data-name": "button-group-options" }, h("slot", { key: 'd51e25b300fe67408c6832a83a3eafdd830b94cb' }), this.getButtonGroupOptions &&
            this.getButtonGroupOptions.map((button) => (h("li", { class: "relative z-10 mr-[-1px]" }, button))))), this.error_text && (h("span", { key: 'dfe424060ba3a94afdf4676c1a4e1d7470fb471b', class: "text-error text-xs font-medium", "data-name": "button-group-error-text" }, this.error_text))));
    }
