...
export class AtInputNumericComponent {
    ...
    render() {
        ...
        return (h(Host, { key: '7e24d13143a556909d3d7ae494388ddc89f9e6a9', class: "w-full" }, h("div", { key: '94da15994488a880a7015dae3a019fb76b25ea97', class: "flex flex-col" }, h("slot", { key: '7e86cfe7b7815ba67623a04ecd29c9198975e226', name: "label" }), (this.label || this.required || this.info_text) && (h("at-form-label", { key: 'dd565232f53430a8d8845b23ec68cdfb759713ff', label: this.label, for: this.inputId, required: this.required && !this.readonly, info_text: this.info_text })), this.hint_text && (h("span", { key: '4787b5f610bc9bc1c9b9e30f13bc6670cfb18258', class: "text-light mb-8 inline-block text-xs leading-tight", "data-name": "input-hint" }, this.hint_text))), h("div", { key: 'f17bb7c46a949355bcf4496c818c8439a172b2e7', class: containerClassname }, this.show_buttons && !this.disabled && !this.readonly && (h("at-button", { key: '890b779d0dc6ad8133ee225d6602329ddb3b1457', class: "border-med rounded-l-md rounded-r-none border-r border-solid", type: "secondaryText", icon: "remove", onClick: this.handleDecrease, disabled: this.value <= this.min, "aria-label": "Subtract", "data-name": "input-subtract" })), h("input", { key: 'b61d6e412a97c259c4424c3778e2bb97844cc7a5', id: this.inputId, readonly: this.readonly ? true : undefined, disabled: this.disabled ? true : undefined, required: this.required, type: "number", placeholder: `${this.placeholder}`, onInput: (event) => (this.value = Number(event.target.value)), onChange: (event) => this.handleChange(event), value: this.value, ref: (el) => (this.inputEl = el), class: classname, "data-name": "input" }), this.show_buttons && !this.disabled && !this.readonly && (h("at-button", { key: 'cf746baee609588e245339ce2ed97fe0ab57c9d8', class: "border-med rounded-l-none rounded-r-md border-l border-solid", type: "secondaryText", icon: "add", onClick: this.handleIncrease, disabled: this.value >= this.max, "aria-label": "Add", "data-name": "input-add" }))), this.error_text && this.invalid && (h("span", { key: '1368c070c5ff291eac06c60c8a4e0ab01442c98a', class: "text-error text-sm", "data-name": "input-error" }, this.error_text))));
    }
