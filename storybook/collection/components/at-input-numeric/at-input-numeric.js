...
export class AtInputNumericComponent {
    ...
    render() {
        ...
        return (h(Host, { key: '8c5100a2536892155b233131ec2e98ed26e1e07e', class: "w-full" }, h("div", { key: 'da77d7da9c9358cc686c3a2cdee9758967c570e7', class: "mb-4 flex flex-col empty:hidden" }, h("slot", { key: '9be5743c7b9175fca2db88edac9712b5eeeb3c29', name: "label" }), (this.label || this.required || this.info_text) && (h("at-form-label", { key: 'c633857329a50afab1551bd2789a2d48ffc15efa', label: this.label, for: this.inputId, required: this.required && !this.readonly, info_text: this.info_text })), this.hint_text && (h("span", { key: '2f57743384cc4c11b742040692d325b565899f1a', class: "text-muted inline-block text-xs leading-tight", "data-name": "input-hint" }, this.hint_text))), h("div", { key: 'b33a30a0c74a41b1b722fcc055c3240e2049252c', class: containerClassname }, this.show_buttons && !this.disabled && !this.readonly && (h("at-button", { key: '27dae60e29ca9df1413dd05e9f8a7c34c5381ebd', class: "border-input rounded-l-md rounded-r-none border-r border-solid", type: "secondaryText", onClick: this.handleDecrease, disabled: this.value <= this.min, "aria-label": "Subtract", "data-name": "input-subtract" }, h("at-icon", { key: '57d5bb0878b4a15c28e9e08c46ff9ac686bf7d49', slot: "icon", name: "subtract" }))), h("input", { key: '26502e73e52e6dc525e7f21f2c1785470fa39ff4', id: this.inputId, readonly: this.readonly ? true : undefined, disabled: this.disabled ? true : undefined, required: this.required, type: "number", placeholder: `${this.placeholder}`, onInput: (event) => (this.value = Number(event.target.value)), onChange: (event) => this.handleChange(event), value: this.value, ref: (el) => (this.inputEl = el), class: classname, "data-name": "input" }), this.show_buttons && !this.disabled && !this.readonly && (h("at-button", { key: '90b64f90cbebaf79de21cdaf6fc32806ae9cd0c4', class: "border-input rounded-l-none rounded-r-md border-l border-solid", type: "secondaryText", onClick: this.handleIncrease, disabled: this.value >= this.max, "aria-label": "Add", "data-name": "input-add" }, h("at-icon", { key: '61a0fa84c008f6e5de558ce487ac403e24d31cd5', slot: "icon", name: "add" })))), this.error_text && this.invalid && (h("span", { key: '7175808db165096056303ccc1d2baef7fef2d4c1', class: "text-error text-sm", "data-name": "input-error" }, this.error_text))));
    }
