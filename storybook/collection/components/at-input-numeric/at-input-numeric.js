...
export class AtInputNumericComponent {
    ...
    render() {
        ...
        return (h(Host, { key: 'fcba8e0e57c26788416647372855450cd9468118', class: "w-full" }, h("div", { key: '6f5275696f933aca9c4ca4e9c9525beec1718619', class: "mb-4 flex flex-col empty:hidden" }, h("slot", { key: 'c8bb0cc9a4761f9d6a33ffb1afde28f0205aab05', name: "label" }), (this.label || this.required || this.info_text) && (h("at-form-label", { key: '183b3369bd22357eb0b7ebf9dfdd69f3284a3398', label: this.label, for: this.inputId, required: this.required && !this.readonly, info_text: this.info_text })), this.hint_text && (h("span", { key: 'bf1c47a468525af7002d0f7913fca275583a9030', class: "text-muted inline-block text-xs leading-tight", "data-name": "input-hint" }, this.hint_text))), h("div", { key: '9ff3d2ee7e58b824156ff21cc698135c7aaf301a', class: containerClassname }, this.show_buttons && !this.disabled && !this.readonly && (h("at-button", { key: '5f630189287217f1c150e4cb776a4dfab3afdce4', class: "border-input rounded-l-md rounded-r-none border-r border-solid", type: "secondaryText", onClick: this.handleDecrease, onKeyDown: (event) => this.handleStepKeyDown(event, this.handleDecrease), disabled: this.value <= this.min, "aria-label": "Subtract", "data-name": "input-subtract" }, h("at-icon", { key: '21c574945c9299aa5a0c3df50afa4e3d6062d9c9', slot: "icon", name: "subtract" }))), h("input", { key: 'c7d7acb2e9e5fcf14da78b96854df4a351f7a415', id: this.inputId, "aria-label": this.aria_label ?? undefined, readonly: this.readonly ? true : undefined, disabled: this.disabled ? true : undefined, required: this.required, type: "number", min: this.min, max: this.max, step: this.step, placeholder: `${this.placeholder}`, onInput: (event) => this.handleInput(event), onChange: (event) => this.handleChange(event), value: this.value, ref: (el) => (this.inputEl = el), class: classname, "data-name": "input" }), this.show_buttons && !this.disabled && !this.readonly && (h("at-button", { key: 'e7bcd2ccc363f910103c2f3c69b873b8c36b7780', class: "border-input rounded-l-none rounded-r-md border-l border-solid", type: "secondaryText", onClick: this.handleIncrease, onKeyDown: (event) => this.handleStepKeyDown(event, this.handleIncrease), disabled: this.value >= this.max, "aria-label": "Add", "data-name": "input-add" }, h("at-icon", { key: 'c8eb44f66fb4be588ffdca563a2516e768c32d1b', slot: "icon", name: "add" })))), this.error_text && this.invalid && (h("span", { key: '4de645d156f91b1294e90294a77998e65385102e', class: "text-error text-sm", "data-name": "input-error" }, this.error_text))));
    }
