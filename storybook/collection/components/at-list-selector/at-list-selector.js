...
export class AtListSelector {
    ...
    render() {
        return (h(Host, { key: '223675a3125c8308c33f54abc0906a4757be42b5', onKeyDown: (event) => this.handleKeyDown(event) }, h("slot", { key: 'f4fc097c5e1acfd85858dee653d0ece656eb90c3', name: "header" }), !!this.options.length && (h("nav", { key: 'cfa04a5622ca1bbaee09b842cd918866631035dc', class: "flex-fill overflow-visible pb-16" }, h("div", { key: '7dc643e8eb5488b9f7516475961d86cf227da648', class: "flex flex-col", role: "menu" }, this.getListItems))), h("slot", { key: '923b30220996e900b3bf7ea68a76ca360c3550a5' })));
    }
