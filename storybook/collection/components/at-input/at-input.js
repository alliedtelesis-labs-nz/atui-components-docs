...
export class AtInputComponent {
    ...
    render() {
        ...
        return (h(Host, { key: 'febf61794adc4558d9b8fbbc6e11ead1ce4c8ae8' }, h("div", { key: 'f68d1fde2bdcd1153c8b25e3a691eca2852b8ebf', class: "mb-4 flex flex-col empty:hidden" }, h("slot", { key: '0cb4462c466dd007ca08371e3754e5214c42831e', name: "label" }), (this.label || this.required || this.info_text) && (h("at-form-label", { key: 'd187794445fd9270fd02b239832a84811c3cc3bd', label: this.label, for: this.inputId, required: this.required && !this.readonly, info_text: this.info_text })), this.hint_text && (h("span", { key: '9df0f9d544f3e72fba7bb94d37c796ad5089f402', class: "text-muted mb-2 inline-block text-xs leading-tight", "data-name": "input-hint" }, this.hint_text))), h("div", { key: '3c035c544459e66dcd09229db08b2ed85c4bc841', class: classname }, h("input", { key: '41f31442141d9653514aca0e13c4df8fc29d3a29', class: "py-input-y pl-input-x flex w-full min-w-0 text-ellipsis outline-0", id: this.inputId, "aria-label": this.aria_label ?? undefined, readonly: this.readonly ? true : undefined, disabled: this.disabled ? true : undefined, required: this.required, type: this.type, placeholder: `${this.placeholder}`, autocomplete: this.autocomplete, autocapitalize: "none", onInput: (event) => this.handleChange(event), onChange: (event) => this.handleChange(event), value: this.value, ref: (el) => (this.inputEl = el), "data-name": "input" }), h("div", { key: '0e178a09ecf85c484effc90206f1550fb751a271', class: "flex items-center py-4 pr-4" }, h("slot", { key: '8f4f06e693a94fcbe1157ad07e923054c100129c', name: "input-actions" }), this.clearable &&
            !this.readonly &&
            !this.disabled &&
            this.value && (h("at-button", { key: '7aef179481295c2e8069500c499b91a2959c697f', class: `transition-all duration-300 ease-in-out ${this.clearable &&
                !this.readonly &&
                !this.disabled &&
                this.value
                ...
                event.stopPropagation();
                this.handleClear();
            }, "data-name": "input-clear" }, h("at-icon", { key: 'c3416f86e6dba34c74e213dd5cddc17a21d28581', slot: "icon", name: "cancel" }))))), this.error_text && this.invalid && (h("span", { key: '08d84d32072a0cb19c52b2a3f233c5849cfd3283', class: "text-error text-sm", "data-name": "input-error" }, this.error_text))));
    }
