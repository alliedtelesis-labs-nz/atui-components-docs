...
export class AtInputComponent {
    ...
    render() {
        ...
        return (h(Host, { key: 'b11c83baadcc1f05ccb25d6f66961cfd45622bcb' }, h("div", { key: 'e9e44d28c51729a9f343c8b755ae229dc70029cb', class: "mb-4 flex flex-col empty:hidden" }, h("slot", { key: '4b88ba348bad770915c7fef3a6b5f8e321b8e05f', name: "label" }), (this.label || this.required || this.info_text) && (h("at-form-label", { key: '445e9b02ae4cbff7fbeaadf6afae42678cd00cdb', label: this.label, for: this.inputId, required: this.required && !this.readonly, info_text: this.info_text })), this.hint_text && (h("span", { key: '936841dadd6e5c674969cb4c6c872338d2a0fa93', class: "text-muted mb-8 inline-block text-xs leading-tight", "data-name": "input-hint" }, this.hint_text))), h("div", { key: 'f4d92687827f619d0eee31ed5755d4deb5afe5e2', class: classname }, h("input", { key: '275ec5d974f9956682f8e3caeacdc36667487f9e', class: "py-input-y pl-input-x flex w-full outline-0", id: this.inputId, readonly: this.readonly ? true : undefined, disabled: this.disabled ? true : undefined, required: this.required, type: this.type, placeholder: `${this.placeholder}`, autocomplete: this.autocomplete, autocapitalize: "none", onInput: (event) => this.handleChange(event), onChange: (event) => this.handleChange(event), value: this.value, ref: (el) => (this.inputEl = el), "data-name": "input" }), h("div", { key: '0e9def4ed83db927618065ed9d1b69ff07b3db48', class: "flex items-center py-4 pr-4" }, h("slot", { key: '7f74b54be58a305656f90c7bff1f91af790883cf', name: "input-actions" }), this.clearable &&
            !this.readonly &&
            !this.disabled &&
            this.value && (h("at-button", { key: '3f1e06941dd95c2b097f3ac5bd87b8ec501666a8', class: `transition-all duration-300 ease-in-out ${this.clearable &&
                !this.readonly &&
                !this.disabled &&
                this.value
                ...
                event.stopPropagation();
                this.handleClear();
            }, "data-name": "input-clear" }, h("at-icon", { key: '0d226e16f1647aa9503504e6c364491636626f1c', slot: "icon", name: "cancel" }))))), this.error_text && this.invalid && (h("span", { key: 'a90a62fba81ceafdd58b4bcbfd21606f74566498', class: "text-error text-sm", "data-name": "input-error" }, this.error_text))));
    }
