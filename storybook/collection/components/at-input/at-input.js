...
export class AtInputComponent {
    ...
    render() {
        ...
        return (h(Host, { key: '89dee6f997e77460d24040c97b5efc511ece38cf' }, h("div", { key: 'cbd1a2d6e10cf077b1a383d644c2d0f065280c84', class: "mb-4 flex flex-col empty:hidden" }, h("slot", { key: '2dc1394e1e7775adf81931520385a34dcb979a85', name: "label" }), (this.label || this.required || this.info_text) && (h("at-form-label", { key: '36c125fceead5f55f002d7a8bdd6ef532ff549fa', label: this.label, for: this.inputId, required: this.required && !this.readonly, info_text: this.info_text })), this.hint_text && (h("span", { key: 'd37778641316181e8e1bb6e0b53cd32b7dac9ff5', class: "text-muted mb-2 inline-block text-xs leading-tight", "data-name": "input-hint" }, this.hint_text))), h("div", { key: '220f6e537958b2afe5eff1d25aa1278f0077d744', class: classname }, h("input", { key: '6c779bc91342d3cbc5db6be19c332fd73688bd68', class: "py-input-y pl-input-x flex w-full min-w-0 text-ellipsis outline-0", id: this.inputId, "aria-label": this.aria_label ?? undefined, readonly: this.readonly ? true : undefined, disabled: this.disabled ? true : undefined, required: this.required, type: this.type, placeholder: `${this.placeholder}`, autocomplete: this.autocomplete, autocapitalize: "none", onInput: (event) => this.handleChange(event), onChange: (event) => this.handleChange(event), value: this.value, ref: (el) => (this.inputEl = el), "data-name": "input" }), h("div", { key: 'ee2ddcf40787b9afd9ee2cd6b77c21d1fa73d1ce', class: "flex items-center py-4 pr-4" }, h("slot", { key: 'b867918b4ec1cb9e92478d8222133fc6e127532d', name: "input-actions" }), this.clearable &&
            !this.readonly &&
            !this.disabled &&
            this.value && (h("at-button", { key: '3ecfab477779e7419dc859c4412d1b3667c480a6', class: `transition-all duration-300 ease-in-out ${this.clearable &&
                !this.readonly &&
                !this.disabled &&
                this.value
                ...
                event.stopPropagation();
                this.handleClear();
            }, "data-name": "input-clear" }, h("at-icon", { key: 'a1be49ffc80afc1cde7cfce1f0da16c39587ae1b', slot: "icon", name: "cancel" }))))), this.error_text && this.invalid && (h("span", { key: '8ed0f750848855f98e988923d92ab9c1fb79a4e8', class: "text-error text-sm", "data-name": "input-error" }, this.error_text))));
    }
