...
export class AtChartBreakdown {
    ...
    async resize(containerHeight) {
        void containerHeight; // backwards-compat; chart self-sizes via ResizeObserver
        if (this.chart) {
            this.chart.resize();
        }
    }
    ...
    render() {
        ...
        return (h(Host, { key: 'fcefc95bd4d0734d5a50d89fefe41c80ddfc7956', style: {
                height: '100%',
                width: '100%',
                minHeight: '65px',
                position: 'relative',
            ...
            } }, h("canvas", { key: 'a3efdd6ddaabf827376e32d8efd2e019f81147af', class: heightVariants[this.height], style: {
                aspectRatio: '1 / 1',
                flexShrink: '0',
            }, ref: (el) => {
                if (el) {
            ...
            } }), showSideText && (h("div", { key: '09bd301e88b61de31a6677e02b6d0f9551d43fee', class: "flex flex-col justify-center ps-8", style: {
                position: 'absolute',
                left: `${this.compactOffset}px`,
            }, ref: (el) => {
                this.sideTextEl = el ?? undefined;
            } }, this.center_value && (h("span", { key: '546a6b411aa9bec932efe2b76e6870e2dd9ebb93', style: {
                fontSize: '3rem',
                fontWeight: '700',
                lineHeight: '1.1',
                color: 'var(--token-text-primary)',
            } }, this.center_value)), this.center_text && (h("span", { key: '6eb2f0c9744cf840c8bf4155888f1abc6d237d45', style: {
                fontSize: '1rem',
    ...
    static get properties() {
        return {
            ...
            "center_value": {
                ...
                "docs": {
                    "tags": [],
                    "text": "Optional value text to display alongside the breakdown chart"
                },
                "getter": false,
                "setter": false,
                "reflect": false,
            ...
            "center_text": {
                ...
                "docs": {
                    "tags": [],
                    "text": "Optional heading text to display alongside the breakdown chart"
                },
                "getter": false,
                "setter": false,
                "reflect": false,
