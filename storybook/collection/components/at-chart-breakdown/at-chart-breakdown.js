...
export class AtChartBreakdown {
    ...
    render() {
        ...
        return (h(Host, { key: '4d5eb6084ba05b3c996f42cf44c49d4d006dae23', style: {
                height: '100%',
                width: '100%',
                minHeight: '65px',
                position: 'relative',
            ...
            } }, h("canvas", { key: '1958ace619009b2339233669d6c173091314742b', class: heightVariants[this.height], style: {
                aspectRatio: '1 / 1',
                flexShrink: '0',
            }, ref: (el) => {
                if (el) {
            ...
            } }), showSideText && (h("div", { key: '79d77fffe571831db06f568f17b3551a6f28dd92', class: "flex flex-col justify-center ps-8", style: {
                position: 'absolute',
                left: `${this.compactOffset}px`,
            }, ref: (el) => {
                this.sideTextEl = el ?? undefined;
            } }, this.center_value && (h("span", { key: '9e6a4ae44dcc5ca4914df751fd56f47a9a2963c0', style: {
                fontSize: '3rem',
                fontWeight: '700',
                lineHeight: '1.1',
                color: 'var(--token-text-primary)',
            } }, this.center_value)), this.center_text && (h("span", { key: '797f7e189cdc95e4c804b622249c61671b6ff829', style: {
                fontSize: '1rem',
