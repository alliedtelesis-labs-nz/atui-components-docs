...
export class AtMultiSelectComponent {
    ...
    render() {
        return (h(Host, { key: 'a6524ab13100e57b2b1f8570a3c1cfbcc53770e0', class: "group/select", onFocusout: async (event) => {
