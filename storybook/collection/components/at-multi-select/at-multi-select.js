...
export class AtMultiSelectComponent {
    ...
    render() {
        return (h(Host, { key: 'd225063119800885e4ca1d86c9feaf162e65fa9e', class: "group/select", onFocusout: async (event) => {
