...
export class AtMultiSelectComponent {
    ...
    render() {
        return (h(Host, { key: '79da9c4a9f5a0a7d39ac8e94e2b845e56f05a9d8', class: "group/select", onFocusout: async (event) => {
            ...
            } }, this.renderLabel(), h("at-menu", { key: 'e000fa2aeea1676824fb1bd76a80ac090a296532', ref: (el) => (this.menuRef = el), trigger: "click", align: "start", width: this.parentWidth, max_height: this.menu_max_height, role: "presentation", autoclose: false, disabled: this.disabled || this.readonly, onAtuiMenuStateChange: (event) => this.updateIsOpenState(event) }, this.renderInput(), !this.disabled && !this.readonly
            ? this.renderOptions()
            : null), h("div", { key: '7284eb96dc686522a9258f210e6929055253956f' }, this.error_text && this.invalid && (h("span", { key: '49f07c8083f1c58ba4321ec05c74c2ab808345a9', "data-name": "multi-select-error", class: "text-error" }, this.error_text)))));
    }
    renderLabel() {
    ...
    static get properties() {
        return {
            ...
            "selection_display": {
                ...
                "mutable": false,
                "complexType": {
                    "original": "AtMultiSelectSelectionDisplay",
                    "resolved": "\"chips\" | \"count\"",
                    "references": {
                        "AtMultiSelectSelectionDisplay": {
                            "location": "local",
                            "path": "/home/runner/work/atui-components/atui-components/atui-components-stencil/src/components/at-multi-select/at-multi-select.tsx",
                            "id": "src/components/at-multi-select/at-multi-select.tsx::AtMultiSelectSelectionDisplay"
                        }
                    }
                },
                "required": false,
                ...
                "docs": {
                    "tags": [],
                    "text": "How the trigger displays the current selection.\n\n`chips` renders the selected values as removable chips inside the trigger,\nwhich grows with the selection - the right behaviour for a form field.\n`count` renders the placeholder plus a badge carrying the number selected,\nat a fixed height however much is selected. Use it in a filter bar, paired\nwith an external `at-chip-list` for the selection itself, so the bar does\nnot reflow as the user picks. In `count` the placeholder carries the field\nname inside the trigger, so the outside label and hint text are not\nrendered - set `label` anyway and it becomes the control's accessible name.\nThe badge says how many, never which, so `count` belongs on a surface that\ndisplays the selection somewhere else - a chip row of its own, or a table's."
                },
                "getter": false,
                "setter": false,
                "reflect": false,
                "attribute": "selection_display",
                "defaultValue": "'chips'"
            },
            "value": {
                "type": "unknown",
