...
export class AtStaticTable {
    ...
    render() {
        return (h(Host, { key: '1ca8d78eedf4d3179f2884bdd583dcc3d300bbb2' }, !this.hide_column_manager && (h("at-table-actions", { key: '7fcef9c15c4ea9fc21a7213e6973e64dea6942a5', ag_grid: this.agGrid }, h("at-column-manager", { key: '0d7eae6098854554fdf3ed2fa7631319c9bdc03e', slot: "column-manager", col_defs: this.col_defs }))), h("at-table", { key: 'c052aee0c669f4ad90d751e3aebf4a2a182f58b3', ref: (el) => (this.tableEl = el), ag_grid: this.agGrid, table_data: this.table_data, col_defs: this.col_defs, page_size: this.page_size, use_custom_pagination: this.use_custom_pagination, disable_auto_init: true })));
    }
