...
export class AtTextStatusCellComponent {
    ...
    render() {
        return (h(Host, { key: '7c3089f19f571ccaf2175eb2853f21f50827d59e', class: "flex h-full items-center" }, this.showSimpleText && this.params && (h("span", { key: '976a7bcceabbdac25f276840c7380005f31ec1c3', class: "truncate text-sm" }, this.text)), !this.showSimpleText &&
            this.params &&
