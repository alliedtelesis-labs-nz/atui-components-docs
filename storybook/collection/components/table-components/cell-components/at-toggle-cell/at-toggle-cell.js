...
export class AtToggleCell {
    ...
    render() {
        return (h(Host, { key: 'abbc9500da46073f5e82d1b261d061803d8310b7', class: "flex h-full items-center leading-[100%]" }, h("at-toggle-switch", { key: 'a0eb5bb95ec55951ef78230b755b2daa3d874378', label: this.label, onChange: () => this.params.onTrigger?.(this.params), label_position: this.labelPosition, show_label: !!this.label, value: this.value, disabled: this.disabled })));
    }
