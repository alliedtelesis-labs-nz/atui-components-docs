...
export class AtToggleCell {
    ...
    render() {
        return (h(Host, { key: 'd7878fabbb156bb411f587d030189e717e31547d', class: "flex h-full items-center leading-[100%]" }, h("at-toggle-switch", { key: 'b90d7e0db4bafd2bd0ed6cfe0b5610c62aa493eb', label: this.label, onChange: () => this.params.onTrigger?.(this.params), label_position: this.labelPosition, show_label: !!this.label, value: this.value, disabled: this.disabled })));
    }
