...
export class AtCheckboxHeaderComponent {
    ...
    render() {
        return (h("at-checkbox", { key: '9241080292d5d192cbc63479c43d4a822732f6ea', disabled: this.disabled, checked: this.isChecked, onAtuiChange: (event) => this.setRowsValue(event.detail) }));
    }
