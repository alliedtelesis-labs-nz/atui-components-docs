...
export class AtColumnManagerComponent {
    ...
    render() {
        return (h("at-menu", { key: 'a92201d999717f824ef45794ee1f4a91f8afbf43', autoclose: false, width: "fit-content", position: "bottom", align: "end" }, h("div", { key: 'df15f83631666d2b685d081f71c07fcb0289e9fc', slot: "menu-trigger" }, h("at-tooltip", { key: '980223ede3ac5d224078399f4090a97bde73c415', position: "top" }, h("at-button", { key: '182a166b5e4e93b151a721e14e9f35cf8bfa3d45', slot: "tooltip-trigger", type: "secondaryText" }, h("at-icon", { key: 'de8adab0be4701ebcea8b5a29d0296de578791e8', slot: "icon", name: "column" })), h("span", { key: '2bce6db8dc958b41a4613a9e468cbef2214b23ff' }, this.translations.ATUI.TABLE.MANAGE_COLUMNS))), h("at-checkbox-group", { key: '0908a559e8a4a56390e58c9dbd347dfd3f39776f', class: "w-fit", options: this.col_defs
                ? this.col_defs
