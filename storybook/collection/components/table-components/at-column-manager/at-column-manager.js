...
export class AtColumnManagerComponent {
    ...
    render() {
        return (h("at-menu", { key: '5015663a54f4c38cd0db7ce4c0b845a30661f3b1', autoclose: false, width: "fit-content", position: "bottom", align: "end" }, h("div", { key: 'a524c58c0125852c729af5ac4ee1fe933d6c10a5', slot: "menu-trigger" }, h("at-tooltip", { key: '5a67dfe34f914002ae6862bd6058da83210a4ed1', position: "top" }, h("at-button", { key: 'c8b53653786da2ec44eb5d051850e2e284b22ce0', slot: "tooltip-trigger", type: "secondaryText" }, h("at-icon", { key: 'd8bc3037e60368aa09bde9098c75f619ad97c565', slot: "icon", name: "column" })), h("span", { key: '9eefc3b813ca0d5c24572380fe0ce5ede632fd9a' }, this.translations.ATUI.TABLE.MANAGE_COLUMNS))), h("at-checkbox-group", { key: 'a7d5a6ccf3835aaf944c39dfc2c941f8fbeb439a', class: "w-fit", options: this.col_defs
                ? this.col_defs
