...
export class AtSearchTable {
    ...
    render() {
        return (h(Host, { key: '1eb94a414b9396a35ce848d168770eee98d8a44c' }, h("at-table-actions", { key: '381099b5d74e0b239666b79d5292e6e94e573e3c', ag_grid: this.agGrid }, h("div", { key: 'ccb3fcd8113a478da7c91e0a087b434b3e3a0341', class: "flex items-center gap-8 px-8", slot: "search" }, this.shouldShowDropdownFilters && (h("at-table-filter-menu", { key: '80062e4465593bbb1620f2a0deb68b2df71b27c2', slot: "filter-menu", col_defs: this.col_defs, selected: this.menuSelectedIds, onAtChange: (event) => this.handleFilterChange(event) })), h("at-search", { key: 'fa7068177d54c03b8606672109d942db3c91beeb', class: "w-input-md", label: this.search_label, hint_text: this.search_hint, info_text: this.search_info_tooltip, placeholder: this.translations.ATUI.TABLE.SEARCH_BY_KEYWORD, onAtChange: (event) => this.handleSearchChange(event) })), this.shouldShowDropdownFilters && (h("at-table-filters", { key: '9a62d8142d30860d176b3cf5c0a49701745fd558', slot: "filters", col_defs: this.col_defs, selected: this.selectedFilters, onAtChange: (event) => this.handleFilterChange(event) })), !this.hide_export_menu && (h("at-table-export-menu", { key: '8c5f7adc271eff58305cd8d9323f1db327a5c256', slot: "export-menu", hide_csv: this.hide_csv_export, hide_pdf: this.hide_pdf_export, onAtChange: (event) => this.handleExport(event) })), this.shouldShowColumnManager && (h("at-column-manager", { key: '5cf70c6e51e0f14e483d5fc49773c49d9b251370', slot: "column-manager", col_defs: this.col_defs, onAtChange: (event) => this.handleColumnChange(event) })), h("div", { key: '34c88a3a1d4cc86e2b2554f5c973654f8b4afb54', slot: "actions" }, h("slot", { key: 'd01c38d4a737f0995546c7baccedbc2fa5e051fc', name: "actions" }))), h("slot", { key: '3d264fb97d3bc411ee8bfa4d3d6a6a6c8636eb20', name: "multi-select-actions" }), this.loading && this.server_side_mode ? (h("at-placeholder", { size: "lg", placeholder_title: this.translations?.ATUI?.TABLE?.LOADING_DATA, show_loading_spinner: true })) : (h("at-table", { ref: (el) => (this.tableEl = el), table_data: this.table_data, col_defs: this.col_defs, page_size: this.server_side_mode
                ? this.pageSize
                : this.page_size, use_custom_pagination: this.server_side_mode, auto_size_columns: this.auto_size_columns, disable_auto_init: !this.server_side_mode })), this.server_side_mode && (h("at-table-pagination", { key: '7f86be3eacb586574b30c40e9925f8ea0d184b42', current_page: this.currentPage, num_pages: this.totalPages, onAtChange: (event) => this.handlePageChange(event), onAtPageSizeChange: (event) => this.handlePageSizeChange(event) }))));
    }
    ...
    static get events() {
        return [{
                ...
                "complexType": {
                    "original": "ISearchTableParams",
                    "resolved": "ISearchTableParams",
                    "references": {
                        "ISearchTableParams": {
                            "location": "import",
                            "path": "../../../types",
