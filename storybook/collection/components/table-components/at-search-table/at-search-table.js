...
export class AtSearchTable {
    ...
    render() {
        return (h(Host, { key: 'f77e9ebfede56dcf17bb3502f8f18ae0c010a330', class: this.server_side_mode ? 'is-loading' : '' }, h("at-table-actions", { key: '873fb088be112c157037914ed771727e07af376e', ag_grid: this.agGrid }, h("at-control-group", { key: '57e4b7a6d68e8d220a7499dbc0004b2006bce7e0', slot: "search" }, this.shouldShowTableFilters && (h("at-table-filter-menu", { key: 'a5f3c957502a02814d702ec23009dab89016bc51', ref: (el) => (this.filterMenuEl =
                el), col_defs: this.col_defs, filters: this.selectedFilters, onAtChange: (event) => this.handleFilterChange(event) })), h("at-search", { key: '22452967485b1d02e5ca3c30260ff6a77a37d01a', class: "w-input-md", info_text: this.searchInfoTooltip, placeholder: this.translations.ATUI.TABLE.SEARCH_BY_KEYWORD, onAtChange: (event) => this.handleSearchChange(event) })), h("div", { key: '979cc046cb92fbc4c9e6673ff1e026a5f52e18d7', class: "contents", slot: "filter-bar" }, h("slot", { key: 'a6c88b42a11556d0632d5abc19b69842a65196c3', name: "filter-bar" })), this.hasDisplayableFilters && (h("at-table-filters", { key: 'caefe45fe143412a30e73b09417bd8dd1e686a4b', slot: "filters", filters: this.chipFilterTree(), onAtChange: (event) => this.handleFilterChange(event), onAtFilterClick: () => this.filterMenuEl?.openMenu() })), this.show_reload_button && (h("at-reload-button", { key: '00dfc93cee28c29baf69e95a1e3e13ac72de6e42', slot: "reload-button", has_updates: this.has_updates, onAtuiReload: (event) => {
            ...
            } })), this.show_export_menu && (h("at-table-export-menu", { key: '2090578095f5004409bdc30fff053f0d520d563d', slot: "export-menu", show_csv: this.show_csv_export, show_pdf: this.show_pdf_export, onAtChange: (event) => this.handleExport(event) })), this.shouldShowColumnManager && (h("at-column-manager", { key: 'bb19a4dfd9f1b155eca14e493fff1663c1e87816', slot: "column-manager", col_defs: this.col_defs, onAtChange: (event) => this.handleColumnChange(event) })), h("div", { key: 'febe35c8ee60bc9a20a22499e991b2478025f070', slot: "leading-actions" }, h("slot", { key: '52a0b3797e46d5fa7c041e72a57d96a0a3e1cb1b', name: "leading-actions" })), h("div", { key: 'a2a083465b1e40b06494eb03032e8f16222d5bc1', slot: "actions" }, h("slot", { key: '468cfd7d057023ecbb511451c5554a22eee590fe', name: "actions" }))), this.renderSelectionBar(), h("div", { key: 'cc1efb45013ea38002efcf34e696e013ab9bd1eb', class: "relative" }, h("at-table", { key: 'ad30d2b1f880f3f0e0108d2ebd9976407ef9f013', ref: (el) => (this.tableEl = el), table_data: this.table_data, col_defs: this.gridColDefs, row_id_field: this.row_id_field, page_size: this.server_side_mode
                ? this.pageSize
                : this.page_size, use_custom_pagination: this.server_side_mode || this.use_custom_pagination, use_custom_sorting: this.server_side_mode, auto_size_columns: this.auto_size_columns, can_auto_init: false, onAtColumnVisibilityChange: (event) => this.syncColumnVisibility(event) }), this.server_side_mode && (h("div", { key: '30a524ab3f245b230c2c83bfd431a6200405df87', class: `loading-overlay bg-surface-foreground/80 absolute inset-0 z-10 items-center justify-center py-120 ${this.showLoadingOverlay ? 'is-visible' : ''}` }, h("div", { key: '416d04f57caa02ac450551b4811d67a1da456f88', class: "flex items-center" }, h("at-loading", { key: '54ceba8aa8a043687c5058f342b0812e2791424c', class: "relative mr-8", size: "sm", "data-name": "placeholder-spinner" }), h("span", { key: '152cc440e0f3a7d23cc0cd93711dc18ef62042d6', class: "text-secondary text-sm font-medium", "data-name": "placeholder-title" }, this.translations?.ATUI?.TABLE
            ?.LOADING_DATA)))), this.server_side_mode && (h("div", { key: 'b46d607a5288236ae1a0bd09c3167ab6ed6bfc9c', class: `no-data-overlay absolute inset-0 z-10 flex-col items-center justify-center gap-8 py-120 ${!this.is_loading && this.hasNoData ? 'is-visible' : ''}` }, h("at-icon", { key: 'd2164c5b5cc258e43706164995e1bf30af681b8c', class: "fill-slate-300", name: this.hasActiveSearch
                ? 'search'
                : 'data_table', size: "sm", "data-name": "no-data-icon" }), h("span", { key: '7ead1e8a02f57b2b699e1d483a6a370b87af1e41', class: "text-secondary text-sm font-medium", "data-name": "no-data-title" }, this.hasActiveSearch
            ? this.translations?.ATUI?.NO_RESULTS_FOUND
            : (this.no_data_message ??
                this.translations?.ATUI?.TABLE?.NO_DATA))))), this.server_side_mode && (h("at-table-pagination", { key: '71f751fd0e990755557f42b1871edf955d4b1ed7', current_page: this.currentPage, num_pages: this.totalPages, page_size: this.pageSize, page_size_options: this.page_size_options, onAtChange: (event) => this.handlePageChange(event), onAtPageSizeChange: (event) => this.handlePageSizeChange(event) }))));
    }
