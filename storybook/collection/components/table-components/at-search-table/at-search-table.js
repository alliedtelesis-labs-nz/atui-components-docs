...
export class AtSearchTable {
    ...
    render() {
        return (h(Host, { key: '8e88ca699f33b0fd65247b19b9ddbdea90caaec8', class: this.server_side_mode ? 'is-loading' : '' }, h("at-table-actions", { key: 'ec25a8c6f8a408b2de11fdd3f86e9ea6fbd94579', ag_grid: this.agGrid }, h("at-control-group", { key: '9f4764375b157ec96239645fc53de3a4a9fc9c15', slot: "search" }, this.shouldShowTableFilters && (h("at-table-filter-menu", { key: '2ff6f6c34a5cc325fe123366d548f3e0e60468e6', ref: (el) => (this.filterMenuEl =
                el), col_defs: this.col_defs, filters: this.selectedFilters, onAtChange: (event) => this.handleFilterChange(event) })), h("at-search", { key: '5881e2a90be78c9e5182adc2c5e12897444d7383', class: "w-input-md", info_text: this.searchInfoTooltip, placeholder: this.translations.ATUI.TABLE.SEARCH_BY_KEYWORD, onAtChange: (event) => this.handleSearchChange(event) })), h("div", { key: '8fd708bb3d085eae21af74a53e7d9a32b7935759', class: "contents", slot: "filter-bar" }, h("slot", { key: '8e967489530e8c00a51ce825c7a4e6754973b45b', name: "filter-bar" })), this.hasDisplayableFilters && (h("at-table-filters", { key: '1181f34c5063b94c12d63d6c37e98c5ae157e9b5', slot: "filters", filters: this.chipFilterTree(), onAtChange: (event) => this.handleFilterChange(event), onAtFilterClick: () => this.filterMenuEl?.openMenu() })), this.show_reload_button && (h("at-reload-button", { key: '959e2ac4594dd844a7a6c8310f9b5d68acb5c5be', slot: "reload-button", has_updates: this.has_updates, onAtuiReload: (event) => {
            ...
            } })), this.show_export_menu && (h("at-table-export-menu", { key: 'eee8c6ad6527740b62eba4210b22ee6aaf249213', slot: "export-menu", show_csv: this.show_csv_export, show_pdf: this.show_pdf_export, onAtChange: (event) => this.handleExport(event) })), this.shouldShowColumnManager && (h("at-column-manager", { key: 'f18fd65547529fe0cb8222b966fdddc242415761', slot: "column-manager", col_defs: this.col_defs, onAtChange: (event) => this.handleColumnChange(event) })), h("div", { key: '0cd1390262cce292a2e717e7580eaf776975af78', slot: "leading-actions" }, h("slot", { key: 'b70a6bb4b712bfc119c00f9fa1c4c537e494a80c', name: "leading-actions" })), h("div", { key: '64b128cb41d85844f71deb9040108e700343c140', slot: "actions" }, h("slot", { key: '420756b5db217787adeef35bc4854cdfae041529', name: "actions" }))), this.renderSelectionBar(), h("div", { key: 'e41ec04d64f0ffe4f85cf95c7e33be279b7c7aa0', class: "relative" }, h("at-table", { key: 'c18aaf732e5f620f9ac6e4da850495e82944c8c5', ref: (el) => (this.tableEl = el), table_data: this.table_data, col_defs: this.gridColDefs, row_id_field: this.row_id_field, page_size: this.server_side_mode
                ? this.pageSize
                : this.page_size, use_custom_pagination: this.server_side_mode || this.use_custom_pagination, use_custom_sorting: this.server_side_mode, auto_size_columns: this.auto_size_columns, can_auto_init: false, onAtColumnVisibilityChange: (event) => this.syncColumnVisibility(event) }), this.server_side_mode && (h("div", { key: 'f7c95b010e839672225a2b9ebec2d5bd8aa51f54', class: `loading-overlay bg-surface-foreground/80 absolute inset-0 z-10 items-center justify-center py-120 ${this.showLoadingOverlay ? 'is-visible' : ''}` }, h("div", { key: 'f697c258d738070682ac4145932e19e2a009994c', class: "flex items-center" }, h("at-loading", { key: 'ce4fa373423d29c59860aaf48c8f7504e29154b5', class: "relative mr-8", size: "sm", "data-name": "placeholder-spinner" }), h("span", { key: '89a0dfb70408c71cda245f14b9fe5ef9bb699e53', class: "text-secondary text-sm font-medium", "data-name": "placeholder-title" }, this.translations?.ATUI?.TABLE
            ?.LOADING_DATA)))), this.server_side_mode && (h("div", { key: '3774c699cbff71c0dfe7b164b83f4a176372c4fd', class: `no-data-overlay absolute inset-0 z-10 flex-col items-center justify-center gap-8 py-120 ${!this.is_loading && this.hasNoData ? 'is-visible' : ''}` }, h("at-icon", { key: '48b3a0bdce534a43af997f2f78ac062d763e2a29', class: "fill-slate-300", name: this.hasActiveSearch
                ? 'search'
                : 'data_table', size: "sm", "data-name": "no-data-icon" }), h("span", { key: 'd116335301ac684669027acbb326b64134f2b6e5', class: "text-secondary text-sm font-medium", "data-name": "no-data-title" }, this.hasActiveSearch
            ? this.translations?.ATUI?.NO_RESULTS_FOUND
            : (this.no_data_message ??
                this.translations?.ATUI?.TABLE?.NO_DATA))))), this.server_side_mode && (h("at-table-pagination", { key: '2813aaa6cac6253ab9f608f803b184635472296a', current_page: this.currentPage, num_pages: this.totalPages, page_size: this.pageSize, page_size_options: this.page_size_options, onAtChange: (event) => this.handlePageChange(event), onAtPageSizeChange: (event) => this.handlePageSizeChange(event) }))));
    }
