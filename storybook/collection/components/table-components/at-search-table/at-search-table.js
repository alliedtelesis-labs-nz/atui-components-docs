...
export class AtSearchTable {
    ...
    render() {
        return (h(Host, { key: '0957a1655c174feff10ca113d82200ddaec65f07' }, h("at-table-actions", { key: '2635b11d72f907db8003740a41cb2b3990588af7', ag_grid: this.agGrid }, h("div", { key: '9664f79df276836e71ef4014e3bcb4b86ecec5b1', class: "flex items-center gap-8 px-8", slot: "search" }, this.shouldShowDropdownFilters && (h("at-table-filter-menu", { key: 'dec8b5e133556b63e49ab557caf856e63c34cd87', slot: "filter-menu", col_defs: this.col_defs, selected: this.menuSelectedIds, onAtChange: (event) => this.handleFilterChange(event) })), h("at-search", { key: '23df43be0a39ebf4272a945ee9a8d0beae5ec24e', class: "w-input-md", label: this.search_label, hint_text: this.search_hint, info_text: this.search_info_tooltip, placeholder: this.translations.ATUI.TABLE.SEARCH_BY_KEYWORD, onAtChange: (event) => this.handleSearchChange(event) })), this.shouldShowDropdownFilters && (h("at-table-filters", { key: '51f6646ddd7d9deb29d530f9176fabc8936c9739', slot: "filters", col_defs: this.col_defs, selected: this.selectedFilters, onAtChange: (event) => this.handleFilterChange(event) })), !this.hide_export_menu && (h("at-table-export-menu", { key: '7612215852d08f220a555b4168c51c68dec8b29b', slot: "export-menu", hide_csv: this.hide_csv_export, hide_pdf: this.hide_pdf_export, onAtChange: (event) => this.handleExport(event) })), this.shouldShowColumnManager && (h("at-column-manager", { key: 'd9886c3de8d8ff8dadc40658dd7739b64cef4fb4', slot: "column-manager", col_defs: this.col_defs, onAtChange: (event) => this.handleColumnChange(event) })), h("div", { key: 'd5e94652552aff95732334c9f8291de935511356', slot: "actions" }, h("slot", { key: '4cba71166b967ce794b4461aafca31c061cab09b', name: "actions" }))), h("slot", { key: 'd74feba39532ba3e3015acb6b7ef9bf92a812a7b', name: "multi-select-actions" }), this.loading && this.server_side_mode ? (h("at-placeholder", { size: "lg", placeholder_title: this.translations?.ATUI?.TABLE?.LOADING_DATA, show_loading_spinner: true })) : (h("at-table", { ref: (el) => (this.tableEl = el), table_data: this.table_data, col_defs: this.col_defs, page_size: this.server_side_mode
                ? this.pageSize
                : this.page_size, use_custom_pagination: this.server_side_mode, auto_size_columns: this.auto_size_columns, disable_auto_init: !this.server_side_mode })), this.server_side_mode && (h("at-table-pagination", { key: 'e100079cc04d514ae69c882ed2f96a78f732e657', current_page: this.currentPage, num_pages: this.totalPages, onAtChange: (event) => this.handlePageChange(event), onAtPageSizeChange: (event) => this.handlePageSizeChange(event) }))));
    }
