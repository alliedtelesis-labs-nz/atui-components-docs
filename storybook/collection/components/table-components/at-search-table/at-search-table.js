...
export class AtSearchTable {
    ...
    render() {
        return (h(Host, { key: 'eadb8c065b8456c6354a79aacd7ddce60f005d0f', class: this.server_side_mode ? 'is-loading' : '' }, h("at-table-actions", { key: '40734717b5795d39fc23508cd7fa942d8f0d6ee7', ag_grid: this.agGrid }, h("at-control-group", { key: 'f672bf843acafb0a9d52b59f824df885f202aa0c', slot: "search" }, this.shouldShowTableFilters &&
            !this.search_filters && (h("at-table-filter-menu", { key: '9bcaf06bc90b76d0618e92592e701a4ebf1ca015', ref: (el) => (this.filterMenuEl =
                el), col_defs: this.col_defs, filters: this.selectedFilters, onAtChange: (event) => this.handleFilterChange(event) })), h("at-search", { key: '98476e684498b3587808756dbeda8476aaed4347', class: "w-input-md", info_text: this.search_info_tooltip, placeholder: this.translations.ATUI.TABLE.SEARCH_BY_KEYWORD, onAtChange: (event) => this.handleSearchChange(event) })), this.shouldShowTableFilters && (h("at-table-filters", { key: 'd0c7e71aa0f2331bd949027df95ffe183a15b487', slot: "filters", filters: this.selectedFilters, onAtChange: (event) => this.handleFilterChange(event), onAtFilterClick: () => this.filterMenuEl?.openMenu() })), !this.hide_export_menu && (h("at-table-export-menu", { key: 'ddc48b381a8d3ec2204f1dc9e0e9071eaeed9985', slot: "export-menu", hide_csv: this.hide_csv_export, hide_pdf: this.hide_pdf_export, onAtChange: (event) => this.handleExport(event) })), this.shouldShowColumnManager && (h("at-column-manager", { key: 'bacaa24108da4a5314ce7c9d680f97de8c48d3e7', slot: "column-manager", col_defs: this.col_defs, onAtChange: (event) => this.handleColumnChange(event) })), h("div", { key: 'e037b6ba86ceb47f6b398ebe66af568753780b0c', slot: "leading-actions" }, h("slot", { key: '615acad91c7635ea42ef2aeb68461c27173edca4', name: "leading-actions" })), h("div", { key: 'cbcfc251cf53fb20e22db85e0f787717d7c3f962', slot: "actions" }, h("slot", { key: '5667f00f6122b48b5117693f999940cab2a0fcfd', name: "actions" }))), h("slot", { key: '2ff320c1ad0c7052d4514f137da4c471d0a118f3', name: "multi-select-actions" }), h("div", { key: 'f009d8173e459eacb4a8952e671c55031b1b4cdb', class: "relative" }, h("at-table", { key: 'b2712aa29e4767f10cca8440bc4c5755e45b67a7', ref: (el) => (this.tableEl = el), table_data: this.table_data, col_defs: this.col_defs, page_size: this.server_side_mode
                ? this.pageSize
                : this.page_size, use_custom_pagination: this.server_side_mode || this.use_custom_pagination, use_custom_sorting: this.server_side_mode, auto_size_columns: this.auto_size_columns, disable_auto_init: !this.server_side_mode }), this.server_side_mode && (h("div", { key: '06c9d810507430846e7599f021e9c7c0b3ba0332', class: `loading-overlay bg-surface-foreground/80 absolute inset-0 z-10 items-center justify-center py-120 ${this.showLoadingOverlay ? 'is-visible' : ''}` }, h("div", { key: 'a4b58c32950be384ec4ce71a204a701dc96cb74c', class: "flex items-center" }, h("at-loading", { key: '3c5702d881317ca1bc3d8231524dbe3406d24930', class: "relative mr-8", size: "sm", "data-name": "placeholder-spinner" }), h("span", { key: '15842fb8e46093a60073ca806931e2d4c0bf5e61', class: "text-secondary text-sm font-medium", "data-name": "placeholder-title" }, this.translations?.ATUI?.TABLE
            ?.LOADING_DATA)))), this.server_side_mode && (h("div", { key: '5f6d1caf75423b2c2dfe6e388e7cce5d26630617', class: `no-data-overlay absolute inset-0 z-10 flex-col items-center justify-center gap-8 py-120 ${!this.loading && this.hasNoData ? 'is-visible' : ''}` }, h("at-icon", { key: 'f95b52cd25ee84a75f4599f7a6c7fc80aa709192', class: "fill-slate-300", name: this.hasActiveSearch
                ? 'search'
                : 'data_table', size: "sm", "data-name": "no-data-icon" }), h("span", { key: '7c0dccc9aa95cf134b934ea9791e37cf37ddeb48', class: "text-secondary text-sm font-medium", "data-name": "no-data-title" }, this.hasActiveSearch
            ? this.translations?.ATUI?.NO_RESULTS_FOUND
            : (this.no_data_message ??
                this.translations?.ATUI?.TABLE?.NO_DATA))))), this.server_side_mode && (h("at-table-pagination", { key: '75dde1de7847d0f6772e253907588cb1ded27c54', current_page: this.currentPage, num_pages: this.totalPages, page_size: this.pageSize, page_size_options: this.page_size_options, onAtChange: (event) => this.handlePageChange(event), onAtPageSizeChange: (event) => this.handlePageSizeChange(event) }))));
    }
