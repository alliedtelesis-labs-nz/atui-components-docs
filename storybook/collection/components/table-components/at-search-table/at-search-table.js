...
export class AtSearchTable {
    ...
    render() {
        return (h(Host, { key: '1e9863b34bb5f2fb12ac9849bb00c539b53fb142', class: this.server_side_mode ? 'is-loading' : '' }, h("at-table-actions", { key: '6f97e756760a46d4f6f4af9d69e38f76a9459942', ag_grid: this.agGrid }, h("at-control-group", { key: 'def6a3ae289fa2ef8f2ab694ee4e944823c7c234', slot: "search" }, this.shouldShowTableFilters && (h("at-table-filter-menu", { key: 'e4d2532dd373923f4eb52d6308293f2ff43d127b', ref: (el) => (this.filterMenuEl =
                el), col_defs: this.col_defs, filters: this.selectedFilters, onAtChange: (event) => this.handleFilterChange(event) })), h("at-search", { key: '4a1163fb57e05b3b7f9ed9b66c4618adaab996f1', class: "w-input-md", info_text: this.searchInfoTooltip, placeholder: this.translations.ATUI.TABLE.SEARCH_BY_KEYWORD, onAtChange: (event) => this.handleSearchChange(event) })), h("div", { key: '8a65bfe4c0626d9b86bba03198a0272dda8a699a', class: "contents", slot: "filter-bar" }, h("slot", { key: 'cd9b3d3b453a07b7582397c81003acc321c94fdf', name: "filter-bar" })), this.hasDisplayableFilters && (h("at-table-filters", { key: 'e911d2f2da513a4420978eb2351bce9ff4d52172', slot: "filters", filters: this.chipFilterTree(), onAtChange: (event) => this.handleFilterChange(event), onAtFilterClick: () => this.filterMenuEl?.openMenu() })), this.show_reload_button && (h("at-reload-button", { key: '291eeadb4af844b3a2a6517fe0e2b861c6f5bb56', slot: "reload-button", has_updates: this.has_updates, onAtuiReload: (event) => {
            ...
            } })), this.show_export_menu && (h("at-table-export-menu", { key: '323ccee4f06688ba0cc0eceec01ce9338700cd4d', slot: "export-menu", show_csv: this.show_csv_export, show_pdf: this.show_pdf_export, onAtChange: (event) => this.handleExport(event) })), this.shouldShowColumnManager && (h("at-column-manager", { key: 'f69a1cdde9263066da170b9d0bbecf83bbc08585', slot: "column-manager", col_defs: this.col_defs, onAtChange: (event) => this.handleColumnChange(event) })), h("div", { key: '113801d33f300bf8bdc0bd74d21d57622182a516', slot: "leading-actions" }, h("slot", { key: '95d83f1eec7ab05d25db9d95d4c174431212d9b4', name: "leading-actions" })), h("div", { key: 'c1ffa365139ef5a4631371726382d9bda752d471', slot: "actions" }, h("slot", { key: '6bc6fcb430c44f5eca3505d0bb6302c601662875', name: "actions" }))), this.renderSelectionBar(), h("div", { key: '2cba7756004c8ecf6d46d003b0032c08d8c02ae3', class: "relative" }, h("at-table", { key: '6403e6bb22aeeb712d6058b7f3229d8231235d06', ref: (el) => (this.tableEl = el), table_data: this.table_data, col_defs: this.gridColDefs, row_id_field: this.row_id_field, page_size: this.server_side_mode
                ? this.pageSize
                : this.page_size, use_custom_pagination: this.server_side_mode || this.use_custom_pagination, use_custom_sorting: this.server_side_mode, auto_size_columns: this.auto_size_columns, can_auto_init: false, onAtColumnVisibilityChange: (event) => this.syncColumnVisibility(event) }), this.server_side_mode && (h("div", { key: 'f42b3a74c5dc1ad52a8f53755de1a32f10cc6fa4', class: `loading-overlay bg-surface-foreground/80 absolute inset-0 z-10 items-center justify-center py-120 ${this.showLoadingOverlay ? 'is-visible' : ''}` }, h("div", { key: 'ca838a36fe861af49869d473e2de6fcd4ca9d9ea', class: "flex items-center" }, h("at-loading", { key: 'db6e7b203ae8e353b84ecc931827cd9a799fc25b', class: "relative mr-8", size: "sm", "data-name": "placeholder-spinner" }), h("span", { key: '3d617e5012ec672e7967f3022fbaea318afb84ac', class: "text-secondary text-sm font-medium", "data-name": "placeholder-title" }, this.translations?.ATUI?.TABLE
            ?.LOADING_DATA)))), this.server_side_mode && (h("div", { key: '96ea24a24ca52760bdeb42e5b7505ba78ad3d6dd', class: `no-data-overlay absolute inset-0 z-10 flex-col items-center justify-center gap-8 py-120 ${!this.is_loading && this.hasNoData ? 'is-visible' : ''}` }, h("at-icon", { key: '6a69a1636637532573db3a7c3b16d116da5f629c', class: "fill-slate-300", name: this.hasActiveSearch
                ? 'search'
                : 'data_table', size: "sm", "data-name": "no-data-icon" }), h("span", { key: 'ee2cb2576de2051f16f8e564572a53d180feffe2', class: "text-secondary text-sm font-medium", "data-name": "no-data-title" }, this.hasActiveSearch
            ? this.translations?.ATUI?.NO_RESULTS_FOUND
            : (this.no_data_message ??
                this.translations?.ATUI?.TABLE?.NO_DATA))))), this.server_side_mode && (h("at-table-pagination", { key: '9fc5633fa583ead82107a7e527abf39ebfd04038', current_page: this.currentPage, num_pages: this.totalPages, page_size: this.pageSize, page_size_options: this.page_size_options, onAtChange: (event) => this.handlePageChange(event), onAtPageSizeChange: (event) => this.handlePageSizeChange(event) }))));
    }
