...
export class AtSidebarMenuitemComponent {
    ...
    render() {
        return (h(Host, { key: '6f186ddfd9ff2f2d07026f48bd252335f08e47f6', role: this.is_trigger ? 'presentation' : 'menuitem', "data-state": this.is_active ? 'active' : 'inactive', tabIndex: this.is_trigger ? undefined : 0, onKeyDown: this.is_trigger
                ? undefined
                : (event) => this.handleKeyDown(event), onClick: (event) => this.handleClick(event), "aria-current": this.is_active ? 'page' : undefined }, h("div", { key: '8517f7a369f0cae3688fd968585d2968ad75cf94', class: "content", "data-name": "content" }, h("slot", { key: 'a8d0bf8c72a8ba43184739c0ea47855e8cb679d2', name: "icon", "data-name": "icon" }), this.icon && this.renderIcon(), h("slot", { key: '726a11709e40f05b50c815e6bc0f52940406069c', name: "label", "data-name": "label" }), this.label && (h("span", { key: '9aba5f1def5d7a72e68670e64f1019c891d11f75', "data-name": "sidebar-menu-item-label", class: "label" }, this.label)), this.badge && (h("at-badge", { key: '449a6022b8054df2bac9c99fdc921a33d3d12c5b', class: "badge", "data-name": "sidebar-menu-item-badge", role: "presentation", type: "error", impact: "high", rounded: false, label: this.badge }))), h("slot", { key: '681a19836ce97d374bfa5acc32e6f817e4101a6d', name: "sidebar-menu-item-actions" })));
    }
