...
export class AtSidebarComponent {
    ...
    render() {
        ...
        return (h(Host, { key: 'b301d76c232bcbd79faa7dc426dae9593055379f', "data-state": this.isOpen ? 'expanded' : 'collapsed', "data-side": this.side, class: `mode-${this.mode} side-${this.side} collapse-${this.collapsible}` }, isModalOverlay && (h("div", { key: 'cf07658c97050bd4020275bbb4863c0a5d889056', class: "backdrop", "data-name": "backdrop", onClick: this.handleBackdropClick, "aria-hidden": "true" })), h("nav", { key: '0a4d84caa56c605bec89e8bf646016d6de67bdf4', "data-name": "sidebar", "data-open": this.isOpen, class: `sidebar collapse-${this.collapsible} w-${this.width}`, "aria-hidden": !this.isOpen && this.collapsible === 'offcanvas'
                ? 'true'
                : 'false', role: "navigation", "aria-label": "Sidebar navigation" }, h("div", { key: 'add39c1405ff60bd6d17d4e9897e88ee2361d574', class: "sidebar-header", "data-name": "sidebar-header" }, h("slot", { key: '3ee5d3963f35f576bed09677b1e356f1fd371b41', name: "sidebar-header" })), h("div", { key: 'c52a5d5022fd03356d5d0f35cf75492a866d9018', class: "sidebar-content", "data-name": "sidebar-content" }, h("slot", { key: '1c34d0c6c2ecbab7ef374abeed23f3eff434c881', name: "sidebar-content" })), h("div", { key: '04837a91a8961d19ca56301330a6ad4a8221a8d1', class: `sidebar-footer`, "data-name": "sidebar-footer" }, h("slot", { key: 'baa3832e26c1b969e376d040cef662166450b5fd', name: "sidebar-footer" }))), h("div", { key: '1b83b2f4678d1335fb376121c4d70afd2120db0d', class: "page-content", "data-name": "page-content", "aria-hidden": isModalOverlay ? 'true' : 'false', inert: isModalOverlay }, h("slot", { key: '12b6dc79878796486c5af70146fc2e7f8acb3d20', name: "page-content" }))));
    }
