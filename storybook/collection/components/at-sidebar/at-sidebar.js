...
export class AtSidebarComponent {
    ...
    render() {
        ...
        return (h(Host, { key: '6a1b8828c28b1af4449665244363678232c570b1', "data-state": this.isOpen ? 'expanded' : 'collapsed', "data-side": this.side, class: `mode-${this.mode} side-${this.side} collapse-${this.collapsible}` }, isModalOverlay && (h("div", { key: 'd6cf42d4f4adecf0301365142d68600169aa03c2', class: "backdrop", "data-name": "backdrop", onClick: this.handleBackdropClick, "aria-hidden": "true" })), h("nav", { key: 'eb7c3470a607ee1ec13acf52274eb558f0b2513d', "data-name": "sidebar", "data-open": this.isOpen, class: `sidebar collapse-${this.collapsible} w-${this.width}`, "aria-hidden": !this.isOpen && this.collapsible === 'offcanvas'
                ? 'true'
                : 'false', role: "navigation", "aria-label": "Sidebar navigation" }, h("div", { key: 'f3be517cb30bbde45185ae4057c220a0cd82fccd', class: "sidebar-header", "data-name": "sidebar-header" }, h("slot", { key: '856e759f009ec78337be53c824cbd1eae851686b', name: "sidebar-header" })), h("div", { key: '5fb03e61ea45087f2fac380e8018a0f5aa2cf47b', class: "sidebar-content", "data-name": "sidebar-content" }, h("slot", { key: '1ee3d783f4650d2a3404aa82f0d997d0fc1150bb', name: "sidebar-content" })), h("div", { key: '28a026403656e27644fc22db1de6f96ae0dd371a', class: `sidebar-footer`, "data-name": "sidebar-footer" }, h("slot", { key: 'bfa6af4a49ef5fe4f229850b916039c68d289912', name: "sidebar-footer" }))), h("div", { key: '9b2ecb38aeb6c2d6974ec154508021c458d1eb51', class: "page-content", "data-name": "page-content", "aria-hidden": isModalOverlay ? 'true' : 'false', inert: isModalOverlay }, h("slot", { key: 'd5c5720b192ab32ea7345ca040eb3b4c7c0d3f11', name: "page-content" }))));
    }
