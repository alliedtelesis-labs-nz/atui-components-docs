...
export class AtCheckbox {
    ...
    render() {
        ...
        return (h(Host, { key: 'bf692b4f8292cdd30de6513340954b3314b1aee1', role: "checkbox", "aria-checked": this.checked, "aria-labelledby": `${this.value}-label`, tabindex: 0, class: classname, "data-name": "checkbox-container", onKeyDown: (event) => (event.key === 'Enter' || event.key === ' ') &&
                this.checkboxEl.click(), onClick: () => this.checkboxEl.click() }, h("input", { key: '8f48ee1d74d9dddc1bb2740cb4c9273fd95ac4fa', type: "checkbox", class: checkboxClassname, "data-name": "checkbox-input", checked: this.checked, onChange: (event) => this.handleChange(event), id: this.value, tabindex: -1, ref: (el) => (this.checkboxEl = el), disabled: this.disabled }), (this.label || this.hint_text) && (h("div", { key: 'dc4569bc71ae3f8691f17a826a4e3a652821f7ba', class: "pointer-events-none flex flex-col" }, h("slot", { key: 'c2e4d005915ecc33a661eafe9ac1d2aac5f4d142', name: "label" }), this.label && (h("label", { key: 'f7dff8dc865b845d90391c450fd6d218dca4ecd6', class: "mt-0 pl-4 text-xs font-medium", id: `${this.value}-label`, "data-name": "checkbox-label" }, this.label)), this.hint_text && (h("span", { key: '33482d37dad8a3ac38ae436cae219bc208cc4b0b', class: "text-muted mt-0 pl-4 text-xs", "data-name": "checkbox-hint" }, this.hint_text)))), h("slot", { key: 'e950425f7cdf42bac0003e576fbc2858822b4aac' })));
    }
