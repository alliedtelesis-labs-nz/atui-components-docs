...
export class AtCheckbox {
    ...
    render() {
        ...
        return (h(Host, { key: 'b851f056c21df0f47a1a271d2f531fa9b6565810', role: "checkbox", "aria-checked": this.checked, "aria-labelledby": `${this.value}-label`, tabindex: 0, class: classname, "data-name": "checkbox-container", onKeyDown: (event) => (event.key === 'Enter' || event.key === ' ') &&
                this.checkboxEl.click(), onClick: () => this.checkboxEl.click() }, h("input", { key: '5b224dcb5a6cc474f075391d6d7c22263eabab43', type: "checkbox", class: checkboxClassname, "data-name": "checkbox-input", checked: this.checked, onChange: (event) => this.handleChange(event), id: this.value, tabindex: -1, ref: (el) => (this.checkboxEl = el), disabled: this.disabled }), (this.label || this.hint_text) && (h("div", { key: 'fe5cd1652403fe61ab75106458b4ac8422132403', class: "pointer-events-none flex flex-col" }, h("slot", { key: '98a1b352c8af3736b74775201c21f6337f96cc23', name: "label" }), this.label && (h("label", { key: 'b591c43ee5322d3c658909c2b37a2c7b5eb8a6dd', class: "mt-0 pl-4 text-xs font-medium", id: `${this.value}-label`, "data-name": "checkbox-label" }, this.label)), this.hint_text && (h("span", { key: '2a7111adbf89e3c73de909c59b708b325a7a0c09', class: "text-muted mt-0 pl-4 text-xs", "data-name": "checkbox-hint" }, this.hint_text)))), h("slot", { key: 'f908ff858dd8644053e0560bb8cd1f29db39650c' })));
    }
