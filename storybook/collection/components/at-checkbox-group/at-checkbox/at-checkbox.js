...
export class AtCheckbox {
    ...
    render() {
        ...
        return (h(Host, { key: '48bd347514b5c0d27e7ce3c636d671d62ca339de', role: "checkbox", "aria-checked": this.checked, "aria-labelledby": `${this.value}-label`, tabindex: 0, class: classname, "data-name": "checkbox-container", onKeyDown: (event) => (event.key === 'Enter' || event.key === ' ') &&
                this.checkboxEl.click(), onClick: () => this.checkboxEl.click() }, h("input", { key: 'bec86394e955b49306efe108aff34c3275d2c9bd', type: "checkbox", class: checkboxClassname, "data-name": "checkbox-input", checked: this.checked, onChange: (event) => this.handleChange(event), id: this.value, tabindex: -1, ref: (el) => (this.checkboxEl = el), disabled: this.disabled }), (this.label || this.hint_text) && (h("div", { key: 'dba53e5266b0d3e717e37b1da7e85d134d02af14', class: "pointer-events-none flex flex-col" }, h("slot", { key: '0d5ba00cbc13961c18b3ebd8d2a349b06cfced14', name: "label" }), this.label && (h("label", { key: 'eec6025a18b723b2647360f5e8fd36864cc8efbd', class: "mt-0 pl-4 text-xs font-medium", id: `${this.value}-label`, "data-name": "checkbox-label" }, this.label)), this.hint_text && (h("span", { key: '66ac3af758a572ef6af576cc2acbaab486e871db', class: "text-muted mt-0 pl-4 text-xs", "data-name": "checkbox-hint" }, this.hint_text)))), h("slot", { key: 'd95f2db3f37b3d3e7e804d61dd7fe46cf647183b' })));
    }
