...
export class AtCheckbox {
    ...
    render() {
        ...
        return (h(Host, { key: '7382c7272251af484dcc5333d64f5c4801b79191', role: "checkbox", "aria-checked": this.checked, "aria-labelledby": `${this.value}-label`, tabindex: 0, class: classname, "data-name": "checkbox-container", onKeyDown: (event) => (event.key === 'Enter' || event.key === ' ') &&
                this.checkboxEl.click(), onClick: () => this.checkboxEl.click() }, h("input", { key: 'bc28abc08fa0d16d651bbb571b1fb999dbe97b41', type: "checkbox", class: checkboxClassname, "data-name": "checkbox-input", checked: this.checked, onChange: (event) => this.handleChange(event), id: this.value, tabindex: -1, ref: (el) => (this.checkboxEl = el), disabled: this.disabled }), (this.label || this.hint_text) && (h("div", { key: '00465bae55aba4dadef4b39777b88997f22aa8b0', class: "pointer-events-none flex flex-col" }, h("slot", { key: 'fc92bde129c1a8fe92622bed70f5c2115bc5876e', name: "label" }), this.label && (h("label", { key: '548a289677e825a91434cdb3dd10d145968e6559', class: "mt-0 pl-4 text-xs font-medium", id: `${this.value}-label`, "data-name": "checkbox-label" }, this.label)), this.hint_text && (h("span", { key: 'd41f872388f02e965d5147e07f03a54a881ca13c', class: "text-light mt-0 pl-4 text-xs", "data-name": "checkbox-hint" }, this.hint_text)))), h("slot", { key: '9ba7d35c1068feb9eb70b13a77cab724458d8bdd' })));
    }
