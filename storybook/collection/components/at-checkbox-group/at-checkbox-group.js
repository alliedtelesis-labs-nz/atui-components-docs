...
export class AtCheckboxGroup {
    ...
    render() {
        ...
        return (h(Host, { key: '1a6c4fcde2b0e535cb7c4a16f4c8a9644e511f5c', role: "group", "aria-label": this.label, "aria-description": this.info_text, class: "flex w-full flex-col" }, h("div", { key: 'f06ef612b024a55f57a971dba1e88c38cbf695bd', class: "mb-4 flex flex-col empty:hidden" }, h("slot", { key: '653089886bfcc435f3054eecad8f9e62f6742039', name: "label" }), (this.label || this.required || this.info_text) && (h("at-form-label", { key: '49e24abde07308c15ac3f4698edc71d961777da3', label: this.label, required: this.required, info_text: this.info_text })), this.hint_text && (h("span", { key: '4948f0c2334cf371c794ffebe0aea8c8e43bcd2a', class: "text-muted inline-block text-xs leading-tight", "data-name": "checkbox-group-hint" }, this.hint_text))), h("ul", { key: '12755fa48d2ebfaca655c1d77eaa734447e4e885', class: classname, "data-name": "checkbox-group-options" }, h("slot", { key: '712e5b172769bf188a6554e0326e25c5ce030a94' }), this.getCheckBoxes &&
            this.getCheckBoxes.map((checkbox) => (h("li", { class: "flex" }, checkbox)))), this.error_text && this.invalid && (h("span", { key: '174502eea9a92438afe98f28c3071cfd297d3086', class: "text-error text-sm", "data-name": "checkbox-group-error-text" }, this.error_text))));
    }
