...
export class AtListItem {
    ...
    render() {
        return (h(Host, { key: '0bab05a1109172508a20b44a62da93d0c5f76de1', role: "listitem", tabIndex: this.selectable ? 0 : undefined, class: `${this.sizeClasses} ${this.selectable ? 'hover:bg-surface-1 cursor-pointer' : ''} border-muted flex items-center gap-3 border-b`, "data-name": "list-item" }, h("div", { key: '7c5c801402478622862ff4a0119eed2efad68924', class: "flex flex-grow flex-col", "data-name": "list-item-details" }, h("div", { key: 'a9d2bb024daa24d920695e9e6d3db2799bf8fe62', class: "flex items-center justify-start gap-8 whitespace-nowrap" }, h("span", { key: 'c0c6993db37fc9271f84214327fa7b20536ca269' }, h("slot", { key: '63c3c02f73af8bbf7e405ba192eddd7167df0091', name: "icon" })), this.item_prefix && (h("span", { key: '8839d8aea04b4d4ff5a71c2eb70f08fb75c5330a', class: "text-secondary mr-[4px] font-normal", "data-name": "prefix" }, this.item_prefix)), h("span", { key: 'ade191c2eeb5c1bb4ac82cd577ea7e887629bd24', class: `flex flex-grow truncate pr-8 font-medium ${this.item_prefix && this.subtitle ? 'flex flex-col' : ''}` }, h("span", { key: '61882d054cac19801c2d898b8e1e34f5efd79e8c', class: "flex flex-row font-normal" }, h("span", { key: 'ee591113b1c87421b5d61718f428798d984416f9', class: "mr-4", "data-name": "title" }, this.item_title), h("slot", { key: '356f64279b522b07cd7a70433241a49066d90fd5', name: "title" })), this.subtitle && (h("span", { key: 'b934ee7ba4d7f0fc84f6eb9e907477b3998fd95d', class: "text-secondary inline text-sm font-normal", "data-name": "subtitle" }, this.subtitle))))), h("div", { key: 'e1634cba94d4b58f09d18702c0a5654fdcecc188', class: "flex flex-wrap items-end justify-end gap-8 text-right", "data-name": "list-item-content" }, h("slot", { key: '77b32de0f7ad22aa5bf357f1bbd3cfef223b32f7' }), this.content && (h("span", { key: '426329b5067e092d955858b575b5b9dca5b5dcbe', "data-name": "content" }, this.content)))));
    }
