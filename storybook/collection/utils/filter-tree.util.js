...
export function flattenFilterConditions(node) {
...
export function everyConditionValid(node) {
    if (!isFilterGroup(node)) {
 ...
 */
export function flattenSingleChildAndRemoveEmptyGroups(group) {
 ...
 */
export function flattenSingleChildGroup(group) {
 ...
 */
export function removeFilterCondition(root, condition) {
 ...
 */
export function rowMatchesFilterGroup(group, getFieldValue) {
