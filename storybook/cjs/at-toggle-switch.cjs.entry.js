...
const AtToggleSwitchComponent = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '3d0bc9865827b9519bd62ee3ea716f7fe847ad8f', id: `${this.toggleId}-host`, role: "switch", "aria-labelledby": `${this.toggleId}-label`, class: classname, tabIndex: 0, onClick: () => this.inputEl.click(), onKeyDown: (event) => {
                if (event.key === ' ' || event.key === 'Enter') {
                    event.preventDefault();
                    this.inputEl.click();
                }
            } }, index.h("div", { key: 'b99048c2a506f1db470efa85e09fc68cf65592fa', class: "flex flex-col" }, index.h("slot", { key: 'b75864cd0ecdee237598d73d211118ad6e69e061', name: "label" }), !!this.label && this.show_label && (index.h("at-form-label", { key: 'df1bda9643845b979b39935a5a153296b053577b', label: this.label, class: "pointer-events-none select-none", for: this.toggleId, id: `${this.toggleId}-label`, "data-name": "switch-label" })), this.hint_text && (index.h("span", { key: '4e777f72c3241c13e675972f9fe36b4babad6fba', class: "text-light inline-block text-xs leading-tight", "data-name": "select-hint" }, this.hint_text))), index.h("div", { key: 'b3497b83c34ea83ce17ab1562af3181d13d8b4fd', class: "relative flex h-20 w-40" }, index.h("input", { key: '784cbf6fb48d1a8e95ace6b35af3cc291aaaa226', id: this.toggleId, class: "h-0 w-0 opacity-0", disabled: this.disabled, type: "checkbox", checked: this.value, tabIndex: -1, onChange: (e) => this.onToggle(e.target.checked), ref: (el) => (this.inputEl = el), "data-name": "switch-input" }), index.h("span", { key: '0154eb48e1cdedef1afb12f32bc517c4be2b5773', class: trackClassname }, index.h("span", { key: '142c7c05222d50d5a521b9e00a75e25a0fadf808', class: thumbClassname }, this.value ? 'check' : 'remove')))));
    }
};
