...
function getChartColors(palette) {
    ...
    return chartColor.readPaletteColors(palette);
}
const DARKEN = 0.7;
const LIGHTEN = 0.75;
const SATURATE = 0.1;
...
function resolveSeriesColors(colors, count, palette) {
    ...
    if (palette !== chartColor.AtChartColorPalette.CATEGORICAL || count <= base.length) {
...
exports.resolveSeriesColors = resolveSeriesColors;
