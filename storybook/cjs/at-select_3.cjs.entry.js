...
const AtSelectComponent = class {
    ...
    renderInput() {
        const getClassname = classlist.classlist(`transition-[color,background-color,border-color,box-shadow,fill] duration-150 ease-in-out placeholder-text-muted group/select:focus-within:ring w-full cursor-pointer rounded-input border border-solid h-input min-h-input py-input-y px-input-x text-ellipsis outline-0 select-none focus:ring focus:z-10`, inputVariantsConfig);
...
const AtSelectOptionComponent = class {
    ...
    render() {
        const getOptionClassname = classlist.classlist('transition-[color,background-color,border-color,box-shadow,fill] duration-150 ease-in-out text-body focus:ring-active-glow flex w-full min-w-0 items-center rounded-menu-item p-8 font-normal focus:ring focus:outline-0 focus:ring-inset gap-4', optionVariantsConfig);
