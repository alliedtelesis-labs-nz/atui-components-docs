...
const AtSelectComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: '184cfa79bbb3128cd1401e38e14a0dad37e3df99', class: "group/select", onFocusout: async (event) => {
            ...
            } }, this.renderLabel(), index.h("at-menu", { key: 'c29e078d1a43a3b5c1fb37ece418056858034a2e', ref: (el) => (this.menuRef = el), trigger: "click", align: "start", width: this.parentWidth, max_height: this.menu_max_height, role: "listbox", disabled: this.disabled || this.readonly, onAtuiMenuStateChange: (event) => this.updateIsOpenState(event) }, this.renderInput(), !this.disabled && !this.readonly
            ? this.renderOptions()
            : null), index.h("div", { key: '267307947840f9e7a1ed6d9ab90b6922eacc65a8' }, this.error_text && this.invalid && (index.h("span", { key: '7e3b532b00f8fcff128cfb395084bcc17638b0f6', class: "text-error", "data-name": "select-error" }, this.error_text)))));
    }
    renderLabel() {
...
const AtSelectGroupComponent = class {
    ...
    label;
    render() {
        return (index.h(index.Host, { key: 'a8d325057c25f59926135f3775418c907d182f8b', role: "group", "aria-labelledby": this.label, "data-name": "select-option-group" }, index.h("div", { key: '85db76423e99990677ea653de236643a405968d0', role: "group", "aria-labelledby": this.label }, index.h("li", { key: 'c6aec6f415cea75dd11ff818e8c244e424e1918a', id: this.label, class: "text-muted border-muted border-b px-0 pt-8 pb-4 text-sm", "data-name": "select-option-group-title" }, this.label), index.h("slot", { key: 'b8f22d6dbf4a7c0d350ba10ad5b9cc2e78014e59' }))));
    }
};
...
const AtSelectOptionComponent = class {
    ...
    render() {
        ...
        return (index.h("li", { key: '1aa91bdca150f0f5c736df6847800bb710b15e35', role: "option", value: this.value, "data-name": "select-option", "aria-selected": this.is_active ? 'true' : 'false', "aria-disabled": this.disabled ? 'true' : 'false', tabIndex: this.disabled ? -1 : 0, class: classname, onClick: this.disabled ? undefined : () => this.handleClick() }, index.h("slot", { key: 'e4552ab6a92a68b5536979000e6a2794a4b90798' }), this.label || this.value, index.h("slot", { key: 'ffff4b63bf7d8a7c5a7bc27887ebe6af191301bf', name: "after" })));
    }
};
