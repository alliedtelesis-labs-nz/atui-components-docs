...
const AtSelectComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'de13c48bbaa512144d2934ef3066191a00aa62d0', class: "group/select", onFocusout: async (event) => {
            ...
            } }, this.renderLabel(), index.h("at-menu", { key: '56c2ccd20601f389916bb2eb11c90c1e12182f38', ref: (el) => (this.menuRef = el), trigger: "click", align: "start", width: this.parentWidth, max_height: this.menu_max_height, role: "listbox", disabled: this.disabled || this.readonly, onAtuiMenuStateChange: (event) => this.updateIsOpenState(event) }, this.renderInput(), !this.disabled && !this.readonly
            ? this.renderOptions()
            : null), index.h("div", { key: '02e799b3da2c30003981291e86520bf7242d98bc' }, this.error_text && this.invalid && (index.h("span", { key: '5b148708ed0623f91f925f702d8b3c2d3051892a', class: "text-error", "data-name": "select-error" }, this.error_text)))));
    }
    renderLabel() {
...
const AtSelectGroupComponent = class {
    ...
    label;
    render() {
        return (index.h(index.Host, { key: 'f74be24e7d64869a7b6c0b5b5a318a3daf9ac89f', role: "group", "aria-labelledby": this.label, "data-name": "select-option-group" }, index.h("div", { key: '73ff5abbf23431c9a7a1d7d594b4d493a361aaf7', role: "group", "aria-labelledby": this.label }, index.h("li", { key: 'c7830b7a9400358a91c1f42b31fd73d59762f477', id: this.label, class: "text-muted border-muted border-b px-0 pt-8 pb-4 text-sm", "data-name": "select-option-group-title" }, this.label), index.h("slot", { key: '76092dac4696ac5f109d0199dc61465c78d6a00d' }))));
    }
};
...
const AtSelectOptionComponent = class {
    ...
    render() {
        ...
        return (index.h("li", { key: '5e922ae3fefe200588d198411d02a6e9c772a35d', role: "option", value: this.value, "data-name": "select-option", "aria-selected": this.is_active ? 'true' : 'false', "aria-disabled": this.disabled ? 'true' : 'false', tabIndex: this.disabled ? -1 : 0, class: classname, onClick: this.disabled ? undefined : () => this.handleClick() }, index.h("slot", { key: '07476d5bdd1e78d640b4f65fd3171cb75c9646e0' }), this.label || this.value, index.h("slot", { key: '3dc38eec6a2b2f9d0767a0e876feae65f11b9249', name: "after" })));
    }
};
