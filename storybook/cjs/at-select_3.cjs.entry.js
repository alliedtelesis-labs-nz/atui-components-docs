...
const AtSelectComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: '770f7009e53a9990aa7f0398337cda40546e8e8d', class: "group/select", onFocusout: async (event) => {
            ...
            } }, this.renderLabel(), index.h("at-menu", { key: '06a52ea152e49762525da52a5a28e084f56ad2ac', ref: (el) => (this.menuRef = el), trigger: "click", align: "start", width: this.parentWidth, max_height: this.menu_max_height, role: "listbox", disabled: this.disabled || this.readonly, onAtuiMenuStateChange: (event) => this.updateIsOpenState(event) }, this.renderInput(), !this.disabled && !this.readonly
            ? this.renderOptions()
            : null), index.h("div", { key: '52a8bfdb8375179dc811cbc1c7430ddfaeeafbb1' }, this.error_text && this.invalid && (index.h("span", { key: '97df876f844841bb7b67fa3ef5f2c6c0788036d7', class: "text-error", "data-name": "select-error" }, this.error_text)))));
    }
    renderLabel() {
...
const AtSelectGroupComponent = class {
    ...
    label;
    render() {
        return (index.h(index.Host, { key: 'bed449117cc3e55f7a55f061b1b2adfe58175488', role: "group", "aria-labelledby": this.label, "data-name": "select-option-group" }, index.h("div", { key: '2ab4743cc855db5916f219f81014e0e9cbfe289a', role: "group", "aria-labelledby": this.label }, index.h("li", { key: '01e4d1a8d3e74b185bde6e61f2dd393e3d42939e', id: this.label, class: "text-muted border-muted border-b px-0 pt-8 pb-4 text-sm", "data-name": "select-option-group-title" }, this.label), index.h("slot", { key: '0d2fecfdc15957c934e0bdb0491d7f5fea5a7a76' }))));
    }
};
...
const AtSelectOptionComponent = class {
    ...
    render() {
        ...
        return (index.h("li", { key: 'cb0842badb50013d3dc9a81972abb9bb15a30334', role: "option", value: this.value, "data-name": "select-option", "aria-selected": this.is_active ? 'true' : 'false', "aria-disabled": this.disabled ? 'true' : 'false', tabIndex: this.disabled ? -1 : 0, class: classname, onClick: this.disabled ? undefined : () => this.handleClick() }, index.h("slot", { key: '983eabe4fcff4c29562cceb41156df79cd45bab8' }), this.label || this.value, index.h("slot", { key: '8d0041737bccd919dfc8d99167aa8549ef8136b6', name: "after" })));
    }
};
