...
const AtSelectComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: '6fcb4afefb340753697fbb71e7b13850c02dfc3b', class: "group/select", onFocusout: async (event) => {
            ...
            } }, this.renderLabel(), index.h("at-menu", { key: '3de22ac82020195fa3b474dee1ce2dfeb2a95eda', ref: (el) => (this.menuRef = el), trigger: "click", align: "start", width: this.parentWidth, max_height: this.menu_max_height, role: "listbox", disabled: this.disabled || this.readonly, onAtuiMenuStateChange: (event) => this.updateIsOpenState(event) }, this.renderInput(), !this.disabled && !this.readonly
            ? this.renderOptions()
            : null), index.h("div", { key: '10a4129ba518b5fbdebaca5a82efa183027d3b67' }, this.error_text && this.invalid && (index.h("span", { key: '40000a89fcc8f85fc3176898d84020a6b3c44745', class: "text-error", "data-name": "select-error" }, this.error_text)))));
    }
    renderLabel() {
...
const AtSelectGroupComponent = class {
    ...
    label;
    render() {
        return (index.h(index.Host, { key: '04bcf005c5926467f27711c511ad101033732ee7', role: "group", "aria-labelledby": this.label, "data-name": "select-option-group" }, index.h("div", { key: '10cabdad3029cb94929ac3937f84cbd7ab26bef0', role: "group", "aria-labelledby": this.label }, index.h("li", { key: 'c16aba8c93dea42e42e1979b7eb6c332f3b30b68', id: this.label, class: "text-muted border-muted border-b px-0 pt-8 pb-4 text-sm", "data-name": "select-option-group-title" }, this.label), index.h("slot", { key: 'd31b3bb408e02e9205762df00cafa29fab95cd82' }))));
    }
};
