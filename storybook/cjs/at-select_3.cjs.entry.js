...
const AtSelectComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'c2ff215c544f90e2f5a67ec23d60b8ee61ed3fe6', class: "group/select", onFocusout: async (event) => {
            ...
            } }, this.renderLabel(), index.h("at-menu", { key: '187972f562ca31e22a5306ea7e1b2b035b0d205e', ref: (el) => (this.menuRef = el), trigger: "click", align: "start", width: this.parentWidth, max_height: this.menu_max_height, role: "listbox", disabled: this.disabled || this.readonly, onAtuiMenuStateChange: (event) => this.updateIsOpenState(event) }, this.renderInput(), !this.disabled && !this.readonly
            ? this.renderOptions()
            : null), index.h("div", { key: 'a8d8ac3cfc8d777d1cb024bb07be94098d6856fe' }, this.error_text && this.invalid && (index.h("span", { key: '530f494ead186df27152c33b625fe2aa9b185154', class: "text-error", "data-name": "select-error" }, this.error_text)))));
    }
    renderLabel() {
...
const AtSelectGroupComponent = class {
    ...
    label;
    render() {
        return (index.h(index.Host, { key: '95213bc20623a048e656df02c7b48dc0511c6bb5', role: "group", "aria-labelledby": this.label, "data-name": "select-option-group" }, index.h("div", { key: 'cbded3e3173c682a7f91a71c5a174fa3e533d33b', role: "group", "aria-labelledby": this.label }, index.h("li", { key: '95e4e0657075924d1d42c5956b492d10b6686139', id: this.label, class: "text-muted border-muted border-b px-0 pt-8 pb-4 text-sm", "data-name": "select-option-group-title" }, this.label), index.h("slot", { key: '941a8bacbedbce7832a49503017bd24630d618db' }))));
    }
};
...
const AtSelectOptionComponent = class {
    ...
    render() {
        ...
        return (index.h("li", { key: 'a932c99ad7b6d64ecdb29c3ac6dba94c70b7fcc9', role: "option", value: this.value, "data-name": "select-option", "aria-selected": this.is_active ? 'true' : 'false', "aria-disabled": this.disabled ? 'true' : 'false', tabIndex: this.disabled ? -1 : 0, class: classname, onClick: this.disabled ? undefined : () => this.handleClick() }, index.h("slot", { key: '6c12f123e9b3678d659130764dde63865015ab25' }), this.label || this.value, index.h("slot", { key: '0cf12cb49080c122b3ff8c4a010a8e81f2362aeb', name: "after" })));
    }
};
