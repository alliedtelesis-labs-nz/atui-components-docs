...
const AtTextIconCell = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '4ad04529045078a3fbdac2961c39848959a10c79', class: "flex h-full items-center gap-4 overflow-hidden leading-normal" }, iconPosition === 'before' && this.renderIcons(), index.h("span", { key: 'aaef53a92a06cd5e463c32853e34b788694cbd7a', class: "truncate" }, this.text), iconPosition === 'after' && this.renderIcons()));
    }
};
