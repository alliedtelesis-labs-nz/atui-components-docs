...
const AtCardComponent = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'd390cd440af9469c60d48af803e02bd1c54ef638', class: containerClassname }, index.h("div", { key: '0156bef73440eacd6911bf1777028a0e0fec0bdd', class: `${headerClassname}` }, index.h("slot", { key: '62b357dbe9e2ab1b6ca53c2d51effdecb0a86cd0', name: "card-header" }), (this.card_title || this.subtitle) && (index.h("div", { key: '2211a88ee24ac005b0a12a17641de0c4904081f6', class: "flex flex-col" }, this.card_title && (index.h("h4", { key: 'ed6e6ed2e06781b1c2db78ae1ddf73f36feaf5ac', "data-name": "card-title", class: "text-h4 font-medium" }, this.card_title)), this.subtitle && (index.h("h5", { key: '85483d755c6082d68ce384de7112e285e3731789', class: "text-muted text-sm font-normal", "data-name": "card-subtitle" }, this.subtitle)))), index.h("slot", { key: '6af87527b9b9545d7ee3f30e3d7bbe84eec2243b', name: "card-header-actions" })), index.h("div", { key: '72f900ec02fdd07bd086e3a8eebcd3ad9eb8dc0c', class: contentClassname, "data-name": "card-content" }, this.content, index.h("slot", { key: '0cb83d1ca500cfffa2fd647906fb0c85f1480d0b' })), index.h("div", { key: 'd479a3b8de2c20c4f67be9afa28a561fda0a9163', class: footerClassname }, index.h("slot", { key: 'b6ad811f30c951f2adca2e800765d3d59d174210', name: "card-footer" }))));
    }
};
