...
const AtTitleSubtitleDateCell = class {
    ...
    render() {
        return (index.h(index.Host, { key: '26fee10c88f4679b9e23a36ae96672a86c2ffd19' }, index.h("div", { key: '5297f5fc1177284142597ed5bcefe36c5ca1e1ee', class: "flex h-full flex-col justify-center" }, index.h("div", { key: '807696be21227bc650e76fe982f4c17a27eccec3', class: "truncate text-sm leading-[100%]" }, this.hourMinuteSecond), index.h("div", { key: '885a5eee3d9b97419edfcfb0a685a8b6e8413ba2', class: "text-secondary truncate text-xs leading-[100%] font-normal" }, this.yearMonthDay))));
    }
};
