...
const AtDashboard = class {
    ...
    render() {
        return (index.h("div", { key: '7a2c2b8b814731f325fcbc016213537bc4e55d2f', class: "grid-stack", ref: (el) => (this.gridContainerRef = el) }, this.widget_items.map((widget) => (index.h("div", { class: "grid-stack-item", id: widget.id, key: widget.id }, index.h("div", { class: "grid-stack-item-content" }, index.h("div", { class: "absolute top-0 right-0" }, index.h("at-menu", null, index.h("at-button", { slot: "menu-trigger", icon: "more_vert", type: "secondaryText" }), index.h("at-button", { label: "Delete", type: "secondaryText", onAtuiClick: () => {
                this.removeWidget(widget);
            } }))), index.h("slot", { name: widget.id })))))));
    }
    static get watchers() { return {
        "widget_templates": [{
                "widgetTemplatesChanged": 0
            }]
    }; }
};
