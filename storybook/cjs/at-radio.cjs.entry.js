...
const AtRadio = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '95447e122f8a4464c263544b4e215ff13b6434ed', "aria-checked": this.value, "aria-disabled": this.disabled, "aria-readonly": this.readonly, role: "radio", tabindex: this.readonly ? -1 : 0, class: classname, "data-name": "radio-container", onKeyDown: (event) => this.handleKeyDown(event), onClick: () => this.handleChange() }, !this.readonly && (index.h("input", { key: '25d4ad83171a4d242860c37a8f07efcc3c70cae5', type: "radio", "data-name": "radio-input", tabindex: -1, name: this.group && this.group, checked: this.value, value: this.option_id, id: this.option_id, disabled: this.readonly || this.disabled, ref: (el) => (this.radioEl = el) })), index.h("div", { key: 'ffb8093ba8b25cafe3b0ead47461048247772250', class: "pointer-events-none flex flex-col" }, this.label && (index.h("span", { key: '0d71300c1b037235d3fc569401bcfb83df0e7368', class: "mt-0 pl-4 text-xs font-medium", id: `${this.option_id}_label`, "data-name": "radio-label" }, this.label)), this.hint_text && (index.h("span", { key: '29c0b92a5aea81ee576a0eeceada5f0906fb7822', class: "text-light mt-0 pl-4 text-xs", "data-name": "radio-hint" }, this.hint_text)), index.h("slot", { key: 'ed2d2fca2a229f61d093632b4033133b5abba6db' }))));
    }
};
