...
const AtRadio = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'f45e35c1c605de117af3b18c8e9c7271303da8ce', "aria-checked": this.value, "aria-disabled": this.disabled, "aria-readonly": this.readonly, role: "radio", tabindex: this.readonly ? -1 : 0, class: classname, "data-name": "radio-container", onKeyDown: (event) => this.handleKeyDown(event), onClick: () => this.handleChange() }, !this.readonly && (index.h("input", { key: 'e009458c3e77426ee09d3667e7aca8a50ea1f252', type: "radio", "data-name": "radio-input", tabindex: -1, name: this.group && this.group, checked: this.value, value: this.option_id, id: this.option_id, disabled: this.readonly || this.disabled, ref: (el) => (this.radioEl = el) })), index.h("div", { key: '12b21d654934f4b806ab35a7e2c320f2a5d81583', class: "pointer-events-none flex flex-col" }, this.label && (index.h("span", { key: '68658283f03eb69daf2ba1d7d9640e9913582b26', class: "mt-0 pl-4 text-xs font-medium", id: `${this.option_id}_label`, "data-name": "radio-label" }, this.label)), this.hint_text && (index.h("span", { key: 'a52f900edee7a2d359d27c7e816dd1c1ad286d36', class: "text-light mt-0 pl-4 text-xs", "data-name": "radio-hint" }, this.hint_text)), index.h("slot", { key: '2bfb3afdffa565fd0653d88d0aea0bfac0b49070' }))));
    }
};
