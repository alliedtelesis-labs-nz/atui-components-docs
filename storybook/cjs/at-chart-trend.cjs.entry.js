...
const AtChartTrend = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'd6be3b1c77257158ade24e07840bbdef0c5b3f18', style: { display: 'block', height: '100%', width: '100%' } }, index.h("div", { key: '4d40b8928d33a684f225c601ac2ea003d2f7de12', class: "flex h-full flex-col justify-between gap-4" }, index.h("div", { key: '53ad23608334b0adce34644f9c89bbffbb18e041', class: "flex items-baseline justify-between gap-8" }, index.h("span", { key: '222a70486a939b27c51007f8ce5808641f2161f6', style: {
                fontSize: '3rem',
                fontWeight: '700',
                lineHeight: '1.1',
            }, "data-name": "value" }, this.value, this.unit && (index.h("span", { key: 'f601306b50d6632f0c12466cb78c75015a9c4fef', style: {
                fontSize: '0.65em',
                fontWeight: '500',
            }, "data-name": "value-unit" }, this.unit)))), index.h("div", { key: '6b00b87a1890f7e813ce9302da5c507d87c67474', class: "relative min-h-0 flex-1", "data-name": "sparkline" }, index.h("at-chart-sparkline", { key: '0bcd04de9c16837e2687c55f6fd94bfa0854735c', class: "absolute inset-0 block h-full w-full", data: this.data, mode: this.mode, status: this.status, color_palette: this.color_palette, height: this.height, refresh_theme: this.refresh_theme })), delta !== 0 ? this.renderDelta(delta) : null)));
    }
};
