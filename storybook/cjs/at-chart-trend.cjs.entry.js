...
const AtChartTrend = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '164d097c5234a4f1b6dd75a4a227fe1a756383cc', style: { display: 'block', height: '100%', width: '100%' } }, index.h("div", { key: '3139e4fb2e5d1e7e7b18a979ad8f42162870bdcc', class: "flex h-full flex-col justify-between gap-4" }, index.h("div", { key: '3b76eb515a7acb70df72df05917e2e1bfdba3a27', class: "flex items-baseline justify-between gap-8" }, index.h("span", { key: 'fad3525e40859802b53c9338e32cb256216b001c', style: {
                fontSize: '3rem',
                fontWeight: '700',
                lineHeight: '1.1',
            }, "data-name": "value" }, this.value, this.unit && (index.h("span", { key: 'c07a36d59dd16eeb1542e2353ac2270bcef92850', style: {
                fontSize: '0.65em',
                fontWeight: '500',
            }, "data-name": "value-unit" }, this.unit)))), index.h("div", { key: '16a22e6fc774c6387c3bd95b1ccfe54f1597d687', class: "relative min-h-0 flex-1", "data-name": "sparkline" }, index.h("at-chart-sparkline", { key: '02d3accea0d5d493576868f5209f1e362cbc2aae', class: "absolute inset-0 block h-full w-full", data: this.data, mode: this.mode, status: this.status, color_palette: this.color_palette, height: this.height, refresh_theme: this.refresh_theme })), delta !== 0 ? this.renderDelta(delta) : null)));
    }
};
