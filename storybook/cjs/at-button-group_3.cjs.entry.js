...
const AtTimeWithUnitComponent = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'c1634c0fb1054837ca326e431b51f2f7b335320b', class: "w-panel-sm flex flex-col" }, index.h("div", { key: '8121d55098c75ef9e3f2767ae2738acf7a8ebc98', class: "grid grid-cols-[1fr_1fr] gap-8" }, index.h("div", { key: 'a43f9607e9a1e9a1ce2278b361adb2b686d22cb3', class: "border-muted flex flex-col gap-8 border-r p-12" }, index.h("h5", { key: 'd9972707af2e9a41cde6e0275907050ebe3d2399', class: "text-h5 text-foreground mb-8 font-medium" }, this.translations.ATUI.TIME.SELECT_RELATIVE_TIME), index.h("div", { key: '860679c05469308738df173bc6621324825a1c3a', class: "flex flex-col gap-8" }, index.h("at-input-numeric", { key: '3ccada7baf63fdb8a2af76202f18da3578755396', value: this.timeValue, min: 1, max: this.getMaxTimeValue(), disabled: this.disabledTimeValue, onAtuiChange: (event) => {
                this.timeValue = event.detail;
            } }), index.h("at-select", { key: 'd9124af6bc1aed67ffe822269782fad9b1872a20', class: "flex-fill", value: this.timeUnit, options: this.dropdownOptions
            ...
            'Now'))) : (this.selectedTime === date.TimeRangeDisplay.ALL && (index.h("span", { class: "text-secondary text-sm font-normal" }, this.translations.ATUI.TIME.ALL_TIME_LABEL)))), visibleCommonOptions.length > 0 && (index.h("div", { key: 'cfcd4fbf85c8e130b1913457ee209bb653da4290', class: "flex flex-col gap-8 p-12" }, index.h("h5", { key: 'b862ce264bbe91b1fd6590c0844e94c4cf823fa3', class: "text-h5 text-foreground mb-8 font-medium" }, this.translations.ATUI.TIME.COMMONLY_USED), index.h("div", { key: 'd3f0821dd00d713029923ed21f0dddf491db6e33', class: "flex flex-col content-stretch", "data-name": "time-with-unit-common-options" }, visibleCommonOptions.map((timerange) => (index.h("button", { onClick: () => this.updateSelectedRange(timerange), onKeyDown: (event) => {
                event.stopPropagation();
                if (event.key === 'Enter' ||
                    event.key === ' ')
                    this.updateSelectedRange(timerange);
            }, tabindex: 0, class: `focus-visible:ring-active-glow cursor-pointer rounded-sm px-[6px] py-2 text-left focus-visible:ring ${this.isSelectedOption(timerange) ? 'bg-active-background text-foreground' : 'hover:bg-surface-2'}` }, index.h("small", null, timeRangeLabel_util.atGetRelativeRangeLabel(timerange, this.translations))))))))), index.h("footer", { key: '2ebb16a850f9cf46bd6e2aa9274de71ebe0d86fb', class: "border-muted flex justify-between border-t p-8" }, index.h("at-button", { key: 'a4412936d60e6b8d928eb4bcd1f37bfd907e5105', type: "secondaryOutline", "data-name": "clear", label: this.translations.ATUI.RESET, onAtuiClick: () => this.clearSelection() }), index.h("div", { key: '222c3d24b1ace999ae87eb8e56c8b8fd0cd5aae0', class: "flex gap-8" }, index.h("at-button", { key: 'e40d258246e4ca7795eb4f600f7642cea4677847', type: "secondaryOutline", "data-name": "cancel", label: this.translations.ATUI.CANCEL, onAtuiClick: () => this.handleCancel() }), index.h("at-button", { key: '6fffedc1ea48425fccaaae9a83f6e8ab7d83a487', "data-name": "apply", label: this.translations.ATUI.APPLY, disabled: !!this.errorText, onAtuiClick: () => this.handleSubmit() })))));
    }
    static get watchers() { return {
        "timeValue": [{
                "watchTimeValue": 0
