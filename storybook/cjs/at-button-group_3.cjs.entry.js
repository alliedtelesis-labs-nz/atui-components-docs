...
const AtButtonGroup = class {
    ...
    render() {
        return (index.h(index.Host, { key: '18edc9b857e4800bb04f9c6a5f89559ac9f3e5fa', role: "radiogroup", "aria-labelledby": this.buttonGroupId }, index.h("div", { key: 'efb064b3f9f6619253299a5dd013c5c6c9794c03', class: "mb-4 flex flex-col empty:hidden" }, index.h("slot", { key: 'c67a297d722adf7f90d6d1f513901f93ab0c3f6b', name: "label" }), (this.label || this.info_text) && (index.h("at-form-label", { key: '3114f3f93296c958c0864bf14e07586741b05fbd', label: this.label, for: this.buttonGroupId, info_text: this.info_text })), this.hint_text && (index.h("span", { key: '06d27da6c16c21d9a1418145755fa43f899689ca', class: "text-muted inline-block text-xs leading-tight", "data-name": "button-group-hint" }, this.hint_text))), index.h("div", { key: '5839be85bb802354eeb5801b36b0a47822c1abc6', class: "border-input h-input bg-surface-background rounded-input relative w-fit border p-[2px] inset-shadow-xs" }, index.h("ul", { key: '0b8c79b65615fac87f441b725f62fa0ad1b304bb', class: "relative z-20 flex h-full flex-row", "data-name": "button-group-options" }, index.h("slot", { key: '35208684e609239151eccff62765d0cd142225e4' }), this.getButtonGroupOptions &&
            this.getButtonGroupOptions.map((button) => (index.h("li", { class: "relative z-10 mr-[-1px] flex" }, button))))), this.error_text && (index.h("span", { key: 'c14966fb2589dd5a0ed0f5ad02c1b62e5211f9e1', class: "text-error text-xs font-medium", "data-name": "button-group-error-text" }, this.error_text))));
    }
...
const AtTimeWithUnitComponent = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'e167a7e4a04008b1672a471b5e634f8ea3c8e6ad', class: "w-panel-sm flex flex-col gap-16" }, index.h("div", { key: 'a7fe1cf51da8ab097bcbb01705bbd57ca467b605', class: "flex flex-col gap-8 p-12" }, index.h("h5", { key: 'ad7f58bd762aa2ea97a3167b250b63436ee8a8b1', class: "text-h5 text-foreground font-medium" }, this.translations.ATUI.TIME.SELECT_RELATIVE_TIME), index.h("div", { key: '9b959c982c2ac906b78cc45c3ac56f1e9bdc4392', class: "grid grid-cols-2 gap-8" }, index.h("at-input-numeric", { key: 'b7a6cac43ab130f1f41b4203eadb397a070e9f66', value: this.timeValue, min: 1, max: this.getMaxTimeValue(), disabled: this.disabledTimeValue, onAtuiChange: (event) => {
                this.timeValue = event.detail;
            } }), index.h("at-select", { key: 'a766ec2a737fa83db8e9bce2ca9d6ef9cd042662', class: "flex-fill", value: this.timeUnit, options: this.dropdownOptions
            ...
            this.selectedTime?.unit && (index.h("span", { class: "text-secondary text-sm font-normal" }, this.startDate.toLocaleString(), " \u2014", ' ', this.translations?.ATUI?.TIME?.NOW || 'Now'))) : (this.selectedTime === date.TimeRangeDisplay.ALL && (index.h("span", { class: "text-secondary text-sm font-normal" }, this.translations.ATUI.TIME.ALL_TIME_LABEL)))), visibleCommonOptions.length > 0 && (index.h("div", { key: '5231eab58639969731668960a8d8558b6fd319b3', class: "flex flex-col gap-8 px-12" }, index.h("h5", { key: '997289d823f9a25618cac22f8f1c0f31cfaa2b7c', class: "text-h5 text-foreground font-medium" }, this.translations.ATUI.TIME.COMMONLY_USED), index.h("div", { key: '5abd919843c2994c613b3d3a41233a75d0d92ba8', class: "grid grid-cols-2 content-stretch", "data-name": "time-with-unit-common-options" }, visibleCommonOptions.map((timerange) => (index.h("button", { onClick: () => this.updateSelectedRange(timerange), onKeyDown: (event) => {
                event.stopPropagation();
                if (event.key === 'Enter' ||
                    event.key === ' ')
                    this.updateSelectedRange(timerange);
            }, tabindex: 0, class: `focus-visible:ring-active-glow cursor-pointer rounded-sm px-[6px] py-2 text-left focus-visible:ring ${this.isSelectedOption(timerange) ? 'bg-active-background' : 'hover:bg-surface-2'}` }, index.h("small", null, timeRangeLabel_util.atGetRelativeRangeLabel(timerange, this.translations)))))))), index.h("footer", { key: '45a14687536a3442b39e4558b92a29f504e49114', class: "flex justify-between p-8" }, index.h("at-button", { key: '3ef278ff02ec1ecc977d863c6585d1be1a7bdd10', type: "secondaryOutline", "data-name": "clear", label: this.translations.ATUI.RESET, onAtuiClick: () => this.clearSelection() }), index.h("div", { key: '1c490ade6bcd8cebc2267ca6e6a63a96c111b0db', class: "flex gap-8" }, index.h("at-button", { key: '97bfae456cb1ec27505104dd400443bcc34e72eb', type: "secondaryOutline", "data-name": "cancel", label: this.translations.ATUI.CANCEL, onAtuiClick: () => this.handleCancel() }), index.h("at-button", { key: '32c22ca43bdbd3978a5d420c428473842978e95f', "data-name": "apply", label: this.translations.ATUI.APPLY, disabled: !!this.errorText, onAtuiClick: () => this.handleSubmit() })))));
    }
    static get watchers() { return {
        "timeValue": [{
                "watchTimeValue": 0
