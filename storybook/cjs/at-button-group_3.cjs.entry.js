...
const AtButtonGroup = class {
    ...
    render() {
        return (index.h(index.Host, { key: '44e1973357a355adc050185f49449a4a9a9962ab', role: "radiogroup", "aria-labelledby": this.buttonGroupId }, index.h("div", { key: '5ddc4438f13f386f1d84d95b320a4d68c6cdc484', class: "mb-4 flex flex-col empty:hidden" }, index.h("slot", { key: '3cd5014a9f51ff225e08ffac01b89c7339675e34', name: "label" }), (this.label || this.info_text) && (index.h("at-form-label", { key: 'ad5bd187de51c33edd6c6f13b12cb0f5ca804d5d', label: this.label, for: this.buttonGroupId, info_text: this.info_text })), this.hint_text && (index.h("span", { key: 'c64073eba25063b7dbcdaab8b5c81da391f1eb50', class: "text-muted inline-block text-xs leading-tight", "data-name": "button-group-hint" }, this.hint_text))), index.h("div", { key: 'f75b6a3b254254d123a6af2dda85623e8ab38662', class: "border-input bg-surface-background relative w-fit rounded-lg border inset-shadow-xs" }, index.h("ul", { key: 'c8e1b730390b74019a41d431e41c67bea4cafd19', class: "relative z-20 m-[2px] flex flex-row", "data-name": "button-group-options" }, index.h("slot", { key: 'd51e25b300fe67408c6832a83a3eafdd830b94cb' }), this.getButtonGroupOptions &&
            this.getButtonGroupOptions.map((button) => (index.h("li", { class: "relative z-10 mr-[-1px]" }, button))))), this.error_text && (index.h("span", { key: 'dfe424060ba3a94afdf4676c1a4e1d7470fb471b', class: "text-error text-xs font-medium", "data-name": "button-group-error-text" }, this.error_text))));
    }
...
const AtCustomTimeRangeComponent = class {
    ...
    render() {
        return (index.h("div", { key: '48f4530f298f4cc9e0dc731750d5693ac4ff72b0', class: "flex w-fit flex-col gap-8" }, index.h("h5", { key: '6a692aace991a1bac7a504ebcf5cfd73f2ad2e54', class: "text-h5 text-foreground p-12 font-medium" }, this.translations.ATUI.TIME.SELECT_ABSOLUTE_TIME), index.h("div", { key: '12a3d74caa579d8c71610aba19520d895ee8c6e1', class: "grid grid-cols-2 gap-16 px-12" }, index.h("div", { key: '8cd222042d78662013a0452784a6b4ea25433a31', class: "flex-fill flex flex-col gap-8" }, index.h("at-input-date", { key: '58d2207c0f956961cdaddba597a4c71be9ec5573', class: "w-full", label: this.translations.ATUI.TIME.FROM_DATE, value: this.from_date_value, min_date: this.min_date, max_date: this.max_date, invalid: this.isFromDateAfterToDate, onAtuiChange: (event) => {
                this.from_date_value = event.detail;
            } }), this.can_set_time && (index.h("at-input-time", { key: '5b4a7de819b176c9f8936470c9c41f99e38d3d3e', class: "w-full", label: this.translations.ATUI.TIME.FROM_TIME, value: this.fromTime, min: this.fromTimeMin, max: this.fromTimeMax, onAtuiChange: (event) => {
                if (event.detail) {
                    this.from_date_value = atTimeDate_util.dayjs(`${this.fromDate} ${event.detail}`, 'YYYY-MM-DD HH:mm').toDate();
                }
            } }))), index.h("div", { key: '2c59cb4943618a5f0eebb5606b4cdb68fa218396', class: "flex-fill flex flex-col gap-8" }, index.h("at-input-date", { key: '16a30a0aca193a8723c7b9ec92c8b40e7218f440', class: "w-full", label: this.translations.ATUI.TIME.TO_DATE, value: this.to_date_value, min_date: this.min_date, max_date: this.max_date, invalid: this.isFromDateAfterToDate, disabled: this.lock_end_date_to_now, onAtuiChange: (event) => {
                this.to_date_value = event.detail;
            } }), this.can_set_time && (index.h("at-input-time", { key: 'ea99273ed4772b7565ea3edb0da4de8150b68aa1', class: "w-full", label: this.translations.ATUI.TIME.TO_TIME, value: this.toTime, min: this.toTimeMin, max: this.toTimeMax, disabled: this.lock_end_date_to_now, onAtuiChange: (event) => {
                if (event.detail) {
                    this.to_date_value = atTimeDate_util.dayjs(`${this.toDate} ${event.detail}`, 'YYYY-MM-DD HH:mm').toDate();
                }
            } })))), index.h("div", { key: '95a993be652d46f87a1b54f51d0fac60c5b7d8c6', class: "align-center rounded-input my-8 flex flex-row justify-between gap-8 px-12" }, index.h("div", { key: 'a609e2b1edc5e0f0763ef42f83035dbee444e20d', class: "flex flex-col" }, index.h("label", { key: 'e2e2f12aa18a97e98f3cc9318732129ef37bcc29', class: "c-form__label" }, this.translations.ATUI.TIME
            .SET_END_DATE_AND_TIME_TO_NOW), index.h("span", { key: '548198f968f20d8cd7e9f9f46a7a438ca341a1ba', class: "text-secondary text-xs" }, this.translations.ATUI.TIME
            .SET_END_DATE_AND_TIME_TO_NOW_DESCRIPTION)), index.h("at-toggle-switch", { key: 'c5afec5ec7c7d920583814fd0f7d1b361ee3f64a', value: this.lock_end_date_to_now, onChange: () => this.setDateNow(), ref: (el) => (this.setDateNowSwitch = el) })), this.isFromDateAfterToDate && (index.h("div", { key: 'f653f8f3802513ae579c70f645f2d2cad800a006', class: "flex flex-col gap-4 px-12" }, index.h("span", { key: '16747899d5ff6d08ec79784dfaf2353b0582c7b7', class: "text-error text-sm", "data-name": "custom-time-range-error-from" }, this.translations.ATUI.TIME.VALIDATION
            .FROM_MUST_BE_BEFORE_TO))), index.h("div", { key: 'ec63dafbbd81ecdb599f8266b2f56060cac226e0', class: "flex flex-row justify-between p-8" }, index.h("at-button", { key: '60fc8c985ba6309724ff1d123ec9e312bdaa26ea', type: "secondaryOutline", "data-name": "custom-time-range-clear", label: this.translations.ATUI.CLEAR_SELECTION, onAtuiClick: () => this.clearSelection() }), index.h("div", { key: 'cbe3e70ca7f13372333cc7554fe669877627f1b2', class: "flex flex-row gap-8" }, index.h("at-button", { key: 'a3a5be6c49133cc7a343e01cd45175196f4fcafb', type: "secondaryOutline", "data-name": "custom-time-range-cancel", label: this.translations.ATUI.CANCEL, onAtuiClick: () => this.handleCancel() }), index.h("at-button", { key: '2baac7324860f429db987883a77f119e10d07294', "data-name": "custom-time-range-apply", label: this.translations.ATUI.APPLY, disabled: this.isRangeInvalid, onAtuiClick: () => this.handleSubmit() })))));
    }
    static get watchers() { return {
        "min_date": [{
                "validateMinDate": 0
...
const AtTimeWithUnitComponent = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'efa90b228c8d1e2a133cc8e1a23f71ed9dcc9d59', class: "w-panel-sm flex flex-col gap-16" }, index.h("div", { key: '3479235ac2a6bb1ce7d2de06d7d17f47f6eb65dc', class: "flex flex-col gap-8 p-12" }, index.h("h5", { key: 'dd6de646f15186167cce8a0f2c6cdcffb3fb9abb', class: "text-h5 text-foreground font-medium" }, this.translations.ATUI.TIME.SELECT_RELATIVE_TIME), index.h("div", { key: '4c38ed8cddf4791e91ae4fef0598e195d49a1596', class: "grid grid-cols-2 gap-8" }, index.h("at-input-numeric", { key: 'df4ac9e7541f17c50d3a9d955f099721ca977458', value: this.timeValue, min: 1, disabled: this.disabledTimeValue, onAtuiChange: (event) => {
                this.timeValue = event.detail;
            } }), index.h("at-select", { key: '3882ac94099b51ddf231726f1325bb6bd7059d64', class: "flex-fill", value: this.timeUnit, options: this.dropdownOptions
            ...
            this.selectedTime?.unit && (index.h("span", { class: "text-secondary text-sm font-normal" }, this.startDate.toLocaleString(), " \u2014", ' ', this.translations?.ATUI?.TIME?.NOW || 'Now'))) : (this.selectedTime === date.TimeRangeDisplay.ALL && (index.h("span", { class: "text-secondary text-sm font-normal" }, this.translations.ATUI.TIME.ALL_TIME_LABEL)))), visibleCommonOptions.length > 0 && (index.h("div", { key: '2bdf7cc9b0b4138aabd6e43486211dd8368e8b8d', class: "flex flex-col gap-8 px-12" }, index.h("h5", { key: '5d94687664d3eb37e23e1f0cae88443fb0f30edb', class: "text-h5 text-foreground font-medium" }, this.translations.ATUI.TIME.COMMONLY_USED), index.h("div", { key: '2f735f6f474e042d1b90f65469cd4c204520cb28', class: "grid grid-cols-2 content-stretch", "data-name": "time-with-unit-common-options" }, visibleCommonOptions.map((timerange) => (index.h("button", { onClick: () => this.updateSelectedRange(timerange), onKeyDown: (event) => {
                event.stopPropagation();
                if (event.key === 'Enter' ||
                    event.key === ' ')
                    this.updateSelectedRange(timerange);
            }, tabindex: 0, class: `focus-visible:ring-active-glow cursor-pointer rounded-sm px-[6px] py-2 text-left focus-visible:ring ${this.isSelectedOption(timerange) ? 'bg-active-background' : 'hover:bg-surface-2'}` }, index.h("small", null, this.translations.ATUI.TIME.LAST, ' ', timerange.value, ' ', this.translations.ATUI.TIME[timerange.unit]))))))), index.h("footer", { key: '9013054174e7bcb3cc5e10963e984803d997d15f', class: "flex justify-between p-8" }, index.h("at-button", { key: '141080aea2b04c9000b356934b56bf4454675197', type: "secondaryOutline", "data-name": "clear", label: this.translations.ATUI.RESET, onAtuiClick: () => this.clearSelection() }), index.h("div", { key: 'bebc9a323a75bf726d1e81a74022ae6671fbfb12', class: "flex gap-8" }, index.h("at-button", { key: 'c2f54303e7fcb95fa6d92715e773022ac4ddcfac', type: "secondaryOutline", "data-name": "cancel", label: this.translations.ATUI.CANCEL, onAtuiClick: () => this.handleCancel() }), index.h("at-button", { key: 'eda83292d48fd8feeeaf51824730675872ab9f01', "data-name": "apply", label: this.translations.ATUI.APPLY, disabled: !!this.errorText, onAtuiClick: () => this.handleSubmit() })))));
    }
    static get watchers() { return {
        "timeValue": [{
                "watchTimeValue": 0
