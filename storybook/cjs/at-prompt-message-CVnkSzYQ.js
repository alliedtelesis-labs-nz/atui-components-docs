...
const AtPromptMessage = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'b2ac2b0548c3975282eed5f2f3b95bf5bdf2d5c1', class: "flex w-full gap-8", "data-name": "message-container", "data-role": this.role }, index.h("div", { key: '9fad5bd48c6a8cd5d2451a485878ec4e4f6dfed3', class: "flex flex-1 flex-col" }, this.name && (index.h("span", { key: '4fe377808a604eab393172ec48f1942d9a5d151a', class: "text-light self-start text-sm", "data-name": "message-name" }, this.name)), index.h("div", { key: '6fe967b72ad81d269aceb3b0bdd0269ac1255435', class: messageClasses }, this.renderContent()), this.renderActions())));
    }
    get el() { return index.getElement(this); }
};

exports.AtPromptMessage = AtPromptMessage;
//# sourceMappingURL=at-prompt-message-CVnkSzYQ.js.map
