...
const AtMenuCell = class {
    ...
    render() {
        const actions = typeof this.params.actions === 'function'
            ...
            : this.params.actions;
        return (index.h(index.Host, { key: '8a0b68b513949fa166192fe220435489bbbd802b', class: "flex h-full items-center gap-4" }, index.h("at-menu", { key: 'aa2c178cdbbbd6f4ae9c89231145b5ab31d00eb1', width: "fit-content", position: "left" }, index.h("at-button", { key: '18e1823c71b3fbc5f14e6920fb22ff2c82a8deba', type: "secondaryText", slot: "menu-trigger" }, !this.params.icon && (index.h("at-icon", { key: '938553ca7cd25d464d1047d9296d6c6857d3feeb', slot: "icon", name: "overflow_menu" }))), index.h("div", { key: '861121cdb95d9f29e3cc5f3e664895ea465a1da8', class: "flex flex-col" }, actions &&
