...
const AtMenuCell = class {
    ...
    render() {
        const actions = typeof this.params.actions === 'function'
            ...
            : this.params.actions;
        return (index.h(index.Host, { key: 'c176607f4e8249060fdd0e30499fb53560295ba3', class: "flex h-full items-center gap-4" }, index.h("at-menu", { key: '782e8dff18a795c32906b10d3b911f9912bbc877', width: "fit-content", position: "left" }, index.h("at-button", { key: '61a0c304d912e1ee289856f6deaccd9244d1d960', type: "secondaryText", slot: "menu-trigger" }, !this.params.icon && (index.h("at-icon", { key: '0f50f9afcc89bd1cc7b342e6dcbf154e7b45bcb8', slot: "icon", name: "overflow_menu" }))), index.h("div", { key: 'e24d26f88b622a71effc112303319174b9ec72da', class: "flex flex-col" }, actions &&
