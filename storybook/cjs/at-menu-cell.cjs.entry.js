...
const AtMenuCell = class {
    ...
    render() {
        const actions = typeof this.params.actions === 'function'
            ...
            : this.params.actions;
        return (index.h(index.Host, { key: 'd21e1badfc99b33b2a313e30221ad64b475ac5f5', class: "flex h-full items-center gap-4" }, index.h("at-menu", { key: 'ee1e2664357066141c97f23bc1b8f4fec5d4dd7f', width: "fit-content", position: "left" }, index.h("at-button", { key: '6274c944b2374dd2d78607e8de411787ed28a6a5', type: "secondaryText", slot: "menu-trigger" }, !this.params.icon && (index.h("at-icon", { key: '47f9b64713d2bcd35ac5c9684928433ba50a1a05', slot: "icon", name: "overflow_menu" }))), index.h("div", { key: 'c1907d8be3614975354c62c74867449606af36bc', class: "flex flex-col" }, actions &&
