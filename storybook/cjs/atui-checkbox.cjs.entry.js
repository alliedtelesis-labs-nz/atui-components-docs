...
const AtuiCheckbox = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'defa382907ef13cb0d26872bac2266376f11861f', role: "checkbox", "aria-checked": this.value, "aria-labelledby": `${this.option_id}-label`, tabindex: 0, class: classname, "data-name": "checkbox-container", onKeyDown: (event) => (event.key === 'Enter' || event.key === ' ') &&
                this.checkboxEl.click(), onClick: () => this.checkboxEl.click() }, index.h("input", { key: '7ee8cc62c8ec8396fc4f85931bc45eadade2afd8', type: "checkbox", class: checkboxClassname, "data-name": "checkbox-input", checked: this.value, onChange: (event) => this.handleChange(event), id: this.option_id, tabindex: -1, ref: (el) => (this.checkboxEl = el), disabled: this.disabled }), (this.label || this.hint_text) && (index.h("div", { key: '2838c9dd17dc6a03448c56e232c8ad1a48274958', class: "pointer-events-none flex flex-col" }, index.h("slot", { key: '959357fb64e6bc4342b8df0fc914c3f41344eaa4', name: "label" }), this.label && (index.h("label", { key: '18c953e7d63a5e68a1f3b3ee5285d22c8320dc7f', class: "mt-0 pl-4 text-xs font-medium", id: `${this.option_id}-label`, "data-name": "checkbox-label" }, this.label)), this.hint_text && (index.h("span", { key: 'fff91e9df9ed0945f179aa963360f96542fad07f', class: "text-light mt-0 pl-4 text-xs", "data-name": "checkbox-hint" }, this.hint_text)))), index.h("slot", { key: '565d07cea66b7e04d603b4762d77ef67cd3a5d3c' })));
    }
