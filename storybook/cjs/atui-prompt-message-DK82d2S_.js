...
const AtuiPromptMessage = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '6305bcb6d213e0128871996d4121197fef451fc4', class: "flex w-full gap-8", "data-name": "message-container", "data-role": this.role }, index.h("div", { key: 'c19dbd8e715f7bea556f25ce1e168479563ff130', class: "flex flex-1 flex-col" }, this.name && (index.h("span", { key: 'f87aafa5831d5ccf10c9fdc24c3aa8d54fb7f4f5', class: "text-light self-start text-sm", "data-name": "message-name" }, this.name)), index.h("div", { key: '5b8280212b929360fc2b00b8470326ab8cf72d8e', class: messageClasses }, this.renderContent()), this.renderActions())));
    }
    get el() { return index.getElement(this); }
};

exports.AtuiPromptMessage = AtuiPromptMessage;
//# sourceMappingURL=atui-prompt-message-DK82d2S_.js.map
