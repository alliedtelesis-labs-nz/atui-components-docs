...
const AtuiToggleSwitchComponent = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'e1380a33caa7c4ce3bc99dd4bbd5fb1eb4c92674', id: `${this.toggleId}-host`, role: "switch", "aria-labelledby": `${this.toggleId}-label`, class: classname, tabIndex: 0, onClick: () => this.inputEl.click(), onKeyDown: (event) => {
                if (event.key === ' ' || event.key === 'Enter') {
                    event.preventDefault();
                    this.inputEl.click();
                }
            } }, index.h("div", { key: 'c39c20c4b8306290130d927a81e8d4141f6b55bb', class: "flex flex-col" }, index.h("slot", { key: '4f109a38ebbfe2c39713889d4f12f45b835cc309', name: "label" }), !!this.label && this.show_label && (index.h("atui-form-label", { key: '5565c2d528972e8aa497c5475bd7f8ae20df9934', label: this.label, class: "pointer-events-none select-none", for: this.toggleId, id: `${this.toggleId}-label`, "data-name": "switch-label" })), this.hint_text && (index.h("span", { key: 'e0ae71d9049e70d8e80941c8af4fb05a60ab98d9', class: "text-light inline-block text-xs leading-tight", "data-name": "select-hint" }, this.hint_text))), index.h("div", { key: 'd3b8c6289999a56f7b09e523c75da79f382dd071', class: "relative flex h-20 w-40" }, index.h("input", { key: 'de51429de5a8621eab805af8437dec6a56cf258f', id: this.toggleId, class: "h-0 w-0 opacity-0", disabled: this.disabled, type: "checkbox", checked: this.value, tabIndex: -1, onChange: (e) => this.onToggle(e.target.checked), ref: (el) => (this.inputEl = el), "data-name": "switch-input" }), index.h("span", { key: '0a952b499a4f596fab0d1c872bc9c766f6ff2ea2', class: trackClassname }, index.h("span", { key: '17453211afeeb1b47c0c92a6d79ea38cf3989308', class: thumbClassname }, this.value ? 'check' : 'remove')))));
    }
};
