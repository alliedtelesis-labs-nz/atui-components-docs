...
const AtBadgeComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'a13d972147754a942ba690fc6781d60d8948e079', class: `${this.baseClasses} ${this.variantClasses} ${this.sizeClasses}` }, index.h("slot", { key: '80ba128dba66473b33a26c4b1287bb32ef5457ee', name: "icon" }), index.h("span", { key: '0f0c3dd6ff5b5d65c8430a28ac13b63d70e0acce', "data-name": "badge-label" }, this.label), index.h("slot", { key: '84c940367452e51330c94d29b1db146af0b458c4' })));
    }
};
