...
const AtBadgeComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: '83437258321e56364fe4f394331bac1ef49b4980', class: `${this.baseClasses} ${this.variantClasses} ${this.sizeClasses}` }, this.icon && (index.h("i", { key: '353e86c676f90964dddb0f6accf735a5bad85873', class: "material-icons icon-sm relative h-[12px] w-[12px] text-[12px]", "data-name": "badge-icon" }, this.icon)), index.h("span", { key: 'ea8bdaa0be7706c288633b08d274d0707369e27d', "data-name": "badge-label" }, this.label), index.h("slot", { key: '3fb5f65ecc2b56fe0167d040104a9c47f2863e83' })));
    }
};
