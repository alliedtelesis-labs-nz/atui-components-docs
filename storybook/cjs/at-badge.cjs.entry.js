...
const AtBadgeComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: '4d983c0ee1187ba2ff4d5e13c852ee4231120316', class: `${this.baseClasses} ${this.variantClasses} ${this.sizeClasses}` }, index.h("slot", { key: 'e47a45b3e9adbfcbc10059aabb50a778f4c381bf', name: "icon" }), index.h("span", { key: 'e851f2a27f98a158f0da4ee90ab688598cd6d26f', "data-name": "badge-label" }, this.label), index.h("slot", { key: 'b632b87f1063751b233f97482bb6ed1ffc1f6bae' })));
    }
};
