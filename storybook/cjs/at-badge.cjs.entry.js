...
const AtBadgeComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'a32c4059ad6de96aaa1e58afe54dc21d980aeeb7', class: `${this.baseClasses} ${this.variantClasses} ${this.sizeClasses}` }, index.h("slot", { key: 'f5f34e61e11758034ee353fb53860bb4a6ea1383', name: "icon" }), index.h("span", { key: 'c9653934603b673b68d0adb624c2bb97156c1765', "data-name": "badge-label" }, this.label), index.h("slot", { key: 'a8047fd891036fcc8b9a547d5f85a621a5a5ba82' })));
    }
};
