...
const AtBadgeComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'd44671884b3972c960bbb0a3bef5bb1c6638aeec', class: `${this.baseClasses} ${this.variantClasses} ${this.sizeClasses}` }, index.h("slot", { key: 'f9ff22deadc43fe8f691286eccd985d278a4611f', name: "icon" }), index.h("span", { key: 'a912e334e9d615a019e5d1c6350fc5ae0fce6cf9', "data-name": "badge-label" }, this.label), index.h("slot", { key: '84716dc3ab2b8952fbb785b1ea63eebd4f562f79' })));
    }
};
