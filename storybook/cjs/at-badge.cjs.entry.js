...
const AtBadgeComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: '547d5d6a5fb0bfdc6a5ffeb32fefed3bddb7f082', class: `${this.baseClasses} ${this.variantClasses} ${this.sizeClasses}` }, index.h("slot", { key: '7a99b56f87a0971db5b4640909c72d1a3357dcb5', name: "icon" }), index.h("span", { key: '24a2f4a36436525955bd970a9d0ab0d609257dc0', "data-name": "badge-label" }, this.label), index.h("slot", { key: 'fa7de5549e32ef4d47ad5a7ba19cc3eca8d060ab' })));
    }
};
