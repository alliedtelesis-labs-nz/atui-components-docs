...
const AtResizablePanelComponent = class {
    constructor(hostRef) {
        ...
        this.atuiResize = index.createEvent(this, "atuiResize", 7);
        this.atuiCollapse = index.createEvent(this, "atuiCollapse", 7);
    }
...
exports.at_resizable_panel = AtResizablePanelComponent;
