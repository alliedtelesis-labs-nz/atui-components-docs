...
const AtTablePagination = class {
    ...
    atPageSizeChange;
    render() {
        return (index.h(index.Host, { key: '9acafab5661a980e2a91fdf02cd297b8fbc47e4c', class: "mt-8 flex items-center justify-end gap-8" }, index.h("span", { key: '5f79338b8b8012aa38d92440d965ee3ca21603c2' }, "Page Size: "), index.h("at-select", { key: '7f7249ba4d6bbc12069e1bcd331073265c061485', options: this.page_size_options, value: `${this.page_size_options[0].value}`, clearable: false, onAtuiChange: (event) => this.atPageSizeChange.emit(parseInt(event.detail)) }), index.h("at-button", { key: 'b18ff009adff82bc6105fc00b8d9a13047b1a547', disabled: this.current_page === 1, type: "secondaryText", icon: "first_page", onAtuiClick: () => this.atChange.emit(1) }), index.h("at-button", { key: '7f1fa8d1c1a67e9547fd0ebe728ca478fafb3401', disabled: this.current_page === 1, type: "secondaryText", icon: "chevron_left", onAtuiClick: () => this.atChange.emit(this.current_page - 1) }), index.h("span", { key: 'c06ce8b3322db7f460554fc24e819e34f82f247c' }, "Page ", this.current_page, " of ", this.num_pages), index.h("at-button", { key: 'adb580b6d25df095a93828eca7610d5914de66b0', disabled: this.current_page === this.num_pages, type: "secondaryText", icon: "chevron_right", onAtuiClick: () => this.atChange.emit(this.current_page + 1) }), index.h("at-button", { key: 'f344590fe1657e38946177a3b8e420982479cc90', disabled: this.current_page === this.num_pages, type: "secondaryText", icon: "last_page", onAtuiClick: () => this.atChange.emit(this.num_pages) })));
    }
};
