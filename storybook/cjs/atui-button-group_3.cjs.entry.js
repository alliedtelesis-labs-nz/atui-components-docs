...
const AtuiButtonGroup = class {
    ...
    render() {
        return (index.h(index.Host, { key: '017ab3c0fcb9bf738366e26f22dade344ff536be', role: "radiogroup", "aria-labelledby": this.buttonGroupId, class: 'flex flex-col items-start' }, index.h("div", { key: 'e468ad47749d3b7a9699c5dfcd49ae7093da4c59', class: "flex flex-col" }, index.h("slot", { key: '410523a6dd09c6e7af6fad3a83976603dff83437', name: "label" }), (this.label || this.info_text) && (index.h("atui-form-label", { key: 'f04500fe369ac046c94336268151a6350147e2c7', id: this.buttonGroupId, label: this.label, info_text: this.info_text })), this.hint_text && (index.h("span", { key: 'df4bf6d4429662db3baf188693ee13c6b352abd9', class: "text-light mb-8 inline-block text-xs leading-tight", "data-name": "button-group-hint" }, this.hint_text))), index.h("div", { key: '96d9d39cf7943d2ad49c479afdbe9517d4898041', class: "border-med relative rounded-lg border bg-white inset-shadow-xs" }, index.h("ul", { key: '7fbff7280ec0f1d6488c429f61fbf9631d50e5f7', class: "relative z-20 m-[3px] flex flex-row", "data-name": "button-group-options" }, this.renderOptions(), index.h("slot", { key: '2ec43c4f287eed77f4c9ee892dc5b1b0b589c85b' }))), this.error_text && (index.h("span", { key: 'f7dcaef11ab2a3efa7992ece36c4fcb10fbcb700', class: "text-error text-xs font-medium", "data-name": "button-group-error-text" }, this.error_text))));
    }
    renderOptions() {
...
const AtuiCustomTimeRangeComponent = class {
    ...
    render() {
        return (index.h("div", { key: 'f0e969fce01a36c89d378f65a8ffaf8e28439bca', class: "flex w-fit flex-col gap-8 border border-gray-300" }, index.h("h5", { key: '614d36a490a4a517d026c0f09f4503fe636fc1d5', class: "text-h5 text-dark p-12 font-medium" }, this.translations.ATUI.TIME.SELECT_ABSOLUTE_TIME), index.h("div", { key: '299832c72461b8c0c17471dcb97917acc631de29', class: "flex flex-row gap-16 px-12" }, index.h("div", { key: '6b53d1a6b0394daeb01f4c8de10e4792abde621d', class: "flex-fill flex flex-col gap-8" }, index.h("div", { key: '8012547f5c0a060616602bbb6e74ef5998270095' }, index.h("label", { key: '58c19b812cc8ca3e7a62d5231fc6095c5b14b022' }, this.translations.ATUI.TIME.FROM_DATE), index.h("div", { key: '011aa0810c102729cfe47c3efea78a706659cde4' }, index.h("input", { key: 'c8ce860da7b8fd6e79c22e06689184202fe6af61', type: "date", name: "fromDp", class: "cursor-pointer", min: timeDatePresentation_util.TimeDatePresentationUtil.getFormattedDate(this.min_date, 'YYYY-MM-DD'), max: timeDatePresentation_util.TimeDatePresentationUtil.getFormattedDate(this.max_date, 'YYYY-MM-DD'), value: this.fromDate, onChange: (event) => {
                this.from_date_value =
                    timeDatePresentation_util.TimeDatePresentationUtil.buildDateFromStrings(event.target.value, this.fromTime);
                this.setToDateAndTime(this.to_date_value);
            } }))), this.can_set_time && (index.h("div", { key: '73d2865215cd1fd1b6ea3c8670a14cf54a861eb8' }, index.h("label", { key: '6664d3affda7e5c09daccb5988d220c720fd8847' }, this.translations.ATUI.TIME.FROM_TIME), index.h("div", { key: 'fbfb8663765c563538305fd751d09e7058980b9e' }, index.h("atui-select", { key: '2ea1c5cb242f18244afa5a9e366e7e724e380568', options: this.getFromTimes, value: this.fromTime, onAtuiChange: (event) => {
                this.from_date_value =
                    timeDatePresentation_util.TimeDatePresentationUtil.buildDateFromStrings(this.fromDate, event.detail);
            } }))))), index.h("div", { key: '9c0fa5cca5b78f2bed902a1d6be86c6ea65d56bc', class: "flex-fill flex flex-col gap-8" }, index.h("div", { key: '209985e0bb011389ac022efb59a544fb5c2bb7c8' }, index.h("label", { key: '101676d6f0fd759b5edd53d58d9e56ded3d5fb33' }, this.translations.ATUI.TIME.TO_DATE), index.h("div", { key: 'ec5c9eef850b8e046adff70bab768577d4e61ae4' }, index.h("input", { key: 'f5be5938124f627966d71de991d6230b7fd1e1d8', type: "date", name: "toDp", class: "cursor-pointer", disabled: this.lock_end_date_to_now, min: timeDatePresentation_util.TimeDatePresentationUtil.getFormattedDate(this.min_date, 'YYYY-MM-DD'), max: timeDatePresentation_util.TimeDatePresentationUtil.getFormattedDate(this.max_date, 'YYYY-MM-DD'), value: this.toDate, ref: (el) => (this.toDatePickerEl = el), onChange: (event) => {
                this.to_date_value =
                    timeDatePresentation_util.TimeDatePresentationUtil.buildDateFromStrings(event.target.value, this.toTime);
                this.setToDateAndTime(this.to_date_value);
            } }))), this.can_set_time && (index.h("div", { key: '9555a3ad1882338dd63ace9ec4a77c94b4450d0c' }, index.h("label", { key: '18bbb04e4b137bcefa5164506f0eaa54137f9ebb' }, this.translations.ATUI.TIME.TO_TIME), index.h("div", { key: '3241742104de228da72327d8a7d9454b95a54dea' }, index.h("atui-select", { key: '8cf999252e956db8691ea6b5d8a7ccafa211bd3c', options: this.getToTimes, value: this.toTime, disabled: this.lock_end_date_to_now, ref: (el) => (this.toTimePickerEl = el), onAtuiChange: (event) => {
                this.to_date_value =
                    timeDatePresentation_util.TimeDatePresentationUtil.buildDateFromStrings(this.toDate, event.detail);
            } })))))), index.h("div", { key: '0bef6c42b12d2d12377af36a706c3cad28b4cc71', class: "align-center my-8 flex flex-row justify-between gap-8 rounded-md px-12" }, index.h("div", { key: '024c852ad225106917991811b4a740b2239c696f', class: "flex flex-col" }, index.h("label", { key: 'f13431b1470843c278eb81eaec277f38e8df97ca', class: "c-form__label" }, this.translations.ATUI.TIME
            .SET_END_DATE_AND_TIME_TO_NOW), index.h("span", { key: '501e7a0d7cb92d53bbd6f8233d84ad3218d1e2de', class: "text-med text-xs" }, this.translations.ATUI.TIME
            .SET_END_DATE_AND_TIME_TO_NOW_DESCRIPTION)), index.h("atui-toggle-switch", { key: 'b05055db760f6ac588afaf1f9e0b1548cb371980', value: this.lock_end_date_to_now, onChange: () => this.setDateNow(), ref: (el) => (this.setDateNowSwitch = el) })), index.h("div", { key: 'e91250f1525d989724ea833c9cef4255b72d8e06', class: "flex flex-row justify-between p-8" }, index.h("atui-button", { key: '4e8acbc9f724a8c65ab893018635a6e2e65843f1', type: "secondaryOutline", "data-name": "custom-time-range-clear", label: this.translations.ATUI.CLEAR_SELECTION, onClick: () => this.clearSelection() }), index.h("div", { key: '9cd9f3be7f5907bb47831730acc759d42c1d5de4', class: "flex flex-row gap-8" }, index.h("atui-button", { key: 'c8acc952d9789ea0a3a1bd82336112b9d8010deb', type: "secondaryOutline", "data-name": "custom-time-range-cancel", label: this.translations.ATUI.CANCEL, onClick: () => this.handleCancel() }), index.h("atui-button", { key: 'fff482facc45a13e311b3c7fcf209248592997f3', "data-name": "custom-time-range-apply", label: this.translations.ATUI.APPLY, onClick: () => this.handleSubmit() })))));
    }
    get el() { return index.getElement(this); }
