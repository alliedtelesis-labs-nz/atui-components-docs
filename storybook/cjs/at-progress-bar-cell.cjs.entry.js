...
const AtProgressBarCell = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '3843241b10e437b77d0b7a93367de5d53c237fae', class: "flex h-full w-full min-w-0 items-center" }, index.h("at-tooltip", { key: 'e5296c005a2b8df9b18708ee37b5c5734f396159', position: "top", disabled: !this.params?.generateTooltip, class: "min-w-0 flex-1 self-center" }, index.h("div", { key: '2c025028a06d4c8b2681be8bf12d3abd681f2514', slot: "tooltip-trigger", class: "flex min-w-0 items-center gap-8" }, index.h("at-progress-bar", { key: 'e7b8893b8ee9d1403780f7008fcf40daaa1c616d', class: "min-w-0 flex-1", percentage: this.percentage, type: this.type, size: this.params?.size ?? 'sm' }), !this.params?.hideLabel && (
        // Reserved width so the bars align down the column
        // rather than jittering with the label's digit count.
        index.h("span", { key: '3fa579c1aa126f9628e8c7a155c941b40f482a7c', class: "text-secondary min-w-[2.5rem] shrink-0 text-right text-xs leading-normal font-normal tabular-nums" }, this.labelValue))), this.params?.generateTooltip && (index.h("span", { key: '5bbe84fe690cd916219021cf4cefd3d6f763f89e', class: "leading-normal" }, this.params.generateTooltip(this.params))))));
    }
};
