...
const AtProgressBarCell = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '8653d27017512e89e35e84d46933e12090cb2e82', class: "flex h-full w-full min-w-0 items-center" }, index.h("at-tooltip", { key: 'cceb836d69ddcc55e8c0f42c2debdc7584e3408d', position: "top", disabled: !this.params?.generateTooltip, class: "min-w-0 flex-1 self-center" }, index.h("div", { key: '5dbcc66af990851aa36b25d6f59d0fb3dac166dc', slot: "tooltip-trigger", class: "flex min-w-0 items-center gap-8" }, index.h("at-progress-bar", { key: 'cfe6d3f224598ae96b1d20ed303088478ea80423', class: "min-w-0 flex-1", percentage: this.percentage, type: this.type, size: this.params?.size ?? 'sm' }), !this.params?.hideLabel && (
        // Reserved width so the bars align down the column
        // rather than jittering with the label's digit count.
        index.h("span", { key: '1b1ae4cd0561e3bcda1c77d45bdae147308cedd4', class: "text-secondary min-w-[2.5rem] shrink-0 text-right text-xs leading-normal font-normal tabular-nums" }, this.labelValue))), this.params?.generateTooltip && (index.h("span", { key: 'ebb7c9f1ee0406828cffb019ed6836e327dcef99', class: "leading-normal" }, this.params.generateTooltip(this.params))))));
    }
};
