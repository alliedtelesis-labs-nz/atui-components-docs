...
const AtProgressBarCell = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '8f5359a057094f8512692bec240efabfd263ffd4', class: "flex h-full w-full min-w-0 items-center" }, index.h("at-tooltip", { key: '09e20cc614e0a15f1c2bb924414fd2bb29028ea4', position: "top", disabled: !this.params?.generateTooltip, class: "min-w-0 flex-1 self-center" }, index.h("div", { key: '22ad9c447577d442d86a3ba8ac51fab6854b6ab2', slot: "tooltip-trigger", class: "flex min-w-0 items-center gap-8" }, index.h("at-progress-bar", { key: 'ad549163c0a4ab0fbb235c490c44affcac3ca864', class: "min-w-0 flex-1", percentage: this.percentage, type: this.type, size: this.params?.size ?? 'sm' }), !this.params?.hideLabel && (
        // Reserved width so the bars align down the column
        // rather than jittering with the label's digit count.
        index.h("span", { key: 'ccbaba796085c85fe0690a48543ec2a49380df9c', class: "text-secondary min-w-[2.5rem] shrink-0 text-right text-xs leading-normal font-normal tabular-nums" }, this.labelValue))), this.params?.generateTooltip && (index.h("span", { key: '643d40dd23823765cf87fa0b88b0a670f99217a0', class: "leading-normal" }, this.params.generateTooltip(this.params))))));
    }
};
