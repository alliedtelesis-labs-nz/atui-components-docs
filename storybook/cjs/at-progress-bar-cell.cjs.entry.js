...
const AtProgressBarCell = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'efdb2b0f4fe09fa83030542b1162a06d902f9df1', class: "flex h-full w-full min-w-0 items-center" }, index.h("at-tooltip", { key: '80ac9f8c6055979ad64ccaa04b1b4ee3db99eced', position: "top", disabled: !this.params?.generateTooltip, class: "min-w-0 flex-1 self-center" }, index.h("div", { key: '3ae54f2584a97a7f9b44f377c591b5fc0a141fe2', slot: "tooltip-trigger", class: "flex min-w-0 items-center gap-8" }, index.h("at-progress-bar", { key: '27cb5ccbf046fec325f45785965290c7bdcf0c73', class: "min-w-0 flex-1", percentage: this.percentage, type: this.type, size: this.params?.size ?? 'sm' }), !this.params?.hideLabel && (
        // Reserved width so the bars align down the column
        // rather than jittering with the label's digit count.
        index.h("span", { key: 'eee31a7ada63f4753d7432a0a48dd5cd64ddf1da', class: "text-secondary min-w-[2.5rem] shrink-0 text-right text-xs leading-normal font-normal tabular-nums" }, this.labelValue))), this.params?.generateTooltip && (index.h("span", { key: 'c4fa0166345d4d9668b6eb27bb61e04701f90e5b', class: "leading-normal" }, this.params.generateTooltip(this.params))))));
    }
};
