...
const AtProgressBarCell = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '4da9db931c804fec137ab0ef4a266648d47af28a', class: "flex h-full w-full min-w-0 items-center" }, index.h("at-tooltip", { key: '802c064f8ef338a26baf0beb86b84a4daadca751', position: "top", disabled: !this.params?.generateTooltip, class: "min-w-0 flex-1 self-center" }, index.h("div", { key: '1899989a62a5c8a249c7de90eb295a74e3e94603', slot: "tooltip-trigger", class: "flex min-w-0 items-center gap-8" }, index.h("at-progress-bar", { key: '81a93a4baf1d39149c562fa943d393b04f98be94', class: "min-w-0 flex-1", percentage: this.percentage, type: this.type, size: this.params?.size ?? 'sm' }), !this.params?.hideLabel && (
        // Reserved width so the bars align down the column
        // rather than jittering with the label's digit count.
        index.h("span", { key: '495403e2a62cf85ce98a8022e43e3b43eb142ac3', class: "text-secondary min-w-[2.5rem] shrink-0 text-right text-xs leading-normal font-normal tabular-nums" }, this.labelValue))), this.params?.generateTooltip && (index.h("span", { key: 'ef78f166307571895be3be02b4db0ddeb77aac4c', class: "leading-normal" }, this.params.generateTooltip(this.params))))));
    }
};
