...
const AtuiRadioGroup = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'b8445adc8b4a00188fbddee328eaa60b70c245a4', role: "radiogroup", onKeyDown: (event) => this.handleKeyDown(event), class: "block w-full" }, index.h("div", { key: '92b2e9d1e0b7bd6f0b88750dd5ab9d656907a550', class: "flex flex-col" }, index.h("slot", { key: '4d3458e871b3719a09a0915909eafa0a65702883', name: "label" }), (this.label || this.required || this.info_text) && (index.h("atui-form-label", { key: '466e57a7d8f5adea4ef4a0dbff4142f00577ffbc', label: this.label, required: this.required, info_text: this.info_text })), this.hint_text && (index.h("span", { key: 'fc251683b2b85bcb7ab1ccbd96b97f21f4a1dd86', class: "mb-8 inline-block text-xs leading-tight text-light", "data-name": "radio-group-hint" }, this.hint_text))), index.h("ul", { key: '23c3fde9eab7ec2508499b9038d86d1b3783d4fc', class: classname, "data-name": "radio-group-options" }, index.h("slot", { key: '68b0da1e53f4944e82483d2cde0aa72a0fdee178' }), this.getRadios &&
            this.getRadios.map((radio) => (index.h("li", { class: "flex" }, radio)))), this.error_text && this.invalid && (index.h("span", { key: '5b4e18d59353841aa689805822c609757e195c2f', class: "text-sm text-error", "data-name": "radio-group-error-text" }, this.error_text))));
    }
