...
function replace() {
  var args = arguments,
      string = timeDate_util.toString(args[0]);
...
var require$$0 = /*@__PURE__*/getAugmentedNamespace(moment.moment);
...
var momentDurationFormatSetup = /*@__PURE__*/getDefaultExportFromCjs(momentDurationFormatExports);
...
class TimeDatePresentationUtil {
    ...
    static isCustomRange(timeRange) {
        if (timeRange.selected === date.TimeRangeDisplay.CUSTOM) {
            ...
            return (!timeDate_util.isEmpty(customRange) && !!customRange.from && !!customRange.to);
        }
    }
}

exports.TimeDatePresentationUtil = TimeDatePresentationUtil;
//# sourceMappingURL=time-date-presentation.util-uUY92u0y.js.map
