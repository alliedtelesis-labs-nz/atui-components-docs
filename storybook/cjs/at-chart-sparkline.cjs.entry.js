...
const AtChartSparkline = class {
    ...
    render() {
        return (index.h(index.Host, { key: '6db632ed63167402cfe61b75923cf3199db6a1b0', style: { height: '100%', width: '100%' } }, index.h("canvas", { key: '7440a2c69798610d904481734b16949ffc52f35f', ref: (el) => (this.canvasEl = el), class: `w-full ${heightVariants[this.height]}`, "data-name": "sparkline-canvas" })));
    }
};
