 ...
 */
function getRelativeTimeString(timestamp, locale = 'en') {
 ...
 */
function getRefreshDelay(timestamp) {
 ...
 */
function atGetRelativeTime(timestamp, locale) {
...
exports.atGetRelativeTime = atGetRelativeTime;
exports.getRefreshDelay = getRefreshDelay;
