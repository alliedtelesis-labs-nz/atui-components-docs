...
const AtMenu = class {
    ...
    render() {
        return (index.h(index.Host, { key: '4a4769a63602cb04599dee194d46bd60a961abcb', class: "relative", onBlur: () => this.trigger === 'click' && !this.disabled
            ...
            }, class: this.disabled ? 'contents' : '' }, index.h("slot", { key: '077316b810f09156b3be3d34d17474c44cc9ad72', name: "menu-trigger" }))), index.h("div", { key: '75cb8a46307c49e3dd7e226886c806085ae2574a', role: this.role, "data-position": this.position, "data-align": this.align, ref: (el) => (this.menuEl = el), "aria-hidden": `${this.isOpen ? 'false' : 'true'}`, popover: "auto", id: this.popoverId, onMouseEnter: () => this.trigger === 'hover' &&
                !this.disabled &&
            ...
            }, onClick: () => this.autoclose && this.mouseLeaveHandler(), class: "w-fit rounded-md bg-white p-4 shadow-md", "data-name": "menu-content-wrapper" }, index.h("slot", { key: '5be776be61ddc64aac52dd7b4c119b2e237c8d65' }))));
    }
