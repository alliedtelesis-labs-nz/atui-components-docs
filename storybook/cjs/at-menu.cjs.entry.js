...
const AtMenu = class {
    ...
    render() {
        return (index.h(index.Host, { key: '995b5cec6bb6fbb01447bbb9ab017e7e93653ecc', class: "relative", onBlur: (e) => {
            ...
            } }, !this.trigger_id && (index.h("div", { key: 'd830d6f2439a83f0eed5da3a4ab35900bca9eae4', "aria-haspopup": "true", "data-name": "menu-trigger", ref: (el) => (this.triggerEl = el), "aria-expanded": `${this.isOpen ? 'true' : 'false'}`, onMouseEnter: () => this.trigger === 'hover' && !this.disabled
                ? this.mouseEnterHandler()
            ...
            }, class: this.disabled ? 'contents' : '' }, index.h("slot", { key: 'c34b04f174594a151bc241c1b70ee283999c0494', name: "menu-trigger" }))), index.h("div", { key: '0de7503fc827d7f888ecd8057c3d625374d735b5', role: this.role, "data-position": this.position, "data-align": this.align, ref: (el) => (this.menuEl = el), "aria-hidden": `${this.isOpen ? 'false' : 'true'}`, popover: "manual", id: this.popoverId, onMouseEnter: () => this.trigger === 'hover' &&
                !this.disabled &&
            ...
            }, onClick: () => this.autoclose && this.mouseLeaveHandler(), class: `w-max min-w-0 flex-none rounded-md bg-white p-4 shadow-md transition-opacity duration-150 ${this.isOpen ? 'opacity-100' : 'opacity-0'}`, "data-name": "menu-content-wrapper" }, index.h("slot", { key: '35637a8b80d5bf1828fd8a697e13b0247db9ef41' }))));
    }
