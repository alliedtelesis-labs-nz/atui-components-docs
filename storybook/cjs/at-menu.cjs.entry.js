...
const AtMenu = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'bf5949e95626314a20703acae6c69f65d8cd7a25', class: "relative", onBlur: (e) => {
            ...
            }, onClick: () => this.autoclose && this.mouseLeaveHandler(), class: `bg-menu border-muted rounded-menu w-max min-w-0 flex-none border p-4 shadow-lg transition-opacity duration-150 ${this.isOpen ? 'opacity-100' : 'opacity-0'}`, "data-name": "menu-content-wrapper" }, index.h("slot", { key: '5e9a9193d1251c5164fb5fcfe9a67f2c1872144e' }))));
    }
