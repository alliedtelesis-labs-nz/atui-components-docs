...
const AtMenu = class {
    ...
    render() {
        return (index.h(index.Host, { key: '9c2a349f7994c2c2b0bccbfbd4c5956b4075265e', class: "relative", onBlur: (e) => {
            ...
            } }, !this.trigger_id && (index.h("div", { key: 'ced2742ccd32c23cda0221718d6c7b77366ea33a', "aria-haspopup": "true", "data-name": "menu-trigger", ref: (el) => (this.triggerEl = el), "aria-expanded": `${this.isOpen ? 'true' : 'false'}`, onMouseEnter: () => this.trigger === 'hover' && !this.disabled
                ? this.mouseEnterHandler()
            ...
            }, class: this.disabled ? 'contents' : '' }, index.h("slot", { key: 'e36b6b3af5a678929f9f5991b05b1d0f79cc96d8', name: "menu-trigger" }))), index.h("div", { key: 'fa124331757995fb83ba0c2db4e34effc23c00fc', role: this.role, "data-position": this.position, "data-align": this.align, ref: (el) => (this.menuEl = el), "aria-hidden": `${this.isOpen ? 'false' : 'true'}`, popover: "manual", id: this.popoverId, onMouseEnter: () => this.trigger === 'hover' &&
                !this.disabled &&
            ...
            }, onClick: () => this.autoclose && this.mouseLeaveHandler(), class: `bg-menu border-muted rounded-menu w-max min-w-0 flex-none border p-4 shadow-lg transition-opacity duration-150 ${this.isOpen ? 'opacity-100' : 'opacity-0'}`, "data-name": "menu-content-wrapper" }, index.h("slot", { key: '5e8ef32d14484fb7182fd5e177d0d14ad9c12a3b' }))));
    }
