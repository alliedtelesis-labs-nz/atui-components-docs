...
const AtInputRangeComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: '0978109914e600c78fb2ab4386f8a12656455aaf' }, index.h("div", { key: '133021cbdf9a08cfa8687c29e72511dd445cc6f3', class: "flex flex-col" }, index.h("slot", { key: 'd17e61ee48de92ed95232cf8affbe701b41e640f', name: "label" }), (this.label || this.required || this.info_text) && (index.h("at-form-label", { key: '710588d216267c967563ff326d5e904584ba38bf', label: this.label, for: this.sliderId, required: this.required && !this.readonly, info_text: this.info_text })), this.hint_text && (index.h("span", { key: '426cf0dd476dd99bf4a733a7ed1f32e196ed170f', class: "text-light inline-block text-xs leading-tight", "data-name": "slider-hint" }, this.hint_text)), this.error_text && this.invalid && (index.h("span", { key: 'a08e1544da9fe2c388ec88ab11bcc546352d6555', class: "text-error text-xs font-normal", "data-name": "slider-error" }, this.error_text)), this.warning_text && !this.invalid && (index.h("span", { key: '244462f8e036bd22d44122b0e393f980f150fa13', class: "text-warning-foreground text-xs font-normal", "data-name": "slider-warning" }, this.warning_text))), index.h("div", { key: 'acf6c2f25edccdfd7eed9a602150e14199d7ea0d', class: `mt-4 flex items-start gap-8 ${this.label_position == 'before' ? 'flex-row-reverse' : 'flex-row'}` }, index.h("div", { key: 'c3296d47a5e33a918fe2f90e691b9587466ef9e0', class: "flex flex-grow flex-col" }, index.h("div", { key: '97c2582548afd40b43d7488476147896a2ef68db', class: "flex flex-grow" }, index.h("div", { key: 'f9cbcf9787e6ba553fc70bb0be3576be6c343261', class: "range-slider", style: {
                '--min': `${this.min}`,
                '--max': `${this.max}`,
                '--step': `${this.step}`,
                '--value': `${this.value}`,
            ...
            }, ref: (el) => (this.sliderContainerRef = el) }, index.h("input", { key: '912a12a919322bb773632dc3ceeac8d283e2ecdc', list: "markers", type: "range", min: this.min, max: this.max, step: this.step, "aria-controls": this.sliderId, disabled: this.disabled || this.readonly
                ? true
            ...
            } }), this.show_value && (index.h("output", { key: '486d17407d8ddbfbaa0988418941d79c06c95669', class: "text-sm" }, this.value)), index.h("div", { key: '6c06b52d16a1cca18af447d9aafe1d1032ca5b54', class: "range-slider__progress" })))), this.show_input && (index.h("div", { key: 'be3134a49e601354b16e1c07403b1a5ffaa3811e', class: "relative flex w-80 flex-row items-center gap-8" }, index.h("at-input-numeric", { key: '8ee8de6f5a824e4f4f8636119445856f1b26647b', readonly: this.readonly, disabled: this.disabled, min: this.min, max: this.max, step: this.step, value: this.value, show_buttons: false, "data-name": "slider-text-input", onAtuiChange: (event) => this.onChange(event.detail) }), this.suffix && (index.h("span", { key: 'd50a703755fca5de72dfda93abc45ba14b6b206c', "data-name": "slider-suffix", class: "text-light absolute top-1/2 right-[36px] -translate-y-1/2" }, this.suffix)))))));
    }
};
