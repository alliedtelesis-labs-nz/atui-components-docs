...
const AtTabContent = class {
    ...
    render() {
        return (index.h("div", { key: 'b024117bd990a528d9f47c54cb84f84640402553', class: `${this.isActive ? 'flex flex-col' : 'hidden'}`, role: "tabpanel", id: `panel-${this.tab_id}`, "aria-labelledby": `tab-${this.tab_id}`, tabIndex: this.isActive ? 0 : -1, "aria-hidden": !this.isActive }, index.h("slot", { key: '8cefae6e661f0600f976bf02ea8548806ace3043' })));
    }
};
