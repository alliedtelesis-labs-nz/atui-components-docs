...
const AtTabContent = class {
    ...
    render() {
        return (index.h("div", { key: '8d2b1cf26bd893c6b06d07ff9869f6ca3c68ee4f', class: `${this.isActive ? 'flex flex-col focus-visible:outline-none' : 'hidden'}`, role: "tabpanel", id: `panel-${this.tab_id}`, "aria-labelledby": `tab-${this.tab_id}`, tabIndex: this.isActive ? 0 : -1, "aria-hidden": !this.isActive }, index.h("slot", { key: 'fde98724d744209c7bfda4d7afa447b58d7db70f' })));
    }
};
