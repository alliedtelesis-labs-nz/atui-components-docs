...
const AtTabContent = class {
    ...
    render() {
        return (index.h("div", { key: 'd07e77d75594165f125f6eadc25d8f5d9806b00b', class: `${this.isActive ? 'flex flex-col' : 'hidden'}`, role: "tabpanel", id: `panel-${this.tab_id}`, "aria-labelledby": `tab-${this.tab_id}`, tabIndex: this.isActive ? 0 : -1, "aria-hidden": !this.isActive }, index.h("slot", { key: '23c88a2c24aa9e05874cc760071f136da64444b0' })));
    }
