...
const AtTreeItemComponent = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '8d45dbf9c32c3814e4c49419b3a39f1b83df1476', class: classname, role: "button", tabIndex: 0, "aria-expanded": this.has_children
                ? this.selected
                    ? 'true'
                    : 'false'
                : undefined, "aria-disabled": this.disabled, onKeyDown: (event) => this.handleKeyDown(event), onClick: (event) => this.handleClick(event) }, index.h("div", { key: 'e93b121ea7cd9942a6a847029eb6c64113739268', class: "z-20 flex h-full w-full items-center justify-between gap-4", style: { paddingLeft: indent } }, index.h("div", { key: 'e6223844ddd6daac660f42287c5dee9f24e93f89', class: "flex gap-4" }, this.has_children && (index.h("at-icon", { key: 'cf1d1e8f94546b5a05add9559398c70152cf1e8a', "data-name": "tree-item-indicator", name: this.selected
                ? 'chevron_down'
                : 'chevron_right' })), this.label && (index.h("span", { key: 'dd224c5ba2a5349ea82f9b66b0f96025d99ef2c4', class: "leading-[16px]", "data-name": "tree-item-label" }, this.label)), index.h("slot", { key: '9069cccaa8dd27c36191587baefed78d85cf13ba', name: "label" })), index.h("slot", { key: '6d382fc9bd620811ecbab7c405b451324749c6f3' })), index.h("div", { key: '3ae1da9ba9d422f59c6466e9e351b0b84eabf9ea', "data-name": "focus-indicator", role: "presentation", class: "pointer-events-none absolute top-0 left-0 z-10 h-full w-full transition-colors duration-300 ease-in-out" })));
    }
};
