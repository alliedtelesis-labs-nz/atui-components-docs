...
const AtTreeItemComponent = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'c481b4dddb2ee0924390efa3c9b040d76be257c7', class: classname, role: "button", tabIndex: 0, "aria-expanded": this.has_children
                ? this.selected
                    ? 'true'
                    : 'false'
                : undefined, "aria-disabled": this.disabled, onKeyDown: (event) => this.handleKeyDown(event), onClick: (event) => this.handleClick(event) }, index.h("div", { key: '786c8551f2d71df83c7ef85963a5dadf46df9fac', class: "z-20 flex h-full w-full items-center justify-between gap-4", style: { paddingLeft: indent } }, index.h("div", { key: '29c1a40971166a1cbcd5f862129e5ab7199a5ea3', class: "flex gap-4" }, this.has_children && (index.h("at-icon", { key: 'c69780d8cc5e64151a4d5fb64aa3dcb9ac76d55a', "data-name": "tree-item-indicator", name: this.selected
                ? 'chevron_down'
                : 'chevron_right' })), this.label && (index.h("span", { key: 'b12f726550faf5319d426c39e914f705134c155c', class: "leading-[16px]", "data-name": "tree-item-label" }, this.label)), index.h("slot", { key: 'ed27a1c34610ff335f92507d9ab1726e3c0f6414', name: "label" })), index.h("slot", { key: '37c9f88dbae20544ec6eef6a0d2cae02c75baed6' })), index.h("div", { key: '9127e16e27a3125e50d22b36f4f5ce8043b311e8', "data-name": "focus-indicator", role: "presentation", class: "pointer-events-none absolute top-0 left-0 z-10 h-full w-full transition-colors duration-300 ease-in-out" })));
    }
};
