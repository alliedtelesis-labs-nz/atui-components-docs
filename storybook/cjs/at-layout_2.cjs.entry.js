...
const AtLayout = class {
    ...
    render() {
        return index.h(index.Host, { key: '3db356e2930d30deeb009a2092d796322769f3fb' }, this.layoutElement);
    }
};
...
const AtTabTrigger = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'f1a173ae51e109301d060a545c8a3cde1ec0c4c3', role: "tab", tabindex: "0", "aria-selected": this.is_active, "data-active": this.is_active ? 'true' : 'false', "data-name": `tab-${this.tab_id}`, onKeyDown: (event) => this.handleKeyDown(event), class: `${classname} ${this.fill ? 'flex-1' : undefined}` }, this.tab_title, index.h("slot", { key: '33c1a7790f134b505d18f922a24e430fa3899ed1' })));
    }
};
