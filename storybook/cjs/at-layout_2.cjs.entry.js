...
const AtLayout = class {
    ...
    render() {
        return index.h(index.Host, { key: '3ac56628f05d3be0217c183397e62a0d3f9bd8a8' }, this.layoutElement);
    }
};
