...
const AtLayout = class {
    ...
    render() {
        return index.h(index.Host, { key: '2bbf3d7019cb8fc9d3a7695867e4f2d2036a54d7' }, this.layoutElement);
    }
};
