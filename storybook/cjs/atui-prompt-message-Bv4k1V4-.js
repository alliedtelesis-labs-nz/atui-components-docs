...
const messageVariants = index$1.cva('rounded-lg py-4 text-base', {
    variants: {
        role: {
...
const AtuiPromptMessage = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '5c5df178f5e289a410aa1bc238bf484ef247cef9', class: "flex w-full gap-8", "data-name": "message-container", "data-role": this.role }, index.h("div", { key: '213edb1718882c907998f0fba0247fa2b4b0be3d', class: "flex flex-1 flex-col" }, this.name && (index.h("span", { key: 'ab7b79b2e9046e3610d127a804a2a8f9c7108ab5', class: "text-light self-start text-sm", "data-name": "message-name" }, this.name)), index.h("div", { key: 'f41d9da7b1249b310fea96d005ea2303e12a6f21', class: messageClasses }, this.renderContent()), this.renderActions())));
    }
    get el() { return index.getElement(this); }
};

exports.AtuiPromptMessage = AtuiPromptMessage;
//# sourceMappingURL=atui-prompt-message-Bv4k1V4-.js.map
