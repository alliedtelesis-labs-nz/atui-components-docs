...
class TimeDateUtil {
    ...
    static convertSecondsToUnit(seconds, unit, decimalPlaces, roundUp = true) {
        const momentSeconds = moment__default.default.duration(seconds, exports.Duration[exports.TimeUnit.SECONDS]);
    ...
    static convertToSeconds(time) {
        const valueInUnit = moment__default.default.duration(time.value, exports.Duration[time.unit]);
        return valueInUnit.asSeconds();
    }
    static getSecondsAgoFromDate(date) {
        return moment__default.default(new Date()).diff(date, exports.Duration.SECONDS);
    }
    static getDateFromRelativeTime(time) {
        ...
        return moment__default.default().subtract(time.value, exports.Duration[time.unit]).toDate();
    }
    /**
    ...
    static getAbsoluteDateRange(time) {
        return {
            startDate: moment__default.default(time.from).toDate(),
            endDate: moment__default.default(time.to).toDate(),
        };
    }
    ...
    static getDataPointIntervalFor30SecPoller(startDate, endDate) {
        const diffSeconds = moment__default.default(endDate).diff(startDate, exports.Duration.SECONDS);
    ...
    static floorDateByTimeUnit(date, unit) {
        return moment__default.default(date).startOf(unit).toDate();
    }
    /**
    ...
    static isSameDateByUnit(date1, date2, unit) {
        return moment__default.default(date1).isSame(date2, unit);
    }
...
//# sourceMappingURL=time-date.util-B46y0gtD.js.map
