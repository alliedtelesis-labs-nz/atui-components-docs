...
const AtTreeComponent = class {
    ...
    render() {
        return (index.h("div", { key: 'fa5801f9a032eb2058bf4390baeeb009eb7412c7', class: "w-full" }, index.h("slot", { key: 'f61db1a39c8f46e32a51be9a630d615f8ca75e8a' }), this.flattenedItemList &&
