...
const AtTreeComponent = class {
    ...
    render() {
        return (index.h("div", { key: 'f4443a6e9ca39983c4e3a1bfdacc7bfa76952fa0', class: "w-full" }, index.h("slot", { key: '44256a95ffabe2ec5ca8b57184a8301fd4e47fd8' }), this.flattenedItemList &&
