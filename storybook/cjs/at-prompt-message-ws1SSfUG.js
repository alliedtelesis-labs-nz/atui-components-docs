...
const AtPromptMessage = class {
    constructor(hostRef) {
         ...
         */
        this.score = exports.VoteStatus.None;
        /**
        ...
        this.handleVote = (score) => {
            const newScore = this.score === score ? exports.VoteStatus.None : score;
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'a4e0a8760cd49e99cea8455e7a4cb42901b13ec5', class: "flex w-full gap-8", "data-name": "message-container", "data-role": this.role }, index.h("div", { key: '8c630ec2cace06160d271d6e3937a53f4ab026a0', class: "flex flex-1 flex-col" }, this.name && (index.h("span", { key: '63d8433f5a708a3d1323566b9ac45e2040bf1d68', class: "text-light self-start text-sm", "data-name": "message-name" }, this.name)), index.h("div", { key: '4d1b5e2847ad0097fc8c383288722aacb06f6dd4', class: messageClasses }, this.renderContent()), this.renderActions())));
    }
    get el() { return index.getElement(this); }
};

exports.AtPromptMessage = AtPromptMessage;
//# sourceMappingURL=at-prompt-message-ws1SSfUG.js.map
