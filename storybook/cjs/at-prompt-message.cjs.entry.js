...
const getMessageClasses = classlist.classlist('rounded-lg py-4 text-base richtext', messageVariantsConfig);
const AtPromptMessage = class {
    ...
    renderContent() {
        ...
        const animationClass = this.response_animation === 'fade' ||
            ...
            ? 'at-prompt-fade-in'
            : '';
        return (index.h("div", { class: `prose prose-sm preserve-newlines max-w-none ${animationClass}`, "data-name": "message-content" }, index.h("slot", null), this.renderSafeContent(contentToDisplay)));
    }
    renderSafeContent(content) {
        if (this.role === 'assistant') {
            const html = g.parse(content);
            const safeHtml = purify.sanitize(html);
            return index.h("span", { innerHTML: safeHtml });
        }
        else {
            return index.h("span", null, content);
        }
    }
    render() {
        ...
        return (index.h(index.Host, { key: '84af4328c7f2cae14d007bb931522caead4778f2', class: "flex w-full gap-8", "data-name": "message-container", "data-role": this.role }, index.h("div", { key: 'cbd1438d5ff55521dd0bb1ab7191a663d0cb6fa5', class: "flex flex-1 flex-col" }, this.name && (index.h("span", { key: 'd36eb778611e35bf4d41a99f3b2442876ee78231', class: "text-muted self-start text-sm", "data-name": "message-name" }, this.name)), index.h("div", { key: 'a9f8dd0042db0d017a1fac2570a81806899719c0', class: messageClasses }, this.renderContent()), this.renderActions())));
    }
