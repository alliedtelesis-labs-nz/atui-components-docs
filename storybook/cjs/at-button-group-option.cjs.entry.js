...
const AtButtonGroupOption = class {
    ...
    render() {
        ...
        return (index.h("button", { key: '67314e516038b530778e7ee1019416140de70a45', class: classname, role: "radio", tabindex: 0, "aria-checked": this.is_active, disabled: this.disabled, onClick: (event) => this.handleClick(event), "data-name": "button-group-option", type: "button" }, this.icon && (index.h("span", { key: 'b3c71c169228ee6e574edff96a9bdb15d64c4513', class: `material-icons h-16 w-16 text-[16px] leading-[16px]`, "data-name": "button-group-option-icon" }, this.icon)), index.h("slot", { key: '4ed5c0ef3bd3ffa5a38edc0930189005f6f291d4', name: "icon" }), index.h("slot", { key: '44e48ff86a7eee8bdde84d519827f94406271c59' }, this.label ? this.label : this.icon ? '' : this.value)));
    }
};
