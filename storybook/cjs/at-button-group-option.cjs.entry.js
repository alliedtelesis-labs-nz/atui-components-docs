...
const AtButtonGroupOption = class {
    ...
    render() {
        ...
        return (index.h("button", { key: 'a0111102f9cca1eaf70f27a8d62b8b0c00b4014d', class: classname, role: "radio", tabindex: 0, "aria-checked": this.is_active, disabled: this.disabled, onClick: (event) => this.handleClick(event), "data-name": "button-group-option", type: "button" }, index.h("slot", { key: '1ea80bd45a940ff976448023be09e9ae683f0067', name: "icon", "data-name": "button-group-option-icon" }), index.h("slot", { key: '23b3230da9ca30076c816d9f2486b6aad0bdbd9d' }), this.label ? this.label : hasIcon ? '' : this.value, index.h("slot", { key: '8f4eea32aad9f8b06e5b6ba5d14c8f8e3d66c213', name: "after" })));
    }
};
