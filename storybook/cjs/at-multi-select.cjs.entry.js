...
const AtMultiSelectComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: '74bf1deaad2b65bcfacb6148fe0799daf0bf8bf7', class: "group/select", onFocusout: async (event) => {
            ...
            } }, this.renderLabel(), index.h("at-menu", { key: '3b623e93f3c69639ce5f3dc88d942e26b86b6697', ref: (el) => (this.menuRef = el), trigger: "click", align: "start", width: this.parentWidth, role: "listbox", autoclose: false, disabled: this.disabled || this.readonly, onAtuiMenuStateChange: (event) => this.updateIsOpenState(event) }, this.renderInput(), !this.disabled && !this.readonly
            ? this.renderOptions()
            : null), index.h("div", { key: '7ddff5faac1374fddc05e2e5c5ae91ccfd763655' }, this.error_text && this.invalid && (index.h("span", { key: '34d55de9a03cc0feaf2a66516acce3e95f3faecd', "data-name": "multi-select-error", class: "text-error" }, this.error_text)))));
    }
    renderLabel() {
    ...
    renderInput() {
        ...
        return (index.h("div", { class: classname, slot: "menu-trigger", "data-name": "multi-select-input-container", tabindex: 0 }, index.h("at-chip-list", { size: "sm", class: "w-full focus-within:ring-0", readonly: this.readonly, disabled: this.disabled, show_clear_all: this.clearable, onAtRemoveChip: (event) => this.handleRemoveChip(event), chips: this.getSelectedLabels(), "data-name": "multi-select-chips-inside" }, this.value.length === 0 && (index.h("div", { class: "text-body text-disabled pointer-events-none select-none" }, this.placeholder))), !this.readonly && !this.disabled && (index.h("div", { class: "absolute right-4 flex items-center" }, index.h("div", { class: "user-select-none fill-foreground pointer-events-none bg-transparent p-4", role: "presentation", tabindex: -1 }, index.h("at-icon", { class: "fill-foreground", name: this.isOpen ? 'caret_up' : 'caret_down', "data-name": "button-icon-right" }))))));
    }
    renderOptions() {
