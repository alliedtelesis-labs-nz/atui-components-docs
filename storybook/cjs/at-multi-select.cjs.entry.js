...
const AtMultiSelectComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'd225063119800885e4ca1d86c9feaf162e65fa9e', class: "group/select", onFocusout: async (event) => {
            ...
            } }, this.renderLabel(), index.h("at-menu", { key: '13954a5533008e247e6cb12f2d7b7f6c0bd76b2f', ref: (el) => (this.menuRef = el), trigger: "click", align: "start", width: this.parentWidth, max_height: this.menu_max_height, role: "presentation", autoclose: false, disabled: this.disabled || this.readonly, onAtuiMenuStateChange: (event) => this.updateIsOpenState(event) }, this.renderInput(), !this.disabled && !this.readonly
            ? this.renderOptions()
            : null), index.h("div", { key: 'e09d19eb186f05eb10fedb72046d60c7e90a2a44' }, this.error_text && this.invalid && (index.h("span", { key: '5fb0f8bf80b62c6a971327dccf4f0d44929d7f89', "data-name": "multi-select-error", class: "text-error" }, this.error_text)))));
    }
    renderLabel() {
