...
const AtChartGauge = class {
    ...
    initChart() {
        chartColor$1.Chart.register(chartColor$1.DoughnutController, chartColor$1.ArcElement, chartColor$1.plugin_tooltip, chartColor$1.index);
        ...
        if (this.center_value || this.center_text) {
            plugins.push(this.getDrawCenterTextPlugin(chartColor.readChartTypography(this.canvasEl)));
        }
    ...
    render() {
        return (index.h(index.Host, { key: '021b603817c33096d40540db89011838263c9999', style: { height: '100%', width: '100%' } }, index.h("canvas", { key: 'fd84428af8af5fa1e19a64805445b2f4ab0aaded', ref: (el) => (this.canvasEl = el), class: `w-full ${heightVariants[this.height]}`, "data-name": "gauge-canvas" })));
    }
};
