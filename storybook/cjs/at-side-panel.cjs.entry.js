...
const AtSidePanelComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'd3e260db7c3b897e57e5e862412876d6cd480a00', "data-open": this.isOpen }, index.h("dialog", { key: 'd7a261b445f8096d2423e14981eea1e70f28604a', ref: (el) => (this.panelDialog = el), class: `${this.backdrop ? 'backdrop' : ''}`, onClose: this.handleDialogClose, onKeyDown: this.handleKeyDown }, index.h("div", { key: 'edb594bbb5c9cf19dfcb8214ba9117e8bd0c51ba', "data-scrollable": this.has_scrollbar, "data-open": this.isOpen, class: `container origin-${this.origin} size-${this.size} size-${this.size} position-${this.position}`, ref: (el) => (this.sidePanelWrapper = el), "data-name": "container" }, index.h("header", { key: 'd8bf230fdfce78edb12088e126566744f9e563a2', class: "header", "data-name": "header" }, index.h("div", { key: '7e4d06e33275285d99e83d63e87508b25446bbf8' }, this.panel_title && (index.h("h3", { key: '1ee8c32bb8193e7dd109a6973806deede77b3e9a', class: "title" }, this.panel_title)), this.panel_subtitle && (index.h("p", { key: '9dc6da2919dfcf5f125000a3c317b3785526461b', class: "subtitle" }, this.panel_subtitle))), this.has_close_button && (index.h("at-button", { key: '81e5a398a538bce23c5d06a2dafb7cc4bc3e6232', size: "md", type: "secondaryText", "data-name": "panel-close", onClick: this.handleClose }, index.h("at-icon", { key: '96bd49a61952c72c700da19a287feedaac84ebdf', slot: "icon", name: "close" })))), index.h("div", { key: '050ff18083dca14751fc7b4be87f45e15be4c79b', "data-name": "content", class: "content" }, index.h("slot", { key: 'f1e1095979f4a92da09e6cf06c7ae4fe45c36571' }))))));
    }
};
