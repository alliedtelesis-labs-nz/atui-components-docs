...
const AtSidePanelComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: '32658be7a9561819471094bf4c52e6e8b09c7bbf', "data-open": this.isOpen }, index.h("dialog", { key: '6b1b0a4b074ef24e4ff98ad634a0d625fc4afd4b', ref: (el) => (this.panelDialog = el), class: `${this.backdrop ? 'backdrop' : ''}`, onClose: this.handleDialogClose, onKeyDown: this.handleKeyDown }, index.h("div", { key: 'c3f081bab167aeef2bb56575df43bf03e0778cd9', "data-scrollable": this.has_scrollbar, "data-open": this.isOpen, class: `container origin-${this.origin} size-${this.size} size-${this.size} position-${this.position}`, ref: (el) => (this.sidePanelWrapper = el), "data-name": "container" }, index.h("header", { key: 'd5dc94646bdb63ed79e108bb361620d715681072', class: "header", "data-name": "header" }, index.h("div", { key: 'e36191e824dabc589415de78ccff81aac84e0ed2' }, this.panel_title && (index.h("h3", { key: 'ce83db08def799e1284b5ab2dfe03c943fef15de', class: "title" }, this.panel_title)), this.panel_subtitle && (index.h("p", { key: '257a966f8b3a9c5bbbe11c61914c3024cb21ecd8', class: "subtitle" }, this.panel_subtitle))), this.has_close_button && (index.h("at-button", { key: 'c183baa8c15a0183cd40fcf97db1476bc2a69a19', size: "md", icon: "close", type: "secondaryText", "data-name": "panel-close", onClick: this.handleClose }))), index.h("div", { key: '8e6c7fd36e684d11fa11a029cee7f8653194edde', "data-name": "content", class: "content" }, index.h("slot", { key: 'c5e72298f0e29334cf3a2ca1524dfbdcf8100328' }))))));
    }
};
