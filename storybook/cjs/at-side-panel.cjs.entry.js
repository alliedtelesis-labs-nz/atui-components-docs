...
const AtSidePanelComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'fdf7aea329d05393b9252efe027c42ac6aaaffe2', "data-open": this.isOpen }, index.h("dialog", { key: '5354a208672f3e43f057a2f46c232a510cd2f018', ref: (el) => (this.panelDialog = el), class: `${this.backdrop ? 'backdrop' : ''}`, onClose: this.handleDialogClose, onKeyDown: this.handleKeyDown }, index.h("div", { key: '6fb325dacb141f20258d417fc2e76f0d92c6e4da', "data-scrollable": this.has_scrollbar, "data-open": this.isOpen, class: `container origin-${this.origin} width-${this.size} size-${this.size} position-${this.position}`, ref: (el) => (this.sidePanelWrapper = el), "data-name": "container" }, index.h("header", { key: '0ffb86ff5e846abdf30b76dee3b8d9e8c233f4a9', class: "header", "data-name": "header" }, index.h("div", { key: '1dd71f9d1ed3d32a47ae6fbea1c3d9209a8c1643' }, index.h("slot", { key: '3fcf994d92a71be72b67a1e9448f1040b7a154de', name: "title" }), this.panel_title && (index.h("h3", { key: 'a7d904feabb10004a87dd5ee62f13ef8b568ad8f', class: "title" }, this.panel_title)), this.panel_subtitle && (index.h("p", { key: '7d7c0dfd8ef49115ec869a59813eeccb2b0f6b11', class: "subtitle" }, this.panel_subtitle))), index.h("div", { key: '35918110130ff7a8d9cff3e79006096fc4d96d93' }, index.h("slot", { key: '82a9059b37f5448b3a583db70f1bb0258992256b', name: "actions" }), this.has_close_button && (index.h("at-button", { key: '79b91cbd234ebcc0d6ff2445b7c1ccf256b8d6a2', size: "md", type: "secondaryText", "data-name": "panel-close", onClick: this.handleClose }, index.h("at-icon", { key: '981789d2e76ec56efb56bdc78c2e1d9720953c58', slot: "icon", name: "close" }))))), index.h("div", { key: 'de8d2d62980073dcec91938dc75a23a323d6a7bd', "data-name": "content", class: "content" }, index.h("slot", { key: '905d7f61aefba6626385e2be9e87718b31e31869' }))))));
    }
};
