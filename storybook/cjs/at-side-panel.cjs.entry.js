...
const AtSidePanelComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: '6803a16f5bdd8e221a25b1260a99836f07d869d2', "data-open": this.isOpen }, index.h("dialog", { key: '28136f18dc21cf16575cbcc1a57ad1afd6ffe30e', ref: (el) => (this.panelDialog = el), class: `${this.backdrop ? 'backdrop' : ''}`, onClose: this.handleDialogClose, onKeyDown: this.handleKeyDown }, index.h("div", { key: '6ffcdf8f829eee95e3759492ee5bd3d0cc971e99', "data-scrollable": this.has_scrollbar, "data-open": this.isOpen, "data-has-footer": this.hasFooter ? 'true' : null, class: `container origin-${this.origin} width-${this.size} size-${this.size} position-${this.position}`, ref: (el) => (this.sidePanelWrapper = el), "data-name": "container" }, index.h("header", { key: '8507f2721ccb59ed357f1eb2108e2539da3ab1eb', class: "header", "data-name": "header" }, index.h("div", { key: 'bc33ee17c26969df47c656325ede12ddea45d66d' }, index.h("slot", { key: 'c8f72a4f9eeda31cfde3cf156355edf9b1cb8d4e', name: "title" }), this.panel_title && (index.h("h3", { key: '6d1e7a3860c262db75367ebbf054b38170e3b1b3', class: "title" }, this.panel_title)), this.panel_subtitle && (index.h("p", { key: 'fd10c6a349d3056bffd4a78d4a544bc35c5dd4bd', class: "subtitle" }, this.panel_subtitle))), index.h("div", { key: '4981cf765e504593dec879a0214196a4eb1bdeb7' }, index.h("slot", { key: 'e1dd28c9c31d9a2ebc45476284852694c04d7e6f', name: "actions" }), this.has_close_button && (index.h("at-button", { key: '8a44755e50e2e0a677309a53561340abe509d734', size: "md", type: "secondaryText", "data-name": "panel-close", onClick: this.handleClose }, index.h("at-icon", { key: 'eb7fba82370f3efadc0f97d7cf3fdc12e53fff84', slot: "icon", name: "close" }))))), index.h("div", { key: 'c6312969eb9984c50c89dae9fee60d2a4a05a514', "data-name": "content", class: "content" }, index.h("slot", { key: 'ff8adae3576b6d96a6c1185834958a3b7f9c3cac' })), index.h("div", { key: '6c1b8540e1ed9999c88a75f2c8c486c4538abafd', "data-name": "footer", class: "footer" }, index.h("slot", { key: 'd9449146242a86b5cbe230c23af5ce6ef3eb2a0e', name: "footer" }))))));
    }
};
