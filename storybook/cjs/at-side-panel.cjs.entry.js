...
const AtSidePanelComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'e92602e1fd1555280f2203210ad3450706262bff', "data-open": this.isOpen }, index.h("dialog", { key: '92edba78ce9cc3f513f837c4a692185c1a3c414e', ref: (el) => (this.panelDialog = el), class: `${this.backdrop ? 'backdrop' : ''}`, onClose: this.handleDialogClose, onKeyDown: this.handleKeyDown }, index.h("div", { key: 'df8ed2167b6d12339d61f08a5ba6fb17f8d386a0', "data-scrollable": this.has_scrollbar, "data-open": this.isOpen, class: `container origin-${this.origin} width-${this.size} size-${this.size} position-${this.position}`, ref: (el) => (this.sidePanelWrapper = el), "data-name": "container" }, index.h("header", { key: 'adf292be650619f4da1ee583819cec15d46313ee', class: "header", "data-name": "header" }, index.h("div", { key: '907366c050ead97253996913628580dbc02b11e1' }, index.h("slot", { key: '5fccd09f30901f990482e3379712f7b2458ac3f6', name: "title" }), this.panel_title && (index.h("h3", { key: 'a778321461bc16148e5ee6a21a9348109f71253c', class: "title" }, this.panel_title)), this.panel_subtitle && (index.h("p", { key: 'b49cb863e1097c74f46f5cb081dcdd57ae67f78f', class: "subtitle" }, this.panel_subtitle))), index.h("div", { key: '2e42039f6f51804fd856fd6dba70131269564b6a' }, index.h("slot", { key: '0bcf150ab99a7813dd63a62241b27b43d9d1abad', name: "actions" }), this.has_close_button && (index.h("at-button", { key: 'e8b74a03b877b04498998f145bca34e46a8a7f71', size: "md", type: "secondaryText", "data-name": "panel-close", onClick: this.handleClose }, index.h("at-icon", { key: '6d4269fde14b3b8f000701a0247194a7cb774185', slot: "icon", name: "close" }))))), index.h("div", { key: '2d08e7225ba697d4a48fc949f4ada6f177d751b3', "data-name": "content", class: "content" }, index.h("slot", { key: 'feb63264a5e5764cbb05ce2b078c4d15c8a7387c' }))))));
    }
};
