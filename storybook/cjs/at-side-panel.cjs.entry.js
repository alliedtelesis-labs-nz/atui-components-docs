...
const AtSidePanelComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: '1b648cac830f68b7d365667c02c0f032e41b64e4', "data-open": this.isOpen }, index.h("dialog", { key: '7b3bb3ca6f6f68c020e075d46d018fc73d59f380', ref: (el) => (this.panelDialog = el), class: `${this.backdrop ? 'backdrop' : ''}`, onClose: this.handleDialogClose, onKeyDown: this.handleKeyDown }, index.h("div", { key: 'a5027a63253baba4a924faf470103f3575abe9ec', "data-scrollable": this.has_scrollbar, "data-open": this.isOpen, class: `container origin-${this.origin} size-${this.size} size-${this.size} position-${this.position}`, ref: (el) => (this.sidePanelWrapper = el), "data-name": "container" }, index.h("header", { key: '67eadef3b6209801bc52486e5c43ae919dff76d8', class: "header", "data-name": "header" }, index.h("div", { key: 'ce6d608039d025cb70d85f3a303c1b8f87fda782' }, this.panel_title && (index.h("h3", { key: 'ca0aa0e73b205e2ec804eedc92147f9f286c5963', class: "title" }, this.panel_title)), this.panel_subtitle && (index.h("p", { key: '310afddb7db8fadfa947f24714b05ff14a900f2b', class: "subtitle" }, this.panel_subtitle))), this.has_close_button && (index.h("at-button", { key: '6e1e02abf55152555fbbcf26e32db918d4477eaa', size: "md", icon: "close", type: "secondaryText", "data-name": "panel-close", onClick: this.handleClose }))), index.h("div", { key: '75ead4601356ffcde0e645f235838bf85da273fe', "data-name": "content", class: "content" }, index.h("slot", { key: 'b02f67b39fa7104bae0bb7be3a16e39781624af9' }))))));
    }
};
