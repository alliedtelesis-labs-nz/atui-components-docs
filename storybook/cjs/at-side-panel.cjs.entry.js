...
const AtSidePanelComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: '242c3707814be435abb08bb21b0e6014c1010b0a', "data-open": this.isOpen }, index.h("dialog", { key: 'a3222a6fbf1003bfb56ba36934575f28a60ea9eb', ref: (el) => (this.panelDialog = el), class: `${this.backdrop ? 'backdrop' : ''}`, onClose: this.handleDialogClose, onKeyDown: this.handleKeyDown }, index.h("div", { key: 'e789875665863eb8bcf6c7b0fde605efb3c13497', "data-scrollable": this.has_scrollbar, "data-open": this.isOpen, "data-has-footer": this.hasFooter ? 'true' : null, class: `container origin-${this.origin} width-${this.size} size-${this.size} position-${this.position}`, ref: (el) => (this.sidePanelWrapper = el), "data-name": "container" }, index.h("header", { key: '3c423e7f307c6fbc29ebb4cace1be6bf8a0b6681', class: "header", "data-name": "header" }, index.h("div", { key: 'ad58d88e89d9f44d222ebea566ba2e8be58750ae' }, index.h("slot", { key: 'fd4ee3c21d1a4e35ae3d3ad83824ea5767582a0b', name: "title" }), this.panel_title && (index.h("h3", { key: 'e06f1a946820a5a6f66176428f88a7bdf0c9487f', class: "title" }, this.panel_title)), this.panel_subtitle && (index.h("p", { key: 'f96b7a71a622b0d2dc14a5aac1e9ac0f1626f668', class: "subtitle" }, this.panel_subtitle))), index.h("div", { key: 'd4ce21e17be391d36fc4a8a447e16f9851d57db2' }, index.h("slot", { key: '90f5d8d12db2d0af66e309d7e50f8004d112aa92', name: "actions" }), this.has_close_button && (index.h("at-button", { key: '249124e11c4bdb307a3d19eeec5f40fefacecf33', size: "md", type: "secondaryText", "data-name": "panel-close", onClick: this.handleClose }, index.h("at-icon", { key: '3935dfa9eeca7302221d54ad369571478870be30', slot: "icon", name: "close" }))))), index.h("div", { key: '37dd05f71fe4409f4172fe0fd0a9103ffef81db1', "data-name": "content", class: "content" }, index.h("slot", { key: '5e4879d832084327d651865e69434149d145f6b0' })), index.h("div", { key: 'df9b601b32f8732513f738bb7a70b749dfe83279', "data-name": "footer", class: "footer" }, index.h("slot", { key: '0279efd82e96a47a3970442a869f7d2c177f3c95', name: "footer" }))))));
    }
};
