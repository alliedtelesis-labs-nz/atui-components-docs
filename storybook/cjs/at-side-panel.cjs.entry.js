...
const AtSidePanelComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: '9ebb674ab311acc8ad0604cab069fd475cd88bfa', "data-open": this.isOpen }, index.h("dialog", { key: 'e69d03a239d597300b31b258f9fa2140092716fa', ref: (el) => (this.panelDialog = el), class: `${this.backdrop ? 'backdrop' : ''}`, onClose: this.handleDialogClose, onKeyDown: this.handleKeyDown }, index.h("div", { key: 'bbd408d15e2d95d899f8178d97f9d130dd923df1', "data-scrollable": this.has_scrollbar, "data-open": this.isOpen, class: `container origin-${this.origin} size-${this.size} size-${this.size} position-${this.position}`, ref: (el) => (this.sidePanelWrapper = el), "data-name": "container" }, index.h("header", { key: '1ac4b183a02e450e3cf3a730f472c08453bc3d85', class: "header", "data-name": "header" }, index.h("div", { key: 'a4571170a5b0ad730b34ec4e1abcb85f0ade11fa' }, this.panel_title && (index.h("h3", { key: 'ec2a3f34f4a4d0507665d4b443a277e8fdc71103', class: "title" }, this.panel_title)), this.panel_subtitle && (index.h("p", { key: '2d3a47dc32bb9270a8d23b25d7849081cb0f11be', class: "subtitle" }, this.panel_subtitle))), this.has_close_button && (index.h("at-button", { key: 'cc2ff4c544385af85f883c13d7c20c8838daca1e', size: "md", type: "secondaryText", "data-name": "panel-close", onClick: this.handleClose }, index.h("at-icon", { key: '61534b97eb0a457038fe7a0b2188f9b856998a9f', slot: "icon", name: "close" })))), index.h("div", { key: '8b041bc0a596c7002f6076082c142a0ec56c4bf2', "data-name": "content", class: "content" }, index.h("slot", { key: 'e3899a8134e8970d7d98f597fbc2ce0ebea9e25d' }))))));
    }
};
