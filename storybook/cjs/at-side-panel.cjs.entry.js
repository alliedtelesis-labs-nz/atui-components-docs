...
const AtSidePanelComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: '64b4763f5250e2b9b8828ac0f015bb609d20e244', "data-open": this.isOpen }, index.h("dialog", { key: '2be15eab3ac7a80c7957d307c5b6cfd61f3368b2', ref: (el) => (this.panelDialog = el), class: `${this.backdrop ? 'backdrop' : ''}`, onClose: this.handleDialogClose, onKeyDown: this.handleKeyDown }, index.h("div", { key: 'af88065476557476649e9e0712d22ec287db9dd3', "data-scrollable": this.has_scrollbar, "data-open": this.isOpen, class: `container origin-${this.origin} width-${this.size} size-${this.size} position-${this.position}`, ref: (el) => (this.sidePanelWrapper = el), "data-name": "container" }, index.h("header", { key: 'b051391c6c0458cbd1b8b438a815a48bb65bf3d8', class: "header", "data-name": "header" }, index.h("div", { key: 'd61d4216f4510c50495f69338f88500a98eb6de2' }, this.panel_title && (index.h("h3", { key: 'ba90029c333bfdf355b2e97a743417e3c7523d6a', class: "title" }, this.panel_title)), this.panel_subtitle && (index.h("p", { key: '6b735d61f4380f3ea118c49f62892dae65ee0c18', class: "subtitle" }, this.panel_subtitle))), this.has_close_button && (index.h("at-button", { key: '5ceffb7c0f94915cead575b702e9b278d8e38f81', size: "md", type: "secondaryText", "data-name": "panel-close", onClick: this.handleClose }, index.h("at-icon", { key: '931f49a5c2c998a337aef6d5b585152ab0fd4430', slot: "icon", name: "close" })))), index.h("div", { key: '84b2044dbd6287a0985ef389b1ab568a0d5929db', "data-name": "content", class: "content" }, index.h("slot", { key: 'e30ef29dcd29607f5e95f40c1d145fcb74ab3a10' }))))));
    }
};
