...
const AtSidePanelComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: '373bafb7e7b6aa456c8cbb4b9a37564e7176b53c', "data-open": this.isOpen }, index.h("dialog", { key: '10acb097edd28bd10e1e76e21d6ffecfa5b7363e', ref: (el) => (this.panelDialog = el), class: `${this.backdrop ? 'backdrop' : ''}`, onClose: this.handleDialogClose, onKeyDown: this.handleKeyDown }, index.h("div", { key: '8bcf8bc38eb0fb538451aed859cec4fc143d0557', "data-scrollable": this.has_scrollbar, "data-open": this.isOpen, "data-has-footer": this.hasFooter ? 'true' : null, class: `container origin-${this.origin} width-${this.size} size-${this.size} position-${this.position}`, ref: (el) => (this.sidePanelWrapper = el), "data-name": "container" }, index.h("header", { key: '15333178663ada52f5d11bcb7b8a33e843846228', class: "header", "data-name": "header" }, index.h("div", { key: '4677a6cd584ea91ba744357ab76325016d236e29' }, index.h("slot", { key: '332dd7b262a0b82398c5389c99be2cf98f1427cb', name: "title" }), this.panel_title && (index.h("h3", { key: '05ae57b901bba850e8bc1ecbb62f2cad4fdbe6e5', class: "title" }, this.panel_title)), this.panel_subtitle && (index.h("p", { key: 'f0379a2eb40457bd23978397a70684ba7fbcf5a5', class: "subtitle" }, this.panel_subtitle))), index.h("div", { key: '78764103e36bd16a0839b6a134ffa7a1a398b7ce' }, index.h("slot", { key: 'aeb9119920c30dd57a817687783f2a3ad7e5661b', name: "actions" }), this.has_close_button && (index.h("at-button", { key: '999d1736ce6620bd12ba623f75724235b6efb81d', size: "md", type: "secondaryText", "data-name": "panel-close", onClick: this.handleClose }, index.h("at-icon", { key: 'cb44e2a6514f61c85b168a7832d70ac353462cae', slot: "icon", name: "close" }))))), index.h("div", { key: '5d006dcb572d8e5ff086a6741af3129dcab54ac3', "data-name": "content", class: "content" }, index.h("slot", { key: 'd995b4b819815fa8e9d97717aba21825e401645c' })), index.h("div", { key: 'f337ab27de06cff9eae83cffd9dff226affeff65', "data-name": "footer", class: "footer" }, index.h("slot", { key: '9832b20e215cfa37114d9a77a3c5b906829f0e55', name: "footer" }))))));
    }
};
