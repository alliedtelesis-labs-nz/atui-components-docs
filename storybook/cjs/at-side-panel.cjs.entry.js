...
const AtSidePanelComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: '962f74decc3ec389f5ed35e2ead18c30f268b6aa', "data-open": this.isOpen }, index.h("dialog", { key: '3e5b6492c7f739b008fbb932ef12664b4a591c60', ref: (el) => (this.panelDialog = el), class: `${this.backdrop ? 'backdrop' : ''}`, onClose: this.handleDialogClose, onKeyDown: this.handleKeyDown }, index.h("div", { key: 'bd2f2fc9976068dbacdba50bf0cdf3e36502ee72', "data-scrollable": this.has_scrollbar, "data-open": this.isOpen, "data-has-footer": this.hasFooter ? 'true' : null, class: `container origin-${this.origin} width-${this.size} size-${this.size} position-${this.position}`, ref: (el) => (this.sidePanelWrapper = el), "data-name": "container" }, index.h("header", { key: '2be0acbe2c3349ed4b5c1b6d2d8a65b35afb9475', class: "header", "data-name": "header" }, index.h("div", { key: '12a167474d9e903c8af62c018a832df263b57f08' }, index.h("slot", { key: '284c7d7b613a6f8f30187dfc816b7b710edd0f86', name: "title" }), this.panel_title && (index.h("h3", { key: 'b345c9cc2f551ced01d58be0608b26d998b2543a', class: "title" }, this.panel_title)), this.panel_subtitle && (index.h("p", { key: 'ade121a83cb4bc9edffded73f9220a5ab7041fb4', class: "subtitle" }, this.panel_subtitle))), index.h("div", { key: 'baf99557508df5ef2b196f88bf38346b4e60eac5' }, index.h("slot", { key: 'f65ff2ea64c6f31fe14bfe47a9229aeba91ec639', name: "actions" }), this.has_close_button && (index.h("at-button", { key: 'c321ee20db8f18586aaf107408ff0da4a83bf0af', size: "md", type: "secondaryText", "data-name": "panel-close", onClick: this.handleClose }, index.h("at-icon", { key: '36a587c8bd3de23b0b8ef693b4f740f3b04af241', slot: "icon", name: "close" }))))), index.h("div", { key: 'acc5c21d3ef2d0b0653e5fd3e33ad4989ce6109d', "data-name": "content", class: `content ${this.padding ? 'padded' : ''}` }, index.h("slot", { key: '04d32835ab9605053774bdb5e9f450524df6069c' })), index.h("div", { key: '649aac7d8e8fad9941bed4b463e540be0a8e3fde', "data-name": "footer", class: "footer" }, index.h("slot", { key: 'f379e7ac3e0cba6bf98df633b7905a0672d39645', name: "footer" }))))));
    }
};
