...
const AtSidePanelComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: '684ceb21f5be3bc2d178e0fb41b68b982c4237c5', "data-open": this.isOpen }, index.h("dialog", { key: '83dd8176a34d202201a072cde650757e11ffec5e', ref: (el) => (this.panelDialog = el), class: `${this.backdrop ? 'backdrop' : ''}`, onClose: this.handleDialogClose, onKeyDown: this.handleKeyDown }, index.h("div", { key: 'cd6601f0db7543309a60961ebc0e2b9e532d5dd0', "data-scrollable": this.has_scrollbar, "data-open": this.isOpen, "data-has-footer": this.hasFooter ? 'true' : null, class: `container origin-${this.origin} width-${this.size} size-${this.size} position-${this.position}`, ref: (el) => (this.sidePanelWrapper = el), "data-name": "container" }, index.h("header", { key: 'e14daa7ede71c13062f7e22341bdd0c323785a69', class: "header", "data-name": "header" }, index.h("div", { key: '86f4e7bdf6fb9bb90bb78f3f4eb0f6706a8c7e70' }, index.h("slot", { key: '28cc1437a90125c63c67fa6b51795d273e0bed5a', name: "title" }), this.panel_title && (index.h("h3", { key: '7f20171da541671c13f23d066d067314547f1bed', class: "title" }, this.panel_title)), this.panel_subtitle && (index.h("p", { key: '3e4fcd20bcac7b2a9fc42ac37ba0bd3ec692512f', class: "subtitle" }, this.panel_subtitle))), index.h("div", { key: 'e532876de154dd6b608d68f6d6c387460338a775' }, index.h("slot", { key: '9ca5896bb4c3b7c0da403b1cc26324da256e3d4e', name: "actions" }), this.has_close_button && (index.h("at-button", { key: '2b558cc4fc08f6a83a69d4c56fe519abc774d2bb', size: "md", type: "secondaryText", "data-name": "panel-close", onClick: this.handleClose }, index.h("at-icon", { key: '079107825e5e918632fa2dd080c07ebb59537f0e', slot: "icon", name: "close" }))))), index.h("div", { key: '069a6c03bbd48f1dde521cc703856e8e6cc9d2a3', "data-name": "content", class: "content" }, index.h("slot", { key: 'a4b7495f53f53ec22f1aea7e55cdd28b4eef3f23' })), index.h("div", { key: '5e02a0250da95bc5965e457b7101885db627ce99', "data-name": "footer", class: "footer" }, index.h("slot", { key: '5548c3d159c756b87d2d016a76cb0399a324397b', name: "footer" }))))));
    }
};
