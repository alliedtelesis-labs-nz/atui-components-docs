...
const AtSidePanelComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: '407b5dc2cc683db572e58ec77913fa2fe9452560', "data-open": this.isOpen }, index.h("dialog", { key: 'fa4ce5c7e9fff5573fc37879924e3ce42f17a956', ref: (el) => (this.panelDialog = el), class: `${this.backdrop ? 'backdrop' : ''}`, onClose: this.handleDialogClose, onKeyDown: this.handleKeyDown }, index.h("div", { key: '19fd2fe3e71da83a9b97fa9cd8a6be8c0d424bcf', "data-scrollable": this.has_scrollbar, "data-open": this.isOpen, class: `container origin-${this.origin} width-${this.size} size-${this.size} position-${this.position}`, ref: (el) => (this.sidePanelWrapper = el), "data-name": "container" }, index.h("header", { key: '8ba5c3c66cd8c76baa1e00bf633943faa244e334', class: "header", "data-name": "header" }, index.h("div", { key: '23d9a988695800af7c6fbe5bca6eb8246d80287d' }, this.panel_title && (index.h("h3", { key: '9799000623b77495e6c35323aa2f089ec4dcbe68', class: "title" }, this.panel_title)), this.panel_subtitle && (index.h("p", { key: 'bcff53756de3b21cd9116629f6c5b7e2ec5af899', class: "subtitle" }, this.panel_subtitle))), this.has_close_button && (index.h("at-button", { key: 'ef4b909aa9388f9b0a3e1d86dcfff10dc0f7163e', size: "md", type: "secondaryText", "data-name": "panel-close", onClick: this.handleClose }, index.h("at-icon", { key: '53d197cabbc357aba179bb6359da654b82f3d76c', slot: "icon", name: "close" })))), index.h("div", { key: 'e3daf3a89f0719d2117463dd9a150c6b2d38bd70', "data-name": "content", class: "content" }, index.h("slot", { key: '4bf9695de7c249ed9a37dcc17c06985d8c816657' }))))));
    }
};
