...
const AtSidePanelComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: '67c217696685ec295a5757c912eda0d97deef990', "data-open": this.isOpen }, index.h("dialog", { key: 'f65bb87efd5912d91dd88d7e342c8fb091f6f298', ref: (el) => (this.panelDialog = el), class: `${this.backdrop ? 'backdrop' : ''}`, onClose: this.handleDialogClose, onKeyDown: this.handleKeyDown }, index.h("div", { key: 'e04260f9d1399d5b233cbb69f2cf0794c435a44f', "data-scrollable": this.has_scrollbar, "data-open": this.isOpen, "data-has-footer": this.hasFooter ? 'true' : null, class: `container origin-${this.origin} width-${this.size} size-${this.size} position-${this.effectivePosition}`, ref: (el) => (this.sidePanelWrapper = el), "data-name": "container" }, index.h("header", { key: '2bf2eaea2e2cd7b90f3b57cc26d57ebe48dd9e20', class: "header", "data-name": "header" }, index.h("div", { key: '25a602a41e5daa4f08cf59586f8f34fb30ba7235' }, index.h("slot", { key: '2e2f827e5a28bee3aecde90f86c8a4da4e856a33', name: "title" }), this.panel_title && (index.h("h3", { key: 'd8d1d5f5a372700dde0c5af4222d9eafe19bffff', class: "title" }, this.panel_title)), this.panel_subtitle && (index.h("p", { key: 'ac5723e5a90e4bc961b03e32934dcaa4e74f62a5', class: "subtitle" }, this.panel_subtitle))), index.h("div", { key: '520c7f5e1efb792f23478d5c16e2a1a8f27a2519' }, index.h("slot", { key: 'c27254ffea05369a88c59aec596389abea0abe86', name: "actions" }), this.has_close_button && (index.h("at-button", { key: 'fa4b312c813835decfe8025168b13ee917046346', size: "md", type: "secondaryText", "data-name": "panel-close", onClick: this.handleClose }, index.h("at-icon", { key: 'ea1c08d2d909a0f7521937dab1b546d0beaad2cf', slot: "icon", name: "close" }))))), index.h("div", { key: 'a9d1919d4447227b69690f07b2d2fd23b2a54611', "data-name": "content", class: `content ${this.padding ? 'padded' : ''}` }, index.h("slot", { key: 'abab73b18e669b4912c6a64f138d886cc83e4efb' })), index.h("div", { key: 'cf6b5719fac7fc9442fc863f83a52428d5e6cb31', "data-name": "footer", class: "footer" }, index.h("slot", { key: '1f82e63112a76497e2b8019c13328c42c980d138', name: "footer" }))))));
    }
};
