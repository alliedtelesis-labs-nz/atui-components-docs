...
const AtSidePanelComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: '12f87889d1f11d0e6296ae86c2b3728431fc10cc', "data-open": this.isOpen }, index.h("dialog", { key: '088493f8b5ba543471297b8b297a9166099e0b39', ref: (el) => (this.panelDialog = el), class: `${this.backdrop ? 'backdrop' : ''}`, onClose: this.handleDialogClose, onKeyDown: this.handleKeyDown }, index.h("div", { key: '96f517ed1876f2a7dfa9717eb3235ce53611b122', "data-scrollable": this.has_scrollbar, "data-open": this.isOpen, class: `container origin-${this.origin} size-${this.size} size-${this.size} position-${this.position}`, ref: (el) => (this.sidePanelWrapper = el), "data-name": "container" }, index.h("header", { key: '9263a36350fb4c754694428b649de7f79c0940df', class: "header", "data-name": "header" }, index.h("div", { key: '28cf371e6ccdda1978a69d1792ded83a3168d220' }, this.panel_title && (index.h("h3", { key: '55dbc719e805262b82372bb0d0812b4093fcf252', class: "title" }, this.panel_title)), this.panel_subtitle && (index.h("p", { key: 'b5ef13b804642020085a7d937d3e61e49a196ca8', class: "subtitle" }, this.panel_subtitle))), this.has_close_button && (index.h("at-button", { key: '324f8a88c5413b2cc5515d3e62d54437b22c8001', size: "md", type: "secondaryText", "data-name": "panel-close", onClick: this.handleClose }, index.h("at-icon", { key: '6ad972c5b6d09ce90e20957b95fd529eaee159ce', slot: "icon", name: "close" })))), index.h("div", { key: '08f1147b9720b005e1000a6e95e07e212a0f6e5f', "data-name": "content", class: "content" }, index.h("slot", { key: '4463d60e34cdfc07331eb1ca66b91de754285b25' }))))));
    }
};
