...
const AtSidePanelComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: '0155b07e5a7e0a5195182d441c227cbe6d727884', "data-open": this.isOpen }, index.h("dialog", { key: '12779b37ef396c84ff26f1f09fb1ad2727d28aae', ref: (el) => (this.panelDialog = el), class: `${this.backdrop ? 'backdrop' : ''}`, onClose: this.handleDialogClose, onKeyDown: this.handleKeyDown }, index.h("div", { key: '9b1a52d625c9dbe80675c6320bf9ae076e20de0f', "data-scrollable": this.has_scrollbar, "data-open": this.isOpen, class: `container origin-${this.origin} width-${this.size} size-${this.size} position-${this.position}`, ref: (el) => (this.sidePanelWrapper = el), "data-name": "container" }, index.h("header", { key: '7d2fb018eb44cb8de567fe51065576eb32ecfe2c', class: "header", "data-name": "header" }, index.h("div", { key: '878352d2a139e63a637a6303b79e19cfd7b69706' }, index.h("slot", { key: '84f808cec335e831d0113257d1874790cecae3c3', name: "title" }), this.panel_title && (index.h("h3", { key: '08194da72c4f935417249283aa1fb675aeeb2d77', class: "title" }, this.panel_title)), this.panel_subtitle && (index.h("p", { key: '902d769c5db8ae7fd1a4027cd64f5f8ca4e525c6', class: "subtitle" }, this.panel_subtitle))), index.h("div", { key: '6a626318301be9297241f0121408cc7d6c231c35' }, index.h("slot", { key: 'b44196cec27718950c053e95161396134196bb09', name: "actions" }), this.has_close_button && (index.h("at-button", { key: '1d9c49876fd835b6f011d39e2cb5396a47256631', size: "md", type: "secondaryText", "data-name": "panel-close", onClick: this.handleClose }, index.h("at-icon", { key: 'ad3b48f6a893c7e7ab72d2874c47dc6d913d2ee6', slot: "icon", name: "close" }))))), index.h("div", { key: 'f434b08e5631c292299a88b8ce3dc57cc318a308', "data-name": "content", class: "content" }, index.h("slot", { key: 'fa4721e8702cbef2f43ef0847af2aff5adb26d96' }))))));
    }
};
