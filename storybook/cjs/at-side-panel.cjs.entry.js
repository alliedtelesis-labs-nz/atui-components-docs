...
const AtSidePanelComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'e5c7735902fbd9556f023ca4111c9966389fc76a', "data-open": this.isOpen }, index.h("dialog", { key: '6720938457b29e330c1fa450f98e192c47b51fa7', ref: (el) => (this.panelDialog = el), class: `${this.backdrop ? 'backdrop' : ''}`, onClose: this.handleDialogClose, onKeyDown: this.handleKeyDown }, index.h("div", { key: '2b05550e9f2bc21894f8b463b315c3173f70b30e', "data-scrollable": this.has_scrollbar, "data-open": this.isOpen, class: `container origin-${this.origin} width-${this.size} size-${this.size} position-${this.position}`, ref: (el) => (this.sidePanelWrapper = el), "data-name": "container" }, index.h("header", { key: '3b303a4deb4093a5326631b578b55ba605a63d1e', class: "header", "data-name": "header" }, index.h("div", { key: '06cd6889c58089e0cf14dc075a30d37e109d13ae' }, index.h("slot", { key: 'f9882f7819b8ed0507a7496fcc3f4ddc301793a7', name: "title" }), this.panel_title && (index.h("h3", { key: 'd73a3c6325745c3df9f11afc525a2601e6184f73', class: "title" }, this.panel_title)), this.panel_subtitle && (index.h("p", { key: '9b1f18575779f8a1d9abcb1e96dfff4acf08e5a1', class: "subtitle" }, this.panel_subtitle))), index.h("div", { key: 'ecc550430a8980b078d39889d2507ef8eeef51d3' }, index.h("slot", { key: '3c03d5bc5f5f372e08ddd3745d8c33348e08ba0b', name: "actions" }), this.has_close_button && (index.h("at-button", { key: 'f4dbb437dc6285869683baf1dca15647edea098c', size: "md", type: "secondaryText", "data-name": "panel-close", onClick: this.handleClose }, index.h("at-icon", { key: '5b3dd3be83712cfc5c3e9f05710811ce2842d185', slot: "icon", name: "close" }))))), index.h("div", { key: '24e1477ca7008d246ffd58a48c219002da9f02bd', "data-name": "content", class: "content" }, index.h("slot", { key: '00779178006607c6cf688553ba9517bc80bb468a' }))))));
    }
};
