...
const AtSidePanelComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: '512d0313e79987615ca806a36b8e68f3c85c01bf', "data-open": this.isOpen }, index.h("dialog", { key: 'b1c5ee38dd1e12732ec5b2b86b63fcef23823f02', ref: (el) => (this.panelDialog = el), class: `${this.backdrop ? 'backdrop' : ''}`, onClose: this.handleDialogClose, onKeyDown: this.handleKeyDown }, index.h("div", { key: 'd34337ec75f3b7e59f4dca4a18b734d880c52e54', "data-scrollable": this.has_scrollbar, "data-open": this.isOpen, class: `container origin-${this.origin} width-${this.size} size-${this.size} position-${this.position}`, ref: (el) => (this.sidePanelWrapper = el), "data-name": "container" }, index.h("header", { key: '78c33d48bbd4e1dc62536435e9df6aac4f6b32e2', class: "header", "data-name": "header" }, index.h("div", { key: 'afe04fd5a8a1afec1488c754037f1c6c4319578a' }, index.h("slot", { key: 'a1f16ceac81d8bb0a70bd3c55b0898a1b098253a', name: "title" }), this.panel_title && (index.h("h3", { key: '3b8bf3ece917467e36f4eb0afe90905204979bb3', class: "title" }, this.panel_title)), this.panel_subtitle && (index.h("p", { key: 'f2971167b46752eb888d332322f67d17ca32b88c', class: "subtitle" }, this.panel_subtitle))), index.h("div", { key: '02df910abe60e74e29cc6bb4f12014c8e3c8ed99' }, index.h("slot", { key: '9208f16c985d391470f0a1f1d51de504447ba77a', name: "actions" }), this.has_close_button && (index.h("at-button", { key: '0152ec1764f65ce750dd3fb4c22a75b451ee50d6', size: "md", type: "secondaryText", "data-name": "panel-close", onClick: this.handleClose }, index.h("at-icon", { key: '2b7cf6fc19bc1d4b1ffca9e139bb29316c0c4dba', slot: "icon", name: "close" }))))), index.h("div", { key: 'e66213d737946a0afc380550f5ec3e9fbeaf52e1', "data-name": "content", class: "content" }, index.h("slot", { key: '07d798c77e68109d4f14b7c87a4148a678a69f9e' }))))));
    }
};
