...
const AtSidePanelComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: '02a1fa6e3d0dd429f38f2ed298d13f29a6a5b942', "data-open": this.isOpen }, index.h("dialog", { key: '0cceb693a52a1e64d0e3bd60e81d8fb07f051995', ref: (el) => (this.panelDialog = el), class: `${this.backdrop ? 'backdrop' : ''}`, onClose: this.handleDialogClose, onKeyDown: this.handleKeyDown }, index.h("div", { key: '91f4c0eb06082f0d7c25abf35e52bd9214cd7793', "data-scrollable": this.has_scrollbar, "data-open": this.isOpen, class: `container origin-${this.origin} size-${this.size} size-${this.size} position-${this.position}`, ref: (el) => (this.sidePanelWrapper = el), "data-name": "container" }, index.h("header", { key: '5f7ef315c9806ba520c63b0a996d799317280553', class: "header", "data-name": "header" }, index.h("div", { key: 'b5f2013fff755b42791db20665dedd98141b935d' }, this.panel_title && (index.h("h3", { key: '38c4f096a3a2f5cd52cc11f5ae2a7820b5f1e16e', class: "title" }, this.panel_title)), this.panel_subtitle && (index.h("p", { key: '7b49b58a71d6a39b64329b7fcbb9e2162aba5540', class: "subtitle" }, this.panel_subtitle))), this.has_close_button && (index.h("at-button", { key: '5ed6bdc3b5efb119c29ca3c7f9f19574bfa39e40', size: "md", icon: "close", type: "secondaryText", "data-name": "panel-close", onClick: this.handleClose }))), index.h("div", { key: 'e536983fbd7a8d66653dfe995192f7b7f596660b', "data-name": "content", class: "content" }, index.h("slot", { key: '671fdcb71682292c82eb86ac4263b5d8f8862dfe' }))))));
    }
};
