...
const AtSidePanelComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: '1aab6f98209a9ac2da5823e4fa9863297b4a0149', "data-open": this.isOpen }, index.h("dialog", { key: '16a1e340e21fdbaf21945f293d57e5bf4479268b', ref: (el) => (this.panelDialog = el), class: `${this.backdrop ? 'backdrop' : ''}`, onClose: this.handleDialogClose, onKeyDown: this.handleKeyDown }, index.h("div", { key: 'dedc471e10ccb005384ac239088f198e4fe57899', "data-scrollable": this.has_scrollbar, "data-open": this.isOpen, class: `container origin-${this.origin} size-${this.size} size-${this.size} position-${this.position}`, ref: (el) => (this.sidePanelWrapper = el), "data-name": "container" }, index.h("header", { key: 'c5aef3a216cf2c243ba698857a5c17551c2450a6', class: "header", "data-name": "header" }, index.h("div", { key: 'ba45b06ead2ae6540b150b95915e50e3e363ede7' }, this.panel_title && (index.h("h3", { key: '4b8d692a9b685279f91802e8bce0e0e9468dde24', class: "title" }, this.panel_title)), this.panel_subtitle && (index.h("p", { key: '6fc928839efc3edede82e925ca8e36413e60a5b3', class: "subtitle" }, this.panel_subtitle))), this.has_close_button && (index.h("at-button", { key: '1dc3736822ae4cbddb0954555971137b40d363de', size: "md", icon: "close", type: "secondaryText", "data-name": "panel-close", onClick: this.handleClose }))), index.h("div", { key: '96378a33891e11493b85c4619dc4dc98482d140f', "data-name": "content", class: "content" }, index.h("slot", { key: '69c08b638d4615a66e6a4868af52575a4bae1a5a' }))))));
    }
};
