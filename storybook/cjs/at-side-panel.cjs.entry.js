...
const AtSidePanelComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'a06e59aa6a77b2498eaadb702b5b2e6a6d60f128', "data-open": this.isOpen }, index.h("dialog", { key: '33da441607621db101e9c97a9b68803fba129886', ref: (el) => (this.panelDialog = el), class: `${this.backdrop ? 'backdrop' : ''}`, onClose: this.handleDialogClose, onKeyDown: this.handleKeyDown }, index.h("div", { key: 'd5149785dbc8db86aaa4933c907b62cca3f2a191', "data-scrollable": this.has_scrollbar, "data-open": this.isOpen, "data-has-footer": this.hasFooter ? 'true' : null, class: `container origin-${this.origin} width-${this.size} size-${this.size} position-${this.position}`, ref: (el) => (this.sidePanelWrapper = el), "data-name": "container" }, index.h("header", { key: '0336b44b7d29d5d6e12675cdf49d2427f1e281f2', class: "header", "data-name": "header" }, index.h("div", { key: '4711e4c5c872e00a5ffd2ce7b7f4b26a99df09d2' }, index.h("slot", { key: 'a257b2428061104f8bda9b9b853dac661ac450b1', name: "title" }), this.panel_title && (index.h("h3", { key: '00f56cdf5d223ec1204d61394633e4f3155d38d6', class: "title" }, this.panel_title)), this.panel_subtitle && (index.h("p", { key: '65988d39d83997127d14d445b92ebbe2e6edf74e', class: "subtitle" }, this.panel_subtitle))), index.h("div", { key: 'ab8a22254635b17d6e9cc525ac4f3c1d9cc057dd' }, index.h("slot", { key: '7c656b396c2befc36b16686024c62230ab0193c0', name: "actions" }), this.has_close_button && (index.h("at-button", { key: '2b21b3945ed110382137622f54ec095271b8c6b8', size: "md", type: "secondaryText", "data-name": "panel-close", onClick: this.handleClose }, index.h("at-icon", { key: 'e09ed6712874e65901213d8575c629340e70a310', slot: "icon", name: "close" }))))), index.h("div", { key: 'ee3e4fc8d612a1db9926ded564e1cc61ace12f84', "data-name": "content", class: "content" }, index.h("slot", { key: 'e524fa9e257788bb0522e01a9735f70ab39f7cdc' })), index.h("div", { key: '6c5203f09b6849229eb8fc05c15b68cad17c6e00', "data-name": "footer", class: "footer" }, index.h("slot", { key: '5968f5851794bdd999c11ee96e0696cf3007d322', name: "footer" }))))));
    }
};
