...
const AtSidePanelComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: '013de3f91ad26d8e7dfd5fb6ae2aa2ce3a611bb3', "data-open": this.isOpen }, index.h("dialog", { key: 'd8f704fabe4411c5f5c56aad7928cc2d4669a13b', ref: (el) => (this.panelDialog = el), class: `${this.backdrop ? 'backdrop' : ''}`, onClose: this.handleDialogClose, onKeyDown: this.handleKeyDown }, index.h("div", { key: '8de84f8c174dd2ea5611367389281ebce0c58514', "data-scrollable": this.has_scrollbar, "data-open": this.isOpen, class: `container origin-${this.origin} size-${this.size} size-${this.size} position-${this.position}`, ref: (el) => (this.sidePanelWrapper = el), "data-name": "container" }, index.h("div", { key: '240adc0d8808fb3119498482318f01b72de8bd3f', class: "header", "data-name": "header" }, index.h("at-header", { key: '08eacf29392a407f46314e894b2ab6a92dd3a249', header_title: this.panel_title, subtitle: this.panel_subtitle }, this.has_close_button && (index.h("at-button", { key: '0b063797e1990c77712cfc16b0bbc8fb9d1c55f0', slot: 'actions', size: "md", icon: "close", "data-name": "panel-close", onClick: this.handleClose })))), index.h("div", { key: 'e8503f518e85e7d5c594b5f9baccf3d56fe6426f', "data-name": "content", class: "content" }, index.h("slot", { key: 'd31b1b94a807b23974de4d225ebf27b7ff5e37df' }))))));
    }
};
