...
const AtSidePanelComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: '6722cab78858326323b53c1989912a9842c90f8e', "data-open": this.isOpen }, index.h("dialog", { key: 'd26e21fd601304be29f85625f2e0cde10134561c', ref: (el) => (this.panelDialog = el), class: `${this.backdrop ? 'backdrop' : ''}`, onClose: this.handleDialogClose, onKeyDown: this.handleKeyDown }, index.h("div", { key: '494a021e4ef1b8eeedda3416fe1c57ab4d0c7372', "data-scrollable": this.has_scrollbar, "data-open": this.isOpen, class: `container origin-${this.origin} width-${this.size} size-${this.size} position-${this.position}`, ref: (el) => (this.sidePanelWrapper = el), "data-name": "container" }, index.h("header", { key: 'b406c74ab84fb41f53cd33a971983f8bbf20a6a7', class: "header", "data-name": "header" }, index.h("div", { key: 'b98f7abcf7b7b0b24ad501e5210b1ed0e617c22a' }, index.h("slot", { key: '7339f2e9c7316983ef3f3d66bce41ca2ee29c74c', name: "title" }), this.panel_title && (index.h("h3", { key: '29725baae15e8fdbddef21509358fe25f52910be', class: "title" }, this.panel_title)), this.panel_subtitle && (index.h("p", { key: '368e8ab75ea5c2546dcca931acdd27e5d23071f5', class: "subtitle" }, this.panel_subtitle))), index.h("div", { key: '49694e7015678f308ae8ef090681e3ba66d32d11' }, index.h("slot", { key: 'e8a3ad64b848a1d1821582a23a180a80625d2539', name: "actions" }), this.has_close_button && (index.h("at-button", { key: '42ecdb41f9bf9d53a74aa88ca74670f8d92cf36c', size: "md", type: "secondaryText", "data-name": "panel-close", onClick: this.handleClose }, index.h("at-icon", { key: '8b59b07eff7e4bbe03cc209cfe04ecad83c7aaaa', slot: "icon", name: "close" }))))), index.h("div", { key: 'cc033f4383875a475ca33a1fb0dd827b82ece84c', "data-name": "content", class: "content" }, index.h("slot", { key: 'b9bca3a875fb7f13a9bfc61b271457c7f0d067b1' }))))));
    }
};
