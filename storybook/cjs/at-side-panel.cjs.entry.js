...
const AtSidePanelComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: '66505e6426941af162ccdec74b8955ac5869faad', class: "contents" }, index.h("dialog", { key: '53ae16a9f607281693fdb6ec0edc7b02127bbb5e', ref: (el) => (this.panelDialog = el), class: this.backdrop ? 'backdrop' : 'no-backdrop', onClose: this.handleDialogClose, onKeyDown: this.handleKeyDown }, index.h("div", { key: '69f5eecaf4305a912c72c8424aeaef17e311cea6', class: `${this.panelClasses} ${this.sizeClasses}`, ref: (el) => (this.sidePanelWrapper = el), "data-name": "panel-wrapper" }, index.h("div", { key: 'fbddaa65ef682fdfddd3156f3424929cb9a21ea4', class: 'z-nav sticky top-0' }, index.h("at-header", { key: 'fb7a442ed5cf438385269b493f97c3802b04a017', header_title: this.panel_title, subtitle: this.panel_subtitle }, this.has_close_button && (index.h("span", { key: '99a54b049d169b3999ea041e8c8c5f91bd08a11f', class: 'rounded-full hover:bg-gray-100', slot: 'actions' }, index.h("i", { key: '1b2d1eca6b18cd2cf5e564137b62cba91308f5ff', class: "material-icons md-16 top-20 right-16 cursor-pointer p-8 !text-[18px]", onClick: this.handleClose, "data-name": "panel-close" }, "close"))))), index.h("div", { key: '3fa2642481f14349f4e3bb2a5034b0bb2a075fab', class: 'flex w-full flex-1 flex-col' }, index.h("slot", { key: '1879bc3fe50f2ad27fd6cca8651c5cfa608fd7d3' }))))));
    }
    get panelClasses() {
