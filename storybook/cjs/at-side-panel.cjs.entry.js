...
const AtSidePanelComponent = class {
    ...
    render() {
        return (index.h("div", { key: '687df249deff8291f845e8070b815fe85463fc66' }, index.h("dialog", { key: '04bc7e42c62f2d2a74571fc396779041b7e0b2c6', id: this.panel_id, ref: (el) => (this.panelDialog = el), class: this.backdrop ? 'backdrop' : 'no-backdrop', onClose: this.handleDialogClose, onKeyDown: this.handleKeyDown }, index.h("div", { key: '812672ecc76268bf091f42c50173ff6922bd1d7d', class: `${this.panelClasses} ${this.sizeClasses}`, ref: (el) => (this.sidePanelWrapper = el), "data-name": "panel-wrapper" }, index.h("div", { key: '7e6454320c55d6bb8e65f200578403dcc875b053', class: 'z-nav sticky top-0' }, index.h("at-header", { key: '25f31add5118e5271d12ac3394ca33cc247587bd', header_title: this.panel_title, subtitle: this.panel_subtitle }, this.has_close_button && (index.h("span", { key: '416301759235a3e6f4a638d65266605a2c713e73', class: 'rounded-full hover:bg-gray-100', slot: 'actions' }, index.h("i", { key: '00d552472b9b9d7fb8a0395488ab20ea8772641f', class: "material-icons md-16 top-20 right-16 cursor-pointer p-8 !text-[18px]", onClick: this.handleClose, "data-name": "panel-close" }, "close"))))), index.h("div", { key: 'f47c51220475ccb41baa6e081d8aa1b03754daac', class: 'flex w-full flex-1 flex-col' }, index.h("slot", { key: '54d6d7cd63569e4d5e07278f7bd576dccdb82ee1' }))))));
    }
    get panelClasses() {
