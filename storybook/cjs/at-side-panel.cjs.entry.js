...
const AtSidePanelComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'd2c15609979efea8afe15f56566583f3455118f9', "data-open": this.isOpen }, index.h("dialog", { key: 'a22788d849c2e1dc5f1debc08134f30350122457', ref: (el) => (this.panelDialog = el), class: `${this.backdrop ? 'backdrop' : ''}`, onClose: this.handleDialogClose, onKeyDown: this.handleKeyDown }, index.h("div", { key: '7d6e3c53ac2b009d4e9ffea6a64a7ac09ffe3f28', "data-scrollable": this.has_scrollbar, "data-open": this.isOpen, class: `container origin-${this.origin} size-${this.size} size-${this.size} position-${this.position}`, ref: (el) => (this.sidePanelWrapper = el), "data-name": "container" }, index.h("header", { key: '57be40d13533c9a886fefdf99a7935795c15d4c2', class: "header", "data-name": "header" }, index.h("div", { key: '422cfb61e359d33a0528c9ffbffcce3bb5eaada6' }, this.panel_title && (index.h("h3", { key: 'd1e7ada0b0a61e6004e89d06cfc086d0d19aceca', class: "title" }, this.panel_title)), this.panel_subtitle && (index.h("p", { key: '7a7b32a7fbfb0ea1a38db81860550fbe4d40669e', class: "subtitle" }, this.panel_subtitle))), this.has_close_button && (index.h("at-button", { key: '383752e11e57975bda715793c0a90ddbd95165e6', size: "md", type: "secondaryText", "data-name": "panel-close", onClick: this.handleClose }, index.h("at-icon", { key: 'ce15c093d55375c30ed6bef293c29ac35551f3d6', slot: "icon", name: "close" })))), index.h("div", { key: '95c7360974a34b207a0ca05c35e30ad4eb8dabbc', "data-name": "content", class: "content" }, index.h("slot", { key: 'ea8176a6ed2b46ba153e49b5b688ad74bfa6720f' }))))));
    }
};
