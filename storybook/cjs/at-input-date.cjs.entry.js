...
const AtInputDate = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '079dcd8fbedc82d7bb1d0d020d6fa91fe524e0f6' }, index.h("style", { key: 'f3eac1ae2af80ebd0cd354424bb6a60c5c2d68bc' }, `
                ...
                `), index.h("div", { key: '38c68256aefae7d89692e18cc3c0e5b57956de3d', class: "flex flex-row" }, index.h("div", { key: '88770f4517eec156aa86340b1d452d543fe14373', class: "flex-fill flex flex-col" }, index.h("div", { key: 'a14f30ec5058db1124752c32542afe6ef01ac6df', class: "flex flex-col" }, (this.label ||
            this.required ||
            this.info_text) && (index.h("at-form-label", { key: '9cb27b30f8948341983d6dfa23204f1ee1e38c30', label: this.label, for: this.inputId, required: this.required && !this.readonly, info_text: this.info_text })), this.hint_text && (index.h("span", { key: 'f7b5cd51bf51c72edf283e32623c5d2a60575a84', class: "text-light mb-8 inline-block text-xs leading-tight", "data-name": "datepicker-hint" }, this.hint_text)), index.h("div", { key: 'e1961002036cc8cba19941dc75428e6c5975b507', class: classname }, index.h("input", { key: '3331c60d625a9bfb404bd3b0ce4b69ec657ac055', type: "date", id: this.inputId, name: "datePicker", class: "flex w-full cursor-pointer px-8 py-8 outline-0", readonly: this.readonly ? true : undefined, disabled: this.disabled ? true : undefined, required: this.required, value: this.selectedDate, min: timeDatePresentation_util.TimeDatePresentationUtil.getFormattedDate(this.min_date, 'YYYY-MM-DD'), max: timeDatePresentation_util.TimeDatePresentationUtil.getFormattedDate(this.max_date, 'YYYY-MM-DD'), "data-name": "datepicker", onChange: (event) => {
            ...
            } }))), this.error_text && this.invalid && (index.h("span", { key: '146fd4c1d3dbf996384ed10029595c1e18c70240', class: "text-error text-sm", "data-name": "datepicker-error" }, this.error_text))))));
    }
};
