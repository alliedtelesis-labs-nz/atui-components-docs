...
const AtuiPromptMessage = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '9e3bd33653e63685fe07ce845c7675f2219d1548', class: "flex w-full gap-8", "data-name": "message-container", "data-role": this.role }, index.h("div", { key: '2a71b744b7e7690f37cee010278aacd71efc6dbd', class: "flex flex-1 flex-col" }, this.name && (index.h("span", { key: 'c8da2be6f55c8762d9b9d4295e22c03fdb546a01', class: "self-start text-sm text-light", "data-name": "message-name" }, this.name)), index.h("div", { key: '6aa116577468031e0b26e9c101b1b9ebba64615d', class: messageClasses }, this.renderContent()), this.renderActions())));
    }
    get el() { return index.getElement(this); }
};

exports.AtuiPromptMessage = AtuiPromptMessage;
//# sourceMappingURL=atui-prompt-message-DVAixQWD.js.map
