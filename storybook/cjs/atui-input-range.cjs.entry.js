...
const AtuiInputRangeComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: '1e18d0d20ed73cdae2cfb10e808327f727b0a941' }, index.h("div", { key: '25288d9bb7b899da451e16767deae88e19e907ce', class: "flex flex-col" }, index.h("slot", { key: '119e57f711bdd3a726fb9a5697ed04efd35dd4fa', name: "label" }), (this.label || this.required || this.info_text) && (index.h("atui-form-label", { key: 'bbd6d20e78b6a9530616bbc91437e45988a6c677', label: this.label, for: this.sliderId, required: this.required && !this.readonly, info_text: this.info_text })), this.hint_text && (index.h("span", { key: '4c6dd237f2a8921a748e22951e06a71af9d7996a', class: "inline-block text-xs leading-tight text-light", "data-name": "slider-hint" }, this.hint_text)), this.error_text && this.invalid && (index.h("span", { key: 'd6d9300e7ccb9e88e9fd30646ab5e032433cf445', class: "text-xs font-normal text-error", "data-name": "slider-error" }, this.error_text)), this.warning_text && !this.invalid && (index.h("span", { key: '8ae7257a3e07df6c0cc703f56fb042ad5863f0c0', class: "text-xs font-normal text-warning-foreground", "data-name": "slider-warning" }, this.warning_text))), index.h("div", { key: '52c4a98b404c26281968f67db8b5bf62d832dbd0', class: `mt-4 flex items-start gap-8 ${this.label_position == 'before' ? 'flex-row-reverse' : 'flex-row'}` }, index.h("div", { key: '3aa10bc3895777dd71ce330d8a802482c4c19c4d', class: "flex flex-grow flex-col" }, index.h("div", { key: '1dec5112572190f918b280729296ce4a197c055e', class: "flex flex-grow" }, index.h("div", { key: 'a66a847f0edc6f85578c8e3e8a035836f22ffe24', class: "range-slider", style: {
                '--min': `${this.min}`,
                '--max': `${this.max}`,
                '--step': `${this.step}`,
                '--value': `${this.value}`,
            ...
            }, ref: (el) => (this.sliderContainerRef = el) }, index.h("input", { key: '6db79b131c036c478856d463462c069a8e38c5ca', list: "markers", type: "range", min: this.min, max: this.max, step: this.step, "aria-controls": this.sliderId, disabled: this.disabled || this.readonly
                ? true
