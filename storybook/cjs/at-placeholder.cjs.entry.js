...
const AtPlaceholderComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'cdc7e32a9697b2f14749bbdd017ed86a9473157f', class: `${this.placeholderSizeClass} bg-surface-foreground text-muted rounded-placeholder relative flex w-full items-center gap-16 text-center`, "data-name": "placeholder-container" }, index.h("span", { key: '2eb023bb919b076a3f7b15d0d136267e8c593f9d', class: "relative z-10 fill-slate-300", "data-name": "placeholder-icon" }, index.h("slot", { key: '5a621959004ad3906da6b8a3170dfb0bc0e7924d', name: "icon" })), this.type !== 'none' && (index.h("span", { key: '52a9ef45594b76ef4cad9767bf8e4abec6debb55', class: `z-0 flex justify-center fill-[var(--token-border-muted)] ${this.type === 'chart-no-data' ? 'absolute inset-0' : ''}`, "data-name": "placeholder-image" }, this.renderImage())), index.h("div", { key: '8015e3892247f0a0782117d4caa12210c53ab593', class: `border-radius-sm relative z-10 flex flex-col justify-center ${this.size === 'xs' ? 'items-start text-left' : 'items-center text-center'}` }, index.h("div", { key: 'b28789abfea174f6a41a2de96aac8dbb5a6decac', class: "flex items-center" }, this.show_loading_spinner && (index.h("at-loading", { key: 'b8927e078a6c6871aa4b9923eabc346ef9861d53', class: "relative mr-8", size: "sm", "data-name": "placeholder-spinner" })), this.placeholder_title && (index.h("h5", { key: 'daf336e6ffa1bf5846167095e80f95df19cd74f4', class: "text-secondary text-sm font-medium", "data-name": "placeholder-title" }, this.placeholder_title))), index.h("p", { key: 'bef9759400b929f6a01b4d93ce7f639275d6f3ed', class: "text-secondary text-sm", "data-name": "placeholder-content" }, this.content), index.h("slot", { key: 'c7eaa12d2fff5ebaaba5331b4fb967a09240d42f' }))));
    }
};
