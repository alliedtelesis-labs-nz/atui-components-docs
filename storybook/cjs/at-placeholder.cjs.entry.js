...
const AtPlaceholderComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: '420ab37b7e4f061a99f88887a0691745ff7ccec0', class: `${this.placeholderSizeClass} bg-surface-foreground text-muted rounded-placeholder relative flex w-full items-center gap-16 text-center`, "data-name": "placeholder-container" }, index.h("span", { key: '2f9525f3feacaeca111a14c9026c4731f4551c98', class: "relative z-10 fill-slate-300", "data-name": "placeholder-icon" }, index.h("slot", { key: 'f3f3d7e0783286e062aee34e396779c9dfe4ac18', name: "icon" })), this.type !== 'none' && (index.h("span", { key: '6c010eba038a3c9e27747a5a0c674f8af6d8339d', class: `z-0 flex justify-center fill-[var(--token-border-muted)] ${this.type === 'chart-no-data' ? 'absolute inset-0' : ''}`, "data-name": "placeholder-image" }, this.renderImage())), index.h("div", { key: 'aec9eeb7157d2caaaea5e18f6f1c1483e7b5606b', class: `border-radius-sm relative z-10 flex flex-col justify-center ${this.size === 'xs' ? 'items-start text-left' : 'items-center text-center'}` }, index.h("div", { key: '4e732bd9d725b4c3da5451a39f2e89d98afde978', class: "flex items-center" }, this.show_loading_spinner && (index.h("at-loading", { key: '040ba7a3234937b21d14f4bba42458e5ebb0114d', class: "relative mr-8", size: "sm", "data-name": "placeholder-spinner" })), this.placeholder_title && (index.h("h5", { key: '68dc5290cd7dc7a5f03fef8a1f3806c7a3dada8c', class: "text-secondary text-sm font-medium", "data-name": "placeholder-title" }, this.placeholder_title))), index.h("p", { key: '81d1e62fa715973b9c5a18140e87a96b623c4a00', class: "text-secondary text-sm", "data-name": "placeholder-content" }, this.content), index.h("slot", { key: 'c4a17e36059552fc69f1f2c9dd008281152b8146' }))));
    }
};
