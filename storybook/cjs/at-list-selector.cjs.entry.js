...
const AtListSelector = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'ab5dc2c03d257992ccb040e19271de5f006cc51b', onKeyDown: (event) => this.handleKeyDown(event) }, index.h("slot", { key: '3f05f8f74b4b211d50feffb445da9c4f442ae703', name: "header" }), !!this.options.length && (index.h("nav", { key: '966ee60f6cb69eb8af4844b50910de1645bac5f4', class: "flex-fill overflow-visible pb-16" }, index.h("div", { key: '82c4a63d94a21bbc67b9ce35d4a8d21a2e1997e3', class: "flex flex-col", role: "menu" }, this.getListItems))), index.h("slot", { key: 'f913cf72b128a8bb336a84d4159cc1867144aafe' })));
    }
};
