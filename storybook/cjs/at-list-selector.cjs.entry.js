...
const AtListSelector = class {
    ...
    render() {
        return (index.h(index.Host, { key: '998d9477599310ecf43d3ce8e2ba906d5d865d9f', onKeyDown: (event) => this.handleKeyDown(event) }, index.h("slot", { key: 'c89f7b6a391661761e390c121547db9cf887d3a3', name: "header" }), !!this.options.length && (index.h("nav", { key: 'bfbdc63f5aa3651d044cc1d43bc671a59a7deafa', class: "flex-fill overflow-visible pb-16" }, index.h("div", { key: 'd3a67cac4fb77b7f1f0551993253b742b645e5c0', class: "flex flex-col", role: "menu" }, this.getListItems))), index.h("slot", { key: 'f31c0c9074fb28b10a4e4d11fa2dd8fbb4e8319b' })));
    }
};
