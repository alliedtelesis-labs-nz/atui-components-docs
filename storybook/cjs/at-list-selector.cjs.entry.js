...
const AtListSelector = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'fe5c85e86dfd03de941e20bb7706d950ea2c7fb5', onKeyDown: (event) => this.handleKeyDown(event) }, index.h("slot", { key: 'd8eb46fbafa6aca75388faa92db3a741c0f95337', name: "header" }), !!this.options.length && (index.h("nav", { key: '62ff84fa8891cfd3e341591e9e03a25f2b67df4b', class: "flex-fill overflow-visible pb-16" }, index.h("div", { key: 'cc8a88c03f50234a35ff6f3cac6ea4488f4eb5f1', class: "flex flex-col", role: "menu" }, this.getListItems))), index.h("slot", { key: 'd4792065c85e8fd112932c07581b4e1173356ff9' })));
    }
};
