...
const AtListSelector = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'e3c955460ba1bb37f09af12cab3ed320529c2c5d', onKeyDown: (event) => this.handleKeyDown(event) }, index.h("slot", { key: '7bbc6941aa1c4469ad920b644dda7abad44fc007', name: "header" }), !!this.options.length && (index.h("nav", { key: '58b7cf643a08908b90784f502589b4c9fcc75bf1', class: "flex-fill overflow-visible pb-16" }, index.h("div", { key: '2367e98492209e887fe65d051b2d730f42874bab', class: "flex flex-col", role: "menu" }, this.getListItems))), index.h("slot", { key: '2194531d0012ab3e2b254b2e85b98980a4c232ad' })));
    }
};
