...
const AtListSelector = class {
    ...
    render() {
        return (index.h(index.Host, { key: '23027af17c56d4be957ebfdd628118333cb81492', onKeyDown: (event) => this.handleKeyDown(event) }, index.h("slot", { key: '192f9e49533360b396a60334e3e1e78f8d0c567c', name: "header" }), !!this.options.length && (index.h("nav", { key: '27ac3075f686b6bda17d3cae4cd1bc15966c96e3', class: "flex-fill overflow-visible pb-16" }, index.h("div", { key: '81319232865f839ede07a4be1e60dc555c986316', class: "flex flex-col", role: "menu" }, this.getListItems))), index.h("slot", { key: 'dc210d601606d56a2766bdda4525e90f9778fed6' })));
    }
};
