...
const AtListSelector = class {
    ...
    render() {
        return (index.h(index.Host, { key: '6a84f20d8de0757b4f099d23c0ac110414deaa96', onKeyDown: (event) => this.handleKeyDown(event) }, index.h("slot", { key: '528777a5f4edb0eade959a48d35bd51c6599ac4b', name: "header" }), !!this.options.length && (index.h("nav", { key: 'bb2bc80ed2910facc4b28b3cbc3dc89c55bbb85b', class: "flex-fill overflow-visible pb-16" }, index.h("div", { key: '231ffdb9fde0482e1706616dbe412ff0ec009169', class: "flex flex-col", role: "menu" }, this.getListItems))), index.h("slot", { key: 'ecaa7aa8e150c0115a82a8ea752eb7526041f547' })));
    }
};
