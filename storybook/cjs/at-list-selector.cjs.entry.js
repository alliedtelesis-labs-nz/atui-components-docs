...
const AtListSelector = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'b4224a5e0a53c31898d56a6bb3a42e9488d12194', onKeyDown: (event) => this.handleKeyDown(event) }, index.h("slot", { key: '9694fd8091503c1e34c3e6cf5cca99c209a0fa4e', name: "header" }), !!this.options.length && (index.h("nav", { key: '15b974204fed561ba55dfc769f6622b40a1038bf', class: "flex-fill overflow-visible pb-16" }, index.h("div", { key: '96935742bbb357646e64fa64d6fe2023e5d51863', class: "flex flex-col", role: "menu" }, this.getListItems))), index.h("slot", { key: '6f052fc38c6eceb4dcd8509da1631926e84f03f7' })));
    }
};
