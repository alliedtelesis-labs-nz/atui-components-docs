...
const AtListSelector = class {
    ...
    render() {
        return (index.h(index.Host, { key: '6845fd10453cd0762fdb17d087599d67e387d255', onKeyDown: (event) => this.handleKeyDown(event) }, index.h("slot", { key: '62e89937cdca48fd5e79966452d7b9c7344b0b52', name: "header" }), !!this.options.length && (index.h("nav", { key: 'd5963f36470e0bd1d5be9ae336ebf5124c7af971', class: "flex-fill overflow-visible pb-16" }, index.h("div", { key: '174b0b7927361cc46cf8a733f7bab42a95947dc5', class: "flex flex-col", role: "menu" }, this.getListItems))), index.h("slot", { key: '516f5c89e9f086d477420584f08d2d040082dfb0' })));
    }
};
