...
const AtListSelector = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'a3c07b6ef17a00b853db9ac85b89fab231772422', onKeyDown: (event) => this.handleKeyDown(event) }, index.h("slot", { key: '122bebd332ba13a2c8a8f93940bc7efe79d83fca', name: "header" }), !!this.options.length && (index.h("nav", { key: '8ee5510f6aa6ed8aa86be9bac2b0c074b522db0e', class: "flex-fill overflow-visible pb-16" }, index.h("div", { key: '5b56d6060c37a053e2188fe4936f676235cb0070', class: "flex flex-col", role: "menu" }, this.getListItems))), index.h("slot", { key: 'f702b0180772a189183965d3b4a848d255756028' })));
    }
};
