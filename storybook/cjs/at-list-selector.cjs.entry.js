...
const AtListSelector = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'eb31860b1e2578f3de9b72046bafdc4a7df57d0b', onKeyDown: (event) => this.handleKeyDown(event) }, index.h("slot", { key: 'edd199c1a324a0c8b152cfffd04d5ce3efb19bee', name: "header" }), !!this.options.length && (index.h("nav", { key: '538c0c366c2e49a296d8406d076f8eb843ba53ff', class: "flex-fill overflow-visible pb-16" }, index.h("div", { key: 'f46669420cca17b72f570dbd08bf2c3ce1d1e1ab', class: "flex flex-col", role: "menu" }, this.getListItems))), index.h("slot", { key: '0fdb98109d442d6226c0b57f8c44ead6055a5b26' })));
    }
};
