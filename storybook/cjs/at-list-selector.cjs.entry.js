...
const AtListSelector = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'ee28c623f24276fccb2733a942a84b33a367be4b', onKeyDown: (event) => this.handleKeyDown(event) }, index.h("slot", { key: 'fea7b16a4becc94ce203239b0066963b3dbb0104', name: "header" }), !!this.options.length && (index.h("nav", { key: '8a3d8a5ce7af2c43f5125c00155a16207e6d533b', class: "flex-fill overflow-visible pb-16" }, index.h("div", { key: '0b91c6fc50b4072f1cc5e4cb00f0173ad7d62ee9', class: "flex flex-col", role: "menu" }, this.getListItems))), index.h("slot", { key: 'c75db3c34e8f1112d6da1473ecaeb14b0ea359a1' })));
    }
};
