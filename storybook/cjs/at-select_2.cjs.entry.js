...
const AtSelectComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: '9ac79191912a0e9c6d7118284fbe7467f867e5b1', class: "group/select", onFocusout: async (event) => {
            ...
            } }, this.renderLabel(), index.h("at-menu", { key: '7b33c4c2b4f76c68af333d06dd9988e0cf05991b', ref: (el) => (this.menuRef = el), trigger: "click", align: "start", width: this.parentWidth, role: "listbox", disabled: this.disabled || this.readonly, onAtuiMenuStateChange: (event) => this.updateIsOpenState(event) }, this.renderInput(), !this.disabled || !this.readonly
            ? this.renderOptions()
            : null), index.h("div", { key: '8f52c8b5b8dc7ed13b67d9d213947ef7c9a9f356' }, this.error_text && this.invalid && (index.h("span", { key: '2906580c5a3a728f113341a4a40d5ee1c176af6e', class: "text-error", "data-name": "select-error" }, this.error_text)))));
    }
    renderLabel() {
...
const AtSelectOptionComponent = class {
    ...
    render() {
        ...
        return (index.h("li", { key: 'fde3b350ee2dd1609cc376483191f9666aa8dd71', role: "option", value: this.value, "data-name": "select-option", "aria-selected": this.is_active ? 'true' : 'false', tabIndex: 0, class: classname, onClick: () => this.handleClick() }, index.h("slot", { key: '25ae12d21b641730d0186ac5c30f5820b19c941a' }), this.value));
    }
};
