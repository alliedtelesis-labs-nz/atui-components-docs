...
const AtRelativeDateTimeCell = class {
    ...
    render() {
        return (index.h(index.Host, { key: '9b980892df5e89de9a3d27eca331a9acc3a50a58', class: "flex h-full items-center" }, index.h("div", { key: '2f48e1ee19f543b08688dc6cbfbf2e4cd259d130', class: "flex h-full flex-col justify-center" }, index.h("div", { key: '58f89b688d5dfa7ecdf5be850310f2a09198a994', class: "truncate text-sm leading-normal" }, this.relativeLabel), this.dateTimeLabel && (index.h("div", { key: 'e7b5ea51c584db5228baf28f0d943784551c10da', class: "text-med truncate text-[10px] leading-normal font-normal" }, "(", this.dateTimeLabel, ")")))));
    }
};
