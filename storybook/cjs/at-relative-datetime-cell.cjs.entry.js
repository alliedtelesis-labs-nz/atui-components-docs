...
const AtRelativeDateTimeCell = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'bb6b2ebdd53862ab0ef7d7a49c54bcdc5988aec0', class: "flex h-full items-center" }, index.h("div", { key: '7de4626263c9454d0800ba151c7bac94e3831b83', class: "flex h-full flex-col justify-center" }, index.h("div", { key: 'd1b2afdfb1853ea02932d81f6b32292ed1ba7854', class: "truncate text-sm leading-normal" }, this.relativeLabel), this.dateTimeLabel && (index.h("div", { key: '07c0e2a2d3acc30bd7bfd43357b29def75d1f65f', class: "text-med truncate text-[10px] leading-normal font-normal" }, "(", this.dateTimeLabel, ")")))));
    }
};
