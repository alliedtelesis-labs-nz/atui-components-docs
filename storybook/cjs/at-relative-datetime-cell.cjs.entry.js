...
const AtRelativeDateTimeCell = class {
    ...
    render() {
        return (index.h(index.Host, { key: '9a64d465e2384b7a6aabf3390773a907a2219984', class: "flex h-full items-center" }, index.h("div", { key: 'c533f230f7a5e48fbe28a1facf33a73acb164218', class: "flex h-full flex-col justify-center" }, index.h("div", { key: '47e6c4c578b8e363b14527f6e09fbc173267c9e6', class: "truncate text-sm leading-normal" }, this.relativeLabel), this.dateTimeLabel && (index.h("div", { key: 'decee34e39a3e716cc237d904d63ef8364ad2439', class: "text-med truncate text-[10px] leading-normal font-normal" }, "(", this.dateTimeLabel, ")")))));
    }
};
