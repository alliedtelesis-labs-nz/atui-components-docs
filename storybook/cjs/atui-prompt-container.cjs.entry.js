...
const AtuiPromptContainer = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'ebb9b82721b0812c9f21139df13808478a03e8ac', class: "flex h-full w-full flex-col overflow-hidden", "data-name": "prompt-container" }, this.renderHeader(), index.h("slot", { key: '2124122c3fdb640825e351355d5535f74ce0de4b', name: "prompt-container-header" }), index.h("div", { key: 'fb818dffdebc5d911e97b115ba3110980816f434', class: "min-h-0 flex-1", "data-name": "thread-wrapper" }, index.h("atui-prompt-thread", { key: '424ef20d956e1e667ed3ee97c15b5e4f1ae53e7e', messages: this.messages, loading: this.loading, auto_scroll: true, enable_vote: this.enable_vote, enable_copy: this.enable_copy, enable_edit: this.enable_edit, "data-name": "container-thread" })), index.h("div", { key: 'f4ad7650d32a04fef7a811209bfffca5ab6643e7', class: "flex flex-col gap-4" }, this.renderFooter(), index.h("slot", { key: '0af32a02bdd958258e1250c3c58b6af2de545099', name: "prompt-container-footer" }))));
    }
