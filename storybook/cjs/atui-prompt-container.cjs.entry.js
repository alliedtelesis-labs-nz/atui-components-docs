...
const AtuiPromptContainer = class {
    ...
    render() {
        return (index.h(index.Host, { key: '917e270cd63941ff59a50f8e1ff8c88763811ea0', class: "flex h-full w-full flex-col overflow-hidden", "data-name": "prompt-container" }, this.renderHeader(), index.h("slot", { key: '981c3c350f1ec08bf17b559ce4ffb691639d8971', name: "prompt-container-header" }), index.h("div", { key: '12e18d43113545c8a1f5de896d5cfe036ae3256a', class: "min-h-0 flex-1", "data-name": "thread-wrapper" }, index.h("atui-prompt-thread", { key: '2f22ce7bda58e229b1d3b177d703d977aa563a57', messages: this.messages, loading: this.loading, auto_scroll: true, enable_vote: this.enable_vote, enable_copy: this.enable_copy, enable_edit: this.enable_edit, "data-name": "container-thread" })), index.h("div", { key: '581fcdc1e8f3fbec2383a12d6365439a83b94340', class: "flex flex-col gap-4" }, this.renderFooter(), index.h("slot", { key: '31852c347b013a39f8560b3bc596e03411d80dd9', name: "prompt-container-footer" }))));
    }
