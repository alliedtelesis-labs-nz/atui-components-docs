...
const AtuiPromptContainer = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'fc3d37ac6b1bc83e2c62c35e0edf6ab0ea3202ee', class: "flex h-full w-full flex-col overflow-hidden", "data-name": "prompt-container" }, this.renderHeader(), index.h("slot", { key: '3c0361b99775169258d4d21ed0a27fb5cb92bba4', name: "prompt-container-header" }), index.h("div", { key: '6a6680558d1057e5fed2a8d232482edf9a121264', class: "min-h-0 flex-1", "data-name": "thread-wrapper" }, index.h("atui-prompt-thread", { key: '9ccc7ec300c4ef81f2f076350a53e506965d75a4', messages: this.messages, loading: this.loading, auto_scroll: true, enable_vote: this.enable_vote, enable_copy: this.enable_copy, enable_edit: this.enable_edit, "data-name": "container-thread" })), index.h("div", { key: '752593cbe013d353355ba3eb8967104d3e078799', class: "flex flex-col gap-4" }, this.renderFooter(), index.h("slot", { key: '8d5c37295d79001f79268d74920570f258b0bb12', name: "prompt-container-footer" }))));
    }
