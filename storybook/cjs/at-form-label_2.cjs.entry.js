...
const AtFormLabelComponent = class {
    ...
    for;
    render() {
        return (index.h("div", { key: 'e01090c68771ffed22245a13690edc8f48fcb5c9', class: "flex items-center gap-8" }, [
            (this.label || this.required) && (index.h("label", { key: 'c252d4b23f41d33fdcb287ea8060546ecd261c34', htmlFor: this.for ?? undefined, class: "flex gap-4" }, this.label, this.required && index.h("span", { key: 'b773a79d3e5089ef447617830bf9253f37d12cec', class: "text-error" }, "*"))),
            this.info_text && (index.h("at-tooltip", { key: 'f20cc801f79759efa3fe554a4f0b21dd18f76f71', position: "right" }, index.h("span", { key: '71adaa0747cdc948d52294f51d32fb77909244da', slot: "tooltip-trigger", class: "material-icons !text-icon-sm text-light cursor-pointer" }, "info_outline"), index.h("span", { key: '926a6b15c7905f61e34ce6791d9986dc84a2c1a7' }, this.info_text))),
        ]));
    }
};
...
const AtTooltip = class {
    ...
    render() {
        return (index.h(index.Host, { key: '2ef1afc5e5e8d4d3fe3741934ff06d9f6e0ddb8c', class: "relative" }, !this.trigger_id && (index.h("div", { key: '65916b0145c47fd48a1e46b8e888bacc351e62aa', "aria-haspopup": "true", "data-name": "tooltip-trigger", ref: (el) => (this.triggerEl = el), "aria-expanded": `${this.isOpen ? 'true' : 'false'}`, class: this.disabled ? 'contents' : '', onMouseEnter: () => !this.disabled ? this.mouseEnterHandler() : null, onMouseLeave: () => !this.disabled ? this.mouseLeaveHandler() : null }, index.h("slot", { key: '7a9fee4331a59317ae91bd8042a499f969409ebf', name: "tooltip-trigger" }))), index.h("div", { key: '909a404a081e6c8f396340e76b992ba75e878f36', ref: (el) => (this.tooltipEl = el), "data-position": this.position, "data-align": this.align, popover: "auto", id: this.popoverId, class: "pointer-events-none w-fit rounded-md bg-gray-950/80 px-[6px] py-2 text-sm text-white opacity-0 shadow-md transition-opacity duration-200 ease-out", "data-name": "tooltip-content-wrapper" }, index.h("slot", { key: '7e27b552b120b8ddd7fab35ca930debf66cadf95' }))));
    }
