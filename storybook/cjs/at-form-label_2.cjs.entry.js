...
const AtTooltip = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'c829e4a0c8adfa79e1da90f3034c37932bd86822', class: "relative" }, !this.trigger_id && (index.h("div", { key: '7bf9e4b4fc46ca3fcb2343582357d90c88ad5c3f', "aria-haspopup": "true", "data-name": "tooltip-trigger", ref: (el) => (this.triggerEl = el), "aria-expanded": `${this.isOpen ? 'true' : 'false'}`, class: this.disabled ? 'contents' : '', onMouseEnter: () => !this.disabled ? this.mouseEnterHandler() : null, onMouseLeave: () => !this.disabled ? this.mouseLeaveHandler() : null }, index.h("slot", { key: '7b976a13c6aeac0f0959f414c33a6a2871ad7fdf', name: "tooltip-trigger" }))), index.h("div", { key: '9783ea78abf93b8f38bd25f50f0cb1b6811558f3', ref: (el) => (this.tooltipEl = el), "data-position": this.position, "data-align": this.align, popover: "auto", id: this.popoverId, class: "pointer-events-none w-fit rounded-md bg-gray-950/80 px-[6px] py-2 text-sm text-white opacity-0 shadow-md transition-opacity duration-200 ease-out", "data-name": "tooltip-content-wrapper" }, index.h("slot", { key: '319c91809a71e4ba406ca025e69cb6c0aaa462ce' }))));
    }
