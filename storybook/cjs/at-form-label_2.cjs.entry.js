...
const AtTooltip = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'cf840400d8dcfaaeb5435ffc0e39266c6620e59e', class: "relative" }, !this.trigger_id && (index.h("div", { key: '41d4da9ed82d13b4f3b4ae948ee1208a56945322', "aria-haspopup": "true", "data-name": "tooltip-trigger", ref: (el) => (this.triggerEl = el), "aria-expanded": `${this.isOpen ? 'true' : 'false'}`, class: this.disabled ? 'contents' : '', onMouseEnter: () => !this.disabled ? this.mouseEnterHandler() : null, onMouseLeave: () => !this.disabled ? this.mouseLeaveHandler() : null }, index.h("slot", { key: '1882eccbc69e146b55cd49c59f35d15516f8b177', name: "tooltip-trigger" }))), index.h("div", { key: 'dda0a91c5161e1b7acc4c515be0c45cd9c62cc06', ref: (el) => (this.tooltipEl = el), "data-position": this.position, "data-align": this.align, popover: "auto", id: this.popoverId, class: "pointer-events-none w-fit rounded-md bg-gray-950/80 px-[6px] py-2 text-sm text-white opacity-0 shadow-md transition-opacity duration-200 ease-out", "data-name": "tooltip-content-wrapper" }, index.h("slot", { key: '5fad8086aed074921533004c1bb8899064aa8855' }))));
    }
