...
const AtTooltip = class {
    ...
    render() {
        return (index.h(index.Host, { key: '55759b9653f05e9b43fdab561140e0f8d08c1f53', class: "relative" }, !this.trigger_id && (index.h("div", { key: '71ece6b2952ff22b391708428ca77ffcb3f417f1', "aria-haspopup": "true", "data-name": "tooltip-trigger", ref: (el) => (this.triggerEl = el), "aria-expanded": `${this.isOpen ? 'true' : 'false'}`, class: this.disabled ? 'contents' : '', onMouseEnter: () => !this.disabled ? this.mouseEnterHandler() : null, onMouseLeave: () => !this.disabled ? this.mouseLeaveHandler() : null }, index.h("slot", { key: 'dc184007184bbfc7b1b2e69f92c0b4149979e0c9', name: "tooltip-trigger" }))), index.h("div", { key: 'a93994e14424f84ae7e9c60607b89451df6b7ce0', ref: (el) => (this.tooltipEl = el), "data-position": this.position, "data-align": this.align, popover: "auto", id: this.popoverId, class: "pointer-events-none w-fit rounded-md bg-gray-950/80 px-[6px] py-2 text-sm text-white opacity-0 shadow-md transition-opacity duration-200 ease-out", "data-name": "tooltip-content-wrapper" }, index.h("slot", { key: '344374059a0bebdf1949898059eba14f9827dfcd' }))));
    }
