...
const AtTooltip = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'e6052dac66eeb524f426fa02af842cd826accc0c', class: "relative" }, !this.trigger_id && (index.h("div", { key: '4cbe71c448fe7b1f9444aacbe7eb93b8fb9c7961', "aria-haspopup": "true", "data-name": "tooltip-trigger", ref: (el) => (this.triggerEl = el), "aria-expanded": `${this.isOpen ? 'true' : 'false'}`, class: this.disabled ? 'contents' : '', onMouseEnter: () => !this.disabled ? this.mouseEnterHandler() : null, onMouseLeave: () => !this.disabled ? this.mouseLeaveHandler() : null }, index.h("slot", { key: 'c5b301e2f5072b93ecd18cd6a2cfbde83ba4f80e', name: "tooltip-trigger" }))), index.h("div", { key: '0ecd652b4eacf627a02e9294da7acea2332f6637', ref: (el) => (this.tooltipEl = el), "data-position": this.position, "data-align": this.align, popover: "auto", id: this.popoverId, class: "pointer-events-none w-fit rounded-md bg-gray-950/80 px-[6px] py-2 text-sm text-white opacity-0 shadow-md transition-opacity duration-200 ease-out", "data-name": "tooltip-content-wrapper" }, index.h("slot", { key: '7d61d795b486332e0111cb65da9c56f5d9067b6c' }))));
    }
