...
const AtFormLabelComponent = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'e52a5a37130898e8537efeea0d5bc6b041fd426b', class: "flex items-center gap-8" }, [
            (this.label || this.required) && (index.h("label", { key: '7c0dc564ab386bb31cf5dc79c5b741b8b7e19864', htmlFor: (_a = this.for) !== null && _a !== void 0 ? _a : undefined, class: "flex gap-4" }, this.label, this.required && index.h("span", { key: 'aba209d4d38d4954bb3edc9773cb0211019e08fb', class: "text-error" }, "*"))),
...
const AtTooltip = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'e9b71be5f8ee10f2ae95a27c3441d5258c18560e', class: "relative" }, !this.trigger_id && (index.h("div", { key: '5b7e1eef93ed84ec9a96bd32a985ffb0b2715387', "aria-haspopup": "true", "data-name": "tooltip-trigger", ref: (el) => (this.triggerEl = el), "aria-expanded": `${this.isOpen ? 'true' : 'false'}`, class: this.disabled ? 'contents' : '', onMouseEnter: () => !this.disabled ? this.mouseEnterHandler() : null, onMouseLeave: () => !this.disabled ? this.mouseLeaveHandler() : null }, index.h("slot", { key: 'da251bdb814e2824166a8aa6b53bf92038b99f80', name: "tooltip-trigger" }))), index.h("div", { key: '940e95173fade08a284857a636f9a167f3f09ca6', ref: (el) => (this.tooltipEl = el), "data-position": this.position, "data-align": this.align, popover: "auto", id: this.popoverId, class: "pointer-events-none w-fit rounded-md bg-gray-950/80 px-[6px] py-2 text-sm text-white opacity-0 shadow-md transition-opacity duration-200 ease-out", "data-name": "tooltip-content-wrapper" }, index.h("slot", { key: '59e4a4829a0bbd77d0f44baea16458ddfb64f7e0' }))));
    }
