...
const AtTooltip = class {
    ...
    render() {
        return (index.h(index.Host, { key: '888aeef8ac0f62a099a9b7bc531bade195c048ba', class: "relative" }, !this.trigger_id && (index.h("div", { key: 'c7164bd42fe9c27d8b1c94231fea4dd995b28607', "aria-haspopup": "true", "data-name": "tooltip-trigger", ref: (el) => (this.triggerEl = el), "aria-expanded": `${this.isOpen ? 'true' : 'false'}`, class: this.disabled ? 'contents' : '', onMouseEnter: () => !this.disabled ? this.mouseEnterHandler() : null, onMouseLeave: () => !this.disabled ? this.mouseLeaveHandler() : null }, index.h("slot", { key: '2887626a315d27f21626c63e3b59823b9d91127a', name: "tooltip-trigger" }))), index.h("div", { key: '9c7aa7c863c6d9ff41f517d7ff95053189719b99', ref: (el) => (this.tooltipEl = el), "data-position": this.position, "data-align": this.align, popover: "auto", id: this.popoverId, class: "pointer-events-none w-fit rounded-md bg-gray-950/80 px-[6px] py-2 text-sm text-white opacity-0 shadow-md transition-opacity duration-200 ease-out", "data-name": "tooltip-content-wrapper" }, index.h("slot", { key: '326250ae0447c404bf2b5706a3bcf05ff0c880a7' }))));
    }
