...
const AtSearchTable = class {
    ...
    render() {
        return (index.h(index.Host, { key: '40ae19c38d992ee6107c01e84d299e8dff04b778' }, index.h("at-table-actions", { key: '29e1eabb3b400cc00b12a40513f5f917470f2176', ag_grid: this.agGrid }, index.h("div", { key: '7b0053a3ec65d775bd50ef621645efe2798067d2', class: "flex items-center gap-8", slot: "search" }, this.shouldShowDropdownFilters && (index.h("at-table-filter-menu", { key: 'f67427bbbac0dcc792d1ead8f62f7f5b7eac052f', slot: "filter-menu", col_defs: this.col_defs, selected: this.menuSelectedIds, onAtChange: (event) => this.handleFilterChange(event) })), index.h("at-search", { key: '311a38826ce285711e2645cf32f830833e41c269', class: "w-input-md", label: this.search_label, hint_text: this.search_hint, info_text: this.search_info_tooltip, placeholder: this.translations.ATUI.TABLE.SEARCH_BY_KEYWORD, onAtChange: (event) => this.handleSearchChange(event) })), this.shouldShowDropdownFilters && (index.h("at-table-filters", { key: '5933d9021f50841ce0f05cc3d35060a882347a75', slot: "filters", col_defs: this.col_defs, selected: this.selectedFilters, onAtChange: (event) => this.handleFilterChange(event) })), !this.hide_export_menu && (index.h("at-table-export-menu", { key: 'dbd551c2df15716686a8dfbbffe896a138fd32d0', slot: "export-menu" })), this.shouldShowColumnManager && (index.h("at-column-manager", { key: '2bcb6c0c8feb64c49d5bb730594e22f0ebc59e15', slot: "column-manager", col_defs: this.col_defs, onAtChange: (event) => this.handleColumnChange(event) })), index.h("div", { key: 'adb28cd9ef870dbb2dca602a2ce5e4995869d3be', slot: "actions" }, index.h("slot", { key: 'b19d352baabd5286442f5c1462bcdac5b1a60d90', name: "actions" }))), index.h("slot", { key: 'd0fbbc0b496c951665e5831e6a858da9ab6c90ba', name: "multi-select-actions" }), index.h("at-table", { key: 'c7a8d79a081f8ebbddea3a7ad728a2142a9337de', ref: (el) => (this.tableEl = el), table_data: this.table_data, col_defs: this.col_defs, page_size: this.page_size, use_custom_pagination: this.use_custom_pagination, disable_auto_init: true, auto_size_columns: this.auto_size_columns })));
    }
