...
const AtSearchTable = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'd365d54836c5305fe434855dcb595cf00b516b0c' }, index.h("at-table-actions", { key: 'f9b044c074e60db6579406edbd1985c497536204', ag_grid: this.agGrid }, index.h("div", { key: 'fc8b83fae3f99fff5bac3553db56282e0acb1c99', class: "flex items-center gap-8 px-8", slot: "search" }, this.shouldShowDropdownFilters && (index.h("at-table-filter-menu", { key: '6177b32830c84f285c6ee2c14b6e3271d0e318a4', slot: "filter-menu", col_defs: this.col_defs, selected: this.menuSelectedIds, onAtChange: (event) => this.handleFilterChange(event) })), index.h("at-search", { key: 'd03c3226f3e6add08fb8e9ad83e35799588e9d6d', class: "w-input-md", label: this.search_label, hint_text: this.search_hint, info_text: this.search_info_tooltip, placeholder: this.translations.ATUI.TABLE.SEARCH_BY_KEYWORD, onAtChange: (event) => this.handleSearchChange(event) })), this.shouldShowDropdownFilters && (index.h("at-table-filters", { key: '1b65fb9e449a1e553c3456a61be8b3e30d371dce', slot: "filters", col_defs: this.col_defs, selected: this.selectedFilters, onAtChange: (event) => this.handleFilterChange(event) })), !this.hide_export_menu && (index.h("at-table-export-menu", { key: 'ff13b17f769e6e3722b06261ea52f4d4490ea2f3', slot: "export-menu", hide_csv: this.hide_csv_export, hide_pdf: this.hide_pdf_export, onAtChange: (event) => this.handleExport(event) })), this.shouldShowColumnManager && (index.h("at-column-manager", { key: 'c710e684963175876bcf3ec24c179ca7ea9be905', slot: "column-manager", col_defs: this.col_defs, onAtChange: (event) => this.handleColumnChange(event) })), index.h("div", { key: '02055bbba01b0b569c82aac880ffadf38b522687', slot: "actions" }, index.h("slot", { key: 'b2c0edf27364c9cefc016fa1a888bbcfb02e6a2d', name: "actions" }))), index.h("slot", { key: '1cee10d347a627c970a66bece8dc44453927522e', name: "multi-select-actions" }), this.loading && this.server_side_mode ? (index.h("at-placeholder", { size: "lg", placeholder_title: this.translations?.ATUI?.TABLE?.LOADING_DATA, show_loading_spinner: true })) : (index.h("at-table", { ref: (el) => (this.tableEl = el), table_data: this.table_data, col_defs: this.col_defs, page_size: this.server_side_mode
                ? this.pageSize
                : this.page_size, use_custom_pagination: this.server_side_mode, auto_size_columns: this.auto_size_columns, disable_auto_init: !this.server_side_mode })), this.server_side_mode && (index.h("at-table-pagination", { key: 'a417d7da0f87743a200c9182e0bf1df0be926546', current_page: this.currentPage, num_pages: this.totalPages, onAtChange: (event) => this.handlePageChange(event), onAtPageSizeChange: (event) => this.handlePageSizeChange(event) }))));
    }
