...
const AtSearchTable = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'c95f4481aef5bf6e2eb5d39d140f474aacc90233', class: this.server_side_mode ? 'is-loading' : '' }, index.h("at-table-actions", { key: '2999b3f4b78c6c98f44f9aa539937a2612cd929f', ag_grid: this.agGrid }, index.h("at-control-group", { key: '107e8b1c7a4211bc3e8ae441e9e870b13d5f0e3d', slot: "search" }, this.shouldShowTableFilters &&
            !this.search_filters && (index.h("at-table-filter-menu", { key: 'a53449e9ea59aa549ef3b0eb6f51c0cab9fca631', col_defs: this.col_defs, filters: this.selectedFilters, onAtChange: (event) => this.handleFilterChange(event) })), index.h("at-search", { key: 'ab07e4f17fb1a908c53a181b127f4bccff32d14d', class: "w-input-md",
            // label={this.search_label}
            hint_text: this.search_hint, info_text: this.search_info_tooltip, placeholder: this.translations.ATUI.TABLE.SEARCH_BY_KEYWORD, onAtChange: (event) => this.handleSearchChange(event) })), this.shouldShowTableFilters && (index.h("at-table-filters", { key: '722d6303d34c6210d7ff3edc8bc4947352ff4f76', slot: "filters", filters: this.selectedFilters, onAtChange: (event) => this.handleFilterChange(event) })), !this.hide_export_menu && (index.h("at-table-export-menu", { key: 'd92c92bad18e2e70047f6e62f16e8585d04def60', slot: "export-menu", hide_csv: this.hide_csv_export, hide_pdf: this.hide_pdf_export, onAtChange: (event) => this.handleExport(event) })), this.shouldShowColumnManager && (index.h("at-column-manager", { key: '3e34303dc188c5bd16d26b4f659e6c9ea4943330', slot: "column-manager", col_defs: this.col_defs, onAtChange: (event) => this.handleColumnChange(event) })), index.h("div", { key: 'ceded9126d65e0b0601dae6a8d1873a6cb8ba5df', slot: "actions" }, index.h("slot", { key: 'e7e5783af72627e98654ac58f085f690d33df941', name: "actions" }))), index.h("slot", { key: '41bc1611e74b405593347e23ee7898f637dd55a9', name: "multi-select-actions" }), index.h("div", { key: 'ff812de50090e0dae6f8bcf21f0330a5411ad963', class: "relative" }, index.h("at-table", { key: '911b60cea6358e7ed1d743aaa5bc5c68f6e28c35', ref: (el) => (this.tableEl = el), table_data: this.table_data, col_defs: this.col_defs, page_size: this.server_side_mode
                ? this.pageSize
                : this.page_size, use_custom_pagination: this.server_side_mode || this.use_custom_pagination, use_custom_sorting: this.server_side_mode, auto_size_columns: this.auto_size_columns, disable_auto_init: !this.server_side_mode }), this.server_side_mode && (index.h("div", { key: '1f420b21239f2aebc70e255ab16fb5dad9dc075f', class: `loading-overlay bg-surface-foreground/80 absolute inset-0 z-10 items-center justify-center py-120 ${this.showLoadingOverlay ? 'is-visible' : ''}` }, index.h("div", { key: 'a632625df37ae9bcf24069e69411304510ddfc54', class: "flex items-center" }, index.h("at-loading", { key: '8ae4d420b68ea9f6c756c4003c2e59a7178723d8', class: "relative mr-8", size: "sm", "data-name": "placeholder-spinner" }), index.h("span", { key: '41a8a73ed074d5a2d6ea5382b46a5dff4576bf99', class: "text-secondary text-sm font-medium", "data-name": "placeholder-title" }, this.translations?.ATUI?.TABLE
            ?.LOADING_DATA)))), this.server_side_mode && (index.h("div", { key: 'f3e0a0018b66148c6b4c379f291522b5da1a8d08', class: `no-data-overlay absolute inset-0 z-10 flex-col items-center justify-center gap-8 py-120 ${!this.loading && this.hasNoData ? 'is-visible' : ''}` }, index.h("at-icon", { key: '0565b63303f3d3824ce96e020d0c763fca7e212e', class: "fill-slate-300", name: this.hasActiveSearch
                ? 'search'
                : 'data_table', size: "sm", "data-name": "no-data-icon" }), index.h("span", { key: '77f39bc1da6663de89540e4871d0dd8d403848f5', class: "text-secondary text-sm font-medium", "data-name": "no-data-title" }, this.hasActiveSearch
            ? this.translations?.ATUI?.NO_RESULTS_FOUND
            : (this.no_data_message ??
                this.translations?.ATUI?.TABLE?.NO_DATA))))), this.server_side_mode && (index.h("at-table-pagination", { key: '02c262085636d36fd8faefce04c347b95245b307', current_page: this.currentPage, num_pages: this.totalPages, page_size: this.pageSize, page_size_options: this.page_size_options, onAtChange: (event) => this.handlePageChange(event), onAtPageSizeChange: (event) => this.handlePageSizeChange(event) }))));
    }
