...
const AtSearchTable = class {
    ...
    render() {
        return (index.h(index.Host, { key: '395e30d739d8fe27ddce5541443f2003d667963d' }, index.h("at-table-actions", { key: 'b62e36ceed43865e2ed920cd3d9de65574bddd52', ag_grid: this.agGrid }, index.h("div", { key: '04c97a39842a97d7d27159dda094a7e448a534fa', class: "flex items-center gap-8", slot: "search" }, this.shouldShowDropdownFilters && (index.h("at-table-filter-menu", { key: '00da3fcaae27527a885f2b0f13cf1ee275d38080', slot: "filter-menu", col_defs: this.col_defs, selected: this.menuSelectedIds, onAtChange: (event) => this.handleFilterChange(event) })), index.h("at-search", { key: '4770b2b88502fbdcc4b3e79c5ba09f5010ac7a75', class: "w-input-md", label: this.search_label, hint_text: this.search_hint, info_text: this.search_info_tooltip, placeholder: this.translations.ATUI.TABLE.SEARCH_BY_KEYWORD, onAtChange: (event) => this.handleSearchChange(event) })), this.shouldShowDropdownFilters && (index.h("at-table-filters", { key: '91f236c73422955cec60320d71ba8812501f5d95', slot: "filters", col_defs: this.col_defs, selected: this.selectedFilters, onAtChange: (event) => this.handleFilterChange(event) })), !this.hide_export_menu && (index.h("at-table-export-menu", { key: 'db6ec8cb7096ca321e69ee1944e77e2b7773f51d', slot: "export-menu" })), this.shouldShowColumnManager && (index.h("at-column-manager", { key: '2685c378b123485c4a76bf250663f103035328d3', slot: "column-manager", col_defs: this.col_defs, onAtChange: (event) => this.handleColumnChange(event) })), index.h("div", { key: '92ff72b7bf00f71af3478cc28d017a36b0c19dcd', slot: "actions" }, index.h("slot", { key: '2bf7dfd31c58829798967874e47c33daba410ef7', name: "actions" }))), index.h("slot", { key: 'c8aeb0ea961bfc89fe1ce107b845453a4fdcb480', name: "multi-select-actions" }), index.h("at-table", { key: 'c79366ef8e338d4574fa739a6a305549340ef709', ref: (el) => (this.tableEl = el), table_data: this.table_data, col_defs: this.col_defs, page_size: this.page_size, use_custom_pagination: this.use_custom_pagination, disable_auto_init: true, auto_size_columns: this.auto_size_columns })));
    }
