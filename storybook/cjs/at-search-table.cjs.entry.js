...
const AtSearchTable = class {
    ...
    render() {
        return (index.h(index.Host, { key: '0a635c2b39b5b1befe2c255bcf2c9cd66c36a48b', class: this.server_side_mode ? 'is-loading' : '' }, index.h("at-table-actions", { key: 'e11b3e5e6c6e3756f388a5eab132bcef07c7dcb3', ag_grid: this.agGrid }, index.h("at-control-group", { key: '503e912e94e9d985b6ad50a8450b7d437ace5652', slot: "search" }, this.shouldShowTableFilters && (index.h("at-table-filter-menu", { key: '7506193c01804ba41ed1ce007d154c81aa5c091a', ref: (el) => (this.filterMenuEl =
                el), col_defs: this.col_defs, filters: this.selectedFilters, onAtChange: (event) => this.handleFilterChange(event) })), index.h("at-search", { key: '0dbe256596e04e59923193a7ae6e7e0262b43f7f', class: "w-input-md", info_text: this.searchInfoTooltip, placeholder: this.translations.ATUI.TABLE.SEARCH_BY_KEYWORD, onAtChange: (event) => this.handleSearchChange(event) })), index.h("div", { key: '0d5f8e2042761e7e1640b7e3193f191b5a17f282', class: "contents", slot: "filter-bar" }, index.h("slot", { key: 'b5f3b941cb01c923144f1757d0c17280c60b8ef4', name: "filter-bar" })), this.hasDisplayableFilters && (index.h("at-table-filters", { key: '00819735ea53c2c9aee9358f363f598e365b595a', slot: "filters", filters: this.chipFilterTree(), onAtChange: (event) => this.handleFilterChange(event), onAtFilterClick: () => this.filterMenuEl?.openMenu() })), this.show_reload_button && (index.h("at-reload-button", { key: 'ec32de836c07c3c084f8f17a903bedd0726bca23', slot: "reload-button", has_updates: this.has_updates, onAtuiReload: (event) => {
            ...
            } })), this.show_export_menu && (index.h("at-table-export-menu", { key: 'f8dc9ec2f031dd880ba4127dff632cd1c94ae9f6', slot: "export-menu", show_csv: this.show_csv_export, show_pdf: this.show_pdf_export, onAtChange: (event) => this.handleExport(event) })), this.shouldShowColumnManager && (index.h("at-column-manager", { key: 'e048ce6d487529a5a50f91e3a512bf48e5339553', slot: "column-manager", col_defs: this.col_defs, onAtChange: (event) => this.handleColumnChange(event) })), index.h("div", { key: 'bc7c917851d93b9ddf908b93ec5383718f1e975c', slot: "leading-actions" }, index.h("slot", { key: 'f5080b3674ed7084695e4f82e1e8f2cf08d0227b', name: "leading-actions" })), index.h("div", { key: '62d27f4759543be55fdb6b6a3a8242b886743e76', slot: "actions" }, index.h("slot", { key: 'f3a68c7faeb23532633ab7a0adec1c54c69fefb1', name: "actions" }))), this.renderSelectionBar(), index.h("div", { key: '12edbae1afc86b9a5a89047527cc309ecbab5b8e', class: "relative" }, index.h("at-table", { key: '37ec50dcccbff9e3ba52e64431fa7beab90cce7f', ref: (el) => (this.tableEl = el), table_data: this.table_data, col_defs: this.gridColDefs, row_id_field: this.row_id_field, page_size: this.server_side_mode
                ? this.pageSize
                : this.page_size, use_custom_pagination: this.server_side_mode || this.use_custom_pagination, use_custom_sorting: this.server_side_mode, auto_size_columns: this.auto_size_columns, can_auto_init: false, onAtColumnVisibilityChange: (event) => this.syncColumnVisibility(event) }), this.server_side_mode && (index.h("div", { key: '4f557d795e9248769bbd97d5bac02829b9a56fbd', class: `loading-overlay bg-surface-foreground/80 absolute inset-0 z-10 items-center justify-center py-120 ${this.showLoadingOverlay ? 'is-visible' : ''}` }, index.h("div", { key: '13eda7d4636b4ac7476216f3d77b3b7e5c42eb8a', class: "flex items-center" }, index.h("at-loading", { key: '9f005f2d9d34dbfb419650010236859aad3f56c3', class: "relative mr-8", size: "sm", "data-name": "placeholder-spinner" }), index.h("span", { key: '40e46b390e799cf74a3b24ea80508d69896af96b', class: "text-secondary text-sm font-medium", "data-name": "placeholder-title" }, this.translations?.ATUI?.TABLE
            ?.LOADING_DATA)))), this.server_side_mode && (index.h("div", { key: '411b995f2cc4f623334bbc4e367c5fae7feefebd', class: `no-data-overlay absolute inset-0 z-10 flex-col items-center justify-center gap-8 py-120 ${!this.is_loading && this.hasNoData ? 'is-visible' : ''}` }, index.h("at-icon", { key: '2695861a77ac67d3b2a914a3a5f4d559dd5938f6', class: "fill-slate-300", name: this.hasActiveSearch
                ? 'search'
                : 'data_table', size: "sm", "data-name": "no-data-icon" }), index.h("span", { key: '244088aff19f97cfaa3502fd79a26b0d4b1d192a', class: "text-secondary text-sm font-medium", "data-name": "no-data-title" }, this.hasActiveSearch
            ? this.translations?.ATUI?.NO_RESULTS_FOUND
            : (this.no_data_message ??
                this.translations?.ATUI?.TABLE?.NO_DATA))))), this.server_side_mode && (index.h("at-table-pagination", { key: '8aac40b584a5862fc69d4d5141bfd54bc4144f03', current_page: this.currentPage, num_pages: this.totalPages, page_size: this.pageSize, page_size_options: this.page_size_options, onAtChange: (event) => this.handlePageChange(event), onAtPageSizeChange: (event) => this.handlePageSizeChange(event) }))));
    }
