...
const AtSearchTable = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'c9f9445dc513c161ceb68566ba85d1d610fef330', class: this.server_side_mode ? 'is-loading' : '' }, index.h("at-table-actions", { key: '0878f3fbeb03c12ffb0ccecdce256c48e5cf8a5f', ag_grid: this.agGrid }, index.h("at-control-group", { key: '15e1fd8c42f5aac409b2abdd0fd5db4e301a19be', slot: "search" }, this.shouldShowTableFilters && (index.h("at-table-filter-menu", { key: 'cdd3f3da4a54fa7578ebf1d4d77ea2aa11c3166f', ref: (el) => (this.filterMenuEl =
                el), col_defs: this.col_defs, filters: this.selectedFilters, onAtChange: (event) => this.handleFilterChange(event) })), index.h("at-search", { key: 'db1d094f15d79efb8387818ccd9231b612ac81dc', class: "w-input-md", info_text: this.searchInfoTooltip, placeholder: this.translations.ATUI.TABLE.SEARCH_BY_KEYWORD, onAtChange: (event) => this.handleSearchChange(event) })), index.h("div", { key: 'd130c85a53156d924a5c2545da39aa854a5c7bf5', class: "contents", slot: "filter-bar" }, index.h("slot", { key: 'd6cbbbb484fc2d09f39e0143abe0b2cb901db72a', name: "filter-bar" })), this.hasDisplayableFilters && (index.h("at-table-filters", { key: 'edd7daee15c5fac0753758af42606cf0017f00f8', slot: "filters", filters: this.chipFilterTree(), onAtChange: (event) => this.handleFilterChange(event), onAtFilterClick: () => this.filterMenuEl?.openMenu() })), this.show_reload_button && (index.h("at-reload-button", { key: '1f5e0f0e665503d043d0faa9e437285d1047dd60', slot: "reload-button", has_updates: this.has_updates, onAtuiReload: (event) => {
            ...
            } })), this.show_export_menu && (index.h("at-table-export-menu", { key: '52150ef6cbd4de95e94a7695804fda9ebb190b8a', slot: "export-menu", show_csv: this.show_csv_export, show_pdf: this.show_pdf_export, onAtChange: (event) => this.handleExport(event) })), this.shouldShowColumnManager && (index.h("at-column-manager", { key: 'd494fa51d25c1942d0365787013273cf5ed63241', slot: "column-manager", col_defs: this.col_defs, onAtChange: (event) => this.handleColumnChange(event) })), index.h("div", { key: '4ba7ef2309933cfdad6cb423f80b5a4c4c75aeca', slot: "leading-actions" }, index.h("slot", { key: '5ff284bea2b8f29a567115bd3b732626473523ce', name: "leading-actions" })), index.h("div", { key: 'e76741e678ac465d0abc24381c58e8ffe21ef9b9', slot: "actions" }, index.h("slot", { key: '093f3b730f89341c3c360fd36a69f758996d79c7', name: "actions" }))), this.renderSelectionBar(), index.h("div", { key: '00d78adb8b131231f7f07f75743e0087d8bc0ce4', class: "relative" }, index.h("at-table", { key: 'd2b65380bbaf26acec2006170f8fc4c08091e8c6', ref: (el) => (this.tableEl = el), table_data: this.table_data, col_defs: this.gridColDefs, row_id_field: this.row_id_field, page_size: this.server_side_mode
                ? this.pageSize
                : this.page_size, use_custom_pagination: this.server_side_mode || this.use_custom_pagination, use_custom_sorting: this.server_side_mode, auto_size_columns: this.auto_size_columns, can_auto_init: false, onAtColumnVisibilityChange: (event) => this.syncColumnVisibility(event) }), this.server_side_mode && (index.h("div", { key: 'be14b1f0fbdd42868274babfe423a434314ec3ca', class: `loading-overlay bg-surface-foreground/80 absolute inset-0 z-10 items-center justify-center py-120 ${this.showLoadingOverlay ? 'is-visible' : ''}` }, index.h("div", { key: '649d49f3240cbc5fc469ee51ea100dd0f304a5d2', class: "flex items-center" }, index.h("at-loading", { key: '865acc8e0641afb442792151d7a98c040ff8ee7a', class: "relative mr-8", size: "sm", "data-name": "placeholder-spinner" }), index.h("span", { key: 'fed244bd93fa2be5d0f90fd5c96f320348dd4c37', class: "text-secondary text-sm font-medium", "data-name": "placeholder-title" }, this.translations?.ATUI?.TABLE
            ?.LOADING_DATA)))), this.server_side_mode && (index.h("div", { key: '9578a91a815b63162464c3be0a6fabc27eeb3d93', class: `no-data-overlay absolute inset-0 z-10 flex-col items-center justify-center gap-8 py-120 ${!this.is_loading && this.hasNoData ? 'is-visible' : ''}` }, index.h("at-icon", { key: '0b4c0b4a843ed85be192532997a43d5a63a6daaa', class: "fill-slate-300", name: this.hasActiveSearch
                ? 'search'
                : 'data_table', size: "sm", "data-name": "no-data-icon" }), index.h("span", { key: 'a9938f2bc681144c4bce66c1bc0c80e49b64d4ef', class: "text-secondary text-sm font-medium", "data-name": "no-data-title" }, this.hasActiveSearch
            ? this.translations?.ATUI?.NO_RESULTS_FOUND
            : (this.no_data_message ??
                this.translations?.ATUI?.TABLE?.NO_DATA))))), this.server_side_mode && (index.h("at-table-pagination", { key: 'f53c9b7c48f1748e8d33ccf7b8e9c4452ba6ef15', current_page: this.currentPage, num_pages: this.totalPages, page_size: this.pageSize, page_size_options: this.page_size_options, onAtChange: (event) => this.handlePageChange(event), onAtPageSizeChange: (event) => this.handlePageSizeChange(event) }))));
    }
