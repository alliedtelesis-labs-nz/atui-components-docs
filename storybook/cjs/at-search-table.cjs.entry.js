...
const AtSearchTable = class {
    ...
    render() {
        return (index.h(index.Host, { key: '11661b4c778cc24839a766f9e6fdbdd68f3211df', class: this.server_side_mode ? 'is-loading' : '' }, index.h("at-table-actions", { key: '8ca58876014a17ed5b5827904e920f64b054f351', ag_grid: this.agGrid }, index.h("at-control-group", { key: '54dcbff5eb20443eb5c7e4f55b055f81f2043689', slot: "search" }, this.shouldShowTableFilters && (index.h("at-table-filter-menu", { key: 'a6d08ccafa3c9e3e16fba6924161d1241b17677d', ref: (el) => (this.filterMenuEl =
                el), col_defs: this.col_defs, filters: this.selectedFilters, onAtChange: (event) => this.handleFilterChange(event) })), index.h("at-search", { key: '12e93415a9935442e27a2b849e4be60dffc45de5', class: "w-input-md", info_text: this.searchInfoTooltip, placeholder: this.translations.ATUI.TABLE.SEARCH_BY_KEYWORD, onAtChange: (event) => this.handleSearchChange(event) })), index.h("div", { key: 'd13a3b4f7e3b014ddf266fdd4ade1fe23776a0f0', class: "contents", slot: "filter-bar" }, index.h("slot", { key: '8eef474fccd3790c355658b8a66de61dcd4ba289', name: "filter-bar" })), this.hasDisplayableFilters && (index.h("at-table-filters", { key: 'c96cf94ff2ec9f9148b4236bb249b9a8ac4fa101', slot: "filters", filters: this.chipFilterTree(), onAtChange: (event) => this.handleFilterChange(event), onAtFilterClick: () => this.filterMenuEl?.openMenu() })), this.show_reload_button && (index.h("at-reload-button", { key: 'f23666829548473d8477d5c57a3e385ac6599377', slot: "reload-button", has_updates: this.has_updates, onAtuiReload: (event) => {
            ...
            } })), this.show_export_menu && (index.h("at-table-export-menu", { key: '4a147be8dceb49579b3e53792d68f2166f1018da', slot: "export-menu", show_csv: this.show_csv_export, show_pdf: this.show_pdf_export, onAtChange: (event) => this.handleExport(event) })), this.shouldShowColumnManager && (index.h("at-column-manager", { key: 'f84372e4e01d2e9262a0d50ba13d6bedc7cf1b4b', slot: "column-manager", col_defs: this.col_defs, onAtChange: (event) => this.handleColumnChange(event) })), index.h("div", { key: '988f8e0fd2fc69c131813913ac593e8c89648578', slot: "leading-actions" }, index.h("slot", { key: '4b5dd812b18b3b2bf8a7e78874d431c7a4733f3d', name: "leading-actions" })), index.h("div", { key: '13d1d7303ff297cba9e669e06a7aa9f45b0fb22f', slot: "actions" }, index.h("slot", { key: 'dbc19860c365d547cb4291cf7eb8201cf0e08f10', name: "actions" }))), this.renderSelectionBar(), index.h("div", { key: '0c75b726e48b356bf8243cdd47d2d7d6c4876b67', class: "relative" }, index.h("at-table", { key: '66e7471f7ef62f0165a752a14d5ab3d444f4ee96', ref: (el) => (this.tableEl = el), table_data: this.table_data, col_defs: this.gridColDefs, row_id_field: this.row_id_field, page_size: this.server_side_mode
                ? this.pageSize
                : this.page_size, use_custom_pagination: this.server_side_mode || this.use_custom_pagination, use_custom_sorting: this.server_side_mode, auto_size_columns: this.auto_size_columns, can_auto_init: false, onAtColumnVisibilityChange: (event) => this.syncColumnVisibility(event) }), this.server_side_mode && (index.h("div", { key: '2f39c5f87e10d8a96014a8df14623ff49f32f4f4', class: `loading-overlay bg-surface-foreground/80 absolute inset-0 z-10 items-center justify-center py-120 ${this.showLoadingOverlay ? 'is-visible' : ''}` }, index.h("div", { key: '8965ba6d15b9cf1927f60859c574be282ca03368', class: "flex items-center" }, index.h("at-loading", { key: '2628bfa2b64bf83d2869fbbb039d5fb965afb212', class: "relative mr-8", size: "sm", "data-name": "placeholder-spinner" }), index.h("span", { key: '9a2470ef7fb87b2c5be41818bcc3da472ecd7be5', class: "text-secondary text-sm font-medium", "data-name": "placeholder-title" }, this.translations?.ATUI?.TABLE
            ?.LOADING_DATA)))), this.server_side_mode && (index.h("div", { key: '50dc5615303436aaaf4e7d469ba3de4da473de9c', class: `no-data-overlay absolute inset-0 z-10 flex-col items-center justify-center gap-8 py-120 ${!this.is_loading && this.hasNoData ? 'is-visible' : ''}` }, index.h("at-icon", { key: '332c2395a26c7b9da97c399f919fbaaa3094307f', class: "fill-slate-300", name: this.hasActiveSearch
                ? 'search'
                : 'data_table', size: "sm", "data-name": "no-data-icon" }), index.h("span", { key: 'a82784dbf72a6b5aba62092b62736c254f14acde', class: "text-secondary text-sm font-medium", "data-name": "no-data-title" }, this.hasActiveSearch
            ? this.translations?.ATUI?.NO_RESULTS_FOUND
            : (this.no_data_message ??
                this.translations?.ATUI?.TABLE?.NO_DATA))))), this.server_side_mode && (index.h("at-table-pagination", { key: '9700e1a3da03c4a9856f0d3fd8e8310eeb19cc1c', current_page: this.currentPage, num_pages: this.totalPages, page_size: this.pageSize, page_size_options: this.page_size_options, onAtChange: (event) => this.handlePageChange(event), onAtPageSizeChange: (event) => this.handlePageSizeChange(event) }))));
    }
