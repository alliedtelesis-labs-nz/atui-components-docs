...
const AtSearchTable = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'addd8fe75c58dbeaa56c30d60861b3344fd2d9d3', class: this.server_side_mode ? 'is-loading' : '' }, index.h("at-table-actions", { key: 'fcb647d808fccc51942b92c022bd519c3db47bc7', ag_grid: this.agGrid }, index.h("at-control-group", { key: '48136cf0ce8c057313917f30bcadb9da7287e5fd', slot: "search" }, this.shouldShowTableFilters && (index.h("at-table-filter-menu", { key: 'bf56247f9fc3b7e9927916aab8c0b0816084b567', ref: (el) => (this.filterMenuEl =
                el), col_defs: this.col_defs, filters: this.selectedFilters, onAtChange: (event) => this.handleFilterChange(event) })), index.h("at-search", { key: '20fe7256f90877455b774ed8e7f2897a4c45c934', class: "w-input-md", info_text: this.searchInfoTooltip, placeholder: this.translations.ATUI.TABLE.SEARCH_BY_KEYWORD, onAtChange: (event) => this.handleSearchChange(event) })), index.h("div", { key: 'aef4a7d644f7a4b40f0575fd28b694d8541e644c', class: "contents", slot: "filter-bar" }, index.h("slot", { key: '5178a69bb595abb6f845a4bf6adce012a24abca1', name: "filter-bar" })), this.hasDisplayableFilters && (index.h("at-table-filters", { key: 'f9565817f4b61b4925214cf2c5f92b1f46c43e08', slot: "filters", filters: this.chipFilterTree(), onAtChange: (event) => this.handleFilterChange(event), onAtFilterClick: () => this.filterMenuEl?.openMenu() })), this.show_reload_button && (index.h("at-reload-button", { key: '25d079af035daba2feb1d32e6758a447dd9a122a', slot: "reload-button", has_updates: this.has_updates, onAtuiReload: (event) => {
            ...
            } })), this.show_export_menu && (index.h("at-table-export-menu", { key: 'b25819ff7caaed079718f3181b1c39bc1aeb4b11', slot: "export-menu", show_csv: this.show_csv_export, show_pdf: this.show_pdf_export, onAtChange: (event) => this.handleExport(event) })), this.shouldShowColumnManager && (index.h("at-column-manager", { key: '345015d9728e4376581d7baf776dcd9b3f7adeda', slot: "column-manager", col_defs: this.col_defs, onAtChange: (event) => this.handleColumnChange(event) })), index.h("div", { key: 'feb2a0a6a9696714c820b3ed4838200ff55349ce', slot: "leading-actions" }, index.h("slot", { key: '99acc6a8b6ce183d4f73600c3ed04f01e7b0bc9b', name: "leading-actions" })), index.h("div", { key: '3ee29bd8059ac37a5ad3f59f3d6dd09e6433fac1', slot: "actions" }, index.h("slot", { key: '609b0c943e0340bf592f847099b60507cab40541', name: "actions" }))), this.renderSelectionBar(), index.h("div", { key: 'd5c5211c36d4010a609faaca566efbf187d9bbc1', class: "relative" }, index.h("at-table", { key: '5f99126399541ac66317f50b36f0bfbb3552a9e7', ref: (el) => (this.tableEl = el), table_data: this.table_data, col_defs: this.gridColDefs, row_id_field: this.row_id_field, page_size: this.server_side_mode
                ? this.pageSize
                : this.page_size, use_custom_pagination: this.server_side_mode || this.use_custom_pagination, use_custom_sorting: this.server_side_mode, auto_size_columns: this.auto_size_columns, can_auto_init: false, onAtColumnVisibilityChange: (event) => this.syncColumnVisibility(event) }), this.server_side_mode && (index.h("div", { key: '36798d8d48befe08a55de9083f0820783533acb4', class: `loading-overlay bg-surface-foreground/80 absolute inset-0 z-10 items-center justify-center py-120 ${this.showLoadingOverlay ? 'is-visible' : ''}` }, index.h("div", { key: 'f23d0858ba3cc4df40b976307b9edef22ccfeff3', class: "flex items-center" }, index.h("at-loading", { key: 'd8950944363c631ae115b5300504e0a2f05fabb7', class: "relative mr-8", size: "sm", "data-name": "placeholder-spinner" }), index.h("span", { key: 'a202a4749ccfdb0de9d713524e100aab853c572a', class: "text-secondary text-sm font-medium", "data-name": "placeholder-title" }, this.translations?.ATUI?.TABLE
            ?.LOADING_DATA)))), this.server_side_mode && (index.h("div", { key: '26b1ff2c254d08e31c5c0db88cccb7366c28af67', class: `no-data-overlay absolute inset-0 z-10 flex-col items-center justify-center gap-8 py-120 ${!this.is_loading && this.hasNoData ? 'is-visible' : ''}` }, index.h("at-icon", { key: 'dd68324dc98d8f3ca49433f6c3a3c0512f2c9e3c', class: "fill-slate-300", name: this.hasActiveSearch
                ? 'search'
                : 'data_table', size: "sm", "data-name": "no-data-icon" }), index.h("span", { key: '1297ff175fbaee64ab80b714a168fd5bd1808cf1', class: "text-secondary text-sm font-medium", "data-name": "no-data-title" }, this.hasActiveSearch
            ? this.translations?.ATUI?.NO_RESULTS_FOUND
            : (this.no_data_message ??
                this.translations?.ATUI?.TABLE?.NO_DATA))))), this.server_side_mode && (index.h("at-table-pagination", { key: 'e80f5f7d334e5703736fda634937f47e5e736733', current_page: this.currentPage, num_pages: this.totalPages, page_size: this.pageSize, page_size_options: this.page_size_options, onAtChange: (event) => this.handlePageChange(event), onAtPageSizeChange: (event) => this.handlePageSizeChange(event) }))));
    }
