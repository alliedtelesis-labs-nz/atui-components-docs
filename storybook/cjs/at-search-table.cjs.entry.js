...
const AtSearchTable = class {
    ...
    render() {
        return (index.h(index.Host, { key: '43c8623e1484b2ed7ac3916b23d15ec6b3be0d20' }, index.h("at-table-actions", { key: 'fb81b282332073b63a46d904366fbe222acc1bec', ag_grid: this.agGrid }, index.h("div", { key: 'b70ac4208ffaef486ea165eac5ad9ad5affbbad8', class: "flex items-center gap-8", slot: "search" }, !this.hide_dropdown_filters && this.col_defs && (index.h("at-table-filter-menu", { key: '301cd95c190658357f8bb81f0a1763c8ffb05a73', slot: "filter-menu", col_defs: this.col_defs, selected: this.menuSelectedIds, onAtChange: (event) => this.handleFilterChange(event) })), index.h("at-search", { key: '70a58066339b45d5fe30c7c566a365ed22402d63', class: "w-input-md", label: this.search_label, hint_text: this.search_hint, info_text: this.search_info_tooltip, placeholder: this.translations.ATUI.TABLE.SEARCH_BY_KEYWORD, onAtChange: (event) => this.handleSearchChange(event) })), !this.hide_dropdown_filters && this.col_defs && (index.h("at-table-filters", { key: '30413f497a8e8f3c6534902967e5aa3711ddc726', slot: "filters", col_defs: this.col_defs, selected: this.selectedFilters, onAtChange: (event) => this.handleFilterChange(event) })), !this.hide_export_menu && (index.h("at-table-export-menu", { key: 'bc9c206a594f51e88b80a1caf847780c231e53b2', slot: "export-menu" })), !this.hide_column_manager && this.col_defs && (index.h("at-column-manager", { key: '5ce0acccd7f605b2dd7457fb68530ba63bc674d3', slot: "column-manager", col_defs: this.col_defs, onAtChange: (event) => this.handleColumnChange(event) })), index.h("div", { key: '664a58aea824e2d94e4ceae2f0c7654e23ff1a12', slot: "actions" }, index.h("slot", { key: 'f141bb871a5a3ecd7c2f48f0706e54d1492f2af9', name: "actions" }))), index.h("slot", { key: 'e033197b1d998a4c3b150f5b27640a16d6db969a', name: "multi-select-actions" }), index.h("at-table", { key: '672d5f400a4c68dff46dbb74b96689186a238cd8', ref: (el) => (this.tableEl = el), table_data: this.table_data, col_defs: this.col_defs, page_size: this.page_size, use_custom_pagination: this.use_custom_pagination, disable_auto_init: true, auto_size_columns: this.auto_size_columns })));
    }
