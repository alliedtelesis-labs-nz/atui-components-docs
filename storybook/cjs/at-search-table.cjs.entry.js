...
const AtSearchTable = class {
    ...
    render() {
        return (index.h(index.Host, { key: '46148ffab0528dbd0ee631aba7822ad92552deeb' }, index.h("at-table-actions", { key: '748c05fd4057d403427a6767b024cfa5657a8983', ag_grid: this.agGrid }, index.h("div", { key: '9158a90d65c38bfe1e6e1d04a628a9c3a1be4993', class: "flex items-center gap-8", slot: "search" }, this.shouldShowDropdownFilters && (index.h("at-table-filter-menu", { key: '617d7be95606b9c2384a4babc167cf6589800cf3', slot: "filter-menu", col_defs: this.col_defs, selected: this.menuSelectedIds, onAtChange: (event) => this.handleFilterChange(event) })), index.h("at-search", { key: 'd0af6aa03b1eefc5ff6b1aaa71970dde267fa334', class: "w-input-md", label: this.search_label, hint_text: this.search_hint, info_text: this.search_info_tooltip, placeholder: this.translations.ATUI.TABLE.SEARCH_BY_KEYWORD, onAtChange: (event) => this.handleSearchChange(event) })), this.shouldShowDropdownFilters && (index.h("at-table-filters", { key: '7899ee8e2b9b847073d53307549e8eeecd551654', slot: "filters", col_defs: this.col_defs, selected: this.selectedFilters, onAtChange: (event) => this.handleFilterChange(event) })), !this.hide_export_menu && (index.h("at-table-export-menu", { key: '9575873ba70d539be6844b16f72a2b1dd3f7ada6', slot: "export-menu" })), this.shouldShowColumnManager && (index.h("at-column-manager", { key: '6cec170b0bab7e061a5be377bd9bbbacd96ccf2a', slot: "column-manager", col_defs: this.col_defs, onAtChange: (event) => this.handleColumnChange(event) })), index.h("div", { key: '3a0549d1327e4b4cf8f27149639846eea95e2a66', slot: "actions" }, index.h("slot", { key: '2462cac0c20badc6be303cb0b7a2e2db94e0a9ca', name: "actions" }))), index.h("slot", { key: 'f7397a13cb292c03bd2ed58c8fddba515738e078', name: "multi-select-actions" }), index.h("at-table", { key: 'fdc450f7a30dca509124fa1fde049f923c3386d3', ref: (el) => (this.tableEl = el), table_data: this.table_data, col_defs: this.col_defs, page_size: this.page_size, use_custom_pagination: this.use_custom_pagination, disable_auto_init: true, auto_size_columns: this.auto_size_columns })));
    }
