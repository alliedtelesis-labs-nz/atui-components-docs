...
const AtChipList = class {
    ...
    render() {
        return (index.h("div", { key: '5639ef30e04a14aaab2dd1fcd96e567e1efcfc00', class: "flex h-full flex-wrap items-center gap-4" }, this.chips && this.getChips, !this.disabled &&
            this.chips &&
            this.chips.length > 1 &&
            this.show_clear_all && (index.h("at-button", { key: '95c8be47fab60b3830f7797f0b1f6afc24345441', size: "sm", type: "secondaryText", icon: "backspace", "data-name": "clear-all", "aria-label": "Clear all chips", onAtuiClick: () => {
                this.removeChipHandler(this.chips);
            } })), index.h("slot", { key: 'dc1a11a0f37230e808192a3eb6d6d57758edc60e' })));
    }
};
