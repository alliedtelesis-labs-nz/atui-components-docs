...
const AtChipList = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '073487231cb830599fd75f9d2cbef5c887f430d7', class: `flex h-full items-center gap-4 ${this.show_overflow_counter
                ? 'flex-nowrap overflow-hidden'
                : 'flex-wrap'}`, ref: (el) => (this.listEl = el) }, this.chips && this.getChips, overflow.length > 0 && (index.h("at-tooltip", { key: 'f3b17f8a15c6013f585c1e612f2acf6efaf892a0',
            // Never shrinks: the counter is the only thing telling
            // the user that chips are missing.
            class: "shrink-0", "data-name": "chip-overflow", position: "top" }, index.h("at-badge", { key: '1bbf411399714d71f5dfaf379c4d60f56c0f5e86', slot: "tooltip-trigger", class: "flex items-center text-center", rounded: true, "data-name": "chip-overflow-counter", type: this.disabled ? 'disabled' : 'default', size: this.size, label: `+${overflow.length}` }), overflow.join(', '))), !this.disabled &&
            this.chips &&
            this.chips.length > 1 &&
            this.show_clear_all && (index.h("at-button", { key: 'adce805c44a794de3a1e9142555751ecf1f2326e', size: "sm", type: "secondaryText", "data-name": "clear-all", "aria-label": "Clear all chips", onAtuiClick: () => {
                this.removeChipHandler(this.chips);
            } }, index.h("at-icon", { key: '7fe80fcdf96fdfbac98d9241ef1aea4d06251f49', slot: "icon", name: "backspace" }))), index.h("slot", { key: 'a4adfbf2bb2af5ae81af10b8bb51a4cbf7ebfc27' })));
    }
