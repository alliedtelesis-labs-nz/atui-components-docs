...
const AtChipList = class {
    ...
    render() {
        return (index.h("div", { key: '5202cb2f1c9e6bd705ee07da33561c1b01caee7d', class: "flex h-full flex-wrap items-center gap-4" }, this.chips && this.getChips, !this.disabled &&
            this.chips &&
            this.chips.length > 1 &&
            this.show_clear_all && (index.h("at-button", { key: '14c9a8492eba8188ea27743112047d4c18d7c9fd', size: "sm", type: "secondaryText", "data-name": "clear-all", "aria-label": "Clear all chips", onAtuiClick: () => {
                this.removeChipHandler(this.chips);
            } }, index.h("at-icon", { key: 'bf3cbfab3938b7d1b712806b1cce276a59b23ecf', slot: "icon", name: "backspace" }))), index.h("slot", { key: '0f044434d46b5f41b0ea5c55f5e101a2186bbb6e' })));
    }
};
