...
const AtChipList = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'ec9388e75a84c2ad0d471377c80264780eca92a0', class: `flex h-full items-center gap-4 ${this.show_overflow_counter
                ? 'flex-nowrap overflow-hidden'
                : 'flex-wrap'}`, ref: (el) => (this.listEl = el) }, this.chips && this.getChips, overflow.length > 0 && (index.h("at-tooltip", { key: '72305c060ab2c337fced85ea7c68c1342ec3fb88',
            // Never shrinks: the counter is the only thing telling
            // the user that chips are missing.
            class: "shrink-0", "data-name": "chip-overflow", position: "top" }, index.h("at-badge", { key: '9addfbead61dfc3ccd2e00e8fd50f7178674c304', slot: "tooltip-trigger", class: "flex items-center text-center", rounded: true, "data-name": "chip-overflow-counter", type: this.disabled ? 'disabled' : 'default', size: this.size, label: `+${overflow.length}` }), overflow.join(', '))), !this.disabled &&
            this.chips &&
            this.chips.length > 1 &&
            this.show_clear_all && (index.h("at-button", { key: '151343563caaac8eb2dc6af5f5b1a335dba5c871', size: "sm", type: "secondaryText", "data-name": "clear-all", "aria-label": "Clear all chips", onAtuiClick: () => {
                this.removeChipHandler(this.chips);
            } }, index.h("at-icon", { key: 'e76e61f1f604ac376658cdce4c2c6ac84a2f76da', slot: "icon", name: "backspace" }))), index.h("slot", { key: 'e30bc80b34021cabaf52f618f2d3738e8d57b617' })));
    }
