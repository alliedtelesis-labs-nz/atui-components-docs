...
const AtChipList = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'fe187df9a24113a69f46dbb071fa903a3e399698', class: `flex h-full items-center gap-4 ${this.show_overflow_counter
                ? 'flex-nowrap overflow-hidden'
                : 'flex-wrap'}`, ref: (el) => (this.listEl = el) }, this.chips && this.getChips, overflow.length > 0 && (index.h("at-tooltip", { key: 'd5ebb10b98f8d0f9afc77edecf4ae7462549d6c0',
            // Never shrinks: the counter is the only thing telling
            // the user that chips are missing.
            class: "shrink-0", "data-name": "chip-overflow", position: "top" }, index.h("at-badge", { key: '5c6fedadeeb97810d5f58d74efaa5d27b72a9544', slot: "tooltip-trigger", class: "flex items-center text-center", rounded: true, "data-name": "chip-overflow-counter", type: this.disabled ? 'disabled' : 'default', size: this.size, label: `+${overflow.length}` }), overflow.join(', '))), !this.disabled &&
            this.chips &&
            this.chips.length > 1 &&
            this.show_clear_all && (index.h("at-button", { key: 'b627c17005cbb4da8e67f6c1d28a9e1472f969b4', size: "sm", type: "secondaryText", "data-name": "clear-all", "aria-label": "Clear all chips", onAtuiClick: () => {
                this.removeChipHandler(this.chips);
            } }, index.h("at-icon", { key: 'f23dac0336eca8f0fdccce4c5790e06999601dd1', slot: "icon", name: "backspace" }))), index.h("slot", { key: '6427a202b97aba540e26d020bd4d97127280775e' })));
    }
