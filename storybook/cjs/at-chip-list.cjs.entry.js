...
const AtChipList = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '54baa3cfba442932932f748f2999a322ae310317', class: `flex h-full items-center gap-4 ${this.show_overflow_counter
                ? 'flex-nowrap overflow-hidden'
                : 'flex-wrap'}`, ref: (el) => (this.listEl = el) }, this.chips && this.getChips, overflow.length > 0 && (index.h("at-tooltip", { key: '5f269593f17e6605e0150e5e054e698e87d7fb6f',
            // Never shrinks: the counter is the only thing telling
            // the user that chips are missing.
            class: "shrink-0", "data-name": "chip-overflow", position: "top" }, index.h("at-badge", { key: '9945b3bbcc15105607923ec189b70db534ff035a', slot: "tooltip-trigger", class: "flex items-center text-center", rounded: true, "data-name": "chip-overflow-counter", type: this.disabled ? 'disabled' : 'default', size: this.size, label: `+${overflow.length}` }), overflow.join(', '))), !this.disabled &&
            this.chips &&
            this.chips.length > 1 &&
            this.show_clear_all && (index.h("at-button", { key: 'eab96fa7e92a4880f21d2955ad3a637a1d1bdec2', size: "sm", type: "secondaryText", "data-name": "clear-all", "aria-label": "Clear all chips", onAtuiClick: () => {
                this.removeChipHandler(this.chips);
            } }, index.h("at-icon", { key: '2c9424d92f9ea8487eb823a9e15fc18a3df74650', slot: "icon", name: "backspace" }))), index.h("slot", { key: 'e69a3dcd08d413d099b0c9a491ba96aebfb6ca22' })));
    }
