...
const AtChipList = class {
    ...
    render() {
        return (index.h("div", { key: '3f3bc0511c4b90d3ce2f115031414fa5cfc63573', class: "flex h-full flex-wrap items-center gap-4" }, this.chips && this.getChips, !this.disabled &&
            this.chips &&
            this.chips.length > 1 &&
            this.show_clear_all && (index.h("at-button", { key: '99f3b14a13c7f216a9df919f707a3b4318784102', size: "sm", type: "secondaryText", "data-name": "clear-all", "aria-label": "Clear all chips", onAtuiClick: () => {
                this.removeChipHandler(this.chips);
            } }, index.h("at-icon", { key: '8fc0fcbb8d0a95a329f8025587e1cb6a958c8040', slot: "icon", name: "backspace" }))), index.h("slot", { key: 'd2a181a126e5f8f9200a95e4fb07b2c9c60e6d72' })));
    }
};
