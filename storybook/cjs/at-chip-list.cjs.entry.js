...
const AtChipList = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'fb5abf76cf8a2f58ffedb1083e2967d8fc9ae848', class: `flex h-full items-center gap-4 ${this.show_overflow_counter
                ? 'flex-nowrap overflow-hidden'
                : 'flex-wrap'}`, ref: (el) => (this.listEl = el) }, this.chips && this.getChips, overflow.length > 0 && (index.h("at-tooltip", { key: '167f96d8c42f570dfa65608c72056c0e48f60cad',
            // Never shrinks: the counter is the only thing telling
            // the user that chips are missing.
            class: "shrink-0", "data-name": "chip-overflow", position: "top" }, index.h("at-badge", { key: '1b332b170996a8048b3b476b4f8a173ba16513c7', slot: "tooltip-trigger", class: "flex items-center text-center", rounded: true, "data-name": "chip-overflow-counter", type: this.disabled ? 'disabled' : 'default', size: this.size, label: `+${overflow.length}` }), overflow.join(', '))), !this.disabled &&
            this.chips &&
            this.chips.length > 1 &&
            this.show_clear_all && (index.h("at-button", { key: '52ced65371ee7fe129396250ed2002decf22b992', size: "sm", type: "secondaryText", "data-name": "clear-all", "aria-label": "Clear all chips", onAtuiClick: () => {
                this.removeChipHandler(this.chips);
            } }, index.h("at-icon", { key: '7817b15e34de1ec6be8228e67dc7fd7caaef087e', slot: "icon", name: "backspace" }))), index.h("slot", { key: 'c63c490c2ef0512a16883bdac6705851c260ea4e' })));
    }
