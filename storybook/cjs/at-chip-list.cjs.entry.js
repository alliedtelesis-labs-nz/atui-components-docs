...
const AtChipList = class {
    ...
    render() {
        return (index.h("div", { key: 'c17da3ac34c7b308c4a5628f127d15dae90ff730', class: "flex h-full flex-wrap items-center gap-4" }, this.chips && this.getChips, !this.disabled &&
            this.chips &&
            this.chips.length > 1 &&
            this.show_clear_all && (index.h("at-button", { key: '7453055e1fb51bb60cc286e8611939823e361966', size: "sm", type: "secondaryText", "data-name": "clear-all", "aria-label": "Clear all chips", onAtuiClick: () => {
                this.removeChipHandler(this.chips);
            } }, index.h("at-icon", { key: 'e0e6c15ee663ee21bf16945168e5da7b282f9826', slot: "icon", name: "backspace" }))), index.h("slot", { key: 'b5419f93f5d8b71348b0fb1607b6fc32a3f2a6c3' })));
    }
};
