...
const AtRelativeTimeComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: '4d6ebd6699953323f45277c56a94f4c6a470bf0d', class: "inline-flex" }, index.h("at-tooltip", { key: '73e31c2af3283ec3ea8fc2a4482b1855945e88ec', position: "top", disabled: !this.titleText }, index.h("time", { key: '310703d03879ddb7ad4d9a5ba68b7258312c4570', slot: "tooltip-trigger", part: "time", "data-name": "relative-time", dateTime: this.datetimeAttr }, this.relativeTimeText), this.titleText)));
    }
