...
const AtAccordionComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'ffefe5b585234f34863436703ad35bbe3a1c668d', class: "flex flex-col gap-2" }, index.h("slot", { key: '0e33071ed37d10d93ae63bd62b962e44cdbf6387' }), this.items &&
            this.items.map((item) => {
