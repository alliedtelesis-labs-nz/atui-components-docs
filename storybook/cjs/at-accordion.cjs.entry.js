...
const AtAccordionComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'f9a5f787a68ebb77ad807fb19bca38e3ca4055ba', class: "flex flex-col gap-2" }, index.h("slot", { key: '3ae6f5eee520224713008f035e8cc48a69844aca' }), this.items &&
            this.items.map((item) => {
