...
const AtAccordionComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: '421af34618218fdf76d42137037937f5a70a4cff', class: "flex flex-col gap-2" }, index.h("slot", { key: 'd10b797078b58a16e0844ce04720f8c4a0d27179' }), this.items &&
            this.items.map((item) => {
