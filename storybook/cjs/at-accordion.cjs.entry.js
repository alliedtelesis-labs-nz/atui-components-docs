...
const AtAccordionComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'b77ccc50ad15a4cf7f593b130b0e30476316e46b', class: "flex flex-col gap-2" }, index.h("slot", { key: 'e7d8c35b928785a72eed2a719a267b6af2df241f' }), this.items &&
            this.items.map((item) => {
