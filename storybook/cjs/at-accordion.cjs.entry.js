...
const AtAccordionComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: '66fff977696f8a2c144a960a96850f004ac791d6', class: "flex flex-col gap-2" }, index.h("slot", { key: '2df583baf8ada52bf533b50db1d9c149107b126a' }), this.items &&
            this.items.map((item) => {
