...
const AtAccordionComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'fb642ef435e68942b3cf94878d76610e01a0df4f', class: "flex flex-col gap-2" }, index.h("slot", { key: '6fffb8e49b961f6f2995fcdeb5cf02e368bffa3f' }), this.items &&
            this.items.map((item) => {
