...
const AtAccordionComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'a2b8730f3d1b810648ed5bc8bdd5b0ad2da98035', class: "flex flex-col gap-2" }, index.h("slot", { key: '75862b80971dfd27afa68b0d0e2862f2b0a02e38' }), this.items &&
            this.items.map((item) => {
