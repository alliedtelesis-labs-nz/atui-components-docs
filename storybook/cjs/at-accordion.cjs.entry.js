...
const AtAccordionComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: '4b9958018655901d34079e76c53d912c9cc825c2', class: "flex flex-col gap-2" }, index.h("slot", { key: 'e20717e2ccd2a90d9de0bdf62d6ddd6ff661c40b' }), this.items &&
            this.items.map((item) => {
