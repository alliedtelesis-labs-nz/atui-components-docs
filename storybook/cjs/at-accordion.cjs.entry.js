...
const AtAccordionComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: '750cc082016a6721da4b487504227cf28ae2c77f', class: "flex flex-col gap-2" }, index.h("slot", { key: 'a4a281c9951c2eb3cf95cc2dca163e51256feac5' }), this.items &&
            this.items.map((item) => {
