...
const AtAccordionComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'ab6cafbb762d0aaba037bff133648e4ebdad8a5e', class: "flex flex-col gap-2" }, index.h("slot", { key: 'ba9b0cde86020e8f1fb19a0d4e395e74ac40c0df' }), this.items &&
            this.items.map((item) => {
