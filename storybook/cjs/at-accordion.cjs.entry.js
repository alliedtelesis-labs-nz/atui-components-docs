...
const AtAccordionComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: '81ad667f0980c93438869fefe5da394e34c5f701', class: "flex flex-col gap-2" }, index.h("slot", { key: '878b85ecb1651551d2af414c5340682842503166' }), this.items &&
            this.items.map((item) => {
