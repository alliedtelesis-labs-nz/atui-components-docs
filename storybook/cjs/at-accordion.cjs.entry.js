...
const AtAccordionComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: '5f904502ddb3f3863d81b1af32e9efb2a872e35f', class: "flex flex-col gap-2" }, index.h("slot", { key: '0e829803db3a4e500c9c7272935583589b5fc2b9' }), this.items &&
            this.items.map((item) => {
