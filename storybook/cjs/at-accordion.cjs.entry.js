...
const AtAccordionComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'd84a71c82b0b8b95d01e84ad55cddf3a0aad73d6', class: "flex flex-col gap-2" }, index.h("slot", { key: '55007170bbaf9da62a15f5805be2f84430902ea0' }), this.items &&
            this.items.map((item) => {
