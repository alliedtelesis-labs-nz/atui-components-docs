...
const AtAccordionComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: '4c8db011dc7019bade030b2431a2256cce5353e9', class: "flex flex-col gap-2" }, index.h("slot", { key: '1462b855e9ca043a85774485b35c8fdc9627d8d7' }), this.items &&
            this.items.map((item) => {
