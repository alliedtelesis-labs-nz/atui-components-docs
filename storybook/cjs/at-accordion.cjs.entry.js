...
const AtAccordionComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: '266e049290e601d61bd254682b844a4651ef9622', class: "flex flex-col gap-2" }, index.h("slot", { key: 'af44d3d5ce6d7f99b1fd7e9d664c0b9d76716c36' }), this.items &&
            this.items.map((item) => {
