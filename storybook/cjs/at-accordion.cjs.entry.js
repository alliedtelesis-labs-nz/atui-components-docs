...
const AtAccordionComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'cfbfa2b1c7e255e4545dd23b5e31889b8d02536e', class: "flex flex-col gap-2" }, index.h("slot", { key: '7011ecdc98c609e876ffebeeec4e06ece4c5a118' }), this.items &&
            this.items.map((item) => {
