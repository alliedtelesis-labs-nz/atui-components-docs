...
const AtAccordionComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'ea4bb68068d88ea220ff20ecf99bd7fb3af5a672', class: "flex flex-col gap-2" }, index.h("slot", { key: '827326cad087d35f25eac43533eaf8c2c7ae1d16' }), this.items &&
            this.items.map((item) => {
