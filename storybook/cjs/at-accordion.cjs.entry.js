...
const AtAccordionComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: '7cf8b56ba588034eff2f894ae708c46123910723', class: "flex flex-col gap-2" }, index.h("slot", { key: 'f1f657ba4db936ad5decc13af94c3041b8e5224b' }), this.items &&
            this.items.map((item) => {
