...
const AtAccordionComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: '7778b64900c7252b8a8ad78e26538baaf45d6754', class: "flex flex-col gap-2" }, index.h("slot", { key: 'e8f165bf4318c37fa697a5bd23633de336da93a8' }), this.items &&
            this.items.map((item) => {
