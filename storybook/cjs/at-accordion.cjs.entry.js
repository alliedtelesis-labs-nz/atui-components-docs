...
const AtAccordionComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'd151dc33f835f2e489059c5a868bfb7bbff26ae7', class: "flex flex-col gap-2" }, index.h("slot", { key: '9a4f615063ef14a0fa2cb7818b65dbe0403618c0' }), this.items &&
            this.items.map((item) => {
