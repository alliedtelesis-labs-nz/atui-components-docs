...
const AtAccordionComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: '6fcf95ee7283905ddc6d7a577a00bc8499fca2f5', class: "flex flex-col gap-2" }, index.h("slot", { key: '0cef3119adc4900e64bf809b86fd7863bb5bd265' }), this.items &&
            this.items.map((item) => {
