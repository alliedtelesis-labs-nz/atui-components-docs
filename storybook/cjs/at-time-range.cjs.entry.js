...
const AtTimeRangeComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'f5489383a83318b935c043ff839930323255be0d', class: "relative flex justify-center gap-8" }, this.enable_relative_time && (index.h("at-button-group", { key: 'fcae26ef8383808289d639765b63f73f1200708a', options: this.buttonGroupOptions, onAtuiIndexChange: (event) => (event.detail === 0 &&
                this.relativeTimeMenuEl.focus()) ||
                (event.detail === 1 &&
                    this.absoluteTimeMenuEl.focus()) })), !this.enable_relative_time && (index.h("at-button-group", { key: '16132ee5118ce5a75f08ec1af62dae8f11ab5222', options: this.predefinedTimeRanges, onAtuiIndexChange: (event) => {
            ...
            } })), index.h("div", { key: '5acbad2c454064e264debd80f1734144f5dc2297', ref: (el) => (this.relativeTimeMenuEl = el), class: "absolute top-[42px] z-10 h-0 overflow-hidden bg-white focus-within:h-fit focus-within:overflow-visible focus:h-fit", tabindex: 0, onChange: (event) => event.stopPropagation() }, index.h("at-time-with-unit", { key: 'c7a1440a0cc2d046723e0bef3c054be43c8a648a', units: this.units, common_options: this.presets, min_date: this.lowerLimit, min_seconds: this.minSeconds, initial_selected_time: this.selected_time_range.selected ===
