...
const AtPromptContainer = class {
    ...
    render() {
        return (index.h(index.Host, { key: '2e3f014e05558065d367de6ceffedb00db5dae5f', class: "flex h-full w-full flex-col overflow-hidden", "data-name": "prompt-container" }, this.renderHeader(), index.h("slot", { key: '1ff895c0db193cd2fecaac3f8ef45fcb42795ea1', name: "prompt-container-header" }), index.h("div", { key: '449ff37e3efbe55f119b051aa631ea842a6ed4bd', class: "min-h-0 flex-1", "data-name": "thread-wrapper" }, index.h("at-prompt-thread", { key: '24027c54a20866241b6070e15ac1433e103cc139', chatbot_title: this.chatbot_title, messages: this.messages, loading: this.loading, auto_scroll: true, enable_vote: this.enable_vote, enable_copy: this.enable_copy, enable_edit: this.enable_edit, response_animation: this.response_animation, "data-name": "container-thread" })), index.h("div", { key: '1e71233904c827230d31365089b835ba65e49479', class: "flex flex-col gap-4" }, this.renderFooter(), index.h("slot", { key: 'b198348088393899d4779485e49d4216026f1c4b', name: "prompt-container-footer" }))));
    }
};
