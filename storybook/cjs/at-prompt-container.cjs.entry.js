...
const AtPromptContainer = class {
    ...
    render() {
        return (index.h(index.Host, { key: '8e1cb446498e7a165f87b61bf1c4b8e386957289', class: "flex h-full w-full flex-col overflow-hidden", "data-name": "prompt-container" }, this.renderHeader(), index.h("slot", { key: '415ca91f0816a54af2a9a52003337805e8650ccd', name: "prompt-container-header" }), index.h("div", { key: '6747648430fa162a38e3925350bf91bfdda4e68e', class: "min-h-0 flex-1", "data-name": "thread-wrapper" }, index.h("at-prompt-thread", { key: '08ea7e8df13295b6b89bba83d7dec0fd6550d478', messages: this.messages, loading: this.loading, auto_scroll: true, enable_vote: this.enable_vote, enable_copy: this.enable_copy, enable_edit: this.enable_edit, response_animation: this.response_animation, "data-name": "container-thread" })), index.h("div", { key: '6443efb64a1c83fdab4b323eeedcb294f4bd2b7a', class: "flex flex-col gap-4" }, this.renderFooter(), index.h("slot", { key: '3e5b9f30d1e0a7fc802ca64896b75873a28de42c', name: "prompt-container-footer" }))));
    }
};
