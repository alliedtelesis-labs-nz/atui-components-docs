...
const AtPromptContainer = class {
    ...
    render() {
        return (index.h(index.Host, { key: '04d733d4c8d4b5397ce6735dd1aaf515e062745f', class: "flex h-full w-full flex-col overflow-hidden", "data-name": "prompt-container" }, this.renderHeader(), index.h("slot", { key: 'c10a06bf1ce755cf444c257992fc584eadda26df', name: "prompt-container-header" }), index.h("div", { key: '9c4ff9c3ba308a849bd42bd22181f05827fbc6b6', class: "min-h-0 flex-1", "data-name": "thread-wrapper" }, index.h("at-prompt-thread", { key: 'fb684b54cca25e7eabe8c2c1cdee5ace4663e2b2', messages: this.messages, loading: this.loading, auto_scroll: true, enable_vote: this.enable_vote, enable_copy: this.enable_copy, enable_edit: this.enable_edit, response_animation: this.response_animation, "data-name": "container-thread" })), index.h("div", { key: 'b4f04be839d492b91880139641ee461ef5bb9c51', class: "flex flex-col gap-4" }, this.renderFooter(), index.h("slot", { key: '337f94d0e843365764aaf65e0b9c5d3418e2169d', name: "prompt-container-footer" }))));
    }
};
