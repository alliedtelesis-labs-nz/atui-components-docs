...
const AtPromptContainer = class {
    ...
    render() {
        return (index.h(index.Host, { key: '83b791ed6a7a426cfaa4883ae1d39f9dffb9d82d', class: "flex h-full w-full flex-col overflow-hidden", "data-name": "prompt-container" }, this.renderHeader(), index.h("slot", { key: 'eac19dac31ff7b3f2dffa261778d60c9cb26a4e4', name: "prompt-container-header" }), index.h("div", { key: 'cd5598f0dc0d0c7a5caee80f59019080f1e68a7e', class: "min-h-0 flex-1", "data-name": "thread-wrapper" }, index.h("at-prompt-thread", { key: '4b39f449e0db6c13a225d4df1920d713404a5311', chatbot_title: this.chatbot_title, messages: this.messages, loading: this.loading, auto_scroll: true, enable_vote: this.enable_vote, enable_copy: this.enable_copy, enable_edit: this.enable_edit, response_animation: this.response_animation, "data-name": "container-thread" })), index.h("div", { key: 'fb76781d8839ea60d0089e01be5de23f01c3df5d', class: "flex flex-col gap-4" }, this.renderFooter(), index.h("slot", { key: '7753465a450a065093c273de8653e92d0541a0bb', name: "prompt-container-footer" }))));
    }
};
