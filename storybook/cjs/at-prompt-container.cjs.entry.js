...
const AtPromptContainer = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'd634572a9b24147f1d7d3df185ef61464aceb87d', class: "flex h-full w-full flex-col overflow-hidden", "data-name": "prompt-container" }, this.renderHeader(), index.h("slot", { key: '6b6d7fce88a8ca4994835c738d7477fcf158ffd9', name: "prompt-container-header" }), index.h("div", { key: '548a2367893d5c9e5abf3ff5d3479fc2d88491be', class: "min-h-0 flex-1", "data-name": "thread-wrapper" }, index.h("at-prompt-thread", { key: '0669ce3acb2f6187807540fdac0d7679a71317f5', messages: this.messages, loading: this.loading, auto_scroll: true, enable_vote: this.enable_vote, enable_copy: this.enable_copy, enable_edit: this.enable_edit, response_animation: this.response_animation, "data-name": "container-thread" })), index.h("div", { key: '1e18524f91a18e337e3b3431f6d6a35669736caf', class: "flex flex-col gap-4" }, this.renderFooter(), index.h("slot", { key: '3161fc9b0d7c76719c51e88ce51795503de70b2e', name: "prompt-container-footer" }))));
    }
};
