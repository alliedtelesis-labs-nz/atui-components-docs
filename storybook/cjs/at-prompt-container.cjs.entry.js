...
const AtPromptContainer = class {
    ...
    render() {
        return (index.h(index.Host, { key: '81187126f73f3f313e7be86cf9873b27180a957f', class: "flex h-full w-full flex-col overflow-hidden", "data-name": "prompt-container" }, this.renderHeader(), index.h("slot", { key: '7541fd10195f2bda3190d120d49a7356a5605855', name: "prompt-container-header" }), index.h("div", { key: '86caf93a785b6bd9996a8b633a5d692dad181375', class: "min-h-0 flex-1", "data-name": "thread-wrapper" }, index.h("at-prompt-thread", { key: '8d14df22d7e80ee55a45da5cd1a92328f800dea4', messages: this.messages, loading: this.loading, auto_scroll: true, enable_vote: this.enable_vote, enable_copy: this.enable_copy, enable_edit: this.enable_edit, response_animation: this.response_animation, "data-name": "container-thread" })), index.h("div", { key: 'bf8d22bb11c0a892833faa3cf780e0b02c998afa', class: "flex flex-col gap-4" }, this.renderFooter(), index.h("slot", { key: '094bc0981ac51a97a00cbf0abe9680f03d24eb38', name: "prompt-container-footer" }))));
    }
};
