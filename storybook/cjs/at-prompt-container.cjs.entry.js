...
const AtPromptContainer = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'd7544ad1e3de1d8e5265a9c76b4b7e6fdafb1cab', class: "flex h-full w-full flex-col overflow-hidden", "data-name": "prompt-container" }, this.renderHeader(), index.h("slot", { key: 'bd3b5ccf8b2d95118688281fd85e60bdd9691013', name: "prompt-container-header" }), index.h("div", { key: '9c09e9114b626168057f4471321ec84d6b8aab64', class: "min-h-0 flex-1", "data-name": "thread-wrapper" }, index.h("at-prompt-thread", { key: '4d18ab95cbaf26f25d511e3773fa82dd882ab8f4', messages: this.messages, loading: this.loading, auto_scroll: true, enable_vote: this.enable_vote, enable_copy: this.enable_copy, enable_edit: this.enable_edit, response_animation: this.response_animation, "data-name": "container-thread" })), index.h("div", { key: 'a9c72d2b38a96fe6f729f0935489e757cf52a992', class: "flex flex-col gap-4" }, this.renderFooter(), index.h("slot", { key: '034b445a47b0d798cbb2b9374dcdc6bec03bdd5c', name: "prompt-container-footer" }))));
    }
};
