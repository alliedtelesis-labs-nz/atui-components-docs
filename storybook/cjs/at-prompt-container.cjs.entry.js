...
const AtPromptContainer = class {
    ...
    render() {
        return (index.h(index.Host, { key: '6bfd1befd0cb06e0f290f4eb2830083ce9a054f3', class: "flex h-full w-full flex-col overflow-hidden", "data-name": "prompt-container" }, this.renderHeader(), index.h("slot", { key: '446ffb0fd2ced1c294d6883f507d8c129f9c3f35', name: "prompt-container-header" }), index.h("div", { key: 'a8da2ce7b45a2d4b423467a2189cafbe311da60f', class: "min-h-0 flex-1", "data-name": "thread-wrapper" }, index.h("at-prompt-thread", { key: 'ae4607c3b66d3000c20435be5d646a532bb6aa8a', messages: this.messages, loading: this.loading, auto_scroll: true, enable_vote: this.enable_vote, enable_copy: this.enable_copy, enable_edit: this.enable_edit, response_animation: this.response_animation, "data-name": "container-thread" })), index.h("div", { key: '834828e701d49c275568f9d528e9575b26558739', class: "flex flex-col gap-4" }, this.renderFooter(), index.h("slot", { key: 'c79bc1ae94d4f594dea1ffe4ec43f8f3a5c73e3e', name: "prompt-container-footer" }))));
    }
};
