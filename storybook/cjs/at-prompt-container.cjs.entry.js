...
const AtPromptContainer = class {
    ...
    render() {
        return (index.h(index.Host, { key: '6b3dc51d7762cb0d6b44939dde00b69f5a0de63f', class: "flex h-full w-full flex-col overflow-hidden", "data-name": "prompt-container" }, this.renderHeader(), index.h("slot", { key: 'aa041836e62076e6b6a6c2a796a464b682c7da66', name: "prompt-container-header" }), index.h("div", { key: '37452e20d70a0c0dc77ffc43659bb4da09da5a72', class: "min-h-0 flex-1", "data-name": "thread-wrapper" }, index.h("at-prompt-thread", { key: '23a8b3bed953d994bf3ebc2f1a131f07a4b8ebce', messages: this.messages, loading: this.loading, auto_scroll: true, enable_vote: this.enable_vote, enable_copy: this.enable_copy, enable_edit: this.enable_edit, response_animation: this.response_animation, "data-name": "container-thread" })), index.h("div", { key: '3f4140c2b11a670022b523ece88bd12d68b76b46', class: "flex flex-col gap-4" }, this.renderFooter(), index.h("slot", { key: '2b2e6f132b259b6f7a913a69b095e29e774277bb', name: "prompt-container-footer" }))));
    }
};
