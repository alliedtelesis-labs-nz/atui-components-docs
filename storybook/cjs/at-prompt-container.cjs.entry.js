...
const AtPromptContainer = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'd56e081bd6df4fc2c30e26768db006edbf3583aa', class: "flex h-full w-full flex-col overflow-hidden", "data-name": "prompt-container" }, this.renderHeader(), index.h("slot", { key: '249959792b45dc7af2fe3375f45769887aef40a7', name: "prompt-container-header" }), index.h("div", { key: '93de6c8f4c263dce2d9d12d001afde5e03c1ed4d', class: "min-h-0 flex-1", "data-name": "thread-wrapper" }, index.h("at-prompt-thread", { key: 'daa31883a2f9e09173b2861a7af0f5f1322c5905', chatbot_title: this.chatbot_title, messages: this.messages, loading: this.loading, auto_scroll: true, enable_vote: this.enable_vote, enable_copy: this.enable_copy, enable_edit: this.enable_edit, response_animation: this.response_animation, "data-name": "container-thread" })), index.h("div", { key: 'f8cc2d9359b75fd1342eb0ca4c8aead2cc291a32', class: "flex flex-col gap-4" }, this.renderFooter(), index.h("slot", { key: 'b2c871a58eb2e975e14d5c509fe09d8d725f4e6b', name: "prompt-container-footer" }))));
    }
};
