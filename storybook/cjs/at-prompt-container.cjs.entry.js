...
const AtPromptContainer = class {
    ...
    render() {
        return (index.h(index.Host, { key: '74b582fbb50205a6b09c1523d161b1256424a0cc', class: "flex h-full w-full flex-col overflow-hidden", "data-name": "prompt-container" }, this.renderHeader(), index.h("slot", { key: '79b1532305792280fb06c9960ee96df52902965f', name: "prompt-container-header" }), index.h("div", { key: '290fef0490ef099fbcfc565db49d927a52b0f06e', class: "min-h-0 flex-1", "data-name": "thread-wrapper" }, index.h("at-prompt-thread", { key: '2ef83b9b32274543d8cdae7bc60069263be7567b', chatbot_title: this.chatbot_title, messages: this.messages, loading: this.loading, auto_scroll: true, enable_vote: this.enable_vote, enable_copy: this.enable_copy, enable_edit: this.enable_edit, response_animation: this.response_animation, "data-name": "container-thread" })), index.h("div", { key: 'b65249c0d47f66ac625594ebb308d7bd103e7afe', class: "flex flex-col gap-4" }, this.renderFooter(), index.h("slot", { key: '3c8d56931acd717c54b3e6532e2a1f01a00e18a8', name: "prompt-container-footer" }))));
    }
};
