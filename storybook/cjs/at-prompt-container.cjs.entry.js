...
const AtPromptContainer = class {
    ...
    render() {
        return (index.h(index.Host, { key: '888cd7a1634ee219ba630dab7bbd83365e338668', class: "flex h-full w-full flex-col overflow-hidden", "data-name": "prompt-container" }, this.renderHeader(), index.h("slot", { key: '012212380641f603b9351fef70d5e3748c08d459', name: "prompt-container-header" }), index.h("div", { key: '5c000086b524d7c6ac83aa18c161af3c51e7daf0', class: "min-h-0 flex-1", "data-name": "thread-wrapper" }, index.h("at-prompt-thread", { key: '9e883bd9940a6b7c70de3e1e45302b8c286b3d6e', messages: this.messages, loading: this.loading, auto_scroll: true, enable_vote: this.enable_vote, enable_copy: this.enable_copy, enable_edit: this.enable_edit, response_animation: this.response_animation, "data-name": "container-thread" })), index.h("div", { key: '94f2d7b5ccb00890da905046e390e57a8b70acd5', class: "flex flex-col gap-4" }, this.renderFooter(), index.h("slot", { key: '74238c53f7e713e5d9fedb1499936432548d2fd4', name: "prompt-container-footer" }))));
    }
};
