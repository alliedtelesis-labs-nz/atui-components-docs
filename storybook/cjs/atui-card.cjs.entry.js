...
const containerVariants = index$1.cva('bg-card flex flex-col overflow-hidden rounded-lg', {
    variants: {
        shadow: {
            none: 'shadow-none',
            sm: 'shadow-sm',
