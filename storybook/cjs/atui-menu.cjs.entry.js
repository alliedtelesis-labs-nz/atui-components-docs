...
const AtuiMenu = class {
    ...
    render() {
        return (index.h(index.Host, { key: '0ccc40e271fd4a14df7653ffd3b74645573589c8', class: "relative z-modal" }, index.h("div", { key: 'fcb61f0ffe05715d172148d4654f517487bb1c1c', class: "relative", onBlur: () => this.trigger === 'click' && !this.disabled
                ? this.mouseLeaveHandler()
                : null }, index.h("div", { key: 'c3c7f3fbd692af418a01b60c8098625bd2addaae', "aria-haspopup": "true", "data-name": "menu-trigger", ref: (el) => (this.triggerEl = el), "aria-expanded": `${this.isOpen ? 'true' : 'false'}`, onMouseEnter: () => this.trigger === 'hover' && !this.disabled
            ...
            }, class: this.disabled ? 'contents' : '' }, index.h("slot", { key: '0a898fb587915acb5f2838767a035aaaee6da384', name: "menu-trigger" })), index.h("div", { key: '34440c8dc0ea4ef501b2b70a96234bdfcd207b0d', role: this.role, "data-position": this.position, "data-align": this.align, ref: (el) => (this.menuEl = el), "aria-hidden": `${this.isOpen ? 'false' : 'true'}`, popover: "auto", id: this.popoverId, onMouseEnter: () => this.trigger === 'hover' &&
                !this.disabled &&
            ...
            }, onClick: () => this.autoclose && this.mouseLeaveHandler(), class: "w-fit rounded-md bg-white p-4 shadow-md", "data-name": "menu-content-wrapper" }, index.h("slot", { key: '179740be7f893b123e430b0b11469d24600a4a42', name: "menu-content" })))));
    }
