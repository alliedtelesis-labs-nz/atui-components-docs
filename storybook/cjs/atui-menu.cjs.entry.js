...
const AtuiMenu = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'ed4ba146ec1573c03321a7a953e728f187c52ae9', class: "z-modal relative" }, index.h("div", { key: 'ef6afe909b65031db18630ffc261f04e8f14b7bf', class: "relative", onBlur: () => this.trigger === 'click' && !this.disabled
                ? this.mouseLeaveHandler()
                : null }, !this.trigger_id && (index.h("div", { key: '60f8046051e3ee2cf2f29cdb9466f2b7961122d0', "aria-haspopup": "true", "data-name": "menu-trigger", ref: (el) => (this.triggerEl = el), "aria-expanded": `${this.isOpen ? 'true' : 'false'}`, onMouseEnter: () => this.trigger === 'hover' && !this.disabled
                ? this.mouseEnterHandler()
            ...
            }, onClick: () => this.autoclose && this.mouseLeaveHandler(), class: "w-fit rounded-md bg-white p-4 shadow-md", "data-name": "menu-content-wrapper" }, index.h("slot", { key: '0fb0d453f16a42d0c7458eca80f931f8bf71a574' })))));
    }
