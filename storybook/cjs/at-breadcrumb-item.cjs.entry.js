...
const AtBreadcrumbItem = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'c525f7b5497134042a653ed2f19e120f3a6c4630', class: "flex w-fit items-center" }, this.is_active ? (index.h("span", { "aria-current": "page", class: "text-active-accent cursor-default rounded-lg px-8 py-2" }, this.label)) : (index.h("a", { role: "link", tabIndex: 0, onKeyDown: (event) => {
                if (event.key === 'Enter') {
