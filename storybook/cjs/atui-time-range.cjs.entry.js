...
const AtuiTimeRangeComponent = class {
    ...
    render() {
        var _a, _b, _c;
        return (index.h(index.Host, { key: '5985db4e0b46e6a3d0ec6abaf33522332c9f0b98', class: "relative flex justify-center gap-8" }, this.enable_relative_time && (index.h("atui-button-group", { key: '684bd2b0af0d7c4fcd497675f557455b350f343b', options: this.buttonGroupOptions, onAtuiIndexChange: (event) => (event.detail === 0 &&
                this.relativeTimeMenuEl.focus()) ||
                (event.detail === 1 &&
                    this.absoluteTimeMenuEl.focus()) })), !this.enable_relative_time && (index.h("atui-button-group", { key: 'a11c20cbc0dcb7e8410925031d562d948c585011', options: this.predefinedTimeRanges, onAtuiIndexChange: (event) => {
