...
const AtDialogComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'aec3fb97dbef7f0f731cd8d97ba74d8d9808b4a1', "data-open": this.isOpen }, index.h("dialog", { key: '1da403152f8845018bd49af75f8b5f49568e182f', ref: (el) => (this.dialog = el), "data-name": "dialog", class: `${this.backdrop ? 'backdrop' : ''}`, role: this.role, "aria-modal": "true", onClose: this.handleDialogClose, onKeyDown: this.handleKeyDown }, index.h("div", { key: '5a0def2522f6ff8845a86c853b57664a23fb40a2', "data-name": "content", ref: (el) => (this.dialogWrapper = el) }, index.h("slot", { key: 'df70a4be9252f7b798e852ada6ce29b813413f36' })))));
    }
};
