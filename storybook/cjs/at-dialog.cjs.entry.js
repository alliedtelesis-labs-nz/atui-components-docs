...
const AtDialogComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: '4830ecd7ebfea63101a3cdf9b94c339ec07ae2ec', "data-open": this.isOpen }, index.h("dialog", { key: '8da934b9e4f0291be4fc50c83a870a24cc9d6ab8', ref: (el) => (this.dialog = el), "data-name": "dialog", class: `${this.backdrop ? 'backdrop' : ''}`, role: this.role, "aria-modal": "true", onClose: this.handleDialogClose, onCancel: this.handleCancel, onKeyDown: this.handleKeyDown }, index.h("div", { key: '9927f62fdeeb193dc957d6b02d7ec420aa02e1f1', "data-name": "content", ref: (el) => (this.dialogWrapper = el) }, index.h("slot", { key: 'f79250f58b3edf0f0ec8074c7db9cf45650922ee' })))));
    }
};
