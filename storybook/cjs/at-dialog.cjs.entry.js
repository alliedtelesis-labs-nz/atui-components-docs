...
const AtDialogComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'f489b8a0f0b5e28564037bcaa1281759ccbcc70d', "data-open": this.isOpen }, index.h("dialog", { key: 'c448c9d483d3fb8d3bf92a928c0776b93c924eb2', ref: (el) => (this.dialog = el), "data-name": "dialog", class: `${this.backdrop ? 'backdrop' : ''}`, role: this.role, "aria-modal": "true", onClose: this.handleDialogClose, onKeyDown: this.handleKeyDown }, index.h("div", { key: '4e582f4b96aec7b54df2e4d71e8d5f0502f17647', "data-name": "content", ref: (el) => (this.dialogWrapper = el) }, index.h("slot", { key: 'b407a230b769b4d9638f555fea2eb0a41b0baac8' })))));
    }
};
