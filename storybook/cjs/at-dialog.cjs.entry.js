...
const AtDialogComponent = class {
    ...
    render() {
        return (index.h("dialog", { key: 'e799c0a20d3cacb8ba28254bd3d893d34c86a7d3', class: `c-atui-dialog ${this.backdrop ? 'backdrop' : ''}`, id: this.dialog_id, "data-name": "dialog", role: this.role, "aria-modal": "true", onClose: this.handleDialogClose, onKeyDown: this.handleKeyDown }, index.h("div", { key: 'a04f3e29394f69e4764718dbd4658af3bf60188b', class: "backdrop-content" }, index.h("slot", { key: '592be5b5d21f4eeacde5a604699a901e735033b9' }))));
    }
...
//# sourceMappingURL=at-dialog.cjs.entry.js.map