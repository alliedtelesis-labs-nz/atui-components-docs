...
const AtDialogComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: '1892fb0626d9c115f14fbb5a04b1127262e53404', "data-open": this.isOpen }, index.h("dialog", { key: '6f31cb8ff7ef640a4e58850fe1b808304c8a2050', ref: (el) => (this.dialog = el), "data-name": "dialog", class: `${this.backdrop ? 'backdrop' : ''}`, role: this.role, "aria-modal": "true", "aria-label": this.aria_label ?? undefined, "aria-labelledby": this.aria_label ? undefined : this.labelledById, onClose: this.handleDialogClose, onCancel: this.handleCancel, onKeyDown: this.handleKeyDown }, index.h("div", { key: '590a0e1c543e12fbcb1943fa4ec82697ae230e88', "data-name": "content", ref: (el) => (this.dialogWrapper = el) }, index.h("slot", { key: 'd1b666043de612edd06c4d6bb2b7446210f2528f' })))));
    }
};
