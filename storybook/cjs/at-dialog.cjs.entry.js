...
const AtDialogComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: '515033ce35c88ea76524bc52972f04b12f483c21' }, index.h("dialog", { key: '82e0c1f09b4fd5156f5671562484aeee42daa4c4', ref: (el) => (this.dialog = el), part: "dialog", id: "dialog", class: `${this.backdrop ? 'backdrop' : ''}`, "data-name": "dialog", role: this.role, "aria-modal": "true", onClose: this.handleDialogClose, onKeyDown: this.handleKeyDown }, index.h("div", { key: '54b126c1c5f1c367335d4da0d6494c6d47e21ae3', part: "content", id: "content", class: "backdrop-content", ref: (el) => (this.dialogWrapper = el) }, index.h("slot", { key: 'ae0e48969c9682722398e79f23a8fcf414c6e0dd' })))));
    }
};
