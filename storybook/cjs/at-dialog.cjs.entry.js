...
const AtDialogComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: '2bfe5e0d5cc97d1bdfd62c2ec37fbb58eb8d3959', "data-open": this.isOpen }, index.h("dialog", { key: '42be70cfc79cabf86e574d300bdf2398574bc810', ref: (el) => (this.dialog = el), "data-name": "dialog", class: `${this.backdrop ? 'backdrop' : ''}`, role: this.role, "aria-modal": "true", onClose: this.handleDialogClose, onCancel: this.handleCancel, onKeyDown: this.handleKeyDown }, index.h("div", { key: 'b27af13a929339c6a8e6aee3bd29dcdeb64313fb', "data-name": "content", ref: (el) => (this.dialogWrapper = el) }, index.h("slot", { key: '3a9ed424ef7ebc3a6499bc2e46fd58a6f028367d' })))));
    }
};
