...
const AtDialogComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: '840c013074fc2799dd9106f40a75215a56d85911', "data-open": this.isOpen }, index.h("dialog", { key: '99573a0c45fb17b6c2446ba11ae63ad2b967315d', ref: (el) => (this.dialog = el), "data-name": "dialog", class: `${this.backdrop ? 'backdrop' : ''}`, role: this.role, "aria-modal": "true", "aria-label": this.aria_label ?? undefined, "aria-labelledby": this.aria_label ? undefined : this.labelledById, onClose: this.handleDialogClose, onCancel: this.handleCancel, onKeyDown: this.handleKeyDown }, index.h("div", { key: 'd6a0f6a901060bd14c09a0eb7171f89773158880', "data-name": "content", ref: (el) => (this.dialogWrapper = el) }, index.h("slot", { key: 'f72f417c422ad6e88236e11d829c51cf0ce9a52f' })))));
    }
};
