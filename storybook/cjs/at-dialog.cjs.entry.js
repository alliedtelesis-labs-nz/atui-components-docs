...
const AtDialogComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: '4dc87de422f210cc95bd053ee3dfa5e1d642c7ee', "data-open": this.isOpen }, index.h("dialog", { key: '74aebf05e5f68011188ad7118002bd2724bf1198', ref: (el) => (this.dialog = el), "data-name": "dialog", class: `${this.backdrop ? 'backdrop' : ''}`, role: this.role, "aria-modal": "true", "aria-label": this.aria_label ?? undefined, "aria-labelledby": this.aria_label ? undefined : this.labelledById, onClose: this.handleDialogClose, onCancel: this.handleCancel, onKeyDown: this.handleKeyDown }, index.h("div", { key: '8fd99623df572cba2219dca7c8b86a796ec285ce', "data-name": "content", ref: (el) => (this.dialogWrapper = el) }, index.h("slot", { key: 'd69a991f798766ee0e8215495d2dc3bd5d1042c1' })))));
    }
};
