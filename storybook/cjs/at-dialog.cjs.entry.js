...
const AtDialogComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: '1d99266968dfb00811120d9712362f7c6fb66bd7', "data-open": this.isOpen }, index.h("dialog", { key: 'e4cf8ff1bf358ed945b8b07e6a0e779d9330b042', ref: (el) => (this.dialog = el), "data-name": "dialog", class: `${this.backdrop ? 'backdrop' : ''}`, role: this.role, "aria-modal": "true", onClose: this.handleDialogClose, onCancel: this.handleCancel, onKeyDown: this.handleKeyDown }, index.h("div", { key: 'deaf1099709eebdd55623ae56dcef40c0323a384', "data-name": "content", ref: (el) => (this.dialogWrapper = el) }, index.h("slot", { key: 'c0d8df45fde1bcc183187cc2486a5db050660786' })))));
    }
};
