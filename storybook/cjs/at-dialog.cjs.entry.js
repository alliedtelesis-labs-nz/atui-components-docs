...
const AtDialogComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: '823ba4629a51ec115c78d089a50a0bf41f23ff8a', "data-open": this.isOpen }, index.h("dialog", { key: '9999014373b654bfd9feba342b683921082502ea', ref: (el) => (this.dialog = el), "data-name": "dialog", class: `${this.backdrop ? 'backdrop' : ''}`, role: this.role, "aria-modal": "true", onClose: this.handleDialogClose, onKeyDown: this.handleKeyDown }, index.h("div", { key: '2787ec8973f8311fa4f93c39ab4bb225168ad941', "data-name": "content", ref: (el) => (this.dialogWrapper = el) }, index.h("slot", { key: 'a59ba2de220591f58b7f030a9b20d39d768c7e2b' })))));
    }
};
