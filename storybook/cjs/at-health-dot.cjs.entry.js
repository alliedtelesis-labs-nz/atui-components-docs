...
const AtHealthDot = class {
    ...
    render() {
        return (index.h(index.Host, { key: '55bd14cc8648ab486d06a7a99a51b6c4cedf57e2', "data-name": "health-dot", class: "inline-flex h-full items-center justify-start", role: "img", "aria-label": statusLabels[this.status] }, this.renderGlyph(this.status, sizePx[this.size])));
    }
};
