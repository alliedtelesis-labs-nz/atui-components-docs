...
const AtHealthDot = class {
    ...
    render() {
        return (index.h(index.Host, { key: '82a9db41a402e7716ea626c36bd1b13ebf477525', "data-name": "health-dot", class: "inline-flex h-full items-center justify-start", role: "img", "aria-label": statusLabels[this.status] }, this.renderGlyph(this.status, sizePx[this.size])));
    }
};
