...
})(exports.AtTimeUnit || (exports.AtTimeUnit = {}));
...
const SECONDS_PER_UNIT = {
    [exports.AtTimeUnit.SECONDS]: 1,
    [exports.AtTimeUnit.MINUTES]: 60,
    [exports.AtTimeUnit.HOURS]: 3600,
    [exports.AtTimeUnit.DAYS]: 86400,
    [exports.AtTimeUnit.WEEKS]: 604800,
    [exports.AtTimeUnit.MONTHS]: 2629746, // 365.2425 * 86400 / 12
    [exports.AtTimeUnit.YEARS]: 31557600, // 365.2425 * 86400
};
class AtTimeDateUtil {
    /**
    ...
    static convertSecondsToUnit(seconds, unit, decimalPlaces, roundUp = true) {
        if (unit === exports.AtTimeUnit.SECONDS || unit === exports.TimeExtraOptions.ALL) {
            return seconds;
        }
    ...
    static getDateFromRelativeTime(time) {
        ...
        return dayjs()
            .subtract(time.value, exports.Duration[time.unit])
            .toDate();
    }
    /**
    ...
    static getRelativeDateRange(time) {
        ...
        const startDate = AtTimeDateUtil.floorDateByTimeUnit(fullStartDate, exports.Duration.MINUTES);
...
exports.AtTimeDateUtil = AtTimeDateUtil;
exports.dayjs = dayjs;
