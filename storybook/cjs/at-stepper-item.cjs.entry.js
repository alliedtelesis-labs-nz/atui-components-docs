...
const AtStepperItem = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '11ac52686ec882ec452a919f9488b2b49a81f58a', role: "listitem", "aria-current": this.state === 'current' ? 'step' : undefined, "data-state": this.state, "data-name": "stepper-item", class: `flex min-w-0 ${isVertical
                ...
                : ''}`, tabindex: this.navigable ? 0 : undefined }, index.h("span", { key: '8da1fb37beed00e76d62fc4e0889f8011f8c3c4f', class: `flex shrink-0 ${isVertical
                ? 'w-24 flex-col items-center'
                : 'items-center'}`, "data-name": "stepper-rail" }, this.renderMarker(), this.renderConnector()), index.h("span", { key: '96581435282b99a83d1bdc4fa8243f3d8ab5df9a', class: `flex min-w-0 flex-col gap-2 ${isVertical ? (this.is_last ? '' : 'pb-16') : 'pr-16'}` }, index.h("span", { key: '9694a3350b14525afafff7f2d18b88b29a21b0fb', class: `truncate text-sm font-medium ${labelVariants[this.state]}`, "data-name": "stepper-label" }, this.label, this.optional && (index.h("span", { key: 'fac6e866c05c14c31b3d644d6f527e358ee6e645', class: "text-secondary ml-4 text-xs font-normal", "data-name": "stepper-optional" }, "Optional")), this.state === 'skipped' && (index.h("at-badge", { key: 'e0ff3f7f46cad2af95b0dcde33e4c062cde16db8', class: "ml-4", label: "Skipped", size: "sm", "data-name": "stepper-skipped" }))), this.description && (index.h("span", { key: '0bb1f6280bac20cd2f6ad4802d7a3b5172a09d77', class: "text-secondary truncate text-xs", "data-name": "stepper-description" }, this.description)), index.h("slot", { key: '99a24c1f3bc60200813c2f1f4e21cc795835da2d' }))));
    }
};
