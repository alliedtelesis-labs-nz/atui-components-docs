...
const AtStepperItem = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'b346fe69deddac8c35e4ca3e74eaed562f6b68a6', role: "listitem", "aria-current": this.state === 'current' ? 'step' : undefined, "data-state": this.state, "data-name": "stepper-item", class: `flex min-w-0 ${isVertical
                ...
                : ''}`, tabindex: this.navigable ? 0 : undefined }, index.h("span", { key: 'aab68f406181605d7c5667179fdab1b8757278cb', class: `flex shrink-0 ${isVertical
                ? 'w-24 flex-col items-center'
                : 'items-center'}`, "data-name": "stepper-rail" }, this.renderMarker(), this.renderConnector()), index.h("span", { key: '39fa47d029eafb688aff0cf2cc119f397e6dce48', class: `flex min-w-0 flex-col gap-2 ${isVertical ? (this.is_last ? '' : 'pb-16') : 'pr-16'}` }, index.h("span", { key: '9a9f2915ad723c8910a2268e5b4700412e75fe18', class: `truncate text-sm font-medium ${labelVariants[this.state]}`, "data-name": "stepper-label" }, this.label, this.optional && (index.h("span", { key: 'e79e72ebe8a52ad6c863522d1a6536a5911f175a', class: "text-secondary ml-4 text-xs font-normal", "data-name": "stepper-optional" }, "Optional")), this.state === 'skipped' && (index.h("at-badge", { key: '7646339f1c65c44236111ff8893f4fe7d910d6c5', class: "ml-4", label: "Skipped", size: "sm", "data-name": "stepper-skipped" }))), this.description && (index.h("span", { key: 'c0c25900829d850c6d25bfca513f390d036e2553', class: "text-secondary truncate text-xs", "data-name": "stepper-description" }, this.description)), index.h("slot", { key: '4f98a315a6a1d76ad27c652a45f9a35faf91f62b' }))));
    }
};
