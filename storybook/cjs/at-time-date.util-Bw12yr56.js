...
const SECONDS_PER_UNIT = {
    [exports.TimeUnit.SECONDS]: 1,
    [exports.TimeUnit.MINUTES]: 60,
    [exports.TimeUnit.HOURS]: 3600,
    [exports.TimeUnit.DAYS]: 86400,
    [exports.TimeUnit.WEEKS]: 604800,
    [exports.TimeUnit.MONTHS]: 2629746, // 365.2425 * 86400 / 12
    [exports.TimeUnit.YEARS]: 31557600, // 365.2425 * 86400
};
class AtTimeDateUtil {
    ...
    static convertSecondsToUnit(seconds, unit, decimalPlaces, roundUp = true) {
        if (unit === exports.TimeUnit.SECONDS || unit === exports.TimeExtraOptions.ALL) {
            return seconds;
        }
