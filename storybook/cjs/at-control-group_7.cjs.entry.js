...
const AtSearch = class {
    ...
    render() {
        return (index.h(index.Host, { key: '88484d2bd12fd4c33cdbc2d685d71b83477fc1ff' }, this.label && (index.h("at-form-label", { key: '95de48b09ecc7c3e99709eac67d505f22d0e959d', label: this.label, for: this.inputId })), index.h("div", { key: 'e8e0e0b96e30d1ed2a37bb60efd848f6c2a3daf3', class: "transition[background-color,color,box-shadow] border-input bg-input-background focus-within:border-active-accent focus-within:ring-active-glow rounded-input h-input min-h-input relative flex flex-row items-center justify-center border duration-300 ease-in-out focus-within:z-10 focus-within:ring" }, index.h("at-icon", { key: 'eac6827982230e07e60f45742bec975e94e4fe91', class: "fill-foreground px-8", name: "search" }), index.h("input", { key: 'ca95aa2fd906aa22a12ee9387cf92fe2d751c2ca', id: this.inputId, role: "searchbox", "aria-label": this.label
                ? undefined
                : this.placeholder || 'Search', tabindex: "0", class: "mr-4 h-full w-full min-w-0 bg-transparent p-0 leading-[30px] text-ellipsis focus:border-none focus:outline-none", placeholder: this.placeholder, value: this.model, autocomplete: "off", name: "search", onInput: () => this.onChangeFn(), ref: (el) => (this.searchEl = el) }), index.h("div", { key: 'e6d3f4cea6e300d8421c7d2cfc86dfa0d39ba16d', class: `mt-2 transition-all duration-300 ease-in-out ${this.model !== '' && this.model !== undefined
                ? 'pr-4 opacity-100'
                : 'pointer-events-none pr-0 opacity-0'}` }, index.h("at-button", { key: 'e95702751baa5f57ad5cb2dd1c41d9debf82e696', size: "sm", type: "secondaryText", "aria-label": "Clear search", onClick: () => this.clearFn(), "data-name": "search-clear", tabindex: this.model !== '' && this.model !== undefined
                ? '0'
                : '-1' }, index.h("at-icon", { key: '87d4cdf174286c12ddcda86280b9a668f1b310eb', slot: "icon", name: "cancel" }))), this.info_text && (index.h("div", { key: '007d03ed665ecd35e097b0f88fdc532255c33609', class: "flex items-center pr-8", "data-name": "search-info" }, index.h("at-tooltip", { key: '5559cc8c3315dcfe146aeddab9178b83d4c89717', position: "top" }, index.h("at-icon", { key: '3f1fe3070caaa8da82a465ba6b53400c276e4d28', slot: "tooltip-trigger", class: "fill-muted cursor-pointer", name: "info", size: "1rem" }), index.h("span", { key: '8b3d76fffd18d32b4228aa1672f0256ec1b8a00d' }, this.info_text))))), this.hint_text && (index.h("span", { key: 'df49627e91d88d1d932f4400fae7034da815f561', class: "text-secondary mt-4 truncate text-xs !leading-normal font-normal empty:hidden", "data-name": "search-hint" }, this.hint_text))));
    }
};
...
const AtTableFilterMenu = class {
    ...
    render() {
        return (index.h(index.Host, { key: '022bbd04268c7989d95cbb8fbae23c6fbfbe5623' }, index.h("at-menu", { key: '9e234bf71a92c0be28654513b69e08b9969ea697', ref: (el) => (this.menuEl = el), autoclose: false, width: "fit-content", class: "self-start", align: "start" }, index.h("div", { key: 'e05b308373e06edb7331c72bbdb1c3e5ec56833c', class: "relative", slot: "menu-trigger", "data-tooltip": "table-filter-menu" }, this.filters &&
            filterTree_util.countFilterConditions(this.filters) > 0 && (index.h("at-badge", { key: '5ebde514fd78f4caf41ed161abba63474d765e88', class: "absolute top-[-8px] left-[-6px] z-50", type: "info", size: "sm", label: filterTree_util.countFilterConditions(this.filters).toString() })), index.h("at-button", { key: '3237e08cda1bf4d704b85c8240507c61e15d2039', slot: "tooltip-trigger", type: "secondaryOutline", class: "h-input", "data-name": "filter-menu-trigger" }, index.h("at-icon", { key: 'a782a1a9b554900e8b21f68fc5037cd9d426fb24', slot: "icon", name: "edit_filters" }))), index.h("at-tooltip", { key: '8e582e0d378911da7776c70051089b6cb6a86935', "trigger-id": "table-filter-menu", position: "top" }, this.translations.ATUI.TABLE.FILTER_DATA), index.h("at-filter-form", { key: '5c5008217ddb864946e6bd9675b412a5837db727', filter_config: this.filterConfig, active_filters: this.filters, onAtSearch: this.handleSearch, onAtCancel: this.handleCancel }))));
    }
};
...
const AtTablePagination = class {
    ...
    atPageSizeChange;
    render() {
        return (index.h(index.Host, { key: '4361d18122825313841e0e6585979bad7b7c0727', class: "mt-8 flex items-center justify-end gap-8" }, index.h("span", { key: 'c4791af06b9181ffb6eacd8d4beefc5310755401' }, "Page Size: "), index.h("at-select", { key: '23c23575b6810de62584d2f3730e3c7011d6b519', options: this.resolvedPageSizeOptions, value: String(this.page_size), clearable: false, onAtuiChange: (event) => this.atPageSizeChange.emit(parseInt(event.detail)) }), index.h("at-button", { key: 'ff0b2b7b3d1269aecb884715eb5e234e5b3e5acf', "data-name": "pagination-first", "aria-label": "First page", disabled: this.current_page === 1, type: "secondaryText", onAtuiClick: () => this.atChange.emit(1) }, index.h("at-icon", { key: 'd73c948e3cea5a877961f5af07224a47b89ed943', slot: "icon", name: "first_page" })), index.h("at-button", { key: '24f33abe768a97f7e81d928056c91b6abd4bcdfc', "data-name": "pagination-previous", "aria-label": "Previous page", disabled: this.current_page === 1, type: "secondaryText", onAtuiClick: () => this.atChange.emit(this.current_page - 1) }, index.h("at-icon", { key: '09839b8183a8045cfa99c548b689634b561351a6', slot: "icon", name: "chevron_left" })), index.h("span", { key: 'a9ca68745fbfdd60f8b11595e93ce47bf8369bdd' }, "Page ", this.current_page, " of ", this.num_pages), index.h("at-button", { key: 'b65ced065077cf636756053e87f39c3303458e37', "data-name": "pagination-next", "aria-label": "Next page", disabled: this.current_page === this.num_pages, type: "secondaryText", onAtuiClick: () => this.atChange.emit(this.current_page + 1) }, index.h("at-icon", { key: 'ad211b816f06187b755572747bfce55a3593dc3e', slot: "icon", name: "chevron_right" })), index.h("at-button", { key: '51f2f13f82f3ab9500a5c43a4e724a8a1ab9bfd6', "data-name": "pagination-last", "aria-label": "Last page", disabled: this.current_page === this.num_pages, type: "secondaryText", onAtuiClick: () => this.atChange.emit(this.num_pages) }, index.h("at-icon", { key: 'e98fc3008b8bfb5639f535558af9c699aa6d79fa', slot: "icon", name: "last_page" }))));
    }
};
