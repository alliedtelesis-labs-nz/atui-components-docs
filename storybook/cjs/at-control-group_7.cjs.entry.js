...
const AtControlGroup = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'bc5de31f0253c4d5941a1695704ab1d23cc828af', class: `at-control-group at-control-group--${this.direction}` }, index.h("slot", { key: 'd34d62820bf600f5b4190c968b0baa775b0d4e05' })));
    }
};
...
const AtSearch = class {
    ...
    render() {
        return (index.h(index.Host, { key: '7e5f26da4b69e0c55a4cc785376284bb5734d312' }, this.label && (index.h("at-form-label", { key: 'e3ca7cefa44f0b493833b80ef3194c92f406e651', label: this.label, for: this.inputId })), index.h("div", { key: 'b17ac26c48c2c6a4e71c84279d42db535f7baed0', class: "transition[background-color,color,box-shadow] border-input bg-input-background focus-within:border-active-accent focus-within:ring-active-glow rounded-input h-input min-h-input relative flex flex-row items-center justify-center border duration-300 ease-in-out focus-within:z-10 focus-within:ring" }, index.h("at-icon", { key: '9dc5d7d9a318a85c699a0a83d0b38b925b983bdf', class: "fill-foreground px-8", name: "search" }), index.h("input", { key: '73cc1a97f6335eaf3faa09e649f336935f4d8c19', id: this.inputId, role: "searchbox", "aria-label": this.label
                ? undefined
                : this.placeholder || 'Search', tabindex: "0", class: "mr-4 h-full w-full min-w-0 bg-transparent p-0 leading-[30px] text-ellipsis focus:border-none focus:outline-none", placeholder: this.placeholder, value: this.model, autocomplete: "off", name: "search", onInput: () => this.onChangeFn(), ref: (el) => (this.searchEl = el) }), index.h("div", { key: 'c0826d4d936be2a9fe6971970fb0f841be0c75b7', class: `mt-2 transition-all duration-300 ease-in-out ${this.model !== '' && this.model !== undefined
                ? 'pr-4 opacity-100'
                : 'pointer-events-none pr-0 opacity-0'}` }, index.h("at-button", { key: 'b319cca400b9e894db833749b81857c75044b350', size: "sm", type: "secondaryText", "aria-label": "Clear search", onClick: () => this.clearFn(), "data-name": "search-clear", tabindex: this.model !== '' && this.model !== undefined
                ? '0'
                : '-1' }, index.h("at-icon", { key: '7c6901d2d03a53f8d1a978ca3d2309a9ffbcf62c', slot: "icon", name: "cancel" }))), this.info_text && (index.h("div", { key: 'a987cb8bf6d8aeabb1dc41988dc3a39709a1dd08', class: "flex items-center pr-8", "data-name": "search-info" }, index.h("at-tooltip", { key: '23ec678a47dee5471d17d7f626c77020ad5548cf', position: "top" }, index.h("at-icon", { key: 'da6d25e3baed07583e369f7d7553addf255a8cde', slot: "tooltip-trigger", class: "fill-muted cursor-pointer", name: "info", size: "1rem" }), index.h("span", { key: 'a30c08d5c11e5cabb86a5003e488cf1221a8a91e' }, this.info_text))))), this.hint_text && (index.h("span", { key: '8550f56b3178ca6cafbf79fcd3b424e94c934c62', class: "text-secondary mt-4 truncate text-xs !leading-normal font-normal empty:hidden", "data-name": "search-hint" }, this.hint_text))));
    }
};
