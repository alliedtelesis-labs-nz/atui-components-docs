...
const AtControlGroup = class {
    ...
    render() {
        return (index.h(index.Host, { key: '89091780de572e5d7c2aa3053dc0965caa5575b8', class: `at-control-group at-control-group--${this.direction}` }, index.h("slot", { key: '67554b8da7a537c381b40101e62c7a778771e1e3' })));
    }
};
...
const AtReloadButton = class {
    ...
    atuiReload;
    render() {
        return (index.h("at-tooltip", { key: '987ab2c31334388b0e9a91c39c6de610247eadde', position: "top" }, index.h("div", { key: 'a48905794b0cc1dd921edac463892ece7e01c390', slot: "tooltip-trigger", class: "relative" }, this.has_updates && (index.h("span", { key: '4575fa710ff2c35a81e93792bce6c099b71d8c8f', class: "!bg-active-foreground pointer-events-none absolute top-[2px] right-[2px] z-10 h-[8px] w-[8px] rounded-full", "data-name": "reload-updates-indicator" })), index.h("at-button", { key: 'b49a831bd27ed5dff65926f37b3aa905e30d63c6', type: "secondaryText", onAtuiClick: () => this.atuiReload.emit() }, index.h("at-icon", { key: '128972d0d1942cc7abf940ee68fac86c3691b72e', slot: "icon", name: "retry" }))), index.h("span", { key: '035e1c6f68ffe627c00e8ce58afa748415c38654' }, this.has_updates
...
const AtSearch = class {
    ...
    render() {
        return (index.h(index.Host, { key: '25f79e37273c134a1f6d478ae3ab8dca0579b942' }, this.label && (index.h("at-form-label", { key: 'bfe761cb7559df5ef3e5243eda11196d24aa4242', label: this.label, for: this.inputId })), index.h("div", { key: '0ba80f6043a3c83aea51cf4ec5692e94bf3b75ba', class: "transition[background-color,color,box-shadow] border-input bg-input-background focus-within:border-active-accent focus-within:ring-active-glow rounded-input h-input min-h-input relative flex flex-row items-center justify-center border duration-300 ease-in-out focus-within:z-10 focus-within:ring" }, index.h("at-icon", { key: 'f8f806d4e0ee735a38b7eebd418cb40f3243853c', class: "fill-foreground px-8", name: "search" }), index.h("input", { key: 'e9960332cbf2c8bfe133133aed0d1410be4ab1f2', id: this.inputId, role: "searchbox", "aria-label": this.label
                ? undefined
                : this.placeholder || 'Search', tabindex: "0", class: "mr-4 h-full w-full min-w-0 bg-transparent p-0 leading-[30px] text-ellipsis focus:border-none focus:outline-none", placeholder: this.placeholder, value: this.model, autocomplete: "off", name: "search", onInput: () => this.onChangeFn(), ref: (el) => (this.searchEl = el) }), index.h("div", { key: 'b996dbdbcc12175cb7936cfad2d950b20864bc25', class: `mt-2 transition-all duration-300 ease-in-out ${this.model !== '' && this.model !== undefined
                ? 'pr-4 opacity-100'
                : 'pointer-events-none pr-0 opacity-0'}` }, index.h("at-button", { key: '977e3c9f8ce5a2cd9aec256f8e9e3f75f439717d', size: "sm", type: "secondaryText", "aria-label": "Clear search", onClick: () => this.clearFn(), "data-name": "search-clear", tabindex: this.model !== '' && this.model !== undefined
                ? '0'
                : '-1' }, index.h("at-icon", { key: '0bfb58e492e5d394e38b15c5466f7abbd31d6cba', slot: "icon", name: "cancel" }))), this.info_text && (index.h("div", { key: 'd1f51b88ff8069e6c5b0289e018dd6f1944f95e5', class: "flex items-center pr-8", "data-name": "search-info" }, index.h("at-tooltip", { key: 'bc4e42565f5487213da6765ffb927b082c4afe67', position: "top" }, index.h("at-icon", { key: '2dff836a45242eeda394ea2497a6492848a44775', slot: "tooltip-trigger", class: "fill-muted cursor-pointer", name: "info", size: "1rem" }), index.h("span", { key: '62abd414e404384d400aaf1df0feca58e87f6f4c' }, this.info_text))))), this.hint_text && (index.h("span", { key: '25dcd89153b31365243fc288930671bff0c70c55', class: "text-secondary mt-4 truncate text-xs !leading-normal font-normal empty:hidden", "data-name": "search-hint" }, this.hint_text))));
    }
};
...
const AtTableFilterMenu = class {
    ...
    render() {
        return (index.h(index.Host, { key: '20b352ed5671960089b5ae76b1ff2f8324cc7b01' }, index.h("at-menu", { key: '51dd260c20fd7c8fef0f4dbfb6c429a7b04c04e6', ref: (el) => (this.menuEl = el), autoclose: false, width: "fit-content", class: "self-start", align: "start" }, index.h("div", { key: '3c8c0f78ee64e42c885ba0982a1229654ee8d2b2', class: "relative", slot: "menu-trigger", "data-tooltip": "table-filter-menu" }, this.filters &&
            filterTree_util.countFilterConditions(this.filters) > 0 && (index.h("at-badge", { key: 'ad201c9126797d23e16ad613852c7c5a383af238', class: "absolute top-[-8px] left-[-6px] z-10", type: "info", size: "sm", label: filterTree_util.countFilterConditions(this.filters).toString() })), index.h("at-button", { key: 'b8eca58a4b9ba873149d6c0381aa6c9630b5aa5f', slot: "tooltip-trigger", type: "secondaryOutline", class: "h-input", "data-name": "filter-menu-trigger" }, index.h("at-icon", { key: '3e67ded5e02f1ba5ffa78d0f5a38e8d29bd12933', slot: "icon", name: "edit_filters" }))), index.h("at-tooltip", { key: '0c8b8db018de9d0f874fabb48664d7bfb672c61c', "trigger-id": "table-filter-menu", position: "top" }, this.translations.ATUI.TABLE.FILTER_DATA), index.h("at-filter-form", { key: '5e52108fd39d0d55d2ab873c695862a66893ef23', filter_config: this.filterConfig, active_filters: this.filters, onAtSearch: this.handleSearch, onAtCancel: this.handleCancel }))));
    }
};
...
const AtTablePagination = class {
    ...
    atPageSizeChange;
    render() {
        return (index.h(index.Host, { key: '21bc437ecec558f02343d1b2cacb480f4a96c89f', class: "mt-8 flex items-center justify-end gap-8" }, index.h("span", { key: '1ba21a862e0846508044102a3eb950fef3cc4c0b' }, "Page Size: "), index.h("at-select", { key: 'c5c7ff39e7da45c170068bb96e2a2dfa24df7df6', options: this.resolvedPageSizeOptions, value: String(this.page_size), clearable: false, onAtuiChange: (event) => this.atPageSizeChange.emit(parseInt(event.detail)) }), index.h("at-button", { key: '22e40168f0e7fa41052932bde8a38d280ae25281', disabled: this.current_page === 1, type: "secondaryText", onAtuiClick: () => this.atChange.emit(1) }, index.h("at-icon", { key: 'c0ecacbc2cd22f5e492771df1c8b9bd660abc0be', slot: "icon", name: "first_page" })), index.h("at-button", { key: '2040d09d15a71130242257ea44bfbf5336366dd6', disabled: this.current_page === 1, type: "secondaryText", onAtuiClick: () => this.atChange.emit(this.current_page - 1) }, index.h("at-icon", { key: 'ad780260acfc51f170bb579e72b7503852a02be9', slot: "icon", name: "chevron_left" })), index.h("span", { key: '3349b5b5fe9451c30c6d39ee9495483c349e153b' }, "Page ", this.current_page, " of ", this.num_pages), index.h("at-button", { key: 'bfbeb5d9928c160fae147743c83a01310fbba06a', disabled: this.current_page === this.num_pages, type: "secondaryText", onAtuiClick: () => this.atChange.emit(this.current_page + 1) }, index.h("at-icon", { key: 'd5de9b6ec68ecc95f435107fa34f033a531673d0', slot: "icon", name: "chevron_right" })), index.h("at-button", { key: 'd271a578aed55144dfd5c9a5a07b9b84257f8eb4', disabled: this.current_page === this.num_pages, type: "secondaryText", onAtuiClick: () => this.atChange.emit(this.num_pages) }, index.h("at-icon", { key: 'a398a6677a5e1fea187e8873ae47fc10d47b508e', slot: "icon", name: "last_page" }))));
    }
};
