...
const AtControlGroup = class {
    ...
    render() {
        return (index.h(index.Host, { key: '4c270bd7e76ab24684a357a64a916956be2c1145', class: `at-control-group at-control-group--${this.direction}` }, index.h("slot", { key: '40c0f7d223f835f891491b4d5d26a0d3a72e73d3' })));
    }
};
...
const AtReloadButton = class {
    ...
    atuiReload;
    render() {
        return (index.h("at-tooltip", { key: '194c53f49648a63810df479e03ea3dfe43714b6c', position: "top" }, index.h("div", { key: '7f14f51eae408de3e60bcd38fdf881345978dc1d', slot: "tooltip-trigger", class: "relative" }, this.has_updates && (index.h("span", { key: '8e43cdb743ae9bc10ef05d6536ce8c2ee3a338e9', class: "!bg-active-foreground pointer-events-none absolute top-[2px] right-[2px] z-10 h-[8px] w-[8px] rounded-full", "data-name": "reload-updates-indicator" })), index.h("at-button", { key: '9e538511b3f41421ce36895a88068755d5e3a190', type: "secondaryText", onAtuiClick: () => this.atuiReload.emit() }, index.h("at-icon", { key: 'e72e99e36510d6386a7d090f15e8b729a2fcdfcf', slot: "icon", name: "retry" }))), index.h("span", { key: 'e2bf62c4ec691e834faa15f32c4976d8279ee5f9' }, this.has_updates
...
const AtSearch = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'bcc5ae44a4ee57367a21fce46fc9817d70942faa' }, this.label && (index.h("at-form-label", { key: '4d0f264ba192c4931c3cd127b7bfc7eb179579be', label: this.label, for: this.inputId })), index.h("div", { key: '73431bfa7ecb384cfc21f07fae71e00ad2ea367d', class: "transition[background-color,color,box-shadow] border-input bg-input-background focus-within:border-active-accent focus-within:ring-active-glow rounded-input h-input min-h-input relative flex flex-row items-center justify-center border duration-300 ease-in-out focus-within:z-10 focus-within:ring" }, index.h("at-icon", { key: 'cc29daea9d7523b925a7d2f9114f5c2acb8ec233', class: "fill-foreground px-8", name: "search" }), index.h("input", { key: '3e09828a08852be02be2d53f22714343d8a4f909', id: this.inputId, role: "searchbox", "aria-label": this.label
                ? undefined
                : this.placeholder || 'Search', tabindex: "0", class: "mr-4 h-full w-full min-w-0 bg-transparent p-0 leading-[30px] text-ellipsis focus:border-none focus:outline-none", placeholder: this.placeholder, value: this.model, autocomplete: "off", name: "search", onInput: () => this.onChangeFn(), ref: (el) => (this.searchEl = el) }), index.h("div", { key: '591d3f63f0b8ebe38592d16183d449774a192e57', class: `mt-2 transition-all duration-300 ease-in-out ${this.model !== '' && this.model !== undefined
                ? 'pr-4 opacity-100'
                : 'pointer-events-none pr-0 opacity-0'}` }, index.h("at-button", { key: 'd37e758195d954af5a602214c6cff161aed4484c', size: "sm", type: "secondaryText", "aria-label": "Clear search", onClick: () => this.clearFn(), "data-name": "search-clear", tabindex: this.model !== '' && this.model !== undefined
                ? '0'
                : '-1' }, index.h("at-icon", { key: '43eec26bc839f6cce9a9bb501cfd46c79baab552', slot: "icon", name: "cancel" }))), this.info_text && (index.h("div", { key: '8d4f58c933363cde7220e856a464dc5ceeffd582', class: "flex items-center pr-8", "data-name": "search-info" }, index.h("at-tooltip", { key: '4251393f14e1acad487e7978b8d66463793c2e28', position: "top" }, index.h("at-icon", { key: 'cc6adb678f8a3538db3a4c9b87f17c3009383f8d', slot: "tooltip-trigger", class: "fill-muted cursor-pointer", name: "info", size: "1rem" }), index.h("span", { key: '39ca8bbada58ebd376d28c171fedeb1405188459' }, this.info_text))))), this.hint_text && (index.h("span", { key: '6b7d0900e052e34c866e568c8f34ea969981b069', class: "text-secondary mt-4 truncate text-xs !leading-normal font-normal empty:hidden", "data-name": "search-hint" }, this.hint_text))));
    }
};
