...
const AtInputNumericComponent = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '4d4184e8cfbf37b8824a46bdf2d6580018569634', class: "w-full" }, index.h("div", { key: '7d82359e5b4aaba0426f44d0bca10a4a1d39f74c', class: "flex flex-col" }, index.h("slot", { key: '80661178a0c6f46298976bac4cba94d7f397882e', name: "label" }), (this.label || this.required || this.info_text) && (index.h("at-form-label", { key: '37167fbcc13df5ef630b6744f363340391ecb5d6', label: this.label, for: this.inputId, required: this.required && !this.readonly, info_text: this.info_text })), this.hint_text && (index.h("span", { key: 'c934f46ebaa2aa043cb978f6a839913a9a8b929b', class: "text-light mb-8 inline-block text-xs leading-tight", "data-name": "input-hint" }, this.hint_text))), index.h("div", { key: '3b2fed55042ebdb0acd7ccc16f4e13c3ebc65d34', class: containerClassname }, this.show_buttons && !this.disabled && !this.readonly && (index.h("at-button", { key: 'b88909f2104e62f75db6e5a3565760988aea2df5', class: "border-med rounded-l-md rounded-r-none border-r border-solid", type: "secondaryText", icon: "remove", onClick: this.handleDecrease, disabled: this.value <= this.min, "aria-label": "Subtract", "data-name": "input-subtract" })), index.h("input", { key: '7dbdb0514774bda7f8fe4f2d9d31724214914fc8', id: this.inputId, readonly: this.readonly ? true : undefined, disabled: this.disabled ? true : undefined, required: this.required, type: "number", placeholder: `${this.placeholder}`, onInput: (event) => (this.value = Number(event.target.value)), onChange: (event) => this.handleChange(event), value: this.value, ref: (el) => (this.inputEl = el), class: classname, "data-name": "input" }), this.show_buttons && !this.disabled && !this.readonly && (index.h("at-button", { key: 'f20dfe6c5a0773d2ca5db39a07da632242de000d', class: "border-med rounded-l-none rounded-r-md border-l border-solid", type: "secondaryText", icon: "add", onClick: this.handleIncrease, disabled: this.value >= this.max, "aria-label": "Add", "data-name": "input-add" }))), this.error_text && this.invalid && (index.h("span", { key: '7c74df9edfb6e5dca0a68278b5b31a59e2a83ba8', class: "text-error text-sm", "data-name": "input-error" }, this.error_text))));
    }
};
