...
const AtInputNumericComponent = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '80c1a70c70cf5b36be06d27675e66117fd58d8d3', class: "w-full" }, index.h("div", { key: 'e1deb9a2efb7cae62dd9aafe971bb6d42bbf5c7c', class: "flex flex-col" }, index.h("slot", { key: 'a3258b8b8877685f223861c0189e3d391443e0b6', name: "label" }), (this.label || this.required || this.info_text) && (index.h("at-form-label", { key: '04106a2e15b898c3708027e9ce576ac6022d32e6', label: this.label, for: this.inputId, required: this.required && !this.readonly, info_text: this.info_text })), this.hint_text && (index.h("span", { key: '877527abc4cb458373e0e00cf1a55a05330ff7f3', class: "text-light mb-8 inline-block text-xs leading-tight", "data-name": "input-hint" }, this.hint_text))), index.h("div", { key: 'ff824572386c741042272d17f3c25308923d18e2', class: containerClassname }, this.show_buttons && !this.disabled && !this.readonly && (index.h("at-button", { key: 'ca5187971831ab8594dbc6948afe2d7d1df3b208', class: "border-med rounded-l-md rounded-r-none border-r border-solid", type: "secondaryText", icon: "remove", onClick: this.handleDecrease, disabled: this.value <= this.min, "aria-label": "Subtract", "data-name": "input-subtract" })), index.h("input", { key: '9edf21d36037e4160f45b7ed99446efc48fb9c35', id: this.inputId, readonly: this.readonly ? true : undefined, disabled: this.disabled ? true : undefined, required: this.required, type: "number", placeholder: `${this.placeholder}`, onInput: (event) => (this.value = Number(event.target.value)), onChange: (event) => this.handleChange(event), value: this.value, ref: (el) => (this.inputEl = el), class: classname, "data-name": "input" }), this.show_buttons && !this.disabled && !this.readonly && (index.h("at-button", { key: '60a8dac6305bd30445e0fef5b68a8a0ad6520ddf', class: "border-med rounded-l-none rounded-r-md border-l border-solid", type: "secondaryText", icon: "add", onClick: this.handleIncrease, disabled: this.value >= this.max, "aria-label": "Add", "data-name": "input-add" }))), this.error_text && this.invalid && (index.h("span", { key: 'ae1783afec1f14db4689bcf58e599a985a598290', class: "text-error text-sm", "data-name": "input-error" }, this.error_text))));
    }
};
