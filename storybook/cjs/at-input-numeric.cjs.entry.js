...
const AtInputNumericComponent = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'f7942c2d19bbfccac3475659f234a5eb637dd9ed', class: "w-full" }, index.h("div", { key: '73cac411ce293ca359b1a33657de18d1419ffddf', class: "flex flex-col" }, index.h("slot", { key: 'e9c100e221084b924712a4cdb55213a97b7f2c7a', name: "label" }), (this.label || this.required || this.info_text) && (index.h("at-form-label", { key: '5ff8b58cc0f874c258d1e0c2c76b8fb4ba2582b8', label: this.label, for: this.inputId, required: this.required && !this.readonly, info_text: this.info_text })), this.hint_text && (index.h("span", { key: 'b3705d22c7d8314008622b747403df1f9f66eb4d', class: "text-light mb-8 inline-block text-xs leading-tight", "data-name": "input-hint" }, this.hint_text))), index.h("div", { key: '22010e5f164d2aa2953dfb345461de98c33f6dfb', class: containerClassname }, this.show_buttons && !this.disabled && !this.readonly && (index.h("at-button", { key: '559fa78aaf37f972940424329c2150efe6a961c3', class: "border-med rounded-l-md rounded-r-none border-r border-solid", type: "secondaryText", icon: "remove", onClick: this.handleDecrease, disabled: this.value <= this.min, "aria-label": "Subtract", "data-name": "input-subtract" })), index.h("input", { key: '7f9c2b865f70bf89c42e22017f22cdae7a28becb', id: this.inputId, readonly: this.readonly ? true : undefined, disabled: this.disabled ? true : undefined, required: this.required, type: "number", placeholder: `${this.placeholder}`, onInput: (event) => (this.value = Number(event.target.value)), onChange: (event) => this.handleChange(event), value: this.value, ref: (el) => (this.inputEl = el), class: classname, "data-name": "input" }), this.show_buttons && !this.disabled && !this.readonly && (index.h("at-button", { key: '2ae13c69d9588627ddb6d83f6c782f01207788f6', class: "border-med rounded-l-none rounded-r-md border-l border-solid", type: "secondaryText", icon: "add", onClick: this.handleIncrease, disabled: this.value >= this.max, "aria-label": "Add", "data-name": "input-add" }))), this.error_text && this.invalid && (index.h("span", { key: 'f9d64e3b46c2b76499601adef6061b5dd4989cb6', class: "text-error text-sm", "data-name": "input-error" }, this.error_text))));
    }
};
