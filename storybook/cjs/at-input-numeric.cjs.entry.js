...
const AtInputNumericComponent = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'dc2913eea15ed46361ab6c34ec2876047097bca6', class: "w-full" }, index.h("div", { key: 'e0e2cacdbb04180c1584b18ef3d3c84986c24d61', class: "mb-4 flex flex-col empty:hidden" }, index.h("slot", { key: '3c394936ff2108f4966f8cab7aab321128bfe8b0', name: "label" }), (this.label || this.required || this.info_text) && (index.h("at-form-label", { key: 'e681722bb26d435eabde376575745f24ff780381', label: this.label, for: this.inputId, required: this.required && !this.readonly, info_text: this.info_text })), this.hint_text && (index.h("span", { key: '1742dcfb55eba2d895fa2b7b87c3102f845fe7f5', class: "text-muted inline-block text-xs leading-tight", "data-name": "input-hint" }, this.hint_text))), index.h("div", { key: 'b0c26cd58bc4c85848b0b29977114dc71b46e2e6', class: containerClassname }, this.show_buttons && !this.disabled && !this.readonly && (index.h("at-button", { key: 'c88208db603a49e09b80c4149288d4cd9bd7f84a', class: "border-input rounded-l-md rounded-r-none border-r border-solid", type: "secondaryText", onClick: this.handleDecrease, onKeyDown: (event) => this.handleStepKeyDown(event, this.handleDecrease), disabled: this.value <= this.min, "aria-label": "Subtract", "data-name": "input-subtract" }, index.h("at-icon", { key: '108ffe83a03ea309e66d12f083abfcbaf375b5b0', slot: "icon", name: "subtract" }))), index.h("input", { key: '18992f5e451ea69133a73a23ceedff6b9f02a41d', id: this.inputId, readonly: this.readonly ? true : undefined, disabled: this.disabled ? true : undefined, required: this.required, type: "number", min: this.min, max: this.max, step: this.step, placeholder: `${this.placeholder}`, onInput: (event) => this.handleInput(event), onChange: (event) => this.handleChange(event), value: this.value, ref: (el) => (this.inputEl = el), class: classname, "data-name": "input" }), this.show_buttons && !this.disabled && !this.readonly && (index.h("at-button", { key: 'e50e3a8419c0c49ca9ca4dc913886ee4d630e535', class: "border-input rounded-l-none rounded-r-md border-l border-solid", type: "secondaryText", onClick: this.handleIncrease, onKeyDown: (event) => this.handleStepKeyDown(event, this.handleIncrease), disabled: this.value >= this.max, "aria-label": "Add", "data-name": "input-add" }, index.h("at-icon", { key: 'de4f5950eae6d12bc0706cf8587d5d187adfb015', slot: "icon", name: "add" })))), this.error_text && this.invalid && (index.h("span", { key: '4315e6e8eb4129cfa24914f8e4ba25de7a42c1f3', class: "text-error text-sm", "data-name": "input-error" }, this.error_text))));
    }
};
