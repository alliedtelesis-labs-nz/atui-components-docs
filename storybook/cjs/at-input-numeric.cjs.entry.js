...
const AtInputNumericComponent = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '0bac07dc0e5235cdccf658e780d0db4782e004e5', class: "w-full" }, index.h("div", { key: 'd7fdbfcf6cba88252cb307a891075e0fca3e356a', class: "mb-4 flex flex-col empty:hidden" }, index.h("slot", { key: '3cf7ed7ee4f230eeecccc7748d3809b99ff403cc', name: "label" }), (this.label || this.required || this.info_text) && (index.h("at-form-label", { key: '6cf48d6824957de8c1deb9c981b1a3decdfd631c', label: this.label, for: this.inputId, required: this.required && !this.readonly, info_text: this.info_text })), this.hint_text && (index.h("span", { key: 'fa65f5313fc238cc104f78fcd6850b31bb34ebf1', class: "text-muted inline-block text-xs leading-tight", "data-name": "input-hint" }, this.hint_text))), index.h("div", { key: '53b6e77dd244028afc482dd68d1e65a3bedcf9d8', class: containerClassname }, this.show_buttons && !this.disabled && !this.readonly && (index.h("at-button", { key: '6d24f0c9034c5deb1e48ca87454eebb80bdc5908', class: "border-input rounded-l-md rounded-r-none border-r border-solid", type: "secondaryText", onClick: this.handleDecrease, onKeyDown: (event) => this.handleStepKeyDown(event, this.handleDecrease), disabled: this.value <= this.min, "aria-label": "Subtract", "data-name": "input-subtract" }, index.h("at-icon", { key: '1f6b1f44c5967c7aa313e3a21c28806a8f390b99', slot: "icon", name: "subtract" }))), index.h("input", { key: '385a291afb91c5177c3a16f38e6515d85987a013', id: this.inputId, "aria-label": this.aria_label ?? undefined, readonly: this.readonly ? true : undefined, disabled: this.disabled ? true : undefined, required: this.required, type: "number", min: this.min, max: this.max, step: this.step, placeholder: `${this.placeholder}`, onInput: (event) => this.handleInput(event), onChange: (event) => this.handleChange(event), value: this.value, ref: (el) => (this.inputEl = el), class: classname, "data-name": "input" }), this.show_buttons && !this.disabled && !this.readonly && (index.h("at-button", { key: '5b6247aee86257038b6cd30d9e116e2aa64c93e1', class: "border-input rounded-l-none rounded-r-md border-l border-solid", type: "secondaryText", onClick: this.handleIncrease, onKeyDown: (event) => this.handleStepKeyDown(event, this.handleIncrease), disabled: this.value >= this.max, "aria-label": "Add", "data-name": "input-add" }, index.h("at-icon", { key: 'ac17637215b865080d762f0615685180bd34e44d', slot: "icon", name: "add" })))), this.error_text && this.invalid && (index.h("span", { key: 'd9eee3ec4d8630dd56e711ca3b2a7f16bad3f971', class: "text-error text-sm", "data-name": "input-error" }, this.error_text))));
    }
};
