...
const AtSidebarComponent = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '7d3a701c35f3ba7bb62b1dce5358035702c64605', "data-state": this.isOpen ? 'expanded' : 'collapsed', class: `mode-${this.mode} side-${this.side} collapse-${this.collapsible}` }, isModalOverlay && (index.h("div", { key: '8f689d900d5d141af8365bd4d1f3af7e417468a6', class: "backdrop", "data-name": "backdrop", onClick: this.handleBackdropClick, "aria-hidden": "true" })), index.h("nav", { key: 'b0c53ba97977cf8eaf3fc9689b92a8f268186943', "data-name": "sidebar", "data-open": this.isOpen, class: `sidebar collapse-${this.collapsible}`, "aria-hidden": !this.isOpen && this.collapsible === 'offcanvas'
                ? 'true'
                : 'false', role: "navigation", "aria-label": "Sidebar navigation" }, index.h("div", { key: '9cd9cc35c71158a1549f92ebf425788b2e939fc3', class: "sidebar-header", "data-name": "sidebar-header" }, index.h("slot", { key: '068d6d7e219d3bb5c13f503771829aa797216fec', name: "sidebar-header" })), index.h("div", { key: '849102bf67e48874b3d6e7b68da33d20c22c50e0', class: "sidebar-content", "data-name": "sidebar-content" }, index.h("slot", { key: '11efdbfb7d5119ff972f902821b8bdad80008012', name: "sidebar-content" })), index.h("div", { key: '9a74c57c78a7a8cdfc1570493576bc0826ad8231', class: `sidebar-footer`, "data-name": "sidebar-footer" }, index.h("slot", { key: '2ac67295064d82c6407f51949411b2b31f937d59', name: "sidebar-footer" }))), index.h("div", { key: '1ce7fb474f1a0861a3d180897cbe461cfede1e69', class: "page-content", "data-name": "page-content", "aria-hidden": isModalOverlay ? 'true' : 'false', inert: isModalOverlay }, index.h("slot", { key: '843a6318f7901ccd1be175ee0030e5db28860f80', name: "page-content" }))));
    }
};
