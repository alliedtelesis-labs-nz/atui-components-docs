...
const AtSidebarComponent = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'a56784c31b58e370c93033745a94934c9427e31d', "data-state": this.isOpen ? 'expanded' : 'collapsed', class: `mode-${this.mode} side-${this.side} collapse-${this.collapsible}` }, isModalOverlay && (index.h("div", { key: '7603b205f95a004bc8f1145b352755bd660023cf', class: "at-sidebar__backdrop", onClick: this.handleBackdropClick, "aria-hidden": "true" })), index.h("nav", { key: 'eb96151eac7bb1ca1015e71d3ef71197421bca75', "data-name": "sidebar-nav", "aria-expanded": this.isOpen ? 'true' : 'false', "aria-hidden": !this.isOpen && this.collapsible === 'offcanvas'
                ? 'true'
                : 'false', part: "nav", class: `at-sidebar__nav collapse-${this.collapsible}` }, index.h("slot", { key: 'd7ca0f314a58e77ff6d0043e1354d960222861c1', name: "at-sidebar__header" }), index.h("div", { key: 'b95c08cbba51df77bfefcb355f5283ac378aa5d9', class: "at-sidebar__nav-content" }, index.h("slot", { key: 'af25dcfad1743406829da578751e63c087268737', name: "sidebar-content" })), index.h("div", { key: 'eec4047b19719a8778528de3319e99a0ca5e7962', class: `${this.isOpen ? '' : 'hidden'}` }, index.h("slot", { key: '924e166a93c8c854b4798d28b5acb1a92c3d4051', name: "sidebar-footer" }))), index.h("div", { key: 'c502dc22bd3da68b9a43aec059c03adbf57bb2e4', class: "at-sidebar__content", "aria-hidden": isModalOverlay ? 'true' : 'false', inert: isModalOverlay }, index.h("slot", { key: '7ab5228f46a43622b47cd7c256a74fa3993ba24e', name: "page-content" }))));
    }
};
