...
const AtSidebarComponent = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'c0d7bcc202cd140822b7283926334019cc50c5a7', "data-state": this.isOpen ? 'expanded' : 'collapsed', class: `mode-${this.mode} side-${this.side} collapse-${this.collapsible}` }, isModalOverlay && (index.h("div", { key: 'e8aba712d8d342cc607f6397ec6f2b2c96b10bae', class: "backdrop", "data-name": "backdrop", onClick: this.handleBackdropClick, "aria-hidden": "true" })), index.h("nav", { key: '98be7c3c012b14ad7aba3684e7edb4e96aab4dfb', "data-name": "sidebar", "data-open": this.isOpen, class: `sidebar collapse-${this.collapsible}`, "aria-hidden": !this.isOpen && this.collapsible === 'offcanvas'
                ? 'true'
                : 'false', role: "navigation", "aria-label": "Sidebar navigation" }, index.h("div", { key: 'bfa9864cad565f9985cb6f3e72ffe27bf27722c8', class: "sidebar-header", "data-name": "sidebar-header" }, index.h("slot", { key: '06847845595b16e82f617375a22ff2609fb85e16', name: "sidebar-header" })), index.h("div", { key: '5ef39230f3db2b5fb61badbc6db20f315f323843', class: "sidebar-content", "data-name": "sidebar-content" }, index.h("slot", { key: '656630370628d587765648dae8af4ad4758f6348', name: "sidebar-content" })), index.h("div", { key: 'e81d300d305f0aa13cb87c537899fabc77b24271', class: `sidebar-footer`, "data-name": "sidebar-footer" }, index.h("slot", { key: '90fea1d015493812773d78836b2b0fca21d305a4', name: "sidebar-footer" }))), index.h("div", { key: 'b11201b110781f75ea2388cd0f5da75ecf1e812d', class: "page-content", "data-name": "page-content", "aria-hidden": isModalOverlay ? 'true' : 'false', inert: isModalOverlay }, index.h("slot", { key: '7796ed73a6da39a2963039eb3013ac0ab87be4e4', name: "page-content" }))));
    }
};
