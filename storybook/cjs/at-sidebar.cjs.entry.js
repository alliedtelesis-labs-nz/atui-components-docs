...
const AtSidebarComponent = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '95eaa02126c2889e8bc35c30af5d1160ab2dbc16', "data-state": this.isOpen ? 'expanded' : 'collapsed', class: `mode-${this.mode} side-${this.side}` }, isModalOverlay && (index.h("div", { key: '297213cd581df1b377cc9dc6416c21b19e30a25b', class: "backdrop", onClick: this.handleBackdropClick, "aria-hidden": "true" })), index.h("nav", { key: '9f181ab18eac74734babf19820dc7140a57e0089', "data-name": "sidebar-nav", "aria-expanded": this.isOpen ? 'true' : 'false', "aria-hidden": !this.isOpen && this.collapsible === 'offcanvas'
                ? 'true'
                : 'false', class: `nav collapse-${this.collapsible}` }, index.h("slot", { key: '3e3dbb3388ab39658ef0ea002f69834f099c6388', name: "sidebar-header" }), index.h("div", { key: '0e3e0e2577cbe67def594f10d6ca4e209928c57d', class: "nav-content" }, index.h("slot", { key: '85952ac6a88bcaa51c3d89644d07d6f765431382', name: "sidebar-content" })), index.h("div", { key: '25cf391b1ee874a54ace56c517aa90c82860980c', class: `${this.isOpen ? '' : 'hidden'}` }, index.h("slot", { key: '9df8d2d0815d55aab8805ec1a8661c25cfb80a22', name: "sidebar-footer" }))), index.h("div", { key: '12269b071c490baafecb4a5068cb97bb9b8032d3', class: "content", "aria-hidden": isModalOverlay ? 'true' : 'false', inert: isModalOverlay }, index.h("slot", { key: 'b1663dc71b6a2cdebf5170de8010fd3e4cb47227', name: "page-content" }))));
    }
};
