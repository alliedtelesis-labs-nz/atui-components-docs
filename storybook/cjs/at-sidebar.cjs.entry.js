...
const AtSidebarComponent = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '66cf16a2e8352a43fc76bc8d1278e736d59f8888', "data-state": this.isOpen ? 'expanded' : 'collapsed', class: `mode-${this.mode} side-${this.side} collapse-${this.collapsible}` }, isModalOverlay && (index.h("div", { key: '083a9df701c1a232c7f83638f8be79f616612e9d', class: "backdrop", "data-name": "backdrop", onClick: this.handleBackdropClick, "aria-hidden": "true" })), index.h("nav", { key: 'e0a8dfe1542185b5fc7a6b966a0acaf886592942', "data-name": "sidebar", "data-open": this.isOpen, class: `sidebar collapse-${this.collapsible}`, "aria-hidden": !this.isOpen && this.collapsible === 'offcanvas'
                ? 'true'
                : 'false', role: "navigation", "aria-label": "Sidebar navigation" }, index.h("div", { key: 'd1ee48339dd7b94d4177ee816284a481b899661e', class: "sidebar-header", "data-name": "sidebar-header" }, index.h("slot", { key: '7e7d96aea161982432409fe30076b34c573e65b4', name: "sidebar-header" })), index.h("div", { key: '87be37e4e8018db01de0c1b3dc1ce7c2ab0cd152', class: "sidebar-content", "data-name": "sidebar-content" }, index.h("slot", { key: 'fc743da372a675bad1eaf8fd72f4ba75f1233ccd', name: "sidebar-content" })), index.h("div", { key: '110a71bae8983cba4ce72011a5b611171a9e06d6', class: `sidebar-footer`, "data-name": "sidebar-footer" }, index.h("slot", { key: '487aaa831599d12c5908ceee26d549661aede4d8', name: "sidebar-footer" }))), index.h("div", { key: 'c89ac4c671ae05a00dabc2f3012f7f3ccf5a7530', class: "page-content", "data-name": "page-content", "aria-hidden": isModalOverlay ? 'true' : 'false', inert: isModalOverlay }, index.h("slot", { key: '670f1dd3522531b4910baf051360590145c197d7', name: "page-content" }))));
    }
};
