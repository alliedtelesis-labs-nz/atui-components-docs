...
const AtSidebarComponent = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '39690ccaeb7bfe7183973bc3306e915ba7229e8d', "data-state": this.isOpen ? 'expanded' : 'collapsed', "data-collasable": this.collapsible, "data-side": this.side, class: "group/sidebar-wrapper flex h-screen w-full items-stretch overflow-hidden" }, index.h("nav", { key: 'f791757c9fe9b72e4ba7f5a04753eff5cea3881f', "data-name": "sidebar-nav", class: `w-${this.width} ` + classname }, index.h("slot", { key: '6f0d93fee49d09cf5885460be7b107ff57b57845', name: "sidebar-header" }), index.h("div", { key: '9330554a48b8b4757aac5e5d9fb432aaf99e06a4', class: "align-items oveflow-y-auto flex flex-1 flex-col p-8" }, index.h("slot", { key: 'cbed6ae1019e7f569b6f26be6337c43708630e77', name: "sidebar-content" })), index.h("div", { key: 'f413f33f30428b094e96e02d386fced8f95ae531', class: `${this.isOpen ? '' : 'hidden'}` }, index.h("slot", { key: '0138347136ed649c7073f64996147296d1334d3b', name: "sidebar-footer" }))), index.h("div", { key: 'bd1c1f329d5615776c66c19f2b2a0bd6b84e70dc', class: "flex w-full overflow-auto" }, index.h("slot", { key: 'd336b0b5cf4156152b3b9f57eeddd42c0d16f109', name: "page-content" }))));
    }
};
