...
const AtSidebarComponent = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '0ceec71ab189d51c1cb4dd4c7e041bd8a90663eb', "data-state": this.isOpen ? 'expanded' : 'collapsed', class: `mode-${this.mode} side-${this.side} collapse-${this.collapsible}` }, isModalOverlay && (index.h("div", { key: 'e1ad79763a60090273ad59963b59f16a3e5f3dbc', class: "backdrop", "data-name": "backdrop", onClick: this.handleBackdropClick, "aria-hidden": "true" })), index.h("nav", { key: '9c0b64671b770fdfd30b16d3618fc45bb8e17265', "data-name": "sidebar", "data-open": this.isOpen, class: `sidebar collapse-${this.collapsible}`, "aria-hidden": !this.isOpen && this.collapsible === 'offcanvas'
                ? 'true'
                : 'false', role: "navigation", "aria-label": "Sidebar navigation" }, index.h("div", { key: '9be5424970e7109446e79c1667d4e5ed6c408432', class: "sidebar-header", "data-name": "sidebar-header" }, index.h("slot", { key: '0735040e7ef76bae0e2169a37688afbe1e720e9b', name: "sidebar-header" })), index.h("div", { key: '0a2851b71cf8bacf141bd090fb9fc9791315ffb3', class: "sidebar-content", "data-name": "sidebar-content" }, index.h("slot", { key: '1e8ffe3e3c35797d9d72b9a880fe361d4d71ea15', name: "sidebar-content" })), index.h("div", { key: '5dbcf8b7affcf10a70a2e92fcf0309a183b806ec', class: `sidebar-footer`, "data-name": "sidebar-footer" }, index.h("slot", { key: '254a3ec159db753c08de854ac8c491a43762f9b0', name: "sidebar-footer" }))), index.h("div", { key: '995f80e4354c9357ae1bc8a2f8a5404579ba8b51', class: "page-content", "data-name": "page-content", "aria-hidden": isModalOverlay ? 'true' : 'false', inert: isModalOverlay }, index.h("slot", { key: 'e429f916d71edb0b0d7b2a03356a754e2f69cb8a', name: "page-content" }))));
    }
};
