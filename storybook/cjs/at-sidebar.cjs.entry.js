...
const AtSidebarComponent = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'd99a114452db694a6c667a00196e1816017caba9', "data-state": this.isOpen ? 'expanded' : 'collapsed', class: `mode-${this.mode} side-${this.side} collapse-${this.collapsible}` }, isModalOverlay && (index.h("div", { key: '8e013f4d9d74d4fa3b57d139bf30a08a2086f95c', class: "backdrop", "data-name": "backdrop", onClick: this.handleBackdropClick, "aria-hidden": "true" })), index.h("nav", { key: '2992ada397d0e0c9f0d53d76759af57feeed6522', "data-name": "sidebar", "data-open": this.isOpen, class: `sidebar collapse-${this.collapsible}`, "aria-expanded": this.isOpen ? 'true' : 'false', "aria-hidden": !this.isOpen && this.collapsible === 'offcanvas'
                ? 'true'
                : 'false' }, index.h("div", { key: '06cfe81ded9b1c45ee44865e274d63576a2a8ee9', class: "sidebar-header", "data-name": "sidebar-header" }, index.h("slot", { key: 'c7a74e1392cf4e5031babbfa2452a6406004fb54', name: "sidebar-header" })), index.h("div", { key: '7e793b3e5a53c0a73076647d0e8bd5411a41c694', class: "sidebar-content", "data-name": "sidebar-content" }, index.h("slot", { key: 'e60c9d87217ac1d1b5bc0b115f56b3c8cb8b6c59', name: "sidebar-content" })), index.h("div", { key: 'db1f86a0cb26e764411ea9953eac7fbc32b5f1cc', class: `sidebar-footer`, "data-name": "sidebar-footer" }, index.h("slot", { key: '3ba0e4bcbddc8dba7cf8e0736ef774c584e5f89b', name: "sidebar-footer" }))), index.h("div", { key: '0c7f10fd6d93ec845fb5aac6ae96885065589cc5', class: "page-content", "data-name": "page-content", "aria-hidden": isModalOverlay ? 'true' : 'false', inert: isModalOverlay }, index.h("slot", { key: 'dbd09baa948cd97c04008fe77675a5e30883957e', name: "page-content" }))));
    }
};
