...
const AtSidebarComponent = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '367326da38ae0b3fd0baef3efa7a554d7fa3082c', "data-state": this.isOpen ? 'expanded' : 'collapsed', class: `mode-${this.mode} side-${this.side} collapse-${this.collapsible}` }, isModalOverlay && (index.h("div", { key: 'ea48fa6db4e0a3bbf1b36d6c7deae1be392b2377', class: "backdrop", "data-name": "backdrop", onClick: this.handleBackdropClick, "aria-hidden": "true" })), index.h("nav", { key: '925b35700c5d8143a509cb01e63f85a8a7908f74', "data-name": "sidebar", "data-open": this.isOpen, class: `sidebar collapse-${this.collapsible}`, "aria-hidden": !this.isOpen && this.collapsible === 'offcanvas'
                ? 'true'
                : 'false', role: "navigation", "aria-label": "Sidebar navigation" }, index.h("div", { key: '8fddb304879be908cceee9a0f8dca75221df040b', class: "sidebar-header", "data-name": "sidebar-header" }, index.h("slot", { key: 'a5f9a7a97468fe15f4af284d215032f8dcbc56dd', name: "sidebar-header" })), index.h("div", { key: '42d573159f5a11cd98d5ea81d4ee72410f51b18b', class: "sidebar-content", "data-name": "sidebar-content" }, index.h("slot", { key: 'cf6c418a116a3c772650aebb434b3c5ecbe2cded', name: "sidebar-content" })), index.h("div", { key: 'd87f3ba5edc949a095bc1f64aa6e95649b3051cb', class: `sidebar-footer`, "data-name": "sidebar-footer" }, index.h("slot", { key: 'fdb7217b9f565c2627a30dbc77df8c95a9a57eda', name: "sidebar-footer" }))), index.h("div", { key: 'eff2f5801a7e36911d3c1cc92ed42494176600de', class: "page-content", "data-name": "page-content", "aria-hidden": isModalOverlay ? 'true' : 'false', inert: isModalOverlay }, index.h("slot", { key: 'e5c01ee8ce6e40806872c2d943ab1b7be7fb1dcd', name: "page-content" }))));
    }
};
