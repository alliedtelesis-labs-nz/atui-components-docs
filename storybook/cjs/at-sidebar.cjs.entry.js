...
const AtSidebarComponent = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'ab4b783de19ced626d905213e2b4eca117be04a6', "data-state": this.isOpen ? 'expanded' : 'collapsed', class: `mode-${this.mode} side-${this.side} collapse-${this.collapsible}` }, isModalOverlay && (index.h("div", { key: '1fe788dcebc211c81a5c7e1173c886ce0da54449', class: "at-sidebar__backdrop", onClick: this.handleBackdropClick, "aria-hidden": "true" })), index.h("nav", { key: '525701b608999554ce72771a8c36d6530c6124e4', "data-name": "sidebar-nav", "aria-expanded": this.isOpen ? 'true' : 'false', "aria-hidden": !this.isOpen && this.collapsible === 'offcanvas'
                ? 'true'
                : 'false', part: "nav", class: `at-sidebar__nav collapse-${this.collapsible}` }, index.h("slot", { key: 'bcd7214bb0462fbee82ff8c49967681b54be5a77', name: "at-sidebar__header" }), index.h("div", { key: '241a5a0278f022622974ed0b02909b85799d8e45', class: "at-sidebar__nav-content" }, index.h("slot", { key: '0eae331186e780350acfd2a7c3eeb5f4680ec6a7', name: "sidebar-content" })), index.h("div", { key: '2ea74b41869fcc46076e7129e58abb7447e8f5a2', class: `${this.isOpen ? '' : 'hidden'}` }, index.h("slot", { key: '5a23d31de996e6d2de78b620f433ff1992ef2e5e', name: "sidebar-footer" }))), index.h("div", { key: '2c4b96403b8a0223c055fb634999c4fe5bf030e5', class: "at-sidebar__content", "aria-hidden": isModalOverlay ? 'true' : 'false', inert: isModalOverlay }, index.h("slot", { key: 'b50f410381587e2b76087c6d8e6c7c57e810beaa', name: "page-content" }))));
    }
};
