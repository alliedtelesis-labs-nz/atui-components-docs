...
const AtSidebarComponent = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '644ddd968b5f04d580d30693bf6a8db226a82cfa', "data-state": this.isOpen ? 'expanded' : 'collapsed', "data-side": this.side, class: `mode-${this.mode} side-${this.side} collapse-${this.collapsible}` }, isModalOverlay && (index.h("div", { key: '430f266043830a939961ac14d462a063aa410054', class: "backdrop", "data-name": "backdrop", onClick: this.handleBackdropClick, "aria-hidden": "true" })), index.h("nav", { key: '010224969230e6ff07af9785b119b8c717ed5168', "data-name": "sidebar", "data-open": this.isOpen, class: `sidebar collapse-${this.collapsible} w-${this.width}`, "aria-hidden": !this.isOpen && this.collapsible === 'offcanvas'
                ? 'true'
                : 'false', role: "navigation", "aria-label": "Sidebar navigation" }, index.h("div", { key: 'b5702bfa33a6a60a422762420f7c639808c09efb', class: "sidebar-header", "data-name": "sidebar-header" }, index.h("slot", { key: '38d60a3f8b040e9d5a8230832957c4aca279d87a', name: "sidebar-header" })), index.h("div", { key: '07b58aee7345964f8049555e39b997623be7bd3a', class: "sidebar-content", "data-name": "sidebar-content" }, index.h("slot", { key: 'fbb2c1ca69e0243907945b01e71e88be5b9e5357', name: "sidebar-content" })), index.h("div", { key: '6e079f71b3bf57dbc901c135503bf2f40d807ac9', class: `sidebar-footer`, "data-name": "sidebar-footer" }, index.h("slot", { key: '2a4b53e43ee8ea512ecf879ae90a53c569ae7c05', name: "sidebar-footer" }))), index.h("div", { key: '8ea121f80fcc9bd60e85c1ebd3e5c9fd32c514cb', class: "page-content", "data-name": "page-content", "aria-hidden": isModalOverlay ? 'true' : 'false', inert: isModalOverlay }, index.h("slot", { key: 'b5e7ab7610c0d16d4cb7602f46c1a8f9ba3b7410', name: "page-content" }))));
    }
};
