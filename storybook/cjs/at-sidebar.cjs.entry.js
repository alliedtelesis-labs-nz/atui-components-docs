...
const AtSidebarComponent = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '56017883ebb3e34e70820ca34e72be8cf29ad282', "data-state": this.isOpen ? 'expanded' : 'collapsed', class: `mode-${this.mode} side-${this.side} collapse-${this.collapsible}` }, isModalOverlay && (index.h("div", { key: 'ab21fa144fcaaa1f17141e8d0ea6f49c0a98e0b6', class: "backdrop", "data-name": "backdrop", onClick: this.handleBackdropClick, "aria-hidden": "true" })), index.h("nav", { key: '9ff1a30c190eb4a471e6ce6e280162e7162fb16d', "data-name": "sidebar", "data-open": this.isOpen, class: `sidebar collapse-${this.collapsible}`, "aria-expanded": this.isOpen ? 'true' : 'false', "aria-hidden": !this.isOpen && this.collapsible === 'offcanvas'
                ? 'true'
                : 'false' }, index.h("div", { key: '11450e524aee179b742d64726d06c4cce67e9b91', class: "sidebar-header", "data-name": "sidebar-header" }, index.h("slot", { key: '7bd55a1f3cf31fff882fb22ab124224edc07f7ea', name: "sidebar-header" })), index.h("div", { key: '674e1726c9edcdcdc59be4c25c3a288833495461', class: "sidebar-content", "data-name": "sidebar-content" }, index.h("slot", { key: 'ada260ee71561cfdd88d35720dd09aa9489767c7', name: "sidebar-content" })), index.h("div", { key: 'bc0963a2be90f10537c64c1933bedf64d41988db', class: `sidebar-footer`, "data-name": "sidebar-footer" }, index.h("slot", { key: '02e95aab5b2ec72d45387daa29daef5314d95202', name: "sidebar-footer" }))), index.h("div", { key: '1944a67a4203ab0d623a26fb495c73a223142a36', class: "page-content", "data-name": "page-content", "aria-hidden": isModalOverlay ? 'true' : 'false', inert: isModalOverlay }, index.h("slot", { key: '711e99cdbea4337bc2cfcfd81cc1456f28ee079f', name: "page-content" }))));
    }
};
