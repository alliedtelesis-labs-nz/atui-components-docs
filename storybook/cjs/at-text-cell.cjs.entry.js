...
const AtTextCellComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'd47d53ffee203d5e8cc9a7eb3ae00aafd9fdf73d', class: "flex h-full items-center" }, index.h("at-tooltip", { key: 'b18f8b7fb2b64c405bc397bff840e71f11dee0a1', position: "right", disabled: !this.params.generateTooltip }, index.h("span", { key: '0cfbd2c3ff91f6983f940a91476df5b4c85a3408', slot: "tooltip-trigger", "data-index": `column-${this.params.rowIndex}-data`, style: this.textStyles, class: `${this.textClass ?? ''} truncate`, onClick: () => {
                if (this.params.click)
                    this.params.click(this.params);
            } }, this.textValue), this.params.generateTooltip && (index.h("span", { key: '462608e81b96de56862ebcd6aec63da4d1480888', class: `${this.params.tooltipClass ?? ''} leading-normal` }, this.params.generateTooltip(this.params))))));
    }
};
