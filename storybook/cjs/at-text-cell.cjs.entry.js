...
const AtTextCellComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: '951a9e3db9541ba6de0219223f512e2a56ed441d', class: "flex h-full items-center" }, index.h("at-tooltip", { key: '55a59080884b58e653a10ee8b133a935a5e82bee', position: "right", disabled: !this.params.generateTooltip }, index.h("span", { key: 'f119f26fabe44d2bf9e5ac8a461fb601d3bc908c', slot: "tooltip-trigger", "data-index": `column-${this.params.rowIndex}-data`, style: this.textStyles, class: `${this.textClass ?? ''} truncate`, onClick: () => {
                if (this.params.click)
                    this.params.click(this.params);
            } }, this.textValue), this.params.generateTooltip && (index.h("span", { key: 'eeceab54b1831272ccbba4b66401303499adee13', class: `${this.params.tooltipClass ?? ''} leading-normal` }, this.params.generateTooltip(this.params))))));
    }
};
