...
const AtTextCellComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'b7fd9853e3fb19cfda40242b889f2124db86f3f1', class: "flex h-full items-center" }, index.h("at-tooltip", { key: 'd67a7cff5c29e21e271022257b8aff4d1198f0fe', position: "right", disabled: !this.params.generateTooltip }, index.h("span", { key: '4f31a997e0697b0c1f066768ca44f862f1684639', slot: "tooltip-trigger", "data-index": `column-${this.params.rowIndex}-data`, style: this.textStyles, class: `${this.textClass ?? ''} truncate`, onClick: () => {
                if (this.params.click)
                    this.params.click(this.params);
            } }, this.textValue), this.params.generateTooltip && (index.h("span", { key: 'c94179955e65f85e5a38ef62c57f0e89522e60f0', class: `${this.params.tooltipClass ?? ''} leading-normal` }, this.params.generateTooltip(this.params))))));
    }
};
