...
const AtTextCellComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'cfe0d7c5f688ce3e486c6b3d24ae39b1116284d5', class: "flex h-full items-center" }, index.h("at-tooltip", { key: 'c0ada3f043d2ecfeb36dd9fae7d0f487de62236b', position: "right", disabled: !this.params.generateTooltip }, index.h("span", { key: 'dd41ef7d6c9f08efc4bd94d6617b24f718bfae1c', slot: "tooltip-trigger", "data-index": `column-${this.params.rowIndex}-data`, style: this.textStyles, class: `${this.textClass ?? ''} truncate`, onClick: () => {
