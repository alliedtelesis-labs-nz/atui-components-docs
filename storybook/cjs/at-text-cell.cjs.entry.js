...
const AtTextCellComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'c43599ded3a4c4091de07caea8eafdff8b345c5b', class: "flex h-full min-w-0 items-center" }, index.h("at-tooltip", { key: 'ac28b98a039168a702ead9d103aa14dee628cb0d', position: "right", disabled: !this.params.generateTooltip, class: "h-fit min-w-0 self-center" }, index.h("span", { key: '512020ca9f74772d3743081265b54e9ba28bdec5', slot: "tooltip-trigger", "data-index": `column-${this.params.rowIndex}-data`, style: this.textStyles, class: `${this.textClass ?? ''} block truncate`, onClick: () => {
                if (this.params.click)
                    this.params.click(this.params);
            } }, this.textValue), this.params.generateTooltip && (index.h("span", { key: '87b7885fca898b8ab49f69bd49c585ae61e2dea3', class: `${this.params.tooltipClass ?? ''} leading-normal` }, this.params.generateTooltip(this.params))))));
    }
};
