...
const AtTooltip = class {
    ...
    render() {
        return (index.h(index.Host, { key: '3d0cbb4427de0b527bd42f12377e8eefad2f29f6', class: "relative" }, !this.trigger_id && (index.h("div", { key: '2c99d7d4a41b4df9c383c426f0700fdcfddd96c0', "aria-haspopup": "true", "data-name": "tooltip-trigger", ref: (el) => (this.triggerEl = el), "aria-expanded": `${this.isOpen ? 'true' : 'false'}`, "aria-describedby": this.popoverId, class: this.disabled ? 'contents' : '', onMouseEnter: () => !this.disabled ? this.showHandler() : null, onMouseLeave: () => !this.disabled ? this.hideHandler() : null, onFocusin: () => !this.disabled ? this.showHandler() : null, onFocusout: () => !this.disabled ? this.hideHandler() : null }, index.h("slot", { key: 'b97f2b685d1b6e98465bcd0e6db9bb550c14b3be', name: "tooltip-trigger" }))), index.h("div", { key: 'aadc6bc33abd14758a0ab55c0dafdaeb03f95f58', ref: (el) => (this.tooltipEl = el), "data-position": this.position, "data-align": this.align, popover: "auto", id: this.popoverId, class: "bg-surface-overlay/90 text-foreground-inv pointer-events-none w-fit rounded-md px-[6px] py-[2px] text-sm leading-tight break-words whitespace-normal opacity-0 shadow-md transition-opacity duration-200 ease-out", "data-name": "tooltip-content-wrapper" }, index.h("slot", { key: 'c6848a1f9d82ee5f797014805a52efbe57c5a9fe' }))));
    }
