...
const AtuiSelectComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: '2fd089fa843e8c6df8474d58f758d6222b2d79dd', class: "group/select", onFocusout: async (event) => {
            ...
            } }, this.renderlabel(), index.h("atui-menu", { key: '12c4c552386244d09e553441a94d3ce5c854950a', ref: (el) => (this.menuRef = el), trigger: "click", align: "start", width: this.parentWidth, role: "listbox", disabled: this.disabled || this.readonly, onMenuStateChange: (event) => this.updateIsOpenState(event) }, this.renderInput(), !this.disabled || !this.readonly
            ? this.renderOptions()
            : null), index.h("div", { key: '87b923e65f362509de51daae509f8335301e0f02' }, this.error_text && this.invalid && (index.h("span", { key: '17f0ff916d34d10159a2dbd5dea16ac7112b53a3', class: "text-error", "data-name": "select-error" }, this.error_text)))));
    }
    renderlabel() {
