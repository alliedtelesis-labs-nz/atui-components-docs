...
const AtuiSidePanelComponent = class {
    ...
    render() {
        return (index.h("div", { key: 'd211a07eda5723a9f10055ecf4bd13f4d07e16a3' }, index.h("dialog", { key: '257c0d45235db65655cdb240bbd742b2819507eb', id: this.panel_id, ref: (el) => (this.panelDialog = el), class: this.backdrop ? 'backdrop' : '', onClose: this.handleDialogClose, onKeyDown: this.handleKeyDown }, index.h("div", { key: '6d71bf2195605e7481c539cbd138c01bcba53f23', class: `${this.panelClasses} ${this.sizeClasses}`, ref: (el) => (this.sidePanelWrapper = el), "data-name": "panel-wrapper" }, index.h("div", { key: '4df526e0383659b51f97b55c682e6db7c1bffb61', class: 'z-nav sticky top-0' }, index.h("atui-header", { key: '98a932a3be955172f52d24a1e021b73aa06eb777', header_title: this.panel_title, subtitle: this.panel_subtitle }, this.has_close_button && (index.h("span", { key: '494443344e7d61d874f4ac8be271b1c819e1091f', class: 'rounded-full hover:bg-gray-100', slot: 'actions' }, index.h("i", { key: 'ffdf8745d6ee4dbac16f15ee0836397033a45367', class: "material-icons md-16 top-20 right-16 cursor-pointer p-8 !text-[18px]", onClick: this.handleClose, "data-name": "panel-close" }, "close"))))), index.h("div", { key: '75225667d5eb12d6079cae60b85988bb22bda085', class: 'flex w-full flex-1 flex-col' }, index.h("slot", { key: 'e4c264f4bb6f31c20d1855e42602a4b1a77a3f05' }))))));
    }
    get panelClasses() {
