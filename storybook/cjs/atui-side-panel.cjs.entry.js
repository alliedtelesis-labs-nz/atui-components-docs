...
const AtuiSidePanelComponent = class {
    ...
    render() {
        return (index.h("div", { key: '590e61ab100a8a92e84258feb41acab7318e2f46' }, index.h("dialog", { key: '0b64751e65029937eca42d90f1627bbf177b0a0b', id: this.panel_id, ref: (el) => (this.panelDialog = el), class: this.backdrop ? 'backdrop' : '' }, index.h("div", { key: '506da7487920748c72c088678ac8ac1c2fcbf036', class: `${this.panelClasses} ${this.sizeClasses}`, ref: (el) => (this.sidePanelWrapper = el), "data-name": "panel-wrapper" }, index.h("div", { key: '52d6928ea586fbf44d7a44543ad4340902433e97', class: 'sticky top-0 z-nav' }, index.h("atui-header", { key: 'afcfb2438095853c4c30b94a880d8d2ef2961b37', header_title: this.panel_title, subtitle: this.panel_subtitle }, this.has_close_button && (index.h("span", { key: '3f6404d18342b0eebe20347aee4cd95439954f11', class: 'rounded-full hover:bg-gray-100', slot: 'actions' }, index.h("i", { key: '6fc03eaac2366ecd318cc8a7eae678827206f9de', class: "material-icons md-16 right-16 top-20 cursor-pointer p-8 !text-[18px]", onClick: this.handleClose, "data-name": "panel-close" }, "close"))))), index.h("div", { key: 'b527dd9a9ec9dd18260bbccb862a2a3b6c82c515', class: 'flex w-full flex-1 flex-col' }, index.h("slot", { key: '8708fdfd43d6b747182882def558f368a1cac5e8', name: 'content' }))))));
    }
    get panelClasses() {
