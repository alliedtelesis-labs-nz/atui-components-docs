...
const AtPromptInputComponent = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'fb2efe45f16d822bf16591e1e656f1f1fbb24c79', id: this.inputId + '-container', class: "w-full px-16" }, index.h("div", { key: 'f7f9e4223adf3f4ab731170f9b615c8d73dd8f30', class: "flex flex-col" }, index.h("slot", { key: '8bd457233e14d1ab117dd7d45928e660e39f264e', name: "label" }), (this.label || this.info_text) && (index.h("at-form-label", { key: '2f4ae19e0ef3033557956383df8b94552ae43880', label: this.label, for: this.inputId, info_text: this.info_text, "data-name": "prompt-input-label" })), this.hint_text && (index.h("span", { key: '2e4fbbddbc2e32f000ac2d7a9d4246df9ec5fdaa', class: "text-light mb-8 inline-block text-xs leading-tight", "data-name": "prompt-input-hint" }, this.hint_text))), index.h("div", { key: '4ba727a82d26ee6117449f4b0e4a4c9b7fbf5435', class: containerClass }, index.h("textarea", { key: '5472d064ab0becb05b234535e00a107fd9d98598', class: inputClass, disabled: this.disabled, id: this.inputId, placeholder: this.placeholder, onInput: (event) => this.handleInput(event), onKeyDown: (event) => this.handleKeyDown(event), value: this.value, ref: (el) => (this.textareaEl = el), style: {
                minHeight: '44px',
                maxHeight: this.max_height + 'px',
                overflow: 'auto',
            }, "data-name": "prompt-input" }), index.h("div", { key: '2104af50b128e8c26a5ca0c88b609de2e99a5b56', class: "flex w-full items-center justify-between gap-1" }, index.h("div", { key: 'c51a5341acb9c92c803b7fda6c38bfde44a4ae45', class: "flex items-center gap-4" }, index.h("slot", { key: '7e0d3fe5f13113218ef1ec25c94cb8cd655176b6', name: "actions-left" })), index.h("div", { key: '423268d8bd6803d48d61eb1c8c1fbf598059f36b', class: "flex items-center gap-4 self-end" }, index.h("slot", { key: '7ae62c803c9d1d330490f90017536fbd52bc4bdc', name: "actions-right" }), index.h("at-button", { key: '9c84d7dcedf435f97202638b27fb9a164b47edbb', class: "rounded-lg", size: "sm", type: "secondary", icon: this.in_progress ? 'stop' : 'arrow_upward', disabled: !canSend, onClick: () => this.sendMessage(), onKeyDown: (event) => {
                if (event.key === 'Enter' ||
                    event.key === ' ') {
                    this.sendMessage();
                }
            }, "data-name": "prompt-send-button" })))), index.h("slot", { key: 'abf74c4ff9a2522115a058510d1441e49211dc3f', name: "footer" }), this.invalid && (index.h("span", { key: 'a869612ba047233497329d2f079e8edcb7426d92', class: "text-error-dark text-xs", "data-name": "error-text" }, this.error_text
            ? this.error_text
...
const AtPromptThread = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'a1d380f2786ff3335a27e39d05a8d7bf59fd3572', class: "block h-full", "data-name": "thread-container" }, index.h("div", { key: '310bd5e411e00ac7395be990ede053036e6f916e', class: "flex h-full flex-col gap-16 overflow-y-auto scroll-smooth", ref: (el) => (this.scrollContainer = el), "data-name": "scroll-container" }, !hasMessages ? (index.h("slot", { name: "thread-empty-state" })) : (index.h("div", { "data-name": "thread-messages-container", class: "flex flex-col gap-16" }, this.renderMessages(), this.renderLoadingIndicator())), index.h("slot", { key: '84dc546479f72bc57b205784c6e67a76ca53dce4', name: "thread-messages" }))));
    }
};
