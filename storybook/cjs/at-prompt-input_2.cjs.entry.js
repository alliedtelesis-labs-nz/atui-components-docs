...
const AtPromptInputComponent = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '735caf4f342cb2aa409c0481f5779912900a14f4', id: this.inputId + '-container', class: "w-full px-16" }, index.h("div", { key: '4643bd606369bc7383e7e6ed41d95ad8d2291126', class: "flex flex-col" }, index.h("slot", { key: '0c8fa5d048b00b57763e6c9253fce9519a82b58b', name: "label" }), (this.label || this.info_text) && (index.h("at-form-label", { key: '3cdc5c7155fc28e538cf2687b9a180999f804e4f', label: this.label, for: this.inputId, info_text: this.info_text, "data-name": "prompt-input-label" })), this.hint_text && (index.h("span", { key: '6aabe9abcae90f0a20ddc43032b72f02f06ead14', class: "text-muted mb-8 inline-block text-xs leading-tight", "data-name": "prompt-input-hint" }, this.hint_text))), index.h("div", { key: '73085cd20a78fb3929852b16b5fb28c2894cb215', class: containerClass }, index.h("textarea", { key: '9a9507f252e6b6fff91e58ef214e96bb03234091', class: inputClass, disabled: this.disabled, id: this.inputId, placeholder: this.placeholder, onInput: (event) => this.handleInput(event), onKeyDown: (event) => this.handleKeyDown(event), value: this.value, ref: (el) => (this.textareaEl = el), style: {
                minHeight: '44px',
                maxHeight: this.max_height + 'px',
                overflow: 'auto',
            }, "data-name": "prompt-input" }), index.h("div", { key: 'ea7847d0d91deb2a276d7a015900b448b517790b', class: "flex w-full items-center justify-between gap-1" }, index.h("div", { key: '3fbb2776892a50e5cd4e5f36478f989c2e81ffcd', class: "flex items-center gap-4" }, index.h("slot", { key: 'abd90924b6c9d63761955d059b3e6fb58203cd3c', name: "actions-left" })), index.h("div", { key: '0aaec592121ae4b38aa46afa93b2ee645b6e5a0d', class: "flex items-center gap-4 self-end" }, index.h("slot", { key: 'c8e845095d33ab2a8abcc22c7eff1ce11e026751', name: "actions-right" }), index.h("at-button", { key: 'c865fcf7c118141a2a10db47847e6d4198082a6b', class: "rounded-lg", size: "sm", type: "secondary", disabled: !canSend, onClick: () => this.sendMessage(), onKeyDown: (event) => {
                if (event.key === 'Enter' ||
                    event.key === ' ') {
                    this.sendMessage();
                }
            }, "data-name": "prompt-send-button" }, index.h("at-icon", { key: 'cc2a7b330f726476598980c426b8b0341e14d550', slot: "icon", name: this.in_progress ? 'stop' : 'allowUp' }))))), index.h("slot", { key: 'b3f85bc7e45dc1c3da41eb30e47e647ddc280e1a', name: "footer" }), this.invalid && (index.h("span", { key: '5b7b9c6c48a1370222feb6c0e20b12c0b2b3b188', class: "text-error-foreground text-xs", "data-name": "error-text" }, this.error_text
            ? this.error_text
...
const AtPromptThread = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '56a943f3a346b883364f3841a003d13261a9fd76', class: "block h-full", "data-name": "thread-container" }, index.h("div", { key: '854cbf3ba7de85a9f7c5e2a0be5f774bfd029fb7', class: "flex h-full flex-col gap-16 overflow-y-auto scroll-smooth", ref: (el) => (this.scrollContainer = el), "data-name": "scroll-container" }, !hasMessages ? (index.h("slot", { name: "thread-empty-state" })) : (index.h("div", { "data-name": "thread-messages-container", class: "flex flex-col gap-16" }, this.renderMessages(), this.renderLoadingIndicator())), index.h("slot", { key: 'd017eed7be66b81466bdd3f5235f8d3879096196', name: "thread-messages" }))));
    }
};
