...
const AtPromptInputComponent = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'a92be3a1e39b1a3f580005fe56c85fb82f99759a', id: this.inputId + '-container', class: "w-full px-16" }, index.h("div", { key: '7a9730762c4e6fb6d84055c3b1b516e8da0a8ef9', class: "flex flex-col" }, index.h("slot", { key: 'ac089935dd15bd31c11820fea52ad57213e7e199', name: "label" }), (this.label || this.info_text) && (index.h("at-form-label", { key: '7bf097ab0c155c85203d1bef5158c51d4bb9bebe', label: this.label, for: this.inputId, info_text: this.info_text, "data-name": "prompt-input-label" })), this.hint_text && (index.h("span", { key: '13c4791e1680faf088fd8709eeca48e7aa3fe0e5', class: "text-light mb-8 inline-block text-xs leading-tight", "data-name": "prompt-input-hint" }, this.hint_text))), index.h("div", { key: '2bb81de1389c0112b650cddab44d82aeb965deea', class: containerClass }, index.h("textarea", { key: 'b4095a42fd7e1056d132048bda7baa7f4dd77d8e', class: inputClass, disabled: this.disabled, id: this.inputId, placeholder: this.placeholder, onInput: (event) => this.handleInput(event), onKeyDown: (event) => this.handleKeyDown(event), value: this.value, ref: (el) => (this.textareaEl = el), style: {
                minHeight: '44px',
                maxHeight: this.max_height + 'px',
                overflow: 'auto',
            }, "data-name": "prompt-input" }), index.h("div", { key: '4e883c44e4507137e46860dfed5c2a2b005f4352', class: "flex w-full items-center justify-between gap-1" }, index.h("div", { key: 'a768d3db3aaedf2ab809df3f9a9f55f86d5d735d', class: "flex items-center gap-4" }, index.h("slot", { key: 'a4f449ac9df8d689e06cc46ed46ace44d5667565', name: "actions-left" })), index.h("div", { key: '4a15694bfabbfdd03db0a01e6458936d98ed0ad6', class: "flex items-center gap-4 self-end" }, index.h("slot", { key: '473664a212b9004f257f2f3a029634d17ab19728', name: "actions-right" }), index.h("at-button", { key: '63b60b6982ec32c0e20515d8f98900301674311a', class: "rounded-lg", size: "sm", type: "secondary", icon: this.in_progress ? 'stop' : 'arrow_upward', disabled: !canSend, onClick: () => this.sendMessage(), onKeyDown: (event) => {
                if (event.key === 'Enter' ||
                    event.key === ' ') {
                    this.sendMessage();
                }
            }, "data-name": "prompt-send-button" })))), index.h("slot", { key: '82ef1305581236e017705a964b5f39766e5fcfcd', name: "footer" }), this.invalid && (index.h("span", { key: '10af5faad97d220caa699afa273e4f4f6c1b8c05', class: "text-error-dark text-xs", "data-name": "error-text" }, this.error_text
            ? this.error_text
...
const AtPromptThread = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '81f8c935bab8099dfaf735c9293259d284648e4f', class: "block h-full", "data-name": "thread-container" }, index.h("div", { key: '7a6613c8c275963ebf1f12e8179f10808a278fd3', class: "flex h-full flex-col gap-16 overflow-y-auto scroll-smooth", ref: (el) => (this.scrollContainer = el), "data-name": "scroll-container" }, !hasMessages ? (index.h("slot", { name: "thread-empty-state" })) : (index.h("div", { "data-name": "thread-messages-container", class: "flex flex-col gap-16" }, this.renderMessages(), this.renderLoadingIndicator())), index.h("slot", { key: '17483cf7ee881e3beaef4f172196c9f93950997f', name: "thread-messages" }))));
    }
};
