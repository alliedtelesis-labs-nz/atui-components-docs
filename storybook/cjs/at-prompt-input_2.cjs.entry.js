...
const AtPromptInputComponent = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '52e644a7a1bac1875415c241319efb07d4ed2787', id: this.inputId + '-container', class: "w-full px-16" }, index.h("div", { key: '1e5b492c8779b786c59cb49163f353260c65e141', class: "flex flex-col" }, index.h("slot", { key: 'cd62395badb1d855664a306410235636f1a35e6d', name: "label" }), (this.label || this.info_text) && (index.h("at-form-label", { key: '2394b9657e0e9ef74cdc6ae6e696f99b4ded7159', label: this.label, for: this.inputId, info_text: this.info_text, "data-name": "prompt-input-label" })), this.hint_text && (index.h("span", { key: '08f615952a6b75f98cccc3d1b7e6499b2fbe1ab6', class: "text-muted mb-8 inline-block text-xs leading-tight", "data-name": "prompt-input-hint" }, this.hint_text))), index.h("div", { key: '69a1786ebe77922ec39eda88b94f8cd00d5c20d8', class: containerClass }, index.h("textarea", { key: '50af7e18c95b5b6ba3406558ba8fb6b6ef446de6', class: inputClass, disabled: this.disabled, id: this.inputId, placeholder: this.placeholder, onInput: (event) => this.handleInput(event), onKeyDown: (event) => this.handleKeyDown(event), value: this.value, ref: (el) => (this.textareaEl = el), style: {
                minHeight: '44px',
                maxHeight: this.max_height + 'px',
                overflow: 'auto',
            }, "data-name": "prompt-input" }), index.h("div", { key: '4d78f22ec140a9ea5062fc667fdbde612ff8620c', class: "flex w-full items-center justify-between gap-1" }, index.h("div", { key: '1df1043e66abad89619b659f91188f8118a82aa1', class: "flex items-center gap-4" }, index.h("slot", { key: 'f9e7f7f3a83a9b26ae5b60c5a5e3c92e110599b6', name: "actions-left" })), index.h("div", { key: 'b4cd3b0e0f6bb5bf1f49d7b25ae731d4f2b59da2', class: "flex items-center gap-4 self-end" }, index.h("slot", { key: 'd8ebb6d0318db986063c988cd8dd3cfe320fe40d', name: "actions-right" }), index.h("at-button", { key: 'df2e2a5194fb9b8705f76932088eb622b48d835b', class: "rounded-lg", size: "sm", type: "secondary", disabled: !canSend, onClick: () => this.sendMessage(), onKeyDown: (event) => {
                if (event.key === 'Enter' ||
                    event.key === ' ') {
                    this.sendMessage();
                }
            }, "data-name": "prompt-send-button" }, index.h("at-icon", { key: '1d8595d3fd7b36d4d43895cf67b89ba5f4538bb7', slot: "icon", name: this.in_progress ? 'stop' : 'allowUp' }))))), index.h("slot", { key: '70f49253350037ff0e0e4897514adc5c2bcf2602', name: "footer" }), this.invalid && (index.h("span", { key: 'a7ef08e58361b584e326793223f601b8055639c5', class: "text-error-foreground text-xs", "data-name": "error-text" }, this.error_text
            ? this.error_text
...
const AtPromptThread = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'b9315cce6b031b77642f778b2ecb3f9411d41fc3', class: "block h-full", "data-name": "thread-container" }, index.h("div", { key: 'a1cb5d8099b4d966834d6abbf2e7c38501868c82', class: "flex h-full flex-col gap-16 overflow-y-auto scroll-smooth", ref: (el) => (this.scrollContainer = el), "data-name": "scroll-container" }, !hasMessages ? (index.h("slot", { name: "thread-empty-state" })) : (index.h("div", { "data-name": "thread-messages-container", class: "flex flex-col gap-16" }, this.renderMessages(), this.renderLoadingIndicator())), index.h("slot", { key: '94be5f1184ba7fa260dcf2bc5900ec9e43ae7d48', name: "thread-messages" }))));
    }
};
