...
const AtPromptInputComponent = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '3f320ddd1106da631ac5bcf0355f9c2d1a947bbf', id: this.inputId + '-container', class: "w-full px-16" }, index.h("div", { key: '3756028e701dfc4e0e08fedca1158343ce08a7a7', class: "flex flex-col" }, index.h("slot", { key: '6a863530999b7b5b3aa2802d3d1b926eefc176d8', name: "label" }), (this.label || this.info_text) && (index.h("at-form-label", { key: '71bfe774d9f0b6a4eadca4774b1d0fad1557d05c', label: this.label, for: this.inputId, info_text: this.info_text, "data-name": "prompt-input-label" })), this.hint_text && (index.h("span", { key: 'c75e5f16686465b92be6b7bc2c4c820e76f1c427', class: "text-light mb-8 inline-block text-xs leading-tight", "data-name": "prompt-input-hint" }, this.hint_text))), index.h("div", { key: 'd0d1367255f309fcc7ca0eff24da8bb1d263ed26', class: containerClass }, index.h("textarea", { key: 'c5c4a9e96025e812301c87871516cc5f11079e94', class: inputClass, disabled: this.disabled, id: this.inputId, placeholder: this.placeholder, onInput: (event) => this.handleInput(event), onKeyDown: (event) => this.handleKeyDown(event), value: this.value, ref: (el) => (this.textareaEl = el), style: {
                minHeight: '44px',
                maxHeight: this.max_height + 'px',
                overflow: 'hidden',
            }, "data-name": "prompt-input" }), index.h("div", { key: '100faaa49bca5180c12a52c12b3cba05c0583a35', class: "flex w-full items-center justify-between gap-1" }, index.h("div", { key: '36d81c9a498e59c03438ffc4c8383ea3207ef7f0', class: "flex items-center gap-4" }, index.h("slot", { key: '932c9a2622f2e80cc2561d4e4aa8e03fdf133574', name: "actions-left" })), index.h("div", { key: '8e7aad01d8565bc1bf056003c1c93236ae713aa6', class: "flex items-center gap-4 self-end" }, index.h("slot", { key: '30216d3ffde15dbf2af948f537fe849355362eb4', name: "actions-right" }), index.h("at-button", { key: '69ee6262bf3b0c7b80a305aa2eeede7467ac3485', class: "rounded-lg", size: "sm", type: "secondary", icon: this.in_progress ? 'stop' : 'arrow_upward', disabled: !canSend, onClick: () => this.sendMessage(), onKeyDown: (event) => {
                if (event.key === 'Enter' ||
                    event.key === ' ') {
                    this.sendMessage();
                }
            }, "data-name": "prompt-send-button" })))), index.h("slot", { key: '9a868fab90020c37f1fc034df33dbc32c1e75459', name: "footer" }), this.invalid && (index.h("span", { key: '35471c6b54480cb04aa4d4774c33eb0e2d3424d1', class: "text-error-dark text-xs", "data-name": "error-text" }, this.error_text
            ? this.error_text
...
const AtPromptThread = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '7ece58018fe242e655ec711188baec8ac8828dc6', class: "block h-full", "data-name": "thread-container" }, index.h("div", { key: '4189692590f0fb0640212dbb832b26068ebb49c5', class: "flex h-full flex-col gap-16 overflow-y-auto scroll-smooth", ref: (el) => (this.scrollContainer = el), "data-name": "scroll-container" }, !hasMessages ? (index.h("slot", { name: "thread-empty-state" })) : (index.h("div", { "data-name": "thread-messages-container", class: "flex flex-col gap-16" }, this.renderMessages(), this.renderLoadingIndicator())), index.h("slot", { key: 'b470446c9250f7c627124701c86f0279b54729a0', name: "thread-messages" }))));
    }
};
