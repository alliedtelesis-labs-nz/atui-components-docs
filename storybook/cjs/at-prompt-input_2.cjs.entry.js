...
const AtPromptInputComponent = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'c75d01d7b0f97889961f472bea12ea73765ea7d8', id: this.inputId + '-container', class: "w-full px-16" }, index.h("div", { key: 'a696841efa340b9ca12a5028734cb98067b34d06', class: "flex flex-col" }, index.h("slot", { key: 'd374d1fcf3863dc5cf8b272fdbb4183330a6239f', name: "label" }), (this.label || this.info_text) && (index.h("at-form-label", { key: '45a3c1c64b71c81e248aa7b0986f9474770d2cc3', label: this.label, for: this.inputId, info_text: this.info_text, "data-name": "prompt-input-label" })), this.hint_text && (index.h("span", { key: '6f2bf113908ead1758fc293632292de89698d669', class: "text-light mb-8 inline-block text-xs leading-tight", "data-name": "prompt-input-hint" }, this.hint_text))), index.h("div", { key: 'ff4bcc42a9fcbfc2415b42fcd9d3906110edc3e2', class: containerClass }, index.h("textarea", { key: '7a9d1d988745eb9d7e6aab14fd65df7dbe53e0b2', class: inputClass, disabled: this.disabled, id: this.inputId, placeholder: this.placeholder, onInput: (event) => this.handleInput(event), onKeyDown: (event) => this.handleKeyDown(event), value: this.value, ref: (el) => (this.textareaEl = el), style: {
                minHeight: '44px',
                maxHeight: this.max_height + 'px',
                overflow: 'auto',
            }, "data-name": "prompt-input" }), index.h("div", { key: '5fd03065c0b75c04127c66491047d1dc26d49f54', class: "flex w-full items-center justify-between gap-1" }, index.h("div", { key: '5d21bb89d4176c8f3df7c01fd901e5525c95011d', class: "flex items-center gap-4" }, index.h("slot", { key: '4d68c53d8343b753bc261fc86c4ef91a4d58fb26', name: "actions-left" })), index.h("div", { key: '7993b6805978ac308cb8be22717a785ecd8e8dd1', class: "flex items-center gap-4 self-end" }, index.h("slot", { key: 'eb319086436fc9a5a01497462308b2db3c5d4c7e', name: "actions-right" }), index.h("at-button", { key: '092ffae26a64f728b15b267c89b0d362f24eb03f', class: "rounded-lg", size: "sm", type: "secondary", disabled: !canSend, onClick: () => this.sendMessage(), onKeyDown: (event) => {
                if (event.key === 'Enter' ||
                    event.key === ' ') {
                    this.sendMessage();
                }
            }, "data-name": "prompt-send-button" }, index.h("at-icon", { key: '005c840ee4c012fb87713cd946ead0a0402304a3', slot: "icon", name: this.in_progress ? 'stop' : 'allowUp' }))))), index.h("slot", { key: '5218ef5414848fa902608f22575f5365f717b20c', name: "footer" }), this.invalid && (index.h("span", { key: 'ead10c654f08e3c36c377292312c350b17279ade', class: "text-error-dark text-xs", "data-name": "error-text" }, this.error_text
            ? this.error_text
...
const AtPromptThread = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'ba6321d400c7323874b2e2a720d58e30405aaed5', class: "block h-full", "data-name": "thread-container" }, index.h("div", { key: 'ed1fe16193c76a5999f30d62d0d098df040079c1', class: "flex h-full flex-col gap-16 overflow-y-auto scroll-smooth", ref: (el) => (this.scrollContainer = el), "data-name": "scroll-container" }, !hasMessages ? (index.h("slot", { name: "thread-empty-state" })) : (index.h("div", { "data-name": "thread-messages-container", class: "flex flex-col gap-16" }, this.renderMessages(), this.renderLoadingIndicator())), index.h("slot", { key: '3ef61760aec0c6bc176135039aadc32967e21b8e', name: "thread-messages" }))));
    }
};
