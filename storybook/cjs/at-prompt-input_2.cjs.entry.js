...
const AtPromptInputComponent = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '6104b95460b5fa5eee505942ff12aa0871e4d763', id: this.inputId + '-container', class: "w-full px-16" }, index.h("div", { key: '19a2f2b821eb5c1992759706dee66fdb7f5dd768', class: "flex flex-col" }, index.h("slot", { key: 'fa0707fde0f8e2911eb6a4ab75f10fcf3f4631ab', name: "label" }), (this.label || this.info_text) && (index.h("at-form-label", { key: 'abab23c11ad04ce891543a94cef0cefbd573bb81', label: this.label, for: this.inputId, info_text: this.info_text, "data-name": "prompt-input-label" })), this.hint_text && (index.h("span", { key: '273a317cfe17f1bb101e653d65fd16a928ba2677', class: "text-light mb-8 inline-block text-xs leading-tight", "data-name": "prompt-input-hint" }, this.hint_text))), index.h("div", { key: '2adab3967fe4d7ced5dd4dea4d742d0a730b768e', class: containerClass }, index.h("textarea", { key: 'e48f3dcc420c23f4515f0905516aa74775a8c208', class: inputClass, disabled: this.disabled, id: this.inputId, placeholder: this.placeholder, onInput: (event) => this.handleInput(event), onKeyDown: (event) => this.handleKeyDown(event), value: this.value, ref: (el) => (this.textareaEl = el), style: {
                minHeight: '44px',
                maxHeight: this.max_height + 'px',
                overflow: 'auto',
            }, "data-name": "prompt-input" }), index.h("div", { key: '9cc0c49efa67dfea1d2399afe847d13b93ad08d5', class: "flex w-full items-center justify-between gap-1" }, index.h("div", { key: '274b406d8fbcc76dfa5d92213f760f30b61361b4', class: "flex items-center gap-4" }, index.h("slot", { key: '377faeb365d11b3f4808b86d04e9a8aaf6d66d02', name: "actions-left" })), index.h("div", { key: 'a02178af83aed567bdefa22577318c455873d3ce', class: "flex items-center gap-4 self-end" }, index.h("slot", { key: '301c16f9ae22958ac03b9acbd68b233215c578b8', name: "actions-right" }), index.h("at-button", { key: '3329593ae037d9f5b3844d19e48c2525e17f0e15', class: "rounded-lg", size: "sm", type: "secondary", icon: this.in_progress ? 'stop' : 'arrow_upward', disabled: !canSend, onClick: () => this.sendMessage(), onKeyDown: (event) => {
                if (event.key === 'Enter' ||
                    event.key === ' ') {
                    this.sendMessage();
                }
            }, "data-name": "prompt-send-button" })))), index.h("slot", { key: '93acdd3aaf932ac0b0eebac71b927c890ae0ce6d', name: "footer" }), this.invalid && (index.h("span", { key: 'c622b0bdaac19cc30e72b2fad47bccea2848901a', class: "text-error-dark text-xs", "data-name": "error-text" }, this.error_text
            ? this.error_text
...
const AtPromptThread = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '47966a391931f6ad504604dd9edcb80642de7a66', class: "block h-full", "data-name": "thread-container" }, index.h("div", { key: '999a1bea41fee87b618211a7d5d6e79594909ce9', class: "flex h-full flex-col gap-16 overflow-y-auto scroll-smooth", ref: (el) => (this.scrollContainer = el), "data-name": "scroll-container" }, !hasMessages ? (index.h("slot", { name: "thread-empty-state" })) : (index.h("div", { "data-name": "thread-messages-container", class: "flex flex-col gap-16" }, this.renderMessages(), this.renderLoadingIndicator())), index.h("slot", { key: '143b406644a388ce4cf49059f242077605c393d4', name: "thread-messages" }))));
    }
};
