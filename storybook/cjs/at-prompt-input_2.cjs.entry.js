...
const AtPromptInputComponent = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '3b933dc36255f532d9bd8f8a182a930c641072cc', id: this.inputId + '-container', class: "w-full px-16" }, index.h("div", { key: '8531dea5e749e2b28f95d5625b31938ce0568532', class: "flex flex-col" }, index.h("slot", { key: 'd3c462f20d1af090fc6729b9e28738320e4bf5da', name: "label" }), (this.label || this.info_text) && (index.h("at-form-label", { key: '9f66085c2514025136a7bbe91685aea8b3ee6af4', label: this.label, for: this.inputId, info_text: this.info_text, "data-name": "prompt-input-label" })), this.hint_text && (index.h("span", { key: '7a9743f4eb63fe61e4eff5ea6ef445124e769723', class: "text-muted mb-8 inline-block text-xs leading-tight", "data-name": "prompt-input-hint" }, this.hint_text))), index.h("div", { key: '62bddb6a66e034d65e92e96dd20be0d51f77d671', class: containerClass }, index.h("textarea", { key: 'b923cf04ede195ed636cf0132138c19bef4842f9', class: inputClass, disabled: this.disabled, id: this.inputId, placeholder: this.placeholder, onInput: (event) => this.handleInput(event), onKeyDown: (event) => this.handleKeyDown(event), value: this.value, ref: (el) => (this.textareaEl = el), style: {
                minHeight: '44px',
                maxHeight: this.max_height + 'px',
                overflow: 'auto',
            }, "data-name": "prompt-input" }), index.h("div", { key: '7fd507310eebbaff3b7b32a2e2016dd1e622603c', class: "flex w-full items-center justify-between gap-1" }, index.h("div", { key: 'd9a6ca3e01430514d966185ae4a4a9e6e9a02c6c', class: "flex items-center gap-4" }, index.h("slot", { key: '637553248a5bbc94ffc943d1b2fff246fc409ef0', name: "actions-left" })), index.h("div", { key: '0b10e5c2ae27785a5229137a0c9f5d957d23462f', class: "flex items-center gap-4 self-end" }, index.h("slot", { key: '0dce2f8e83f38f12bc8500ef392214533d0943e8', name: "actions-right" }), index.h("at-button", { key: '05e26c0e0e1b8607c5d55dcaace7a7f048e3677b', class: "rounded-lg", size: "sm", type: "secondary", disabled: !canSend, onClick: () => this.sendMessage(), onKeyDown: (event) => {
                if (event.key === 'Enter' ||
                    event.key === ' ') {
                    this.sendMessage();
                }
            }, "data-name": "prompt-send-button" }, index.h("at-icon", { key: '825222ee0e4f065981fc4d25eb54899333e9e61e', slot: "icon", name: this.in_progress ? 'stop' : 'allowUp' }))))), index.h("slot", { key: '3faa95848ea1aa455a4d695fe759f88de9adda04', name: "footer" }), this.invalid && (index.h("span", { key: 'b4ea87641bc5c8b9f5c50e1d916b4fd99bd8a8de', class: "text-error-foreground text-xs", "data-name": "error-text" }, this.error_text
            ? this.error_text
...
const AtPromptThread = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '657160074821b2811a93e0deaf3d5bd10116cc0b', class: "block h-full", "data-name": "thread-container" }, index.h("div", { key: 'a684d7207549d85295270cbacd58e4265606d419', class: "flex h-full flex-col gap-16 overflow-y-auto scroll-smooth", ref: (el) => (this.scrollContainer = el), "data-name": "scroll-container" }, !hasMessages ? (index.h("slot", { name: "thread-empty-state" })) : (index.h("div", { "data-name": "thread-messages-container", class: "flex flex-col gap-16" }, this.renderMessages(), this.renderLoadingIndicator())), index.h("slot", { key: 'f3690535911cadcbedf00b3bf7e9cefe90355615', name: "thread-messages" }))));
    }
};
