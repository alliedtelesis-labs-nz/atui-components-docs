...
const AtPromptInputComponent = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '7fee4ccc7bd8271809488d4ddbb912b40495e600', id: this.inputId + '-container', class: "w-full px-16" }, index.h("div", { key: '0b1e06f52d7c1b39ed127e60d86c03534fc02bbe', class: "flex flex-col empty:hidden" }, index.h("slot", { key: 'ee6eb70bc5099ee1cc01c060c755732ff2fc9170', name: "label" }), (this.label || this.info_text) && (index.h("at-form-label", { key: '2ab4d1d911ccf6e4e4ab11d710cc96c8e77830b6', label: this.label, for: this.inputId, info_text: this.info_text, "data-name": "prompt-input-label" })), this.hint_text && (index.h("span", { key: '9dbf81341b672086670d5cd881af85f9b074ac11', class: "text-muted mb-8 inline-block text-xs leading-tight", "data-name": "prompt-input-hint" }, this.hint_text))), index.h("div", { key: '7dcf2e97b5dd4e96d9e9276e2a0a77bebba492db', class: containerClass }, index.h("textarea", { key: '6b56c88fb447cce4a2718ebcf9448c4000efe495', class: inputClass, disabled: this.disabled, id: this.inputId, placeholder: this.placeholder, onInput: (event) => this.handleInput(event), onKeyDown: (event) => this.handleKeyDown(event), value: this.value, ref: (el) => (this.textareaEl = el), style: {
                minHeight: '44px',
                maxHeight: this.max_height + 'px',
                overflow: 'auto',
            }, "data-name": "prompt-input" }), index.h("div", { key: '264f41dba8dad432a6133bc395d5a10c525ff1e9', class: "flex w-full items-center justify-between gap-1" }, index.h("div", { key: '18e03532b0bbee0259082b87dc0e97ea7f4056df', class: "flex items-center gap-4" }, index.h("slot", { key: '9c3b47770690099efcbd0f9b7ef4fadf50b19d4f', name: "actions-left" })), index.h("div", { key: '2c9897b31ce97bceab6b693ed592ebcc8d5e7f38', class: "flex items-center gap-4 self-end" }, index.h("slot", { key: '18f15cf603c297df6198fe10d82bae9b8cd45a2a', name: "actions-right" }), index.h("at-button", { key: '3d00dd6c103bc68b7524b13681b3db180f132657', class: "rounded-lg", size: "sm", type: "primary", disabled: !canSend, onClick: () => this.sendMessage(), onKeyDown: (event) => {
                if (event.key === 'Enter' ||
                    event.key === ' ') {
                    this.sendMessage();
                }
            }, "data-name": "prompt-send-button" }, index.h("at-icon", { key: 'd354eaa022425f8feffef971139af67557b34311', slot: "icon", name: this.in_progress ? 'stop' : 'send' }))))), index.h("slot", { key: 'dd11c2a93ef4553189be5274ac0d49bf2323adf2', name: "footer" }), this.invalid && (index.h("span", { key: '598ed8180ef3b9dd1ba31dad73c0a312667fd2c9', class: "text-error-foreground text-xs", "data-name": "error-text" }, this.error_text
            ? this.error_text
...
const AtPromptThread = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'bc02d9c7d28e464d7b214be97ea83e3ab592efed', class: "block h-full", "data-name": "thread-container" }, index.h("div", { key: '39b4e09da6fe2f074775bcd63f6e803490cca1d3', class: "flex h-full flex-col gap-16 overflow-y-auto scroll-smooth", ref: (el) => (this.scrollContainer = el), "data-name": "scroll-container" }, !hasMessages ? (index.h("slot", { name: "thread-empty-state" })) : (index.h("div", { "data-name": "thread-messages-container", class: "flex flex-col gap-16" }, this.renderMessages(), this.renderLoadingIndicator())), index.h("slot", { key: '2b9aea8353dfa42c09e0af4768dc928657910db2', name: "thread-messages" }))));
    }
};
