...
const AtCheckbox = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '9923ca518c2c67d29fb928736c85fac2940c8a63', role: "checkbox", "aria-checked": this.checked, "aria-labelledby": this.label ? `${this.value}-label` : undefined, tabindex: 0, class: classname, "data-name": "checkbox-container", onKeyDown: (event) => (event.key === 'Enter' || event.key === ' ') &&
                this.checkboxEl.click(), onClick: () => this.checkboxEl.click() }, index.h("input", { key: '80fcce203749b3459a1b1613abaa4d29a8de9959', type: "checkbox", class: checkboxClassname, "data-name": "checkbox-input", checked: this.checked, onChange: (event) => this.handleChange(event), id: this.value, tabindex: -1, ref: (el) => (this.checkboxEl = el), disabled: this.disabled }), (this.label || this.hint_text) && (index.h("div", { key: 'ad90d0dcbd03f2afd494dff530eb4794ae6ec512', class: "pointer-events-none flex flex-col" }, index.h("slot", { key: '509ceac5fa1aea0e352fdaa89932936dea2153d0', name: "label" }), this.label && (index.h("label", { key: 'ba8a1c1c606a8de1af1bf696345bdebae4dd653c', class: "mt-0 pl-4 text-xs font-medium", id: `${this.value}-label`, "data-name": "checkbox-label" }, this.label)), this.hint_text && (index.h("span", { key: '06be68a4231e6c48fff0f0b2c4a9599dd30d13f5', class: "text-muted mt-0 pl-4 text-xs", "data-name": "checkbox-hint" }, this.hint_text)))), index.h("slot", { key: '9d98aad7b11d15f5a310afc62e9ef0898930059f' })));
    }
};
