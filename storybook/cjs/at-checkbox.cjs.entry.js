...
const AtCheckbox = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '86acbe8deb2f6ab1e9fbbcf03f11cd601504fcfb', role: "checkbox", "aria-checked": this.checked, "aria-labelledby": `${this.value}-label`, tabindex: 0, class: classname, "data-name": "checkbox-container", onKeyDown: (event) => (event.key === 'Enter' || event.key === ' ') &&
                this.checkboxEl.click(), onClick: () => this.checkboxEl.click() }, index.h("input", { key: '09a30dc3f89ac01e3e08daad8726a720b3a71676', type: "checkbox", class: checkboxClassname, "data-name": "checkbox-input", checked: this.checked, onChange: (event) => this.handleChange(event), id: this.value, tabindex: -1, ref: (el) => (this.checkboxEl = el), disabled: this.disabled }), (this.label || this.hint_text) && (index.h("div", { key: '86ca809cd8bc0ed561c72be070d1ce8ab4aee4de', class: "pointer-events-none flex flex-col" }, index.h("slot", { key: 'ae3b76e7d6c0dee305fcf23fd0abdac2a6a66c97', name: "label" }), this.label && (index.h("label", { key: 'b0e48869e27c1a0cf5978289baf190cff9145f99', class: "mt-0 pl-4 text-xs font-medium", id: `${this.value}-label`, "data-name": "checkbox-label" }, this.label)), this.hint_text && (index.h("span", { key: '5f98a62e7b326d8be1813ac3dff700a97bd55f54', class: "text-muted mt-0 pl-4 text-xs", "data-name": "checkbox-hint" }, this.hint_text)))), index.h("slot", { key: 'ea21477b14557a2ab66ac96e77e1b82f06f2777a' })));
    }
};
