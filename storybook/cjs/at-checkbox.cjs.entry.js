...
const AtCheckbox = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '127b3f5ecaa3edc1b758e30ff7f12ba46c6de4df', role: "checkbox", "aria-checked": this.checked, "aria-labelledby": `${this.value}-label`, tabindex: 0, class: classname, "data-name": "checkbox-container", onKeyDown: (event) => (event.key === 'Enter' || event.key === ' ') &&
                this.checkboxEl.click(), onClick: () => this.checkboxEl.click() }, index.h("input", { key: 'aed6b379158803eb77b68669a61ef78eb5daba96', type: "checkbox", class: checkboxClassname, "data-name": "checkbox-input", checked: this.checked, onChange: (event) => this.handleChange(event), id: this.value, tabindex: -1, ref: (el) => (this.checkboxEl = el), disabled: this.disabled }), (this.label || this.hint_text) && (index.h("div", { key: '372eb10508dfd6133cb4adb3e92be132e118fd27', class: "pointer-events-none flex flex-col" }, index.h("slot", { key: '25dd1701036e82568300dc419daa68a80794e052', name: "label" }), this.label && (index.h("label", { key: '7b9733dcbf27467baf4b14434631c6498488486a', class: "mt-0 pl-4 text-xs font-medium", id: `${this.value}-label`, "data-name": "checkbox-label" }, this.label)), this.hint_text && (index.h("span", { key: '704a67c8a8ddd45cb7857a9e9546af81d638723d', class: "text-muted mt-0 pl-4 text-xs", "data-name": "checkbox-hint" }, this.hint_text)))), index.h("slot", { key: '59920fbfa44de556f1f604a3c22acd29da8203ed' })));
    }
};
