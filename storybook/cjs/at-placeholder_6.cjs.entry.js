...
const AtTableFilterMenu = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'dd245788957e05095a136093212ba57e5aec0e10' }, index.h("at-menu", { key: '7b4b6c5ce7174f79078df2a8571bb46ee3c59ad6', autoclose: false, width: "fit-content", class: "self-start", align: "end" }, index.h("at-tooltip", { key: '87a5adef3c2c21fe5dbfcd2bc4955b2fa1988415', slot: "menu-trigger", position: "top" }, index.h("at-button", { key: 'e6fd4760fabcfd04aa53bc2831919bffa85c8717', slot: "tooltip-trigger", type: "secondaryOutline", icon: "filter_list" }), index.h("span", { key: '09f9ea58bd1c1b4306d4c3b26deb65b55538c797' }, this.translations.ATUI.TABLE.FILTER_DATA)), index.h("div", { key: '0b3e4397f976ca5df2078d04ff7bbf7107f5fc6b', class: "flex flex-col" }, index.h("at-checkbox-group", { key: 'ac98e3ba3d1a038714602d0295a941c592968200', class: "w-fit", options: this.filteredColumns, value: this.selected, onAtuiChange: (event) => this.handleColumnSelect(event) })))));
    }
