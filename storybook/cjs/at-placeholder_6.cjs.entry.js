...
const AtTablePagination = class {
    ...
    atPageSizeChange;
    render() {
        return (index.h(index.Host, { key: 'f12297b29b9c9f2806a177378a47574deead1808', class: "mt-8 flex items-center justify-end gap-8" }, index.h("span", { key: '1b004a2b7026936af5e5cf7a2bb01c2c2a719d2d' }, "Page Size: "), index.h("at-select", { key: '9d295eea66703025ba4fca31ed2e71277f1d2337', options: this.page_size_options, value: String(this.page_size), clearable: false, onAtuiChange: (event) => this.atPageSizeChange.emit(parseInt(event.detail)) }), index.h("at-button", { key: 'e58ed503cbb9c9d9d8373f6db4a896bb2de4774d', disabled: this.current_page === 1, type: "secondaryText", icon: "first_page", onAtuiClick: () => this.atChange.emit(1) }), index.h("at-button", { key: '010a732eeb5615778a835e20d4d1503dcb1565b5', disabled: this.current_page === 1, type: "secondaryText", icon: "chevron_left", onAtuiClick: () => this.atChange.emit(this.current_page - 1) }), index.h("span", { key: 'd4e8d3ad39de62e25c7cd48cbbfed32a35db22d7' }, "Page ", this.current_page, " of ", this.num_pages), index.h("at-button", { key: '39a6d34ce782b9e2d15f3a859b7ab9cd9b53231b', disabled: this.current_page === this.num_pages, type: "secondaryText", icon: "chevron_right", onAtuiClick: () => this.atChange.emit(this.current_page + 1) }), index.h("at-button", { key: '2df61153213862155e1dc1b2b6b2a298a5f0e44b', disabled: this.current_page === this.num_pages, type: "secondaryText", icon: "last_page", onAtuiClick: () => this.atChange.emit(this.num_pages) })));
    }
};
