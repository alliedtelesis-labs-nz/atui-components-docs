...
const AtPlaceholderComponent = class {
    ...
    render() {
        return (index.h("div", { key: '2a679337f5be6e2b2d4a187d2958f382885479dd', class: `${this.placeholderSizeClass} bg-surface-0 text-med flex w-full items-center gap-16 rounded-sm text-center`, "data-name": "placeholder-container" }, this.icon && this.icon !== 'none' && (index.h("span", { key: '0353fe46c384bd825c8c7c372fa40be8c996bf56', class: `material-icons text-slate-300 ${this.iconSizeClass}`, "data-name": "placeholder-icon" }, this.icon)), index.h("div", { key: '2d407b8401a0e1aee869501e6b91d81237eff250', class: `border-radius-sm flex flex-col justify-center ${this.size === 'xs' ? 'items-start text-left' : 'items-center text-center'}` }, index.h("div", { key: '3e65e69f5b71355bb772ff8a219a19748c1326ac', class: "flex items-center" }, this.show_loading_spinner && (index.h("at-loading", { key: '8144434eedc1a163f892b44c9b277263479639f2', class: "relative mr-8", size: "sm", type: "secondary", "data-name": "placeholder-spinner" })), this.placeholder_title && (index.h("h5", { key: 'dd7707a0d46d49b29ea7f2746f96517aa88c8e1e', class: "text-med text-sm font-medium", "data-name": "placeholder-title" }, this.placeholder_title))), index.h("p", { key: '3979fff4218223f6490f281a5066c81fbfa9bf5a', class: "text-med text-sm", "data-name": "placeholder-content" }, this.content), index.h("slot", { key: '0e5448b39eb37795e6b46bcb03b0fd95f8de4528' }))));
    }
};
...
const AtSearch = class {
    ...
    render() {
        return (index.h("div", { key: 'c07be93db801a2b885ab90b3e5675b26ac58e0ca' }, (this.label || this.info_text) && (index.h("at-form-label", { key: '7d1541e5f5144dd85fb97dae7e064b80a397a305', label: this.label, for: this.label
                ...
                : undefined, info_text: this.info_text })), index.h("div", { key: '9e0f2279418d8758b3f153784785f59b378bd6a4', class: "active-within:border-active-dark transition[background-color,color,box-shadow] border-med bg-surface-0 focus-within:border-active-dark focus-within:ring-active-foreground/40 relative flex h-[36px] flex-row items-center justify-center rounded-md border duration-300 ease-in-out focus-within:ring-2" }, index.h("span", { key: '55ce6d62ac63d009377a6a64cb3f90ecbfde38f0', class: "px-8" }, index.h("at-icon", { key: '456ad806cac0f6ee875e0f78b7bf2b4fc8a9a84e', class: "fill-light", name: "search" })), index.h("input", { key: 'e5d7639bc249c4d285a5b6cce008602c3015b3fa', id: this.label
                ? `search-input-${this.label.replace(/\s+/g, '-').toLowerCase()}`
                : undefined, role: "searchbox", tabindex: "0", class: "mr-24 h-30 w-full bg-transparent p-0 leading-[30px] focus:border-none focus:outline-none", placeholder: this.placeholder, value: this.model, autocomplete: "off", name: "search", onInput: () => this.onChangeFn(), ref: (el) => (this.searchEl = el) }), index.h("div", { key: '9d9025651796e7b8da9cdaf2672d6b1fa8c337c6', class: `transition-all duration-300 ease-in-out ${this.model !== '' && this.model !== undefined
                ? 'pr-4 opacity-100'
                : 'pointer-events-none pr-0 opacity-0'}` }, index.h("at-button", { key: 'b0870844cf159ecde2fb11423c535aa0dba1f24c', size: "sm", type: "secondaryText", onClick: () => this.clearFn(), "data-name": "search-clear", tabindex: this.model !== '' && this.model !== undefined
                ? '0'
                : '-1' }, index.h("at-icon", { key: '0f4cee43547468b995d2ca9c89dc60ad59f03359', slot: "icon", name: "backspace" })))), index.h("span", { key: '8dd3468d21a22056a82633507d41bb15872d37fb', class: "text-med mt-4 truncate text-xs !leading-normal font-normal", "data-name": "search-hint" }, this.hint_text)));
    }
};
...
const AtTableFilters = class {
    ...
    render() {
        return (this.col_defs && (index.h(index.Host, { key: 'cc62d7c295a1dd5e41b37c75794cd0dca9710714', class: "flex items-start gap-8" }, this.selected.length > 0 && (index.h("div", { key: '7e484eabc623746153ec74480da9698b552af515', class: "bg-surface-0 flex min-h-[36px] flex-wrap items-end gap-8 rounded-md p-8" }, this.selected.map((column) => (index.h("div", { class: "flex items-center gap-2" }, index.h("at-input", { class: "w-input-sm", label: column.id, prefix: column.id + ': ', value: column.value, onAtuiChange: (event) => this.filterChangeHandler(event, column.id) }, index.h("div", { slot: "input-actions" }, index.h("at-button", { type: "secondaryText", size: "sm", onClick: () => this.clearSingleFilter(column.id), "data-name": `filter-clear-${column.id}` }, index.h("at-icon", { slot: "icon", name: "cancel" }))))))), index.h("at-button", { key: 'f7d6a3ec0bbc18c0e5d5ec6965372370a29f8798', type: "secondaryText", label: "Clear All", onClick: this.clearFilters, "data-name": "filter-clear-all" }))))));
    }
};
