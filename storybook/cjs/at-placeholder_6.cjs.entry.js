...
const AtPlaceholderComponent = class {
    ...
    render() {
        return (index.h("div", { key: '99304a756301d6519bdd7413aa784181ba1f791c', class: `${this.placeholderSizeClass} bg-surface-0 text-med flex w-full items-center gap-16 rounded-sm text-center`, "data-name": "placeholder-container" }, this.icon && this.icon !== 'none' && (index.h("span", { key: 'c5f9ec845801199c8700427e1fa7127ebeaf7cfc', class: `material-icons text-slate-300 ${this.iconSizeClass}`, "data-name": "placeholder-icon" }, this.icon)), index.h("div", { key: 'c6ddae710e9aca4dec5c5f9ecab57d9d2c590e86', class: `border-radius-sm flex flex-col justify-center ${this.size === 'xs' ? 'items-start text-left' : 'items-center text-center'}` }, index.h("div", { key: '36826ba3ca6f874efd0d8f6ba34b869dfd7d3582', class: "flex items-center" }, this.show_loading_spinner && (index.h("at-loading", { key: '41220b771932600b05088565e86140c33ea39274', class: "relative mr-8", size: "sm", type: "secondary", "data-name": "placeholder-spinner" })), this.placeholder_title && (index.h("h5", { key: '0276404e5f7063699f69038eb1fa3fa08f136147', class: "text-med text-sm font-medium", "data-name": "placeholder-title" }, this.placeholder_title))), index.h("p", { key: '1c27e8da7bdcf2d8201110127724c5d9abbb620f', class: "text-med text-sm", "data-name": "placeholder-content" }, this.content), index.h("slot", { key: 'ab5d19a5cc789cd10c3f8528701280e43f8c978e' }))));
    }
};
...
const AtSearch = class {
    ...
    render() {
        return (index.h("div", { key: 'dc6e629d3190eb3781d4295c4e7df9edad461a87' }, (this.label || this.info_text) && (index.h("at-form-label", { key: 'befd05d28ced04aaecad147a4d9e43f316a69dd9', label: this.label, for: this.label
                ? `search-input-${this.label.replace(/\s+/g, '-').toLowerCase()}`
                : undefined, info_text: this.info_text })), index.h("div", { key: 'd84f08a78c01137d0492090225826910aed801d4', class: "active-within:border-active-dark transition[background-color,color,box-shadow] border-med bg-surface-0 focus-within:border-active-dark focus-within:ring-active-foreground/40 relative flex h-[36px] flex-row items-center justify-center rounded-md border duration-300 ease-in-out focus-within:ring-2" }, index.h("span", { key: '951f6f8ae94bc9b59cce45c0609dea188be615c2', class: "px-8" }, index.h("i", { key: 'ce92ac294bcc73a9786ce431b838f3ceeb18873d', class: "material-icons text-light !text-[16px] !leading-[30px]" }, "search")), index.h("input", { key: 'd5336177e63e8ceecfe23fe3487ab9b16477b167', id: this.label
                ? `search-input-${this.label.replace(/\s+/g, '-').toLowerCase()}`
                : undefined, role: "searchbox", tabindex: "0", class: "mr-24 h-30 w-full bg-transparent p-0 leading-[30px] focus:border-none focus:outline-none", placeholder: this.placeholder, value: this.model, autocomplete: "off", name: "search", onInput: () => this.onChangeFn(), ref: (el) => (this.searchEl = el) }), index.h("div", { key: '44c3bf2c94e728f3d01afd56ff10905b66d1bd43', class: `transition-all duration-300 ease-in-out ${this.model !== '' && this.model !== undefined
                ? 'pr-4 opacity-100'
                : 'pointer-events-none pr-0 opacity-0'}` }, index.h("at-button", { key: 'b436d53ffd2ed9f99c093b2d6f9a80a7134928e2', size: "sm", type: "secondaryText", icon: "backspace", onClick: () => this.clearFn(), "data-name": "search-clear", tabindex: this.model !== '' && this.model !== undefined
                ? '0'
                : '-1' }))), index.h("span", { key: 'ff3eaa49a2e5052fdd75a4d7fb93b1e809d99764', class: "text-med mt-4 truncate text-xs !leading-normal font-normal", "data-name": "search-hint" }, this.hint_text)));
    }
};
