...
const AtTablePagination = class {
    ...
    atPageSizeChange;
    render() {
        return (index.h(index.Host, { key: '2fa760f9e10aaf7a00f825fdb644b18091f88f43', class: "mt-8 flex items-center justify-end gap-8" }, index.h("span", { key: '4985e859b7e13b8b464a3b3e21d2b25968d963c0' }, "Page Size: "), index.h("at-select", { key: '3f8ea394b17f66bf24943788b312385db67a698c', options: this.page_size_options, value: String(this.page_size), clearable: false, onAtuiChange: (event) => this.atPageSizeChange.emit(parseInt(event.detail)) }), index.h("at-button", { key: '64e884d42b2a22fb28191478479e7fe9b1979494', disabled: this.current_page === 1, type: "secondaryText", icon: "first_page", onAtuiClick: () => this.atChange.emit(1) }), index.h("at-button", { key: '2273e61aa5626c04ef865d5b924569422e1c774b', disabled: this.current_page === 1, type: "secondaryText", icon: "chevron_left", onAtuiClick: () => this.atChange.emit(this.current_page - 1) }), index.h("span", { key: 'e4db658bf92392cd43cdc5d1a257b8acacc02bbf' }, "Page ", this.current_page, " of ", this.num_pages), index.h("at-button", { key: '90c4273f32575c8d73487e1f39e6e1983ebcbb0b', disabled: this.current_page === this.num_pages, type: "secondaryText", icon: "chevron_right", onAtuiClick: () => this.atChange.emit(this.current_page + 1) }), index.h("at-button", { key: 'df2129cad0bdc3244755c263f2ec2aeced214db7', disabled: this.current_page === this.num_pages, type: "secondaryText", icon: "last_page", onAtuiClick: () => this.atChange.emit(this.num_pages) })));
    }
};
