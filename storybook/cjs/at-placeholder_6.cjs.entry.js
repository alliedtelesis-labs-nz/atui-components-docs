...
const AtTableFilterMenu = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'b40480d2b227e039a8f8a50b9614e19c70940f06' }, index.h("at-menu", { key: '82b134a5f8cd310875b6847f79667bfbd9fa2115', autoclose: false, width: "fit-content", class: "self-start", align: "end" }, index.h("at-tooltip", { key: '769d1511c41dc3698ff57a4f740d30cfe62b1c98', slot: "menu-trigger", position: "top" }, index.h("at-button", { key: '604e05fc0ebecc1eba2ea213f1af118d03a03921', slot: "tooltip-trigger", type: "secondaryOutline", icon: "filter_list" }), index.h("span", { key: 'b1ceafafd55db7dd0bd05a4c2558a573954fd11b' }, this.translations.ATUI.TABLE.FILTER_DATA)), index.h("div", { key: '231eab32c48607da431d8ef494703e06bd3fd4e6', class: "flex flex-col" }, index.h("at-checkbox-group", { key: 'db118b075a181d7bd0cefffe0423b3efa595c14c', class: "w-fit", options: this.filteredColumns, value: this.selected, onAtuiChange: (event) => this.handleColumnSelect(event) })))));
    }
...
const AtTablePagination = class {
    ...
    atPageSizeChange;
    render() {
        return (index.h(index.Host, { key: 'c466df596fad0a96b61b9bb9d2b54bb34450fd5f', class: "mt-8 flex items-center justify-end gap-8" }, index.h("span", { key: '547a6740d90584c73d45afd1bd4c2f26599886cd' }, "Page Size: "), index.h("at-select", { key: 'a21d7276813103bd52ce81cac6eea82c8259434d', options: this.page_size_options, value: String(this.page_size), clearable: false, onAtuiChange: (event) => this.atPageSizeChange.emit(parseInt(event.detail)) }), index.h("at-button", { key: '083313e1f3e9ae47cd454a5d4de8eeab7532095e', disabled: this.current_page === 1, type: "secondaryText", icon: "first_page", onAtuiClick: () => this.atChange.emit(1) }), index.h("at-button", { key: '7ccb91269878a874f9c46b093cbabdb0ef6d2655', disabled: this.current_page === 1, type: "secondaryText", icon: "chevron_left", onAtuiClick: () => this.atChange.emit(this.current_page - 1) }), index.h("span", { key: '84e782ed13420937d62d7bf2a6865935c8dc96e5' }, "Page ", this.current_page, " of ", this.num_pages), index.h("at-button", { key: 'fe8edeab14e5c43e2468160bcac1e87fb62ef9ad', disabled: this.current_page === this.num_pages, type: "secondaryText", icon: "chevron_right", onAtuiClick: () => this.atChange.emit(this.current_page + 1) }), index.h("at-button", { key: '3d38bfa3dfb8149c3f37ead19e3bdc5cc94967f9', disabled: this.current_page === this.num_pages, type: "secondaryText", icon: "last_page", onAtuiClick: () => this.atChange.emit(this.num_pages) })));
    }
};
