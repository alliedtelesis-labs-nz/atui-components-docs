...
const AtResizableGroupComponent = class {
    constructor(hostRef) {
        ...
        this.atuiResizableChange = index.createEvent(this, "atuiResizableChange", 7);
    }
    ...
    componentWillLoad() {
        this.controller = new resizeController.ResizeController({
...
exports.at_resizable_group = AtResizableGroupComponent;
