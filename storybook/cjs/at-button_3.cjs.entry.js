...
const AtButtonComponent = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'f0bf2504a53c2864937a566bd228ced866577163', class: classname, role: "button", tabIndex: 0, onKeyDown: (event) => this.handleKeyDown(event), onClick: (event) => this.handleClick(event) }, index.h("div", { key: '6cf8ddeccb39f6579b32036ef98a0b37e42f54a6', class: "z-20 flex h-full w-full items-center justify-center gap-4" }, this.in_progress && (index.h("at-loading", { key: 'faed0f2e0009d9969b445b92641bd70994855ae4', class: "absolute", size: "sm", type: this.spinnerColour })), index.h("slot", { key: '2aaef0e5533a51463317182bc42ed05fcd1e0546', name: "icon" }), this.icon && (index.h("span", { key: 'f64a2a1ac68e69f67c8a1c3fa45fc14e9544bfd3', class: `material-icons !text-icon-md h-16 w-16 leading-[16px] ${this.in_progress ? 'invisible' : 'visible'}`, "data-name": "button-icon" }, this.icon)), this.label && (index.h("span", { key: 'f35d20793fbd4e8c4a43411dfaf60be1fd9fe348', class: `leading-[16px] ${this.in_progress ? 'invisible' : 'visible'}`, "data-name": "button-label" }, this.label)), index.h("slot", { key: 'c6e31bd844cd90ff6cea353a58f14899200a7bb9' }), index.h("slot", { key: '06d19716f9bc3452cd157fb6348e95fa678c24cd', name: "icon_after" }), this.icon_after && (index.h("span", { key: '1ca0196762ff9ea3bb8aa045b9163420a77e43cd', class: `material-icons !text-icon-md h-16 w-16 leading-[16px] ${this.in_progress ? 'invisible w-0' : 'visible'}`, "data-name": "button-icon-right" }, this.icon_after))), index.h("div", { key: 'e5efb6ac4e3067dc61013dfdeda515f745ddf294', "data-name": "focus-indicator", role: "presentation", class: focusIndicatorClassname })));
    }
};
