...
const AtAccordionItemComponent = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '3ffeecdea08438a6c838240e3689a47ce4bf637a', "data-name": this.item_id, "data-state": this.open ? 'expanded' : 'collapsed' }, index.h("details", { key: 'c72c526784e0291a8cad2f03eb8983f1dd817b5e', class: "group/accordion-item", role: "group", open: this.detailsOpen, ref: (el) => (this.detailsEl = el) }, index.h("summary", { key: '64065b839ab3ebaa0ac85905fd0da677ecdb9978', id: `trigger-${this.item_id}`, role: "button", "aria-expanded": this.open, "aria-disabled": this.disabled ? 'true' : undefined, "data-state": this.open ? 'expanded' : 'collapsed', class: classname, onClick: (event) => this.handleSummaryInteraction(event), onTouchEnd: (event) => this.handleSummaryInteraction(event), onKeyDown: (event) => {
                if (event.key === 'Enter' || event.key === ' ') {
                    this.handleSummaryInteraction(event);
                }
            }, "aria-controls": `content-${this.item_id}` }, this.label && (index.h("at-accordion-trigger", { key: '5ca1b7e2001c37bc05b84678469e62f7be85795b', label: this.label })), index.h("slot", { key: '60cac22002d186ef7b5cdafadb80ea38f3adcad6', name: "accordion-trigger" })), index.h("div", { key: '6fe4463a4b122ac069d71bc131c5c0835644649f', id: `content-${this.item_id}`, "aria-labelledby": `trigger-${this.item_id}`, "data-state": this.open ? 'expanded' : 'collapsed', "data-name": "accordion-item-content" }, this.content && (index.h("div", { key: 'fc0519bc06ce0c9bd1fcbeec9327219f2910276b', class: "flex flex-col p-16 leading-normal" }, this.content)), index.h("slot", { key: 'd7b3a94337c8804733f5bf0129105ef319a7f628' })))));
    }
...
const AtAccordionTriggerComponent = class {
    ...
    label;
    render() {
        return (index.h(index.Host, { key: 'b102b15f3b94f750685d5a6d02b89286ac4da215', class: "group flex flex-1 items-center justify-between p-8", "data-name": "accordion-trigger" }, this.label && (index.h("span", { key: '3fc9b51b42675c4a2a3acc7cd32094682112d8d3', class: "flex flex-grow truncate text-sm font-medium group-hover:underline" }, this.label)), index.h("slot", { key: 'fa5b836cee4df62060de6aee13db7dda1bd8997b' }), index.h("at-icon", { key: 'bde8f54d4c04a016c36b2bf9f6feba9902b8f30d', role: "presentation", "aria-hidden": "true", class: "fill-light group-data-[state=expanded]/accordion-item:rotate-180", name: "chevron_down" })));
    }
};
