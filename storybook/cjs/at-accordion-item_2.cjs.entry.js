...
const AtAccordionItemComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: '5727b763ace551d58b4171a35e5328d9638e1667', "data-name": this.item_id, "data-state": this.open ? 'expanded' : 'collapsed' }, index.h("details", { key: 'dc016406de8ee5f209e5b670efc7a9b3f6dbd035', class: `group/accordion-item'}`, ref: (el) => (this.accordionElement = el), role: "group", open: this.open }, index.h("summary", { key: '38361710c0576b6f5adac1a53fde85c13fad6d3f', id: `trigger-${this.item_id}`, role: "button", "aria-expanded": this.open, "data-state": this.open ? 'expanded' : 'collapsed', class: "group/accordion-item focus-within:ring-active-foreground/40 flex rounded-sm outline-0 focus-within:ring-2", onClick: (event) => this.handleSummaryInteraction(event), onTouchEnd: (event) => this.handleSummaryInteraction(event), "aria-controls": `content-${this.item_id}` }, this.label && (index.h("at-accordion-trigger", { key: 'c04ea80775f2afc875191f20233568766d55dac5', label: this.label })), index.h("slot", { key: '8b91a1b23669201b019f6c5d07c1c013ae7211ba', name: "accordion-trigger" })), index.h("div", { key: '3fd5d21c2816394269650ac2f9eef0943a246c5f', id: `content-${this.item_id}`, "aria-labelledby": `trigger-${this.item_id}`, hidden: !this.open, "data-name": "accordion-item-content" }, this.content && (index.h("div", { key: '4805fed545394bb51dbf416853bba212f7113833', class: "flex flex-col p-16 leading-normal" }, this.content)), index.h("slot", { key: 'cbcc8bbf24611a2fde725bac8d038c131c377953' })))));
    }
};
