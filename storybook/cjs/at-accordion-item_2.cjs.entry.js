...
const AtAccordionItemComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: '9baac999cea4fb4d442a08e3c93f6e9d383a984d', "data-name": this.item_id, "data-state": this.open ? 'expanded' : 'collapsed' }, index.h("details", { key: '694e19f1fa012de01b1d67651c4e6660825ddad9', class: `group/accordion-item'}`, ref: (el) => (this.accordionElement = el), role: "group", open: this.open }, index.h("summary", { key: '499e578c5765af1c2ccb244fdc767a81d872c3e8', id: `trigger-${this.item_id}`, role: "button", "aria-expanded": this.open, "data-state": this.open ? 'expanded' : 'collapsed', class: "group/accordion-item focus-within:ring-active-glow flex rounded-sm outline-0 focus-within:ring", onClick: (event) => this.handleSummaryInteraction(event), onTouchEnd: (event) => this.handleSummaryInteraction(event), "aria-controls": `content-${this.item_id}` }, this.label && (index.h("at-accordion-trigger", { key: 'ff15a05eac7efed3aa71de743ab7926d495525f6', label: this.label })), index.h("slot", { key: 'eaa2b303a539eed2915fbac34f2fc165255fe00a', name: "accordion-trigger" })), index.h("div", { key: '81540afaef9fd17ad6f11484afbdf5a63797c76f', id: `content-${this.item_id}`, "aria-labelledby": `trigger-${this.item_id}`, hidden: !this.open, "data-name": "accordion-item-content" }, this.content && (index.h("div", { key: '6841cdab605d4c65c6c5a3d1e4e2573d527e4ccf', class: "flex flex-col p-16 leading-normal" }, this.content)), index.h("slot", { key: '43ff8b8063d0689b5ef8ff2cbf8405cc8b4ba718' })))));
    }
};
