...
const AtSearch = class {
    ...
    render() {
        return (index.h("div", { key: '0b6b06a5d5961502a5708211e27773f7ce29088c' }, (this.label || this.info_text) && (index.h("at-form-label", { key: 'c2fa0a14e7f6334f1f3b858a650aa851c6fa4b2d', label: this.label, for: this.label
                ...
                : undefined, info_text: this.info_text })), index.h("div", { key: 'e1a93052f772cfbc69b87385847fdefcc3c13f6e', class: "active-within:border-active-dark transition[background-color,color,box-shadow] border-med bg-surface-0 focus-within:border-active-dark focus-within:ring-active-foreground/40 relative flex h-[36px] flex-row items-center justify-center rounded-md border duration-300 ease-in-out focus-within:ring-2" }, index.h("span", { key: '0d65b029fb430adbfb2fa56950880007fb1f1687', class: "px-8" }, index.h("i", { key: '91832c550295aa654370a0e07f51772058ced9a0', class: "material-icons text-light !text-[16px] !leading-[30px]" }, "search")), index.h("input", { key: '8b788faec855bae92e820d9d58b38e5f634cc59b', id: this.label
                ? `search-input-${this.label.replace(/\s+/g, '-').toLowerCase()}`
