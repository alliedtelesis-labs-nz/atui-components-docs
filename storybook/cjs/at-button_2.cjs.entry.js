...
const AtButtonComponent = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'e99bccaa16fae73525fbbcd8d2684614a97dc0e4', class: classname, role: "button", tabIndex: 0, onKeyDown: (event) => this.handleKeyDown(event), onClick: (event) => this.handleClick(event) }, index.h("div", { key: '0340166cae1cee86d048222cc72c97d49863b3b7', class: "z-20 flex h-full w-full items-center justify-center gap-4" }, this.in_progress && (index.h("at-loading", { key: 'b4596bd664f41ab3adf1c8394a9e944014df6928', class: "absolute", size: "sm", type: this.spinnerColour })), index.h("slot", { key: '13e1edf28684a2641235df72033c1d88b59c587b', name: "icon" }), this.icon && (index.h("span", { key: '0aae629069384e133bd909ca3ebf9eb9f9c0c5bb', class: `material-icons !text-icon-md h-16 w-16 leading-[16px] ${this.in_progress ? 'invisible' : 'visible'}`, "data-name": "button-icon" }, this.icon)), this.label && (index.h("span", { key: '6ebc60af83a34d57be829b366903325c303f037a', class: `leading-[16px] ${this.in_progress ? 'invisible' : 'visible'}`, "data-name": "button-label" }, this.label)), index.h("slot", { key: '12ec7cb6196b07d9f9e5bd5a022f9879d7c0b82f' }), index.h("slot", { key: '9006fd47d96e5c495357e1152e18366f20711719', name: "icon_after" }), this.icon_after && (index.h("span", { key: '37231bee8f317e22adeefc4fac6ead6cbf28789c', class: `material-icons !text-icon-md h-16 w-16 leading-[16px] ${this.in_progress ? 'invisible w-0' : 'visible'}`, "data-name": "button-icon-right" }, this.icon_after))), index.h("div", { key: '2f7f4a12ff4b2624c3b0e54936e480697702d426', "data-name": "focus-indicator", role: "presentation", class: focusIndicatorClassname })));
    }
};
