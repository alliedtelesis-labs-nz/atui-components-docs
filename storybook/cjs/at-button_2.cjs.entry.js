...
const AtButtonComponent = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'ac9c033cffff5ad2224c0ed8a2513f01171ada3e', class: classname, role: "button", tabIndex: 0, onKeyDown: (event) => this.handleKeyDown(event), onClick: (event) => this.handleClick(event) }, index.h("div", { key: '520c950250cf924ad3d0f0e9ffb9810d884bb283', class: "z-20 flex h-full w-full items-center justify-center gap-4" }, this.in_progress && (index.h("at-loading", { key: '0bf76e7df4a6f29ca2d45fc22f7c298e4c424fec', class: "absolute", size: "sm", type: this.spinnerColour })), index.h("slot", { key: 'f44e1c7cc27f3105f115dd62107b60afd1a960ef', name: "icon" }), this.icon && (index.h("span", { key: '9a14196eee8e80ab1efa32bd374b86dcbde37700', class: `material-icons !text-icon-md h-16 w-16 leading-[16px] ${this.in_progress ? 'invisible' : 'visible'}`, "data-name": "button-icon" }, this.icon)), this.label && (index.h("span", { key: '678aae5c603d7948aae628cd67f2db4bcf30c4b4', class: `leading-[16px] ${this.in_progress ? 'invisible' : 'visible'}`, "data-name": "button-label" }, this.label)), index.h("slot", { key: 'b0d18e20ad391f86e42c0aa30e278b770b9dfa2a' }), index.h("slot", { key: '348ef0cb84a985b32b824303e219c7f5fc5935ad', name: "icon_after" }), this.icon_after && (index.h("span", { key: '2451182675d4331fbfac0b20e96592eec85ca63a', class: `material-icons !text-icon-md h-16 w-16 leading-[16px] ${this.in_progress ? 'invisible w-0' : 'visible'}`, "data-name": "button-icon-right" }, this.icon_after))), index.h("div", { key: '9096e85bacf142d3bc8c9ef0d61705203186331b', "data-name": "focus-indicator", role: "presentation", class: focusIndicatorClassname })));
    }
};
