...
const AtButtonComponent = class {
    ...
    render() {
        const classname = classlist.classlist('at-button group relative box-border flex inline-flex cursor-pointer items-center justify-center gap-4 overflow-hidden rounded-button font-medium whitespace-nowrap transition-[background-color,color,box-shadow,border-color] duration-150 ease-in-out outline-none focus:outline-none', buttonVariantsConfig)({
        ...
        return (index.h(index.Host, { key: '7a4419c610b087e6ffaa1e0be881a9339b977177', class: classname, role: "button", tabIndex: this.disabled ? -1 : 0, "aria-disabled": this.disabled ? 'true' : undefined, onKeyDown: (event) => this.handleKeyDown(event), onClick: (event) => this.handleClick(event) }, index.h("div", { key: 'b4fc88a8f3b892ab185db4dc988d1892b38477df', class: "z-20 flex h-full w-full items-center justify-center gap-4" }, this.in_progress && (index.h("at-loading", { key: '75d63f1d997fed36ae2a4a0dc238264b7554c544', class: "absolute", size: "sm", type: this.spinnerColour })), !this.in_progress && (index.h("slot", { key: 'd854197b828a01c2d053b886f05b8fe5b20d1fc1', name: "icon", "data-name": "button-icon" })), this.label && (index.h("span", { key: '2e8fbc311ac5d477a0720ba525d418b79e535c9d', class: `leading-[16px] ${this.in_progress ? 'invisible' : 'visible'}`, "data-name": "button-label" }, this.label)), index.h("slot", { key: '6677dc1c3b79304533d4533a505e8b40bfb2bf78' }), !this.in_progress && (index.h("slot", { key: '314254fd43e486abb14f9bb3ce96a631a3a09b33', name: "icon_after", "data-name": "button-icon-right" }))), index.h("div", { key: '68be17bf7df0dffcf83e6d22f9ab7442ce33b525', "data-name": "focus-indicator", role: "presentation", class: focusIndicatorClassname })));
    }
};
...
const AtLoadingComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: '12f5109a4f8a8b4beee4f67f460a0588cb4cd03e', class: `${this.sizeClasses} inline-flex items-center gap-8`, role: "status", "aria-label": this.variant === 'typing' ? 'Typing' : 'Loading' }, this.renderIndicator(), index.h("slot", { key: 'dbe3445551e7f24cb85ef24fac4d7c148a74cb25' })));
    }
};
