...
const AtButtonComponent = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '29907a15cfaab16f2b5120ab0d75ce48649dee48', class: classname, role: "button", tabIndex: 0, onKeyDown: (event) => this.handleKeyDown(event), onClick: (event) => this.handleClick(event) }, index.h("div", { key: '3afd959690d29caf93f9b957d9fd6dd579bf4673', class: "z-20 flex h-full w-full items-center justify-center gap-4" }, this.in_progress && (index.h("at-loading", { key: '98ccf8f3612164f5ffc268a4c7b6b5a016ad9952', class: "absolute", size: "sm", type: this.spinnerColour })), index.h("slot", { key: 'fe6dbeafa0768b9413f9416ce8dd955ca0b2b54f', name: "icon" }), this.icon && (index.h("span", { key: 'f7d3d7a80dc24fb9489ffac1115e79d688af7750', class: `material-icons h-16 w-16 text-[16px] leading-[16px] ${this.in_progress ? 'invisible' : 'visible'}`, "data-name": "button-icon" }, this.icon)), this.label && (index.h("span", { key: '5a27c5961710aa8954b517c2dc306a404b004efc', class: `leading-[16px] ${this.in_progress ? 'invisible' : 'visible'}`, "data-name": "button-label" }, this.label)), index.h("slot", { key: '26648bef89114431429594f5c90a51d4cdf15012' }), index.h("slot", { key: '461cf1ea165273367295395e94ddeb157b64e4ab', name: "icon_after" }), this.icon_after && (index.h("span", { key: '91ab8c900a743184dab4d5da7c132cddd63da668', class: `material-icons h-16 w-16 text-[16px] leading-[16px] ${this.in_progress ? 'invisible w-0' : 'visible'}`, "data-name": "button-icon-right" }, this.icon_after))), index.h("div", { key: '1438cd7076f79ee524261f5f2527047b61874fa3', "data-name": "focus-indicator", role: "presentation", class: focusIndicatorClassname })));
    }
};
