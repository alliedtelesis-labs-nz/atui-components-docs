...
const AtButtonComponent = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '522323f3d212dfdd77e215ee99af4f88c17d33d6', class: classname, role: "button", tabIndex: 0, onKeyDown: (event) => this.handleKeyDown(event), onClick: (event) => this.handleClick(event) }, index.h("div", { key: '83c265c1a6f9f28f02521257818e8410e352961e', class: "z-20 flex h-full w-full items-center justify-center gap-4" }, this.in_progress && (index.h("at-loading", { key: '23b29de6955c9dc8b417a314d18f2861bba746e2', class: "absolute", size: "sm", type: this.spinnerColour })), index.h("slot", { key: '8128dc53c7856540dc538ad683e0bffef435d0d3', name: "icon" }), this.icon && (index.h("span", { key: '12aede10c6712fc1f16856cf4073d2d8aab57f41', class: `material-icons !text-icon-md h-16 w-16 leading-[16px] ${this.in_progress ? 'invisible' : 'visible'}`, "data-name": "button-icon" }, this.icon)), this.label && (index.h("span", { key: 'de7374212f4eabef11eac981b47e8af729af2012', class: `leading-[16px] ${this.in_progress ? 'invisible' : 'visible'}`, "data-name": "button-label" }, this.label)), index.h("slot", { key: 'ddbc49b12af132ac152bdf9db78c3ba0ecac8dd8' }), index.h("slot", { key: '0776f841382f03de0589b34236b7e9d296430d46', name: "icon_after" }), this.icon_after && (index.h("span", { key: '134edfc6dadd8b1d1a9d8c3feda72993408fee7d', class: `material-icons !text-icon-md h-16 w-16 leading-[16px] ${this.in_progress ? 'invisible w-0' : 'visible'}`, "data-name": "button-icon-right" }, this.icon_after))), index.h("div", { key: 'ea5a47f8c598b72399b020fa2f2de76f89a8d4fa', "data-name": "focus-indicator", role: "presentation", class: focusIndicatorClassname })));
    }
};
