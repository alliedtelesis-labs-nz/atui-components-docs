...
const AtButtonComponent = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '49d79e6f9a7099bdeb6aed4f563938ab1a1161be', class: classname, role: "button", tabIndex: this.disabled ? -1 : 0, "aria-disabled": this.disabled ? 'true' : undefined, onKeyDown: (event) => this.handleKeyDown(event), onClick: (event) => this.handleClick(event) }, index.h("div", { key: 'a3a0db3679c899f3f86f777ef79ff8d73d206eb3', class: "z-20 flex h-full w-full items-center justify-center gap-4" }, this.in_progress && (index.h("at-loading", { key: '9472631e2e5a60f9d79bb0913383f231e007e5ba', class: "absolute", size: "sm", type: this.spinnerColour })), !this.in_progress && (index.h("slot", { key: '9a4ff6eb2999832e227655880a125d9305937051', name: "icon", "data-name": "button-icon" })), this.label && (index.h("span", { key: 'a6791bf02bd59e693768d347359556bdb698d003', class: `leading-[16px] ${this.in_progress ? 'invisible' : 'visible'}`, "data-name": "button-label" }, this.label)), index.h("slot", { key: 'e03c844dd375641c7a1c1389f5e0a47d11d25d1b' }), !this.in_progress && (index.h("slot", { key: '37248fc8b1f2b02753ebfc1c433b6bf11095c247', name: "icon_after", "data-name": "button-icon-right" }))), index.h("div", { key: '797d0c73661cf904f4a405d3881dd22f6cadf1b6', "data-name": "focus-indicator", role: "presentation", class: focusIndicatorClassname })));
    }
};
