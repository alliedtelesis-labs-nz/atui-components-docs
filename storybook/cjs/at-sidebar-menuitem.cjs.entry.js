...
const AtSidebarMenuitemComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: '2c093d841f54af2d1dead8bb4c9aaa7283341e31', role: "menuitem", "data-state": this.is_active ? 'active' : 'inactive', tabIndex: 0, onKeyDown: this.handleKeyDown }, index.h("div", { key: '0a9ae877c784e0b7d009718d2bca81c9798ff3df', class: "content", "data-name": "content" }, index.h("slot", { key: 'ce28dac5e06cc5c1ebdcb3748567ce7d5dc079b2', name: "label", "data-name": "label" }), this.badge && (index.h("at-badge", { key: '20317572772e24f6a714e64400f125d7530fe32e', class: "badge", "data-name": "sidebar-menu-item-badge", role: "presentation", type: "error", impact: "high", rounded: false, label: this.badge })), this.icon && index.h("i", { key: 'ab1a4b000510a779f452f16a08d792dc06df8f2f', class: "icon" }, this.icon), this.label && (index.h("span", { key: 'dad95bd820ce4f157a5f5f63693c70ccedbf44c4', "data-name": "sidebar-menu-item-label", class: "label" }, this.label))), index.h("slot", { key: '5e64548c5655cdd07933f502d06830b20504ce65', name: "actions" }), index.h("div", { key: '11abd2ed95da2513c94cfdb62158f3b5b8009c05', class: "focus-indicator", "data-name": "focus-indicator", role: "presentation" })));
    }
};
