...
const AtSidebarMenuitemComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'c19b383e10dfc520e0dccdac283a41489820a350', role: "menuitem", "data-state": this.is_active ? 'active' : 'inactive', tabIndex: 0, class: this.depth ? `depth-${this.depth}` : '', onKeyDown: this.handleKeyDown }, index.h("div", { key: '4190dad43a75e01467a210f36f27c58fce4d7e73', class: "at-sidebar-menuitem__content" }, index.h("slot", { key: 'e195c5bd4e43544ef5610bbb2a440898c184311c', name: "menu-item-label" }), this.badge && (index.h("at-badge", { key: 'e8e07dcd24b355b19a1d01bd4bd34f2d0427ddec', "data-name": "menu-badge", role: "presentation", class: "at-sidebar-menuitem__badge", type: "error", impact: "high", rounded: false, label: this.badge })), this.icon && (index.h("span", { key: '5f6575395d88251d49f078736449a72f919b0fa0', class: "material-icons" }, this.icon)), this.label && (index.h("span", { key: '2dd5ab73ce39d94c2d51aa2bf5af3b6cf4063c03', part: "label", "data-name": "sidebar-menu-item-label", class: "at-sidebar-menuitem__label" }, this.label))), index.h("slot", { key: '58b823af32a890592d6db2c541101ced7b722416', name: "menu-item-actions" }), index.h("div", { key: 'c86c8fdb8e65a700a380b0aba49832d7615c9b3f', "data-name": "focus-indicator", role: "presentation" })));
    }
};
