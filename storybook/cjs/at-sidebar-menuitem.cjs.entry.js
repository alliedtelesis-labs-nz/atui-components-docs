...
const AtSidebarMenuitemComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: '7a9a61fcc213598023ab55ecdac4ee1b14bb004e', role: "menuitem", "data-state": this.is_active ? 'active' : 'inactive', tabIndex: 0, class: this.depth ? `depth-${this.depth}` : '', onKeyDown: this.handleKeyDown }, index.h("div", { key: '902808cad59ab673434c5f07d86ab2bf97b2518e', class: "content", "data-name": "content" }, index.h("slot", { key: 'eb1d711faeb6f8b72760fff1a7bd905e1a23db64', name: "label", "data-name": "label" }), this.badge && (index.h("at-badge", { key: 'ace8ff3863d8d3bad89c79d670f98074edc8ac67', class: "badge", "data-name": "badge", role: "presentation", type: "error", impact: "high", rounded: false, label: this.badge })), this.icon && (index.h("span", { key: 'e86769a3de2ee4c1b863836e8133939df38f6dea', class: "material-icons" }, this.icon)), this.label && (index.h("span", { key: '0ec77ad211130b42c59e41ce83b32b7b8a55606f', "data-name": "label", class: "label" }, this.label))), index.h("slot", { key: 'd1a8cae22312a119a1c4158c58ee5500fe1d50c4', name: "actions" }), index.h("div", { key: '9ad8214ff9e9461e3683f5f91a65765439e334df', class: "focus-visible:", "data-name": "focus-indicator", role: "presentation" })));
    }
};
