...
const AtSidebarMenuitemComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: '55c578adc437b79cc751d99466a328c58401fdcc', role: "menuitem", "data-state": this.is_active ? 'active' : 'inactive', tabIndex: 0, onKeyDown: this.handleKeyDown }, index.h("div", { key: '32684bdcbe62ccaae7bd61de2d51e411973f77a4', class: "content", "data-name": "content" }, index.h("slot", { key: 'f600b97a27f4cc19ed824b873fd1055fcd7a2852', name: "label", "data-name": "label" }), this.badge && (index.h("at-badge", { key: '632c939c5ab0fefcef2d3279f703e7b2676b798a', class: "badge", "data-name": "sidebar-menu-item-badge", role: "presentation", type: "error", impact: "high", rounded: false, label: this.badge })), this.icon && index.h("i", { key: '2f59be22ebfcc5901ddb3680119d95cb17646379', class: "icon" }, this.icon), this.label && (index.h("span", { key: '5d95e83e317e1bc9e91edcc44d86cfa14e5152d8', "data-name": "sidebar-menu-item-label", class: "label" }, this.label))), index.h("slot", { key: '87030d60de6a2a1a14e4840e39331f46ca3b0c2e', name: "sidebar-menu-item-actions" }), index.h("div", { key: '0bd9322df270e14e8e1a6cfa840a44e8d5e18e88', class: "focus-indicator", "data-name": "focus-indicator", role: "presentation" })));
    }
};
