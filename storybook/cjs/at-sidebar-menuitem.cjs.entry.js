...
const AtSidebarMenuitemComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: '62d5fb13cd7187a7e52db3aeb388284d9a8ccd35', role: "menuitem", "data-state": this.is_active ? 'active' : 'inactive', tabIndex: 0, onKeyDown: (event) => this.handleKeyDown(event), onClick: (event) => this.handleClick(event) }, index.h("div", { key: '70fb3f7f82cd34cbc846c505bfa5ce4352021f01', class: "content", "data-name": "content" }, index.h("slot", { key: '7d8030c130a114f6bedf97b489d50f69aa512334', name: "icon", "data-name": "icon" }), index.h("slot", { key: 'e1685096612b490fc81c3f4b5e3cfd076dab7c18', name: "label", "data-name": "label" }), this.badge && (index.h("at-badge", { key: '81f8ecbd8034936cff0989993f62a939ec374425', class: "badge", "data-name": "sidebar-menu-item-badge", role: "presentation", type: "error", impact: "high", rounded: false, label: this.badge })), this.icon && this.renderIcon(), this.label && (index.h("span", { key: 'ecb9c06ec9cea3f2cf8399b1c82e2ebe3f314482', "data-name": "sidebar-menu-item-label", class: "label" }, this.label))), index.h("slot", { key: 'd9986302eb835157affdcc33362d27f29010e931', name: "sidebar-menu-item-actions" }), index.h("div", { key: '74c87d06a1408a74ace9ce8dc3b6387ed2bb8fb6', class: "focus-indicator", "data-name": "focus-indicator", role: "presentation" })));
    }
};
