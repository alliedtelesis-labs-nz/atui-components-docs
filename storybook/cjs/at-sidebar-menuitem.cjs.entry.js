...
const AtSidebarMenuitemComponent = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '72e698a28b5dc954b4758579d115ad46fc228fd4', role: "menuitem", "data-state": this.is_active ? 'active' : 'inactive', class: classname, tabIndex: 0, onKeyDown: this.handleKeyDown }, index.h("div", { key: 'feab1aa8d6253e79cf3ffb566cd5682ff982d5dc', class: "flex items-center gap-8 truncate" }, index.h("slot", { key: '719163cf7e66ef28a8b167e3bca43d90e8b29230', name: "menu-item-label" }), this.badge && (index.h("at-badge", { key: '5917064ab689f3b27799e0f406aa622e4b1f83f2', "data-name": "menu-badge", role: "presentation", class: "pointer-events-none absolute top-[-8px] left-[22px] z-20 !rounded-[4px] !px-[3px] !py-4 !text-[11px] !leading-[10px] !font-medium", type: "error", impact: "high", rounded: false, label: this.badge })), this.icon && (index.h("span", { key: '7e9a6cccc8c26f4ca386da287c21ae2f5c0230f6', class: "material-icons !text-icon-xl z-10 flex items-center justify-center p-2" }, this.icon)), this.label && (index.h("span", { key: '5c7180c5665e8ae559013aa03e06f22676b278b7', "data-name": "sidebar-menu-item-label", class: "label z-10 truncate whitespace-nowrap" }, this.label))), index.h("slot", { key: 'c2c03911dec989df7ea4a54a73b8db07e35407c5', name: "menu-item-actions" }), index.h("div", { key: '8338e1181f7c6cd1b1996a906acbc869456da16d', "data-name": "focus-indicator", role: "presentation", class: focusIndicatorClassname })));
    }
};
