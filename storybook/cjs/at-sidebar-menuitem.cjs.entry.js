...
const AtSidebarMenuitemComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'd1c2d8d12e8df97d8d790b7362b36a8d5f65e7db', role: "menuitem", "data-state": this.is_active ? 'active' : 'inactive', tabIndex: 0, onKeyDown: (event) => this.handleKeyDown(event), onClick: (event) => this.handleClick(event) }, index.h("div", { key: '385a91349865418bb3cf01f96065298ca7665d92', class: "content", "data-name": "content" }, index.h("slot", { key: '493cf00d284f57c275d7657b5625f3c3bfde63a3', name: "icon", "data-name": "icon" }), index.h("slot", { key: 'fba4cab07c5ec09f771b2044ff805da0ce590219', name: "label", "data-name": "label" }), this.badge && (index.h("at-badge", { key: 'b6879c53ecab6ef59f537b8b319f1efdfc2b4914', class: "badge", "data-name": "sidebar-menu-item-badge", role: "presentation", type: "error", impact: "high", rounded: false, label: this.badge })), this.icon && this.renderIcon(), this.label && (index.h("span", { key: '34a3f8d9e1b4b04547d300667ccb96fe02abb28d', "data-name": "sidebar-menu-item-label", class: "label" }, this.label))), index.h("slot", { key: '2e46cc56115cc854c4d90c302fa35a2f1c005dd8', name: "sidebar-menu-item-actions" }), index.h("div", { key: 'be486457afb1e9f1024f8326efbe986a36c1f3eb', class: "focus-indicator", "data-name": "focus-indicator", role: "presentation" })));
    }
};
