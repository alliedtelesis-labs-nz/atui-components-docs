...
const AtSidebarMenuitemComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: '73df39a3974aea2677ec056f707226b0c853cb62', role: this.is_trigger ? 'presentation' : 'menuitem', "data-state": this.is_active ? 'active' : 'inactive', tabIndex: this.is_trigger ? undefined : 0, onKeyDown: this.is_trigger
                ? undefined
                : (event) => this.handleKeyDown(event), onClick: (event) => this.handleClick(event), "aria-current": this.is_active ? 'page' : undefined }, index.h("div", { key: 'c03d7011da2998ad21c5af1c5023e9d70b56a04d', class: "content", "data-name": "content" }, index.h("slot", { key: '217756565499c335fdb2b14dc405e8351dd71a4b', name: "icon", "data-name": "icon" }), this.icon && this.renderIcon(), index.h("slot", { key: '783004d02a0764fb8a5b9f68bead6cb561929cd4', name: "label", "data-name": "label" }), this.label && (index.h("span", { key: 'f13edda85f2e9d8ae837d4b2daf8be59b62f8aab', "data-name": "sidebar-menu-item-label", class: "label" }, this.label)), this.badge && (index.h("at-badge", { key: '353c221b18114d84039f9b5ad2643a45d0853876', class: "badge", "data-name": "sidebar-menu-item-badge", role: "presentation", type: "error", impact: "high", rounded: false, label: this.badge }))), index.h("slot", { key: '06a18302dd94af156a63be5bc90ea7311b84fa8b', name: "sidebar-menu-item-actions" })));
    }
};
