...
const AtSidebarMenuitemComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: '2c093d841f54af2d1dead8bb4c9aaa7283341e31', role: "menuitem", "data-state": this.is_active ? 'active' : 'inactive', tabIndex: 0, onKeyDown: this.handleKeyDown }, index.h("div", { key: '0a9ae877c784e0b7d009718d2bca81c9798ff3df', class: "content", "data-name": "content" }, index.h("slot", { key: 'ce28dac5e06cc5c1ebdcb3748567ce7d5dc079b2', name: "label", "data-name": "label" }), this.badge && (index.h("at-badge", { key: 'c16edce48139bc8b31310d094e86cb43e50f1a7b', class: "badge", "data-name": "badge", role: "presentation", type: "error", impact: "high", rounded: false, label: this.badge })), this.icon && index.h("i", { key: 'af24b33fa4eed02b668e4bb5a27487c1493cce63', class: "icon" }, this.icon), this.label && (index.h("span", { key: 'a7bec70d45404917a01a2271e44e1c9d15b547c1', "data-name": "label", class: "label" }, this.label))), index.h("slot", { key: '0c80b90adacadc48ed984537fe419f35d86b6c21', name: "actions" }), index.h("div", { key: 'c3e5f50d5839713737a51d8a523947f591031d0b', class: "focus-indicator", "data-name": "focus-indicator", role: "presentation" })));
    }
};
