...
const AtSidebarMenuitemComponent = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'dd7e094100f9664f7a1e0272799ab5f53b7a7f17', role: "menuitem", "data-state": this.is_active ? 'active' : 'inactive', class: classname }, index.h("div", { key: 'fc2522342914429d0a514f5042170803934718d5', class: "flex items-center gap-8 truncate" }, index.h("slot", { key: '9489239b7629389c0a9c14f15efcf9e42b5f2b70', name: "menu-item-label" }), this.badge && (index.h("at-badge", { key: '995e55fa6f8060fbd28564e50b965735d23f0c0a', "data-name": "menu-badge", role: "presentation", class: "pointer-events-none absolute top-[-8px] left-[22px] z-20 !rounded-[4px] !px-[3px] !py-4 !text-[11px] !leading-[10px] !font-medium", type: "error", impact: "high", rounded: false, label: this.badge })), this.icon && (index.h("span", { key: 'dc6e0e215ab7d3cc537e31f18c62e628b3a3f842', class: "material-icons text-icon-xl z-10 flex items-center justify-center p-2" }, this.icon)), this.label && (index.h("span", { key: '784f3652b70454ee4911a1e8edf880a517269b61', "data-name": "sidebar-menu-item-label", class: "label z-10 truncate whitespace-nowrap" }, this.label))), index.h("slot", { key: '200f44341a9d2afcc62a07904186bb21a663a05b', name: "menu-item-actions" }), index.h("div", { key: '5d77e53d45216fd5d56612517097308d762a4024', "data-name": "focus-indicator", role: "presentation", class: focusIndicatorClassname })));
    }
};
