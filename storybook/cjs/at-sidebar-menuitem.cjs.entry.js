...
const AtSidebarMenuitemComponent = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '31315a80a6bf804f5682f42a0c9bc27de2018289', role: "menuitem", "data-state": this.is_active ? 'active' : 'inactive', class: classname, tabIndex: 0, onKeyDown: this.handleKeyDown }, index.h("div", { key: 'd38fd0b4b2c822b493f8fd9545ee8386a15480b1', class: "flex items-center gap-8 truncate" }, index.h("slot", { key: '3f532f4394c633e2b4909447168196c6b8af62bc', name: "menu-item-label" }), this.badge && (index.h("at-badge", { key: 'f0b24c851ef88fe130efe25b9b86053c52bcb453', "data-name": "menu-badge", role: "presentation", class: "pointer-events-none absolute top-[-8px] left-[22px] z-20 !rounded-[4px] !px-[3px] !py-4 !text-[11px] !leading-[10px] !font-medium", type: "error", impact: "high", rounded: false, label: this.badge })), this.icon && (index.h("span", { key: 'e90fe3cb4c50e8bd4beb2f0d90a628b90d7f557f', class: "material-icons text-icon-xl z-10 flex items-center justify-center p-2" }, this.icon)), this.label && (index.h("span", { key: 'bb9e139562f75e0eb03025268758a75a2a12e2d8', "data-name": "sidebar-menu-item-label", class: "label z-10 truncate whitespace-nowrap" }, this.label))), index.h("slot", { key: 'd482ff0c96b759a3c9ed12de75a552c2e627d799', name: "menu-item-actions" }), index.h("div", { key: '8f24d324c54492c0866a3161af03665109d566ca', "data-name": "focus-indicator", role: "presentation", class: focusIndicatorClassname })));
    }
