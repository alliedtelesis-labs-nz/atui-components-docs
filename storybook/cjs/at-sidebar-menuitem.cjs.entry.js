...
const AtSidebarMenuitemComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'a6c3cf19af0868abb2d2838a808fc9dca281fb16', role: this.is_trigger ? 'presentation' : 'menuitem', "data-state": this.is_active ? 'active' : 'inactive', tabIndex: this.is_trigger ? undefined : 0, onKeyDown: this.is_trigger
                ? undefined
                : (event) => this.handleKeyDown(event), onClick: (event) => this.handleClick(event), "aria-current": this.is_active ? 'page' : undefined }, index.h("div", { key: '689d4808557ad2182870965835165abe816da7d1', class: "content", "data-name": "content" }, index.h("slot", { key: '542212a6e563264166d86fe93a540d8117473c1d', name: "icon", "data-name": "icon" }), this.icon && this.renderIcon(), index.h("slot", { key: 'da152891afadd73a236d2700bb7c8dc8b2678e0f', name: "label", "data-name": "label" }), this.label && (index.h("span", { key: 'fb3080c6eb71bbf55270db1e03587a6c082e9fb8', "data-name": "sidebar-menu-item-label", class: "label" }, this.label)), this.badge && (index.h("at-badge", { key: 'b9eb440516ffd7a60a6caa183c4729cdc2161e47', class: "badge", "data-name": "sidebar-menu-item-badge", role: "presentation", type: "error", impact: "high", rounded: false, label: this.badge }))), index.h("slot", { key: '6293d5a00f5ac6fbd518f30b6fa4c2176196f7c1', name: "sidebar-menu-item-actions" })));
    }
};
