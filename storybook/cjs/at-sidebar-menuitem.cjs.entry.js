...
const AtSidebarMenuitemComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: '02754bdc3a71dfa766a1ab0943731ba5a8e301df', role: "menuitem", "data-state": this.is_active ? 'active' : 'inactive', tabIndex: 0, onKeyDown: (event) => this.handleKeyDown(event), onClick: (event) => this.handleClick(event) }, index.h("div", { key: '2459cd899fe2751f05aa2a425463e3ef25d065e6', class: "content", "data-name": "content" }, index.h("slot", { key: '2bad9bf9a8d625c320942872ffcc1e4b6c03fc15', name: "label", "data-name": "label" }), this.badge && (index.h("at-badge", { key: 'c6ec31823015899a39cc2815c23b4bb4b2899dff', class: "badge", "data-name": "sidebar-menu-item-badge", role: "presentation", type: "error", impact: "high", rounded: false, label: this.badge })), this.icon && index.h("i", { key: 'e556529857a50e3283e3f5faeafb03cc096a9712', class: "icon" }, this.icon), this.label && (index.h("span", { key: '70aadcfdc91dab66d85ec8dd2e5fbd5a9adb1e3a', "data-name": "sidebar-menu-item-label", class: "label" }, this.label))), index.h("slot", { key: '59b0461b7c43080c2f286e7f1e3b6e4e2391bab8', name: "sidebar-menu-item-actions" }), index.h("div", { key: 'e0d01b60948bd3931388f8d4888ba3afff4c6bb6', class: "focus-indicator", "data-name": "focus-indicator", role: "presentation" })));
    }
};
