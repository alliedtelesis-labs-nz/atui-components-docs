...
const AtSidebarMenuitemComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: '7dac43336ec92609066b9f6c40c2e5dc94a62f08', role: "menuitem", "data-state": this.is_active ? 'active' : 'inactive', tabIndex: 0, class: this.depth ? `depth-${this.depth}` : '', onKeyDown: this.handleKeyDown }, index.h("div", { key: '9aa8599e918ad44a286ef4ced7ca8d628f47c306', class: "content", "data-name": "content" }, index.h("slot", { key: '3b5ee34f5a789069a1f1b614029699f0071e2a57', name: "label", "data-name": "label" }), this.badge && (index.h("at-badge", { key: 'c6c4382f0348e98b8c79e35cdf517d7364b13137', class: "badge", "data-name": "badge", role: "presentation", type: "error", impact: "high", rounded: false, label: this.badge })), this.icon && index.h("i", { key: 'f7e8826b99a3c9fc826ba5903a4125d918a80e2a', class: "icon" }, this.icon), this.label && (index.h("span", { key: '29caf7781ebb7599485085e39c864325da2e5ac5', "data-name": "label", class: "label" }, this.label))), index.h("slot", { key: 'c72b6cef60da8bd184a0c010e0270a0df387e0d8', name: "actions" }), index.h("div", { key: 'af25ae5e0402bfecf72d0b34755e6a56323e2c14', class: "focus-indicator", "data-name": "focus-indicator", role: "presentation" })));
    }
};
