...
const AtSidebarMenuitemComponent = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'ce0c1f5cc13d25dc24b50692c3d74a161cb55101', role: this.is_trigger ? 'presentation' : 'menuitem', "data-state": this.is_active ? 'active' : 'inactive', tabIndex: this.is_trigger ? undefined : 0, onKeyDown: this.is_trigger
                ? undefined
                : (event) => this.handleKeyDown(event), onClick: (event) => this.handleClick(event), "aria-current": this.is_active ? 'page' : undefined }, index.h("div", { key: 'aef450a1e45e895925a8e261d4afdc0a97addd8c', class: "content", "data-name": "content" }, index.h("slot", { key: 'b08b7cd9ab48ccd2e96a21f6f6d946079be56166', name: "icon", "data-name": "icon" }), this.icon && this.renderIcon(), index.h("slot", { key: '968054afb1f3d6ed3b6b3202b8a3598796ca150a', name: "label", "data-name": "label" }), this.label && (index.h("span", { key: '0db72f38e3ddcaa380af4b7c5387a4e2795206f6', "data-name": "sidebar-menu-item-label", class: "label" }, this.label)), this.badge && (index.h("at-badge", { key: 'a46437edc824004a1d6ad7911b796db542393e0e', class: "badge", "data-name": "sidebar-menu-item-badge", role: "presentation", type: "error", impact: "high", rounded: false, label: this.badge }))), index.h("slot", { key: '1b316e9eadfe829571686fd47af32e90f00f2f1f', name: "sidebar-menu-item-actions" })));
    }
};
