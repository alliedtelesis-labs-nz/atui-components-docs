...
const AtuiDialogComponent = class {
    ...
    render() {
        return (index.h("dialog", { key: '7f9eee22d5fc66b0a5fadd0ada23876e1026e686', class: `c-atui-dialog ${this.backdrop ? 'backdrop' : ''}`, id: this.dialog_id, "data-name": "dialog", role: this.role, "aria-modal": "true", onClose: this.handleDialogClose, onKeyDown: this.handleKeyDown }, index.h("div", { key: '2e2925023c03d4736879b8e6f16ed536b1f6c7a7', class: "backdrop-content" }, index.h("slot", { key: '873af6c2c05cc8b3b44fc0db2064dc9102cbc191' }))));
    }
