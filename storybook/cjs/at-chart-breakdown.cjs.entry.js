...
const AtChartBreakdown = class {
    constructor(hostRef) {
        ...
        this.atuiLegendToggle = index.createEvent(this, "atuiLegendToggle", 7);
    }
    /**
    ...
    getLeftAlignPlugin() {
        ...
        return {
            ...
            afterDraw: (chart) => {
                ...
                const lineHeight = Math.max(legendFontPx, swatchSize) + chartLegend.LEGEND_ITEM_PADDING;
    ...
    getLegendOverflowPlugin() {
        return {
            ...
            beforeLayout: (chart) => {
                ...
                const legendFontFamily = this.legend_options?.labels?.font?.family ??
                    'sans-serif';
                const itemHeight = legendFontPx + chartLegend.LEGEND_ITEM_PADDING;
                const swatchSize = 10;
                const swatchGap = 6;
                const ctx = chart.ctx;
                ctx.save();
                ...
                const requiredWidth = swatchSize +
                    swatchGap +
                    widestLabel +
                    chartLegend.LEGEND_ITEM_PADDING * 2;
                const requiredHeight = labelCount * itemHeight + chartLegend.LEGEND_ITEM_PADDING * 2;
    ...
    applyPresetPalette(colors) {
        ...
        this.data.datasets = this.data.datasets.map((dataset) => {
            const color = chartColor$1.resolveSeriesColors(colors, dataset.data.length, this.color_palette);
            return {
                ...dataset,
                backgroundColor: color,
    ...
    render() {
        ...
        const typography = showSideText
            ...
            : undefined;
        return (index.h(index.Host, { key: '4d695c2d1c6bdd59cdb3a2b5f1451c5ab7df548c', style: {
                height: '100%',
                width: '100%',
                minHeight: '65px',
                position: 'relative',
            ...
            } }, index.h("canvas", { key: '9cea63313fac68a75d221657b5de35a488815b5f', class: heightVariants[this.height], style: {
                aspectRatio: '1 / 1',
                flexShrink: '0',
            }, ref: (el) => {
                if (el) {
            ...
            } }), showSideText && (index.h("div", { key: '978d06def4922df70bc40e1ec337811b46972424', class: "flex flex-col justify-center ps-8", style: {
                position: 'absolute',
                left: `${this.compactOffset}px`,
            }, ref: (el) => {
                this.sideTextEl = el ?? undefined;
            } }, this.center_value && (index.h("span", { key: '42c292cbeaeb4a1f5ec8b372efbbc33fe1457d91', style: {
                fontSize: `${typography.valueRem}rem`,
                fontWeight: String(typography.weightBold),
                lineHeight: '1.1',
                color: 'var(--chart-title)',
            } }, this.center_value)), this.center_text && (index.h("span", { key: '707d12925fb2b1ceb5236b99039410bdb986d2b7', style: {
...
exports.at_chart_breakdown = AtChartBreakdown;
