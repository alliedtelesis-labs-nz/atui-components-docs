...
const AtChartBreakdown = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '60d2b1eb397737662462346c5bc9ba28498bb9a2', style: {
                height: '100%',
                width: '100%',
                minHeight: '65px',
                position: 'relative',
            ...
            } }, index.h("canvas", { key: '2076cdbc588c85eb49cbcb6c35a9cc45a79123ab', class: heightVariants[this.height], style: {
                aspectRatio: '1 / 1',
                flexShrink: '0',
            }, ref: (el) => {
                if (el) {
            ...
            } }), showSideText && (index.h("div", { key: '4b0e6e2c764067721d21cefdb3ad90ffbb2cbc4c', class: "flex flex-col justify-center ps-8", style: {
                position: 'absolute',
                left: `${this.compactOffset}px`,
            }, ref: (el) => {
                this.sideTextEl = el ?? undefined;
            } }, this.center_value && (index.h("span", { key: 'cecb21d4673b6ce1bec51205eca4ab0bc7889a36', style: {
                fontSize: '3rem',
                fontWeight: '700',
                lineHeight: '1.1',
                color: 'var(--token-text-primary)',
            } }, this.center_value)), this.center_text && (index.h("span", { key: 'fc9b082547d88c995cd33f6f940a2956ad67e775', style: {
                fontSize: '1rem',
