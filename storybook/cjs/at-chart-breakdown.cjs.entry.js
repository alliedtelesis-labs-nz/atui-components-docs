...
const AtChartBreakdown = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'ce55bd7ea4b4c5e843e06153c7fc305cd9bfd677', style: {
                height: '100%',
                width: '100%',
                minHeight: '65px',
                position: 'relative',
            ...
            } }, index.h("canvas", { key: '617cbf9d41eda988e3a402e967d6fc79704b4c53', class: heightVariants[this.height], style: {
                aspectRatio: '1 / 1',
                flexShrink: '0',
            }, ref: (el) => {
                if (el) {
            ...
            } }), showSideText && (index.h("div", { key: 'f4458f26faa272e96b4703200ced58fe2f6ab400', class: "flex flex-col justify-center ps-8", style: {
                position: 'absolute',
                left: `${this.compactOffset}px`,
            }, ref: (el) => {
                this.sideTextEl = el ?? undefined;
            } }, this.center_value && (index.h("span", { key: '1e9530efd98b012236d03eb72b8d8bfd794613e9', style: {
                fontSize: '3rem',
                fontWeight: '700',
                lineHeight: '1.1',
                color: 'var(--token-text-primary)',
            } }, this.center_value)), this.center_text && (index.h("span", { key: 'e6286b4caa374841fa8dd0de3443c69384e89d64', style: {
                fontSize: '1rem',
