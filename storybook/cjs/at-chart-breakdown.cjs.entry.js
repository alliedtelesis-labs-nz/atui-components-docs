...
const AtChartBreakdown = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '4208ea776a7455a05712380ff0c85cfd4abe0ca1', style: {
                height: '100%',
                width: '100%',
                minHeight: '65px',
                position: 'relative',
            ...
            } }, index.h("canvas", { key: '304e2d39bddd96509cdbddf7f309365eb4325f6c', class: heightVariants[this.height], style: {
                aspectRatio: '1 / 1',
                flexShrink: '0',
            }, ref: (el) => {
                if (el) {
            ...
            } }), showSideText && (index.h("div", { key: '494d664892fa157f047e5282f44dd471f6311318', class: "flex flex-col justify-center ps-8", style: {
                position: 'absolute',
                left: `${this.compactOffset}px`,
            }, ref: (el) => {
                this.sideTextEl = el ?? undefined;
            } }, this.center_value && (index.h("span", { key: 'd95ebaeeadd4c59eab312d40e4266fffac764b1e', style: {
                fontSize: '3rem',
                fontWeight: '700',
                lineHeight: '1.1',
                color: 'var(--token-text-primary)',
            } }, this.center_value)), this.center_text && (index.h("span", { key: '930f965d182b81233b37643252a3d3368ac278f7', style: {
                fontSize: '1rem',
