...
const AtFilterForm = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'ec3c9117d34f5fa659af9c82497c9613df61b71f', class: "flex flex-col gap-4 p-8" }, this.renderGroup(this.root, true), index.h("div", { key: 'e471843b8de44b1c5219f708f5cef0209e155486', class: "flex justify-end gap-4" }, index.h("at-button", { key: 'a095df16352e7a1d1ab37791a55a45838816db2f', label: "Cancel", type: "secondaryOutline", onAtuiClick: () => this.onCancel() }), index.h("at-button", { key: '9cc704f3d0f4274b25a8470347b8d1e82fb665aa', label: "Search", type: "primary", disabled: !this.isFormValid, onAtuiClick: () => this.onSearch() }))));
    }
