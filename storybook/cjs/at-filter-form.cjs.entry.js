...
const AtFilterForm = class {
    ...
    render() {
        return (index.h(index.Host, { key: '0a56d5a79bf373797e66f50dafdd6b463bffe28e', class: "flex flex-col gap-4 p-8" }, this.renderGroup(this.root, true), index.h("div", { key: '869a34b8729e76e79f5dc8177120488692acf8c2', class: "flex justify-end gap-4" }, index.h("at-button", { key: '5c2f59c8b205aedb270b5f72ec9ee996c347fbe0', label: "Cancel", type: "secondaryOutline", onAtuiClick: () => this.onCancel() }), index.h("at-button", { key: '11a0b5753e36487208441ad355fda8ad2957775e', label: "Search", type: "primary", disabled: !this.isFormValid, onAtuiClick: () => this.onSearch() }))));
    }
