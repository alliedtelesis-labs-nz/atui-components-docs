...
const AtSearch = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'dea11b4a12bed7e3d3b310c279f198272053f895' }, this.label && (index.h("at-form-label", { key: '46eb11240eca09299f773b2f6738fc5a9e5f58c4', label: this.label, for: this.inputId })), index.h("div", { key: '08085435e1d5128b2b15a5922bd40acae00714fe', class: "transition[background-color,color,box-shadow] border-input bg-input-background focus-within:border-active-accent focus-within:ring-active-glow rounded-input h-input min-h-input relative flex flex-row items-center justify-center border duration-300 ease-in-out focus-within:z-10 focus-within:ring" }, index.h("at-icon", { key: 'fbb5619f184b61d25fbba5be42c0fb98fed5be68', class: "fill-foreground px-8", name: "search" }), index.h("input", { key: 'c8754406889a2caa84d77a8f0cd4d60dc99f5186', id: this.inputId, role: "searchbox", "aria-label": this.label
                ...
                ? 'pr-4 opacity-100'
                : 'pointer-events-none pr-0 opacity-0'}` }, index.h("at-button", { key: 'b9a0a332230c77f24333ac901be7ca9b7713f558', size: "sm", type: "secondaryText", "aria-label": "Clear search", onClick: () => this.clearFn(), "data-name": "search-clear", tabindex: this.model !== '' && this.model !== undefined
                ? '0'
                : '-1' }, index.h("at-icon", { key: '7b323d5f64be3232974ad50ee6171aa29e5f4a1a', slot: "icon", name: "backspace" }))), this.info_text && (index.h("div", { key: 'a31d11761280da6771fc22c71a83ce526b56675d', class: "flex items-center pr-8", "data-name": "search-info" }, index.h("at-tooltip", { key: '9b7ca26454329bc1fa7f44e3d7a36eaeeceebdd2', position: "top" }, index.h("at-icon", { key: '0c7e7dead8c084b077bd00f9e02d26f2bb5797b2', slot: "tooltip-trigger", class: "fill-muted cursor-pointer", name: "info", size: "1rem" }), index.h("span", { key: '3372b77a83af18004edbc79a25e3855329b5659c' }, this.info_text))))), this.hint_text && (index.h("span", { key: '06330849966251ff4a5da02141aa662fbe85cd3f', class: "text-secondary mt-4 truncate text-xs !leading-normal font-normal empty:hidden", "data-name": "search-hint" }, this.hint_text))));
    }
};
