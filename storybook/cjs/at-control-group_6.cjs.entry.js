...
const AtControlGroup = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'd96b2d6c01e7c696375df922f6a0f748d496506a', class: `at-control-group at-control-group--${this.direction}` }, index.h("slot", { key: '00ff81c2f421cf8974003923f0bb1f3c066d39c2' })));
    }
};
...
const AtSearch = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'dea11b4a12bed7e3d3b310c279f198272053f895' }, this.label && (index.h("at-form-label", { key: '46eb11240eca09299f773b2f6738fc5a9e5f58c4', label: this.label, for: this.inputId })), index.h("div", { key: '08085435e1d5128b2b15a5922bd40acae00714fe', class: "transition[background-color,color,box-shadow] border-input bg-input-background focus-within:border-active-accent focus-within:ring-active-glow rounded-input h-input min-h-input relative flex flex-row items-center justify-center border duration-300 ease-in-out focus-within:z-10 focus-within:ring" }, index.h("at-icon", { key: 'fbb5619f184b61d25fbba5be42c0fb98fed5be68', class: "fill-foreground px-8", name: "search" }), index.h("input", { key: 'c8754406889a2caa84d77a8f0cd4d60dc99f5186', id: this.inputId, role: "searchbox", "aria-label": this.label
                ? undefined
                : this.placeholder || 'Search', tabindex: "0", class: "mr-24 h-full w-full bg-transparent p-0 leading-[30px] focus:border-none focus:outline-none", placeholder: this.placeholder, value: this.model, autocomplete: "off", name: "search", onInput: () => this.onChangeFn(), ref: (el) => (this.searchEl = el) }), index.h("div", { key: '188dddc80a4c9484addd1af63bbe39b68b5332fe', class: `transition-all duration-300 ease-in-out ${this.model !== '' && this.model !== undefined
                ? 'pr-4 opacity-100'
                : 'pointer-events-none pr-0 opacity-0'}` }, index.h("at-button", { key: '788b488218b249c5b0337a1f2bd44845aa861720', size: "sm", type: "secondaryText", onClick: () => this.clearFn(), "data-name": "search-clear", tabindex: this.model !== '' && this.model !== undefined
                ? '0'
                : '-1' }, index.h("at-icon", { key: 'dcf2a62532e4f1076a36ccf8a096e959fba48a55', slot: "icon", name: "backspace" }))), this.info_text && (index.h("div", { key: 'd58ed99301f5d5561cfb974b105f7058097c901b', class: "flex items-center pr-8", "data-name": "search-info" }, index.h("at-tooltip", { key: 'c88150dbebf4d67be70605e8e9bc82de7631ff74', position: "top" }, index.h("at-icon", { key: 'd82241ecb45ef5dd838d22670bd856ca6fcc61bb', slot: "tooltip-trigger", class: "fill-muted cursor-pointer", name: "info", size: "1rem" }), index.h("span", { key: 'cac29d2dc4cd8cc2adaa89be2bbc2bfd9712aad5' }, this.info_text))))), this.hint_text && (index.h("span", { key: '4342bbaaa61efdfd2b2db46d927315b580c90c37', class: "text-secondary mt-4 truncate text-xs !leading-normal font-normal empty:hidden", "data-name": "search-hint" }, this.hint_text))));
    }
};
...
const AtTableFilterMenu = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'a8d346cf3666e9141455a75574564d72235c97c6' }, index.h("at-menu", { key: '3c2f8e65c3a3736338649282e6cbd20c410793d3', ref: (el) => (this.menuEl = el), autoclose: false, width: "fit-content", class: "self-start", align: "start" }, index.h("div", { key: '43ba021f0728a60fc289047c8314be9293c3ac44', class: "relative", slot: "menu-trigger", "data-tooltip": "table-filter-menu" }, this.filters &&
            filterTree_util.countFilterConditions(this.filters) > 0 && (index.h("at-badge", { key: 'f012c42d8c9dc609c97c52e76843a1a96ba3be71', class: "absolute top-[-8px] left-[-6px] z-10", type: "info", size: "sm", label: filterTree_util.countFilterConditions(this.filters).toString() })), index.h("at-button", { key: '6e5f476655fba20742c008e57982822917177d53', slot: "tooltip-trigger", type: "secondaryOutline", class: "h-input", "data-name": "filter-menu-trigger" }, index.h("at-icon", { key: '8b6e221ff3255b391cd13984759a9445e9e85320', slot: "icon", name: "edit_filters" }))), index.h("at-tooltip", { key: '6dd2bed992b70540581d5d0a22e584fd3b989df2', "trigger-id": "table-filter-menu", position: "top" }, this.translations.ATUI.TABLE.FILTER_DATA), index.h("at-filter-form", { key: '986f55bacbcc94ff6d947f2aba50e30e8431afff', filter_config: this.filterConfig, active_filters: this.filters, onAtSearch: this.handleSearch, onAtCancel: this.handleCancel }))));
    }
};
...
const AtTablePagination = class {
    ...
    atPageSizeChange;
    render() {
        return (index.h(index.Host, { key: '88343266b36cc58a3e776d94f2a3a26658d89e40', class: "mt-8 flex items-center justify-end gap-8" }, index.h("span", { key: 'ce10e23766bfdb93b0b5335b121913484ab9de60' }, "Page Size: "), index.h("at-select", { key: 'af67df0c7324493ed5bf9b155db58a1364cc2310', options: this.resolvedPageSizeOptions, value: String(this.page_size), clearable: false, onAtuiChange: (event) => this.atPageSizeChange.emit(parseInt(event.detail)) }), index.h("at-button", { key: '9f1732d4f1b57eca5c4e5709a94ce8d9ab6cce9e', disabled: this.current_page === 1, type: "secondaryText", onAtuiClick: () => this.atChange.emit(1) }, index.h("at-icon", { key: '9ea611131ac23dd659baf3db2ff5186373eedfe6', slot: "icon", name: "first_page" })), index.h("at-button", { key: '928ca9b697e3f4cdd05f2203f8ff488dcff3061a', disabled: this.current_page === 1, type: "secondaryText", onAtuiClick: () => this.atChange.emit(this.current_page - 1) }, index.h("at-icon", { key: '0350c49225cc2da71907d667b941effa33d587d0', slot: "icon", name: "chevron_left" })), index.h("span", { key: '01cd9ee0b94152736900a9326ce43ee073b3341d' }, "Page ", this.current_page, " of ", this.num_pages), index.h("at-button", { key: '9055c6e52fee83ca7c5e6e058911b6fc0adb5891', disabled: this.current_page === this.num_pages, type: "secondaryText", onAtuiClick: () => this.atChange.emit(this.current_page + 1) }, index.h("at-icon", { key: '127173dda0dcfecddd777342ba839157a6081d2c', slot: "icon", name: "chevron_right" })), index.h("at-button", { key: '697f6a309c2e58af7ad7722c2db61f5cba0f7030', disabled: this.current_page === this.num_pages, type: "secondaryText", onAtuiClick: () => this.atChange.emit(this.num_pages) }, index.h("at-icon", { key: '1ba4fc5fd0a8c4ab1394f697fa3f27a9ac516c33', slot: "icon", name: "last_page" }))));
    }
};
