...
const AtControlGroup = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'dea321a1b8517b2387857744df5b3a53fc96bc79', class: `at-control-group at-control-group--${this.direction}` }, index.h("slot", { key: '4960fe180f0c78494516f11783d91e62e7af1083' })));
    }
};
...
const AtSearch = class {
    ...
    render() {
        return (index.h(index.Host, { key: '503e898f68ae0d6bd065e202bdffcc95f4003392' }, (this.label || this.info_text) && (index.h("at-form-label", { key: 'e463e77ab7a84699ca18d3b744a2fde5f5fc422a', label: this.label, for: this.label
                ? `search-input-${this.label.replace(/\s+/g, '-').toLowerCase()}`
                : undefined, info_text: this.info_text })), index.h("div", { key: '68e7e2cc553ef13afaf00f94690b4f26b8ca3103', class: "transition[background-color,color,box-shadow] border-input bg-input-background focus-within:border-active-accent focus-within:ring-active-glow rounded-input h-input min-h-input relative flex flex-row items-center justify-center border duration-300 ease-in-out focus-within:z-10 focus-within:ring" }, index.h("at-icon", { key: '4b3558506c10651884d7ab260a5298593f27ef78', class: "fill-foreground px-8", name: "search" }), index.h("input", { key: 'a628fca95f9dac4949c83ef9744473664d1c2759', id: this.label
                ? `search-input-${this.label.replace(/\s+/g, '-').toLowerCase()}`
                : undefined, role: "searchbox", tabindex: "0", class: "mr-24 h-full w-full bg-transparent p-0 leading-[30px] focus:border-none focus:outline-none", placeholder: this.placeholder, value: this.model, autocomplete: "off", name: "search", onInput: () => this.onChangeFn(), ref: (el) => (this.searchEl = el) }), index.h("div", { key: 'd5fddad78d1dfa7009c6f26c5369beba1bce95c3', class: `transition-all duration-300 ease-in-out ${this.model !== '' && this.model !== undefined
                ? 'pr-4 opacity-100'
                : 'pointer-events-none pr-0 opacity-0'}` }, index.h("at-button", { key: 'e3733755322a8f00967c371bd6f34d1ec91a8c13', size: "sm", type: "secondaryText", onClick: () => this.clearFn(), "data-name": "search-clear", tabindex: this.model !== '' && this.model !== undefined
                ? '0'
                : '-1' }, index.h("at-icon", { key: '83c363ecc34cf50a78da82ed618e99badef973f7', slot: "icon", name: "backspace" })))), this.hint_text && (index.h("span", { key: '3e32d0dc410bc9ca86180580e7303bfac2de6f8a', class: "text-secondary mt-4 truncate text-xs !leading-normal font-normal empty:hidden", "data-name": "search-hint" }, this.hint_text))));
    }
};
...
const AtTableFilterMenu = class {
    ...
    render() {
        return (index.h(index.Host, { key: '36ed726190ebec54dbdb355e84455cc4058731eb' }, index.h("at-menu", { key: '32f586457a35f8368817d70b36fdc1bf2bd4ad04', autoclose: false, width: "fit-content", class: "self-start", align: "start" }, index.h("at-tooltip", { key: 'a75dda35c67f222ca42e391f710ca6c864209536', slot: "menu-trigger", position: "top" }, index.h("at-button", { key: '1761ae2bfee4fd894c00f200db8aa1760d02ff41', slot: "tooltip-trigger", type: "secondaryOutline" }, index.h("at-icon", { key: '6a0ecc6e4f50a7b1d5290c87bda5b7160416d9bd', slot: "icon", name: "edit_filters" })), index.h("span", { key: '47603094cbfa24f82c94467bb9b033019aa91ee1' }, this.translations.ATUI.TABLE.FILTER_DATA)), index.h("div", { key: '4cff76a0e480ccd2d3445716985c06ae336e721f', class: "flex flex-col" }, index.h("at-checkbox-group", { key: 'c570df1f6d13fca499c6fd5849fcedc2d9b6fcbd', class: "w-fit", options: this.filteredColumns, value: this.selected, onAtuiChange: (event) => this.handleColumnSelect(event) })))));
    }
...
const AtTableFilters = class {
    ...
    render() {
        return (this.col_defs && (index.h(index.Host, { key: '3563bdcb7145320391a62152d02c2a0dcf140eed', class: "flex items-start gap-8" }, this.selected.length > 0 && (index.h("div", { key: 'a1ff9b5d0880a3c35960ad1cdf2b2bf4d77d4761', class: "bg-surface-foreground rounded-input flex min-h-[36px] flex-wrap items-end gap-8 p-8" }, this.selected.map((column) => (index.h("div", { class: "flex items-center gap-2" }, index.h("at-input", { class: "w-input-sm", label: this.getHeaderName(column.id), prefix: this.getHeaderName(column.id) + ': ', value: column.value, onAtuiChange: (event) => this.filterChangeHandler(event, column.id) }, index.h("div", { slot: "input-actions" }, index.h("at-button", { type: "secondaryText", size: "sm", onClick: () => this.clearSingleFilter(column.id), "data-name": `filter-clear-${column.id}` }, index.h("at-icon", { slot: "icon", name: "cancel" }))))))), index.h("at-button", { key: '3e849b5fb0e4a769b1fdb82fdc2d48f6839ed65f', type: "secondaryText", label: "Clear All", onClick: this.clearFilters, "data-name": "filter-clear-all" }))))));
    }
};
...
const AtTablePagination = class {
    ...
    atPageSizeChange;
    render() {
        return (index.h(index.Host, { key: '2d1085ee0c7527c137b483a7717a0af5fe30ebe0', class: "mt-8 flex items-center justify-end gap-8" }, index.h("span", { key: 'bfc91b2101c50ba53405bf1b4084a90f28fc0b8f' }, "Page Size: "), index.h("at-select", { key: '4e2efe43a30b30f215b97917e5ab310e5f1a3196', options: this.page_size_options, value: String(this.page_size), clearable: false, onAtuiChange: (event) => this.atPageSizeChange.emit(parseInt(event.detail)) }), index.h("at-button", { key: '6f135988064d29b3975182566c8140d164bf3ad1', disabled: this.current_page === 1, type: "secondaryText", onAtuiClick: () => this.atChange.emit(1) }, index.h("at-icon", { key: '46462ccc81acf43a88ec5ee67c29fc8cdc340e49', slot: "icon", name: "first_page" })), index.h("at-button", { key: 'bb49d0e32b1aaf78a548eef9b117b17d9c444171', disabled: this.current_page === 1, type: "secondaryText", onAtuiClick: () => this.atChange.emit(this.current_page - 1) }, index.h("at-icon", { key: 'c79dd5afeba7c81eb14a9afb9c263fda2ded14e0', slot: "icon", name: "chevron_left" })), index.h("span", { key: 'deedf712be995430a900539c082d51e636d25c4d' }, "Page ", this.current_page, " of ", this.num_pages), index.h("at-button", { key: '9494754fbc0abee9d53f34d740253203aa03b5a4', disabled: this.current_page === this.num_pages, type: "secondaryText", onAtuiClick: () => this.atChange.emit(this.current_page + 1) }, index.h("at-icon", { key: '16b5a1883db067db171ad4183ec73c4842a9edda', slot: "icon", name: "chevron_right" })), index.h("at-button", { key: '8c98ab4fe5af411fd56419237a906b062c59604d', disabled: this.current_page === this.num_pages, type: "secondaryText", onAtuiClick: () => this.atChange.emit(this.num_pages) }, index.h("at-icon", { key: 'b6033c7fc8f033247423231b88f6bbe398410e1e', slot: "icon", name: "last_page" }))));
    }
};
