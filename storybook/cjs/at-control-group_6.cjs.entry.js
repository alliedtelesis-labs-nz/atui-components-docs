...
const AtSearch = class {
    ...
    render() {
        return (index.h(index.Host, { key: '326bc470dfb43fe9a1c0301f8eec9c07c1cedeaa' }, this.label && (index.h("at-form-label", { key: '85ae6acc960367036427c87a85e9df79bbecd46c', label: this.label, for: this.inputId })), index.h("div", { key: '05c6a81171d340fd1bff80f2ebeff6d4a9ec0e4d', class: "transition[background-color,color,box-shadow] border-input bg-input-background focus-within:border-active-accent focus-within:ring-active-glow rounded-input h-input min-h-input relative flex flex-row items-center justify-center border duration-300 ease-in-out focus-within:z-10 focus-within:ring" }, index.h("at-icon", { key: '89182307c987a24333214c6e0fd1ba67ce7f43ea', class: "fill-foreground px-8", name: "search" }), index.h("input", { key: '7949ab05f516025e83d72dfd6936cfd336d20ab5', id: this.inputId, role: "searchbox", "aria-label": this.label
                ? undefined
                : this.placeholder || 'Search', tabindex: "0", class: "mr-24 h-full w-full bg-transparent p-0 leading-[30px] focus:border-none focus:outline-none", placeholder: this.placeholder, value: this.model, autocomplete: "off", name: "search", onInput: () => this.onChangeFn(), ref: (el) => (this.searchEl = el) }), index.h("div", { key: '57161c6de0ef77b63eeacd0408f6a995326bfa0f', class: `transition-all duration-300 ease-in-out ${this.model !== '' && this.model !== undefined
                ? 'pr-4 opacity-100'
                : 'pointer-events-none pr-0 opacity-0'}` }, index.h("at-button", { key: '5ff0cb568cb6754f7c39ac512826205530979d51', size: "sm", type: "secondaryText", onClick: () => this.clearFn(), "data-name": "search-clear", tabindex: this.model !== '' && this.model !== undefined
                ? '0'
                : '-1' }, index.h("at-icon", { key: '029d70963da6d3d76d4634cb968ac1c61c4ca200', slot: "icon", name: "backspace" }))), this.info_text && (index.h("div", { key: '7bc8738ad360a66ee1455ae3fd1e73702bc9f140', class: "flex items-center pr-8", "data-name": "search-info" }, index.h("at-tooltip", { key: '8fb99cdbdc00cec3a567804a8338a64bdbc4fcc8', position: "top" }, index.h("at-icon", { key: '59b8535f8ef710375253a470b8bb8ec4d16bb9fd', slot: "tooltip-trigger", class: "fill-muted cursor-pointer", name: "info", size: "1rem" }), index.h("span", { key: 'da781b8dc8fa0b98678350363e1b0b8674d8b85d' }, this.info_text))))), this.hint_text && (index.h("span", { key: '8f6eaf4d25839a5534c2e0122800511a364556a3', class: "text-secondary mt-4 truncate text-xs !leading-normal font-normal empty:hidden", "data-name": "search-hint" }, this.hint_text))));
    }
};
