...
const AtControlGroup = class {
    ...
    render() {
        return (index.h(index.Host, { key: '647b69943f4e8858eeaac147e0d53b73cb557767', class: `at-control-group at-control-group--${this.direction}` }, index.h("slot", { key: 'b9a0f0f4a406beed4caaa097527426a3625e291f' })));
    }
};
...
const AtSearch = class {
    ...
    render() {
        return (index.h(index.Host, { key: '8b2c0dcc97010eb9c2df3a4ec7b3b0bdac2f7f5b' }, this.label && (index.h("at-form-label", { key: 'dc3ee16970917002df31e9ff24c563b714e4433a', label: this.label, for: this.inputId })), index.h("div", { key: 'c30e22dd5971d56a07a660c89afca77a5a693d2c', class: "transition[background-color,color,box-shadow] border-input bg-input-background focus-within:border-active-accent focus-within:ring-active-glow rounded-input h-input min-h-input relative flex flex-row items-center justify-center border duration-300 ease-in-out focus-within:z-10 focus-within:ring" }, index.h("at-icon", { key: 'e1670d0a130136ee98ffd1305d8a047ecc03c8ef', class: "fill-foreground px-8", name: "search" }), index.h("input", { key: 'bcf0dccf1ef6712804c6a0b6b864444111bb1c0a', id: this.inputId, role: "searchbox", "aria-label": this.label
                ? undefined
                : this.placeholder || 'Search', tabindex: "0", class: "mr-24 h-full w-full bg-transparent p-0 leading-[30px] focus:border-none focus:outline-none", placeholder: this.placeholder, value: this.model, autocomplete: "off", name: "search", onInput: () => this.onChangeFn(), ref: (el) => (this.searchEl = el) }), index.h("div", { key: 'b4398f2e2505bf127f57a68fd0bd186dd43abafa', class: `transition-all duration-300 ease-in-out ${this.model !== '' && this.model !== undefined
                ? 'pr-4 opacity-100'
                : 'pointer-events-none pr-0 opacity-0'}` }, index.h("at-button", { key: '574653986a7d5a17dbfdb5421f847f57c8e5acb0', size: "sm", type: "secondaryText", onClick: () => this.clearFn(), "data-name": "search-clear", tabindex: this.model !== '' && this.model !== undefined
                ? '0'
                : '-1' }, index.h("at-icon", { key: 'c412c5effae71490342a755e13e8f994124dd20e', slot: "icon", name: "backspace" }))), this.info_text && (index.h("div", { key: 'ac3238d0cb761b759c592386c330728abbeabf4b', class: "flex items-center pr-8", "data-name": "search-info" }, index.h("at-tooltip", { key: '00cfde54ffd16fe07b43db6f6394a3501afe2aa5', position: "top" }, index.h("at-icon", { key: 'f8782bbb7d1a8720392efb2adc36cab50d29f9a6', slot: "tooltip-trigger", class: "fill-muted cursor-pointer", name: "info", size: "1rem" }), index.h("span", { key: '57373f60e43e3b874eac7c62940c659167deddaf' }, this.info_text))))), this.hint_text && (index.h("span", { key: 'b1dea18cf290f5c62c8d02743fc3f81739e500d5', class: "text-secondary mt-4 truncate text-xs !leading-normal font-normal empty:hidden", "data-name": "search-hint" }, this.hint_text))));
    }
};
...
const AtTableFilterMenu = class {
    ...
    render() {
        return (index.h(index.Host, { key: '48cb57aaf46bfe9e734bb381620bd60184ee5ad8' }, index.h("at-menu", { key: '70fd4f326a613d21a6f428add880d2868a4fa37b', ref: (el) => (this.menuEl = el), autoclose: false, width: "fit-content", class: "self-start", align: "start" }, index.h("div", { key: 'f5bed524e904a3d917aaa2993ecdce1f454896f7', class: "relative", slot: "menu-trigger", "data-tooltip": "table-filter-menu" }, this.filters &&
            filterTree_util.countFilterConditions(this.filters) > 0 && (index.h("at-badge", { key: '1d19a5da02fff87c8eff7046b178b950fb76a180', class: "absolute top-[-8px] left-[-6px] z-10", type: "info", size: "sm", label: filterTree_util.countFilterConditions(this.filters).toString() })), index.h("at-button", { key: '2d944170d3057505bea1bd2fa6dc6a7d56ab164e', slot: "tooltip-trigger", type: "secondaryOutline", class: "h-input", "data-name": "filter-menu-trigger" }, index.h("at-icon", { key: '9410e3913389196546601a1fc5955b74d3c3b08c', slot: "icon", name: "edit_filters" }))), index.h("at-tooltip", { key: '5aebda4f5be1c9c884cb84099570c61166fe9cf2', "trigger-id": "table-filter-menu", position: "top" }, this.translations.ATUI.TABLE.FILTER_DATA), index.h("at-filter-form", { key: '456caa6c3f36b27afe805a3f22cc0d212e05b2db', filter_config: this.filterConfig, active_filters: this.filters, onAtSearch: this.handleSearch, onAtCancel: this.handleCancel }))));
    }
};
...
const AtTablePagination = class {
    ...
    atPageSizeChange;
    render() {
        return (index.h(index.Host, { key: '83d1963d638dbe1dc55d955ef067dd5c4c159a13', class: "mt-8 flex items-center justify-end gap-8" }, index.h("span", { key: '0e7d9e9c76f89f1c64e9ee8502061d54e3981ad7' }, "Page Size: "), index.h("at-select", { key: '2f3126353e968c0f42821bb33a745da5f97e367d', options: this.resolvedPageSizeOptions, value: String(this.page_size), clearable: false, onAtuiChange: (event) => this.atPageSizeChange.emit(parseInt(event.detail)) }), index.h("at-button", { key: 'cee25e4afd3f9940b8b4cfe070840093ef2af7f7', disabled: this.current_page === 1, type: "secondaryText", onAtuiClick: () => this.atChange.emit(1) }, index.h("at-icon", { key: '849fe13b1ef41157e43da9b0860f9ec31755dc60', slot: "icon", name: "first_page" })), index.h("at-button", { key: 'f03d6f991dbcf271dc4c7545753d57d238d57ad4', disabled: this.current_page === 1, type: "secondaryText", onAtuiClick: () => this.atChange.emit(this.current_page - 1) }, index.h("at-icon", { key: '9e051bf87b94cc0b11648223852a2a152296d3ed', slot: "icon", name: "chevron_left" })), index.h("span", { key: '73b538c32368ba9a0ebc5f122794785d76b10b61' }, "Page ", this.current_page, " of ", this.num_pages), index.h("at-button", { key: 'bb0a8e5c02d6268e91b66b910c29caca81d96d49', disabled: this.current_page === this.num_pages, type: "secondaryText", onAtuiClick: () => this.atChange.emit(this.current_page + 1) }, index.h("at-icon", { key: '4496c5cc8dae8395b49ceb85e98400d77d11b539', slot: "icon", name: "chevron_right" })), index.h("at-button", { key: 'ed904f1e96c324248a309b5824e51d9d00ff6ac4', disabled: this.current_page === this.num_pages, type: "secondaryText", onAtuiClick: () => this.atChange.emit(this.num_pages) }, index.h("at-icon", { key: '165cac7a968c2df6dc922b5f03f348680a91451b', slot: "icon", name: "last_page" }))));
    }
};
