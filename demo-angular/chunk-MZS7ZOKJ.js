import{b as t,c as i,e as s}from"./chunk-ADWYJZ22.js";import{h as e}from"./chunk-B7O3QC5Z.js";var l=`dialog.backdrop::backdrop {
...
.c-atui-dialog:not([open]) {
  ...
  opacity: 0;
  visibility: hidden;
}`,c=(()=>{let o=class{constructor(a){t(this,a),this.role="dialog",this.backdrop=!1,this.isOpen=!1,this.handleDialogClose=n=>{n.preventDefault(),this.isOpen&&this.closeDialog()},this.handleKeyDown=n=>{n.key==="Escape"&&this.isOpen&&(n.preventDefault(),this.closeDialog())}}openDialog(){return e(this,null,function*(){let a=this.el.querySelector("dialog");a&&!this.isOpen&&(a.showModal(),this.isOpen=!0,this.backdrop&&a.classList.add("backdrop"))})}closeDialog(){return e(this,null,function*(){let a=this.el.querySelector("dialog");a&&this.isOpen&&(a.close(),this.isOpen=!1,a.removeAttribute("open"),a.classList.remove("backdrop"))})}render(){return i("dialog",{key:"a7cf76492afd7f55bbadc23b360f0fccb41457c9",class:`c-atui-dialog ${this.backdrop?"backdrop":""}`,id:this.dialog_id,"data-name":"dialog",role:this.role,"aria-modal":"true",onClose:this.handleDialogClose,onKeyDown:this.handleKeyDown},i("div",{key:"07a3552e9e0adc62e8f7cd301c89337c4763e1a3",class:"backdrop-content"},i("slot",{key:"7466c89b5b53865fd8a3c69243ce6e8a32980960"})))}get el(){return s(this)}};return o.style=l,o})();export{c as atui_dialog};
